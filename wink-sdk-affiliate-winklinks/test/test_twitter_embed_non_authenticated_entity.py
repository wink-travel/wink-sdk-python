...
class TestTwitterEmbedNonAuthenticatedEntity(unittest.TestCase):
    """TwitterEmbedNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TwitterEmbedNonAuthenticatedEntity:
        """Test TwitterEmbedNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TwitterEmbedNonAuthenticatedEntity`
        """
        model = TwitterEmbedNonAuthenticatedEntity()
        if include_optional:
    ...
    def testTwitterEmbedNonAuthenticatedEntity(self):
        """Test TwitterEmbedNonAuthenticatedEntity"""
