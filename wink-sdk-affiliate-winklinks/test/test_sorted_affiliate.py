...
class TestSortedAffiliate(unittest.TestCase):
    """SortedAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortedAffiliate:
        """Test SortedAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortedAffiliate`
        """
        model = SortedAffiliate()
        if include_optional:
            return SortedAffiliate(
                id = 'list-item-1',
                index = 0
            )
        else:
