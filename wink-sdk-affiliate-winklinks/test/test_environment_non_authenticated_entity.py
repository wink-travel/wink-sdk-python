...
class TestEnvironmentNonAuthenticatedEntity(unittest.TestCase):
    """EnvironmentNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentNonAuthenticatedEntity:
        """Test EnvironmentNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentNonAuthenticatedEntity`
        """
        model = EnvironmentNonAuthenticatedEntity()
        if include_optional:
            return EnvironmentNonAuthenticatedEntity(
                active_profiles = [
                    ''
                    ],
                default_profiles = [
    ...
    def testEnvironmentNonAuthenticatedEntity(self):
        """Test EnvironmentNonAuthenticatedEntity"""
