...
class TestSyndicatedItemAffiliate(unittest.TestCase):
    """SyndicatedItemAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyndicatedItemAffiliate:
        """Test SyndicatedItemAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyndicatedItemAffiliate`
        """
        model = SyndicatedItemAffiliate()
        if include_optional:
            return SyndicatedItemAffiliate(
                id = 'doc-1',
    ...
    def testSyndicatedItemAffiliate(self):
        """Test SyndicatedItemAffiliate"""
