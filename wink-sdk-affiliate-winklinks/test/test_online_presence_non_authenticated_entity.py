...
class TestOnlinePresenceNonAuthenticatedEntity(unittest.TestCase):
    """OnlinePresenceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnlinePresenceNonAuthenticatedEntity:
        """Test OnlinePresenceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnlinePresenceNonAuthenticatedEntity`
        """
        model = OnlinePresenceNonAuthenticatedEntity()
        if include_optional:
            return OnlinePresenceNonAuthenticatedEntity(
                type = 'WINK',
                identifier = '',
                audiences = [
                    'EVERYONE'
    ...
    def testOnlinePresenceNonAuthenticatedEntity(self):
        """Test OnlinePresenceNonAuthenticatedEntity"""
