...
class TestRedirectViewNonAuthenticatedEntityStatusCode(unittest.TestCase):
    """RedirectViewNonAuthenticatedEntityStatusCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RedirectViewNonAuthenticatedEntityStatusCode:
        """Test RedirectViewNonAuthenticatedEntityStatusCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RedirectViewNonAuthenticatedEntityStatusCode`
        """
        model = RedirectViewNonAuthenticatedEntityStatusCode()
        if include_optional:
            return RedirectViewNonAuthenticatedEntityStatusCode(
                error = True,
    ...
    def testRedirectViewNonAuthenticatedEntityStatusCode(self):
        """Test RedirectViewNonAuthenticatedEntityStatusCode"""
