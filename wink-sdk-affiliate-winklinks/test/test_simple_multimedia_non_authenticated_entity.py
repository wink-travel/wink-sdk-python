...
class TestSimpleMultimediaNonAuthenticatedEntity(unittest.TestCase):
    """SimpleMultimediaNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimediaNonAuthenticatedEntity:
        """Test SimpleMultimediaNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimediaNonAuthenticatedEntity`
        """
        model = SimpleMultimediaNonAuthenticatedEntity()
        if include_optional:
            return SimpleMultimediaNonAuthenticatedEntity(
                ...
                attribution = [
                    wink_sdk_affiliate_winklinks.models.image_attribution_non_authenticated_entity.ImageAttribution_Non_Authenticated_Entity(
    ...
    def testSimpleMultimediaNonAuthenticatedEntity(self):
        """Test SimpleMultimediaNonAuthenticatedEntity"""
