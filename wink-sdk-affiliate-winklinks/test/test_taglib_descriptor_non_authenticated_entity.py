...
class TestTaglibDescriptorNonAuthenticatedEntity(unittest.TestCase):
    """TaglibDescriptorNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaglibDescriptorNonAuthenticatedEntity:
        """Test TaglibDescriptorNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaglibDescriptorNonAuthenticatedEntity`
        """
        model = TaglibDescriptorNonAuthenticatedEntity()
        if include_optional:
            return TaglibDescriptorNonAuthenticatedEntity(
                taglib_location = '',
                taglib_uri = ''
            )
        else:
    ...
    def testTaglibDescriptorNonAuthenticatedEntity(self):
        """Test TaglibDescriptorNonAuthenticatedEntity"""
