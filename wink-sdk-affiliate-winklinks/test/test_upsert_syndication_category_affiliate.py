...
class TestUpsertSyndicationCategoryAffiliate(unittest.TestCase):
    """UpsertSyndicationCategoryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSyndicationCategoryAffiliate:
        """Test UpsertSyndicationCategoryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSyndicationCategoryAffiliate`
        """
        model = UpsertSyndicationCategoryAffiliate()
        if include_optional:
            return UpsertSyndicationCategoryAffiliate(
                name = 'Faves'
            )
        else:
            return UpsertSyndicationCategoryAffiliate(
    ...
    def testUpsertSyndicationCategoryAffiliate(self):
        """Test UpsertSyndicationCategoryAffiliate"""
