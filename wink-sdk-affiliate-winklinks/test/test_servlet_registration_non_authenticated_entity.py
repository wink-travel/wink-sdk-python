...
class TestServletRegistrationNonAuthenticatedEntity(unittest.TestCase):
    """ServletRegistrationNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServletRegistrationNonAuthenticatedEntity:
        """Test ServletRegistrationNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServletRegistrationNonAuthenticatedEntity`
        """
        model = ServletRegistrationNonAuthenticatedEntity()
        if include_optional:
            return ServletRegistrationNonAuthenticatedEntity(
                run_as_role = '',
                mappings = [
                    ''
                    ],
    ...
    def testServletRegistrationNonAuthenticatedEntity(self):
        """Test ServletRegistrationNonAuthenticatedEntity"""
