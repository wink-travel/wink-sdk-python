...
class TestUpsertSyndicationSettingsAffiliate(unittest.TestCase):
    """UpsertSyndicationSettingsAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSyndicationSettingsAffiliate:
        """Test UpsertSyndicationSettingsAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSyndicationSettingsAffiliate`
        """
        model = UpsertSyndicationSettingsAffiliate()
        if include_optional:
            return UpsertSyndicationSettingsAffiliate(
                intelligent = False,
                engine_configuration_identifier = '',
                initial_display_type = 'GRID_COLUMNS',
    ...
    def testUpsertSyndicationSettingsAffiliate(self):
        """Test UpsertSyndicationSettingsAffiliate"""
