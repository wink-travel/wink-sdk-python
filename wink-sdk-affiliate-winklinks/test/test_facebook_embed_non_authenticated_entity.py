...
class TestFacebookEmbedNonAuthenticatedEntity(unittest.TestCase):
    """FacebookEmbedNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacebookEmbedNonAuthenticatedEntity:
        """Test FacebookEmbedNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacebookEmbedNonAuthenticatedEntity`
        """
        model = FacebookEmbedNonAuthenticatedEntity()
        if include_optional:
    ...
    def testFacebookEmbedNonAuthenticatedEntity(self):
        """Test FacebookEmbedNonAuthenticatedEntity"""
