...
class TestUnlockSyndicatedItemNonAuthenticatedEntity(unittest.TestCase):
    """UnlockSyndicatedItemNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnlockSyndicatedItemNonAuthenticatedEntity:
        """Test UnlockSyndicatedItemNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnlockSyndicatedItemNonAuthenticatedEntity`
        """
        model = UnlockSyndicatedItemNonAuthenticatedEntity()
        if include_optional:
            return UnlockSyndicatedItemNonAuthenticatedEntity(
                code = 'Google'
            )
        else:
            return UnlockSyndicatedItemNonAuthenticatedEntity(
    ...
    def testUnlockSyndicatedItemNonAuthenticatedEntity(self):
        """Test UnlockSyndicatedItemNonAuthenticatedEntity"""
