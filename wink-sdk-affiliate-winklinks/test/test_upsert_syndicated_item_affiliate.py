...
class TestUpsertSyndicatedItemAffiliate(unittest.TestCase):
    """UpsertSyndicatedItemAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSyndicatedItemAffiliate:
        """Test UpsertSyndicatedItemAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSyndicatedItemAffiliate`
        """
        model = UpsertSyndicatedItemAffiliate()
        if include_optional:
            return UpsertSyndicatedItemAffiliate(
                ...
                descriptions = [
                    wink_sdk_affiliate_winklinks.models.simple_description_affiliate.SimpleDescription_Affiliate(
    ...
    def testUpsertSyndicatedItemAffiliate(self):
        """Test UpsertSyndicatedItemAffiliate"""
