...
class TestImageAttributionAffiliate(unittest.TestCase):
    """ImageAttributionAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageAttributionAffiliate:
        """Test ImageAttributionAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAttributionAffiliate`
        """
        model = ImageAttributionAffiliate()
        if include_optional:
            return ImageAttributionAffiliate(
    ...
    def testImageAttributionAffiliate(self):
        """Test ImageAttributionAffiliate"""
