...
class TestTikTokEmbedNonAuthenticatedEntity(unittest.TestCase):
    """TikTokEmbedNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TikTokEmbedNonAuthenticatedEntity:
        """Test TikTokEmbedNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TikTokEmbedNonAuthenticatedEntity`
        """
        model = TikTokEmbedNonAuthenticatedEntity()
        if include_optional:
            return TikTokEmbedNonAuthenticatedEntity(
                url = '',
                author_name = '',
                author_unique_id = '',
                author_url = '',
    ...
    def testTikTokEmbedNonAuthenticatedEntity(self):
        """Test TikTokEmbedNonAuthenticatedEntity"""
