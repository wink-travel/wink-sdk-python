...
class TestDefaultHttpStatusCodeNonAuthenticatedEntity(unittest.TestCase):
    """DefaultHttpStatusCodeNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultHttpStatusCodeNonAuthenticatedEntity:
        """Test DefaultHttpStatusCodeNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultHttpStatusCodeNonAuthenticatedEntity`
        """
        model = DefaultHttpStatusCodeNonAuthenticatedEntity()
        if include_optional:
            return DefaultHttpStatusCodeNonAuthenticatedEntity(
                error = True,
    ...
    def testDefaultHttpStatusCodeNonAuthenticatedEntity(self):
        """Test DefaultHttpStatusCodeNonAuthenticatedEntity"""
