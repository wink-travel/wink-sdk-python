...
class TestRedirectViewStatusCode(unittest.TestCase):
    """RedirectViewStatusCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RedirectViewStatusCode:
        """Test RedirectViewStatusCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RedirectViewStatusCode`
        """
        model = RedirectViewStatusCode()
        if include_optional:
            return RedirectViewStatusCode(
                error = True,
    ...
    def testRedirectViewStatusCode(self):
        """Test RedirectViewStatusCode"""
