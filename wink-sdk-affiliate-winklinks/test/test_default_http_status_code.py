...
class TestDefaultHttpStatusCode(unittest.TestCase):
    """DefaultHttpStatusCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultHttpStatusCode:
        """Test DefaultHttpStatusCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultHttpStatusCode`
        """
        model = DefaultHttpStatusCode()
        if include_optional:
    ...
    def testDefaultHttpStatusCode(self):
        """Test DefaultHttpStatusCode"""
