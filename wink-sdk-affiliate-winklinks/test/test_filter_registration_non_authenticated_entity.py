...
class TestFilterRegistrationNonAuthenticatedEntity(unittest.TestCase):
    """FilterRegistrationNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterRegistrationNonAuthenticatedEntity:
        """Test FilterRegistrationNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterRegistrationNonAuthenticatedEntity`
        """
        model = FilterRegistrationNonAuthenticatedEntity()
        if include_optional:
            return FilterRegistrationNonAuthenticatedEntity(
    ...
    def testFilterRegistrationNonAuthenticatedEntity(self):
        """Test FilterRegistrationNonAuthenticatedEntity"""
