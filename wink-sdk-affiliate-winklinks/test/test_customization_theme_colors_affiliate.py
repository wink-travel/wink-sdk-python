...
class TestCustomizationThemeColorsAffiliate(unittest.TestCase):
    """CustomizationThemeColorsAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationThemeColorsAffiliate:
        """Test CustomizationThemeColorsAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationThemeColorsAffiliate`
        """
        model = CustomizationThemeColorsAffiliate()
        if include_optional:
            return CustomizationThemeColorsAffiliate(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testCustomizationThemeColorsAffiliate(self):
        """Test CustomizationThemeColorsAffiliate"""
