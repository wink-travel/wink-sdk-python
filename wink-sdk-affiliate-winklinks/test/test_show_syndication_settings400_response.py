...
class TestShowSyndicationSettings400Response(unittest.TestCase):
    """ShowSyndicationSettings400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowSyndicationSettings400Response:
        """Test ShowSyndicationSettings400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowSyndicationSettings400Response`
        """
        model = ShowSyndicationSettings400Response()
        if include_optional:
            return ShowSyndicationSettings400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowSyndicationSettings400Response(self):
        """Test ShowSyndicationSettings400Response"""
