...
class TestSpotifyEmbedNonAuthenticatedEntity(unittest.TestCase):
    """SpotifyEmbedNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpotifyEmbedNonAuthenticatedEntity:
        """Test SpotifyEmbedNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpotifyEmbedNonAuthenticatedEntity`
        """
        model = SpotifyEmbedNonAuthenticatedEntity()
        if include_optional:
    ...
    def testSpotifyEmbedNonAuthenticatedEntity(self):
        """Test SpotifyEmbedNonAuthenticatedEntity"""
