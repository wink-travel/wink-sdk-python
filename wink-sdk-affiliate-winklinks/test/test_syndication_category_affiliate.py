...
class TestSyndicationCategoryAffiliate(unittest.TestCase):
    """SyndicationCategoryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyndicationCategoryAffiliate:
        """Test SyndicationCategoryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyndicationCategoryAffiliate`
        """
        model = SyndicationCategoryAffiliate()
        if include_optional:
    ...
    def testSyndicationCategoryAffiliate(self):
        """Test SyndicationCategoryAffiliate"""
