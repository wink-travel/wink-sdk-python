...
class TestBooleanResponseNonAuthenticatedEntity(unittest.TestCase):
    """BooleanResponseNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BooleanResponseNonAuthenticatedEntity:
        """Test BooleanResponseNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BooleanResponseNonAuthenticatedEntity`
        """
        model = BooleanResponseNonAuthenticatedEntity()
        if include_optional:
    ...
    def testBooleanResponseNonAuthenticatedEntity(self):
        """Test BooleanResponseNonAuthenticatedEntity"""
