...
class TestConsumeExternalUrlRequestAffiliate(unittest.TestCase):
    """ConsumeExternalUrlRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsumeExternalUrlRequestAffiliate:
        """Test ConsumeExternalUrlRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsumeExternalUrlRequestAffiliate`
        """
        model = ConsumeExternalUrlRequestAffiliate()
        if include_optional:
            return ConsumeExternalUrlRequestAffiliate(
    ...
    def testConsumeExternalUrlRequestAffiliate(self):
        """Test ConsumeExternalUrlRequestAffiliate"""
