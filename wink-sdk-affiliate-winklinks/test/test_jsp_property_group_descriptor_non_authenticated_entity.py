...
class TestJspPropertyGroupDescriptorNonAuthenticatedEntity(unittest.TestCase):
    """JspPropertyGroupDescriptorNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JspPropertyGroupDescriptorNonAuthenticatedEntity:
        """Test JspPropertyGroupDescriptorNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JspPropertyGroupDescriptorNonAuthenticatedEntity`
        """
        model = JspPropertyGroupDescriptorNonAuthenticatedEntity()
        if include_optional:
            return JspPropertyGroupDescriptorNonAuthenticatedEntity(
    ...
    def testJspPropertyGroupDescriptorNonAuthenticatedEntity(self):
        """Test JspPropertyGroupDescriptorNonAuthenticatedEntity"""
