...
class TestInstagramEmbedNonAuthenticatedEntity(unittest.TestCase):
    """InstagramEmbedNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstagramEmbedNonAuthenticatedEntity:
        """Test InstagramEmbedNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstagramEmbedNonAuthenticatedEntity`
        """
        model = InstagramEmbedNonAuthenticatedEntity()
        if include_optional:
    ...
    def testInstagramEmbedNonAuthenticatedEntity(self):
        """Test InstagramEmbedNonAuthenticatedEntity"""
