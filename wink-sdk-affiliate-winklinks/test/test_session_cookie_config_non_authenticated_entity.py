...
class TestSessionCookieConfigNonAuthenticatedEntity(unittest.TestCase):
    """SessionCookieConfigNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SessionCookieConfigNonAuthenticatedEntity:
        """Test SessionCookieConfigNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SessionCookieConfigNonAuthenticatedEntity`
        """
        model = SessionCookieConfigNonAuthenticatedEntity()
        if include_optional:
            return SessionCookieConfigNonAuthenticatedEntity(
                domain = '',
                path = '',
                name = '',
                attributes = {
    ...
    def testSessionCookieConfigNonAuthenticatedEntity(self):
        """Test SessionCookieConfigNonAuthenticatedEntity"""
