...
class TestRemoveEntryResponseAffiliate(unittest.TestCase):
    """RemoveEntryResponseAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveEntryResponseAffiliate:
        """Test RemoveEntryResponseAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveEntryResponseAffiliate`
        """
        model = RemoveEntryResponseAffiliate()
        if include_optional:
    ...
    def testRemoveEntryResponseAffiliate(self):
        """Test RemoveEntryResponseAffiliate"""
