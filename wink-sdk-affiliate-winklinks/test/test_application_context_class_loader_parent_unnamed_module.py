...
class TestApplicationContextClassLoaderParentUnnamedModule(unittest.TestCase):
    """ApplicationContextClassLoaderParentUnnamedModule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationContextClassLoaderParentUnnamedModule:
        """Test ApplicationContextClassLoaderParentUnnamedModule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationContextClassLoaderParentUnnamedModule`
        """
        model = ApplicationContextClassLoaderParentUnnamedModule()
        if include_optional:
            return ApplicationContextClassLoaderParentUnnamedModule(
                name = '',
    ...
    def testApplicationContextClassLoaderParentUnnamedModule(self):
        """Test ApplicationContextClassLoaderParentUnnamedModule"""
