...
class TestSyndicationSettingsAffiliate(unittest.TestCase):
    """SyndicationSettingsAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyndicationSettingsAffiliate:
        """Test SyndicationSettingsAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyndicationSettingsAffiliate`
        """
        model = SyndicationSettingsAffiliate()
        if include_optional:
    ...
    def testSyndicationSettingsAffiliate(self):
        """Test SyndicationSettingsAffiliate"""
