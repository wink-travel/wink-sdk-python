...
class ApplicationContextClassLoaderParent(BaseModel):
    """
    ...
    defined_packages: Optional[List[ApplicationContextClassLoaderParentDefinedPackagesInner]] = Field(default=None, alias="definedPackages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "definedPackages": [ApplicationContextClassLoaderParentDefinedPackagesInner.from_dict(_item) for _item in obj["definedPackages"]] if obj.get("definedPackages") is not None else None,
