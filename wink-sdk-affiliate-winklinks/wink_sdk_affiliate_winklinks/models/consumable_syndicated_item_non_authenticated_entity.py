...
class ConsumableSyndicatedItemNonAuthenticatedEntity(BaseModel):
    ...
    item_display: StrictStr = Field(description="Item indicator for how to display itself", alias="itemDisplay")
    ...
    parent_item_display: StrictStr = Field(description="Settings indicator for how to display the item", alias="parentItemDisplay")
    layout_display: Optional[StrictStr] = Field(default='LIST', description="Which way to display the list when WinkLinks first loads", alias="layoutDisplay")
    ...
    __properties: ClassVar[List[str]] = ["id", "ownerIdentifier", "createdDate", "title", "contentUrl", "sort", "type", "metadata", "descriptions", "tags", "multimedias", "itemDisplay", "lockCode", "uniqueId", "userTags", "hashTags", "parentItemDisplay", "layoutDisplay", "profilePictureGeometry", "configurationId", "clientId"]
    ...
    @field_validator('parent_item_display')
    def parent_item_display_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parentItemDisplay": obj.get("parentItemDisplay"),
            "layoutDisplay": obj.get("layoutDisplay") if obj.get("layoutDisplay") is not None else 'LIST',
