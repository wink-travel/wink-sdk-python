...
class ApplicationContextNonAuthenticatedEntity(BaseModel):
    """
    ...
    autowire_capable_bean_factory: Optional[Any] = Field(default=None, alias="autowireCapableBeanFactory")
    ...
    environment: Optional[EnvironmentNonAuthenticatedEntity] = None
    ...
    parent_bean_factory: Optional[Any] = Field(default=None, alias="parentBeanFactory")
    class_loader: Optional[ApplicationContextNonAuthenticatedEntityClassLoader] = Field(default=None, alias="classLoader")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if autowire_capable_bean_factory (nullable) is None
        # and model_fields_set contains the field
        if self.autowire_capable_bean_factory is None and "autowire_capable_bean_factory" in self.model_fields_set:
            _dict['autowireCapableBeanFactory'] = None

        # set to None if parent_bean_factory (nullable) is None
        # and model_fields_set contains the field
        if self.parent_bean_factory is None and "parent_bean_factory" in self.model_fields_set:
            _dict['parentBeanFactory'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "environment": EnvironmentNonAuthenticatedEntity.from_dict(obj["environment"]) if obj.get("environment") is not None else None,
            ...
            "classLoader": ApplicationContextNonAuthenticatedEntityClassLoader.from_dict(obj["classLoader"]) if obj.get("classLoader") is not None else None
        })
        return _obj
