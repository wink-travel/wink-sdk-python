...
class ApplicationContextNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    parent: Optional[ApplicationContextNonAuthenticatedEntity] = None
    ...
    __properties: ClassVar[List[str]] = ["parent", "id", "displayName", "autowireCapableBeanFactory", "startupDate", "applicationName", "environment", "beanDefinitionCount", "beanDefinitionNames", "parentBeanFactory", "classLoader"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parent": ApplicationContextNonAuthenticatedEntity.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "id": obj.get("id"),
...
ApplicationContextNonAuthenticatedEntity.model_rebuild(raise_errors=False)
