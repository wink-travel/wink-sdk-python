...
class HttpStatusCodeNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["error", "is2xxSuccessful", "is3xxRedirection", "is4xxClientError", "is5xxServerError", "is1xxInformational"]
