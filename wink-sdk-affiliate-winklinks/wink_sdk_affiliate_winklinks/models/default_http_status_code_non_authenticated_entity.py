...
class DefaultHttpStatusCodeNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["error", "is1xxInformational", "is2xxSuccessful", "is3xxRedirection", "is4xxClientError", "is5xxServerError"]
