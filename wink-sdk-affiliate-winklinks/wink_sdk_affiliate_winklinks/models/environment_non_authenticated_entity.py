...
class EnvironmentNonAuthenticatedEntity(BaseModel):
    """
    EnvironmentNonAuthenticatedEntity
    """ # noqa: E501
    active_profiles: Optional[List[StrictStr]] = Field(default=None, alias="activeProfiles")
    default_profiles: Optional[List[StrictStr]] = Field(default=None, alias="defaultProfiles")
    __properties: ClassVar[List[str]] = ["activeProfiles", "defaultProfiles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultProfiles": obj.get("defaultProfiles")
        })
        return _obj
