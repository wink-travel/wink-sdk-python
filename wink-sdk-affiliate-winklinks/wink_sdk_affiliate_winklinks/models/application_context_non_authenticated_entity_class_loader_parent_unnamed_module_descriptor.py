...
class ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleDescriptor(BaseModel):
    """
    ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleDescriptor
    """ # noqa: E501
    open: Optional[StrictBool] = None
    automatic: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["open", "automatic"]
