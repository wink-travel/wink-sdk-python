...
class ServletContextNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["classLoader", "majorVersion", "minorVersion", "sessionCookieConfig", "attributeNames", "contextPath", "initParameterNames", "sessionTrackingModes", "sessionTimeout", "servletRegistrations", "filterRegistrations", "effectiveSessionTrackingModes", "jspConfigDescriptor", "virtualServerName", "requestCharacterEncoding", "responseCharacterEncoding", "defaultSessionTrackingModes", "effectiveMajorVersion", "effectiveMinorVersion", "serverInfo", "servletContextName"]
