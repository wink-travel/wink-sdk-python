...
class ServletContextNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["classLoader", "majorVersion", "minorVersion", "defaultSessionTrackingModes", "effectiveMajorVersion", "effectiveMinorVersion", "serverInfo", "servletContextName", "servletRegistrations", "filterRegistrations", "effectiveSessionTrackingModes", "jspConfigDescriptor", "virtualServerName", "sessionTimeout", "requestCharacterEncoding", "responseCharacterEncoding", "attributeNames", "contextPath", "initParameterNames", "sessionTrackingModes", "sessionCookieConfig"]
