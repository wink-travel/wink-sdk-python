...
class ServletContextNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    class_loader: Optional[ApplicationContextNonAuthenticatedEntityClassLoaderParent] = Field(default=None, alias="classLoader")
    ...
    __properties: ClassVar[List[str]] = ["classLoader", "majorVersion", "minorVersion", "effectiveMajorVersion", "effectiveMinorVersion", "serverInfo", "servletContextName", "servletRegistrations", "filterRegistrations", "effectiveSessionTrackingModes", "requestCharacterEncoding", "attributeNames", "contextPath", "initParameterNames", "sessionTrackingModes", "sessionCookieConfig", "defaultSessionTrackingModes", "jspConfigDescriptor", "virtualServerName", "sessionTimeout", "responseCharacterEncoding"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "classLoader": ApplicationContextNonAuthenticatedEntityClassLoaderParent.from_dict(obj["classLoader"]) if obj.get("classLoader") is not None else None,
