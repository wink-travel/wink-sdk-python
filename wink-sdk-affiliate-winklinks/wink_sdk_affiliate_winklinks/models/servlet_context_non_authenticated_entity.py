...
class ServletContextNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["classLoader", "majorVersion", "minorVersion", "attributeNames", "contextPath", "initParameterNames", "sessionTrackingModes", "sessionTimeout", "defaultSessionTrackingModes", "effectiveMajorVersion", "effectiveMinorVersion", "serverInfo", "servletContextName", "servletRegistrations", "filterRegistrations", "effectiveSessionTrackingModes", "jspConfigDescriptor", "virtualServerName", "requestCharacterEncoding", "responseCharacterEncoding", "sessionCookieConfig"]
