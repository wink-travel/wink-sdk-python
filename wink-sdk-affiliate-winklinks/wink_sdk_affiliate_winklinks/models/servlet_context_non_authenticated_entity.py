...
class ServletContextNonAuthenticatedEntity(BaseModel):
    """
    ServletContextNonAuthenticatedEntity
    """ # noqa: E501
    class_loader: Optional[ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleClassLoader] = Field(default=None, alias="classLoader")
    ...
    session_cookie_config: Optional[SessionCookieConfigNonAuthenticatedEntity] = Field(default=None, alias="sessionCookieConfig")
    ...
    servlet_registrations: Optional[Dict[str, ServletRegistrationNonAuthenticatedEntity]] = Field(default=None, alias="servletRegistrations")
    filter_registrations: Optional[Dict[str, FilterRegistrationNonAuthenticatedEntity]] = Field(default=None, alias="filterRegistrations")
    effective_session_tracking_modes: Optional[List[StrictStr]] = Field(default=None, alias="effectiveSessionTrackingModes")
    jsp_config_descriptor: Optional[JspConfigDescriptorNonAuthenticatedEntity] = Field(default=None, alias="jspConfigDescriptor")
    ...
    __properties: ClassVar[List[str]] = ["classLoader", "majorVersion", "minorVersion", "attributeNames", "contextPath", "initParameterNames", "sessionTrackingModes", "sessionCookieConfig", "sessionTimeout", "defaultSessionTrackingModes", "effectiveMajorVersion", "effectiveMinorVersion", "serverInfo", "servletContextName", "servletRegistrations", "filterRegistrations", "effectiveSessionTrackingModes", "jspConfigDescriptor", "virtualServerName", "requestCharacterEncoding", "responseCharacterEncoding"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "classLoader": ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleClassLoader.from_dict(obj["classLoader"]) if obj.get("classLoader") is not None else None,
            ...
            "sessionCookieConfig": SessionCookieConfigNonAuthenticatedEntity.from_dict(obj["sessionCookieConfig"]) if obj.get("sessionCookieConfig") is not None else None,
            ...
            "servletRegistrations": dict(
                (_k, ServletRegistrationNonAuthenticatedEntity.from_dict(_v))
                for _k, _v in obj["servletRegistrations"].items()
            )
            if obj.get("servletRegistrations") is not None
            else None,
            "filterRegistrations": dict(
                (_k, FilterRegistrationNonAuthenticatedEntity.from_dict(_v))
            ...
            "jspConfigDescriptor": JspConfigDescriptorNonAuthenticatedEntity.from_dict(obj["jspConfigDescriptor"]) if obj.get("jspConfigDescriptor") is not None else None,
