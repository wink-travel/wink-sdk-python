...
class TwitterEmbedNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["url", "author_name", "author_url", "html", "width", "height", "type", "cache_age", "provider_name", "provider_url", "version", "valid"]
