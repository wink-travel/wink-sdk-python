...
class ApplicationContextNonAuthenticatedEntityClassLoaderParentDefinedPackagesInner(BaseModel):
    """
    ApplicationContextNonAuthenticatedEntityClassLoaderParentDefinedPackagesInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "sealed", "annotations", "declaredAnnotations", "specificationTitle", "specificationVersion", "specificationVendor", "implementationTitle", "implementationVersion", "implementationVendor"]
