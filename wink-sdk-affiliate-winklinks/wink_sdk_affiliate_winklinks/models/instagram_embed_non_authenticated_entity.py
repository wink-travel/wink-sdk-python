...
class InstagramEmbedNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["author_name", "html", "width", "thumbnail_url", "thumbnail_width", "thumbnail_height", "type", "provider_name", "provider_url", "version", "valid"]
