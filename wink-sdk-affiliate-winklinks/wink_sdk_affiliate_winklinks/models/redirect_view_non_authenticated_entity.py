...
class RedirectViewNonAuthenticatedEntity(BaseModel):
    ...
    static_attributes: Optional[Dict[str, Any]] = Field(default=None, alias="staticAttributes")
    ...
    status_code: Optional[RedirectViewNonAuthenticatedEntityStatusCode] = Field(default=None, alias="statusCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statusCode": RedirectViewNonAuthenticatedEntityStatusCode.from_dict(obj["statusCode"]) if obj.get("statusCode") is not None else None,
