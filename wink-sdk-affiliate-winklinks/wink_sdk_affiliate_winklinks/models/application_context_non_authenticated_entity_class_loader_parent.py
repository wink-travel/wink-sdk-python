...
class ApplicationContextNonAuthenticatedEntityClassLoaderParent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "registeredAsParallelCapable", "unnamedModule", "definedPackages", "defaultAssertionStatus"]
