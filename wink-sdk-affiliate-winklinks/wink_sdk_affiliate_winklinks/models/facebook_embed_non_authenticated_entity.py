...
class FacebookEmbedNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["author_name", "author_url", "html", "width", "height", "type", "provider_name", "provider_url", "version", "valid"]
