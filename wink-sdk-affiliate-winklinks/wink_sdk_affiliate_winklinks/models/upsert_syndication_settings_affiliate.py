...
class UpsertSyndicationSettingsAffiliate(BaseModel):
    """
    UpsertSyndicationSettingsAffiliate
    """ # noqa: E501
    item_display: StrictStr = Field(description="Whether to treat all links as flat web links or try to embed more advanced data.", alias="itemDisplay")
    customization_identifier: UUID = Field(description="Customization identifier", alias="customizationIdentifier")
    layout_display: Optional[StrictStr] = Field(default='GRID_COLUMNS', description="Which way to display the list when WinkLinks first loads", alias="layoutDisplay")
    ...
    __properties: ClassVar[List[str]] = ["itemDisplay", "customizationIdentifier", "layoutDisplay", "profilePictureGeometry", "onlinePresencePosition", "qrCodeOptions", "themeColors"]
