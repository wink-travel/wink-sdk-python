...
class TikTokEmbedNonAuthenticatedEntity(BaseModel):
    """
    TikTokEmbedNonAuthenticatedEntity
    """ # noqa: E501
    url: Optional[StrictStr] = None
    author_name: Optional[StrictStr] = None
    author_unique_id: Optional[StrictStr] = None
    author_url: Optional[StrictStr] = None
    embed_product_id: Optional[StrictStr] = None
    embed_type: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["url", "author_name", "author_unique_id", "author_url", "embed_product_id", "embed_type", "html", "width", "height", "thumbnail_url", "thumbnail_width", "thumbnail_height", "type", "provider_name", "provider_url", "title", "version", "valid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "author_unique_id": obj.get("author_unique_id"),
            "author_url": obj.get("author_url"),
            "embed_product_id": obj.get("embed_product_id"),
            "embed_type": obj.get("embed_type"),
            "html": obj.get("html"),
            "width": obj.get("width"),
