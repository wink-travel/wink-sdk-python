...
class ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModule(BaseModel):
    """
    ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModule
    """ # noqa: E501
    ...
    descriptor: Optional[ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleDescriptor] = None
    ...
    native_access_enabled: Optional[StrictBool] = Field(default=None, alias="nativeAccessEnabled")
    layer: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["name", "classLoader", "descriptor", "named", "annotations", "declaredAnnotations", "packages", "nativeAccessEnabled", "layer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "descriptor": ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleDescriptor.from_dict(obj["descriptor"]) if obj.get("descriptor") is not None else None,
            "named": obj.get("named"),
            "annotations": obj.get("annotations"),
            "declaredAnnotations": obj.get("declaredAnnotations"),
            "packages": obj.get("packages"),
            "nativeAccessEnabled": obj.get("nativeAccessEnabled"),
            "layer": obj.get("layer")
        })
        return _obj
