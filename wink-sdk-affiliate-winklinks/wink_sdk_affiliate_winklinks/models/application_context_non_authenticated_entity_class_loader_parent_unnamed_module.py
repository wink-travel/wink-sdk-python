...
class ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModule(BaseModel):
    ...
    declared_annotations: Optional[List[Any]] = Field(default=None, alias="declaredAnnotations")
    ...
    __properties: ClassVar[List[str]] = ["name", "descriptor", "named", "annotations", "declaredAnnotations", "packages", "nativeAccessEnabled", "layer"]
