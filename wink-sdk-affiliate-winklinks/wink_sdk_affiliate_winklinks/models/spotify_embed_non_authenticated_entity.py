...
class SpotifyEmbedNonAuthenticatedEntity(BaseModel):
    """
    SpotifyEmbedNonAuthenticatedEntity
    """ # noqa: E501
    thumbnail_url: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["thumbnail_url", "thumbnail_height", "thumbnail_width", "html", "width", "height", "type", "title", "provider_name", "provider_url", "version", "valid"]
