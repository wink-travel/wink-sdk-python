...
class JspConfigDescriptorNonAuthenticatedEntity(BaseModel):
    """
    JspConfigDescriptorNonAuthenticatedEntity
    """ # noqa: E501
    jsp_property_groups: Optional[List[JspPropertyGroupDescriptorNonAuthenticatedEntity]] = Field(default=None, alias="jspPropertyGroups")
    taglibs: Optional[List[TaglibDescriptorNonAuthenticatedEntity]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jspPropertyGroups": [JspPropertyGroupDescriptorNonAuthenticatedEntity.from_dict(_item) for _item in obj["jspPropertyGroups"]] if obj.get("jspPropertyGroups") is not None else None,
            "taglibs": [TaglibDescriptorNonAuthenticatedEntity.from_dict(_item) for _item in obj["taglibs"]] if obj.get("taglibs") is not None else None
        })
        return _obj
