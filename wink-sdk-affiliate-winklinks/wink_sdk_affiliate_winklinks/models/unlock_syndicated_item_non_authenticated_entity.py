...
class UnlockSyndicatedItemNonAuthenticatedEntity(BaseModel):
    """
    UnlockSyndicatedItemNonAuthenticatedEntity
    """ # noqa: E501
    code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The site name of this entry")
