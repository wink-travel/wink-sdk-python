...
class SyndicationAccountNonAuthenticatedEntity(BaseModel):
    """
    A publishable company object
    """ # noqa: E501
    identifier: StrictStr = Field(description="The company ID")
    url_name: StrictStr = Field(description="The company url name", alias="urlName")
    name: StrictStr = Field(description="The company name")
    description: StrictStr = Field(description="The company description")
    member_since: date = Field(description="When the company account was created", alias="memberSince")
    logo: Optional[SimpleMultimediaNonAuthenticatedEntity] = None
    online_presence: Optional[List[OnlinePresenceNonAuthenticatedEntity]] = Field(default=None, alias="onlinePresence")
    __properties: ClassVar[List[str]] = ["identifier", "urlName", "name", "description", "memberSince", "logo", "onlinePresence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logo": SimpleMultimediaNonAuthenticatedEntity.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
            "onlinePresence": [OnlinePresenceNonAuthenticatedEntity.from_dict(_item) for _item in obj["onlinePresence"]] if obj.get("onlinePresence") is not None else None
        })
        return _obj
