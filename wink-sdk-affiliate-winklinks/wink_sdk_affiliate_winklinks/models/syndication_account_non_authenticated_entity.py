...
class SyndicationAccountNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The company ID")
    url_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The company url name", alias="urlName")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The company name")
    description: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The company description")
    member_since: date = Field(description="When the company account was created", alias="memberSince")
    logo: Optional[SimpleMultimediaNonAuthenticatedEntity] = Field(default=None, description="The company ID")
