...
class ApplicationContextNonAuthenticatedEntityClassLoader(BaseModel):
    """
    ...
    parent: Optional[ApplicationContextNonAuthenticatedEntityClassLoaderParent] = None
    unnamed_module: Optional[ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModule] = Field(default=None, alias="unnamedModule")
    defined_packages: Optional[List[ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleClassLoaderDefinedPackagesInner]] = Field(default=None, alias="definedPackages")
    default_assertion_status: Optional[StrictBool] = Field(default=None, alias="defaultAssertionStatus")
    __properties: ClassVar[List[str]] = ["name", "registeredAsParallelCapable", "parent", "unnamedModule", "definedPackages", "defaultAssertionStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": ApplicationContextNonAuthenticatedEntityClassLoaderParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "unnamedModule": ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModule.from_dict(obj["unnamedModule"]) if obj.get("unnamedModule") is not None else None,
            "definedPackages": [ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleClassLoaderDefinedPackagesInner.from_dict(_item) for _item in obj["definedPackages"]] if obj.get("definedPackages") is not None else None,
