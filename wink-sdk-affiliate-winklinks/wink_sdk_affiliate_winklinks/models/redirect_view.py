...
class RedirectView(BaseModel):
    ...
    status_code: Optional[RedirectViewStatusCode] = Field(default=None, alias="statusCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statusCode": RedirectViewStatusCode.from_dict(obj["statusCode"]) if obj.get("statusCode") is not None else None,
