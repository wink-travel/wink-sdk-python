...
class ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleClassLoader(BaseModel):
    """
    ApplicationContextNonAuthenticatedEntityClassLoaderParentUnnamedModuleClassLoader
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "registeredAsParallelCapable", "definedPackages", "defaultAssertionStatus"]
