...
class SortedAffiliate(BaseModel):
    """
    Sorted object strictly to use for sorting of list items
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="List item ID")
    index: StrictInt = Field(description="List item position")
    __properties: ClassVar[List[str]] = ["id", "index"]
