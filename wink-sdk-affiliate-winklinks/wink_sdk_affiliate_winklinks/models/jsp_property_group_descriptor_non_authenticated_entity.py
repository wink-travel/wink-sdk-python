...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["isXml", "includePreludes", "includeCodas", "errorOnELNotFound", "pageEncoding", "scriptingInvalid", "elIgnored", "buffer", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "defaultContentType", "urlPatterns", "deferredSyntaxAllowedAsLiteral"]
