...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["defaultContentType", "pageEncoding", "deferredSyntaxAllowedAsLiteral", "scriptingInvalid", "includePreludes", "includeCodas", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "buffer", "isXml", "urlPatterns", "elIgnored", "errorOnELNotFound"]
