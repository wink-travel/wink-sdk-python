...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["includeCodas", "deferredSyntaxAllowedAsLiteral", "isXml", "defaultContentType", "includePreludes", "pageEncoding", "errorOnELNotFound", "elIgnored", "errorOnUndeclaredNamespace", "trimDirectiveWhitespaces", "scriptingInvalid", "buffer", "urlPatterns"]
