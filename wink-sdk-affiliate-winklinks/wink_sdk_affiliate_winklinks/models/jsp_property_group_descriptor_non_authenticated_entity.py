...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deferredSyntaxAllowedAsLiteral", "errorOnELNotFound", "pageEncoding", "scriptingInvalid", "isXml", "includePreludes", "includeCodas", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "elIgnored", "buffer", "defaultContentType", "urlPatterns"]
