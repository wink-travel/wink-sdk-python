...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["errorOnELNotFound", "pageEncoding", "scriptingInvalid", "isXml", "includePreludes", "includeCodas", "errorOnUndeclaredNamespace", "elIgnored", "trimDirectiveWhitespaces", "deferredSyntaxAllowedAsLiteral", "buffer", "defaultContentType", "urlPatterns"]
