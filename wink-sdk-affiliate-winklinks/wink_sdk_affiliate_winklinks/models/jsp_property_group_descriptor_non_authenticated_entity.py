...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deferredSyntaxAllowedAsLiteral", "pageEncoding", "scriptingInvalid", "isXml", "includePreludes", "includeCodas", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "elIgnored", "errorOnELNotFound", "buffer", "defaultContentType", "urlPatterns"]
