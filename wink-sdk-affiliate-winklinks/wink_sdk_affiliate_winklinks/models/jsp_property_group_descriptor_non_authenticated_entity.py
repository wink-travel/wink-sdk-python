...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deferredSyntaxAllowedAsLiteral", "isXml", "buffer", "defaultContentType", "urlPatterns", "errorOnELNotFound", "pageEncoding", "scriptingInvalid", "includePreludes", "includeCodas", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "elIgnored"]
