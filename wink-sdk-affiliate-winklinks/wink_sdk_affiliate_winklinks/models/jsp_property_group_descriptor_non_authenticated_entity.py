...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["defaultContentType", "elIgnored", "errorOnELNotFound", "pageEncoding", "scriptingInvalid", "isXml", "includePreludes", "includeCodas", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "deferredSyntaxAllowedAsLiteral", "buffer", "urlPatterns"]
