...
class JspPropertyGroupDescriptorNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["scriptingInvalid", "includePreludes", "includeCodas", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "pageEncoding", "deferredSyntaxAllowedAsLiteral", "buffer", "elIgnored", "errorOnELNotFound", "defaultContentType", "urlPatterns", "isXml"]
