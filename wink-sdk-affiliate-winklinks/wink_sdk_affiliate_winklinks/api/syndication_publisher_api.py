...
class SyndicationPublisherApi:
    ...
    def show_syndication_entry_list(
        self,
        status: Annotated[Optional[StrictStr], Field(description="Return based on this status.")] = None,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        :param status: Return based on this status.
        :type status: str
        :param wink_version:
        :type wink_version: str
        :param accept:
    ...
    def show_syndication_settings(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSyndicationSettings400Response",
            '200': "SyndicationSettingsWithThemeColorsAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_syndication_settings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SyndicationSettingsWithThemeColorsAffiliate]:
        """Show WinkLinks Settings
    ...
    def _sort_syndication_entry_list_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if sorted_affiliate is not None:
            _body_params = sorted_affiliate
    ...
    def _upsert_syndication_settings_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if upsert_syndication_settings_affiliate is not None:
            _body_params = upsert_syndication_settings_affiliate
