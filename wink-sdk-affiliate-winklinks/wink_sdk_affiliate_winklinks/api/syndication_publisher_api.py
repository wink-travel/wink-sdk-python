...
class SyndicationPublisherApi:
    ...
    def _consume_external_url_for_syndication_entry_serialize(
        ...
        if consume_external_url_request_affiliate is not None:
            _body_params = consume_external_url_request_affiliate
    ...
    def show_syndication_settings(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSyndicationSettings400Response",
            '200': "SyndicationSettingsAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_syndication_settings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SyndicationSettingsAffiliate]:
        """Show WinkLinks Settings
