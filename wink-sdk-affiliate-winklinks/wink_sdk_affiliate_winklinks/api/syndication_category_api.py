...
class SyndicationCategoryApi:
    ...
    def create_syndication_category(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '201': "SyndicationCategoryAffiliate",
        }
    ...
    def create_syndication_category_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SyndicationCategoryAffiliate]:
        """Create WinkLinks Category
    ...
    def _create_syndication_category_serialize(
        ...
        if upsert_syndication_category_affiliate is not None:
            _body_params = upsert_syndication_category_affiliate
    ...
    def remove_syndication_category(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSyndicationSettings400Response",
            '200': "SyndicationCategoryAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_syndication_category_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSyndicationSettings400Response",
            '200': "List[SyndicationCategoryAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_syndication_category_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SyndicationCategoryAffiliate]]:
        """Show WinkLinks Categories
