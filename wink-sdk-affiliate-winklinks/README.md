...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.44#egg=wink_sdk_affiliate_winklinks&subdirectory=wink-sdk-affiliate-winklinks
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.44#egg=wink_sdk_affiliate_winklinks&subdirectory=wink_sdk_affiliate_winklinks`)
