...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.28#egg=wink_sdk_affiliate_winklinks&subdirectory=wink-sdk-affiliate-winklinks
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.28#egg=wink_sdk_affiliate_winklinks&subdirectory=wink_sdk_affiliate_winklinks`)
...
*SyndicationConsumerApi* | [**redirect_url**](docs/SyndicationConsumerApi.md#redirect_url) | **GET** /api/sell/{companyIdentifier}/syndication/{syndicatedItemIdentifier}/redirect | Redirect WinkLinks link
...
*SyndicationConsumerApi* | [**track_share**](docs/SyndicationConsumerApi.md#track_share) | **GET** /api/sell/{companyIdentifier}/syndication/{syndicatedItemIdentifier}/share | Track WinkLinks share
...
## Documentation For Models
 ...
 - [ApplicationContextNonAuthenticatedEntityClassLoaderParentDefinedPackagesInner](docs/ApplicationContextNonAuthenticatedEntityClassLoaderParentDefinedPackagesInner.md)
 ...
 - [DefaultHttpStatusCodeNonAuthenticatedEntity](docs/DefaultHttpStatusCodeNonAuthenticatedEntity.md)
 ...
 - [JspPropertyGroupDescriptorNonAuthenticatedEntity](docs/JspPropertyGroupDescriptorNonAuthenticatedEntity.md)
 ...
 - [RedirectViewNonAuthenticatedEntityStatusCode](docs/RedirectViewNonAuthenticatedEntityStatusCode.md)
