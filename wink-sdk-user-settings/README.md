...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.23#egg=wink_sdk_user_settings&subdirectory=wink-sdk-user-settings
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.23#egg=wink_sdk_user_settings&subdirectory=wink_sdk_user_settings`)
