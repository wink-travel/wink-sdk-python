...
class UserSettingsApi:
    ...
    def _change_password_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/user-settings/change-password',
    ...
    def show_profile(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowProfile400Response",
            '200': "ProfileViewNonAuthenticatedEntity",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_profile_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProfileViewNonAuthenticatedEntity]:
        """Show Profile
    ...
    def show_user_profile(
        ...
        _param = self._show_user_profile_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_user_profile_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpsertUserProfileResponse]:
        """Show User Profile
    ...
    @validate_call
    def show_user_profile_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_user_profile_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/user-settings/profile',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_profile(
        self,
        upsert_profile_request_non_authenticated_entity: UpsertProfileRequestNonAuthenticatedEntity,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param upsert_profile_request_non_authenticated_entity: (required)
        :type upsert_profile_request_non_authenticated_entity: UpsertProfileRequestNonAuthenticatedEntity
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._update_profile_serialize(
            upsert_profile_request_non_authenticated_entity=upsert_profile_request_non_authenticated_entity,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _update_profile_serialize(
        self,
        upsert_profile_request_non_authenticated_entity,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if upsert_profile_request_non_authenticated_entity is not None:
            _body_params = upsert_profile_request_non_authenticated_entity
    ...
    def update_user_profile(
        self,
        upsert_user_profile_request: UpsertUserProfileRequest,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param upsert_user_profile_request: (required)
        :type upsert_user_profile_request: UpsertUserProfileRequest
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._update_user_profile_serialize(
            upsert_user_profile_request=upsert_user_profile_request,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _update_user_profile_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if upsert_user_profile_request is not None:
            _body_params = upsert_user_profile_request
