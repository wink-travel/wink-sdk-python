...
class SalesChannelLightweightAuthenticatedEntity(BaseModel):
    """
    ...
    rate_modifiers: Optional[List[SpecialRateLightweightAuthenticatedEntity]] = Field(default=None, description="Promotions for this channel", alias="rateModifiers")
    rate_modifier_bundles: Optional[List[SpecialRateBundleLightweightAuthenticatedEntity]] = Field(default=None, description="Promotion bundles for this channel", alias="rateModifierBundles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateModifiers": [SpecialRateLightweightAuthenticatedEntity.from_dict(_item) for _item in obj["rateModifiers"]] if obj.get("rateModifiers") is not None else None,
            "rateModifierBundles": [SpecialRateBundleLightweightAuthenticatedEntity.from_dict(_item) for _item in obj["rateModifierBundles"]] if obj.get("rateModifierBundles") is not None else None,
