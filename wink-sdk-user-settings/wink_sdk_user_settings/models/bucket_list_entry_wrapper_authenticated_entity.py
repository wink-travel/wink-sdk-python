...
class BucketListEntryWrapperAuthenticatedEntity(BaseModel):
    """
    BucketListEntryWrapperAuthenticatedEntity
    """ # noqa: E501
    entry: BucketListEntryAuthenticatedEntity
    inventory: InventoryAuthenticatedEntity
    __properties: ClassVar[List[str]] = ["entry", "inventory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entry": BucketListEntryAuthenticatedEntity.from_dict(obj["entry"]) if obj.get("entry") is not None else None,
            "inventory": InventoryAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None
        })
        return _obj
