...
class RateModifierBundleAuthenticatedEntity(BaseModel):
    """
    ...
    items: List[RateModifierAuthenticatedEntity]
    modifier_override: Optional[Dict[str, Any]] = Field(default=None, alias="modifierOverride")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [RateModifierAuthenticatedEntity.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
