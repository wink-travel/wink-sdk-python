...
class InventoryAddressAuthenticatedEntity(BaseModel):
    """
    Address information
    """ # noqa: E501
    ...
    city_geo_name_id: Optional[StrictStr] = Field(default=None, description="Unique city ID", alias="cityGeoNameId")
    city_url_name: Optional[StrictStr] = Field(default=None, description="Url name", alias="cityUrlName")
    city: Optional[StrictStr] = Field(default=None, description="Ascii name of city")
    ...
    country_geo_name_id: Optional[StrictStr] = Field(default=None, description="Country geo name ID", alias="countryGeoNameId")
    continent: Optional[StrictStr] = Field(default=None, description="continent")
    __properties: ClassVar[List[str]] = ["address1", "address2", "state", "postalCode", "county", "cityGeoNameId", "cityUrlName", "city", "country", "countryCode", "countryGeoNameId", "continent"]
