...
class SalesChannelAuthenticatedEntity(BaseModel):
    """
    ...
    rate_modifiers: Optional[List[RateModifierAuthenticatedEntity]] = Field(default=None, description="Promotions for this channel", alias="rateModifiers")
    rate_modifier_bundles: Optional[List[RateModifierBundleAuthenticatedEntity]] = Field(default=None, description="Promotion bundles for this channel", alias="rateModifierBundles")
    __properties: ClassVar[List[str]] = ["identifier", "supplierIdentifier", "supplierName", "supplierAvailable", "subType", "ownerIdentifier", "ownerName", "enabled", "channelDisabled", "blacklisted", "percentDiscount", "commission", "rateModifiers", "rateModifierBundles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateModifiers": [RateModifierAuthenticatedEntity.from_dict(_item) for _item in obj["rateModifiers"]] if obj.get("rateModifiers") is not None else None,
            "rateModifierBundles": [RateModifierBundleAuthenticatedEntity.from_dict(_item) for _item in obj["rateModifierBundles"]] if obj.get("rateModifierBundles") is not None else None
        })
        return _obj
