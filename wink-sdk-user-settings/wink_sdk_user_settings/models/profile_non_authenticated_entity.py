...
class ProfileNonAuthenticatedEntity(BaseModel):
    """
    ...
    user: ProfileUserNonAuthenticatedEntity = Field(description="User details")
    personal: PersonalNonAuthenticatedEntity = Field(description="Detailed customer information for this profile")
    preferences: PreferencesNonAuthenticatedEntity = Field(description="Customer preferences")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "share", "user", "personal", "preferences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "share": obj.get("share"),
            "user": ProfileUserNonAuthenticatedEntity.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "personal": PersonalNonAuthenticatedEntity.from_dict(obj["personal"]) if obj.get("personal") is not None else None,
            "preferences": PreferencesNonAuthenticatedEntity.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None
        })
        return _obj
