...
class UpsertUserProfileResponse(BaseModel):
    """
    User profile information
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="User ID")
    ...
    username: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique user email")
    profile_picture: Optional[SimpleMultimedia] = Field(default=None, description="Profile picture url that originates from a federated authentication system", alias="profilePicture")
    profile_picture_url: Optional[StrictStr] = Field(default=None, description="A fully qualified URL based on the Cloudinary identifier", alias="profilePictureUrl")
    __properties: ClassVar[List[str]] = ["identifier", "firstName", "lastName", "username", "profilePicture", "profilePictureUrl"]
