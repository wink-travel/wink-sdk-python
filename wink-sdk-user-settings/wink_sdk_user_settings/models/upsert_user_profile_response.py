...
class UpsertUserProfileResponse(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="User ID")
    ...
    username: StrictStr = Field(description="Unique user email")
    profile_picture: Optional[SimpleMultimedia] = Field(default=None, alias="profilePicture")
