...
class ProfileViewNonAuthenticatedEntity(BaseModel):
    """
    ...
    profile: ProfileNonAuthenticatedEntity
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "profile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": ProfileNonAuthenticatedEntity.from_dict(obj["profile"]) if obj.get("profile") is not None else None
        })
        return _obj
