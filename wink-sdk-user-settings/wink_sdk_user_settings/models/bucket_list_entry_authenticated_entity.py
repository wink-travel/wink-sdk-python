...
class BucketListEntryAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    bucket_list_identifier: StrictStr = Field(alias="bucketListIdentifier")
    user_identifier: StrictStr = Field(alias="userIdentifier")
    type: StrictStr
    identifier: StrictStr
    channel_inventory_identifier: StrictStr = Field(alias="channelInventoryIdentifier")
    inventory_name: StrictStr = Field(alias="inventoryName")
    engine_identifier: StrictStr = Field(alias="engineIdentifier")
    engine_configuration_identifier: StrictStr = Field(alias="engineConfigurationIdentifier")
