...
class InventoryAuthenticatedEntity(BaseModel):
    ...
    image: SimpleMultimediaAuthenticatedEntity = Field(description="Main image of inventory")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "salesChannel", "inventoryType", "inventoryIdentifier", "inventoryName", "inventoryNameInEnglish", "enabled", "image", "pricePoint", "location", "address", "quantity", "commissionable", "bookable", "lowestPrice", "lowestDisplayPrice"]
