...
class InventoryAuthenticatedEntity(BaseModel):
    """
    ...
    sales_channel: SalesChannelLightweightAuthenticatedEntity = Field(description="Parent sales channel", alias="salesChannel")
    ...
    location: GeoJsonPointAuthenticatedEntity = Field(description="Location")
    address: InventoryAddressAuthenticatedEntity = Field(description="Defaults to property address.")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "salesChannel", "inventoryType", "inventoryIdentifier", "inventoryName", "inventoryNameInEnglish", "enabled", "imageIdentifier", "pricePoint", "location", "address", "quantity", "commissionable", "bookable", "lowestPrice", "lowestDisplayPrice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salesChannel": SalesChannelLightweightAuthenticatedEntity.from_dict(obj["salesChannel"]) if obj.get("salesChannel") is not None else None,
            ...
            "address": InventoryAddressAuthenticatedEntity.from_dict(obj["address"]) if obj.get("address") is not None else None,
