...
class InventoryAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="Inventory identifier")
    sales_channel: SalesChannelAuthenticatedEntity = Field(alias="salesChannel")
    inventory_type: StrictStr = Field(description="Inventory type", alias="inventoryType")
    inventory_identifier: StrictStr = Field(description="Inventory type identifier", alias="inventoryIdentifier")
    inventory_name: StrictStr = Field(description="Name of blocking as hotel is seeing it", alias="inventoryName")
    inventory_name_in_english: StrictStr = Field(description="Name of blocking as traveler is seeing it", alias="inventoryNameInEnglish")
    enabled: StrictBool = Field(description="Whether this blocking is enabled or not")
    image_identifier: StrictStr = Field(description="Main image of blocking", alias="imageIdentifier")
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    location: GeoJsonPointAuthenticatedEntity
    address: AddressAuthenticatedEntity
    ...
    lowest_price: Optional[CustomMonetaryAmount] = Field(default=None, alias="lowestPrice")
    lowest_display_price: Optional[CustomMonetaryAmount] = Field(default=None, alias="lowestDisplayPrice")
    hotel: HotelOnMapAuthenticatedEntity
    __properties: ClassVar[List[str]] = ["identifier", "salesChannel", "inventoryType", "inventoryIdentifier", "inventoryName", "inventoryNameInEnglish", "enabled", "imageIdentifier", "pricePoint", "location", "address", "quantity", "commissionable", "bookable", "lowestPrice", "lowestDisplayPrice", "hotel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salesChannel": SalesChannelAuthenticatedEntity.from_dict(obj["salesChannel"]) if obj.get("salesChannel") is not None else None,
            ...
            "hotel": HotelOnMapAuthenticatedEntity.from_dict(obj["hotel"]) if obj.get("hotel") is not None else None
        })
        return _obj
