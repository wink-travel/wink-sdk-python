...
class UpsertUserProfileRequest(BaseModel):
    ...
    profile_picture: Optional[SimpleMultimedia] = Field(default=None, description="Profile picture that originates from a Cloudinary upload", alias="profilePicture")
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "username", "profilePicture"]
