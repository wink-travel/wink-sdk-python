...
class GeoNameAuthenticatedEntity(BaseModel):
    """
    ...
    country: Optional[CountryAuthenticatedEntity] = None
    sub_country: Optional[SubCountryAuthenticatedEntity] = Field(default=None, alias="subCountry")
    sub_sub_country: Optional[SubSubCountryAuthenticatedEntity] = Field(default=None, alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountryAuthenticatedEntity.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountryAuthenticatedEntity.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountryAuthenticatedEntity.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
