...
class SpecialRateBundleLightweightAuthenticatedEntity(BaseModel):
    """
    ...
    description: Optional[List[LocalizedDescriptionAuthenticatedEntity]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "description": [LocalizedDescriptionAuthenticatedEntity.from_dict(_item) for _item in obj["description"]] if obj.get("description") is not None else None,
