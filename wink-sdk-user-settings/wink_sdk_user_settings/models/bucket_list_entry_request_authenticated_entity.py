...
class BucketListEntryRequestAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "identifier", "channelInventoryIdentifier", "inventoryName", "engineConfigurationIdentifier"]
