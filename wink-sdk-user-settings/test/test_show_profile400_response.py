...
class TestShowProfile400Response(unittest.TestCase):
    """ShowProfile400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowProfile400Response:
        """Test ShowProfile400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowProfile400Response`
        """
        model = ShowProfile400Response()
        if include_optional:
            return ShowProfile400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowProfile400Response(self):
        """Test ShowProfile400Response"""
