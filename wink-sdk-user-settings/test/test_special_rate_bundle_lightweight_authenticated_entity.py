...
class TestSpecialRateBundleLightweightAuthenticatedEntity(unittest.TestCase):
    """SpecialRateBundleLightweightAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialRateBundleLightweightAuthenticatedEntity:
        """Test SpecialRateBundleLightweightAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialRateBundleLightweightAuthenticatedEntity`
        """
        model = SpecialRateBundleLightweightAuthenticatedEntity()
        if include_optional:
            return SpecialRateBundleLightweightAuthenticatedEntity(
    ...
    def testSpecialRateBundleLightweightAuthenticatedEntity(self):
        """Test SpecialRateBundleLightweightAuthenticatedEntity"""
