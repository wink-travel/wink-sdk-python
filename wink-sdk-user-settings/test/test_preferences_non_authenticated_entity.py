...
class TestPreferencesNonAuthenticatedEntity(unittest.TestCase):
    """PreferencesNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreferencesNonAuthenticatedEntity:
        """Test PreferencesNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreferencesNonAuthenticatedEntity`
        """
        model = PreferencesNonAuthenticatedEntity()
        if include_optional:
            return PreferencesNonAuthenticatedEntity(
    ...
    def testPreferencesNonAuthenticatedEntity(self):
        """Test PreferencesNonAuthenticatedEntity"""
