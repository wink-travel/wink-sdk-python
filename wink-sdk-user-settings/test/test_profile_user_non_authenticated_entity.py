...
class TestProfileUserNonAuthenticatedEntity(unittest.TestCase):
    """ProfileUserNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileUserNonAuthenticatedEntity:
        """Test ProfileUserNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileUserNonAuthenticatedEntity`
        """
        model = ProfileUserNonAuthenticatedEntity()
        if include_optional:
            return ProfileUserNonAuthenticatedEntity(
                first_name = 'Avid',
                last_name = 'Travelman',
    ...
    def testProfileUserNonAuthenticatedEntity(self):
        """Test ProfileUserNonAuthenticatedEntity"""
