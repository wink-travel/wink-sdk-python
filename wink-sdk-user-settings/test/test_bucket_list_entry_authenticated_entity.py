...
class TestBucketListEntryAuthenticatedEntity(unittest.TestCase):
    """BucketListEntryAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketListEntryAuthenticatedEntity:
        """Test BucketListEntryAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketListEntryAuthenticatedEntity`
        """
        model = BucketListEntryAuthenticatedEntity()
        if include_optional:
    ...
    def testBucketListEntryAuthenticatedEntity(self):
        """Test BucketListEntryAuthenticatedEntity"""
