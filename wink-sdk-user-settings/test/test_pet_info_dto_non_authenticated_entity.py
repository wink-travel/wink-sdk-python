...
class TestPetInfoDtoNonAuthenticatedEntity(unittest.TestCase):
    """PetInfoDtoNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoDtoNonAuthenticatedEntity:
        """Test PetInfoDtoNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoDtoNonAuthenticatedEntity`
        """
        model = PetInfoDtoNonAuthenticatedEntity()
        if include_optional:
            return PetInfoDtoNonAuthenticatedEntity(
                name = '',
                type = ''
            )
        else:
    ...
    def testPetInfoDtoNonAuthenticatedEntity(self):
        """Test PetInfoDtoNonAuthenticatedEntity"""
