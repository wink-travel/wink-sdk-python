...
class TestImageAttributionAuthenticatedEntity(unittest.TestCase):
    """ImageAttributionAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageAttributionAuthenticatedEntity:
        """Test ImageAttributionAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAttributionAuthenticatedEntity`
        """
        model = ImageAttributionAuthenticatedEntity()
        if include_optional:
            return ImageAttributionAuthenticatedEntity(
    ...
    def testImageAttributionAuthenticatedEntity(self):
        """Test ImageAttributionAuthenticatedEntity"""
