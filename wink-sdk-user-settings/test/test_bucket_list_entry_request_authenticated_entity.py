...
class TestBucketListEntryRequestAuthenticatedEntity(unittest.TestCase):
    """BucketListEntryRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketListEntryRequestAuthenticatedEntity:
        """Test BucketListEntryRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketListEntryRequestAuthenticatedEntity`
        """
        model = BucketListEntryRequestAuthenticatedEntity()
        if include_optional:
            return BucketListEntryRequestAuthenticatedEntity(
                type = 'hotel',
                identifier = '',
    ...
    def testBucketListEntryRequestAuthenticatedEntity(self):
        """Test BucketListEntryRequestAuthenticatedEntity"""
