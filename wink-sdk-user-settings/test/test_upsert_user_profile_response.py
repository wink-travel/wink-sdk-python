...
class TestUpsertUserProfileResponse(unittest.TestCase):
    """UpsertUserProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertUserProfileResponse:
        """Test UpsertUserProfileResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertUserProfileResponse`
        """
        model = UpsertUserProfileResponse()
        if include_optional:
            return UpsertUserProfileResponse(
                ...
                profile_picture = wink_sdk_user_settings.models.simple_multimedia.SimpleMultimedia(
                    ...
                    category = '1', 
                    descriptions = [
                        wink_sdk_user_settings.models.simple_description.SimpleDescription(
                    ...
                    attribution = [
                        wink_sdk_user_settings.models.image_attribution.ImageAttribution(
                            url = 'https://maps.google.com/maps/contrib/111628493169070103594', 
                            name = 'Samuel Adams', )
                        ], 
                    is_landscape = True, ),
                profile_picture_url = 'https://res.cloudinary.com/traveliko/image/upload/c_scale,h_512,q_auto:best,w_512/k8nvegwqn0ih3xqioykn.jpg'
            )
        else:
            return UpsertUserProfileResponse(
                identifier = 'user-1',
    ...
    def testUpsertUserProfileResponse(self):
        """Test UpsertUserProfileResponse"""
