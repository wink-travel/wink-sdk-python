...
class TestPropertyPolicyAuthenticatedEntity(unittest.TestCase):
    """PropertyPolicyAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyPolicyAuthenticatedEntity:
        """Test PropertyPolicyAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyPolicyAuthenticatedEntity`
        """
        model = PropertyPolicyAuthenticatedEntity()
        if include_optional:
            return PropertyPolicyAuthenticatedEntity(
    ...
    def testPropertyPolicyAuthenticatedEntity(self):
        """Test PropertyPolicyAuthenticatedEntity"""
