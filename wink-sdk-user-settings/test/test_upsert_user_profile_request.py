...
class TestUpsertUserProfileRequest(unittest.TestCase):
    """UpsertUserProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertUserProfileRequest:
        """Test UpsertUserProfileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertUserProfileRequest`
        """
        model = UpsertUserProfileRequest()
        if include_optional:
    ...
    def testUpsertUserProfileRequest(self):
        """Test UpsertUserProfileRequest"""
