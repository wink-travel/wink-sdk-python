    ...
    def make_instance(self, include_optional) -> SimpleMultimediaAuthenticatedEntity:
        ...
        if include_optional:
            return SimpleMultimediaAuthenticatedEntity(
                ...
                category = '1',
                descriptions = [
                    wink_sdk_user_settings.models.simple_description_authenticated_entity.SimpleDescription_Authenticated_Entity(
                ...
                attribution = [
                    wink_sdk_user_settings.models.image_attribution_authenticated_entity.ImageAttribution_Authenticated_Entity(
