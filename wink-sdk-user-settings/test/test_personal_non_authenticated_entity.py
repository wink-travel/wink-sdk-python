...
class TestPersonalNonAuthenticatedEntity(unittest.TestCase):
    """PersonalNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalNonAuthenticatedEntity:
        """Test PersonalNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalNonAuthenticatedEntity`
        """
        model = PersonalNonAuthenticatedEntity()
        if include_optional:
            return PersonalNonAuthenticatedEntity(
                gender = 'MALE',
    ...
    def testPersonalNonAuthenticatedEntity(self):
        """Test PersonalNonAuthenticatedEntity"""
