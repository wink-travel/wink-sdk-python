...
class TestHotelOnMapAuthenticatedEntity(unittest.TestCase):
    """HotelOnMapAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelOnMapAuthenticatedEntity:
        """Test HotelOnMapAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelOnMapAuthenticatedEntity`
        """
        model = HotelOnMapAuthenticatedEntity()
        if include_optional:
            return HotelOnMapAuthenticatedEntity(
    ...
    def testHotelOnMapAuthenticatedEntity(self):
        """Test HotelOnMapAuthenticatedEntity"""
