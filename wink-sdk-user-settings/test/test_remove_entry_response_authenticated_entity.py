...
class TestRemoveEntryResponseAuthenticatedEntity(unittest.TestCase):
    """RemoveEntryResponseAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveEntryResponseAuthenticatedEntity:
        """Test RemoveEntryResponseAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveEntryResponseAuthenticatedEntity`
        """
        model = RemoveEntryResponseAuthenticatedEntity()
        if include_optional:
    ...
    def testRemoveEntryResponseAuthenticatedEntity(self):
        """Test RemoveEntryResponseAuthenticatedEntity"""
