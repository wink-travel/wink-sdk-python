...
class TestInventoryAddressAuthenticatedEntity(unittest.TestCase):
    """InventoryAddressAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryAddressAuthenticatedEntity:
        """Test InventoryAddressAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryAddressAuthenticatedEntity`
        """
        model = InventoryAddressAuthenticatedEntity()
        if include_optional:
            return InventoryAddressAuthenticatedEntity(
                address1 = '234',
    ...
    def testInventoryAddressAuthenticatedEntity(self):
        """Test InventoryAddressAuthenticatedEntity"""
