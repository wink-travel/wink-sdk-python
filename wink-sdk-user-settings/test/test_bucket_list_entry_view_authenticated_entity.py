...
class TestBucketListEntryViewAuthenticatedEntity(unittest.TestCase):
    """BucketListEntryViewAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketListEntryViewAuthenticatedEntity:
        """Test BucketListEntryViewAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketListEntryViewAuthenticatedEntity`
        """
        model = BucketListEntryViewAuthenticatedEntity()
        if include_optional:
            return BucketListEntryViewAuthenticatedEntity(
                ...
                version = 12,
                data = wink_sdk_user_settings.models.bucket_list_entry_authenticated_entity.BucketListEntry_Authenticated_Entity(
    ...
    def testBucketListEntryViewAuthenticatedEntity(self):
        """Test BucketListEntryViewAuthenticatedEntity"""
