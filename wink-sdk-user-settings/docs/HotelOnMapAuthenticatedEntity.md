...
**short_descriptions** | [**List[LocalizedDescriptionAuthenticatedEntity]**](LocalizedDescriptionAuthenticatedEntity.md) | A localized list of short property descriptions | [optional] 
**long_descriptions** | [**List[LocalizedDescriptionAuthenticatedEntity]**](LocalizedDescriptionAuthenticatedEntity.md) | A localized list of longer property descriptions | [optional] 
...
**reservations** | [**ContactAuthenticatedEntity**](ContactAuthenticatedEntity.md) |  | [optional] 
...
**policy** | [**PropertyPolicyAuthenticatedEntity**](PropertyPolicyAuthenticatedEntity.md) |  | [optional] 
...
**address** | [**AddressAuthenticatedEntity**](AddressAuthenticatedEntity.md) |  | [optional] 
...
hotel_on_map_authenticated_entity_instance = HotelOnMapAuthenticatedEntity.from_json(json)
# print the JSON string representation of the object
print(HotelOnMapAuthenticatedEntity.to_json())

# convert the object into a dict
hotel_on_map_authenticated_entity_dict = hotel_on_map_authenticated_entity_instance.to_dict()
# create an instance of HotelOnMapAuthenticatedEntity from a dict
hotel_on_map_authenticated_entity_from_dict = HotelOnMapAuthenticatedEntity.from_dict(hotel_on_map_authenticated_entity_dict)
```
