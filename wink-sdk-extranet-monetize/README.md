...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.52#egg=wink_sdk_extranet_monetize&subdirectory=wink-sdk-extranet-monetize
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.52#egg=wink_sdk_extranet_monetize&subdirectory=wink_sdk_extranet_monetize`)
