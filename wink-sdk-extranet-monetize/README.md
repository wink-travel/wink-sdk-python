...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.24#egg=wink_sdk_extranet_monetize&subdirectory=wink-sdk-extranet-monetize
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.24#egg=wink_sdk_extranet_monetize&subdirectory=wink_sdk_extranet_monetize`)
...
## Documentation For Models
 ...
 - [CancellationPolicyViewSupplier](docs/CancellationPolicyViewSupplier.md)
 ...
 - [MasterRateViewSupplier](docs/MasterRateViewSupplier.md)
 ...
 - [RateModifierBundleViewSupplier](docs/RateModifierBundleViewSupplier.md)
 - [RateModifierSupplier](docs/RateModifierSupplier.md)
 - [RateModifierViewSupplier](docs/RateModifierViewSupplier.md)
 ...
 - [RatePlanViewSupplier](docs/RatePlanViewSupplier.md)
 ...
 - [UpgradeView](docs/UpgradeView.md)
 ...
 - [UpsertRateModifierBundleRequestSupplier](docs/UpsertRateModifierBundleRequestSupplier.md)
