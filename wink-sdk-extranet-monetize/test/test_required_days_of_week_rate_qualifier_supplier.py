...
class TestRequiredDaysOfWeekRateQualifierSupplier(unittest.TestCase):
    """RequiredDaysOfWeekRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequiredDaysOfWeekRateQualifierSupplier:
        """Test RequiredDaysOfWeekRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequiredDaysOfWeekRateQualifierSupplier`
        """
        model = RequiredDaysOfWeekRateQualifierSupplier()
        if include_optional:
            return RequiredDaysOfWeekRateQualifierSupplier(
    ...
    def testRequiredDaysOfWeekRateQualifierSupplier(self):
        """Test RequiredDaysOfWeekRateQualifierSupplier"""
