...
class TestSpecialRateBundleSupplier(unittest.TestCase):
    """SpecialRateBundleSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialRateBundleSupplier:
        """Test SpecialRateBundleSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialRateBundleSupplier`
        """
        model = SpecialRateBundleSupplier()
        if include_optional:
            return SpecialRateBundleSupplier(
                id = 'doc-1',
    ...
    def testSpecialRateBundleSupplier(self):
        """Test SpecialRateBundleSupplier"""
