...
class TestCancellationPolicyExceptions(unittest.TestCase):
    """CancellationPolicyExceptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptions:
        """Test CancellationPolicyExceptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptions`
        """
        model = CancellationPolicyExceptions()
        if include_optional:
    ...
    def testCancellationPolicyExceptions(self):
        """Test CancellationPolicyExceptions"""
