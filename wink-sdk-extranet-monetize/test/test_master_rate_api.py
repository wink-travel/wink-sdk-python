...
class TestMasterRateApi(unittest.TestCase):
    """MasterRateApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MasterRateApi()

    def tearDown(self) -> None:
        pass

    def test_set_perks(self) -> None:
        """Test case for set_perks

        Set Master Rate Perks
        """
        pass

    def test_show_master_rate(self) -> None:
        """Test case for show_master_rate
    ...
    def test_toggle_master_rate(self) -> None:
        """Test case for toggle_master_rate
