...
class TestCancellationPolicyException(unittest.TestCase):
    """CancellationPolicyException unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyException:
        """Test CancellationPolicyException
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyException`
        """
        model = CancellationPolicyException()
        if include_optional:
            return CancellationPolicyException(
    ...
    def testCancellationPolicyException(self):
        """Test CancellationPolicyException"""
