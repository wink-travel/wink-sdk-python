...
class TestBedroomConfigurationSupplier(unittest.TestCase):
    """BedroomConfigurationSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomConfigurationSupplier:
        """Test BedroomConfigurationSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomConfigurationSupplier`
        """
        model = BedroomConfigurationSupplier()
        if include_optional:
            return BedroomConfigurationSupplier(
                identifier = '',
                name = '',
                bedroom_list = [
    ...
    def testBedroomConfigurationSupplier(self):
        """Test BedroomConfigurationSupplier"""
