...
class TestIdentifierNamePairSupplier(unittest.TestCase):
    """IdentifierNamePairSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentifierNamePairSupplier:
        """Test IdentifierNamePairSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentifierNamePairSupplier`
        """
        model = IdentifierNamePairSupplier()
        if include_optional:
            return IdentifierNamePairSupplier(
                identifier = 'record-1',
                name = 'Record One'
            )
        else:
    ...
    def testIdentifierNamePairSupplier(self):
        """Test IdentifierNamePairSupplier"""
