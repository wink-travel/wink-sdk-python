...
class TestRatePlanApi(unittest.TestCase):
    """RatePlanApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RatePlanApi()

    def tearDown(self) -> None:
        pass

    def test_create_rate_plan(self) -> None:
    ...
    def test_remove_rate_plan(self) -> None:
        """Test case for remove_rate_plan

        Delete Rate Plan
        """
        pass

    def test_show_rate_plan(self) -> None:
        """Test case for show_rate_plan

        Show Rate Plan
        """
        pass

    def test_show_rate_plans(self) -> None:
        """Test case for show_rate_plans

        Show Rate Plans
        """
        pass

    def test_update_rate_plan(self) -> None:
