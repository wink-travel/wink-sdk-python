...
class TestBlackoutDateSupplier(unittest.TestCase):
    """BlackoutDateSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlackoutDateSupplier:
        """Test BlackoutDateSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlackoutDateSupplier`
        """
        model = BlackoutDateSupplier()
        if include_optional:
            return BlackoutDateSupplier(
    ...
    def testBlackoutDateSupplier(self):
        """Test BlackoutDateSupplier"""
