...
class TestRatePlanSupplier(unittest.TestCase):
    """RatePlanSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanSupplier:
        """Test RatePlanSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanSupplier`
        """
        model = RatePlanSupplier()
        if include_optional:
            return RatePlanSupplier(
                identifier = '',
                hotel_identifier = '',
                name = 'BAR 1',
                prepaid = False,
