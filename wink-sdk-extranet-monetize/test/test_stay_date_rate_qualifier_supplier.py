...
class TestStayDateRateQualifierSupplier(unittest.TestCase):
    """StayDateRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StayDateRateQualifierSupplier:
        """Test StayDateRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StayDateRateQualifierSupplier`
        """
        model = StayDateRateQualifierSupplier()
        if include_optional:
            return StayDateRateQualifierSupplier(
    ...
    def testStayDateRateQualifierSupplier(self):
        """Test StayDateRateQualifierSupplier"""
