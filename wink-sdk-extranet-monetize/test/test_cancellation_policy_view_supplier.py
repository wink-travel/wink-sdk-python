...
class TestCancellationPolicyViewSupplier(unittest.TestCase):
    """CancellationPolicyViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyViewSupplier:
        """Test CancellationPolicyViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyViewSupplier`
        """
        model = CancellationPolicyViewSupplier()
        if include_optional:
    ...
    def testCancellationPolicyViewSupplier(self):
        """Test CancellationPolicyViewSupplier"""
