...
class TestSpecialRateLightweightSupplier(unittest.TestCase):
    """SpecialRateLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialRateLightweightSupplier:
        """Test SpecialRateLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialRateLightweightSupplier`
        """
        model = SpecialRateLightweightSupplier()
        if include_optional:
            return SpecialRateLightweightSupplier(
                ...
                arrival_days_of_week_rate_qualifier = wink_sdk_extranet_monetize.models.arrival_days_of_week_rate_qualifier_supplier.ArrivalDaysOfWeekRateQualifier_Supplier(
                    days_of_week = null, ),
                departure_days_of_week_rate_qualifier = wink_sdk_extranet_monetize.models.available_days_of_week_rate_qualifier_supplier.AvailableDaysOfWeekRateQualifier_Supplier(
                    days_of_week = null, ),
    ...
    def testSpecialRateLightweightSupplier(self):
        """Test SpecialRateLightweightSupplier"""
