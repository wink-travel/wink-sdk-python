...
class TestSellDateRateQualifierSupplier(unittest.TestCase):
    """SellDateRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellDateRateQualifierSupplier:
        """Test SellDateRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellDateRateQualifierSupplier`
        """
        model = SellDateRateQualifierSupplier()
        if include_optional:
            return SellDateRateQualifierSupplier(
    ...
    def testSellDateRateQualifierSupplier(self):
        """Test SellDateRateQualifierSupplier"""
