...
class TestBedroomSupplier(unittest.TestCase):
    """BedroomSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomSupplier:
        """Test BedroomSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomSupplier`
        """
        model = BedroomSupplier()
        if include_optional:
            return BedroomSupplier(
                type = 'MASTER',
                bed_list = [
