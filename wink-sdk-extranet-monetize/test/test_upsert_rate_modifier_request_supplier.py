...
class TestUpsertRateModifierRequestSupplier(unittest.TestCase):
    """UpsertRateModifierRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertRateModifierRequestSupplier:
        """Test UpsertRateModifierRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertRateModifierRequestSupplier`
        """
        model = UpsertRateModifierRequestSupplier()
        if include_optional:
            return UpsertRateModifierRequestSupplier(
                name = 'Early bird',
                type = 'DISCOUNT',
    ...
    def testUpsertRateModifierRequestSupplier(self):
        """Test UpsertRateModifierRequestSupplier"""
