...
class TestLocalizedDescription(unittest.TestCase):
    """LocalizedDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedDescription:
        """Test LocalizedDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedDescription`
        """
    ...
    def testLocalizedDescription(self):
        """Test LocalizedDescription"""
