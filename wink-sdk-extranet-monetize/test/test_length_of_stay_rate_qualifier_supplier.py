...
class TestLengthOfStayRateQualifierSupplier(unittest.TestCase):
    """LengthOfStayRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LengthOfStayRateQualifierSupplier:
        """Test LengthOfStayRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LengthOfStayRateQualifierSupplier`
        """
        model = LengthOfStayRateQualifierSupplier()
        if include_optional:
            return LengthOfStayRateQualifierSupplier(
                min_los = 0,
                max_los = 0
            )
        else:
    ...
    def testLengthOfStayRateQualifierSupplier(self):
        """Test LengthOfStayRateQualifierSupplier"""
