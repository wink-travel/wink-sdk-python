...
class TestTransactionalTravelInventorySupplier(unittest.TestCase):
    """TransactionalTravelInventorySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionalTravelInventorySupplier:
        """Test TransactionalTravelInventorySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionalTravelInventorySupplier`
        """
        model = TransactionalTravelInventorySupplier()
        if include_optional:
            return TransactionalTravelInventorySupplier(
                identifier = '',
                name = '1 hour session',
                descriptions = [
    ...
    def testTransactionalTravelInventorySupplier(self):
        """Test TransactionalTravelInventorySupplier"""
