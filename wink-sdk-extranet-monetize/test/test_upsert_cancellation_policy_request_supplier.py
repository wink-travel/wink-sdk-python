...
class TestUpsertCancellationPolicyRequestSupplier(unittest.TestCase):
    """UpsertCancellationPolicyRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertCancellationPolicyRequestSupplier:
        """Test UpsertCancellationPolicyRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertCancellationPolicyRequestSupplier`
        """
        model = UpsertCancellationPolicyRequestSupplier()
        if include_optional:
            return UpsertCancellationPolicyRequestSupplier(
                refundable = False,
    ...
    def testUpsertCancellationPolicyRequestSupplier(self):
        """Test UpsertCancellationPolicyRequestSupplier"""
