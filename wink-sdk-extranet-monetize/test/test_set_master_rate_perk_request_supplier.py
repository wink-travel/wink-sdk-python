...
class TestSetMasterRatePerkRequestSupplier(unittest.TestCase):
    """SetMasterRatePerkRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetMasterRatePerkRequestSupplier:
        """Test SetMasterRatePerkRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetMasterRatePerkRequestSupplier`
        """
        model = SetMasterRatePerkRequestSupplier()
        if include_optional:
            return SetMasterRatePerkRequestSupplier(
                perk_types = [
                    'PERK_LOYALTY_POINTS'
                    ]
            )
    ...
    def testSetMasterRatePerkRequestSupplier(self):
        """Test SetMasterRatePerkRequestSupplier"""
