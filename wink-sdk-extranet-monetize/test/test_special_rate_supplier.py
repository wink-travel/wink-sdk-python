...
class TestSpecialRateSupplier(unittest.TestCase):
    """SpecialRateSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialRateSupplier:
        """Test SpecialRateSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialRateSupplier`
        """
        model = SpecialRateSupplier()
        if include_optional:
            return SpecialRateSupplier(
                id = 'doc-1',
    ...
    def testSpecialRateSupplier(self):
        """Test SpecialRateSupplier"""
