...
class TestPromotionRateQualifierSupplier(unittest.TestCase):
    """PromotionRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionRateQualifierSupplier:
        """Test PromotionRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionRateQualifierSupplier`
        """
        model = PromotionRateQualifierSupplier()
        if include_optional:
            return PromotionRateQualifierSupplier(
                promotion = 'NA'
            )
        else:
            return PromotionRateQualifierSupplier(
    ...
    def testPromotionRateQualifierSupplier(self):
        """Test PromotionRateQualifierSupplier"""
