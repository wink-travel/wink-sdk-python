...
class TestInventoryUsageSupplier(unittest.TestCase):
    """InventoryUsageSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryUsageSupplier:
        """Test InventoryUsageSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryUsageSupplier`
        """
        model = InventoryUsageSupplier()
        if include_optional:
            return InventoryUsageSupplier(
                ...
                type = 'GUEST_ROOM',
                item_list = [
                    wink_sdk_extranet_monetize.models.inventory_usage_item_supplier.InventoryUsageItem_Supplier(
                        usage = 'RATE_MODIFIER', 
                        count = 56, )
                    ],
                referenced = True
    ...
    def testInventoryUsageSupplier(self):
        """Test InventoryUsageSupplier"""
