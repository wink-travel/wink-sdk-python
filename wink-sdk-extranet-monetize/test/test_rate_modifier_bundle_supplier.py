...
class TestRateModifierBundleSupplier(unittest.TestCase):
    """RateModifierBundleSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateModifierBundleSupplier:
        """Test RateModifierBundleSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateModifierBundleSupplier`
        """
        model = RateModifierBundleSupplier()
        if include_optional:
            return RateModifierBundleSupplier(
                identifier = '',
                hotel_identifier = '',
    ...
    def testRateModifierBundleSupplier(self):
        """Test RateModifierBundleSupplier"""
