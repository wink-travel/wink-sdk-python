...
class TestPrepayRateQualifierSupplier(unittest.TestCase):
    """PrepayRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrepayRateQualifierSupplier:
        """Test PrepayRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrepayRateQualifierSupplier`
        """
        model = PrepayRateQualifierSupplier()
        if include_optional:
            return PrepayRateQualifierSupplier(
                prepay = True
            )
        else:
            return PrepayRateQualifierSupplier(
    ...
    def testPrepayRateQualifierSupplier(self):
        """Test PrepayRateQualifierSupplier"""
