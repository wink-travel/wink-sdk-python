...
class TestUpsertCancellationPolicyExceptionSupplier(unittest.TestCase):
    """UpsertCancellationPolicyExceptionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertCancellationPolicyExceptionSupplier:
        """Test UpsertCancellationPolicyExceptionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertCancellationPolicyExceptionSupplier`
        """
        model = UpsertCancellationPolicyExceptionSupplier()
        if include_optional:
            return UpsertCancellationPolicyExceptionSupplier(
    ...
    def testUpsertCancellationPolicyExceptionSupplier(self):
        """Test UpsertCancellationPolicyExceptionSupplier"""
