...
class TestTransactionalTravelInventory(unittest.TestCase):
    """TransactionalTravelInventory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionalTravelInventory:
        """Test TransactionalTravelInventory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionalTravelInventory`
        """
        model = TransactionalTravelInventory()
        if include_optional:
            return TransactionalTravelInventory(
                identifier = '',
                name = '1 hour session',
                descriptions = [
    ...
    def testTransactionalTravelInventory(self):
        """Test TransactionalTravelInventory"""
