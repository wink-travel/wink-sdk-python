...
class TestMasterRateSupplier(unittest.TestCase):
    """MasterRateSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MasterRateSupplier:
        """Test MasterRateSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MasterRateSupplier`
        """
        model = MasterRateSupplier()
        if include_optional:
            return MasterRateSupplier(
                identifier = '',
                hotel_identifier = '',
    ...
    def testMasterRateSupplier(self):
        """Test MasterRateSupplier"""
