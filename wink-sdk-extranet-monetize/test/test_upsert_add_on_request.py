...
class TestUpsertAddOnRequest(unittest.TestCase):
    """UpsertAddOnRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertAddOnRequest:
        """Test UpsertAddOnRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertAddOnRequest`
        """
        model = UpsertAddOnRequest()
        if include_optional:
            return UpsertAddOnRequest(
                featured_ind = False,
                ...
                address = wink_sdk_extranet_monetize.models.upsert_address_request.UpsertAddressRequest(
    ...
    def testUpsertAddOnRequest(self):
        """Test UpsertAddOnRequest"""
