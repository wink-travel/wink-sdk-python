...
class TestPerkLightweightSupplier(unittest.TestCase):
    """PerkLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerkLightweightSupplier:
        """Test PerkLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerkLightweightSupplier`
        """
        model = PerkLightweightSupplier()
        if include_optional:
            return PerkLightweightSupplier(
                identifier = '',
                guaranteed = True,
                level = 56,
                descriptions = [
    ...
    def testPerkLightweightSupplier(self):
        """Test PerkLightweightSupplier"""
