...
class TestSubSubCountrySupplier(unittest.TestCase):
    """SubSubCountrySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountrySupplier:
        """Test SubSubCountrySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountrySupplier`
        """
        model = SubSubCountrySupplier()
        if include_optional:
            return SubSubCountrySupplier(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountrySupplier(self):
        """Test SubSubCountrySupplier"""
