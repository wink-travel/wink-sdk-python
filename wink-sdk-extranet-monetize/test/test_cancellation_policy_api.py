...
class TestCancellationPolicyApi(unittest.TestCase):
    """CancellationPolicyApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CancellationPolicyApi()

    def tearDown(self) -> None:
        pass

    def test_create_cancellation_policy(self) -> None:
        """Test case for create_cancellation_policy

        Create Cancellation Policy
        """
        pass

    def test_is_cancellation_policy_removable(self) -> None:
        """Test case for is_cancellation_policy_removable

        Verify Removable
        """
        pass

    def test_remove_cancellation_policy(self) -> None:
        """Test case for remove_cancellation_policy

        Delete Cancellation Policy
        """
        pass

    def test_show_cancellation_policy(self) -> None:
        """Test case for show_cancellation_policy

        Show Cancellation Policy
        """
        pass

    def test_show_cancellation_policy_list(self) -> None:
        """Test case for show_cancellation_policy_list

        Show Cancellation Policies
        """
        pass

    def test_update_cancellation_policy(self) -> None:
        """Test case for update_cancellation_policy
