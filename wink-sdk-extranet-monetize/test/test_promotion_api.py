...
class TestPromotionApi(unittest.TestCase):
    ...
    def test_remove_rate_modifier(self) -> None:
        """Test case for remove_rate_modifier

        Delete Promotion
        """
        pass

    def test_show_promotion(self) -> None:
        """Test case for show_promotion

        Show Promotion
        """
        pass

    def test_show_promotions(self) -> None:
        """Test case for show_promotions
