...
class TestPageRateSupplier(unittest.TestCase):
    """PageRateSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageRateSupplier:
        """Test PageRateSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageRateSupplier`
        """
        model = PageRateSupplier()
        if include_optional:
            return PageRateSupplier(
                ...
                size = 56,
                content = [
                    wink_sdk_extranet_monetize.models.rate_supplier.Rate_Supplier(
                        id = 'doc-1', 
                        hotel_identifier = 'hotel-1', 
                        rate_source = 'TRAVELIKO', 
                        rate_plan_identifier = 'rate-plan-1', 
                        guest_room_identifier = 'guest-room-1', 
                        rate = 10, 
                        currency_code = 'USD', 
                        master = True, 
                ...
                sort = wink_sdk_extranet_monetize.models.sort_object_supplier.SortObject_Supplier(
                    empty = True, 
                    unsorted = True, 
                    sorted = True, ),
                pageable = wink_sdk_extranet_monetize.models.pageable_object_supplier.PageableObject_Supplier(
                    offset = 56, 
                    sort = wink_sdk_extranet_monetize.models.sort_object_supplier.SortObject_Supplier(
                        empty = True, 
                        unsorted = True, 
