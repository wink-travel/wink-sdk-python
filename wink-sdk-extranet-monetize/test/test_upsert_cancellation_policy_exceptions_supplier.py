...
class TestUpsertCancellationPolicyExceptionsSupplier(unittest.TestCase):
    """UpsertCancellationPolicyExceptionsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertCancellationPolicyExceptionsSupplier:
        """Test UpsertCancellationPolicyExceptionsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertCancellationPolicyExceptionsSupplier`
        """
        model = UpsertCancellationPolicyExceptionsSupplier()
        if include_optional:
            return UpsertCancellationPolicyExceptionsSupplier(
                list = [
    ...
    def testUpsertCancellationPolicyExceptionsSupplier(self):
        """Test UpsertCancellationPolicyExceptionsSupplier"""
