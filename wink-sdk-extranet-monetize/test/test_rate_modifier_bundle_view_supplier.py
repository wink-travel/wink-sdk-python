...
class TestRateModifierBundleViewSupplier(unittest.TestCase):
    """RateModifierBundleViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateModifierBundleViewSupplier:
        """Test RateModifierBundleViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateModifierBundleViewSupplier`
        """
        model = RateModifierBundleViewSupplier()
        if include_optional:
            return RateModifierBundleViewSupplier(
                ...
                version = 12,
                rate_modifier_bundle = wink_sdk_extranet_monetize.models.rate_modifier_bundle_supplier.RateModifierBundle_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
                    name = 'Early bird - Long Term', 
                    enabled = True, 
                    items = [
                        wink_sdk_extranet_monetize.models.rate_modifier_supplier.RateModifier_Supplier(
                            identifier = '', 
                            hotel_identifier = '', 
                            name = 'Early bird', 
                            type = 'DISCOUNT', 
                    ...
                    modifier_override = wink_sdk_extranet_monetize.models.variable_charge_supplier.VariableCharge_Supplier(
                        type = 'FIXED', 
                        percent = 0.25, ), 
                    type = 'DISCOUNT', 
    ...
    def testRateModifierBundleViewSupplier(self):
        """Test RateModifierBundleViewSupplier"""
