...
class TestCancellationPolicyRemovableResponseSupplier(unittest.TestCase):
    """CancellationPolicyRemovableResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyRemovableResponseSupplier:
        """Test CancellationPolicyRemovableResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyRemovableResponseSupplier`
        """
        model = CancellationPolicyRemovableResponseSupplier()
        if include_optional:
            return CancellationPolicyRemovableResponseSupplier(
                removable = True,
                rate_plans = [
                    wink_sdk_extranet_monetize.models.identifier_name_pair_supplier.IdentifierNamePair_Supplier(
                        identifier = 'record-1', 
                        name = 'Record One', )
                    ]
            )
    ...
    def testCancellationPolicyRemovableResponseSupplier(self):
        """Test CancellationPolicyRemovableResponseSupplier"""
