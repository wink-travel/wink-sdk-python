...
class TestLocalizedDescriptionSupplier(unittest.TestCase):
    """LocalizedDescriptionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedDescriptionSupplier:
        """Test LocalizedDescriptionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedDescriptionSupplier`
        """
        model = LocalizedDescriptionSupplier()
        if include_optional:
            return LocalizedDescriptionSupplier(
    ...
    def testLocalizedDescriptionSupplier(self):
        """Test LocalizedDescriptionSupplier"""
