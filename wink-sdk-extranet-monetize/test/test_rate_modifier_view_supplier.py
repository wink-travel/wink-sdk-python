...
class TestRateModifierViewSupplier(unittest.TestCase):
    """RateModifierViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateModifierViewSupplier:
        """Test RateModifierViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateModifierViewSupplier`
        """
        model = RateModifierViewSupplier()
        if include_optional:
            return RateModifierViewSupplier(
                ...
                version = 12,
                rate_modifier = wink_sdk_extranet_monetize.models.rate_modifier_supplier.RateModifier_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
                    name = 'Early bird', 
                    type = 'DISCOUNT', 
    ...
    def testRateModifierViewSupplier(self):
        """Test RateModifierViewSupplier"""
