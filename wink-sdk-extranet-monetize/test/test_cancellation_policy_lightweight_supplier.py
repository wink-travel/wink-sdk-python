...
class TestCancellationPolicyLightweightSupplier(unittest.TestCase):
    """CancellationPolicyLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyLightweightSupplier:
        """Test CancellationPolicyLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyLightweightSupplier`
        """
        model = CancellationPolicyLightweightSupplier()
        if include_optional:
            return CancellationPolicyLightweightSupplier(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyLightweightSupplier(self):
        """Test CancellationPolicyLightweightSupplier"""
