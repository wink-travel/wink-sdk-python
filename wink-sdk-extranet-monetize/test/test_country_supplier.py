...
class TestCountrySupplier(unittest.TestCase):
    """CountrySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountrySupplier:
        """Test CountrySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountrySupplier`
        """
        model = CountrySupplier()
        if include_optional:
