...
class TestUpgradeView(unittest.TestCase):
    """UpgradeView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradeView:
        """Test UpgradeView
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpgradeView`
        """
        model = UpgradeView()
        if include_optional:
            return UpgradeView(
                ...
                version = 12,
                upgrade = wink_sdk_extranet_monetize.models.add_on.AddOn(
                    identifier = '', 
                    hotel_identifier = '', 
                    featured_ind = False, 
                    ...
                    descriptions = [
                        wink_sdk_extranet_monetize.models.simple_description.SimpleDescription(
                            name = 'An example title', 
                            description = 'This is a longer description in the specified language.', 
                            language = 'en', )
                        ], 
                    multimedias = [
                        wink_sdk_extranet_monetize.models.simple_multimedia.SimpleMultimedia(
                            ...
                            lifestyle_type = 'LIFESTYLE_HEALTH_FITNESS', 
                            attribution = [
                                wink_sdk_extranet_monetize.models.image_attribution.ImageAttribution(
                                    url = 'https://maps.google.com/maps/contrib/111628493169070103594', 
                                    name = 'Samuel Adams', )
                                ], 
                            is_landscape = True, )
                        ], 
                    contact = wink_sdk_extranet_monetize.models.contact.Contact(
                        first_name = 'John', 
                        last_name = 'Smith', 
                    ...
                    address = wink_sdk_extranet_monetize.models.address.Address(
                        address1 = '234 Near da beach', 
                        address2 = 'Pebble #5001', 
                        state = 'CA', 
                        postal_code = '90210', 
                        county = 'Alameda county', 
                        city = wink_sdk_extranet_monetize.models.geo_name.GeoName(
                            geo_name_id = '5128581', 
                            type = 'CITY', 
                            name = 'New York City', 
                            ...
                            radius_in_meters = 56, 
                            country = wink_sdk_extranet_monetize.models.country.Country(
                                iso = 'US', 
                                iso3 = 'USA', 
                                iso_numeric = 840, 
                                fips = 'US', 
                            ...
                            sub_country = wink_sdk_extranet_monetize.models.sub_country.SubCountry(
                                code = 'US.NY', 
                                country_code = 'US', 
                                sub_country_code = 'NY', 
                                name = 'New York', 
                                ascii_name = 'New York', 
                                geo_name_id = '5128638', ), 
                            sub_sub_country = wink_sdk_extranet_monetize.models.sub_sub_country.SubSubCountry(
                                code = '', 
                                country_code = '', 
                                sub_country_code = '', 
                    ...
                    security_features = ["1"], 
                    socials = [
                        wink_sdk_extranet_monetize.models.social.Social(
                            type = 'FACEBOOK', 
                            enabled = True, )
                        ], 
                    price_point = 'THREE', 
                    recognition_list = [
                        wink_sdk_extranet_monetize.models.travel_inventory_recognition.TravelInventoryRecognition(
                            identifier = '', 
                            category = 'AWARD', 
                            type = 'PERCENT_RATING', 
                            provider = 'Michelin', 
                    ...
                    transactional_inventory_list = [
                        wink_sdk_extranet_monetize.models.transactional_travel_inventory.TransactionalTravelInventory(
                            identifier = '', 
                            name = '1 hour session', 
                            descriptions = [
                                wink_sdk_extranet_monetize.models.simple_description.SimpleDescription(
                    ...
                    opens = '09:00', 
                    closes = '17:30', 
                    days_of_week = wink_sdk_extranet_monetize.models.dow_pattern_group.DowPatternGroup(
                        mon = True, 
                        tue = True, 
                        wed = True, 
                        thu = True, 
                    ...
                    rate_plan = wink_sdk_extranet_monetize.models.rate_plan.RatePlan(
                        identifier = '', 
                        hotel_identifier = '', 
                        name = 'BAR 1', 
                        prepaid = False, 
                        ...
                        rate_plan_level_fees = [
                            wink_sdk_extranet_monetize.models.rate_plan_level_fee.RatePlanLevelFee(
                                descriptions = [
                                    wink_sdk_extranet_monetize.models.localized_description.LocalizedDescription(
                                        description = 'This is a longer description in the specified language.', 
                                        language = 'en', )
                                    ], 
                                fixed_amount = , 
                        ...
                        available_days_of_week = wink_sdk_extranet_monetize.models.dow_pattern_group.DowPatternGroup(
                            mon = True, 
                            tue = True, 
                            wed = True, 
                            thu = True, 
                        ...
                        early_check_in_charge = wink_sdk_extranet_monetize.models.variable_charge.VariableCharge(
                            type = 'FIXED', 
                            percent = 0.25, ), 
                        late_check_out_charge = wink_sdk_extranet_monetize.models.variable_charge.VariableCharge(
                            type = 'FIXED', 
                            percent = 0.25, ), 
                        cancellation_policy_identifier = 'cancellation-policy-1', 
                        cancellation_policy = wink_sdk_extranet_monetize.models.cancellation_policy.CancellationPolicy(
                            identifier = '', 
                            hotel_identifier = '', 
                            refundable = False, 
                            ...
                            policy_code = '', ), 
                        cancellation_policy_exceptions = wink_sdk_extranet_monetize.models.cancellation_policy_exceptions.CancellationPolicyExceptions(
                            list = [
                                wink_sdk_extranet_monetize.models.cancellation_policy_exception.CancellationPolicyException(
                    ...
                    mandatory = True, ),
                featured_image_identifier = 'noimage_opaque_nyrtl0.png'
            )
        else:
            return UpgradeView(
        )
