...
class TestCancellationPolicyExceptionSupplier(unittest.TestCase):
    """CancellationPolicyExceptionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionSupplier:
        """Test CancellationPolicyExceptionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionSupplier`
        """
        model = CancellationPolicyExceptionSupplier()
        if include_optional:
            return CancellationPolicyExceptionSupplier(
    ...
    def testCancellationPolicyExceptionSupplier(self):
        """Test CancellationPolicyExceptionSupplier"""
