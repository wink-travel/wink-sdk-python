...
class TestGeoIPSupplier(unittest.TestCase):
    """GeoIPSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoIPSupplier:
        """Test GeoIPSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoIPSupplier`
        """
        model = GeoIPSupplier()
        if include_optional:
            return GeoIPSupplier(
                geo_name_id = '8798734',
                locale_code = 'en',
                continent_code = 'NA',
