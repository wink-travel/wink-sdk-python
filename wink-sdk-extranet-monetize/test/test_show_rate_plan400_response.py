...
class TestShowRatePlan400Response(unittest.TestCase):
    """ShowRatePlan400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowRatePlan400Response:
        """Test ShowRatePlan400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowRatePlan400Response`
        """
        model = ShowRatePlan400Response()
        if include_optional:
            return ShowRatePlan400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowRatePlan400Response(self):
        """Test ShowRatePlan400Response"""
