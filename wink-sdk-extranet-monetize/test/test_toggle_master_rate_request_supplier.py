...
class TestToggleMasterRateRequestSupplier(unittest.TestCase):
    """ToggleMasterRateRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToggleMasterRateRequestSupplier:
        """Test ToggleMasterRateRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToggleMasterRateRequestSupplier`
        """
        model = ToggleMasterRateRequestSupplier()
        if include_optional:
            return ToggleMasterRateRequestSupplier(
                enabled = True
            )
        else:
            return ToggleMasterRateRequestSupplier(
    ...
    def testToggleMasterRateRequestSupplier(self):
        """Test ToggleMasterRateRequestSupplier"""
