...
class TestVariableCharge(unittest.TestCase):
    """VariableCharge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariableCharge:
        """Test VariableCharge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariableCharge`
        """
