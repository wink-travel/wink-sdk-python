...
class TestDowPatternGroup(unittest.TestCase):
    """DowPatternGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DowPatternGroup:
        """Test DowPatternGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DowPatternGroup`
        """
        model = DowPatternGroup()
        if include_optional:
