...
class TestCancellationPolicyLightweight(unittest.TestCase):
    """CancellationPolicyLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyLightweight:
        """Test CancellationPolicyLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyLightweight`
        """
        model = CancellationPolicyLightweight()
        if include_optional:
            return CancellationPolicyLightweight(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyLightweight(self):
        """Test CancellationPolicyLightweight"""
