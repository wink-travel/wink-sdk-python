...
class TestTimezoneRateQualifierSupplier(unittest.TestCase):
    """TimezoneRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimezoneRateQualifierSupplier:
        """Test TimezoneRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimezoneRateQualifierSupplier`
        """
        model = TimezoneRateQualifierSupplier()
        if include_optional:
            return TimezoneRateQualifierSupplier(
                timezone = ''
            )
        else:
            return TimezoneRateQualifierSupplier(
    ...
    def testTimezoneRateQualifierSupplier(self):
        """Test TimezoneRateQualifierSupplier"""
