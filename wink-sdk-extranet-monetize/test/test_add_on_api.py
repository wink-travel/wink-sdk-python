...
class TestAddOnApi(unittest.TestCase):
    ...
    def test_add_multimedia(self) -> None:
        """Test case for add_multimedia
    ...
    def test_remove_add_on(self) -> None:
    ...
    def test_show_add_on(self) -> None:
        """Test case for show_add_on

        Show Add-On
        """
        pass

    def test_show_add_ons(self) -> None:
        """Test case for show_add_ons
    ...
    def test_update_add_on_multimedia(self) -> None:
        """Test case for update_add_on_multimedia

        Update Multimedia
        """
        pass

    def test_upload_binary_add_on_media(self) -> None:
        """Test case for upload_binary_add_on_media
