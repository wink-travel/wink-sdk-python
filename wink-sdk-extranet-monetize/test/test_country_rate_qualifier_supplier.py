...
class TestCountryRateQualifierSupplier(unittest.TestCase):
    """CountryRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryRateQualifierSupplier:
        """Test CountryRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryRateQualifierSupplier`
        """
        model = CountryRateQualifierSupplier()
        if include_optional:
            return CountryRateQualifierSupplier(
    ...
    def testCountryRateQualifierSupplier(self):
        """Test CountryRateQualifierSupplier"""
