...
class TestPromotionBundleApi(unittest.TestCase):
    """PromotionBundleApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PromotionBundleApi()

    def tearDown(self) -> None:
        pass

    def test_create_rate_modifier_bundle(self) -> None:
        """Test case for create_rate_modifier_bundle

        Create Promotion Bundle
        """
        pass

    def test_remove_rate_modifier_bundle(self) -> None:
        """Test case for remove_rate_modifier_bundle

        Delete Promotion Bundle
        """
        pass

    def test_show_rate_modifier_bundle(self) -> None:
        """Test case for show_rate_modifier_bundle

        Show Promotion Bundle
        """
        pass

    def test_show_rate_modifier_bundles(self) -> None:
        """Test case for show_rate_modifier_bundles

        Show Promotion Bundles
        """
        pass

    def test_update_rate_modifier_bundle(self) -> None:
        """Test case for update_rate_modifier_bundle
