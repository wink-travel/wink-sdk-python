...
class TestUpsertSpecialRateBundleRequestSupplier(unittest.TestCase):
    """UpsertSpecialRateBundleRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSpecialRateBundleRequestSupplier:
        """Test UpsertSpecialRateBundleRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSpecialRateBundleRequestSupplier`
        """
        model = UpsertSpecialRateBundleRequestSupplier()
        if include_optional:
            return UpsertSpecialRateBundleRequestSupplier(
    ...
    def testUpsertSpecialRateBundleRequestSupplier(self):
        """Test UpsertSpecialRateBundleRequestSupplier"""
