...
class TestContactSupplier(unittest.TestCase):
    """ContactSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactSupplier:
        """Test ContactSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactSupplier`
        """
