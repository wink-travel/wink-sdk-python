...
class TestIPRangeRateQualifierSupplier(unittest.TestCase):
    """IPRangeRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPRangeRateQualifierSupplier:
        """Test IPRangeRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPRangeRateQualifierSupplier`
        """
        model = IPRangeRateQualifierSupplier()
        if include_optional:
            return IPRangeRateQualifierSupplier(
                start_ip_range = '',
                end_ip_range = ''
            )
        else:
    ...
    def testIPRangeRateQualifierSupplier(self):
        """Test IPRangeRateQualifierSupplier"""
