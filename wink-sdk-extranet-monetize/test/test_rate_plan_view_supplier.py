...
class TestRatePlanViewSupplier(unittest.TestCase):
    """RatePlanViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanViewSupplier:
        """Test RatePlanViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanViewSupplier`
        """
        model = RatePlanViewSupplier()
        if include_optional:
    ...
    def testRatePlanViewSupplier(self):
        """Test RatePlanViewSupplier"""
