...
class TestUpsertRateModifierBundleRequestSupplier(unittest.TestCase):
    """UpsertRateModifierBundleRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertRateModifierBundleRequestSupplier:
        """Test UpsertRateModifierBundleRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertRateModifierBundleRequestSupplier`
        """
        model = UpsertRateModifierBundleRequestSupplier()
        if include_optional:
            return UpsertRateModifierBundleRequestSupplier(
    ...
    def testUpsertRateModifierBundleRequestSupplier(self):
        """Test UpsertRateModifierBundleRequestSupplier"""
