        ...
        if include_optional:
            return RatePlan(
                ...
                arrival_days_of_week = wink_sdk_extranet_monetize.models.dow_pattern_group.DowPatternGroup(
                    ...
                    sun = True, 
                    disabled = True, ),
                departure_days_of_week = wink_sdk_extranet_monetize.models.dow_pattern_group.DowPatternGroup(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                required_days_of_week = wink_sdk_extranet_monetize.models.dow_pattern_group.DowPatternGroup(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                ...
                single_occupancy_rate_modifier = wink_sdk_extranet_monetize.models.variable_charge.VariableCharge(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_monetize.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '', ), ),
                extra_pax_rate_modifier = wink_sdk_extranet_monetize.models.variable_charge.VariableCharge(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_monetize.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '', ), ),
                extra_child_rate_modifier = wink_sdk_extranet_monetize.models.variable_charge.VariableCharge(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_monetize.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
