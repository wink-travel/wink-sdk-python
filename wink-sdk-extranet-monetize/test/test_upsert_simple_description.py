...
class TestUpsertSimpleDescription(unittest.TestCase):
    """UpsertSimpleDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSimpleDescription:
        """Test UpsertSimpleDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSimpleDescription`
        """
        model = UpsertSimpleDescription()
        if include_optional:
            return UpsertSimpleDescription(
    ...
    def testUpsertSimpleDescription(self):
        """Test UpsertSimpleDescription"""
