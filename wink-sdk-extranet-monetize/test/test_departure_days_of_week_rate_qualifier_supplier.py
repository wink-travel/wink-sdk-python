...
class TestDepartureDaysOfWeekRateQualifierSupplier(unittest.TestCase):
    """DepartureDaysOfWeekRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepartureDaysOfWeekRateQualifierSupplier:
        """Test DepartureDaysOfWeekRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepartureDaysOfWeekRateQualifierSupplier`
        """
        model = DepartureDaysOfWeekRateQualifierSupplier()
        if include_optional:
            return DepartureDaysOfWeekRateQualifierSupplier(
    ...
    def testDepartureDaysOfWeekRateQualifierSupplier(self):
        """Test DepartureDaysOfWeekRateQualifierSupplier"""
