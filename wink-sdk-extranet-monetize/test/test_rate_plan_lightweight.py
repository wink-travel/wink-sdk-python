...
class TestRatePlanLightweight(unittest.TestCase):
    """RatePlanLightweight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanLightweight:
        """Test RatePlanLightweight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanLightweight`
        """
        model = RatePlanLightweight()
        if include_optional:
            return RatePlanLightweight(
                identifier = '0',
    ...
    def testRatePlanLightweight(self):
        """Test RatePlanLightweight"""
