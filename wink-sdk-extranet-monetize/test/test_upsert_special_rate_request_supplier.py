...
class TestUpsertSpecialRateRequestSupplier(unittest.TestCase):
    """UpsertSpecialRateRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSpecialRateRequestSupplier:
        """Test UpsertSpecialRateRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSpecialRateRequestSupplier`
        """
        model = UpsertSpecialRateRequestSupplier()
        if include_optional:
            return UpsertSpecialRateRequestSupplier(
                name = 'Early bird',
                type = 'DISCOUNT',
                ...
                city_rate_qualifiers = [
                    wink_sdk_extranet_monetize.models.city_rate_qualifier_supplier.CityRateQualifier_Supplier(
                        city = wink_sdk_extranet_monetize.models.geo_ip_lightweight_supplier.GeoIpLightweight_Supplier(
                            geo_name_id = '8798734', 
                            locale_code = 'en', 
                            continent_code = 'NA', 
    ...
    def testUpsertSpecialRateRequestSupplier(self):
        """Test UpsertSpecialRateRequestSupplier"""
