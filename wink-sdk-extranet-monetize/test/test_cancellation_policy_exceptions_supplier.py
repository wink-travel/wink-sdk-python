...
class TestCancellationPolicyExceptionsSupplier(unittest.TestCase):
    """CancellationPolicyExceptionsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionsSupplier:
        """Test CancellationPolicyExceptionsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionsSupplier`
        """
        model = CancellationPolicyExceptionsSupplier()
        if include_optional:
            return CancellationPolicyExceptionsSupplier(
                list = [
    ...
    def testCancellationPolicyExceptionsSupplier(self):
        """Test CancellationPolicyExceptionsSupplier"""
