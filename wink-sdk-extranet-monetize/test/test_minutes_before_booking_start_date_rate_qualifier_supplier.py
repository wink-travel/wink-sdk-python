...
class TestMinutesBeforeBookingStartDateRateQualifierSupplier(unittest.TestCase):
    """MinutesBeforeBookingStartDateRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MinutesBeforeBookingStartDateRateQualifierSupplier:
        """Test MinutesBeforeBookingStartDateRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MinutesBeforeBookingStartDateRateQualifierSupplier`
        """
        model = MinutesBeforeBookingStartDateRateQualifierSupplier()
        if include_optional:
            return MinutesBeforeBookingStartDateRateQualifierSupplier(
                seconds = 0
            )
        else:
            return MinutesBeforeBookingStartDateRateQualifierSupplier(
    ...
    def testMinutesBeforeBookingStartDateRateQualifierSupplier(self):
        """Test MinutesBeforeBookingStartDateRateQualifierSupplier"""
