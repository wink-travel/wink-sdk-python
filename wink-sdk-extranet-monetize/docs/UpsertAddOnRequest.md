...
**descriptions** | [**List[UpsertSimpleDescription]**](UpsertSimpleDescription.md) | Localized descriptions describing inventory. | 
...
**rate_plan_identifier** | **UUID** | Pass an optional rate plan identifier if you want to add more complex restrictions to this add-on. Example: You want the add-on to only be available when a specific room is available. | [optional] 
