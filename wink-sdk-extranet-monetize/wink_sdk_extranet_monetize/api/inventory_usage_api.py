...
class InventoryUsageApi:
    ...
    def show_add_on_usage(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Hotel identifier inventoryowner")],
        ...
        :param property_identifier: Hotel identifier inventoryowner (required)
