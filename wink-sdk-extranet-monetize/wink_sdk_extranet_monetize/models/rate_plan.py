...
class RatePlan(BaseModel):
    ...
    rate_plan_level_fees: Optional[List[RatePlanLevelFee]] = Field(default=None, description="This can be a one-time fee such as a cleaning fee", alias="ratePlanLevelFees")
    ...
    cancellation_policy_exceptions: Optional[CancellationPolicyExceptions] = Field(default=None, alias="cancellationPolicyExceptions")
