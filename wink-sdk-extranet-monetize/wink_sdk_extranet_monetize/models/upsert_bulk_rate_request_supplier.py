...
class UpsertBulkRateRequestSupplier(BaseModel):
    """
    UpsertBulkRateRequestSupplier
    """ # noqa: E501
    start_date: date = Field(description="Start date for where you want to begin updating rates", alias="startDate")
    end_date: date = Field(description="End date for where you want to stop updating rates", alias="endDate")
    rate_source: StrictStr = Field(description="Indicate where this rate originated from. Leave as TRAVELIKO unless you are a channel manager and responsible for the property's rates externally of this platform.", alias="rateSource")
    ...
    number_of_units: Optional[StrictInt] = Field(default=None, description="Update the amount of rooms available for this date range. Leave empty if you don't want to update this property.", alias="numberOfUnits")
    rate: Optional[CustomMonetaryAmount] = None
    min_length_of_stay: Optional[StrictInt] = Field(default=None, description="Control the minimum length of stay at the day-level. This means that a guest arriving within this date range is required to stay at least these number of days in order to get this rate. Leave empty if you don't want to update this property.", alias="minLengthOfStay")
    max_length_of_stay: Optional[StrictInt] = Field(default=None, description="Control the maximum length of stay at the day-level. This means that a guest arriving within this date range is required to stay no longer than these number of days in order to get this rate. Leave empty if you don't want to update this property.", alias="maxLengthOfStay")
    ...
    __properties: ClassVar[List[str]] = ["startDate", "endDate", "rateSource", "master", "closedOnArrival", "closedOnDeparture", "numberOfUnits", "rate", "minLengthOfStay", "maxLengthOfStay", "singleOccupancyRateModifier", "extraPaxRateModifier", "extraChildRateModifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numberOfUnits": obj.get("numberOfUnits"),
            "rate": CustomMonetaryAmount.from_dict(obj["rate"]) if obj.get("rate") is not None else None,
