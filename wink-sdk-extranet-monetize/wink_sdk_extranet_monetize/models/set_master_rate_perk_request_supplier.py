...
class SetMasterRatePerkRequestSupplier(BaseModel):
    """
    SetMasterRatePerkRequestSupplier
    """ # noqa: E501
    perk_types: Optional[List[StrictStr]] = Field(default=None, description="Optional perks", alias="perkTypes")
    __properties: ClassVar[List[str]] = ["perkTypes"]
