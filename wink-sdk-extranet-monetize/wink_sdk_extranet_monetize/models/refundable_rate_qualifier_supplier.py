...
class RefundableRateQualifierSupplier(BaseModel):
    """
    RefundableRateQualifierSupplier
    """ # noqa: E501
    refundable: StrictBool = Field(description="Whether restriction is on refundable rates")
    __properties: ClassVar[List[str]] = ["refundable"]
