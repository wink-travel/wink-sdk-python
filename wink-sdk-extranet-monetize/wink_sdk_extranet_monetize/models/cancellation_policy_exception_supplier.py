...
class CancellationPolicyExceptionSupplier(BaseModel):
    """
    ...
    cancellation_policy: CancellationPolicyLightweightSupplier = Field(description="Cancellation policy", alias="cancellationPolicy")
