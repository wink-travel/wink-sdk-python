...
class StayDateRateQualifierSupplier(BaseModel):
    """
    StayDateRateQualifierSupplier
    """ # noqa: E501
    effective_date: date = Field(description="The effective (start) date of the stay date rate qualifier", alias="effectiveDate")
    expire_date: date = Field(description="The expiration (end) date of the stay date rate qualifier", alias="expireDate")
