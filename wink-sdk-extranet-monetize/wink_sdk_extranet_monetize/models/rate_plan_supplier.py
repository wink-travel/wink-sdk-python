...
class RatePlanSupplier(BaseModel):
    ...
    cancellation_policy: Optional[CancellationPolicySupplier] = Field(default=None, alias="cancellationPolicy")
    cancellation_policy_exceptions: Optional[CancellationPolicyExceptionsSupplier] = Field(default=None, alias="cancellationPolicyExceptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cancellationPolicy": CancellationPolicySupplier.from_dict(obj["cancellationPolicy"]) if obj.get("cancellationPolicy") is not None else None,
