...
class PerkLightweightSupplier(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescription], Field(min_length=1)] = Field(description="Localized description for this perk")
