...
class CancellationPolicySupplier(BaseModel):
    """
    ...
    hotel_identifier: UUID = Field(description="Property this cancellation is associated with", alias="hotelIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "hotelIdentifier", "refundable", "advanceCancellationFreeOfCharge", "refundableCancellationCharge", "noShowCharge", "nonRefundableCancellationCharge", "nonRefundableDeadline", "nonRefundableAfterDeadlineCancellationCharge", "policyCode"]
