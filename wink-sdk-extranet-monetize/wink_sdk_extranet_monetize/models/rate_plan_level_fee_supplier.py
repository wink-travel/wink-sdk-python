...
class RatePlanLevelFeeSupplier(BaseModel):
    """
    RatePlanLevelFeeSupplier
    """ # noqa: E501
    descriptions: Annotated[List[LocalizedDescriptionSupplier], Field(min_length=1)] = Field(description="List of localized descriptions for this fee.")
