...
class RatePlanLightweightSupplier(BaseModel):
    ...
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Rate plan identifier")
    ...
    rate_plan_level_fees: Optional[List[RatePlanLevelFeeSupplier]] = Field(default=None, alias="ratePlanLevelFees")
