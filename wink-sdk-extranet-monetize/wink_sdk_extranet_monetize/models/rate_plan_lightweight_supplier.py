...
class RatePlanLightweightSupplier(BaseModel):
    """
    RatePlanLightweightSupplier
    """ # noqa: E501
    identifier: UUID = Field(description="Rate plan identifier")
    hotel_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Hotel ID", alias="hotelIdentifier")
    ...
    rate_plan_level_fees: Optional[List[RatePlanLevelFeeSupplier]] = Field(default=None, description="This can be a one-time fee such as a cleaning fee", alias="ratePlanLevelFees")
    available_days_of_week: Optional[DowPatternGroupSupplier] = Field(default=None, alias="availableDaysOfWeek")
    arrival_days_of_week: Optional[DowPatternGroupSupplier] = Field(default=None, alias="arrivalDaysOfWeek")
    departure_days_of_week: Optional[DowPatternGroupSupplier] = Field(default=None, alias="departureDaysOfWeek")
    required_days_of_week: Optional[DowPatternGroupSupplier] = Field(default=None, alias="requiredDaysOfWeek")
    early_check_in_charge: Optional[VariableChargeSupplier] = Field(default=None, alias="earlyCheckInCharge")
    late_check_out_charge: Optional[VariableChargeSupplier] = Field(default=None, alias="lateCheckOutCharge")
    cancellation_policy: Optional[CancellationPolicyLightweightSupplier] = Field(default=None, description="The cancellation policy for this rate plan.", alias="cancellationPolicy")
    cancellation_policy_exceptions: Optional[CancellationPolicyExceptionsSupplier] = Field(default=None, description="Allows a property to dynamically use another cancellation policy for a specific date range", alias="cancellationPolicyExceptions")
    single_occupancy_rate_modifier: Optional[VariableChargeSupplier] = Field(default=None, alias="singleOccupancyRateModifier")
    extra_pax_rate_modifier: Optional[VariableChargeSupplier] = Field(default=None, alias="extraPaxRateModifier")
    extra_child_rate_modifier: Optional[VariableChargeSupplier] = Field(default=None, alias="extraChildRateModifier")
    __properties: ClassVar[List[str]] = ["identifier", "hotelIdentifier", "name", "prepaid", "enabled", "breakfast", "brunch", "lunch", "dinner", "allInclusive", "allInclusivePlusAlcohol", "sellStartDate", "sellEndDate", "stayStartDate", "stayEndDate", "loyaltyPointsAccrue", "maxAdvanceBookingOffset", "minAdvanceBookingOffset", "minTotalOccupancy", "maxTotalOccupancy", "minLOS", "maxLOS", "minAge", "maxAge", "ratePlanLevelFees", "availableDaysOfWeek", "arrivalDaysOfWeek", "departureDaysOfWeek", "requiredDaysOfWeek", "earlyCheckInCharge", "lateCheckOutCharge", "cancellationPolicy", "cancellationPolicyExceptions", "singleOccupancyRateModifier", "extraPaxRateModifier", "extraChildRateModifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratePlanLevelFees": [RatePlanLevelFeeSupplier.from_dict(_item) for _item in obj["ratePlanLevelFees"]] if obj.get("ratePlanLevelFees") is not None else None,
            "availableDaysOfWeek": DowPatternGroupSupplier.from_dict(obj["availableDaysOfWeek"]) if obj.get("availableDaysOfWeek") is not None else None,
            "arrivalDaysOfWeek": DowPatternGroupSupplier.from_dict(obj["arrivalDaysOfWeek"]) if obj.get("arrivalDaysOfWeek") is not None else None,
            "departureDaysOfWeek": DowPatternGroupSupplier.from_dict(obj["departureDaysOfWeek"]) if obj.get("departureDaysOfWeek") is not None else None,
            "requiredDaysOfWeek": DowPatternGroupSupplier.from_dict(obj["requiredDaysOfWeek"]) if obj.get("requiredDaysOfWeek") is not None else None,
            "earlyCheckInCharge": VariableChargeSupplier.from_dict(obj["earlyCheckInCharge"]) if obj.get("earlyCheckInCharge") is not None else None,
            "lateCheckOutCharge": VariableChargeSupplier.from_dict(obj["lateCheckOutCharge"]) if obj.get("lateCheckOutCharge") is not None else None,
            "cancellationPolicy": CancellationPolicyLightweightSupplier.from_dict(obj["cancellationPolicy"]) if obj.get("cancellationPolicy") is not None else None,
            "cancellationPolicyExceptions": CancellationPolicyExceptionsSupplier.from_dict(obj["cancellationPolicyExceptions"]) if obj.get("cancellationPolicyExceptions") is not None else None,
            "singleOccupancyRateModifier": VariableChargeSupplier.from_dict(obj["singleOccupancyRateModifier"]) if obj.get("singleOccupancyRateModifier") is not None else None,
            "extraPaxRateModifier": VariableChargeSupplier.from_dict(obj["extraPaxRateModifier"]) if obj.get("extraPaxRateModifier") is not None else None,
            "extraChildRateModifier": VariableChargeSupplier.from_dict(obj["extraChildRateModifier"]) if obj.get("extraChildRateModifier") is not None else None
        })
        return _obj
