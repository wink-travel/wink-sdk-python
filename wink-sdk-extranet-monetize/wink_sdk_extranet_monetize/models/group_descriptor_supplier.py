...
class GroupDescriptorSupplier(BaseModel):
    """
    ...
    aggregates: Optional[List[AggregateDescriptorSupplier]] = Field(default=None, description="Primitive aggregate data points")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field": obj.get("field"),
            "dir": obj.get("dir"),
            "aggregates": [AggregateDescriptorSupplier.from_dict(_item) for _item in obj["aggregates"]] if obj.get("aggregates") is not None else None
        })
        return _obj
