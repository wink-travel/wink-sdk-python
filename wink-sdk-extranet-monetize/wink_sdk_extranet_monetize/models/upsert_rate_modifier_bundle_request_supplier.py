...
class UpsertRateModifierBundleRequestSupplier(BaseModel):
    """
    ...
    item_identifiers: Annotated[List[Annotated[str, Field(min_length=2, strict=True)]], Field(min_length=2, max_length=2147483647)] = Field(alias="itemIdentifiers")
