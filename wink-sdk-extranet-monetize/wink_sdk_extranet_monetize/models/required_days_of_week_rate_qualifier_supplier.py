...
class RequiredDaysOfWeekRateQualifierSupplier(BaseModel):
    """
    RequiredDaysOfWeekRateQualifierSupplier
    """ # noqa: E501
    days_of_week: DowPatternGroupSupplier = Field(description="The days of the week the user has to stay on to get this rate", alias="daysOfWeek")
