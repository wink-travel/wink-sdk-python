...
class LengthOfStayRateQualifierSupplier(BaseModel):
    """
    LengthOfStayRateQualifierSupplier
    """ # noqa: E501
    min_los: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Minimum length of stay qualifier", alias="minLOS")
    max_los: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Maximum length of stay qualifier", alias="maxLOS")
    __properties: ClassVar[List[str]] = ["minLOS", "maxLOS"]
