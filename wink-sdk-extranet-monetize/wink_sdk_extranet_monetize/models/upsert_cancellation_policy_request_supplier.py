...
class UpsertCancellationPolicyRequestSupplier(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["refundable", "advanceCancellationFreeOfCharge", "refundableCancellationCharge", "noShowCharge", "nonRefundableCancellationCharge", "nonRefundableDeadline", "nonRefundableAfterDeadlineCancellationCharge"]
