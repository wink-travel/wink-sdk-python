...
class PromotionRateQualifierSupplier(BaseModel):
    """
    PromotionRateQualifierSupplier
    """ # noqa: E501
    promotion: Annotated[str, Field(min_length=1, strict=True)] = Field(description="promotion code")
    __properties: ClassVar[List[str]] = ["promotion"]
