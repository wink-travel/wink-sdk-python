...
class RateModifierBundleViewSupplier(BaseModel):
    """
    ...
    rate_modifier_bundle: RateModifierBundleSupplier = Field(alias="rateModifierBundle")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "rateModifierBundle"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rate_modifier_bundle
        if self.rate_modifier_bundle:
            _dict['rateModifierBundle'] = self.rate_modifier_bundle.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateModifierBundle": RateModifierBundleSupplier.from_dict(obj["rateModifierBundle"]) if obj.get("rateModifierBundle") is not None else None
        })
        return _obj
