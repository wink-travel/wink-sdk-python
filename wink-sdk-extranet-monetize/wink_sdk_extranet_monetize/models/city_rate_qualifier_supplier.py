...
class CityRateQualifierSupplier(BaseModel):
    """
    CityRateQualifierSupplier
    """ # noqa: E501
    city: GeoIpLightweightSupplier = Field(description="City geoIP")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "city": GeoIpLightweightSupplier.from_dict(obj["city"]) if obj.get("city") is not None else None
        })
        return _obj
