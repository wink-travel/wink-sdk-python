...
class ArrivalDaysOfWeekRateQualifierSupplier(BaseModel):
    """
    ArrivalDaysOfWeekRateQualifierSupplier
    """ # noqa: E501
    days_of_week: DowPatternGroupSupplier = Field(description="The days of the week when this rate is available for guests to arrive on", alias="daysOfWeek")
    __properties: ClassVar[List[str]] = ["daysOfWeek"]
