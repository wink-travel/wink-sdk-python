...
class AdvanceBookingRateQualifierSupplier(BaseModel):
    """
    AdvanceBookingRateQualifierSupplier
    """ # noqa: E501
    min_advance_booking_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Minimum advance booking offset qualifier", alias="minAdvanceBookingOffset")
    max_advance_booking_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Maximum advance booking offset qualifier", alias="maxAdvanceBookingOffset")
    __properties: ClassVar[List[str]] = ["minAdvanceBookingOffset", "maxAdvanceBookingOffset"]
