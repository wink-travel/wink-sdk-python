...
class BlackoutDateSupplier(BaseModel):
    """
    BlackoutDateSupplier
    """ # noqa: E501
    effective_date: date = Field(description="Blackout start date.", alias="effectiveDate")
    expire_date: date = Field(description="Blackout end date.", alias="expireDate")
