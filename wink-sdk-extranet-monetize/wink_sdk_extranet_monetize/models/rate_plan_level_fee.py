...
class RatePlanLevelFee(BaseModel):
    """
    RatePlanLevelFee
    """ # noqa: E501
    descriptions: Annotated[List[LocalizedDescription], Field(min_length=1)] = Field(description="List of localized descriptions for this fee.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "descriptions": [LocalizedDescription.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None,
