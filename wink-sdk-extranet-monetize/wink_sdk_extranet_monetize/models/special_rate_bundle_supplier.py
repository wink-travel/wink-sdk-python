...
from wink_sdk_extranet_monetize.models.special_rate_lightweight_supplier import SpecialRateLightweightSupplier
from wink_sdk_extranet_monetize.models.variable_charge_supplier import VariableChargeSupplier
from typing import Optional, Set
from typing_extensions import Self

class SpecialRateBundleSupplier(BaseModel):
    """
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Internal name of promotion ancillary.")
    enabled: StrictBool = Field(description="Whether this promotion ancillary is enabled or not.")
    items: Annotated[List[SpecialRateLightweightSupplier], Field(min_length=1)]
    modifier_override: Optional[VariableChargeSupplier] = Field(default=None, alias="modifierOverride")
    type: Optional[StrictStr] = Field(default=None, description="Required if manual override modifier is not null")
    pricing_type: Optional[StrictStr] = Field(default=None, description="Determines whether this discount should be applied per night, per stay or per person - per night; Required if amount override is not null", alias="pricingType")
    is_valid: Optional[StrictBool] = Field(default=None, alias="isValid")
    has_fixed_discount_modifier: Optional[StrictBool] = Field(default=None, alias="hasFixedDiscountModifier")
    has_percent_discount_modifier: Optional[StrictBool] = Field(default=None, alias="hasPercentDiscountModifier")
    description: Optional[List[LocalizedDescriptionSupplier]] = None
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "hotelIdentifier", "name", "enabled", "items", "modifierOverride", "type", "pricingType", "isValid", "hasFixedDiscountModifier", "hasPercentDiscountModifier", "description"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.items:
            ...
            _dict['items'] = _items
        # override the default output from pydantic by calling `to_dict()` of modifier_override
        if self.modifier_override:
            _dict['modifierOverride'] = self.modifier_override.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [SpecialRateLightweightSupplier.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "modifierOverride": VariableChargeSupplier.from_dict(obj["modifierOverride"]) if obj.get("modifierOverride") is not None else None,
            "type": obj.get("type"),
            "pricingType": obj.get("pricingType"),
            "isValid": obj.get("isValid"),
            "hasFixedDiscountModifier": obj.get("hasFixedDiscountModifier"),
            "hasPercentDiscountModifier": obj.get("hasPercentDiscountModifier"),
            "description": [LocalizedDescriptionSupplier.from_dict(_item) for _item in obj["description"]] if obj.get("description") is not None else None
        })
        return _obj
