...
class SpecialRateBundleSupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "hotelIdentifier", "name", "enabled", "items", "modifierOverride", "type", "pricingType", "isValid", "description", "hasPercentDiscountModifier", "hasFixedDiscountModifier"]
