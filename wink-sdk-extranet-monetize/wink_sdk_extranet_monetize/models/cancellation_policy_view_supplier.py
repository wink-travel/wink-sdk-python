...
class CancellationPolicyViewSupplier(BaseModel):
    """
    ...
    cancellation_policy: CancellationPolicySupplier = Field(alias="cancellationPolicy")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "cancellationPolicy"]
