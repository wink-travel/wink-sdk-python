...
class ContinentRateQualifierSupplier(BaseModel):
    """
    ContinentRateQualifierSupplier
    """ # noqa: E501
    continent: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Continent code")
    __properties: ClassVar[List[str]] = ["continent"]
