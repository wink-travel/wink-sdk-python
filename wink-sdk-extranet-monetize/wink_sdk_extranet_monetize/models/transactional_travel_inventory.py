...
class TransactionalTravelInventory(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescription], Field(min_length=1, max_length=2147483647)] = Field(description="Localized descriptions describing inventory.")
    ...
    multimedias: Optional[List[SimpleMultimedia]] = Field(default=None, description="List of images / videos of item.")
