...
class MinutesBeforeBookingStartDateRateQualifierSupplier(BaseModel):
    """
    MinutesBeforeBookingStartDateRateQualifierSupplier
    """ # noqa: E501
    seconds: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Seconds before day of arrival occurs")
