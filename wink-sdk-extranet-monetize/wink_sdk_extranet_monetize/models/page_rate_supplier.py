...
class PageRateSupplier(BaseModel):
    """
    PageRateSupplier
    """ # noqa: E501
    ...
    content: Optional[List[RateSupplier]] = None
    number: Optional[StrictInt] = None
    pageable: Optional[PageableObjectSupplier] = None
    sort: Optional[SortObjectSupplier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [RateSupplier.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "number": obj.get("number"),
            "pageable": PageableObjectSupplier.from_dict(obj["pageable"]) if obj.get("pageable") is not None else None,
            "sort": SortObjectSupplier.from_dict(obj["sort"]) if obj.get("sort") is not None else None,
