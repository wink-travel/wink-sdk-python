...
class CountryRateQualifierSupplier(BaseModel):
    """
    CountryRateQualifierSupplier
    """ # noqa: E501
    country: GeoNameCountrySupplier = Field(description="country to restrict on")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "country": GeoNameCountrySupplier.from_dict(obj["country"]) if obj.get("country") is not None else None
        })
        return _obj
