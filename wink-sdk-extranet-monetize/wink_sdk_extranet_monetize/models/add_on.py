...
class AddOn(BaseModel):
    ...
    contact: Contact = Field(description="Associate a contact person for this blocking (if applicable).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratePlan": RatePlanLightweight.from_dict(obj["ratePlan"]) if obj.get("ratePlan") is not None else None,
