...
class RoomRangeRateQualifierSupplier(BaseModel):
    """
    RoomRangeRateQualifierSupplier
    """ # noqa: E501
    min_rooms: Annotated[int, Field(strict=True, ge=1)] = Field(description="Minimum number of rooms", alias="minRooms")
    max_rooms: Optional[StrictInt] = Field(default=None, description="Maximum number of rooms", alias="maxRooms")
    __properties: ClassVar[List[str]] = ["minRooms", "maxRooms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minRooms": obj.get("minRooms"),
            "maxRooms": obj.get("maxRooms")
        })
        return _obj
