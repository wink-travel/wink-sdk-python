...
class StateSupplier(BaseModel):
    ...
    sort: Optional[List[SortDescriptorSupplier]] = Field(default=None, description="Descriptors used for sorting result set.")
    filter: Optional[CompositeFilterDescriptorSupplier] = Field(default=None, description="Descriptors used for filtering result set")
    group: Optional[List[GroupDescriptorSupplier]] = Field(default=None, description="Descriptors to group result sets by.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [SortDescriptorSupplier.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
            "filter": CompositeFilterDescriptorSupplier.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "group": [GroupDescriptorSupplier.from_dict(_item) for _item in obj["group"]] if obj.get("group") is not None else None
        })
        return _obj
