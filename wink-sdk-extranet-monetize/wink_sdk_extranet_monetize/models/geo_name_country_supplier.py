...
class GeoNameCountrySupplier(BaseModel):
    """
    ...
    continent_name: Optional[StrictStr] = Field(default=None, alias="continentName")
    ...
    __properties: ClassVar[List[str]] = ["geoNameId", "continentCode", "continentName", "countryIsoCode", "countryName"]
