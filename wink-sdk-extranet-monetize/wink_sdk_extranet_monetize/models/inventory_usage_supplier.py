...
class InventoryUsageSupplier(BaseModel):
    """
    InventoryUsageSupplier
    """ # noqa: E501
    inventory_identifier: UUID = Field(description="Inventory type identifier", alias="inventoryIdentifier")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of the inventory")
    type: StrictStr = Field(description="Inventory type")
    item_list: List[InventoryUsageItemSupplier] = Field(description="How the inventoryIdentifier is currently being used", alias="itemList")
    referenced: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["inventoryIdentifier", "name", "type", "itemList", "referenced"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "type": obj.get("type"),
            "itemList": [InventoryUsageItemSupplier.from_dict(_item) for _item in obj["itemList"]] if obj.get("itemList") is not None else None,
