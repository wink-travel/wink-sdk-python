...
class UpsertRatePlanRequestSupplier(BaseModel):
    """
    ...
    loyalty_points_accrue: StrictBool = Field(description="Property honors loyalty points with this rate plan.", alias="loyaltyPointsAccrue")
    ...
    cancellation_policy_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The cancellation policy for this rate plan.", alias="cancellationPolicyIdentifier")
    cancellation_policy_exceptions: Optional[UpsertCancellationPolicyExceptionsSupplier] = Field(default=None, description="Allows a property to dynamically use another cancellation policy for a specific date range", alias="cancellationPolicyExceptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cancellationPolicyExceptions": UpsertCancellationPolicyExceptionsSupplier.from_dict(obj["cancellationPolicyExceptions"]) if obj.get("cancellationPolicyExceptions") is not None else None,
