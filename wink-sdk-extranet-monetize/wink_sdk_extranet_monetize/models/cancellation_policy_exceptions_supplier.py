...
class CancellationPolicyExceptionsSupplier(BaseModel):
    """
    CancellationPolicyExceptionsSupplier
    """ # noqa: E501
    list: Annotated[List[CancellationPolicyExceptionSupplier], Field(min_length=1)] = Field(description="List of cancellation policy exceptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [CancellationPolicyExceptionSupplier.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
