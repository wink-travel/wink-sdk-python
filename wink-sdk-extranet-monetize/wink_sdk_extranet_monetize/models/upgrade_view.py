...
class UpgradeView(BaseModel):
    ...
    upgrade: Optional[AddOn] = None
    featured_image_identifier: Optional[StrictStr] = Field(default='noimage_opaque_nyrtl0.png', description="Convenience method to easily access the featured image without having to go through the entire list of images. Defaults to placeholder image if no image is present.", alias="featuredImageIdentifier")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "upgrade", "featuredImageIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "upgrade": AddOn.from_dict(obj["upgrade"]) if obj.get("upgrade") is not None else None,
            "featuredImageIdentifier": obj.get("featuredImageIdentifier") if obj.get("featuredImageIdentifier") is not None else 'noimage_opaque_nyrtl0.png'
        })
        return _obj
