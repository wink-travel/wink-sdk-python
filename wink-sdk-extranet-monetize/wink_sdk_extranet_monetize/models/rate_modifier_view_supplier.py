...
class RateModifierViewSupplier(BaseModel):
    """
    ...
    rate_modifier: RateModifierSupplier = Field(alias="rateModifier")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "rateModifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rate_modifier
        if self.rate_modifier:
            _dict['rateModifier'] = self.rate_modifier.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateModifier": RateModifierSupplier.from_dict(obj["rateModifier"]) if obj.get("rateModifier") is not None else None
        })
        return _obj
