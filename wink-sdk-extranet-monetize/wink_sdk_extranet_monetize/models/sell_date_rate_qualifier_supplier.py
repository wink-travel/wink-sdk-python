...
class SellDateRateQualifierSupplier(BaseModel):
    """
    SellDateRateQualifierSupplier
    """ # noqa: E501
    effective_date: date = Field(description="The effective (start) date of the sell date rate qualifier", alias="effectiveDate")
    expire_date: date = Field(description="The expiration (end) date of the sell date rate qualifier", alias="expireDate")
    __properties: ClassVar[List[str]] = ["effectiveDate", "expireDate"]
