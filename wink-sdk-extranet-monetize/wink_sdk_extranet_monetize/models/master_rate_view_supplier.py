...
class MasterRateViewSupplier(BaseModel):
    """
    ...
    master_rate: MasterRateSupplier = Field(alias="masterRate")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "masterRate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of master_rate
        if self.master_rate:
            _dict['masterRate'] = self.master_rate.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "masterRate": MasterRateSupplier.from_dict(obj["masterRate"]) if obj.get("masterRate") is not None else None
        })
        return _obj
