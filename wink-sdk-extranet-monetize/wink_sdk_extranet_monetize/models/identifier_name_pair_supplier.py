...
class IdentifierNamePairSupplier(BaseModel):
    """
    IdentifierNamePairSupplier
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Identifier of associated entity")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Entity name")
