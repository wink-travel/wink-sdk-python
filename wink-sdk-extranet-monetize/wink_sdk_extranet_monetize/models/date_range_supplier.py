...
class DateRangeSupplier(BaseModel):
    """
    DateRangeSupplier
    """ # noqa: E501
    start_date: date = Field(description="Retrieve data range starting with and including this start date", alias="startDate")
    end_date: date = Field(description="Retrieve data range ending with and including this end date", alias="endDate")
