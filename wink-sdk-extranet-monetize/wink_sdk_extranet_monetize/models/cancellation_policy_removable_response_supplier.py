...
class CancellationPolicyRemovableResponseSupplier(BaseModel):
    """
    CancellationPolicyRemovableResponseSupplier
    """ # noqa: E501
    removable: Optional[StrictBool] = None
    rate_plans: Optional[List[IdentifierNamePairSupplier]] = Field(default=None, alias="ratePlans")
    __properties: ClassVar[List[str]] = ["removable", "ratePlans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratePlans": [IdentifierNamePairSupplier.from_dict(_item) for _item in obj["ratePlans"]] if obj.get("ratePlans") is not None else None
        })
        return _obj
