...
class GeoIpLightweightSupplier(BaseModel):
    """
    Uses MaxMind's city lite db to persist GeoIpLightweight objects in our own db.
    """ # noqa: E501
    geo_name_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="GeoNameLightweight identifiers taken from [https://geonames.org](https://geonames.org).", alias="geoNameId")
    locale_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Locale code", alias="localeCode")
    continent_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Continent code", alias="continentCode")
    continent_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Continent name", alias="continentName")
    country_iso_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Country ISO code", alias="countryIsoCode")
    country_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Country name", alias="countryName")
    city_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="City name", alias="cityName")
    timezone: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Timezone")
    sub_division1_code: Optional[StrictStr] = Field(default=None, description="Sub-division 1 code", alias="subDivision1Code")
    sub_division1_name: Optional[StrictStr] = Field(default=None, description="Sub-division 1 name", alias="subDivision1Name")
    sub_division2_code: Optional[StrictStr] = Field(default=None, description="Sub-division 2 code", alias="subDivision2Code")
    sub_division2_name: Optional[StrictStr] = Field(default=None, description="Sub-division 2 name", alias="subDivision2Name")
    __properties: ClassVar[List[str]] = ["geoNameId", "localeCode", "continentCode", "continentName", "countryIsoCode", "countryName", "cityName", "timezone", "subDivision1Code", "subDivision1Name", "subDivision2Code", "subDivision2Name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subDivision1Code": obj.get("subDivision1Code"),
            "subDivision1Name": obj.get("subDivision1Name"),
            "subDivision2Code": obj.get("subDivision2Code"),
            "subDivision2Name": obj.get("subDivision2Name")
        })
        return _obj
