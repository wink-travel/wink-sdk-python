...
class IPRangeRateQualifierSupplier(BaseModel):
    """
    IPRangeRateQualifierSupplier
    """ # noqa: E501
    start_ip_range: Annotated[str, Field(min_length=1, strict=True)] = Field(description="start of IP range", alias="startIPRange")
    end_ip_range: Annotated[str, Field(min_length=1, strict=True)] = Field(description="end of IP range", alias="endIPRange")
    __properties: ClassVar[List[str]] = ["startIPRange", "endIPRange"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "startIPRange": obj.get("startIPRange"),
            "endIPRange": obj.get("endIPRange")
        })
        return _obj
