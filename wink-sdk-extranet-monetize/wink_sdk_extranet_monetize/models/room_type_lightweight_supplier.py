...
class RoomTypeLightweightSupplier(BaseModel):
    ...
    location: GeoJsonPointSupplier = Field(description="Geo-location point where inventory takes place. Defaults to location of property.")
    ...
    contact: ContactSupplier = Field(description="Associate a contact person for this inventory (if applicable).")
