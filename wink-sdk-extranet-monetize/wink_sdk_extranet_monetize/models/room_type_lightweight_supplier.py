...
from wink_sdk_extranet_monetize.models.simple_address import SimpleAddress
...
class RoomTypeLightweightSupplier(BaseModel):
    """
    ...
    location: GeoJsonPoint = Field(description="Geo-location point where inventory takes place. Defaults to location of property.")
    descriptions: Annotated[List[SimpleDescription], Field(min_length=1)] = Field(description="Localized descriptions describing inventory.")
    multimedias: Annotated[List[SimpleMultimedia], Field(min_length=1)] = Field(description="List of images / videos of inventory.")
    contact: Contact = Field(description="Associate a contact person for this inventory (if applicable).")
    address: SimpleAddress = Field(description="Defaults to property address.")
    ...
    socials: Optional[List[Social]] = Field(default=None, description="Social network accounts for inventory (if applicable).")
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    recognition_list: Optional[List[TravelInventoryRecognition]] = Field(default=None, description="Inventory-level recognition.", alias="recognitionList")
    transactional_inventory_list: Optional[List[TransactionalTravelInventory]] = Field(default=None, description="Purchasable items for this inventory.", alias="transactionalInventoryList")
    ...
    bedroom_configuration_list: Annotated[List[BedroomConfigurationSupplier], Field(min_length=1)] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
