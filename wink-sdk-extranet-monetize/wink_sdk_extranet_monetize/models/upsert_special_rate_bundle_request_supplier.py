...
class UpsertSpecialRateBundleRequestSupplier(BaseModel):
    """
    ...
    item_identifiers: Annotated[List[UUID], Field(min_length=2, max_length=2147483647)] = Field(alias="itemIdentifiers")
    ...
    __properties: ClassVar[List[str]] = ["name", "enabled", "itemIdentifiers", "modifierOverride", "type", "pricingType"]
