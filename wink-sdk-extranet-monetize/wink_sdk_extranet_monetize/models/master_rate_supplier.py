...
class MasterRateSupplier(BaseModel):
    ...
    room: Optional[GuestRoomSupplier] = None
    rate_plan: Optional[RatePlanSupplier] = Field(default=None, alias="ratePlan")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "room": GuestRoomSupplier.from_dict(obj["room"]) if obj.get("room") is not None else None,
            "ratePlan": RatePlanSupplier.from_dict(obj["ratePlan"]) if obj.get("ratePlan") is not None else None,
