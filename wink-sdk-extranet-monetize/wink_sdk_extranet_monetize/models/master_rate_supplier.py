...
class MasterRateSupplier(BaseModel):
    """
    MasterRateSupplier
    """ # noqa: E501
    ...
    name: StrictStr = Field(description="Internal name of master rate. The name is generated by guest room and rate plan names respectively.")
    room_type: RoomTypeLightweightSupplier = Field(alias="roomType")
    rate_plan: RatePlanLightweightSupplier = Field(alias="ratePlan")
    enabled: StrictBool = Field(description="Flag to enable / disable master rate across all sales channels")
    perk_types: Optional[List[PerkLightweightSupplier]] = Field(default=None, alias="perkTypes")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "hotelIdentifier", "name", "roomType", "ratePlan", "enabled", "perkTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "roomType": RoomTypeLightweightSupplier.from_dict(obj["roomType"]) if obj.get("roomType") is not None else None,
            "ratePlan": RatePlanLightweightSupplier.from_dict(obj["ratePlan"]) if obj.get("ratePlan") is not None else None,
