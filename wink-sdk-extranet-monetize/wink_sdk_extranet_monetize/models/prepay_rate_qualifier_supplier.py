...
class PrepayRateQualifierSupplier(BaseModel):
    """
    PrepayRateQualifierSupplier
    """ # noqa: E501
    prepay: StrictBool = Field(description="Whether prepay is required or not")
    __properties: ClassVar[List[str]] = ["prepay"]
