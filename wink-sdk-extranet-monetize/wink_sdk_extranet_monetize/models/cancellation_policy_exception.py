...
class CancellationPolicyException(BaseModel):
    """
    ...
    cancellation_policy: CancellationPolicyLightweight = Field(description="Cancellation policy", alias="cancellationPolicy")
