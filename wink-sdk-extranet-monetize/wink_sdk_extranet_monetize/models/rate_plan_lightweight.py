...
class RatePlanLightweight(BaseModel):
    ...
    rate_plan_level_fees: Optional[List[RatePlanLevelFee]] = Field(default=None, alias="ratePlanLevelFees")
    available_days_of_week: Optional[DowPatternGroup] = Field(default=None, alias="availableDaysOfWeek")
    arrival_days_of_week: Optional[DowPatternGroup] = Field(default=None, alias="arrivalDaysOfWeek")
    departure_days_of_week: Optional[DowPatternGroup] = Field(default=None, alias="departureDaysOfWeek")
    required_days_of_week: Optional[DowPatternGroup] = Field(default=None, alias="requiredDaysOfWeek")
    early_check_in_charge: Optional[VariableCharge] = Field(default=None, alias="earlyCheckInCharge")
    late_check_out_charge: Optional[VariableCharge] = Field(default=None, alias="lateCheckOutCharge")
    cancellation_policy: Optional[CancellationPolicyLightweight] = Field(default=None, description="The cancellation policy for this rate plan.", alias="cancellationPolicy")
    cancellation_policy_exceptions: Optional[CancellationPolicyExceptions] = Field(default=None, description="Allows a property to dynamically use another cancellation policy for a specific date range", alias="cancellationPolicyExceptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratePlanLevelFees": [RatePlanLevelFee.from_dict(_item) for _item in obj["ratePlanLevelFees"]] if obj.get("ratePlanLevelFees") is not None else None,
            "availableDaysOfWeek": DowPatternGroup.from_dict(obj["availableDaysOfWeek"]) if obj.get("availableDaysOfWeek") is not None else None,
            "arrivalDaysOfWeek": DowPatternGroup.from_dict(obj["arrivalDaysOfWeek"]) if obj.get("arrivalDaysOfWeek") is not None else None,
            "departureDaysOfWeek": DowPatternGroup.from_dict(obj["departureDaysOfWeek"]) if obj.get("departureDaysOfWeek") is not None else None,
            "requiredDaysOfWeek": DowPatternGroup.from_dict(obj["requiredDaysOfWeek"]) if obj.get("requiredDaysOfWeek") is not None else None,
            "earlyCheckInCharge": VariableCharge.from_dict(obj["earlyCheckInCharge"]) if obj.get("earlyCheckInCharge") is not None else None,
            "lateCheckOutCharge": VariableCharge.from_dict(obj["lateCheckOutCharge"]) if obj.get("lateCheckOutCharge") is not None else None,
            "cancellationPolicy": CancellationPolicyLightweight.from_dict(obj["cancellationPolicy"]) if obj.get("cancellationPolicy") is not None else None,
            "cancellationPolicyExceptions": CancellationPolicyExceptions.from_dict(obj["cancellationPolicyExceptions"]) if obj.get("cancellationPolicyExceptions") is not None else None,
