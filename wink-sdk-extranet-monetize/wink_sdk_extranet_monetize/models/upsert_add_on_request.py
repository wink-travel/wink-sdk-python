...
class UpsertAddOnRequest(BaseModel):
    ...
    descriptions: List[SimpleDescription] = Field(description="Localized descriptions describing blocking.")
    multimedias: List[SimpleMultimedia] = Field(description="List of images / videos of blocking.")
    ...
    days_of_week: Optional[DowPatternGroup] = Field(default=None, alias="daysOfWeek")
