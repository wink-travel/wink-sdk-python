...
class AvailableDaysOfWeekRateQualifierSupplier(BaseModel):
    """
    AvailableDaysOfWeekRateQualifierSupplier
    """ # noqa: E501
    days_of_week: DowPatternGroupSupplier = Field(description="The days of the week when this rate is available", alias="daysOfWeek")
