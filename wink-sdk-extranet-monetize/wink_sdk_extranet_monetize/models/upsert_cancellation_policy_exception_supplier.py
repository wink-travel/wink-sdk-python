...
class UpsertCancellationPolicyExceptionSupplier(BaseModel):
    """
    UpsertCancellationPolicyExceptionSupplier
    """ # noqa: E501
    cancellation_policy_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Cancellation policy", alias="cancellationPolicyIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["cancellationPolicyIdentifier", "startDate", "endDate"]
