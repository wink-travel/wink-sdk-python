...
from wink_sdk_extranet_monetize.configuration import Configuration
from wink_sdk_extranet_monetize.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_extranet_monetize.models
from wink_sdk_extranet_monetize import rest
from wink_sdk_extranet_monetize.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_extranet_monetize.models, klass)
