...
**bedroom_configuration_list** | [**List[BedroomConfigurationNonAuthenticatedEntity]**](BedroomConfigurationNonAuthenticatedEntity.md) | A room type can have more than one bed configuration. | 
...
guest_room_lightweight_non_authenticated_entity_instance = GuestRoomLightweightNonAuthenticatedEntity.from_json(json)
# print the JSON string representation of the object
print(GuestRoomLightweightNonAuthenticatedEntity.to_json())

# convert the object into a dict
guest_room_lightweight_non_authenticated_entity_dict = guest_room_lightweight_non_authenticated_entity_instance.to_dict()
# create an instance of GuestRoomLightweightNonAuthenticatedEntity from a dict
guest_room_lightweight_non_authenticated_entity_from_dict = GuestRoomLightweightNonAuthenticatedEntity.from_dict(guest_room_lightweight_non_authenticated_entity_dict)
```
