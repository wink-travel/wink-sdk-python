...
**rate_plan** | [**RatePlanNonAuthenticatedEntity**](RatePlanNonAuthenticatedEntity.md) |  | [optional] 
...
add_on_non_authenticated_entity_instance = AddOnNonAuthenticatedEntity.from_json(json)
# print the JSON string representation of the object
print(AddOnNonAuthenticatedEntity.to_json())

# convert the object into a dict
add_on_non_authenticated_entity_dict = add_on_non_authenticated_entity_instance.to_dict()
# create an instance of AddOnNonAuthenticatedEntity from a dict
add_on_non_authenticated_entity_from_dict = AddOnNonAuthenticatedEntity.from_dict(add_on_non_authenticated_entity_dict)
```
