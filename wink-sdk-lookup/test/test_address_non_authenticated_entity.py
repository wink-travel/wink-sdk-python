...
class TestAddressNonAuthenticatedEntity(unittest.TestCase):
    """AddressNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressNonAuthenticatedEntity:
        """Test AddressNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressNonAuthenticatedEntity`
        """
        model = AddressNonAuthenticatedEntity()
        if include_optional:
            return AddressNonAuthenticatedEntity(
    ...
    def testAddressNonAuthenticatedEntity(self):
        """Test AddressNonAuthenticatedEntity"""
