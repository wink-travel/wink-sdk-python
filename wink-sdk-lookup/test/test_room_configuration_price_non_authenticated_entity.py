...
class TestRoomConfigurationPriceNonAuthenticatedEntity(unittest.TestCase):
    """RoomConfigurationPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceNonAuthenticatedEntity:
        """Test RoomConfigurationPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationPriceNonAuthenticatedEntity`
        """
        model = RoomConfigurationPriceNonAuthenticatedEntity()
        if include_optional:
            return RoomConfigurationPriceNonAuthenticatedEntity(
                adults = 56,
                children = 56,
                    ...
                    items = [
                        wink_sdk_lookup.models.items.Items(
                            rate_plan_level_fee = wink_sdk_lookup.models.rate_plan_level_fee_non_authenticated_entity.RatePlanLevelFee_Non_Authenticated_Entity(
                                ...
                                fixed_amount = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                                    amount = 1.337, 
                                    currency = '', ), 
                                type = 'PER_DAY', ), 
                ...
                add_on_offers = [
                    wink_sdk_lookup.models.add_on_localized_inventory_non_authenticated_entity.AddOnLocalizedInventory_Non_Authenticated_Entity(
                        add_on = wink_sdk_lookup.models.add_on_non_authenticated_entity.AddOn_Non_Authenticated_Entity(
                            ...
                            opens = '09:00', 
                            closes = '17:30', 
                            days_of_week = wink_sdk_lookup.models.dow_pattern_group_non_authenticated_entity.DowPatternGroup_Non_Authenticated_Entity(
                                mon = True, 
                                tue = True, 
                                wed = True, 
                                thu = True, 
                ...
                perk_value = 56,
                active_cancellation_policy = wink_sdk_lookup.models.cancellation_policy_non_authenticated_entity.CancellationPolicy_Non_Authenticated_Entity(
                    identifier = '', 
                    hotel_identifier = '', 
                    refundable = False, 
                    advance_cancellation_free_of_charge = 'UNTIL_EIGHTEEN_HUNDRED_HOURS_ON_DAY_OF_ARRIVAL', 
                ...
                source_total = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                user_specified_currency_total = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                internal_total = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                available = True,
                rate_source = ''
    ...
    def testRoomConfigurationPriceNonAuthenticatedEntity(self):
        """Test RoomConfigurationPriceNonAuthenticatedEntity"""
