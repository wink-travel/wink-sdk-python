...
class TestSimpleAddressNonAuthenticatedEntity(unittest.TestCase):
    """SimpleAddressNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleAddressNonAuthenticatedEntity:
        """Test SimpleAddressNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleAddressNonAuthenticatedEntity`
        """
        model = SimpleAddressNonAuthenticatedEntity()
        if include_optional:
            return SimpleAddressNonAuthenticatedEntity(
    ...
    def testSimpleAddressNonAuthenticatedEntity(self):
        """Test SimpleAddressNonAuthenticatedEntity"""
