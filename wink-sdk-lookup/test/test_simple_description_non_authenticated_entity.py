...
class TestSimpleDescriptionNonAuthenticatedEntity(unittest.TestCase):
    """SimpleDescriptionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDescriptionNonAuthenticatedEntity:
        """Test SimpleDescriptionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDescriptionNonAuthenticatedEntity`
        """
        model = SimpleDescriptionNonAuthenticatedEntity()
        if include_optional:
            return SimpleDescriptionNonAuthenticatedEntity(
    ...
    def testSimpleDescriptionNonAuthenticatedEntity(self):
        """Test SimpleDescriptionNonAuthenticatedEntity"""
