...
class TestCancellationPolicyExceptionNonAuthenticatedEntity(unittest.TestCase):
    """CancellationPolicyExceptionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionNonAuthenticatedEntity:
        """Test CancellationPolicyExceptionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionNonAuthenticatedEntity`
        """
        model = CancellationPolicyExceptionNonAuthenticatedEntity()
        if include_optional:
            return CancellationPolicyExceptionNonAuthenticatedEntity(
    ...
    def testCancellationPolicyExceptionNonAuthenticatedEntity(self):
        """Test CancellationPolicyExceptionNonAuthenticatedEntity"""
