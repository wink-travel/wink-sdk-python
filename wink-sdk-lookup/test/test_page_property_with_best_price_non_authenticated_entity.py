...
class TestPagePropertyWithBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """PagePropertyWithBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagePropertyWithBestPriceNonAuthenticatedEntity:
        """Test PagePropertyWithBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagePropertyWithBestPriceNonAuthenticatedEntity`
        """
        model = PagePropertyWithBestPriceNonAuthenticatedEntity()
        if include_optional:
            return PagePropertyWithBestPriceNonAuthenticatedEntity(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
                    wink_sdk_lookup.models.property_with_best_price_non_authenticated_entity.PropertyWithBestPrice_Non_Authenticated_Entity(
                        hotel = wink_sdk_lookup.models.property_aggregate_lightweight_non_authenticated_entity.PropertyAggregateLightweight_Non_Authenticated_Entity(
                            ...
                            number_of_rooms = 32, 
                            address = wink_sdk_lookup.models.simple_address_non_authenticated_entity.SimpleAddress_Non_Authenticated_Entity(
                                address1 = '234', 
                            ...
                            active = True, 
                            url_parameters = '', ), 
                        lowest_price = wink_sdk_lookup.models.room_type_best_price_non_authenticated_entity.RoomTypeBestPrice_Non_Authenticated_Entity(
                            ...
                            price = wink_sdk_lookup.models.room_configuration_price_non_authenticated_entity.RoomConfigurationPrice_Non_Authenticated_Entity(
                                ...
                                rate_plan = wink_sdk_lookup.models.room_configuration_price_rate_plan_non_authenticated_entity.RoomConfigurationPriceRatePlan_Non_Authenticated_Entity(
                                    identifier = '0', 
                                    name = 'BAR 1', 
                                    breakfast = False, 
                                    brunch = False, 
                                    ...
                                    cancellation_policy = wink_sdk_lookup.models.cancellation_policy_lightweight_non_authenticated_entity.CancellationPolicyLightweight_Non_Authenticated_Entity(
                                        identifier = '', 
                                        hotel_identifier = '', 
                                        refundable = False, 
                                ...
                                price = wink_sdk_lookup.models.stay_rate_non_authenticated_entity.StayRate_Non_Authenticated_Entity(
                                    ...
                                    available = True, 
                                    source_to_user_currency_quote = wink_sdk_lookup.models.quote_lightweight_non_authenticated_entity.QuoteLightweight_Non_Authenticated_Entity(
                                        source = '0', 
                                        target = '0', 
                                        exchange_rate = 1.337, 
                                        timestamp = 56, ), 
                                    source_to_internal_currency_quote = wink_sdk_lookup.models.quote_lightweight_non_authenticated_entity.QuoteLightweight_Non_Authenticated_Entity(
                                        source = '0', 
                                        target = '0', 
                                        exchange_rate = 1.337, 
                                        timestamp = 56, ), 
                                ...
                                extra_charges = wink_sdk_lookup.models.extra_charges_non_authenticated_entity.ExtraCharges_Non_Authenticated_Entity(
                                    items = [
                                        wink_sdk_lookup.models.extra_charge_non_authenticated_entity.ExtraCharge_Non_Authenticated_Entity(
                            ...
                            sort = 56, ), 
                        room_type_list = [
                            wink_sdk_lookup.models.guest_room_lightweight_non_authenticated_entity.GuestRoomLightweight_Non_Authenticated_Entity(
                ...
                sort = wink_sdk_lookup.models.sort_object_non_authenticated_entity.SortObject_Non_Authenticated_Entity(
                    empty = True, 
                    sorted = True, 
                    unsorted = True, ),
                pageable = wink_sdk_lookup.models.pageable_object_non_authenticated_entity.PageableObject_Non_Authenticated_Entity(
                    offset = 56, 
                    unpaged = True, 
                    sort = wink_sdk_lookup.models.sort_object_non_authenticated_entity.SortObject_Non_Authenticated_Entity(
                        empty = True, 
    ...
    def testPagePropertyWithBestPriceNonAuthenticatedEntity(self):
        """Test PagePropertyWithBestPriceNonAuthenticatedEntity"""
