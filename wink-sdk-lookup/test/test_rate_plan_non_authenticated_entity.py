        ...
        if include_optional:
            return RatePlanNonAuthenticatedEntity(
                ...
                arrival_days_of_week = wink_sdk_lookup.models.dow_pattern_group_non_authenticated_entity.DowPatternGroup_Non_Authenticated_Entity(
                    ...
                    sun = True, 
                    disabled = True, ),
                departure_days_of_week = wink_sdk_lookup.models.dow_pattern_group_non_authenticated_entity.DowPatternGroup_Non_Authenticated_Entity(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                required_days_of_week = wink_sdk_lookup.models.dow_pattern_group_non_authenticated_entity.DowPatternGroup_Non_Authenticated_Entity(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
