...
class TestPropertyPolicyNonAuthenticatedEntity(unittest.TestCase):
    """PropertyPolicyNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyPolicyNonAuthenticatedEntity:
        """Test PropertyPolicyNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyPolicyNonAuthenticatedEntity`
        """
        model = PropertyPolicyNonAuthenticatedEntity()
        if include_optional:
            return PropertyPolicyNonAuthenticatedEntity(
    ...
    def testPropertyPolicyNonAuthenticatedEntity(self):
        """Test PropertyPolicyNonAuthenticatedEntity"""
