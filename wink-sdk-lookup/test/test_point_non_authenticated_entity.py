...
class TestPointNonAuthenticatedEntity(unittest.TestCase):
    """PointNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PointNonAuthenticatedEntity:
        """Test PointNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointNonAuthenticatedEntity`
        """
        model = PointNonAuthenticatedEntity()
        if include_optional:
            return PointNonAuthenticatedEntity(
                x = 1.337,
                y = 1.337
            )
        else:
    ...
    def testPointNonAuthenticatedEntity(self):
        """Test PointNonAuthenticatedEntity"""
