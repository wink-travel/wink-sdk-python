...
class TestSocialNonAuthenticatedEntity(unittest.TestCase):
    """SocialNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialNonAuthenticatedEntity:
        """Test SocialNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SocialNonAuthenticatedEntity`
        """
        model = SocialNonAuthenticatedEntity()
        if include_optional:
            return SocialNonAuthenticatedEntity(
                type = 'FACEBOOK',
                location = '',
                enabled = True
            )
    ...
    def testSocialNonAuthenticatedEntity(self):
        """Test SocialNonAuthenticatedEntity"""
