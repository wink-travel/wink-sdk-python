...
class TestCancellationPolicyNonAuthenticatedEntity(unittest.TestCase):
    """CancellationPolicyNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyNonAuthenticatedEntity:
        """Test CancellationPolicyNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyNonAuthenticatedEntity`
        """
        model = CancellationPolicyNonAuthenticatedEntity()
        if include_optional:
            return CancellationPolicyNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyNonAuthenticatedEntity(self):
        """Test CancellationPolicyNonAuthenticatedEntity"""
