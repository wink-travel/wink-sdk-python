...
class TestPageHotelWithBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """PageHotelWithBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageHotelWithBestPriceNonAuthenticatedEntity:
        """Test PageHotelWithBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageHotelWithBestPriceNonAuthenticatedEntity`
        """
        model = PageHotelWithBestPriceNonAuthenticatedEntity()
        if include_optional:
            return PageHotelWithBestPriceNonAuthenticatedEntity(
                ...
                size = 56,
                content = [
                    wink_sdk_lookup.models.hotel_with_best_price_non_authenticated_entity.HotelWithBestPrice_Non_Authenticated_Entity(
                ...
                number = 56,
                sort = [
                    wink_sdk_lookup.models.sort_object.SortObject(
                        direction = '', 
                        null_handling = '', 
                        ascending = True, 
                        property = '', 
    ...
    def testPageHotelWithBestPriceNonAuthenticatedEntity(self):
        """Test PageHotelWithBestPriceNonAuthenticatedEntity"""
