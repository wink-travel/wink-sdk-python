...
class TestAddOnLightweightNonAuthenticatedEntity(unittest.TestCase):
    """AddOnLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOnLightweightNonAuthenticatedEntity:
        """Test AddOnLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOnLightweightNonAuthenticatedEntity`
        """
        model = AddOnLightweightNonAuthenticatedEntity()
        if include_optional:
            return AddOnLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testAddOnLightweightNonAuthenticatedEntity(self):
        """Test AddOnLightweightNonAuthenticatedEntity"""
