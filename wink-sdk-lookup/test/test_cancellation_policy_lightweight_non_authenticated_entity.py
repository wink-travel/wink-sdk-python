...
class TestCancellationPolicyLightweightNonAuthenticatedEntity(unittest.TestCase):
    """CancellationPolicyLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyLightweightNonAuthenticatedEntity:
        """Test CancellationPolicyLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyLightweightNonAuthenticatedEntity`
        """
        model = CancellationPolicyLightweightNonAuthenticatedEntity()
        if include_optional:
            return CancellationPolicyLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyLightweightNonAuthenticatedEntity(self):
        """Test CancellationPolicyLightweightNonAuthenticatedEntity"""
