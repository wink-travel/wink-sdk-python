...
class TestAddOnLocalizedInventoryNonAuthenticatedEntity(unittest.TestCase):
    """AddOnLocalizedInventoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOnLocalizedInventoryNonAuthenticatedEntity:
        """Test AddOnLocalizedInventoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOnLocalizedInventoryNonAuthenticatedEntity`
        """
        model = AddOnLocalizedInventoryNonAuthenticatedEntity()
        if include_optional:
            return AddOnLocalizedInventoryNonAuthenticatedEntity(
    ...
    def testAddOnLocalizedInventoryNonAuthenticatedEntity(self):
        """Test AddOnLocalizedInventoryNonAuthenticatedEntity"""
