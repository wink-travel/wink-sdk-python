...
class TestAddOnNonAuthenticatedEntity(unittest.TestCase):
    """AddOnNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOnNonAuthenticatedEntity:
        """Test AddOnNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOnNonAuthenticatedEntity`
        """
        model = AddOnNonAuthenticatedEntity()
        if include_optional:
            return AddOnNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testAddOnNonAuthenticatedEntity(self):
        """Test AddOnNonAuthenticatedEntity"""
