...
class TestCountryNonAuthenticatedEntity(unittest.TestCase):
    """CountryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryNonAuthenticatedEntity:
        """Test CountryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryNonAuthenticatedEntity`
        """
        model = CountryNonAuthenticatedEntity()
        if include_optional:
            return CountryNonAuthenticatedEntity(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
    ...
    def testCountryNonAuthenticatedEntity(self):
        """Test CountryNonAuthenticatedEntity"""
