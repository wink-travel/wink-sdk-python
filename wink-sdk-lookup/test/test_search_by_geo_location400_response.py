...
class TestSearchByGeoLocation400Response(unittest.TestCase):
    """SearchByGeoLocation400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchByGeoLocation400Response:
        """Test SearchByGeoLocation400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchByGeoLocation400Response`
        """
        model = SearchByGeoLocation400Response()
        if include_optional:
            return SearchByGeoLocation400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testSearchByGeoLocation400Response(self):
        """Test SearchByGeoLocation400Response"""
