...
class TestSubCountryNonAuthenticatedEntity(unittest.TestCase):
    """SubCountryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryNonAuthenticatedEntity:
        """Test SubCountryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryNonAuthenticatedEntity`
        """
        model = SubCountryNonAuthenticatedEntity()
        if include_optional:
            return SubCountryNonAuthenticatedEntity(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountryNonAuthenticatedEntity(self):
        """Test SubCountryNonAuthenticatedEntity"""
