...
class TestRoomTypeWithPriceConfigurationNonAuthenticatedEntity(unittest.TestCase):
    """RoomTypeWithPriceConfigurationNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomTypeWithPriceConfigurationNonAuthenticatedEntity:
        """Test RoomTypeWithPriceConfigurationNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomTypeWithPriceConfigurationNonAuthenticatedEntity`
        """
        model = RoomTypeWithPriceConfigurationNonAuthenticatedEntity()
        if include_optional:
            return RoomTypeWithPriceConfigurationNonAuthenticatedEntity(
    ...
    def testRoomTypeWithPriceConfigurationNonAuthenticatedEntity(self):
        """Test RoomTypeWithPriceConfigurationNonAuthenticatedEntity"""
