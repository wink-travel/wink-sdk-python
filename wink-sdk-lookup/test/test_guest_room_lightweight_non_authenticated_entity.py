...
class TestGuestRoomLightweightNonAuthenticatedEntity(unittest.TestCase):
    """GuestRoomLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomLightweightNonAuthenticatedEntity:
        """Test GuestRoomLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomLightweightNonAuthenticatedEntity`
        """
        model = GuestRoomLightweightNonAuthenticatedEntity()
        if include_optional:
            return GuestRoomLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testGuestRoomLightweightNonAuthenticatedEntity(self):
        """Test GuestRoomLightweightNonAuthenticatedEntity"""
