...
class TestHotelOnMapLightweightNonAuthenticatedEntity(unittest.TestCase):
    """HotelOnMapLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelOnMapLightweightNonAuthenticatedEntity:
        """Test HotelOnMapLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelOnMapLightweightNonAuthenticatedEntity`
        """
        model = HotelOnMapLightweightNonAuthenticatedEntity()
        if include_optional:
            return HotelOnMapLightweightNonAuthenticatedEntity(
                hotel_identifier = '',
                ...
                general_manager = wink_sdk_lookup.models.general_manager_non_authenticated_entity.GeneralManager_Non_Authenticated_Entity(
                    name = 'Jane Doe', 
                    image = wink_sdk_lookup.models.simple_multimedia_non_authenticated_entity.SimpleMultimedia_Non_Authenticated_Entity(
                        multimedia_identifier = '', 
                        identifier = 'cloudinary-image-1', 
                        type = 'IMAGE', 
                        source = 'CLOUDINARY', 
    ...
    def testHotelOnMapLightweightNonAuthenticatedEntity(self):
        """Test HotelOnMapLightweightNonAuthenticatedEntity"""
