...
class TestPropertyAggregateLightweightNonAuthenticatedEntity(unittest.TestCase):
    """PropertyAggregateLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateLightweightNonAuthenticatedEntity:
        """Test PropertyAggregateLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateLightweightNonAuthenticatedEntity`
        """
        model = PropertyAggregateLightweightNonAuthenticatedEntity()
        if include_optional:
            return PropertyAggregateLightweightNonAuthenticatedEntity(
    ...
    def testPropertyAggregateLightweightNonAuthenticatedEntity(self):
        """Test PropertyAggregateLightweightNonAuthenticatedEntity"""
