        ...
        if include_optional:
            return StayRateNonAuthenticatedEntity(
                ...
                source_base_total = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                internal_base_total = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                ...
                internal_total = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                user_specified_currency_average_price_per_night = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                internal_average_price_per_night = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                source_average_price_per_night = wink_sdk_lookup.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
