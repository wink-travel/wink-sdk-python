...
class TestLocalizedDescriptionNonAuthenticatedEntity(unittest.TestCase):
    """LocalizedDescriptionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedDescriptionNonAuthenticatedEntity:
        """Test LocalizedDescriptionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedDescriptionNonAuthenticatedEntity`
        """
        model = LocalizedDescriptionNonAuthenticatedEntity()
        if include_optional:
            return LocalizedDescriptionNonAuthenticatedEntity(
    ...
    def testLocalizedDescriptionNonAuthenticatedEntity(self):
        """Test LocalizedDescriptionNonAuthenticatedEntity"""
