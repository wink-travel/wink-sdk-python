...
class GeoJsonLineStringNonAuthenticatedEntity(BaseModel):
    """
    GeoJsonLineStringNonAuthenticatedEntity
    """ # noqa: E501
    type: Optional[StrictStr] = None
    coordinates: Optional[List[PointNonAuthenticatedEntity]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "coordinates": [PointNonAuthenticatedEntity.from_dict(_item) for _item in obj["coordinates"]] if obj.get("coordinates") is not None else None
        })
        return _obj
