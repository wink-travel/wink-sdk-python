...
class CitySearchRequestNonAuthenticatedEntity(BaseModel):
    """
    City search request
    """ # noqa: E501
    geo_name_id: StrictStr = Field(description="GeoNameLightweight identifier from the [https://geonames.org](https://geonames.org) dataset.", alias="geoNameId")
    ...
    __properties: ClassVar[List[str]] = ["geoNameId", "userSession", "searchFilters", "page", "size"]
