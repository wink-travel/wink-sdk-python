...
class GeoJsonPolygonNonAuthenticatedEntity(BaseModel):
    """
    GeoJsonPolygonNonAuthenticatedEntity
    """ # noqa: E501
    points: Optional[List[PointNonAuthenticatedEntity]] = None
    coordinates: Optional[List[GeoJsonLineStringNonAuthenticatedEntity]] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["points", "coordinates", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "points": [PointNonAuthenticatedEntity.from_dict(_item) for _item in obj["points"]] if obj.get("points") is not None else None,
            "coordinates": [GeoJsonLineStringNonAuthenticatedEntity.from_dict(_item) for _item in obj["coordinates"]] if obj.get("coordinates") is not None else None,
            "type": obj.get("type")
        })
        return _obj
