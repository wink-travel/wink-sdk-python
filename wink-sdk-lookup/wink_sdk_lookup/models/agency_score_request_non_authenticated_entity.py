...
class AgencyScoreRequestNonAuthenticatedEntity(BaseModel):
    """
    AgencyScoreRequestNonAuthenticatedEntity
    """ # noqa: E501
    city_url_name_or_country_code: Optional[StrictStr] = Field(default=None, description="Unique url name for city or country code for country.", alias="cityUrlNameOrCountryCode")
    ...
    __properties: ClassVar[List[str]] = ["cityUrlNameOrCountryCode", "sort", "userSession", "page", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cityUrlNameOrCountryCode": obj.get("cityUrlNameOrCountryCode"),
            "sort": obj.get("sort"),
