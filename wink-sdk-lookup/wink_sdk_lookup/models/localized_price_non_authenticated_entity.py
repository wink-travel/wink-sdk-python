...
class LocalizedPriceNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sourceToUserCurrencyQuote", "sourceToInternalCurrencyQuote", "userSpecifiedCurrencyBaseTotal", "sourceBaseTotal", "internalBaseTotal", "userSpecifiedCurrencyPromotionalModifier", "sourcePromotionalModifier", "internalPromotionalModifier", "userSpecifiedCurrencyPremiumModifier", "sourcePremiumModifier", "internalPremiumModifier", "userSpecifiedCurrencyChannelModifier", "sourceChannelModifier", "internalChannelModifier", "quantity", "promotionalDiscountPercent", "channelDiscountPercent", "premiumPercent", "hasChannelDiscount", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "hasPremium", "hasPromotion", "totalDiscountPercent"]
