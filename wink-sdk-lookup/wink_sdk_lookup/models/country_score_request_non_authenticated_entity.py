...
class CountryScoreRequestNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    country_code: StrictStr = Field(description="Unique country code you want to search in as it was given to you in the lookup entry or by using standard country codes as defined here [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2).", alias="countryCode")
    ...
    search_filters: Optional[SearchFiltersNonAuthenticatedEntity] = Field(default=None, alias="searchFilters")
    page: Annotated[int, Field(strict=True, ge=0)] = Field(description="The page to paginate to. Note: Page uses a 0-based index.")
    size: Annotated[int, Field(le=50, strict=True, ge=1)] = Field(description="The result size to return.")
