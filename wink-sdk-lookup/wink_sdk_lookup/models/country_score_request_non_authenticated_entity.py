...
class CountryScoreRequestNonAuthenticatedEntity(BaseModel):
    """
    CountryScoreRequestNonAuthenticatedEntity
    """ # noqa: E501
    country_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique country code you want to search in as it was given to you in the lookup entry or by using standard country codes as defined here [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2).", alias="countryCode")
    sort: StrictStr = Field(description="Choose the criteria you want the results sorted on.")
    user_session: UserSessionNonAuthenticatedEntity = Field(description="User session is the current search state. SimpleDateTimeItinerary and other data points are all included here.", alias="userSession")
    search_filters: Optional[SearchFiltersNonAuthenticatedEntity] = Field(default=None, description="How user likes to have results displayed", alias="searchFilters")
    page: Annotated[int, Field(strict=True, ge=0)] = Field(description="The page to paginate to. Note: Page uses a 0-based index.")
    size: Annotated[int, Field(le=20, strict=True, ge=1)] = Field(description="The result size to return.")
    __properties: ClassVar[List[str]] = ["countryCode", "sort", "userSession", "searchFilters", "page", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchFilters": SearchFiltersNonAuthenticatedEntity.from_dict(obj["searchFilters"]) if obj.get("searchFilters") is not None else None,
            "page": obj.get("page") if obj.get("page") is not None else 0,
            "size": obj.get("size") if obj.get("size") is not None else 6
        })
        return _obj
