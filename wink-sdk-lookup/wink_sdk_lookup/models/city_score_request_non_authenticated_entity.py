...
class CityScoreRequestNonAuthenticatedEntity(BaseModel):
    """
    CityScoreRequestNonAuthenticatedEntity
    """ # noqa: E501
    url_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique url name for city you wish to search in as it was given to you in the lookup entry.", alias="urlName")
    ...
    __properties: ClassVar[List[str]] = ["urlName", "sort", "userSession", "searchFilters", "page", "size"]
