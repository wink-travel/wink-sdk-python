...
class AddressNonAuthenticatedEntity(BaseModel):
    """
    Address information
    """ # noqa: E501
    ...
    city: GeoNameNonAuthenticatedEntity
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "city": GeoNameNonAuthenticatedEntity.from_dict(obj["city"]) if obj.get("city") is not None else None,
            "valid": obj.get("valid"),
