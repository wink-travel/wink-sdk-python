...
class RoomConfigurationPriceNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["channelInventoryIdentifier", "list", "commissionable", "commission", "direct", "adults", "children", "startDate", "endDate", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "price", "extraCharges", "configuration", "addOnOffers", "perkValue", "activeCancellationPolicy", "roomNights", "priceList", "available", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "rateSource"]
