...
class MapRequestNonAuthenticatedEntity(BaseModel):
    """
    MapRequestNonAuthenticatedEntity
    """ # noqa: E501
    user_session: UserSessionNonAuthenticatedEntity = Field(description="User session containing geo-location to search around.", alias="userSession")
    location: Optional[GeoJsonPointNonAuthenticatedEntity] = Field(default=None, description="User's last map location")
    bounds: Optional[GeoJsonPolygonNonAuthenticatedEntity] = Field(default=None, description="Map bounds the user is looking. Bounds provided by map provider.")
    ...
    inventory_types: Optional[List[StrictStr]] = Field(default=None, alias="inventoryTypes")
    page: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=0, description="The page to paginate to. Note: Page uses a 0-based index.")
    size: Optional[Annotated[int, Field(le=20, strict=True, ge=1)]] = Field(default=10, description="The result size to return.")
    __properties: ClassVar[List[str]] = ["userSession", "location", "bounds", "searchFilters", "inventoryTypes", "page", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bounds": GeoJsonPolygonNonAuthenticatedEntity.from_dict(obj["bounds"]) if obj.get("bounds") is not None else None,
