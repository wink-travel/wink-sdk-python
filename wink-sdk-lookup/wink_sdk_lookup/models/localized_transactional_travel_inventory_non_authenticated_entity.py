...
class LocalizedTransactionalTravelInventoryNonAuthenticatedEntity(BaseModel):
    ...
    descriptions: Annotated[List[SimpleDescriptionNonAuthenticatedEntity], Field(min_length=1, max_length=2147483647)] = Field(description="Localized descriptions describing blocking.")
    pricing_type: StrictStr = Field(description="How this blocking item should be priced.", alias="pricingType")
    price: LocalizedPriceNonAuthenticatedEntity
