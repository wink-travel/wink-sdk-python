...
class LocalizedTransactionalTravelInventoryNonAuthenticatedEntity(BaseModel):
    ...
    descriptions: Annotated[List[SimpleDescriptionNonAuthenticatedEntity], Field(min_length=1, max_length=2147483647)]
    ...
    multimedias: Optional[List[SimpleMultimediaNonAuthenticatedEntity]] = None
