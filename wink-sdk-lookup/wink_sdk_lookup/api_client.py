...
from wink_sdk_lookup.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_lookup.models
from wink_sdk_lookup import rest
from wink_sdk_lookup.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_lookup.models, klass)
