...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.36#egg=wink_sdk_lookup&subdirectory=wink-sdk-lookup
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.36#egg=wink_sdk_lookup&subdirectory=wink_sdk_lookup`)
