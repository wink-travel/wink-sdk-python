...
from wink_sdk_ping.configuration import Configuration
from wink_sdk_ping.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_ping.models
from wink_sdk_ping import rest
from wink_sdk_ping.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_ping.models, klass)
