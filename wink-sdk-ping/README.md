...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.57#egg=wink_sdk_ping&subdirectory=wink-sdk-ping
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.57#egg=wink_sdk_ping&subdirectory=wink_sdk_ping`)
