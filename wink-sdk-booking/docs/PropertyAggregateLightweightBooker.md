...
**location** | [**GeoJsonPointBooker**](GeoJsonPointBooker.md) | Geo-location | [optional] 
**descriptions** | [**List[SimpleDescriptionBooker]**](SimpleDescriptionBooker.md) | Short and long welcome text | [optional] 
...
**reservations** | [**ContactBooker**](ContactBooker.md) | Contact details for reservations desk | [optional] 
**socials** | [**List[SocialBooker]**](SocialBooker.md) | Property&#39;s social network accounts | [optional] 
**images** | [**List[SimpleMultimediaBooker]**](SimpleMultimediaBooker.md) | Property images. | [optional] 
**videos** | [**List[SimpleMultimediaBooker]**](SimpleMultimediaBooker.md) | Property videos. | [optional] 
**policy** | [**PropertyPolicyBooker**](PropertyPolicyBooker.md) | Basic property policy record. | [optional] 
**third_party_reviews** | [**List[TravelInventoryRecognitionBooker]**](TravelInventoryRecognitionBooker.md) | Array of awards and third party reviews given to property by certified / non-certified providers. | [optional] 
...
**general_manager** | [**GeneralManagerBooker**](GeneralManagerBooker.md) |  | [optional] 
...
**address** | [**SimpleAddressBooker**](SimpleAddressBooker.md) | Property address. | [optional] 
...
property_aggregate_lightweight_booker_instance = PropertyAggregateLightweightBooker.from_json(json)
# print the JSON string representation of the object
print(PropertyAggregateLightweightBooker.to_json())

# convert the object into a dict
property_aggregate_lightweight_booker_dict = property_aggregate_lightweight_booker_instance.to_dict()
# create an instance of PropertyAggregateLightweightBooker from a dict
property_aggregate_lightweight_booker_from_dict = PropertyAggregateLightweightBooker.from_dict(property_aggregate_lightweight_booker_dict)
```
