...
**user** | [**ReviewUserBooker**](ReviewUserBooker.md) |  | [optional] 
**review_date** | **datetime** | Date of review. | [optional] 
**average_score** | **float** | Total points divided by number of questions. | [optional] 
**answers** | [**List[ReviewAnswerBooker]**](ReviewAnswerBooker.md) | List of user review answers. | [optional] 
...
review_booker_instance = ReviewBooker.from_json(json)
# print the JSON string representation of the object
print(ReviewBooker.to_json())

# convert the object into a dict
review_booker_dict = review_booker_instance.to_dict()
# create an instance of ReviewBooker from a dict
review_booker_from_dict = ReviewBooker.from_dict(review_booker_dict)
```
