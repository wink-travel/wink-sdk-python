...
**location** | [**GeoJsonPointBooker**](GeoJsonPointBooker.md) | Geo-location point where blocking takes place. Defaults to location of property. | 
**descriptions** | [**List[SimpleDescriptionBooker]**](SimpleDescriptionBooker.md) |  | 
**multimedias** | [**List[SimpleMultimediaBooker]**](SimpleMultimediaBooker.md) |  | 
**contact** | [**ContactBooker**](ContactBooker.md) | Associate a contact person for this blocking (if applicable). | 
**address** | [**SimpleAddressBooker**](SimpleAddressBooker.md) | Defaults to property address. | 
...
**socials** | [**List[SocialBooker]**](SocialBooker.md) |  | [optional] 
**price_point** | **str** | Level of expensiveness. | [default to 'THREE']
**recognition_list** | [**List[TravelInventoryRecognitionBooker]**](TravelInventoryRecognitionBooker.md) |  | [optional] 
...
**bedroom_configuration_list** | [**List[BedroomConfigurationBooker]**](BedroomConfigurationBooker.md) |  | 
...
guest_room_lightweight_booker_instance = GuestRoomLightweightBooker.from_json(json)
# print the JSON string representation of the object
print(GuestRoomLightweightBooker.to_json())

# convert the object into a dict
guest_room_lightweight_booker_dict = guest_room_lightweight_booker_instance.to_dict()
# create an instance of GuestRoomLightweightBooker from a dict
guest_room_lightweight_booker_from_dict = GuestRoomLightweightBooker.from_dict(guest_room_lightweight_booker_dict)
```
