...
**location** | [**GeoJsonPointBooker**](GeoJsonPointBooker.md) |  | 
**descriptions** | [**List[SimpleDescriptionBooker]**](SimpleDescriptionBooker.md) | Localized descriptions describing blocking. | 
**multimedias** | [**List[SimpleMultimediaBooker]**](SimpleMultimediaBooker.md) | List of images / videos of blocking. | 
...
**socials** | [**List[SocialBooker]**](SocialBooker.md) | Social network accounts for blocking (if applicable). | [optional] 
**price_point** | **str** | Level of expensiveness. | [default to 'THREE']
**recognition_list** | [**List[TravelInventoryRecognitionBooker]**](TravelInventoryRecognitionBooker.md) | Inventory-level recognition. | [optional] 
...
**bedroom_configuration_list** | [**List[BedroomConfigurationBooker]**](BedroomConfigurationBooker.md) | A room type can have more than one bed configuration. | 
