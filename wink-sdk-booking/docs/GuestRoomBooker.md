...
guest_room_booker_instance = GuestRoomBooker.from_json(json)
# print the JSON string representation of the object
print(GuestRoomBooker.to_json())

# convert the object into a dict
guest_room_booker_dict = guest_room_booker_instance.to_dict()
# create an instance of GuestRoomBooker from a dict
guest_room_booker_from_dict = GuestRoomBooker.from_dict(guest_room_booker_dict)
```
