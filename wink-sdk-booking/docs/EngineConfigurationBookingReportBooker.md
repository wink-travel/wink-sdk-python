...
**theme_colors** | [**EngineConfigurationThemeColorsBooker**](EngineConfigurationThemeColorsBooker.md) |  | [optional] 
...
engine_configuration_booking_report_booker_instance = EngineConfigurationBookingReportBooker.from_json(json)
# print the JSON string representation of the object
print(EngineConfigurationBookingReportBooker.to_json())

# convert the object into a dict
engine_configuration_booking_report_booker_dict = engine_configuration_booking_report_booker_instance.to_dict()
# create an instance of EngineConfigurationBookingReportBooker from a dict
engine_configuration_booking_report_booker_from_dict = EngineConfigurationBookingReportBooker.from_dict(engine_configuration_booking_report_booker_dict)
```
