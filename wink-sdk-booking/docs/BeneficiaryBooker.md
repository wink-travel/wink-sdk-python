...
**amount_due** | [**BeneficiaryChargeBooker**](BeneficiaryChargeBooker.md) | The original slice requested | [optional] 
...
**pending_refunds** | [**List[PendingRefundBooker]**](PendingRefundBooker.md) |  | [optional] 
...
beneficiary_booker_instance = BeneficiaryBooker.from_json(json)
# print the JSON string representation of the object
print(BeneficiaryBooker.to_json())

# convert the object into a dict
beneficiary_booker_dict = beneficiary_booker_instance.to_dict()
# create an instance of BeneficiaryBooker from a dict
beneficiary_booker_from_dict = BeneficiaryBooker.from_dict(beneficiary_booker_dict)
```
