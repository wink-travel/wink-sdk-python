...
**user** | [**AuthenticatedUserBooker**](AuthenticatedUserBooker.md) | The authenticated user ID that made the request | 
...
**display_price_quote** | [**QuoteLightweightBooker**](QuoteLightweightBooker.md) | The quote used to create totalDisplayPrice. | 
**supplier_price_quote** | [**QuoteLightweightBooker**](QuoteLightweightBooker.md) | The quote used to create totalSupplierPrice. | 
**internal_price_quote** | [**QuoteLightweightBooker**](QuoteLightweightBooker.md) | The quote used to create totalInternalPrice. | 
**capture_price_quote** | [**QuoteLightweightBooker**](QuoteLightweightBooker.md) | The quote used to create totalCapturePrice. | 
**item_list** | [**List[BookingContractItemBooker]**](BookingContractItemBooker.md) | Holds one booking line item for a specific supplier. | 
...
**payment** | [**BookingContractPaymentDetailsBooker**](BookingContractPaymentDetailsBooker.md) | Payment details the merchant provided us at the time of payment. | 
...
**refunds** | [**List[RefundBooker]**](RefundBooker.md) | An optional list of refunds that occurred with this booking. If the refund amount(s) is the same as the total price, the booking also gets cancelled. | [optional] 
**payouts** | [**List[PayoutBooker]**](PayoutBooker.md) | An optional list of refunds that occurred with this booking. If the refund amount(s) is the same as the total price, the booking also gets cancelled. | [optional] 
...
wink_booking_contract_booker_instance = WinkBookingContractBooker.from_json(json)
# print the JSON string representation of the object
print(WinkBookingContractBooker.to_json())

# convert the object into a dict
wink_booking_contract_booker_dict = wink_booking_contract_booker_instance.to_dict()
# create an instance of WinkBookingContractBooker from a dict
wink_booking_contract_booker_from_dict = WinkBookingContractBooker.from_dict(wink_booking_contract_booker_dict)
```
