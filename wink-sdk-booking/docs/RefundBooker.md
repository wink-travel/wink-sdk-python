...
refund_booker_instance = RefundBooker.from_json(json)
# print the JSON string representation of the object
print(RefundBooker.to_json())

# convert the object into a dict
refund_booker_dict = refund_booker_instance.to_dict()
# create an instance of RefundBooker from a dict
refund_booker_from_dict = RefundBooker.from_dict(refund_booker_dict)
```
