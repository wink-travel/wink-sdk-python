...
**source_to_user_currency_quote** | [**QuoteLightweightBooker**](QuoteLightweightBooker.md) | Hotel to user currency exchange rate. | [optional] 
**source_to_internal_currency_quote** | [**QuoteLightweightBooker**](QuoteLightweightBooker.md) | Hotel to wink currency exchange rate. | [optional] 
**offer_details** | [**List[LocalizedDescriptionBooker]**](LocalizedDescriptionBooker.md) |  | [optional] 
...
stay_rate_booker_instance = StayRateBooker.from_json(json)
# print the JSON string representation of the object
print(StayRateBooker.to_json())

# convert the object into a dict
stay_rate_booker_dict = stay_rate_booker_instance.to_dict()
# create an instance of StayRateBooker from a dict
stay_rate_booker_from_dict = StayRateBooker.from_dict(stay_rate_booker_dict)
```
