...
**attribution** | [**List[ImageAttributionBooker]**](ImageAttributionBooker.md) | Whether image has attribution properties | [optional] 
...
simple_multimedia_booker_instance = SimpleMultimediaBooker.from_json(json)
# print the JSON string representation of the object
print(SimpleMultimediaBooker.to_json())

# convert the object into a dict
simple_multimedia_booker_dict = simple_multimedia_booker_instance.to_dict()
# create an instance of SimpleMultimediaBooker from a dict
simple_multimedia_booker_from_dict = SimpleMultimediaBooker.from_dict(simple_multimedia_booker_dict)
```
