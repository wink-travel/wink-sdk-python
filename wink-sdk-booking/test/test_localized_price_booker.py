...
class TestLocalizedPriceBooker(unittest.TestCase):
    """LocalizedPriceBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedPriceBooker:
        """Test LocalizedPriceBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedPriceBooker`
        """
        model = LocalizedPriceBooker()
        if include_optional:
            return LocalizedPriceBooker(
    ...
    def testLocalizedPriceBooker(self):
        """Test LocalizedPriceBooker"""
