...
class TestContactBooker(unittest.TestCase):
    """ContactBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactBooker:
        """Test ContactBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactBooker`
        """
        model = ContactBooker()
        if include_optional:
            return ContactBooker(
                first_name = 'John',
                last_name = 'Smith',
