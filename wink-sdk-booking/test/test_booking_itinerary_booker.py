...
class TestBookingItineraryBooker(unittest.TestCase):
    """BookingItineraryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingItineraryBooker:
        """Test BookingItineraryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingItineraryBooker`
        """
        model = BookingItineraryBooker()
        if include_optional:
            return BookingItineraryBooker(
    ...
    def testBookingItineraryBooker(self):
        """Test BookingItineraryBooker"""
