...
class TestProfileUserBooker(unittest.TestCase):
    """ProfileUserBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileUserBooker:
        """Test ProfileUserBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileUserBooker`
        """
        model = ProfileUserBooker()
        if include_optional:
            return ProfileUserBooker(
                first_name = 'Avid',
                last_name = 'Travelman',
    ...
    def testProfileUserBooker(self):
        """Test ProfileUserBooker"""
