...
class TestStayRateBooker(unittest.TestCase):
    """StayRateBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StayRateBooker:
        """Test StayRateBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StayRateBooker`
        """
        model = StayRateBooker()
        if include_optional:
            return StayRateBooker(
