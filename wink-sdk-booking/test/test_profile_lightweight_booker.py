...
class TestProfileLightweightBooker(unittest.TestCase):
    """ProfileLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileLightweightBooker:
        """Test ProfileLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileLightweightBooker`
        """
        model = ProfileLightweightBooker()
        if include_optional:
            return ProfileLightweightBooker(
    ...
    def testProfileLightweightBooker(self):
        """Test ProfileLightweightBooker"""
