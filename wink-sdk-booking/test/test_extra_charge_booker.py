...
class TestExtraChargeBooker(unittest.TestCase):
    """ExtraChargeBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargeBooker:
        """Test ExtraChargeBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargeBooker`
        """
        model = ExtraChargeBooker()
        if include_optional:
            return ExtraChargeBooker(
    ...
    def testExtraChargeBooker(self):
        """Test ExtraChargeBooker"""
