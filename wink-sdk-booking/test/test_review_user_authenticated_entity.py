...
class TestReviewUserAuthenticatedEntity(unittest.TestCase):
    """ReviewUserAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewUserAuthenticatedEntity:
        """Test ReviewUserAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewUserAuthenticatedEntity`
        """
        model = ReviewUserAuthenticatedEntity()
        if include_optional:
            return ReviewUserAuthenticatedEntity(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testReviewUserAuthenticatedEntity(self):
        """Test ReviewUserAuthenticatedEntity"""
