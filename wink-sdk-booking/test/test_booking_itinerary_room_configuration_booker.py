...
class TestBookingItineraryRoomConfigurationBooker(unittest.TestCase):
    """BookingItineraryRoomConfigurationBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingItineraryRoomConfigurationBooker:
        """Test BookingItineraryRoomConfigurationBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingItineraryRoomConfigurationBooker`
        """
        model = BookingItineraryRoomConfigurationBooker()
        if include_optional:
            return BookingItineraryRoomConfigurationBooker(
                adults = 2,
                children = [
                    wink_sdk_booking.models.booking_itinerary_room_configuration_child_booker.BookingItineraryRoomConfigurationChild_Booker(
                        quantity = 56, 
                        age = 56, )
                    ]
            )
    ...
    def testBookingItineraryRoomConfigurationBooker(self):
        """Test BookingItineraryRoomConfigurationBooker"""
