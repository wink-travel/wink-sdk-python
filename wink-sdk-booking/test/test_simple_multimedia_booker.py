...
class TestSimpleMultimediaBooker(unittest.TestCase):
    """SimpleMultimediaBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimediaBooker:
        """Test SimpleMultimediaBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimediaBooker`
        """
        model = SimpleMultimediaBooker()
        if include_optional:
            return SimpleMultimediaBooker(
    ...
    def testSimpleMultimediaBooker(self):
        """Test SimpleMultimediaBooker"""
