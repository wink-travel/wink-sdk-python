...
class TestCancellationPolicyLightweightBooker(unittest.TestCase):
    """CancellationPolicyLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyLightweightBooker:
        """Test CancellationPolicyLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyLightweightBooker`
        """
        model = CancellationPolicyLightweightBooker()
        if include_optional:
            return CancellationPolicyLightweightBooker(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyLightweightBooker(self):
        """Test CancellationPolicyLightweightBooker"""
