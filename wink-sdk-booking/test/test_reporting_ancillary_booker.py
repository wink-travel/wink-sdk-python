...
class TestReportingAncillaryBooker(unittest.TestCase):
    """ReportingAncillaryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingAncillaryBooker:
        """Test ReportingAncillaryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingAncillaryBooker`
        """
        model = ReportingAncillaryBooker()
        if include_optional:
            return ReportingAncillaryBooker(
                name = '',
                type = 'LODGING',
                gross_amount = 1.337,
                net_amount = 1.337,
    ...
    def testReportingAncillaryBooker(self):
        """Test ReportingAncillaryBooker"""
