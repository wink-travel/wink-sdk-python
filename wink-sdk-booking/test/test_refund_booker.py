...
class TestRefundBooker(unittest.TestCase):
    """RefundBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundBooker:
        """Test RefundBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundBooker`
        """
        model = RefundBooker()
        if include_optional:
            return RefundBooker(
