...
class TestContactAuthenticatedEntity(unittest.TestCase):
    """ContactAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactAuthenticatedEntity:
        """Test ContactAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactAuthenticatedEntity`
        """
        model = ContactAuthenticatedEntity()
        if include_optional:
            return ContactAuthenticatedEntity(
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testContactAuthenticatedEntity(self):
        """Test ContactAuthenticatedEntity"""
