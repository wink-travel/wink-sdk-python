...
class TestReviewAuthenticatedEntity(unittest.TestCase):
    """ReviewAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewAuthenticatedEntity:
        """Test ReviewAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAuthenticatedEntity`
        """
        model = ReviewAuthenticatedEntity()
        if include_optional:
            return ReviewAuthenticatedEntity(
                identifier = '',
                booking_identifier = '',
                hotel_identifier = '',
    ...
    def testReviewAuthenticatedEntity(self):
        """Test ReviewAuthenticatedEntity"""
