...
class TestCancellationPolicyExceptionBooker(unittest.TestCase):
    """CancellationPolicyExceptionBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionBooker:
        """Test CancellationPolicyExceptionBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionBooker`
        """
        model = CancellationPolicyExceptionBooker()
        if include_optional:
            return CancellationPolicyExceptionBooker(
    ...
    def testCancellationPolicyExceptionBooker(self):
        """Test CancellationPolicyExceptionBooker"""
