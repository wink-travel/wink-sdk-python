...
class TestBedroomAuthenticatedEntity(unittest.TestCase):
    """BedroomAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomAuthenticatedEntity:
        """Test BedroomAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomAuthenticatedEntity`
        """
        model = BedroomAuthenticatedEntity()
        if include_optional:
            return BedroomAuthenticatedEntity(
                type = 'MASTER',
                bed_list = [
    ...
    def testBedroomAuthenticatedEntity(self):
        """Test BedroomAuthenticatedEntity"""
