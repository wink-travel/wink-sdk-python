...
class TestBooleanResponseAuthenticatedEntity(unittest.TestCase):
    """BooleanResponseAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BooleanResponseAuthenticatedEntity:
        """Test BooleanResponseAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BooleanResponseAuthenticatedEntity`
        """
        model = BooleanResponseAuthenticatedEntity()
        if include_optional:
    ...
    def testBooleanResponseAuthenticatedEntity(self):
        """Test BooleanResponseAuthenticatedEntity"""
