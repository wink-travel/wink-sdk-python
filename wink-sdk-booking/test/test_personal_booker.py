...
class TestPersonalBooker(unittest.TestCase):
    """PersonalBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalBooker:
        """Test PersonalBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalBooker`
        """
        model = PersonalBooker()
        if include_optional:
            return PersonalBooker(
                gender = 'MALE',
