...
class TestSubmitReviewAnswerAuthenticatedEntity(unittest.TestCase):
    """SubmitReviewAnswerAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitReviewAnswerAuthenticatedEntity:
        """Test SubmitReviewAnswerAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitReviewAnswerAuthenticatedEntity`
        """
        model = SubmitReviewAnswerAuthenticatedEntity()
        if include_optional:
            return SubmitReviewAnswerAuthenticatedEntity(
                question_identifier = '',
                category = 'COMFORT',
                sort = 56,
                value = 56
    ...
    def testSubmitReviewAnswerAuthenticatedEntity(self):
        """Test SubmitReviewAnswerAuthenticatedEntity"""
