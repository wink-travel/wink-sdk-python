...
class TestPropertyPolicyBooker(unittest.TestCase):
    """PropertyPolicyBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyPolicyBooker:
        """Test PropertyPolicyBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyPolicyBooker`
        """
        model = PropertyPolicyBooker()
        if include_optional:
            return PropertyPolicyBooker(
    ...
    def testPropertyPolicyBooker(self):
        """Test PropertyPolicyBooker"""
