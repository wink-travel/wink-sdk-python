...
class TestPendingRefundBooker(unittest.TestCase):
    """PendingRefundBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingRefundBooker:
        """Test PendingRefundBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingRefundBooker`
        """
        model = PendingRefundBooker()
        if include_optional:
            return PendingRefundBooker(
    ...
    def testPendingRefundBooker(self):
        """Test PendingRefundBooker"""
