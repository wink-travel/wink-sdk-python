...
class TestAggregateDescriptorBooker(unittest.TestCase):
    """AggregateDescriptorBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateDescriptorBooker:
        """Test AggregateDescriptorBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateDescriptorBooker`
        """
        model = AggregateDescriptorBooker()
        if include_optional:
            return AggregateDescriptorBooker(
    ...
    def testAggregateDescriptorBooker(self):
        """Test AggregateDescriptorBooker"""
