...
class TestSocialAuthenticatedEntity(unittest.TestCase):
    """SocialAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialAuthenticatedEntity:
        """Test SocialAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SocialAuthenticatedEntity`
        """
        model = SocialAuthenticatedEntity()
        if include_optional:
            return SocialAuthenticatedEntity(
                type = 'FACEBOOK',
                location = '',
                enabled = True
            )
    ...
    def testSocialAuthenticatedEntity(self):
        """Test SocialAuthenticatedEntity"""
