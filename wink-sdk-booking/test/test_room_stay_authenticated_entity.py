...
class TestRoomStayAuthenticatedEntity(unittest.TestCase):
    """RoomStayAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomStayAuthenticatedEntity:
        """Test RoomStayAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomStayAuthenticatedEntity`
        """
        model = RoomStayAuthenticatedEntity()
        if include_optional:
            return RoomStayAuthenticatedEntity(
                ...
                extra_charges = wink_sdk_booking.models.extra_charges_authenticated_entity.ExtraCharges_Authenticated_Entity(
                    ...
                    source_total = , 
                    internal_total = , ),
                active_cancellation_policy = wink_sdk_booking.models.cancellation_policy_authenticated_entity.CancellationPolicy_Authenticated_Entity(
                    identifier = '', 
                    hotel_identifier = '', 
                    refundable = False, 
                    advance_cancellation_free_of_charge = 'UNTIL_EIGHTEEN_HUNDRED_HOURS_ON_DAY_OF_ARRIVAL', 
    ...
    def testRoomStayAuthenticatedEntity(self):
        """Test RoomStayAuthenticatedEntity"""
