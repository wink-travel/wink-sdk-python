...
class TestSortObjectBooker(unittest.TestCase):
    """SortObjectBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortObjectBooker:
        """Test SortObjectBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortObjectBooker`
        """
        model = SortObjectBooker()
        if include_optional:
            return SortObjectBooker(
                empty = True,
                sorted = True,
                unsorted = True
            )
