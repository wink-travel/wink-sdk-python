...
class TestCancellationPolicyAuthenticatedEntity(unittest.TestCase):
    """CancellationPolicyAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyAuthenticatedEntity:
        """Test CancellationPolicyAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyAuthenticatedEntity`
        """
        model = CancellationPolicyAuthenticatedEntity()
        if include_optional:
            return CancellationPolicyAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyAuthenticatedEntity(self):
        """Test CancellationPolicyAuthenticatedEntity"""
