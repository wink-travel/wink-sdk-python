...
class TestEngineConfigurationThemeBooker(unittest.TestCase):
    """EngineConfigurationThemeBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeBooker:
        """Test EngineConfigurationThemeBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeBooker`
        """
        model = EngineConfigurationThemeBooker()
        if include_optional:
            return EngineConfigurationThemeBooker(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeBooker(self):
        """Test EngineConfigurationThemeBooker"""
