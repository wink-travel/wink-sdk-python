...
class TestCheckoutRequestAuthenticatedEntity(unittest.TestCase):
    """CheckoutRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckoutRequestAuthenticatedEntity:
        """Test CheckoutRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckoutRequestAuthenticatedEntity`
        """
        model = CheckoutRequestAuthenticatedEntity()
        if include_optional:
            return CheckoutRequestAuthenticatedEntity(
                shopping_cart_identifier = 'shopping-cart-1',
                engine_configuration_identifier = 'customization-1',
                redirect_url = 'https://ota.wink.travel/thank-you'
            )
        else:
            return CheckoutRequestAuthenticatedEntity(
                shopping_cart_identifier = 'shopping-cart-1',
    ...
    def testCheckoutRequestAuthenticatedEntity(self):
        """Test CheckoutRequestAuthenticatedEntity"""
