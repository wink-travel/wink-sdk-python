...
class TestUpsertShoppingCartItemRequestAuthenticatedEntity(unittest.TestCase):
    """UpsertShoppingCartItemRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertShoppingCartItemRequestAuthenticatedEntity:
        """Test UpsertShoppingCartItemRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertShoppingCartItemRequestAuthenticatedEntity`
        """
        model = UpsertShoppingCartItemRequestAuthenticatedEntity()
        if include_optional:
            return UpsertShoppingCartItemRequestAuthenticatedEntity(
                hotel_identifier = '',
                ...
                ancillaries = [
                    wink_sdk_booking.models.ancillary_request_authenticated_entity.AncillaryRequest_Authenticated_Entity(
                        type_identifier = '', 
                ...
                engine_configuration_identifier = 'custom-1',
                valid_user = True
            )
        else:
            return UpsertShoppingCartItemRequestAuthenticatedEntity(
    ...
    def testUpsertShoppingCartItemRequestAuthenticatedEntity(self):
        """Test UpsertShoppingCartItemRequestAuthenticatedEntity"""
