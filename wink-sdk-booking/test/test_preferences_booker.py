...
class TestPreferencesBooker(unittest.TestCase):
    """PreferencesBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreferencesBooker:
        """Test PreferencesBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreferencesBooker`
        """
        model = PreferencesBooker()
        if include_optional:
            return PreferencesBooker(
    ...
    def testPreferencesBooker(self):
        """Test PreferencesBooker"""
