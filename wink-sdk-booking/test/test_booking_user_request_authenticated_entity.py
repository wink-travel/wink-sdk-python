...
class TestBookingUserRequestAuthenticatedEntity(unittest.TestCase):
    """BookingUserRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserRequestAuthenticatedEntity:
        """Test BookingUserRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserRequestAuthenticatedEntity`
        """
        model = BookingUserRequestAuthenticatedEntity()
        if include_optional:
            return BookingUserRequestAuthenticatedEntity(
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testBookingUserRequestAuthenticatedEntity(self):
        """Test BookingUserRequestAuthenticatedEntity"""
