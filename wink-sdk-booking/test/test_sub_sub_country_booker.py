...
class TestSubSubCountryBooker(unittest.TestCase):
    """SubSubCountryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryBooker:
        """Test SubSubCountryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryBooker`
        """
        model = SubSubCountryBooker()
        if include_optional:
            return SubSubCountryBooker(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryBooker(self):
        """Test SubSubCountryBooker"""
