...
class TestSimpleDescriptionBooker(unittest.TestCase):
    """SimpleDescriptionBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDescriptionBooker:
        """Test SimpleDescriptionBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDescriptionBooker`
        """
        model = SimpleDescriptionBooker()
        if include_optional:
            return SimpleDescriptionBooker(
    ...
    def testSimpleDescriptionBooker(self):
        """Test SimpleDescriptionBooker"""
