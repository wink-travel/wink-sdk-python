...
class TestRatePlanLevelFeeBooker(unittest.TestCase):
    """RatePlanLevelFeeBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanLevelFeeBooker:
        """Test RatePlanLevelFeeBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanLevelFeeBooker`
        """
        model = RatePlanLevelFeeBooker()
        if include_optional:
            return RatePlanLevelFeeBooker(
                descriptions = [
    ...
    def testRatePlanLevelFeeBooker(self):
        """Test RatePlanLevelFeeBooker"""
