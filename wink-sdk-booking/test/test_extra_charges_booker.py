...
class TestExtraChargesBooker(unittest.TestCase):
    """ExtraChargesBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargesBooker:
        """Test ExtraChargesBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargesBooker`
        """
        model = ExtraChargesBooker()
        if include_optional:
            return ExtraChargesBooker(
                items = [
    ...
    def testExtraChargesBooker(self):
        """Test ExtraChargesBooker"""
