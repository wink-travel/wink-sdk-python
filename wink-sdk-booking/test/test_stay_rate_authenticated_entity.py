...
class TestStayRateAuthenticatedEntity(unittest.TestCase):
    """StayRateAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StayRateAuthenticatedEntity:
        """Test StayRateAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StayRateAuthenticatedEntity`
        """
        model = StayRateAuthenticatedEntity()
        if include_optional:
            return StayRateAuthenticatedEntity(
                ...
                source_base_total = wink_sdk_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                internal_base_total = wink_sdk_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                ...
                internal_total = wink_sdk_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                user_specified_currency_average_price_per_night = wink_sdk_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                internal_average_price_per_night = wink_sdk_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                source_average_price_per_night = wink_sdk_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
    ...
    def testStayRateAuthenticatedEntity(self):
        """Test StayRateAuthenticatedEntity"""
