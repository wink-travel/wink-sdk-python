...
class TestReviewAnswerOptionAuthenticatedEntity(unittest.TestCase):
    """ReviewAnswerOptionAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewAnswerOptionAuthenticatedEntity:
        """Test ReviewAnswerOptionAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAnswerOptionAuthenticatedEntity`
        """
        model = ReviewAnswerOptionAuthenticatedEntity()
        if include_optional:
            return ReviewAnswerOptionAuthenticatedEntity(
                sort = 56,
                value = 56
            )
        else:
    ...
    def testReviewAnswerOptionAuthenticatedEntity(self):
        """Test ReviewAnswerOptionAuthenticatedEntity"""
