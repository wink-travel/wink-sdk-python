...
class TestPageableObjectBooker(unittest.TestCase):
    """PageableObjectBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageableObjectBooker:
        """Test PageableObjectBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageableObjectBooker`
        """
        model = PageableObjectBooker()
        if include_optional:
            return PageableObjectBooker(
                offset = 56,
                sort = [
    ...
    def testPageableObjectBooker(self):
        """Test PageableObjectBooker"""
