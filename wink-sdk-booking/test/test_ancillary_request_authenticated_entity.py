...
class TestAncillaryRequestAuthenticatedEntity(unittest.TestCase):
    """AncillaryRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AncillaryRequestAuthenticatedEntity:
        """Test AncillaryRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AncillaryRequestAuthenticatedEntity`
        """
        model = AncillaryRequestAuthenticatedEntity()
        if include_optional:
            return AncillaryRequestAuthenticatedEntity(
                type_identifier = '',
    ...
    def testAncillaryRequestAuthenticatedEntity(self):
        """Test AncillaryRequestAuthenticatedEntity"""
