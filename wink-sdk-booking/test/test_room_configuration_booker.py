...
class TestRoomConfigurationBooker(unittest.TestCase):
    """RoomConfigurationBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationBooker:
        """Test RoomConfigurationBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationBooker`
        """
        model = RoomConfigurationBooker()
        if include_optional:
            return RoomConfigurationBooker(
                adults = 2,
                children = [
    ...
    def testRoomConfigurationBooker(self):
        """Test RoomConfigurationBooker"""
