...
class TestChildAuthenticatedEntity(unittest.TestCase):
    """ChildAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChildAuthenticatedEntity:
        """Test ChildAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildAuthenticatedEntity`
        """
        model = ChildAuthenticatedEntity()
        if include_optional:
            return ChildAuthenticatedEntity(
                quantity = 1,
                age = 0
            )
        else:
    ...
    def testChildAuthenticatedEntity(self):
        """Test ChildAuthenticatedEntity"""
