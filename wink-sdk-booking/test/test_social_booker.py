...
class TestSocialBooker(unittest.TestCase):
    """SocialBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialBooker:
        """Test SocialBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SocialBooker`
        """
        model = SocialBooker()
        if include_optional:
            return SocialBooker(
