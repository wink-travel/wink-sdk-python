...
class TestBookingViewBooker(unittest.TestCase):
    """BookingViewBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingViewBooker:
        """Test BookingViewBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingViewBooker`
        """
        model = BookingViewBooker()
        if include_optional:
    ...
    def testBookingViewBooker(self):
        """Test BookingViewBooker"""
