...
class TestBookingAncillaryBooker(unittest.TestCase):
    """BookingAncillaryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingAncillaryBooker:
        """Test BookingAncillaryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingAncillaryBooker`
        """
        model = BookingAncillaryBooker()
        if include_optional:
            return BookingAncillaryBooker(
                identifier = '',
                hotel_identifier = '',
                type_identifier = '',
    ...
    def testBookingAncillaryBooker(self):
        """Test BookingAncillaryBooker"""
