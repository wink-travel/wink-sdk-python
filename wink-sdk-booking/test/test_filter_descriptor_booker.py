...
class TestFilterDescriptorBooker(unittest.TestCase):
    """FilterDescriptorBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterDescriptorBooker:
        """Test FilterDescriptorBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterDescriptorBooker`
        """
        model = FilterDescriptorBooker()
        if include_optional:
            return FilterDescriptorBooker(
    ...
    def testFilterDescriptorBooker(self):
        """Test FilterDescriptorBooker"""
