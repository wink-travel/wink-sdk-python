...
class TestSimpleAddressBooker(unittest.TestCase):
    """SimpleAddressBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleAddressBooker:
        """Test SimpleAddressBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleAddressBooker`
        """
        model = SimpleAddressBooker()
        if include_optional:
            return SimpleAddressBooker(
    ...
    def testSimpleAddressBooker(self):
        """Test SimpleAddressBooker"""
