...
class TestRoomConfigurationPriceRatePlanBooker(unittest.TestCase):
    """RoomConfigurationPriceRatePlanBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceRatePlanBooker:
        """Test RoomConfigurationPriceRatePlanBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationPriceRatePlanBooker`
        """
        model = RoomConfigurationPriceRatePlanBooker()
        if include_optional:
            return RoomConfigurationPriceRatePlanBooker(
                identifier = '',
                name = 'BAR 1',
                breakfast = False,
                brunch = False,
    ...
    def testRoomConfigurationPriceRatePlanBooker(self):
        """Test RoomConfigurationPriceRatePlanBooker"""
