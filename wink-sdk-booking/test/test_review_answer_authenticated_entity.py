...
class TestReviewAnswerAuthenticatedEntity(unittest.TestCase):
    """ReviewAnswerAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewAnswerAuthenticatedEntity:
        """Test ReviewAnswerAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAnswerAuthenticatedEntity`
        """
        model = ReviewAnswerAuthenticatedEntity()
        if include_optional:
            return ReviewAnswerAuthenticatedEntity(
                question_identifier = '',
                category = 'COMFORT',
                sort = 56,
                value = 56
    ...
    def testReviewAnswerAuthenticatedEntity(self):
        """Test ReviewAnswerAuthenticatedEntity"""
