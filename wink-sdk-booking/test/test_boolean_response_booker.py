...
class TestBooleanResponseBooker(unittest.TestCase):
    """BooleanResponseBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BooleanResponseBooker:
        """Test BooleanResponseBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BooleanResponseBooker`
        """
        model = BooleanResponseBooker()
        if include_optional:
    ...
    def testBooleanResponseBooker(self):
        """Test BooleanResponseBooker"""
