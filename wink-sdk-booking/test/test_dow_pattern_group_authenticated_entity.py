...
class TestDowPatternGroupAuthenticatedEntity(unittest.TestCase):
    """DowPatternGroupAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DowPatternGroupAuthenticatedEntity:
        """Test DowPatternGroupAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DowPatternGroupAuthenticatedEntity`
        """
        model = DowPatternGroupAuthenticatedEntity()
        if include_optional:
            return DowPatternGroupAuthenticatedEntity(
                mon = True,
                tue = True,
                wed = True,
                thu = True,
    ...
    def testDowPatternGroupAuthenticatedEntity(self):
        """Test DowPatternGroupAuthenticatedEntity"""
