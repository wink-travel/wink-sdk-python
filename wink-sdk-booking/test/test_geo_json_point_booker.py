...
class TestGeoJsonPointBooker(unittest.TestCase):
    """GeoJsonPointBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonPointBooker:
        """Test GeoJsonPointBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonPointBooker`
        """
        model = GeoJsonPointBooker()
        if include_optional:
            return GeoJsonPointBooker(
                x = 1.337,
                y = 1.337,
                type = '',
                coordinates = [
    ...
    def testGeoJsonPointBooker(self):
        """Test GeoJsonPointBooker"""
