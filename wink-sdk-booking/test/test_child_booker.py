...
class TestChildBooker(unittest.TestCase):
    """ChildBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChildBooker:
        """Test ChildBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildBooker`
        """
        model = ChildBooker()
        if include_optional:
            return ChildBooker(
