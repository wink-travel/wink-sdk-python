...
class TestSubSubCountryLightweightBooker(unittest.TestCase):
    """SubSubCountryLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryLightweightBooker:
        """Test SubSubCountryLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryLightweightBooker`
        """
        model = SubSubCountryLightweightBooker()
        if include_optional:
            return SubSubCountryLightweightBooker(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryLightweightBooker(self):
        """Test SubSubCountryLightweightBooker"""
