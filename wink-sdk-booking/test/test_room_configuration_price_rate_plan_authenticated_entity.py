...
class TestRoomConfigurationPriceRatePlanAuthenticatedEntity(unittest.TestCase):
    """RoomConfigurationPriceRatePlanAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceRatePlanAuthenticatedEntity:
        """Test RoomConfigurationPriceRatePlanAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationPriceRatePlanAuthenticatedEntity`
        """
        model = RoomConfigurationPriceRatePlanAuthenticatedEntity()
        if include_optional:
            return RoomConfigurationPriceRatePlanAuthenticatedEntity(
                identifier = '',
                name = 'BAR 1',
                breakfast = False,
                brunch = False,
                ...
                early_check_in_charge = wink_sdk_booking.models.variable_charge_authenticated_entity.VariableCharge_Authenticated_Entity(),
                late_check_out_charge = wink_sdk_booking.models.variable_charge_authenticated_entity.VariableCharge_Authenticated_Entity(),
    ...
    def testRoomConfigurationPriceRatePlanAuthenticatedEntity(self):
        """Test RoomConfigurationPriceRatePlanAuthenticatedEntity"""
