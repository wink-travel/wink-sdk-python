...
class TestGeneralManagerBooker(unittest.TestCase):
    """GeneralManagerBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralManagerBooker:
        """Test GeneralManagerBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralManagerBooker`
        """
        model = GeneralManagerBooker()
        if include_optional:
            return GeneralManagerBooker(
                name = 'Jane Doe',
                image = wink_sdk_booking.models.simple_multimedia_booker.SimpleMultimedia_Booker(
    ...
    def testGeneralManagerBooker(self):
        """Test GeneralManagerBooker"""
