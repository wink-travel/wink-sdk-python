...
class TestCancellationPolicyExceptionsBooker(unittest.TestCase):
    """CancellationPolicyExceptionsBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionsBooker:
        """Test CancellationPolicyExceptionsBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionsBooker`
        """
        model = CancellationPolicyExceptionsBooker()
        if include_optional:
            return CancellationPolicyExceptionsBooker(
                list = [
    ...
    def testCancellationPolicyExceptionsBooker(self):
        """Test CancellationPolicyExceptionsBooker"""
