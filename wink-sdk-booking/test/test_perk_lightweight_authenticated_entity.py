...
class TestPerkLightweightAuthenticatedEntity(unittest.TestCase):
    """PerkLightweightAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerkLightweightAuthenticatedEntity:
        """Test PerkLightweightAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerkLightweightAuthenticatedEntity`
        """
        model = PerkLightweightAuthenticatedEntity()
        if include_optional:
            return PerkLightweightAuthenticatedEntity(
                identifier = '',
                guaranteed = True,
                level = 56,
                descriptions = [
    ...
    def testPerkLightweightAuthenticatedEntity(self):
        """Test PerkLightweightAuthenticatedEntity"""
