...
class TestCustomizationThemeColorsBooker(unittest.TestCase):
    """CustomizationThemeColorsBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationThemeColorsBooker:
        """Test CustomizationThemeColorsBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationThemeColorsBooker`
        """
        model = CustomizationThemeColorsBooker()
        if include_optional:
            return CustomizationThemeColorsBooker(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testCustomizationThemeColorsBooker(self):
        """Test CustomizationThemeColorsBooker"""
