...
class TestCreateCart400Response(unittest.TestCase):
    """CreateCart400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCart400Response:
        """Test CreateCart400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCart400Response`
        """
        model = CreateCart400Response()
        if include_optional:
            return CreateCart400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testCreateCart400Response(self):
        """Test CreateCart400Response"""
