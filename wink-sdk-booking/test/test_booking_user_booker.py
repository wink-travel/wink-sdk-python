...
class TestBookingUserBooker(unittest.TestCase):
    """BookingUserBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserBooker:
        """Test BookingUserBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserBooker`
        """
        model = BookingUserBooker()
        if include_optional:
            return BookingUserBooker(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testBookingUserBooker(self):
        """Test BookingUserBooker"""
