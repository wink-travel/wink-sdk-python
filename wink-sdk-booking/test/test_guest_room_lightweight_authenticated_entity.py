...
class TestGuestRoomLightweightAuthenticatedEntity(unittest.TestCase):
    """GuestRoomLightweightAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomLightweightAuthenticatedEntity:
        """Test GuestRoomLightweightAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomLightweightAuthenticatedEntity`
        """
        model = GuestRoomLightweightAuthenticatedEntity()
        if include_optional:
            return GuestRoomLightweightAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testGuestRoomLightweightAuthenticatedEntity(self):
        """Test GuestRoomLightweightAuthenticatedEntity"""
