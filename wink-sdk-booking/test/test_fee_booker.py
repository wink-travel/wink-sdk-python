...
class TestFeeBooker(unittest.TestCase):
    """FeeBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeeBooker:
        """Test FeeBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeeBooker`
        """
        model = FeeBooker()
        if include_optional:
            return FeeBooker(
