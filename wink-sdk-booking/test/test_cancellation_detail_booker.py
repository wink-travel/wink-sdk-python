...
class TestCancellationDetailBooker(unittest.TestCase):
    """CancellationDetailBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationDetailBooker:
        """Test CancellationDetailBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationDetailBooker`
        """
        model = CancellationDetailBooker()
        if include_optional:
            return CancellationDetailBooker(
    ...
    def testCancellationDetailBooker(self):
        """Test CancellationDetailBooker"""
