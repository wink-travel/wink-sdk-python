...
class TestCancellationPolicyLightweightAuthenticatedEntity(unittest.TestCase):
    """CancellationPolicyLightweightAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyLightweightAuthenticatedEntity:
        """Test CancellationPolicyLightweightAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyLightweightAuthenticatedEntity`
        """
        model = CancellationPolicyLightweightAuthenticatedEntity()
        if include_optional:
            return CancellationPolicyLightweightAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyLightweightAuthenticatedEntity(self):
        """Test CancellationPolicyLightweightAuthenticatedEntity"""
