...
class TestExtraChargeAuthenticatedEntity(unittest.TestCase):
    """ExtraChargeAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargeAuthenticatedEntity:
        """Test ExtraChargeAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargeAuthenticatedEntity`
        """
        model = ExtraChargeAuthenticatedEntity()
        if include_optional:
            return ExtraChargeAuthenticatedEntity(
    ...
    def testExtraChargeAuthenticatedEntity(self):
        """Test ExtraChargeAuthenticatedEntity"""
