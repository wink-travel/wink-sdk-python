...
class TestExtraChargesAuthenticatedEntity(unittest.TestCase):
    """ExtraChargesAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargesAuthenticatedEntity:
        """Test ExtraChargesAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargesAuthenticatedEntity`
        """
        model = ExtraChargesAuthenticatedEntity()
        if include_optional:
            return ExtraChargesAuthenticatedEntity(
                items = [
    ...
    def testExtraChargesAuthenticatedEntity(self):
        """Test ExtraChargesAuthenticatedEntity"""
