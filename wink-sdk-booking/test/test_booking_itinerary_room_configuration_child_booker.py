...
class TestBookingItineraryRoomConfigurationChildBooker(unittest.TestCase):
    """BookingItineraryRoomConfigurationChildBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingItineraryRoomConfigurationChildBooker:
        """Test BookingItineraryRoomConfigurationChildBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingItineraryRoomConfigurationChildBooker`
        """
        model = BookingItineraryRoomConfigurationChildBooker()
        if include_optional:
            return BookingItineraryRoomConfigurationChildBooker(
                quantity = 56,
                age = 56
            )
        else:
    ...
    def testBookingItineraryRoomConfigurationChildBooker(self):
        """Test BookingItineraryRoomConfigurationChildBooker"""
