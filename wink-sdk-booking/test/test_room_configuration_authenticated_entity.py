...
class TestRoomConfigurationAuthenticatedEntity(unittest.TestCase):
    """RoomConfigurationAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationAuthenticatedEntity:
        """Test RoomConfigurationAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationAuthenticatedEntity`
        """
        model = RoomConfigurationAuthenticatedEntity()
        if include_optional:
            return RoomConfigurationAuthenticatedEntity(
                adults = 2,
                children = [
    ...
    def testRoomConfigurationAuthenticatedEntity(self):
        """Test RoomConfigurationAuthenticatedEntity"""
