...
class TestReviewQuestionAuthenticatedEntity(unittest.TestCase):
    """ReviewQuestionAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewQuestionAuthenticatedEntity:
        """Test ReviewQuestionAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewQuestionAuthenticatedEntity`
        """
        model = ReviewQuestionAuthenticatedEntity()
        if include_optional:
            return ReviewQuestionAuthenticatedEntity(
                identifier = '',
                category = 'COMFORT',
                sort = 56,
                options = [
    ...
    def testReviewQuestionAuthenticatedEntity(self):
        """Test ReviewQuestionAuthenticatedEntity"""
