...
class TestSubCountryAuthenticatedEntity(unittest.TestCase):
    """SubCountryAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryAuthenticatedEntity:
        """Test SubCountryAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryAuthenticatedEntity`
        """
        model = SubCountryAuthenticatedEntity()
        if include_optional:
            return SubCountryAuthenticatedEntity(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountryAuthenticatedEntity(self):
        """Test SubCountryAuthenticatedEntity"""
