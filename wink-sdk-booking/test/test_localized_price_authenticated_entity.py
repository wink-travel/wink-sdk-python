...
class TestLocalizedPriceAuthenticatedEntity(unittest.TestCase):
    """LocalizedPriceAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedPriceAuthenticatedEntity:
        """Test LocalizedPriceAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedPriceAuthenticatedEntity`
        """
        model = LocalizedPriceAuthenticatedEntity()
        if include_optional:
            return LocalizedPriceAuthenticatedEntity(
    ...
    def testLocalizedPriceAuthenticatedEntity(self):
        """Test LocalizedPriceAuthenticatedEntity"""
