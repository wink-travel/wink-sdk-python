...
class TestBookingContractItemBooker(unittest.TestCase):
    """BookingContractItemBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractItemBooker:
        """Test BookingContractItemBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractItemBooker`
        """
        model = BookingContractItemBooker()
        if include_optional:
            return BookingContractItemBooker(
    ...
    def testBookingContractItemBooker(self):
        """Test BookingContractItemBooker"""
