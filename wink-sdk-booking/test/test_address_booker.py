...
class TestAddressBooker(unittest.TestCase):
    """AddressBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressBooker:
        """Test AddressBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressBooker`
        """
        model = AddressBooker()
        if include_optional:
            return AddressBooker(
