...
class TestImageAttributionBooker(unittest.TestCase):
    """ImageAttributionBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageAttributionBooker:
        """Test ImageAttributionBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAttributionBooker`
        """
        model = ImageAttributionBooker()
        if include_optional:
            return ImageAttributionBooker(
    ...
    def testImageAttributionBooker(self):
        """Test ImageAttributionBooker"""
