...
class TestRatePlanAuthenticatedEntity(unittest.TestCase):
    """RatePlanAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanAuthenticatedEntity:
        """Test RatePlanAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanAuthenticatedEntity`
        """
        model = RatePlanAuthenticatedEntity()
        if include_optional:
            return RatePlanAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                name = 'BAR 1',
                prepaid = False,
                ...
                arrival_days_of_week = wink_sdk_booking.models.dow_pattern_group_authenticated_entity.DowPatternGroup_Authenticated_Entity(
                    ...
                    sun = True, 
                    disabled = True, ),
                departure_days_of_week = wink_sdk_booking.models.dow_pattern_group_authenticated_entity.DowPatternGroup_Authenticated_Entity(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                required_days_of_week = wink_sdk_booking.models.dow_pattern_group_authenticated_entity.DowPatternGroup_Authenticated_Entity(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                early_check_in_charge = None,
                late_check_out_charge = None,
    ...
    def testRatePlanAuthenticatedEntity(self):
        """Test RatePlanAuthenticatedEntity"""
