...
class TestCustomizationLightweightBooker(unittest.TestCase):
    """CustomizationLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationLightweightBooker:
        """Test CustomizationLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationLightweightBooker`
        """
        model = CustomizationLightweightBooker()
        if include_optional:
            return CustomizationLightweightBooker(
    ...
    def testCustomizationLightweightBooker(self):
        """Test CustomizationLightweightBooker"""
