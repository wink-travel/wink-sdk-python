...
class TestSubmitReviewRequestAuthenticatedEntity(unittest.TestCase):
    """SubmitReviewRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitReviewRequestAuthenticatedEntity:
        """Test SubmitReviewRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitReviewRequestAuthenticatedEntity`
        """
        model = SubmitReviewRequestAuthenticatedEntity()
        if include_optional:
            return SubmitReviewRequestAuthenticatedEntity(
                answers = [
    ...
    def testSubmitReviewRequestAuthenticatedEntity(self):
        """Test SubmitReviewRequestAuthenticatedEntity"""
