...
class TestSimpleDateTimeItineraryBooker(unittest.TestCase):
    """SimpleDateTimeItineraryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDateTimeItineraryBooker:
        """Test SimpleDateTimeItineraryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDateTimeItineraryBooker`
        """
        model = SimpleDateTimeItineraryBooker()
        if include_optional:
            return SimpleDateTimeItineraryBooker(
    ...
    def testSimpleDateTimeItineraryBooker(self):
        """Test SimpleDateTimeItineraryBooker"""
