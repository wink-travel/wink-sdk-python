...
class TestMediaAuthorAttributionAuthenticatedEntity(unittest.TestCase):
    """MediaAuthorAttributionAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaAuthorAttributionAuthenticatedEntity:
        """Test MediaAuthorAttributionAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaAuthorAttributionAuthenticatedEntity`
        """
        model = MediaAuthorAttributionAuthenticatedEntity()
        if include_optional:
            return MediaAuthorAttributionAuthenticatedEntity(
    ...
    def testMediaAuthorAttributionAuthenticatedEntity(self):
        """Test MediaAuthorAttributionAuthenticatedEntity"""
