...
class TestCountryLightweightBooker(unittest.TestCase):
    """CountryLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryLightweightBooker:
        """Test CountryLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryLightweightBooker`
        """
        model = CountryLightweightBooker()
        if include_optional:
            return CountryLightweightBooker(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
    ...
    def testCountryLightweightBooker(self):
        """Test CountryLightweightBooker"""
