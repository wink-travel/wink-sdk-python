...
class TestBookingUserSessionBooker(unittest.TestCase):
    """BookingUserSessionBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserSessionBooker:
        """Test BookingUserSessionBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserSessionBooker`
        """
        model = BookingUserSessionBooker()
        if include_optional:
            return BookingUserSessionBooker(
    ...
    def testBookingUserSessionBooker(self):
        """Test BookingUserSessionBooker"""
