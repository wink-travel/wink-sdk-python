...
class TestHotelOnMapBooker(unittest.TestCase):
    """HotelOnMapBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelOnMapBooker:
        """Test HotelOnMapBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelOnMapBooker`
        """
        model = HotelOnMapBooker()
        if include_optional:
            return HotelOnMapBooker(
