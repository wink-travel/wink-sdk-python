...
class TestSubCountryLightweightBooker(unittest.TestCase):
    """SubCountryLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryLightweightBooker:
        """Test SubCountryLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryLightweightBooker`
        """
        model = SubCountryLightweightBooker()
        if include_optional:
            return SubCountryLightweightBooker(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountryLightweightBooker(self):
        """Test SubCountryLightweightBooker"""
