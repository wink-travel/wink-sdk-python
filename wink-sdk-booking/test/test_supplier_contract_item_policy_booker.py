...
class TestSupplierContractItemPolicyBooker(unittest.TestCase):
    """SupplierContractItemPolicyBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierContractItemPolicyBooker:
        """Test SupplierContractItemPolicyBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierContractItemPolicyBooker`
        """
        model = SupplierContractItemPolicyBooker()
        if include_optional:
            return SupplierContractItemPolicyBooker(
                refundable = True,
    ...
    def testSupplierContractItemPolicyBooker(self):
        """Test SupplierContractItemPolicyBooker"""
