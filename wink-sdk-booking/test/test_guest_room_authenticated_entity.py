...
class TestGuestRoomAuthenticatedEntity(unittest.TestCase):
    """GuestRoomAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomAuthenticatedEntity:
        """Test GuestRoomAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomAuthenticatedEntity`
        """
        model = GuestRoomAuthenticatedEntity()
        if include_optional:
            return GuestRoomAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testGuestRoomAuthenticatedEntity(self):
        """Test GuestRoomAuthenticatedEntity"""
