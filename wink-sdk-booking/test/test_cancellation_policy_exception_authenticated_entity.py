...
class TestCancellationPolicyExceptionAuthenticatedEntity(unittest.TestCase):
    """CancellationPolicyExceptionAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionAuthenticatedEntity:
        """Test CancellationPolicyExceptionAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionAuthenticatedEntity`
        """
        model = CancellationPolicyExceptionAuthenticatedEntity()
        if include_optional:
            return CancellationPolicyExceptionAuthenticatedEntity(
    ...
    def testCancellationPolicyExceptionAuthenticatedEntity(self):
        """Test CancellationPolicyExceptionAuthenticatedEntity"""
