...
class TestGuestRoomLightweightBooker(unittest.TestCase):
    """GuestRoomLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomLightweightBooker:
        """Test GuestRoomLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomLightweightBooker`
        """
        model = GuestRoomLightweightBooker()
        if include_optional:
            return GuestRoomLightweightBooker(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
                ...
                address = wink_sdk_booking.models.simple_address_booker.SimpleAddress_Booker(
    ...
    def testGuestRoomLightweightBooker(self):
        """Test GuestRoomLightweightBooker"""
