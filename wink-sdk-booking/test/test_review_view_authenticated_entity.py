...
class TestReviewViewAuthenticatedEntity(unittest.TestCase):
    """ReviewViewAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewViewAuthenticatedEntity:
        """Test ReviewViewAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewViewAuthenticatedEntity`
        """
        model = ReviewViewAuthenticatedEntity()
        if include_optional:
            return ReviewViewAuthenticatedEntity(
                ...
                version = 12,
                review = wink_sdk_booking.models.review_authenticated_entity.Review_Authenticated_Entity(
                    identifier = '', 
                    booking_identifier = '', 
                    hotel_identifier = '', 
                    user = wink_sdk_booking.models.review_user_authenticated_entity.ReviewUser_Authenticated_Entity(
                        user_identifier = '', 
                        first_name = 'John', 
                        last_name = 'Smith', 
                    ...
                    average_score = 8.7, 
                    answers = [
                        wink_sdk_booking.models.review_answer_authenticated_entity.ReviewAnswer_Authenticated_Entity(
                            question_identifier = '', 
                            category = 'COMFORT', 
                            sort = 56, 
                            value = 56, )
    ...
    def testReviewViewAuthenticatedEntity(self):
        """Test ReviewViewAuthenticatedEntity"""
