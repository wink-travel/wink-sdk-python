...
class TestReportingExtraChargeBooker(unittest.TestCase):
    """ReportingExtraChargeBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingExtraChargeBooker:
        """Test ReportingExtraChargeBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingExtraChargeBooker`
        """
        model = ReportingExtraChargeBooker()
        if include_optional:
            return ReportingExtraChargeBooker(
                name = '',
                description = '',
                gross_amount = 1.337,
                net_amount = 1.337,
    ...
    def testReportingExtraChargeBooker(self):
        """Test ReportingExtraChargeBooker"""
