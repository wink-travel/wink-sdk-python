...
class TestCheckoutResponseAuthenticatedEntity(unittest.TestCase):
    """CheckoutResponseAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckoutResponseAuthenticatedEntity:
        """Test CheckoutResponseAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckoutResponseAuthenticatedEntity`
        """
        model = CheckoutResponseAuthenticatedEntity()
        if include_optional:
            return CheckoutResponseAuthenticatedEntity(
                list = [
                    wink_sdk_booking.models.payable_contract_response_authenticated_entity.PayableContractResponse_Authenticated_Entity(
                        id = 'contract-1', 
                        trace_id = 'trace-1', 
    ...
    def testCheckoutResponseAuthenticatedEntity(self):
        """Test CheckoutResponseAuthenticatedEntity"""
