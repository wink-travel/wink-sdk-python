...
class TestDowPatternGroupBooker(unittest.TestCase):
    """DowPatternGroupBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DowPatternGroupBooker:
        """Test DowPatternGroupBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DowPatternGroupBooker`
        """
        model = DowPatternGroupBooker()
        if include_optional:
            return DowPatternGroupBooker(
                mon = True,
                tue = True,
                wed = True,
                thu = True,
    ...
    def testDowPatternGroupBooker(self):
        """Test DowPatternGroupBooker"""
