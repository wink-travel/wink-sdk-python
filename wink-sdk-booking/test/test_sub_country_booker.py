...
class TestSubCountryBooker(unittest.TestCase):
    """SubCountryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryBooker:
        """Test SubCountryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryBooker`
        """
        model = SubCountryBooker()
        if include_optional:
            return SubCountryBooker(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
