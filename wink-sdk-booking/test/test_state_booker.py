...
class TestStateBooker(unittest.TestCase):
    """StateBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateBooker:
        """Test StateBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateBooker`
        """
        model = StateBooker()
        if include_optional:
            return StateBooker(
                ...
                take = 10,
                sort = [
                    wink_sdk_booking.models.sort_descriptor_booker.SortDescriptor_Booker(
                        dir = 'asc', 
                        field = 'hotel.name', )
                    ],
                filter = wink_sdk_booking.models.composite_filter_descriptor_booker.CompositeFilterDescriptor_Booker(
                    logic = 'and', 
                    filters = [
                        wink_sdk_booking.models.filter_descriptor_booker.FilterDescriptor_Booker(
                            field = 'hotel.name', 
                            operator = 'startsWith', 
                            value = Happy Res, 
                            ignore_case = True, )
                ...
                group = [
                    wink_sdk_booking.models.group_descriptor_booker.GroupDescriptor_Booker(
                        field = 'createdDate', 
                        dir = 'asc', 
                        aggregates = [
                            wink_sdk_booking.models.aggregate_descriptor_booker.AggregateDescriptor_Booker(
