...
class TestBedroomBooker(unittest.TestCase):
    """BedroomBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomBooker:
        """Test BedroomBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomBooker`
        """
        model = BedroomBooker()
        if include_optional:
            return BedroomBooker(
                type = 'MASTER',
                bed_list = [
