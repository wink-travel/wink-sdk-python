...
class TestGeoNameBooker(unittest.TestCase):
    """GeoNameBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameBooker:
        """Test GeoNameBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameBooker`
        """
        model = GeoNameBooker()
        if include_optional:
            return GeoNameBooker(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
