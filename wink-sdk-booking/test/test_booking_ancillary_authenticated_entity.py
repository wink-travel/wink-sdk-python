...
class TestBookingAncillaryAuthenticatedEntity(unittest.TestCase):
    """BookingAncillaryAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingAncillaryAuthenticatedEntity:
        """Test BookingAncillaryAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingAncillaryAuthenticatedEntity`
        """
        model = BookingAncillaryAuthenticatedEntity()
        if include_optional:
            return BookingAncillaryAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                type_identifier = '',
    ...
    def testBookingAncillaryAuthenticatedEntity(self):
        """Test BookingAncillaryAuthenticatedEntity"""
