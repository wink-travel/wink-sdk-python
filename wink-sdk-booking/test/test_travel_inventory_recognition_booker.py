...
class TestTravelInventoryRecognitionBooker(unittest.TestCase):
    """TravelInventoryRecognitionBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelInventoryRecognitionBooker:
        """Test TravelInventoryRecognitionBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelInventoryRecognitionBooker`
        """
        model = TravelInventoryRecognitionBooker()
        if include_optional:
            return TravelInventoryRecognitionBooker(
                identifier = '',
                category = 'AWARD',
                type = 'PERCENT_RATING',
                provider = 'Michelin',
    ...
    def testTravelInventoryRecognitionBooker(self):
        """Test TravelInventoryRecognitionBooker"""
