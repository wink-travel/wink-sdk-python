...
class TestReportingDailyRateBooker(unittest.TestCase):
    """ReportingDailyRateBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingDailyRateBooker:
        """Test ReportingDailyRateBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingDailyRateBooker`
        """
        model = ReportingDailyRateBooker()
        if include_optional:
            return ReportingDailyRateBooker(
    ...
    def testReportingDailyRateBooker(self):
        """Test ReportingDailyRateBooker"""
