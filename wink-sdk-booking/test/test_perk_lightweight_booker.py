...
class TestPerkLightweightBooker(unittest.TestCase):
    """PerkLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerkLightweightBooker:
        """Test PerkLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerkLightweightBooker`
        """
        model = PerkLightweightBooker()
        if include_optional:
            return PerkLightweightBooker(
                identifier = '',
                guaranteed = True,
                level = 56,
                descriptions = [
    ...
    def testPerkLightweightBooker(self):
        """Test PerkLightweightBooker"""
