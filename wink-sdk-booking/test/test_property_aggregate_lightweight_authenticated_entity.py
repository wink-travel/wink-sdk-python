...
class TestPropertyAggregateLightweightAuthenticatedEntity(unittest.TestCase):
    """PropertyAggregateLightweightAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateLightweightAuthenticatedEntity:
        """Test PropertyAggregateLightweightAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateLightweightAuthenticatedEntity`
        """
        model = PropertyAggregateLightweightAuthenticatedEntity()
        if include_optional:
            return PropertyAggregateLightweightAuthenticatedEntity(
    ...
    def testPropertyAggregateLightweightAuthenticatedEntity(self):
        """Test PropertyAggregateLightweightAuthenticatedEntity"""
