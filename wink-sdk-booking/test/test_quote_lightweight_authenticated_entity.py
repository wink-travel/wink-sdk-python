...
class TestQuoteLightweightAuthenticatedEntity(unittest.TestCase):
    """QuoteLightweightAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLightweightAuthenticatedEntity:
        """Test QuoteLightweightAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLightweightAuthenticatedEntity`
        """
        model = QuoteLightweightAuthenticatedEntity()
        if include_optional:
            return QuoteLightweightAuthenticatedEntity(
                source = '0',
                target = '0',
                exchange_rate = 1.337,
                timestamp = 56
    ...
    def testQuoteLightweightAuthenticatedEntity(self):
        """Test QuoteLightweightAuthenticatedEntity"""
