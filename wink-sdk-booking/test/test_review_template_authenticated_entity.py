...
class TestReviewTemplateAuthenticatedEntity(unittest.TestCase):
    """ReviewTemplateAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewTemplateAuthenticatedEntity:
        """Test ReviewTemplateAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewTemplateAuthenticatedEntity`
        """
        model = ReviewTemplateAuthenticatedEntity()
        if include_optional:
            return ReviewTemplateAuthenticatedEntity(
                ...
                user_identifier = '',
                questions = [
                    wink_sdk_booking.models.review_question_authenticated_entity.ReviewQuestion_Authenticated_Entity(
                        identifier = '', 
                        category = 'COMFORT', 
                        sort = 56, 
                        options = [
    ...
    def testReviewTemplateAuthenticatedEntity(self):
        """Test ReviewTemplateAuthenticatedEntity"""
