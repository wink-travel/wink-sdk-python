...
class TestBedBooker(unittest.TestCase):
    """BedBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedBooker:
        """Test BedBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedBooker`
        """
        model = BedBooker()
        if include_optional:
            return BedBooker(
