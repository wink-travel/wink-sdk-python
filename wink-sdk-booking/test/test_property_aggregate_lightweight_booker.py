...
class TestPropertyAggregateLightweightBooker(unittest.TestCase):
    """PropertyAggregateLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateLightweightBooker:
        """Test PropertyAggregateLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateLightweightBooker`
        """
        model = PropertyAggregateLightweightBooker()
        if include_optional:
            return PropertyAggregateLightweightBooker(
    ...
    def testPropertyAggregateLightweightBooker(self):
        """Test PropertyAggregateLightweightBooker"""
