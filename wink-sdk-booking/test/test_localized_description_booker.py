...
class TestLocalizedDescriptionBooker(unittest.TestCase):
    """LocalizedDescriptionBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedDescriptionBooker:
        """Test LocalizedDescriptionBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedDescriptionBooker`
        """
        model = LocalizedDescriptionBooker()
        if include_optional:
            return LocalizedDescriptionBooker(
    ...
    def testLocalizedDescriptionBooker(self):
        """Test LocalizedDescriptionBooker"""
