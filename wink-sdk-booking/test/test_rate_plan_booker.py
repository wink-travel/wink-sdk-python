...
class TestRatePlanBooker(unittest.TestCase):
    """RatePlanBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanBooker:
        """Test RatePlanBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanBooker`
        """
        model = RatePlanBooker()
        if include_optional:
            return RatePlanBooker(
                identifier = '',
                hotel_identifier = '',
                name = 'BAR 1',
                prepaid = False,
                ...
                arrival_days_of_week = wink_sdk_booking.models.dow_pattern_group_booker.DowPatternGroup_Booker(
                    ...
                    sun = True, 
                    disabled = True, ),
                departure_days_of_week = wink_sdk_booking.models.dow_pattern_group_booker.DowPatternGroup_Booker(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                required_days_of_week = wink_sdk_booking.models.dow_pattern_group_booker.DowPatternGroup_Booker(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
