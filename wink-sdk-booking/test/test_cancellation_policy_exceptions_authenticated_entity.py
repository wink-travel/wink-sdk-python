...
class TestCancellationPolicyExceptionsAuthenticatedEntity(unittest.TestCase):
    """CancellationPolicyExceptionsAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionsAuthenticatedEntity:
        """Test CancellationPolicyExceptionsAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionsAuthenticatedEntity`
        """
        model = CancellationPolicyExceptionsAuthenticatedEntity()
        if include_optional:
            return CancellationPolicyExceptionsAuthenticatedEntity(
                list = [
    ...
    def testCancellationPolicyExceptionsAuthenticatedEntity(self):
        """Test CancellationPolicyExceptionsAuthenticatedEntity"""
