...
class TestSubSubCountryAuthenticatedEntity(unittest.TestCase):
    """SubSubCountryAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryAuthenticatedEntity:
        """Test SubSubCountryAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryAuthenticatedEntity`
        """
        model = SubSubCountryAuthenticatedEntity()
        if include_optional:
            return SubSubCountryAuthenticatedEntity(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryAuthenticatedEntity(self):
        """Test SubSubCountryAuthenticatedEntity"""
