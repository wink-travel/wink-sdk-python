...
class TestTravelInventoryRecognitionAuthenticatedEntity(unittest.TestCase):
    """TravelInventoryRecognitionAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelInventoryRecognitionAuthenticatedEntity:
        """Test TravelInventoryRecognitionAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelInventoryRecognitionAuthenticatedEntity`
        """
        model = TravelInventoryRecognitionAuthenticatedEntity()
        if include_optional:
            return TravelInventoryRecognitionAuthenticatedEntity(
                identifier = '',
                category = 'AWARD',
                type = 'PERCENT_RATING',
                provider = 'Michelin',
    ...
    def testTravelInventoryRecognitionAuthenticatedEntity(self):
        """Test TravelInventoryRecognitionAuthenticatedEntity"""
