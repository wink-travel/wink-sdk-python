...
class TestReviewQuestionLightweightAuthenticatedEntity(unittest.TestCase):
    """ReviewQuestionLightweightAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewQuestionLightweightAuthenticatedEntity:
        """Test ReviewQuestionLightweightAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewQuestionLightweightAuthenticatedEntity`
        """
        model = ReviewQuestionLightweightAuthenticatedEntity()
        if include_optional:
            return ReviewQuestionLightweightAuthenticatedEntity(
                identifier = '',
                category = 'COMFORT',
                sort = 56,
                options = [
                    wink_sdk_booking.models.review_answer_option_authenticated_entity.ReviewAnswerOption_Authenticated_Entity(
                        sort = 56, 
                        value = 56, )
                    ]
            )
    ...
    def testReviewQuestionLightweightAuthenticatedEntity(self):
        """Test ReviewQuestionLightweightAuthenticatedEntity"""
