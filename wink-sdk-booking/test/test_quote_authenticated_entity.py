...
class TestQuoteAuthenticatedEntity(unittest.TestCase):
    """QuoteAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteAuthenticatedEntity:
        """Test QuoteAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteAuthenticatedEntity`
        """
        model = QuoteAuthenticatedEntity()
        if include_optional:
            return QuoteAuthenticatedEntity(
                source = '',
                target = '',
                exchange_rate = 1.337,
                timestamp = 56
    ...
    def testQuoteAuthenticatedEntity(self):
        """Test QuoteAuthenticatedEntity"""
