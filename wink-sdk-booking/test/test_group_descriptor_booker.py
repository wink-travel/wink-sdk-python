...
class TestGroupDescriptorBooker(unittest.TestCase):
    """GroupDescriptorBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupDescriptorBooker:
        """Test GroupDescriptorBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupDescriptorBooker`
        """
        model = GroupDescriptorBooker()
        if include_optional:
            return GroupDescriptorBooker(
    ...
    def testGroupDescriptorBooker(self):
        """Test GroupDescriptorBooker"""
