...
class TestBeneficiaryBooker(unittest.TestCase):
    """BeneficiaryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryBooker:
        """Test BeneficiaryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryBooker`
        """
        model = BeneficiaryBooker()
        if include_optional:
            return BeneficiaryBooker(
    ...
    def testBeneficiaryBooker(self):
        """Test BeneficiaryBooker"""
