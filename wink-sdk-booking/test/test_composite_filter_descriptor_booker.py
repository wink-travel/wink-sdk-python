...
class TestCompositeFilterDescriptorBooker(unittest.TestCase):
    """CompositeFilterDescriptorBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompositeFilterDescriptorBooker:
        """Test CompositeFilterDescriptorBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompositeFilterDescriptorBooker`
        """
        model = CompositeFilterDescriptorBooker()
        if include_optional:
            return CompositeFilterDescriptorBooker(
                logic = 'and',
                filters = [
    ...
    def testCompositeFilterDescriptorBooker(self):
        """Test CompositeFilterDescriptorBooker"""
