...
class TestCountryBooker(unittest.TestCase):
    """CountryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryBooker:
        """Test CountryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryBooker`
        """
        model = CountryBooker()
        if include_optional:
            return CountryBooker(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
