...
class TestBedroomConfigurationAuthenticatedEntity(unittest.TestCase):
    """BedroomConfigurationAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomConfigurationAuthenticatedEntity:
        """Test BedroomConfigurationAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomConfigurationAuthenticatedEntity`
        """
        model = BedroomConfigurationAuthenticatedEntity()
        if include_optional:
            return BedroomConfigurationAuthenticatedEntity(
                identifier = '',
                name = '',
                bedroom_list = [
    ...
    def testBedroomConfigurationAuthenticatedEntity(self):
        """Test BedroomConfigurationAuthenticatedEntity"""
