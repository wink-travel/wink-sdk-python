...
class TestReviewUserBooker(unittest.TestCase):
    """ReviewUserBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewUserBooker:
        """Test ReviewUserBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewUserBooker`
        """
        model = ReviewUserBooker()
        if include_optional:
            return ReviewUserBooker(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
