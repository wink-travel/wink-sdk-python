...
class TestSimpleDescriptionAuthenticatedEntity(unittest.TestCase):
    """SimpleDescriptionAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDescriptionAuthenticatedEntity:
        """Test SimpleDescriptionAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDescriptionAuthenticatedEntity`
        """
        model = SimpleDescriptionAuthenticatedEntity()
        if include_optional:
            return SimpleDescriptionAuthenticatedEntity(
    ...
    def testSimpleDescriptionAuthenticatedEntity(self):
        """Test SimpleDescriptionAuthenticatedEntity"""
