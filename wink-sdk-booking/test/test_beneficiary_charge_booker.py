...
class TestBeneficiaryChargeBooker(unittest.TestCase):
    """BeneficiaryChargeBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryChargeBooker:
        """Test BeneficiaryChargeBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryChargeBooker`
        """
        model = BeneficiaryChargeBooker()
        if include_optional:
            return BeneficiaryChargeBooker(
                type = 'PERCENTAGE',
                percent = 1.337
            )
        else:
    ...
    def testBeneficiaryChargeBooker(self):
        """Test BeneficiaryChargeBooker"""
