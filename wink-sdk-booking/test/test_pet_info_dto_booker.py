...
class TestPetInfoDtoBooker(unittest.TestCase):
    """PetInfoDtoBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoDtoBooker:
        """Test PetInfoDtoBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoDtoBooker`
        """
        model = PetInfoDtoBooker()
        if include_optional:
            return PetInfoDtoBooker(
                name = '',
                type = ''
            )
        else:
