...
class TestMediaAuthorAttributionBooker(unittest.TestCase):
    """MediaAuthorAttributionBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaAuthorAttributionBooker:
        """Test MediaAuthorAttributionBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaAuthorAttributionBooker`
        """
        model = MediaAuthorAttributionBooker()
        if include_optional:
            return MediaAuthorAttributionBooker(
    ...
    def testMediaAuthorAttributionBooker(self):
        """Test MediaAuthorAttributionBooker"""
