...
class TestLocalizedDescriptionAuthenticatedEntity(unittest.TestCase):
    """LocalizedDescriptionAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedDescriptionAuthenticatedEntity:
        """Test LocalizedDescriptionAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedDescriptionAuthenticatedEntity`
        """
        model = LocalizedDescriptionAuthenticatedEntity()
        if include_optional:
            return LocalizedDescriptionAuthenticatedEntity(
    ...
    def testLocalizedDescriptionAuthenticatedEntity(self):
        """Test LocalizedDescriptionAuthenticatedEntity"""
