...
class TestQuoteBooker(unittest.TestCase):
    """QuoteBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteBooker:
        """Test QuoteBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteBooker`
        """
        model = QuoteBooker()
        if include_optional:
            return QuoteBooker(
