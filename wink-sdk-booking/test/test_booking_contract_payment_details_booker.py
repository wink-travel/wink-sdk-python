...
class TestBookingContractPaymentDetailsBooker(unittest.TestCase):
    """BookingContractPaymentDetailsBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractPaymentDetailsBooker:
        """Test BookingContractPaymentDetailsBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractPaymentDetailsBooker`
        """
        model = BookingContractPaymentDetailsBooker()
        if include_optional:
            return BookingContractPaymentDetailsBooker(
    ...
    def testBookingContractPaymentDetailsBooker(self):
        """Test BookingContractPaymentDetailsBooker"""
