...
class TestGuestRoomBooker(unittest.TestCase):
    """GuestRoomBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomBooker:
        """Test GuestRoomBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomBooker`
        """
        model = GuestRoomBooker()
        if include_optional:
            return GuestRoomBooker(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
