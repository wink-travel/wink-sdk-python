...
class TestGeoJsonPointAuthenticatedEntity(unittest.TestCase):
    """GeoJsonPointAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonPointAuthenticatedEntity:
        """Test GeoJsonPointAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonPointAuthenticatedEntity`
        """
        model = GeoJsonPointAuthenticatedEntity()
        if include_optional:
            return GeoJsonPointAuthenticatedEntity(
                x = 1.337,
                y = 1.337,
                type = '',
                coordinates = [
    ...
    def testGeoJsonPointAuthenticatedEntity(self):
        """Test GeoJsonPointAuthenticatedEntity"""
