...
class TestGeneralManagerAuthenticatedEntity(unittest.TestCase):
    """GeneralManagerAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralManagerAuthenticatedEntity:
        """Test GeneralManagerAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralManagerAuthenticatedEntity`
        """
        model = GeneralManagerAuthenticatedEntity()
        if include_optional:
            return GeneralManagerAuthenticatedEntity(
                name = 'Jane Doe',
                image = wink_sdk_booking.models.simple_multimedia_authenticated_entity.SimpleMultimedia_Authenticated_Entity(
    ...
    def testGeneralManagerAuthenticatedEntity(self):
        """Test GeneralManagerAuthenticatedEntity"""
