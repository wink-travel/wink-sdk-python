...
class TestBedAuthenticatedEntity(unittest.TestCase):
    """BedAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedAuthenticatedEntity:
        """Test BedAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedAuthenticatedEntity`
        """
        model = BedAuthenticatedEntity()
        if include_optional:
            return BedAuthenticatedEntity(
                bed_type_code = '1',
                quantity = 10
            )
        else:
    ...
    def testBedAuthenticatedEntity(self):
        """Test BedAuthenticatedEntity"""
