...
class TestPayoutBooker(unittest.TestCase):
    """PayoutBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutBooker:
        """Test PayoutBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutBooker`
        """
        model = PayoutBooker()
        if include_optional:
            return PayoutBooker(
