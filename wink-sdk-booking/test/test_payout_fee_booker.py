...
class TestPayoutFeeBooker(unittest.TestCase):
    """PayoutFeeBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutFeeBooker:
        """Test PayoutFeeBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutFeeBooker`
        """
        model = PayoutFeeBooker()
        if include_optional:
            return PayoutFeeBooker(
                identifier = '',
