...
class TestBedroomConfigurationBooker(unittest.TestCase):
    """BedroomConfigurationBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomConfigurationBooker:
        """Test BedroomConfigurationBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomConfigurationBooker`
        """
        model = BedroomConfigurationBooker()
        if include_optional:
            return BedroomConfigurationBooker(
                identifier = '',
                name = '',
                bedroom_list = [
    ...
    def testBedroomConfigurationBooker(self):
        """Test BedroomConfigurationBooker"""
