...
class TestProfileBooker(unittest.TestCase):
    """ProfileBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileBooker:
        """Test ProfileBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileBooker`
        """
        model = ProfileBooker()
        if include_optional:
            return ProfileBooker(
                profile_identifier = '',
                user_identifier = '',
                share = True,
