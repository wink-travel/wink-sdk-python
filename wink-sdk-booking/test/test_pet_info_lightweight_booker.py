...
class TestPetInfoLightweightBooker(unittest.TestCase):
    """PetInfoLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoLightweightBooker:
        """Test PetInfoLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoLightweightBooker`
        """
        model = PetInfoLightweightBooker()
        if include_optional:
            return PetInfoLightweightBooker(
                name = '0',
                type = '0'
            )
        else:
    ...
    def testPetInfoLightweightBooker(self):
        """Test PetInfoLightweightBooker"""
