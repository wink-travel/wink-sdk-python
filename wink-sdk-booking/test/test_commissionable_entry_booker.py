...
class TestCommissionableEntryBooker(unittest.TestCase):
    """CommissionableEntryBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommissionableEntryBooker:
        """Test CommissionableEntryBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommissionableEntryBooker`
        """
        model = CommissionableEntryBooker()
        if include_optional:
            return CommissionableEntryBooker(
                name = '',
                identifier = '',
                type = 'GUEST_ROOM',
    ...
    def testCommissionableEntryBooker(self):
        """Test CommissionableEntryBooker"""
