...
class TestReviewAnswerBooker(unittest.TestCase):
    """ReviewAnswerBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewAnswerBooker:
        """Test ReviewAnswerBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAnswerBooker`
        """
        model = ReviewAnswerBooker()
        if include_optional:
            return ReviewAnswerBooker(
                question_identifier = '',
                category = 'COMFORT',
                sort = 56,
                value = 56
    ...
    def testReviewAnswerBooker(self):
        """Test ReviewAnswerBooker"""
