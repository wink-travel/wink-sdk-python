...
class TestGeoNameLightweightBooker(unittest.TestCase):
    """GeoNameLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameLightweightBooker:
        """Test GeoNameLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameLightweightBooker`
        """
        model = GeoNameLightweightBooker()
        if include_optional:
            return GeoNameLightweightBooker(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
    ...
    def testGeoNameLightweightBooker(self):
        """Test GeoNameLightweightBooker"""
