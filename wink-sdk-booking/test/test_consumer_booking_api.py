...
class TestConsumerBookingApi(unittest.TestCase):
    """ConsumerBookingApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ConsumerBookingApi()
    ...
    def test_cancel_group_booking(self) -> None:
        """Test case for cancel_group_booking
    ...
    def test_show_booking(self) -> None:
        """Test case for show_booking

        Show Booking
        """
        pass

    def test_show_booking_by_transaction_id(self) -> None:
        """Test case for show_booking_by_transaction_id

        Show Booking by TX ID
        """
        pass

    def test_show_booking_grid(self) -> None:
        """Test case for show_booking_grid

        Search Bookings
        """
        pass

    def test_show_bookings(self) -> None:
        """Test case for show_bookings

        Show Booking List
        """
        pass

    def test_show_bookings_by_review_state(self) -> None:
        """Test case for show_bookings_by_review_state

        Show Bookings by Review
        """
        pass

    def test_show_bookings_by_state(self) -> None:
        """Test case for show_bookings_by_state

        Show Bookings by Time
        """
        pass

    def test_show_grouped_bookings(self) -> None:
        """Test case for show_grouped_bookings
