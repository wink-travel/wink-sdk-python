...
class TestAuthenticatedUserBooker(unittest.TestCase):
    """AuthenticatedUserBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticatedUserBooker:
        """Test AuthenticatedUserBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticatedUserBooker`
        """
        model = AuthenticatedUserBooker()
        if include_optional:
            return AuthenticatedUserBooker(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testAuthenticatedUserBooker(self):
        """Test AuthenticatedUserBooker"""
