...
class TestSortDescriptorBooker(unittest.TestCase):
    """SortDescriptorBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortDescriptorBooker:
        """Test SortDescriptorBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortDescriptorBooker`
        """
        model = SortDescriptorBooker()
        if include_optional:
            return SortDescriptorBooker(
                dir = 'asc',
    ...
    def testSortDescriptorBooker(self):
        """Test SortDescriptorBooker"""
