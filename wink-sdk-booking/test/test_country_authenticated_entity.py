...
class TestCountryAuthenticatedEntity(unittest.TestCase):
    """CountryAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryAuthenticatedEntity:
        """Test CountryAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryAuthenticatedEntity`
        """
        model = CountryAuthenticatedEntity()
        if include_optional:
            return CountryAuthenticatedEntity(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
    ...
    def testCountryAuthenticatedEntity(self):
        """Test CountryAuthenticatedEntity"""
