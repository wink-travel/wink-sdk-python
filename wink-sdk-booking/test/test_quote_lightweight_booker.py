...
class TestQuoteLightweightBooker(unittest.TestCase):
    """QuoteLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLightweightBooker:
        """Test QuoteLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLightweightBooker`
        """
        model = QuoteLightweightBooker()
        if include_optional:
            return QuoteLightweightBooker(
                source = '0',
                target = '0',
                exchange_rate = 1.337,
                timestamp = 56
    ...
    def testQuoteLightweightBooker(self):
        """Test QuoteLightweightBooker"""
