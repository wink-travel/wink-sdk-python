...
class TestReviewBooker(unittest.TestCase):
    """ReviewBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewBooker:
        """Test ReviewBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewBooker`
        """
        model = ReviewBooker()
        if include_optional:
            return ReviewBooker(
                ...
                booking_identifier = '',
                hotel_identifier = '',
                user = wink_sdk_booking.models.review_user_booker.ReviewUser_Booker(
                    user_identifier = '', 
                    first_name = 'John', 
                    last_name = 'Smith', 
