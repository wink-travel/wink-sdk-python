...
class TestGuestUserBooker(unittest.TestCase):
    """GuestUserBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestUserBooker:
        """Test GuestUserBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestUserBooker`
        """
        model = GuestUserBooker()
        if include_optional:
            return GuestUserBooker(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
