...
class TestEngineConfigurationBookingReportBooker(unittest.TestCase):
    """EngineConfigurationBookingReportBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationBookingReportBooker:
        """Test EngineConfigurationBookingReportBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationBookingReportBooker`
        """
        model = EngineConfigurationBookingReportBooker()
        if include_optional:
            return EngineConfigurationBookingReportBooker(
                identifier = '',
    ...
    def testEngineConfigurationBookingReportBooker(self):
        """Test EngineConfigurationBookingReportBooker"""
