...
class TestRatePlanLevelFeeAuthenticatedEntity(unittest.TestCase):
    """RatePlanLevelFeeAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanLevelFeeAuthenticatedEntity:
        """Test RatePlanLevelFeeAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanLevelFeeAuthenticatedEntity`
        """
        model = RatePlanLevelFeeAuthenticatedEntity()
        if include_optional:
            return RatePlanLevelFeeAuthenticatedEntity(
                descriptions = [
    ...
    def testRatePlanLevelFeeAuthenticatedEntity(self):
        """Test RatePlanLevelFeeAuthenticatedEntity"""
