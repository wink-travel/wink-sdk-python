...
class TestEngineConfigurationThemeColorsBooker(unittest.TestCase):
    """EngineConfigurationThemeColorsBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeColorsBooker:
        """Test EngineConfigurationThemeColorsBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeColorsBooker`
        """
        model = EngineConfigurationThemeColorsBooker()
        if include_optional:
            return EngineConfigurationThemeColorsBooker(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeColorsBooker(self):
        """Test EngineConfigurationThemeColorsBooker"""
