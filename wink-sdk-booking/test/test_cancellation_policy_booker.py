...
class TestCancellationPolicyBooker(unittest.TestCase):
    """CancellationPolicyBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyBooker:
        """Test CancellationPolicyBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyBooker`
        """
        model = CancellationPolicyBooker()
        if include_optional:
            return CancellationPolicyBooker(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyBooker(self):
        """Test CancellationPolicyBooker"""
