...
class TestReviewLightweightBooker(unittest.TestCase):
    """ReviewLightweightBooker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewLightweightBooker:
        """Test ReviewLightweightBooker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewLightweightBooker`
        """
        model = ReviewLightweightBooker()
        if include_optional:
            return ReviewLightweightBooker(
                identifier = 'review-1',
    ...
    def testReviewLightweightBooker(self):
        """Test ReviewLightweightBooker"""
