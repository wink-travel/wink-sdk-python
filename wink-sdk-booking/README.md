...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.26#egg=wink_sdk_booking&subdirectory=wink-sdk-booking
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.26#egg=wink_sdk_booking&subdirectory=wink_sdk_booking`)
