...
class ReviewApi:
    ...
    def populate_review(
        ...
        :param booking_identifier: (required)
        ...
        _param = self._populate_review_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "ReviewTemplateAuthenticatedEntity",
        }
    ...
    @validate_call
    def populate_review_with_http_info(
        self,
        booking_identifier: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReviewTemplateAuthenticatedEntity]:
        """Show Review Template
    ...
    @validate_call
    def populate_review_without_preload_content(
        self,
        booking_identifier: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _populate_review_serialize(
        self,
        booking_identifier,
        wink_version,
        accept,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/booking/{bookingIdentifier}/review/questions',
    ...
    def submit_review(
        self,
        booking_identifier: StrictStr,
        submit_review_request_authenticated_entity: SubmitReviewRequestAuthenticatedEntity,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param booking_identifier: (required)
        :type booking_identifier: str
        :param submit_review_request_authenticated_entity: (required)
        :type submit_review_request_authenticated_entity: SubmitReviewRequestAuthenticatedEntity
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._submit_review_serialize(
            booking_identifier=booking_identifier,
            submit_review_request_authenticated_entity=submit_review_request_authenticated_entity,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def submit_review_with_http_info(
        self,
        booking_identifier: StrictStr,
        submit_review_request_authenticated_entity: SubmitReviewRequestAuthenticatedEntity,
        wink_version: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReviewAuthenticatedEntity]:
        """Submit Review
    ...
    @validate_call
    def submit_review_without_preload_content(
        self,
        booking_identifier: StrictStr,
        submit_review_request_authenticated_entity: SubmitReviewRequestAuthenticatedEntity,
        wink_version: Optional[StrictStr] = None,
    ...
    def _submit_review_serialize(
        self,
        booking_identifier,
        submit_review_request_authenticated_entity,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if submit_review_request_authenticated_entity is not None:
            _body_params = submit_review_request_authenticated_entity
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/booking/{bookingIdentifier}/review',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
