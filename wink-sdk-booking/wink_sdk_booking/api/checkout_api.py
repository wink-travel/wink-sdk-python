...
class CheckoutApi:
    ...
    def checkout(
        self,
        checkout_request_authenticated_entity: CheckoutRequestAuthenticatedEntity,
        ...
        :param checkout_request_authenticated_entity: (required)
        :type checkout_request_authenticated_entity: CheckoutRequestAuthenticatedEntity
        :param wink_version:
        ...
        _param = self._checkout_serialize(
            checkout_request_authenticated_entity=checkout_request_authenticated_entity,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "CheckoutResponseAuthenticatedEntity",
        }
    ...
    def checkout_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CheckoutResponseAuthenticatedEntity]:
        """Prepare booking
    ...
    def _checkout_serialize(
        self,
        checkout_request_authenticated_entity,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if checkout_request_authenticated_entity is not None:
            _body_params = checkout_request_authenticated_entity
