...
class CancellationPolicyExceptionAuthenticatedEntity(BaseModel):
    """
    ...
    cancellation_policy: CancellationPolicyLightweightAuthenticatedEntity = Field(description="Cancellation policy", alias="cancellationPolicy")
