...
class ExtraChargeBooker(BaseModel):
    ...
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeBooker] = Field(default=None, alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceBooker] = Field(default=None, alias="unitPrice")
    price: Optional[LocalizedPriceBooker] = None
