...
class ExtraChargeBooker(BaseModel):
    """
    ExtraChargeBooker
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeBooker] = Field(default=None, description="What the guest is paying extra for", alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceBooker] = Field(default=None, description="The localized unit price of the extra charge", alias="unitPrice")
    price: Optional[LocalizedPriceBooker] = Field(default=None, description="The localized price of the extra charge")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ratePlanLevelFee": RatePlanLevelFeeBooker.from_dict(obj["ratePlanLevelFee"]) if obj.get("ratePlanLevelFee") is not None else None,
            "unitPrice": LocalizedPriceBooker.from_dict(obj["unitPrice"]) if obj.get("unitPrice") is not None else None,
