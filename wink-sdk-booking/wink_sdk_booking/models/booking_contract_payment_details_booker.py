...
class BookingContractPaymentDetailsBooker(BaseModel):
    """
    ...
    fees: Optional[List[FeeBooker]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fees": [FeeBooker.from_dict(_item) for _item in obj["fees"]] if obj.get("fees") is not None else None,
