...
class BookingUserSessionBooker(BaseModel):
    """
    User session information containing itinerary and other user related data.
    """ # noqa: E501
    itinerary: BookingItineraryBooker = Field(description="Dates and travel info.")
    language: Optional[StrictStr] = Field(default=None, description="User's language preference")
    currency: Optional[StrictStr] = Field(default=None, description="User's currency preference")
    promotional_codes: Optional[List[StrictStr]] = Field(default=None, alias="promotionalCodes")
    selected_room_configuration_index: Optional[StrictInt] = Field(default=None, description="User can pass the current room configuration index to retrieve rates specifically for that room configuration.", alias="selectedRoomConfigurationIndex")
    lifestyle: Optional[StrictStr] = Field(default=None, description="The preferred user lifestyle.")
    __properties: ClassVar[List[str]] = ["itinerary", "language", "currency", "promotionalCodes", "selectedRoomConfigurationIndex", "lifestyle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "itinerary": BookingItineraryBooker.from_dict(obj["itinerary"]) if obj.get("itinerary") is not None else None,
            "language": obj.get("language"),
            "currency": obj.get("currency"),
            "promotionalCodes": obj.get("promotionalCodes"),
            "selectedRoomConfigurationIndex": obj.get("selectedRoomConfigurationIndex"),
