...
class PageBookingBooker(BaseModel):
    """
    PageBookingBooker
    """ # noqa: E501
    ...
    content: Optional[List[BookingBooker]] = None
    number: Optional[StrictInt] = None
    pageable: Optional[PageableObjectBooker] = None
    sort: Optional[SortObjectBooker] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [BookingBooker.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "number": obj.get("number"),
            "pageable": PageableObjectBooker.from_dict(obj["pageable"]) if obj.get("pageable") is not None else None,
            "sort": SortObjectBooker.from_dict(obj["sort"]) if obj.get("sort") is not None else None,
