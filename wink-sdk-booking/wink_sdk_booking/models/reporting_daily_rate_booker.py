...
class ReportingDailyRateBooker(BaseModel):
    """
    ReportingDailyRateBooker
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, description="The rate date.", alias="date")
    base_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The rate given to us by channel manager / CRS / PMS.", alias="baseAmount")
    gross_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The derived amount based on promotions, member discounts etc within our platform.", alias="grossAmount")
    net_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The gross amount minus fees and commissions.", alias="netAmount")
    net_amount_with_refund: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The net amount minus potential refund. Null if booking contains no refund.", alias="netAmountWithRefund")
    currency: Optional[StrictStr] = Field(default=None, description="The currency for these amounts.")
    __properties: ClassVar[List[str]] = ["date", "baseAmount", "grossAmount", "netAmount", "netAmountWithRefund", "currency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "netAmountWithRefund": obj.get("netAmountWithRefund"),
