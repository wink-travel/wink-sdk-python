...
class SubmitReviewRequestAuthenticatedEntity(BaseModel):
    """
    SubmitReviewRequestAuthenticatedEntity
    """ # noqa: E501
    answers: Annotated[List[SubmitReviewAnswerAuthenticatedEntity], Field(min_length=1, max_length=2147483647)] = Field(description="List of user review answers.")
    ...
    __properties: ClassVar[List[str]] = ["answers", "messageFromGuest", "imageIdentifier", "text", "roomNumber", "roomRating"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answers": [SubmitReviewAnswerAuthenticatedEntity.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None,
