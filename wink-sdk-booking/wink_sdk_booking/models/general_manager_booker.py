...
class GeneralManagerBooker(BaseModel):
    """
    General manager related data.
    """ # noqa: E501
    name: StrictStr = Field(description="Name of GM currently managing the property.")
    image: Optional[SimpleMultimediaBooker] = Field(default=None, description="Cloudinary image identifier of GM currently managing the property.")
    descriptions: Optional[List[LocalizedDescriptionBooker]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "image": SimpleMultimediaBooker.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "descriptions": [LocalizedDescriptionBooker.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None
        })
        return _obj
