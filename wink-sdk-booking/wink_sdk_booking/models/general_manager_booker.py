...
class GeneralManagerBooker(BaseModel):
    ...
    image: Optional[SimpleMultimediaBooker] = None
    descriptions: Optional[List[LocalizedDescriptionBooker]] = Field(default=None, description="Localized welcome message from GM.")
