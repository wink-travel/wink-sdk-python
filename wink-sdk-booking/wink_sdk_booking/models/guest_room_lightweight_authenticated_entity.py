...
class GuestRoomLightweightAuthenticatedEntity(BaseModel):
    """
    ...
    location: GeoJsonPointAuthenticatedEntity = Field(description="Geo-location point where blocking takes place. Defaults to location of property.")
    descriptions: Annotated[List[SimpleDescriptionAuthenticatedEntity], Field(min_length=1)] = Field(description="Localized descriptions describing inventory.")
    multimedias: Annotated[List[SimpleMultimediaAuthenticatedEntity], Field(min_length=1)] = Field(description="List of images / videos of blocking.")
    contact: ContactAuthenticatedEntity = Field(description="Associate a contact person for this blocking (if applicable).")
    address: SimpleAddressAuthenticatedEntity = Field(description="Defaults to property address.")
    ...
    socials: Optional[List[SocialAuthenticatedEntity]] = Field(default=None, description="Social network accounts for blocking (if applicable).")
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    recognition_list: Optional[List[TravelInventoryRecognitionAuthenticatedEntity]] = Field(default=None, description="Inventory-level recognition.", alias="recognitionList")
    ...
    bedroom_configuration_list: Annotated[List[BedroomConfigurationAuthenticatedEntity], Field(min_length=1)] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "multimedias": [SimpleMultimediaAuthenticatedEntity.from_dict(_item) for _item in obj["multimedias"]] if obj.get("multimedias") is not None else None,
            "contact": ContactAuthenticatedEntity.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            ...
            "recognitionList": [TravelInventoryRecognitionAuthenticatedEntity.from_dict(_item) for _item in obj["recognitionList"]] if obj.get("recognitionList") is not None else None,
            ...
            "bedroomConfigurationList": [BedroomConfigurationAuthenticatedEntity.from_dict(_item) for _item in obj["bedroomConfigurationList"]] if obj.get("bedroomConfigurationList") is not None else None,
            "size": obj.get("size"),
