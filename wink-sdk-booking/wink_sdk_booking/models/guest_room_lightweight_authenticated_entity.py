...
class GuestRoomLightweightAuthenticatedEntity(BaseModel):
    ...
    descriptions: List[SimpleDescriptionAuthenticatedEntity] = Field(description="Localized descriptions describing blocking.")
    multimedias: List[SimpleMultimediaAuthenticatedEntity] = Field(description="List of images / videos of blocking.")
    contact: ContactAuthenticatedEntity
    address: SimpleAddressAuthenticatedEntity
    ...
    bedroom_configuration_list: List[BedroomConfigurationAuthenticatedEntity] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
