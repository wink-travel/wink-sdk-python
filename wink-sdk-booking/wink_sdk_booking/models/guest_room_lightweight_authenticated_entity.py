...
class GuestRoomLightweightAuthenticatedEntity(BaseModel):
    ...
    descriptions: Annotated[List[SimpleDescriptionAuthenticatedEntity], Field(min_length=1)]
    multimedias: Annotated[List[SimpleMultimediaAuthenticatedEntity], Field(min_length=1)]
    ...
    socials: Optional[List[SocialAuthenticatedEntity]] = None
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    recognition_list: Optional[List[TravelInventoryRecognitionAuthenticatedEntity]] = Field(default=None, alias="recognitionList")
    ...
    bedroom_configuration_list: Annotated[List[BedroomConfigurationAuthenticatedEntity], Field(min_length=1)] = Field(alias="bedroomConfigurationList")
