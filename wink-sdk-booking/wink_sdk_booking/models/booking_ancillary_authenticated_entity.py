...
class BookingAncillaryAuthenticatedEntity(BaseModel):
    """
    ...
    price: LocalizedPriceAuthenticatedEntity = Field(description="Pricing information for this ancillary.")
    ...
    contact: ContactAuthenticatedEntity = Field(description="Travel blocking contact (if applicable)")
    address: SimpleAddressAuthenticatedEntity = Field(description="Travel blocking address (if applicable)")
