...
class EngineConfigurationBookingReportBooker(BaseModel):
    """
    ...
    theme_colors: Optional[EngineConfigurationThemeColorsBooker] = Field(default=None, alias="themeColors")
    ...
    city: Optional[GeoNameBooker] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EngineConfigurationBookingReportBooker from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EngineConfigurationBookingReportBooker from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "themeColors": EngineConfigurationThemeColorsBooker.from_dict(obj["themeColors"]) if obj.get("themeColors") is not None else None,
            ...
            "city": GeoNameBooker.from_dict(obj["city"]) if obj.get("city") is not None else None,
