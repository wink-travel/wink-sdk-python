...
class ReviewViewAuthenticatedEntity(BaseModel):
    """
    ...
    review: ReviewAuthenticatedEntity
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "review"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "review": ReviewAuthenticatedEntity.from_dict(obj["review"]) if obj.get("review") is not None else None
        })
        return _obj
