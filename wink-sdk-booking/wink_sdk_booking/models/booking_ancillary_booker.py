...
class BookingAncillaryBooker(BaseModel):
    ...
    price: LocalizedPriceBooker = Field(description="Pricing information for this ancillary.")
    ...
    contact: ContactBooker = Field(description="Travel blocking contact (if applicable)")
    address: SimpleAddressBooker = Field(description="Travel blocking address (if applicable)")
