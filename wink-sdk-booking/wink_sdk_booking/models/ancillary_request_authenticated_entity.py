...
class AncillaryRequestAuthenticatedEntity(BaseModel):
    """
    ...
    channel_inventory_identifier: UUID = Field(description="Channel inventory identifier", alias="channelInventoryIdentifier")
    transactional_travel_inventory_identifier: UUID = Field(description="Travel blocking identifier", alias="transactionalTravelInventoryIdentifier")
    ...
    quantity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Quantity of the ancillary requested.")
    identifier: Optional[UUID] = Field(default=None, description="Ancillary identifier")
    type: StrictStr = Field(description="Inventory type")
    __properties: ClassVar[List[str]] = ["typeIdentifier", "channelInventoryIdentifier", "transactionalTravelInventoryIdentifier", "startDate", "endDate", "quantity", "identifier", "type"]
