...
class AncillaryRequestAuthenticatedEntity(BaseModel):
    ...
    channel_inventory_identifier: StrictStr = Field(description="Channel inventory identifier", alias="channelInventoryIdentifier")
    ...
    identifier: Optional[StrictStr] = Field(default=None, description="Ancillary identifier")
