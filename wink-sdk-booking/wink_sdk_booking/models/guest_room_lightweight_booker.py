...
class GuestRoomLightweightBooker(BaseModel):
    """
    ...
    location: GeoJsonPointBooker = Field(description="Geo-location point where blocking takes place. Defaults to location of property.")
    descriptions: Annotated[List[SimpleDescriptionBooker], Field(min_length=1)]
    multimedias: Annotated[List[SimpleMultimediaBooker], Field(min_length=1)]
    contact: ContactBooker = Field(description="Associate a contact person for this blocking (if applicable).")
    address: SimpleAddressBooker = Field(description="Defaults to property address.")
    ...
    socials: Optional[List[SocialBooker]] = None
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    recognition_list: Optional[List[TravelInventoryRecognitionBooker]] = Field(default=None, alias="recognitionList")
    ...
    bedroom_configuration_list: Annotated[List[BedroomConfigurationBooker], Field(min_length=1)] = Field(alias="bedroomConfigurationList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GuestRoomLightweightBooker from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GuestRoomLightweightBooker from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "multimedias": [SimpleMultimediaBooker.from_dict(_item) for _item in obj["multimedias"]] if obj.get("multimedias") is not None else None,
            ...
            "recognitionList": [TravelInventoryRecognitionBooker.from_dict(_item) for _item in obj["recognitionList"]] if obj.get("recognitionList") is not None else None,
            ...
            "bedroomConfigurationList": [BedroomConfigurationBooker.from_dict(_item) for _item in obj["bedroomConfigurationList"]] if obj.get("bedroomConfigurationList") is not None else None,
            "size": obj.get("size"),
