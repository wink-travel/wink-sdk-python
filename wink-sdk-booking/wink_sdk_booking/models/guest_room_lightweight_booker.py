...
class GuestRoomLightweightBooker(BaseModel):
    ...
    location: GeoJsonPointBooker
    descriptions: List[SimpleDescriptionBooker] = Field(description="Localized descriptions describing blocking.")
    multimedias: List[SimpleMultimediaBooker] = Field(description="List of images / videos of blocking.")
    contact: ContactBooker
    address: SimpleAddressBooker
    ...
    socials: Optional[List[SocialBooker]] = Field(default=None, description="Social network accounts for blocking (if applicable).")
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    recognition_list: Optional[List[TravelInventoryRecognitionBooker]] = Field(default=None, description="Inventory-level recognition.", alias="recognitionList")
    ...
    bedroom_configuration_list: List[BedroomConfigurationBooker] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
