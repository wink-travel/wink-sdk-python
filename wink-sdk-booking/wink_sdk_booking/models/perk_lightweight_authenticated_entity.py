...
class PerkLightweightAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="Enum identifier identifier for this perk. Makes the persistent version backwards compatible.")
    ...
    descriptions: List[SimpleDescriptionAuthenticatedEntity] = Field(description="Localized description for this perk")
