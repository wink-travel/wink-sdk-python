...
class RealtimeShoppingCartAuthenticatedEntity(BaseModel):
    """
    RealtimeShoppingCartAuthenticatedEntity
    """ # noqa: E501
    id: StrictStr = Field(description="Shopping cart ID")
    item_list: Optional[List[RealtimeShoppingCartItemAuthenticatedEntity]] = Field(default=None, description="List of priced shopping cart items. Each entry is a separately booked room.", alias="itemList")
    ...
    __properties: ClassVar[List[str]] = ["id", "itemList", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "itemList": [RealtimeShoppingCartItemAuthenticatedEntity.from_dict(_item) for _item in obj["itemList"]] if obj.get("itemList") is not None else None,
