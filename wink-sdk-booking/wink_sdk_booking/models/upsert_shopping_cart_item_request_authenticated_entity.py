...
class UpsertShoppingCartItemRequestAuthenticatedEntity(BaseModel):
    ...
    currency: Annotated[str, Field(min_length=1, strict=True)] = Field(description="User's currency preference")
    lifestyle: Optional[StrictStr] = Field(default=None, description="Control which lifestyle the user used.")
    engine_configuration_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Affiliate customization", alias="engineConfigurationIdentifier")
