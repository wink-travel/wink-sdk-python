...
class CheckoutResponseAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    list: Annotated[List[PayableContractResponseAuthenticatedEntity], Field(min_length=1)] = Field(description="TripPay's ID to be used in conjunction with TripPay's reactive widget")
