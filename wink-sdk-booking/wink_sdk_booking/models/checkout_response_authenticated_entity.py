...
class CheckoutResponseAuthenticatedEntity(BaseModel):
    """
    CheckoutResponseAuthenticatedEntity
    """ # noqa: E501
    list: Annotated[List[PayableContractResponseAuthenticatedEntity], Field(min_length=1)] = Field(description="TripPay's ID to be used in conjunction with TripPay's payment widget")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [PayableContractResponseAuthenticatedEntity.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
