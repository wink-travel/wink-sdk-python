...
class StayRateBooker(BaseModel):
    ...
    source_to_user_currency_quote: Optional[QuoteBooker] = Field(default=None, alias="sourceToUserCurrencyQuote")
    source_to_internal_currency_quote: Optional[QuoteBooker] = Field(default=None, alias="sourceToInternalCurrencyQuote")
    offer_details: Optional[List[LocalizedDescriptionBooker]] = Field(default=None, description="Localized text of the discount", alias="offerDetails")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sourceToUserCurrencyQuote": QuoteBooker.from_dict(obj["sourceToUserCurrencyQuote"]) if obj.get("sourceToUserCurrencyQuote") is not None else None,
            "sourceToInternalCurrencyQuote": QuoteBooker.from_dict(obj["sourceToInternalCurrencyQuote"]) if obj.get("sourceToInternalCurrencyQuote") is not None else None,
