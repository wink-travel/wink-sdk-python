...
class RatePlanLevelFeeBooker(BaseModel):
    """
    RatePlanLevelFeeBooker
    """ # noqa: E501
    descriptions: Annotated[List[LocalizedDescriptionBooker], Field(min_length=1)] = Field(description="List of localized descriptions for this fee.")
