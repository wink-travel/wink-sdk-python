...
class RoomStayAuthenticatedEntity(BaseModel):
    """
    RoomStayAuthenticatedEntity
    """ # noqa: E501
    policy: PropertyPolicyAuthenticatedEntity = Field(description="Property policy information.")
    room: GuestRoomLightweightAuthenticatedEntity = Field(description="Guest room details.")
    rooms: StrictInt = Field(description="Number of rooms. Always 1 since we switched to creating one booking per room.")
    bedroom_configuration: BedroomConfigurationAuthenticatedEntity = Field(description="Desired bedroom layout", alias="bedroomConfiguration")
    ...
    price: StayRateAuthenticatedEntity = Field(description="Price details")
    ...
    rate_plan: RoomConfigurationPriceRatePlanAuthenticatedEntity = Field(description="Rate plan used for this stay", alias="ratePlan")
    perk_types: Optional[List[PerkLightweightAuthenticatedEntity]] = Field(default=None, description="List of perks that came with the master rate", alias="perkTypes")
    extra_charges: ExtraChargesAuthenticatedEntity = Field(description="Rate plan-level extra charges", alias="extraCharges")
    active_cancellation_policy: CancellationPolicyLightweightAuthenticatedEntity = Field(description="Based on the itinerary, the cancellation policy could be taken directly from the rate plan or it could be a policy exception also listed on the rate plan", alias="activeCancellationPolicy")
    ...
    __properties: ClassVar[List[str]] = ["policy", "room", "rooms", "bedroomConfiguration", "adults", "children", "startDate", "endDate", "price", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "extraCharges", "activeCancellationPolicy", "roomNights", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "rateSource", "cancellable", "guests", "cancellableByHotel", "cancellableWithPotentialCharge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "room": GuestRoomLightweightAuthenticatedEntity.from_dict(obj["room"]) if obj.get("room") is not None else None,
            "rooms": obj.get("rooms") if obj.get("rooms") is not None else 1,
            "bedroomConfiguration": BedroomConfigurationAuthenticatedEntity.from_dict(obj["bedroomConfiguration"]) if obj.get("bedroomConfiguration") is not None else None,
            ...
            "price": StayRateAuthenticatedEntity.from_dict(obj["price"]) if obj.get("price") is not None else None,
            "roomRateIdentifier": obj.get("roomRateIdentifier"),
            "roomRateInternalName": obj.get("roomRateInternalName"),
            "ratePlan": RoomConfigurationPriceRatePlanAuthenticatedEntity.from_dict(obj["ratePlan"]) if obj.get("ratePlan") is not None else None,
            "perkTypes": [PerkLightweightAuthenticatedEntity.from_dict(_item) for _item in obj["perkTypes"]] if obj.get("perkTypes") is not None else None,
            "extraCharges": ExtraChargesAuthenticatedEntity.from_dict(obj["extraCharges"]) if obj.get("extraCharges") is not None else None,
            "activeCancellationPolicy": CancellationPolicyLightweightAuthenticatedEntity.from_dict(obj["activeCancellationPolicy"]) if obj.get("activeCancellationPolicy") is not None else None,
