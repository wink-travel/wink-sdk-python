...
class RoomStayAuthenticatedEntity(BaseModel):
    ...
    The priced stay.
    """ # noqa: E501
    policy: PropertyPolicyAuthenticatedEntity
    room: GuestRoomLightweightAuthenticatedEntity
    rooms: StrictInt = Field(description="Number of rooms. Always 1 since we switched to creating one booking per room.")
    bedroom_configuration: BedroomConfigurationAuthenticatedEntity = Field(alias="bedroomConfiguration")
    ...
    price: StayRateAuthenticatedEntity
    ...
    rate_plan: RoomConfigurationPriceRatePlanAuthenticatedEntity = Field(alias="ratePlan")
    ...
    extra_charges: ExtraChargesAuthenticatedEntity = Field(alias="extraCharges")
    active_cancellation_policy: CancellationPolicyAuthenticatedEntity = Field(alias="activeCancellationPolicy")
    ...
    __properties: ClassVar[List[str]] = ["policy", "room", "rooms", "bedroomConfiguration", "adults", "children", "startDate", "endDate", "price", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "extraCharges", "activeCancellationPolicy", "cancellable", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "roomNights", "rateSource", "guests", "cancellableByHotel", "cancellableWithPotentialCharge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeCancellationPolicy": CancellationPolicyAuthenticatedEntity.from_dict(obj["activeCancellationPolicy"]) if obj.get("activeCancellationPolicy") is not None else None,
