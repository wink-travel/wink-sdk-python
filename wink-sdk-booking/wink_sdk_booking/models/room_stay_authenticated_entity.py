...
class RoomStayAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policy", "room", "rooms", "bedroomConfiguration", "adults", "children", "startDate", "endDate", "price", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "extraCharges", "activeCancellationPolicy", "roomNights", "rateSource", "cancellable", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "guests", "cancellableByHotel", "cancellableWithPotentialCharge"]
