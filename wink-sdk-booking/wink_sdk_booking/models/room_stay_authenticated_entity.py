...
class RoomStayAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policy", "room", "rooms", "bedroomConfiguration", "adults", "children", "startDate", "endDate", "price", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "extraCharges", "activeCancellationPolicy", "cancellable", "cancellableWithPotentialCharge", "cancellableByHotel", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "roomNights", "rateSource", "guests"]
