...
class RoomStayAuthenticatedEntity(BaseModel):
    ...
    room_rate_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Master rate identifier", alias="roomRateIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["policy", "room", "rooms", "bedroomConfiguration", "adults", "children", "startDate", "endDate", "price", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "extraCharges", "activeCancellationPolicy", "guests", "rateSource", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "roomNights", "cancellableByHotel", "cancellableWithPotentialCharge", "cancellable"]
