...
class RoomStayAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policy", "room", "rooms", "bedroomConfiguration", "adults", "children", "startDate", "endDate", "price", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "extraCharges", "activeCancellationPolicy", "cancellable", "roomNights", "cancellableByHotel", "cancellableWithPotentialCharge", "rateSource", "internalTotal", "guests", "sourceTotal", "userSpecifiedCurrencyTotal"]
