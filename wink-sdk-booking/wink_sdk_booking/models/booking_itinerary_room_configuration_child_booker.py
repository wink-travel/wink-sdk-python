...
class BookingItineraryRoomConfigurationChildBooker(BaseModel):
    """
    Child configuration
    """ # noqa: E501
    quantity: StrictInt = Field(description="Number of children")
    age: StrictInt = Field(description="Age of children")
