...
class CheckoutRequestAuthenticatedEntity(BaseModel):
    """
    CheckoutRequestAuthenticatedEntity
    """ # noqa: E501
    shopping_cart_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Shopping cart to send to TripPay", alias="shoppingCartIdentifier")
    customization_identifier: Optional[StrictStr] = Field(default=None, description="Wink affiliate customization", alias="customizationIdentifier")
    redirect_url: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Wink affiliate customization", alias="redirectUrl")
    __properties: ClassVar[List[str]] = ["shoppingCartIdentifier", "customizationIdentifier", "redirectUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shoppingCartIdentifier": obj.get("shoppingCartIdentifier"),
            "customizationIdentifier": obj.get("customizationIdentifier"),
            "redirectUrl": obj.get("redirectUrl") if obj.get("redirectUrl") is not None else 'https://ota.wink.travel/thank-you'
        })
        return _obj
