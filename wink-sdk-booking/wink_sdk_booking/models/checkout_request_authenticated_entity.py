...
class CheckoutRequestAuthenticatedEntity(BaseModel):
    ...
    engine_configuration_identifier: Optional[StrictStr] = Field(default=None, description="Wink affiliate customization", alias="engineConfigurationIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["shoppingCartIdentifier", "engineConfigurationIdentifier", "redirectUrl"]
