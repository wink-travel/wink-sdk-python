...
class CheckoutRequestAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    shopping_cart_identifier: StrictStr = Field(description="Shopping cart to send to TripPay", alias="shoppingCartIdentifier")
    ...
    redirect_url: StrictStr = Field(description="Wink affiliate customization", alias="redirectUrl")
