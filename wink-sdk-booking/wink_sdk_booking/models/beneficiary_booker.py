...
class BeneficiaryBooker(BaseModel):
    """
    ...
    amount_due: Optional[BeneficiaryChargeBooker] = Field(default=None, description="The original slice requested", alias="amountDue")
    ...
    pending_refunds: Optional[List[PendingRefundBooker]] = Field(default=None, alias="pendingRefunds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BeneficiaryBooker from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BeneficiaryBooker from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "amountDue": BeneficiaryChargeBooker.from_dict(obj["amountDue"]) if obj.get("amountDue") is not None else None,
            ...
            "pendingRefunds": [PendingRefundBooker.from_dict(_item) for _item in obj["pendingRefunds"]] if obj.get("pendingRefunds") is not None else None,
