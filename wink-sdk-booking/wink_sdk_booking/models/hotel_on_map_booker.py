...
class HotelOnMapBooker(BaseModel):
    """
    ...
    location: Optional[GeoJsonPointBooker] = None
    short_descriptions: Optional[List[LocalizedDescriptionBooker]] = Field(default=None, description="A localized list of short property descriptions", alias="shortDescriptions")
    long_descriptions: Optional[List[LocalizedDescriptionBooker]] = Field(default=None, description="A localized list of longer property descriptions", alias="longDescriptions")
    ...
    reservations: Optional[ContactBooker] = None
    ...
    policy: Optional[PropertyPolicyBooker] = None
    ...
    address: Optional[AddressBooker] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shortDescriptions": [LocalizedDescriptionBooker.from_dict(_item) for _item in obj["shortDescriptions"]] if obj.get("shortDescriptions") is not None else None,
            "longDescriptions": [LocalizedDescriptionBooker.from_dict(_item) for _item in obj["longDescriptions"]] if obj.get("longDescriptions") is not None else None,
