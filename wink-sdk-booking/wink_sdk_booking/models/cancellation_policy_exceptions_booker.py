...
class CancellationPolicyExceptionsBooker(BaseModel):
    """
    Allows a property to dynamically use another cancellation policy for a specific date range
    """ # noqa: E501
    list: List[CancellationPolicyExceptionBooker] = Field(description="List of cancellation policy exceptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [CancellationPolicyExceptionBooker.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
