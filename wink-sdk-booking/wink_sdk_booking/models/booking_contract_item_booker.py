...
class BookingContractItemBooker(BaseModel):
    """
    ...
    itinerary: SimpleDateTimeItineraryBooker
    ...
    beneficiary_list: Annotated[List[BeneficiaryBooker], Field(min_length=1, max_length=2147483647)] = Field(alias="beneficiaryList")
    payable: StrictStr = Field(description="When to charge for this item.")
    policy: Optional[SupplierContractItemPolicyBooker] = None
    ...
    daily_rate_list: Optional[List[DailyRateBooker]] = Field(default=None, alias="dailyRateList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": GuestUserBooker.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "nameInEnglish": obj.get("nameInEnglish"),
            "descriptionInEnglish": obj.get("descriptionInEnglish"),
            "itinerary": SimpleDateTimeItineraryBooker.from_dict(obj["itinerary"]) if obj.get("itinerary") is not None else None,
            "pricingType": obj.get("pricingType"),
            "type": obj.get("type"),
            "beneficiaryList": [BeneficiaryBooker.from_dict(_item) for _item in obj["beneficiaryList"]] if obj.get("beneficiaryList") is not None else None,
            "payable": obj.get("payable"),
            "policy": SupplierContractItemPolicyBooker.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
            "externalIdentifier": obj.get("externalIdentifier"),
            "tokensEarned": obj.get("tokensEarned"),
            "dailyRateList": [DailyRateBooker.from_dict(_item) for _item in obj["dailyRateList"]] if obj.get("dailyRateList") is not None else None,
