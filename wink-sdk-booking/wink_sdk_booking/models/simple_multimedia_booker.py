...
class SimpleMultimediaBooker(BaseModel):
    ...
    attribution: Optional[List[MediaAuthorAttributionBooker]] = Field(default=None, description="Whether image has attribution properties")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attribution": [MediaAuthorAttributionBooker.from_dict(_item) for _item in obj["attribution"]] if obj.get("attribution") is not None else None,
