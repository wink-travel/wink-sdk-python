...
class PayoutBooker(BaseModel):
    ...
    quote: Optional[QuoteLightweightBooker] = Field(default=None, description="FX quote for this transfer.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quote": QuoteLightweightBooker.from_dict(obj["quote"]) if obj.get("quote") is not None else None,
