...
class BookingItineraryRoomConfigurationBooker(BaseModel):
    """
    Room Configuration
    """ # noqa: E501
    adults: StrictInt = Field(description="Number of adults")
    children: Optional[List[BookingItineraryRoomConfigurationChildBooker]] = Field(default=None, description="Children configurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [BookingItineraryRoomConfigurationChildBooker.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj
