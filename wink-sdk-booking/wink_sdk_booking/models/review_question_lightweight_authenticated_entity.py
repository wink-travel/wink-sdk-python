...
class ReviewQuestionLightweightAuthenticatedEntity(BaseModel):
    """
    ...
    options: Optional[List[ReviewAnswerOptionAuthenticatedEntity]] = None
    __properties: ClassVar[List[str]] = ["identifier", "category", "sort", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort"),
            "options": [ReviewAnswerOptionAuthenticatedEntity.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
