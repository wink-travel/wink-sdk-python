...
class StayRateAuthenticatedEntity(BaseModel):
    ...
    source_to_user_currency_quote: Optional[QuoteAuthenticatedEntity] = Field(default=None, alias="sourceToUserCurrencyQuote")
    source_to_internal_currency_quote: Optional[QuoteAuthenticatedEntity] = Field(default=None, alias="sourceToInternalCurrencyQuote")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sourceToUserCurrencyQuote": QuoteAuthenticatedEntity.from_dict(obj["sourceToUserCurrencyQuote"]) if obj.get("sourceToUserCurrencyQuote") is not None else None,
            "sourceToInternalCurrencyQuote": QuoteAuthenticatedEntity.from_dict(obj["sourceToInternalCurrencyQuote"]) if obj.get("sourceToInternalCurrencyQuote") is not None else None,
