...
class LocalizedPriceBooker(BaseModel):
    """
    LocalizedPriceBooker
    """ # noqa: E501
    source_to_user_currency_quote: QuoteLightweightBooker = Field(description="Hotel to user currency exchange rate.", alias="sourceToUserCurrencyQuote")
    source_to_internal_currency_quote: QuoteLightweightBooker = Field(description="Hotel to wink currency exchange rate.", alias="sourceToInternalCurrencyQuote")
