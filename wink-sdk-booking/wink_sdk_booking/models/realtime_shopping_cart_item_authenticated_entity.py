...
class RealtimeShoppingCartItemAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="identifier for item in cart")
    ...
    stay: RoomStayAuthenticatedEntity
