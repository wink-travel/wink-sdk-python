...
class ExtraChargesAuthenticatedEntity(BaseModel):
    """
    ExtraChargesAuthenticatedEntity
    """ # noqa: E501
    items: Optional[List[ExtraChargeAuthenticatedEntity]] = Field(default=None, description="List of extra charges that applies to the rate plan.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ExtraChargeAuthenticatedEntity.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
