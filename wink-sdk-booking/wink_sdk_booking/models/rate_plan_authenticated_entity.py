...
class RatePlanAuthenticatedEntity(BaseModel):
    """
    ...
    available_days_of_week: Optional[DowPatternGroupAuthenticatedEntity] = Field(default=None, alias="availableDaysOfWeek")
    arrival_days_of_week: Optional[DowPatternGroupAuthenticatedEntity] = Field(default=None, alias="arrivalDaysOfWeek")
    departure_days_of_week: Optional[DowPatternGroupAuthenticatedEntity] = Field(default=None, alias="departureDaysOfWeek")
    required_days_of_week: Optional[DowPatternGroupAuthenticatedEntity] = Field(default=None, alias="requiredDaysOfWeek")
    ...
    cancellation_policy: Optional[CancellationPolicyAuthenticatedEntity] = Field(default=None, alias="cancellationPolicy")
    cancellation_policy_exceptions: Optional[CancellationPolicyExceptionsAuthenticatedEntity] = Field(default=None, alias="cancellationPolicyExceptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "availableDaysOfWeek": DowPatternGroupAuthenticatedEntity.from_dict(obj["availableDaysOfWeek"]) if obj.get("availableDaysOfWeek") is not None else None,
            "arrivalDaysOfWeek": DowPatternGroupAuthenticatedEntity.from_dict(obj["arrivalDaysOfWeek"]) if obj.get("arrivalDaysOfWeek") is not None else None,
            "departureDaysOfWeek": DowPatternGroupAuthenticatedEntity.from_dict(obj["departureDaysOfWeek"]) if obj.get("departureDaysOfWeek") is not None else None,
            "requiredDaysOfWeek": DowPatternGroupAuthenticatedEntity.from_dict(obj["requiredDaysOfWeek"]) if obj.get("requiredDaysOfWeek") is not None else None,
            ...
            "cancellationPolicy": CancellationPolicyAuthenticatedEntity.from_dict(obj["cancellationPolicy"]) if obj.get("cancellationPolicy") is not None else None,
            "cancellationPolicyExceptions": CancellationPolicyExceptionsAuthenticatedEntity.from_dict(obj["cancellationPolicyExceptions"]) if obj.get("cancellationPolicyExceptions") is not None else None
        })
        return _obj
