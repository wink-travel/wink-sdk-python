...
class LocalizedPriceAuthenticatedEntity(BaseModel):
    """
    LocalizedPriceAuthenticatedEntity
    """ # noqa: E501
    source_to_user_currency_quote: QuoteLightweightAuthenticatedEntity = Field(description="Hotel to user currency exchange rate.", alias="sourceToUserCurrencyQuote")
    source_to_internal_currency_quote: QuoteLightweightAuthenticatedEntity = Field(description="Hotel to wink currency exchange rate.", alias="sourceToInternalCurrencyQuote")
