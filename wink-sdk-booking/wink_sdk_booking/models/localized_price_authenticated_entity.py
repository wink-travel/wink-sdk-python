...
class LocalizedPriceAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    source_to_user_currency_quote: QuoteAuthenticatedEntity = Field(alias="sourceToUserCurrencyQuote")
    source_to_internal_currency_quote: QuoteAuthenticatedEntity = Field(alias="sourceToInternalCurrencyQuote")
