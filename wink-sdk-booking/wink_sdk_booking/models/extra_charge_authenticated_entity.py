...
class ExtraChargeAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeAuthenticatedEntity] = Field(default=None, alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceAuthenticatedEntity] = Field(default=None, alias="unitPrice")
    price: Optional[LocalizedPriceAuthenticatedEntity] = None
