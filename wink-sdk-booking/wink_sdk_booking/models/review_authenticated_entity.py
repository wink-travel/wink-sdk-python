...
class ReviewAuthenticatedEntity(BaseModel):
    """
    ...
    booking_identifier: Optional[UUID] = Field(default=None, description="Booking identifier identifier booking this review is associated with.", alias="bookingIdentifier")
    hotel_identifier: Optional[UUID] = Field(default=None, description="Hotel identifier this booking is associated with.", alias="hotelIdentifier")
    user: Optional[ReviewUserAuthenticatedEntity] = Field(default=None, description="User details of creator of booking.")
    ...
    answers: Optional[List[ReviewAnswerAuthenticatedEntity]] = Field(default=None, description="List of user review answers.")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "bookingIdentifier", "hotelIdentifier", "user", "reviewDate", "averageScore", "answers", "messageFromGuest", "responseFromHotel", "imageIdentifier", "text", "approvedText", "approvedImage", "likes", "roomNumber", "roomRating", "responded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": ReviewUserAuthenticatedEntity.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "reviewDate": obj.get("reviewDate"),
            "averageScore": obj.get("averageScore"),
            "answers": [ReviewAnswerAuthenticatedEntity.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None,
