...
class GeoNameBooker(BaseModel):
    ...
    country: Optional[CountryBooker] = None
    sub_country: Optional[SubCountryBooker] = Field(default=None, alias="subCountry")
    sub_sub_country: Optional[SubSubCountryBooker] = Field(default=None, alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountryBooker.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountryBooker.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountryBooker.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
