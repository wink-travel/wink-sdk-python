...
class ReportingExtraChargeBooker(BaseModel):
    """
    ...
    net_amount_with_refund: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="netAmountWithRefund")
    currency: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "description", "grossAmount", "netAmount", "netAmountWithRefund", "currency"]
