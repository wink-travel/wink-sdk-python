...
class PerkLightweightBooker(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescriptionBooker], Field(min_length=1)] = Field(description="Localized description for this perk")
