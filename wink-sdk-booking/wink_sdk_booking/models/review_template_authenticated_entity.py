...
class ReviewTemplateAuthenticatedEntity(BaseModel):
    ...
    questions: Annotated[List[ReviewQuestionAuthenticatedEntity], Field(min_length=1, max_length=2147483647)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "questions": [ReviewQuestionAuthenticatedEntity.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None
        })
        return _obj
