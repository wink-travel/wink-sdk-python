...
class ReviewTemplateAuthenticatedEntity(BaseModel):
    """
    ReviewTemplateAuthenticatedEntity
    """ # noqa: E501
    booking_identifier: StrictStr = Field(description="Booking ID to review", alias="bookingIdentifier")
    hotel_identifier: StrictStr = Field(description="Hotel ID to review", alias="hotelIdentifier")
    hotel_name: StrictStr = Field(description="Hotel name to review", alias="hotelName")
    user_identifier: StrictStr = Field(description="User ID doing the reviewing", alias="userIdentifier")
    questions: Annotated[List[ReviewQuestionLightweightAuthenticatedEntity], Field(min_length=1, max_length=2147483647)]
    __properties: ClassVar[List[str]] = ["bookingIdentifier", "hotelIdentifier", "hotelName", "userIdentifier", "questions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hotelName": obj.get("hotelName"),
            "userIdentifier": obj.get("userIdentifier"),
            "questions": [ReviewQuestionLightweightAuthenticatedEntity.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None
        })
        return _obj
