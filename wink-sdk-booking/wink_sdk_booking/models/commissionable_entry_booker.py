...
class CommissionableEntryBooker(BaseModel):
    """
    ...
    type: StrictStr
    commission_percent: Union[StrictFloat, StrictInt] = Field(alias="commissionPercent")
    __properties: ClassVar[List[str]] = ["name", "identifier", "type", "commissionPercent"]
