...
class RatePlanLevelFeeAuthenticatedEntity(BaseModel):
    """
    RatePlanLevelFeeAuthenticatedEntity
    """ # noqa: E501
    descriptions: Annotated[List[LocalizedDescriptionAuthenticatedEntity], Field(min_length=1)] = Field(description="List of localized descriptions for this fee.")
