...
class CancellationPolicyExceptionBooker(BaseModel):
    """
    ...
    cancellation_policy: CancellationPolicyLightweightBooker = Field(description="Cancellation policy", alias="cancellationPolicy")
