...
class ReportingAncillaryBooker(BaseModel):
    """
    ReportingAncillaryBooker
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Full name of ancillary in English.")
    type: Optional[StrictStr] = Field(default=None, description="The type")
    gross_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The gross amount.", alias="grossAmount")
    ...
    net_amount_with_refund: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The gross amount minus fees and commissions.", alias="netAmountWithRefund")
    currency: Optional[StrictStr] = Field(default=None, description="The currency for these amounts.")
    __properties: ClassVar[List[str]] = ["name", "type", "grossAmount", "netAmount", "netAmountWithRefund", "currency"]
