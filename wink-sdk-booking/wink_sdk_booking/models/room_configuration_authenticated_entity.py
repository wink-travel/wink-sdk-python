...
class RoomConfigurationAuthenticatedEntity(BaseModel):
    """
    Room Configuration
    """ # noqa: E501
    adults: Annotated[int, Field(strict=True, ge=1)] = Field(description="Number of adults")
    children: Optional[List[ChildAuthenticatedEntity]] = Field(default=None, description="Children configurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [ChildAuthenticatedEntity.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj
