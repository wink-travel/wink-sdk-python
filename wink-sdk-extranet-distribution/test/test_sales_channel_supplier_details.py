...
class TestSalesChannelSupplierDetails(unittest.TestCase):
    """SalesChannelSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelSupplierDetails:
        """Test SalesChannelSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelSupplierDetails`
        """
        model = SalesChannelSupplierDetails()
        if include_optional:
            return SalesChannelSupplierDetails(
                identifier = '',
                supplier_identifier = '',
    ...
    def testSalesChannelSupplierDetails(self):
        """Test SalesChannelSupplierDetails"""
