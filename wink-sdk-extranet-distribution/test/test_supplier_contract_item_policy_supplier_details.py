...
class TestSupplierContractItemPolicySupplierDetails(unittest.TestCase):
    """SupplierContractItemPolicySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierContractItemPolicySupplierDetails:
        """Test SupplierContractItemPolicySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierContractItemPolicySupplierDetails`
        """
        model = SupplierContractItemPolicySupplierDetails()
        if include_optional:
            return SupplierContractItemPolicySupplierDetails(
                refundable = True,
    ...
    def testSupplierContractItemPolicySupplierDetails(self):
        """Test SupplierContractItemPolicySupplierDetails"""
