...
class TestRoomRangeRateQualifierSupplierDetails(unittest.TestCase):
    """RoomRangeRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomRangeRateQualifierSupplierDetails:
        """Test RoomRangeRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomRangeRateQualifierSupplierDetails`
        """
        model = RoomRangeRateQualifierSupplierDetails()
        if include_optional:
            return RoomRangeRateQualifierSupplierDetails(
                min_rooms = 1,
                max_rooms = 56
            )
        else:
    ...
    def testRoomRangeRateQualifierSupplierDetails(self):
        """Test RoomRangeRateQualifierSupplierDetails"""
