...
class TestSimpleMultimediaSupplier(unittest.TestCase):
    """SimpleMultimediaSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimediaSupplier:
        """Test SimpleMultimediaSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimediaSupplier`
        """
        model = SimpleMultimediaSupplier()
        if include_optional:
            return SimpleMultimediaSupplier(
                ...
                category = '1',
                descriptions = [
                    wink_sdk_extranet_distribution.models.simple_description_supplier.SimpleDescription_Supplier(
                ...
                attribution = [
                    wink_sdk_extranet_distribution.models.image_attribution_supplier.ImageAttribution_Supplier(
    ...
    def testSimpleMultimediaSupplier(self):
        """Test SimpleMultimediaSupplier"""
