...
class TestRatePlanLightweightSupplierDetails(unittest.TestCase):
    """RatePlanLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanLightweightSupplierDetails:
        """Test RatePlanLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanLightweightSupplierDetails`
        """
        model = RatePlanLightweightSupplierDetails()
        if include_optional:
            return RatePlanLightweightSupplierDetails(
                identifier = '0',
                ...
                arrival_days_of_week = wink_sdk_extranet_distribution.models.dow_pattern_group_supplier_details.DowPatternGroup_SupplierDetails(
                    ...
                    sun = True, 
                    disabled = True, ),
                departure_days_of_week = wink_sdk_extranet_distribution.models.dow_pattern_group_supplier_details.DowPatternGroup_SupplierDetails(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                required_days_of_week = wink_sdk_extranet_distribution.models.dow_pattern_group_supplier_details.DowPatternGroup_SupplierDetails(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                early_check_in_charge = wink_sdk_extranet_distribution.models.variable_charge_supplier.VariableCharge_Supplier(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '0', ), ),
                late_check_out_charge = wink_sdk_extranet_distribution.models.variable_charge_supplier.VariableCharge_Supplier(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '0', ), ),
                cancellation_policy = wink_sdk_extranet_distribution.models.cancellation_policy_lightweight_supplier_details.CancellationPolicyLightweight_SupplierDetails(
                    identifier = '', 
                    hotel_identifier = '', 
                    refundable = False, 
                ...
                single_occupancy_rate_modifier = wink_sdk_extranet_distribution.models.variable_charge_supplier.VariableCharge_Supplier(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '0', ), ),
                extra_pax_rate_modifier = wink_sdk_extranet_distribution.models.variable_charge_supplier.VariableCharge_Supplier(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '0', ), ),
                extra_child_rate_modifier = wink_sdk_extranet_distribution.models.variable_charge_supplier.VariableCharge_Supplier(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
    ...
    def testRatePlanLightweightSupplierDetails(self):
        """Test RatePlanLightweightSupplierDetails"""
