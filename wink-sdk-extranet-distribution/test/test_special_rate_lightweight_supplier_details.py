...
class TestSpecialRateLightweightSupplierDetails(unittest.TestCase):
    """SpecialRateLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialRateLightweightSupplierDetails:
        """Test SpecialRateLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialRateLightweightSupplierDetails`
        """
        model = SpecialRateLightweightSupplierDetails()
        if include_optional:
            return SpecialRateLightweightSupplierDetails(
    ...
    def testSpecialRateLightweightSupplierDetails(self):
        """Test SpecialRateLightweightSupplierDetails"""
