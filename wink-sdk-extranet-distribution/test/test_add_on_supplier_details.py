...
class TestAddOnSupplierDetails(unittest.TestCase):
    """AddOnSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOnSupplierDetails:
        """Test AddOnSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOnSupplierDetails`
        """
        model = AddOnSupplierDetails()
        if include_optional:
            return AddOnSupplierDetails(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testAddOnSupplierDetails(self):
        """Test AddOnSupplierDetails"""
