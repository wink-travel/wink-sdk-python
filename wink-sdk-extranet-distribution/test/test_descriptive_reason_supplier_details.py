...
class TestDescriptiveReasonSupplierDetails(unittest.TestCase):
    """DescriptiveReasonSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescriptiveReasonSupplierDetails:
        """Test DescriptiveReasonSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescriptiveReasonSupplierDetails`
        """
        model = DescriptiveReasonSupplierDetails()
        if include_optional:
            return DescriptiveReasonSupplierDetails(
                identifier = '',
                name = '',
                map = {
                    'key' : ''
    ...
    def testDescriptiveReasonSupplierDetails(self):
        """Test DescriptiveReasonSupplierDetails"""
