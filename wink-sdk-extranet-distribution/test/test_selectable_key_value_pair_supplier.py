...
class TestSelectableKeyValuePairSupplier(unittest.TestCase):
    """SelectableKeyValuePairSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelectableKeyValuePairSupplier:
        """Test SelectableKeyValuePairSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelectableKeyValuePairSupplier`
        """
        model = SelectableKeyValuePairSupplier()
        if include_optional:
            return SelectableKeyValuePairSupplier(
                value = 'id-1',
    ...
    def testSelectableKeyValuePairSupplier(self):
        """Test SelectableKeyValuePairSupplier"""
