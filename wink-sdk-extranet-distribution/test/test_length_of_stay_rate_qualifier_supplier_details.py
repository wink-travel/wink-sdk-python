...
class TestLengthOfStayRateQualifierSupplierDetails(unittest.TestCase):
    """LengthOfStayRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LengthOfStayRateQualifierSupplierDetails:
        """Test LengthOfStayRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LengthOfStayRateQualifierSupplierDetails`
        """
        model = LengthOfStayRateQualifierSupplierDetails()
        if include_optional:
            return LengthOfStayRateQualifierSupplierDetails(
                min_los = 0,
                max_los = 0
            )
        else:
    ...
    def testLengthOfStayRateQualifierSupplierDetails(self):
        """Test LengthOfStayRateQualifierSupplierDetails"""
