...
class TestRoomConfigurationSupplierDetails(unittest.TestCase):
    """RoomConfigurationSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationSupplierDetails:
        """Test RoomConfigurationSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationSupplierDetails`
        """
        model = RoomConfigurationSupplierDetails()
        if include_optional:
            return RoomConfigurationSupplierDetails(
                adults = 2,
                children = [
    ...
    def testRoomConfigurationSupplierDetails(self):
        """Test RoomConfigurationSupplierDetails"""
