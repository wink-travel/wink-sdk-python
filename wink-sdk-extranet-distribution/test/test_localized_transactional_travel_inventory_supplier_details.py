...
class TestLocalizedTransactionalTravelInventorySupplierDetails(unittest.TestCase):
    """LocalizedTransactionalTravelInventorySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedTransactionalTravelInventorySupplierDetails:
        """Test LocalizedTransactionalTravelInventorySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedTransactionalTravelInventorySupplierDetails`
        """
        model = LocalizedTransactionalTravelInventorySupplierDetails()
        if include_optional:
            return LocalizedTransactionalTravelInventorySupplierDetails(
                identifier = '',
                name = '1 hour session',
                descriptions = [
    ...
    def testLocalizedTransactionalTravelInventorySupplierDetails(self):
        """Test LocalizedTransactionalTravelInventorySupplierDetails"""
