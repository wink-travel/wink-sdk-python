...
class TestBookingItinerarySupplierDetails(unittest.TestCase):
    """BookingItinerarySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingItinerarySupplierDetails:
        """Test BookingItinerarySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingItinerarySupplierDetails`
        """
        model = BookingItinerarySupplierDetails()
        if include_optional:
            return BookingItinerarySupplierDetails(
    ...
    def testBookingItinerarySupplierDetails(self):
        """Test BookingItinerarySupplierDetails"""
