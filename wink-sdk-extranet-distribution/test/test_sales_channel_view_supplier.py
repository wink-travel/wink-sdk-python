...
class TestSalesChannelViewSupplier(unittest.TestCase):
    """SalesChannelViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelViewSupplier:
        """Test SalesChannelViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelViewSupplier`
        """
        model = SalesChannelViewSupplier()
        if include_optional:
            return SalesChannelViewSupplier(
                id = 'doc-1',
    ...
    def testSalesChannelViewSupplier(self):
        """Test SalesChannelViewSupplier"""
