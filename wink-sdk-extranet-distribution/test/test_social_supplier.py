...
class TestSocialSupplier(unittest.TestCase):
    """SocialSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialSupplier:
        """Test SocialSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SocialSupplier`
        """
        model = SocialSupplier()
        if include_optional:
            return SocialSupplier(
                type = 'FACEBOOK',
                location = '',
                enabled = True
            )
