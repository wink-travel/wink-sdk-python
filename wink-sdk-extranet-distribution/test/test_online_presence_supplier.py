...
class TestOnlinePresenceSupplier(unittest.TestCase):
    """OnlinePresenceSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnlinePresenceSupplier:
        """Test OnlinePresenceSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnlinePresenceSupplier`
        """
        model = OnlinePresenceSupplier()
        if include_optional:
            return OnlinePresenceSupplier(
                type = 'WINK',
                identifier = '',
                audiences = [
                    'EVERYONE'
    ...
    def testOnlinePresenceSupplier(self):
        """Test OnlinePresenceSupplier"""
