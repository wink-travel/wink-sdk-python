...
class TestCustomizationLightweightSupplierDetails(unittest.TestCase):
    """CustomizationLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationLightweightSupplierDetails:
        """Test CustomizationLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationLightweightSupplierDetails`
        """
        model = CustomizationLightweightSupplierDetails()
        if include_optional:
            return CustomizationLightweightSupplierDetails(
                ...
                logos = [
                    wink_sdk_extranet_distribution.models.simple_multimedia_supplier_details.SimpleMultimedia_SupplierDetails(
                        ...
                        attribution = [
                            wink_sdk_extranet_distribution.models.image_attribution_supplier_details.ImageAttribution_SupplierDetails(
                ...
                self_hosted = True,
                theme_colors = wink_sdk_extranet_distribution.models.customization_theme_colors_supplier_details.CustomizationThemeColors_SupplierDetails(
                    primary = '#dc3545', 
                    secondary = '#6c757d', 
                    success = '#28a745', 
                    danger = '#dc3545', 
                ...
                end_date = '2021-12-31',
                room_configurations = [
                    wink_sdk_extranet_distribution.models.room_configuration_supplier_details.RoomConfiguration_SupplierDetails(
                        adults = 2, 
                        children = [
                ...
                city = wink_sdk_extranet_distribution.models.geo_name_lightweight_supplier_details.GeoNameLightweight_SupplierDetails(
                    geo_name_id = '5128581', 
                    type = 'CITY', 
                    name = 'New York City', 
                    ...
                    country = wink_sdk_extranet_distribution.models.country_lightweight_supplier_details.CountryLightweight_SupplierDetails(
                        iso = 'US', 
                        name = 'United States', 
                        capital = 'Washington', 
                        continent = 'NA', 
                        ...
                        geo_name_id = '6252001', ), 
                    sub_country = wink_sdk_extranet_distribution.models.sub_country_lightweight_supplier_details.SubCountryLightweight_SupplierDetails(
                        name = 'New York', 
                        ascii_name = 'New York', 
                        geo_name_id = '5128638', ), 
                    sub_sub_country = wink_sdk_extranet_distribution.models.sub_sub_country_lightweight_supplier_details.SubSubCountryLightweight_SupplierDetails(
                        name = '', 
                        ascii_name = '', 
                        geo_name_id = '', ), ),
    ...
    def testCustomizationLightweightSupplierDetails(self):
        """Test CustomizationLightweightSupplierDetails"""
