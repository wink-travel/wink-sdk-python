    ...
    def make_instance(self, include_optional) -> BookingTestRequestSupplierDetails:
        ...
        if include_optional:
            return BookingTestRequestSupplierDetails(
                query = wink_sdk_extranet_distribution.models.verify_rates_request_supplier_details.VerifyRatesRequest_SupplierDetails(
                    channel = wink_sdk_extranet_distribution.models.channel_name_supplier_details.ChannelName_SupplierDetails(
                        sub_type = 'DIRECT', 
                        owner_identifier = '', 
                        name = '', ), 
                    ...
                    latitude = 1.337, 
                    longitude = 1.337, ),
                room = wink_sdk_extranet_distribution.models.room_configuration_price_supplier_details.RoomConfigurationPrice_SupplierDetails(
                    adults = 56, 
                    children = 56, 
                    ...
                    available = True, 
                    rate_source = '', ),
                notification = wink_sdk_extranet_distribution.models.booking_test_notification_supplier_details.BookingTestNotification_SupplierDetails(
                    notify_property = True, 
                    notify_channel_manager = True, 
                    notify_booker = True, 
                    booker = wink_sdk_extranet_distribution.models.booking_user_supplier_details.BookingUser_SupplierDetails(
                        user_identifier = '', 
                        first_name = 'John', 
                        last_name = 'Smith', 
