...
class TestGeoIPSupplierDetails(unittest.TestCase):
    """GeoIPSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoIPSupplierDetails:
        """Test GeoIPSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoIPSupplierDetails`
        """
        model = GeoIPSupplierDetails()
        if include_optional:
            return GeoIPSupplierDetails(
                geo_name_id = '8798734',
                locale_code = 'en',
                continent_code = 'NA',
    ...
    def testGeoIPSupplierDetails(self):
        """Test GeoIPSupplierDetails"""
