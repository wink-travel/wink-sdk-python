...
class TestCustomizationThemeColorsSupplierDetails(unittest.TestCase):
    """CustomizationThemeColorsSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationThemeColorsSupplierDetails:
        """Test CustomizationThemeColorsSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationThemeColorsSupplierDetails`
        """
        model = CustomizationThemeColorsSupplierDetails()
        if include_optional:
            return CustomizationThemeColorsSupplierDetails(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testCustomizationThemeColorsSupplierDetails(self):
        """Test CustomizationThemeColorsSupplierDetails"""
