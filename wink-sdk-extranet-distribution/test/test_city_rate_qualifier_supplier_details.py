...
class TestCityRateQualifierSupplierDetails(unittest.TestCase):
    """CityRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CityRateQualifierSupplierDetails:
        """Test CityRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CityRateQualifierSupplierDetails`
        """
        model = CityRateQualifierSupplierDetails()
        if include_optional:
            return CityRateQualifierSupplierDetails(
    ...
    def testCityRateQualifierSupplierDetails(self):
        """Test CityRateQualifierSupplierDetails"""
