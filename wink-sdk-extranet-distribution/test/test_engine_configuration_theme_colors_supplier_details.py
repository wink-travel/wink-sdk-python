...
class TestEngineConfigurationThemeColorsSupplierDetails(unittest.TestCase):
    """EngineConfigurationThemeColorsSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeColorsSupplierDetails:
        """Test EngineConfigurationThemeColorsSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeColorsSupplierDetails`
        """
        model = EngineConfigurationThemeColorsSupplierDetails()
        if include_optional:
            return EngineConfigurationThemeColorsSupplierDetails(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeColorsSupplierDetails(self):
        """Test EngineConfigurationThemeColorsSupplierDetails"""
