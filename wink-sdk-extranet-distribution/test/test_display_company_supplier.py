...
class TestDisplayCompanySupplier(unittest.TestCase):
    """DisplayCompanySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisplayCompanySupplier:
        """Test DisplayCompanySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisplayCompanySupplier`
        """
        model = DisplayCompanySupplier()
        if include_optional:
            return DisplayCompanySupplier(
                identifier = '',
                ...
                city = wink_sdk_extranet_distribution.models.key_value_pair_supplier.KeyValuePair_Supplier(
                    value = 'id-1', 
                    label = 'Readable text label', ),
                country = wink_sdk_extranet_distribution.models.key_value_pair_supplier.KeyValuePair_Supplier(
                    value = 'id-1', 
                    label = 'Readable text label', ),
                continent = wink_sdk_extranet_distribution.models.key_value_pair_supplier.KeyValuePair_Supplier(
                    value = 'id-1', 
                    label = 'Readable text label', ),
                name = '',
                owner_name = '',
    ...
    def testDisplayCompanySupplier(self):
        """Test DisplayCompanySupplier"""
