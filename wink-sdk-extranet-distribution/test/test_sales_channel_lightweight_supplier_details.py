...
class TestSalesChannelLightweightSupplierDetails(unittest.TestCase):
    """SalesChannelLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelLightweightSupplierDetails:
        """Test SalesChannelLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelLightweightSupplierDetails`
        """
        model = SalesChannelLightweightSupplierDetails()
        if include_optional:
            return SalesChannelLightweightSupplierDetails(
                ...
                commission = 0.2,
                rate_modifiers = [
                    wink_sdk_extranet_distribution.models.special_rate_lightweight_supplier_details.SpecialRateLightweight_SupplierDetails(
                        ...
                        city_rate_qualifiers = [
                            wink_sdk_extranet_distribution.models.city_rate_qualifier_supplier_details.CityRateQualifier_SupplierDetails(
                                city = wink_sdk_extranet_distribution.models.geo_ip_lightweight_supplier_details.GeoIpLightweight_SupplierDetails(
                                    geo_name_id = '8798734', 
                                    locale_code = 'en', 
                                    continent_code = 'NA', 
                        ...
                        arrival_days_of_week_rate_qualifier = wink_sdk_extranet_distribution.models.arrival_days_of_week_rate_qualifier_supplier_details.ArrivalDaysOfWeekRateQualifier_SupplierDetails(
                            days_of_week = wink_sdk_extranet_distribution.models.dow_pattern_group_supplier_details.DowPatternGroup_SupplierDetails(
                                ...
                                sun = True, 
                                disabled = True, ), ), 
                        departure_days_of_week_rate_qualifier = wink_sdk_extranet_distribution.models.available_days_of_week_rate_qualifier_supplier_details.AvailableDaysOfWeekRateQualifier_SupplierDetails(
                            days_of_week = , ), 
                ...
                rate_modifier_bundles = [
                    wink_sdk_extranet_distribution.models.special_rate_bundle_lightweight_supplier_details.SpecialRateBundleLightweight_SupplierDetails(
                        identifier = 'document-1', 
                        hotel_identifier = 'hotel-1', 
    ...
    def testSalesChannelLightweightSupplierDetails(self):
        """Test SalesChannelLightweightSupplierDetails"""
