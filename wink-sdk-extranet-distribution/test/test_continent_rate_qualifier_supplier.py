...
class TestContinentRateQualifierSupplier(unittest.TestCase):
    """ContinentRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContinentRateQualifierSupplier:
        """Test ContinentRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContinentRateQualifierSupplier`
        """
        model = ContinentRateQualifierSupplier()
        if include_optional:
            return ContinentRateQualifierSupplier(
                continent = 'NA'
            )
        else:
            return ContinentRateQualifierSupplier(
    ...
    def testContinentRateQualifierSupplier(self):
        """Test ContinentRateQualifierSupplier"""
