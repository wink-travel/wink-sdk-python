...
class TestLocalizedPriceSupplierDetails(unittest.TestCase):
    """LocalizedPriceSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedPriceSupplierDetails:
        """Test LocalizedPriceSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedPriceSupplierDetails`
        """
        model = LocalizedPriceSupplierDetails()
        if include_optional:
            return LocalizedPriceSupplierDetails(
    ...
    def testLocalizedPriceSupplierDetails(self):
        """Test LocalizedPriceSupplierDetails"""
