...
class TestCountryRateQualifierSupplierDetails(unittest.TestCase):
    """CountryRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryRateQualifierSupplierDetails:
        """Test CountryRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryRateQualifierSupplierDetails`
        """
        model = CountryRateQualifierSupplierDetails()
        if include_optional:
            return CountryRateQualifierSupplierDetails(
    ...
    def testCountryRateQualifierSupplierDetails(self):
        """Test CountryRateQualifierSupplierDetails"""
