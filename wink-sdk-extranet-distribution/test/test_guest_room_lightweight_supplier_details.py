...
class TestGuestRoomLightweightSupplierDetails(unittest.TestCase):
    """GuestRoomLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomLightweightSupplierDetails:
        """Test GuestRoomLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomLightweightSupplierDetails`
        """
        model = GuestRoomLightweightSupplierDetails()
        if include_optional:
            return GuestRoomLightweightSupplierDetails(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
                ...
                address = wink_sdk_extranet_distribution.models.simple_address_supplier_details.SimpleAddress_SupplierDetails(
    ...
    def testGuestRoomLightweightSupplierDetails(self):
        """Test GuestRoomLightweightSupplierDetails"""
