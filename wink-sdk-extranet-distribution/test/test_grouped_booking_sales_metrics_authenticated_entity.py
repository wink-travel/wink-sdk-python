...
class TestGroupedBookingSalesMetricsAuthenticatedEntity(unittest.TestCase):
    """GroupedBookingSalesMetricsAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupedBookingSalesMetricsAuthenticatedEntity:
        """Test GroupedBookingSalesMetricsAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupedBookingSalesMetricsAuthenticatedEntity`
        """
        model = GroupedBookingSalesMetricsAuthenticatedEntity()
        if include_optional:
            return GroupedBookingSalesMetricsAuthenticatedEntity(
                type = 'BY_TOTAL',
                type_name = '',
                type_identifier = '',
                bookings = 56,
    ...
    def testGroupedBookingSalesMetricsAuthenticatedEntity(self):
        """Test GroupedBookingSalesMetricsAuthenticatedEntity"""
