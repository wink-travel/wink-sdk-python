...
class TestPromotionRateQualifierSupplierDetails(unittest.TestCase):
    """PromotionRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PromotionRateQualifierSupplierDetails:
        """Test PromotionRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PromotionRateQualifierSupplierDetails`
        """
        model = PromotionRateQualifierSupplierDetails()
        if include_optional:
            return PromotionRateQualifierSupplierDetails(
                promotion = 'NA'
            )
        else:
            return PromotionRateQualifierSupplierDetails(
    ...
    def testPromotionRateQualifierSupplierDetails(self):
        """Test PromotionRateQualifierSupplierDetails"""
