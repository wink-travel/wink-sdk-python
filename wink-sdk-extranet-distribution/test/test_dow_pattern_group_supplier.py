...
class TestDowPatternGroupSupplier(unittest.TestCase):
    """DowPatternGroupSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DowPatternGroupSupplier:
        """Test DowPatternGroupSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DowPatternGroupSupplier`
        """
        model = DowPatternGroupSupplier()
        if include_optional:
            return DowPatternGroupSupplier(
                mon = True,
                tue = True,
                wed = True,
                thu = True,
    ...
    def testDowPatternGroupSupplier(self):
        """Test DowPatternGroupSupplier"""
