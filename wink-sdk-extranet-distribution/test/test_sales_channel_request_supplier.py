...
class TestSalesChannelRequestSupplier(unittest.TestCase):
    """SalesChannelRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelRequestSupplier:
        """Test SalesChannelRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelRequestSupplier`
        """
        model = SalesChannelRequestSupplier()
        if include_optional:
            return SalesChannelRequestSupplier(
                id = 'doc-1',
    ...
    def testSalesChannelRequestSupplier(self):
        """Test SalesChannelRequestSupplier"""
