...
class TestDailyRateSupplierDetails(unittest.TestCase):
    """DailyRateSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DailyRateSupplierDetails:
        """Test DailyRateSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DailyRateSupplierDetails`
        """
        model = DailyRateSupplierDetails()
        if include_optional:
            return DailyRateSupplierDetails(
                ...
                internal_base_rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                user_specified_currency_base_rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                ...
                rate = wink_sdk_extranet_distribution.models.daily_rate_rate_supplier_details.DailyRateRate_SupplierDetails(
                    ...
                    rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '', ), 
                    master = True, 
                ...
                source_rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                ...
                base_rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                user_specified_currency_rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                internal_rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                end_date = True,
                quantity = 56,
    ...
    def testDailyRateSupplierDetails(self):
        """Test DailyRateSupplierDetails"""
