...
class TestBedSupplierDetails(unittest.TestCase):
    """BedSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedSupplierDetails:
        """Test BedSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedSupplierDetails`
        """
        model = BedSupplierDetails()
        if include_optional:
            return BedSupplierDetails(
                bed_type_code = '1',
                quantity = 10
            )
        else:
    ...
    def testBedSupplierDetails(self):
        """Test BedSupplierDetails"""
