...
class TestReviewLightweightSupplierDetails(unittest.TestCase):
    """ReviewLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewLightweightSupplierDetails:
        """Test ReviewLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewLightweightSupplierDetails`
        """
        model = ReviewLightweightSupplierDetails()
        if include_optional:
            return ReviewLightweightSupplierDetails(
                identifier = 'review-1',
                booking_identifier = 'booking-1',
                hotel_identifier = 'hotel-1',
                user = wink_sdk_extranet_distribution.models.review_user_supplier_details.ReviewUser_SupplierDetails(
                    user_identifier = '', 
                    first_name = 'John', 
                    last_name = 'Smith', 
                ...
                average_score = 8.7,
                answers = [
                    wink_sdk_extranet_distribution.models.review_answer_supplier_details.ReviewAnswer_SupplierDetails(
    ...
    def testReviewLightweightSupplierDetails(self):
        """Test ReviewLightweightSupplierDetails"""
