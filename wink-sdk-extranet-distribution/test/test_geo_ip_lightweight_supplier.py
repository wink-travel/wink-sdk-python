...
class TestGeoIpLightweightSupplier(unittest.TestCase):
    """GeoIpLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoIpLightweightSupplier:
        """Test GeoIpLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoIpLightweightSupplier`
        """
        model = GeoIpLightweightSupplier()
        if include_optional:
            return GeoIpLightweightSupplier(
                geo_name_id = '8798734',
                locale_code = 'en',
                continent_code = 'NA',
    ...
    def testGeoIpLightweightSupplier(self):
        """Test GeoIpLightweightSupplier"""
