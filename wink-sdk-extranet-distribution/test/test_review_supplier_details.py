...
class TestReviewSupplierDetails(unittest.TestCase):
    """ReviewSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewSupplierDetails:
        """Test ReviewSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewSupplierDetails`
        """
        model = ReviewSupplierDetails()
        if include_optional:
            return ReviewSupplierDetails(
                identifier = '',
                booking_identifier = '',
                hotel_identifier = '',
    ...
    def testReviewSupplierDetails(self):
        """Test ReviewSupplierDetails"""
