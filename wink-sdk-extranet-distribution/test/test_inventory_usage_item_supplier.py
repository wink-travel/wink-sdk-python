...
class TestInventoryUsageItemSupplier(unittest.TestCase):
    """InventoryUsageItemSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryUsageItemSupplier:
        """Test InventoryUsageItemSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryUsageItemSupplier`
        """
        model = InventoryUsageItemSupplier()
        if include_optional:
            return InventoryUsageItemSupplier(
                usage = 'RATE_MODIFIER',
                count = 56
            )
        else:
    ...
    def testInventoryUsageItemSupplier(self):
        """Test InventoryUsageItemSupplier"""
