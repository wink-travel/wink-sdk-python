...
class TestRateModifierSupplierDetails(unittest.TestCase):
    """RateModifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateModifierSupplierDetails:
        """Test RateModifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateModifierSupplierDetails`
        """
        model = RateModifierSupplierDetails()
        if include_optional:
            return RateModifierSupplierDetails(
                identifier = '',
                hotel_identifier = '',
                name = 'Early bird',
                type = 'DISCOUNT',
    ...
    def testRateModifierSupplierDetails(self):
        """Test RateModifierSupplierDetails"""
