...
class TestInventoryUpdateRequestSupplier(unittest.TestCase):
    """InventoryUpdateRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryUpdateRequestSupplier:
        """Test InventoryUpdateRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryUpdateRequestSupplier`
        """
        model = InventoryUpdateRequestSupplier()
        if include_optional:
            return InventoryUpdateRequestSupplier(
                identifier = '',
                enabled = True
            )
        else:
    ...
    def testInventoryUpdateRequestSupplier(self):
        """Test InventoryUpdateRequestSupplier"""
