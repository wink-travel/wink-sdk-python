...
class TestInventoryViewSupplier(unittest.TestCase):
    """InventoryViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryViewSupplier:
        """Test InventoryViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryViewSupplier`
        """
        model = InventoryViewSupplier()
        if include_optional:
            return InventoryViewSupplier(
                id = 'doc-1',
    ...
    def testInventoryViewSupplier(self):
        """Test InventoryViewSupplier"""
