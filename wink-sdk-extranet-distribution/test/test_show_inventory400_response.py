...
class TestShowInventory400Response(unittest.TestCase):
    """ShowInventory400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowInventory400Response:
        """Test ShowInventory400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowInventory400Response`
        """
        model = ShowInventory400Response()
        if include_optional:
            return ShowInventory400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowInventory400Response(self):
        """Test ShowInventory400Response"""
