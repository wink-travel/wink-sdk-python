...
class TestRoomConfigurationPriceRatePlanSupplierDetails(unittest.TestCase):
    """RoomConfigurationPriceRatePlanSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceRatePlanSupplierDetails:
        """Test RoomConfigurationPriceRatePlanSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationPriceRatePlanSupplierDetails`
        """
        model = RoomConfigurationPriceRatePlanSupplierDetails()
        if include_optional:
            return RoomConfigurationPriceRatePlanSupplierDetails(
                identifier = '',
                name = 'BAR 1',
                breakfast = False,
                brunch = False,
    ...
    def testRoomConfigurationPriceRatePlanSupplierDetails(self):
        """Test RoomConfigurationPriceRatePlanSupplierDetails"""
