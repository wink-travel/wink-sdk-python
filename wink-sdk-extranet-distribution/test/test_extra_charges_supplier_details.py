...
class TestExtraChargesSupplierDetails(unittest.TestCase):
    """ExtraChargesSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargesSupplierDetails:
        """Test ExtraChargesSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargesSupplierDetails`
        """
        model = ExtraChargesSupplierDetails()
        if include_optional:
            return ExtraChargesSupplierDetails(
                items = [
    ...
    def testExtraChargesSupplierDetails(self):
        """Test ExtraChargesSupplierDetails"""
