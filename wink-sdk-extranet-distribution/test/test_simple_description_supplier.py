...
class TestSimpleDescriptionSupplier(unittest.TestCase):
    """SimpleDescriptionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDescriptionSupplier:
        """Test SimpleDescriptionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDescriptionSupplier`
        """
        model = SimpleDescriptionSupplier()
        if include_optional:
    ...
    def testSimpleDescriptionSupplier(self):
        """Test SimpleDescriptionSupplier"""
