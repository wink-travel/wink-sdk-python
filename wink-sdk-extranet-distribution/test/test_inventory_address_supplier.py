...
class TestInventoryAddressSupplier(unittest.TestCase):
    """InventoryAddressSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryAddressSupplier:
        """Test InventoryAddressSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryAddressSupplier`
        """
        model = InventoryAddressSupplier()
        if include_optional:
            return InventoryAddressSupplier(
                address1 = '234',
    ...
    def testInventoryAddressSupplier(self):
        """Test InventoryAddressSupplier"""
