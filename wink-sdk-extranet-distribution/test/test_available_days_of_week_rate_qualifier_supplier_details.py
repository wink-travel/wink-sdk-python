...
class TestAvailableDaysOfWeekRateQualifierSupplierDetails(unittest.TestCase):
    """AvailableDaysOfWeekRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableDaysOfWeekRateQualifierSupplierDetails:
        """Test AvailableDaysOfWeekRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableDaysOfWeekRateQualifierSupplierDetails`
        """
        model = AvailableDaysOfWeekRateQualifierSupplierDetails()
        if include_optional:
            return AvailableDaysOfWeekRateQualifierSupplierDetails(
    ...
    def testAvailableDaysOfWeekRateQualifierSupplierDetails(self):
        """Test AvailableDaysOfWeekRateQualifierSupplierDetails"""
