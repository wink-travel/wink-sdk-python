...
class TestRoomConfigurationPriceSupplierDetails(unittest.TestCase):
    """RoomConfigurationPriceSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceSupplierDetails:
        """Test RoomConfigurationPriceSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationPriceSupplierDetails`
        """
        model = RoomConfigurationPriceSupplierDetails()
        if include_optional:
            return RoomConfigurationPriceSupplierDetails(
                adults = 56,
                children = 56,
                ...
                perk_value = 56,
                active_cancellation_policy = wink_sdk_extranet_distribution.models.cancellation_policy_supplier_details.CancellationPolicy_SupplierDetails(
                    identifier = '', 
                    hotel_identifier = '', 
                    refundable = False, 
                    advance_cancellation_free_of_charge = 'UNTIL_EIGHTEEN_HUNDRED_HOURS_ON_DAY_OF_ARRIVAL', 
    ...
    def testRoomConfigurationPriceSupplierDetails(self):
        """Test RoomConfigurationPriceSupplierDetails"""
