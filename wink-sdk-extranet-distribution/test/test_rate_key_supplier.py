...
class TestRateKeySupplier(unittest.TestCase):
    """RateKeySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateKeySupplier:
        """Test RateKeySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateKeySupplier`
        """
        model = RateKeySupplier()
        if include_optional:
            return RateKeySupplier(
                hotel_identifier = '',
