...
class TestChannelNameSupplier(unittest.TestCase):
    """ChannelNameSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelNameSupplier:
        """Test ChannelNameSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelNameSupplier`
        """
        model = ChannelNameSupplier()
        if include_optional:
            return ChannelNameSupplier(
                sub_type = 'DIRECT',
                owner_identifier = '',
                name = ''
            )
    ...
    def testChannelNameSupplier(self):
        """Test ChannelNameSupplier"""
