...
class TestSellDateRateQualifierSupplierDetails(unittest.TestCase):
    """SellDateRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellDateRateQualifierSupplierDetails:
        """Test SellDateRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellDateRateQualifierSupplierDetails`
        """
        model = SellDateRateQualifierSupplierDetails()
        if include_optional:
            return SellDateRateQualifierSupplierDetails(
    ...
    def testSellDateRateQualifierSupplierDetails(self):
        """Test SellDateRateQualifierSupplierDetails"""
