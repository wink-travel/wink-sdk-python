...
class TestVariableChargeSupplier(unittest.TestCase):
    """VariableChargeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariableChargeSupplier:
        """Test VariableChargeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariableChargeSupplier`
        """
        model = VariableChargeSupplier()
        if include_optional:
            return VariableChargeSupplier(
                type = 'FIXED',
                percent = 0.25,
    ...
    def testVariableChargeSupplier(self):
        """Test VariableChargeSupplier"""
