...
class TestSpecialRateBundleLightweightSupplier(unittest.TestCase):
    """SpecialRateBundleLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialRateBundleLightweightSupplier:
        """Test SpecialRateBundleLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialRateBundleLightweightSupplier`
        """
        model = SpecialRateBundleLightweightSupplier()
        if include_optional:
            return SpecialRateBundleLightweightSupplier(
    ...
    def testSpecialRateBundleLightweightSupplier(self):
        """Test SpecialRateBundleLightweightSupplier"""
