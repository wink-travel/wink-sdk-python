...
class TestDisplayCompanyWithSalesMetricsSupplier(unittest.TestCase):
    """DisplayCompanyWithSalesMetricsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisplayCompanyWithSalesMetricsSupplier:
        """Test DisplayCompanyWithSalesMetricsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisplayCompanyWithSalesMetricsSupplier`
        """
        model = DisplayCompanyWithSalesMetricsSupplier()
        if include_optional:
            return DisplayCompanyWithSalesMetricsSupplier(
                owner_identifier = '',
                type = 'DIRECT',
                owner_name = '',
                continent = '',
    ...
    def testDisplayCompanyWithSalesMetricsSupplier(self):
        """Test DisplayCompanyWithSalesMetricsSupplier"""
