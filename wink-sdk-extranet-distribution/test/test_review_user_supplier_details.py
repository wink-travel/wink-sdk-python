...
class TestReviewUserSupplierDetails(unittest.TestCase):
    """ReviewUserSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewUserSupplierDetails:
        """Test ReviewUserSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewUserSupplierDetails`
        """
        model = ReviewUserSupplierDetails()
        if include_optional:
            return ReviewUserSupplierDetails(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testReviewUserSupplierDetails(self):
        """Test ReviewUserSupplierDetails"""
