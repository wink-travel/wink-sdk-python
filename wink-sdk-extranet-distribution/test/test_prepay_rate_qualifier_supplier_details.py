...
class TestPrepayRateQualifierSupplierDetails(unittest.TestCase):
    """PrepayRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrepayRateQualifierSupplierDetails:
        """Test PrepayRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrepayRateQualifierSupplierDetails`
        """
        model = PrepayRateQualifierSupplierDetails()
        if include_optional:
            return PrepayRateQualifierSupplierDetails(
                prepay = True
            )
        else:
            return PrepayRateQualifierSupplierDetails(
    ...
    def testPrepayRateQualifierSupplierDetails(self):
        """Test PrepayRateQualifierSupplierDetails"""
