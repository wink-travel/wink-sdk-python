...
class TestGeoJsonPointSupplierDetails(unittest.TestCase):
    """GeoJsonPointSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonPointSupplierDetails:
        """Test GeoJsonPointSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonPointSupplierDetails`
        """
        model = GeoJsonPointSupplierDetails()
        if include_optional:
            return GeoJsonPointSupplierDetails(
                x = 1.337,
                y = 1.337,
                type = '',
                coordinates = [
    ...
    def testGeoJsonPointSupplierDetails(self):
        """Test GeoJsonPointSupplierDetails"""
