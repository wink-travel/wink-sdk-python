    ...
    def make_instance(self, include_optional) -> PageRateSupplier:
        ...
        if include_optional:
            return PageRateSupplier(
                ...
                size = 56,
                content = [
                    wink_sdk_extranet_distribution.models.rate_supplier.Rate_Supplier(
                        id = 'doc-1', 
                        hotel_identifier = '', 
                        ...
                        ttl = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        available = True, )
                    ],
                number = 56,
                sort = [
                    wink_sdk_extranet_distribution.models.sort_object.SortObject(
                        direction = '', 
                        null_handling = '', 
                        ascending = True, 
                        property = '', 
