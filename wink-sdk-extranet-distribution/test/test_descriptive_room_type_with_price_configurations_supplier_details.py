...
class TestDescriptiveRoomTypeWithPriceConfigurationsSupplierDetails(unittest.TestCase):
    """DescriptiveRoomTypeWithPriceConfigurationsSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescriptiveRoomTypeWithPriceConfigurationsSupplierDetails:
        """Test DescriptiveRoomTypeWithPriceConfigurationsSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescriptiveRoomTypeWithPriceConfigurationsSupplierDetails`
        """
        model = DescriptiveRoomTypeWithPriceConfigurationsSupplierDetails()
        if include_optional:
            return DescriptiveRoomTypeWithPriceConfigurationsSupplierDetails(
    ...
    def testDescriptiveRoomTypeWithPriceConfigurationsSupplierDetails(self):
        """Test DescriptiveRoomTypeWithPriceConfigurationsSupplierDetails"""
