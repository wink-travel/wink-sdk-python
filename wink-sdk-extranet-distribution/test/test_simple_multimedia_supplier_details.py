...
class TestSimpleMultimediaSupplierDetails(unittest.TestCase):
    """SimpleMultimediaSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimediaSupplierDetails:
        """Test SimpleMultimediaSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimediaSupplierDetails`
        """
        model = SimpleMultimediaSupplierDetails()
        if include_optional:
            return SimpleMultimediaSupplierDetails(
    ...
    def testSimpleMultimediaSupplierDetails(self):
        """Test SimpleMultimediaSupplierDetails"""
