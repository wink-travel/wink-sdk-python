...
class TestContinentRateQualifierSupplierDetails(unittest.TestCase):
    """ContinentRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContinentRateQualifierSupplierDetails:
        """Test ContinentRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContinentRateQualifierSupplierDetails`
        """
        model = ContinentRateQualifierSupplierDetails()
        if include_optional:
            return ContinentRateQualifierSupplierDetails(
                continent = 'NA'
            )
        else:
            return ContinentRateQualifierSupplierDetails(
    ...
    def testContinentRateQualifierSupplierDetails(self):
        """Test ContinentRateQualifierSupplierDetails"""
