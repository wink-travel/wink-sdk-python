...
class TestSimpleAddressSupplierDetails(unittest.TestCase):
    """SimpleAddressSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleAddressSupplierDetails:
        """Test SimpleAddressSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleAddressSupplierDetails`
        """
        model = SimpleAddressSupplierDetails()
        if include_optional:
            return SimpleAddressSupplierDetails(
    ...
    def testSimpleAddressSupplierDetails(self):
        """Test SimpleAddressSupplierDetails"""
