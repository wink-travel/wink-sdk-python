...
class TestPageInventoryViewSupplier(unittest.TestCase):
    """PageInventoryViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageInventoryViewSupplier:
        """Test PageInventoryViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageInventoryViewSupplier`
        """
        model = PageInventoryViewSupplier()
        if include_optional:
            return PageInventoryViewSupplier(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
                    wink_sdk_extranet_distribution.models.inventory_view_supplier.InventoryView_Supplier(
                        id = 'doc-1', 
                        created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        version = 12, 
                        inventory = wink_sdk_extranet_distribution.models.inventory_supplier.Inventory_Supplier(
                            identifier = '', 
    ...
    def testPageInventoryViewSupplier(self):
        """Test PageInventoryViewSupplier"""
