...
class TestTransactionalTravelInventorySupplierDetails(unittest.TestCase):
    """TransactionalTravelInventorySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionalTravelInventorySupplierDetails:
        """Test TransactionalTravelInventorySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionalTravelInventorySupplierDetails`
        """
        model = TransactionalTravelInventorySupplierDetails()
        if include_optional:
            return TransactionalTravelInventorySupplierDetails(
                identifier = '',
                name = '1 hour session',
                descriptions = [
    ...
    def testTransactionalTravelInventorySupplierDetails(self):
        """Test TransactionalTravelInventorySupplierDetails"""
