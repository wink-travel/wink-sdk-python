...
class TestDisplayCompanyWithSalesMetricsAuthenticatedEntity(unittest.TestCase):
    """DisplayCompanyWithSalesMetricsAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisplayCompanyWithSalesMetricsAuthenticatedEntity:
        """Test DisplayCompanyWithSalesMetricsAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisplayCompanyWithSalesMetricsAuthenticatedEntity`
        """
        model = DisplayCompanyWithSalesMetricsAuthenticatedEntity()
        if include_optional:
            return DisplayCompanyWithSalesMetricsAuthenticatedEntity(
                owner_identifier = '',
                type = 'TRIP_PAY',
                owner_name = '',
                url_name = '',
    ...
    def testDisplayCompanyWithSalesMetricsAuthenticatedEntity(self):
        """Test DisplayCompanyWithSalesMetricsAuthenticatedEntity"""
