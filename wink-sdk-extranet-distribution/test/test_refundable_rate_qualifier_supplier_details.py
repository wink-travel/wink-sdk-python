...
class TestRefundableRateQualifierSupplierDetails(unittest.TestCase):
    """RefundableRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundableRateQualifierSupplierDetails:
        """Test RefundableRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundableRateQualifierSupplierDetails`
        """
        model = RefundableRateQualifierSupplierDetails()
        if include_optional:
            return RefundableRateQualifierSupplierDetails(
                refundable = True
            )
        else:
            return RefundableRateQualifierSupplierDetails(
    ...
    def testRefundableRateQualifierSupplierDetails(self):
        """Test RefundableRateQualifierSupplierDetails"""
