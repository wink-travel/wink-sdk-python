...
class TestCityRateQualifierSupplier(unittest.TestCase):
    """CityRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CityRateQualifierSupplier:
        """Test CityRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CityRateQualifierSupplier`
        """
        model = CityRateQualifierSupplier()
        if include_optional:
            return CityRateQualifierSupplier(
    ...
    def testCityRateQualifierSupplier(self):
        """Test CityRateQualifierSupplier"""
