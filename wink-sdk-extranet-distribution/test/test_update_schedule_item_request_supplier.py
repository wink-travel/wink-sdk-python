...
class TestUpdateScheduleItemRequestSupplier(unittest.TestCase):
    """UpdateScheduleItemRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduleItemRequestSupplier:
        """Test UpdateScheduleItemRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduleItemRequestSupplier`
        """
        model = UpdateScheduleItemRequestSupplier()
        if include_optional:
            return UpdateScheduleItemRequestSupplier(
    ...
    def testUpdateScheduleItemRequestSupplier(self):
        """Test UpdateScheduleItemRequestSupplier"""
