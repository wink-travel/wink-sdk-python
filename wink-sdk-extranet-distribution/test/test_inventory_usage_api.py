...
class TestInventoryUsageApi(unittest.TestCase):
    """InventoryUsageApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InventoryUsageApi()

    def tearDown(self) -> None:
        pass

    def test_show_activity_usage(self) -> None:
        """Test case for show_activity_usage

        Show Activity Usage
        """
        pass

    def test_show_add_on_usage(self) -> None:
        """Test case for show_add_on_usage

        Show Add-On Usage
        """
        pass

    def test_show_attraction_usage(self) -> None:
        """Test case for show_attraction_usage

        Show Attraction Usage
        """
        pass

    def test_show_meeting_room_usage(self) -> None:
        """Test case for show_meeting_room_usage

        Show Meeting Room Usage
        """
        pass

    def test_show_place_usage(self) -> None:
        """Test case for show_place_usage

        Show Place Usage
        """
        pass

    def test_show_rate_plan_usage(self) -> None:
        """Test case for show_rate_plan_usage

        Show Rate Plan Usage
        """
        pass

    def test_show_restaurant_usage(self) -> None:
        """Test case for show_restaurant_usage

        Show Restaurant Usage
        """
        pass

    def test_show_room_type_usage(self) -> None:
        """Test case for show_room_type_usage

        Show Room Type Usage
        """
        pass

    def test_show_spa_usage(self) -> None:
        """Test case for show_spa_usage
