...
class TestAdvanceBookingRateQualifierSupplier(unittest.TestCase):
    """AdvanceBookingRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvanceBookingRateQualifierSupplier:
        """Test AdvanceBookingRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvanceBookingRateQualifierSupplier`
        """
        model = AdvanceBookingRateQualifierSupplier()
        if include_optional:
            return AdvanceBookingRateQualifierSupplier(
    ...
    def testAdvanceBookingRateQualifierSupplier(self):
        """Test AdvanceBookingRateQualifierSupplier"""
