...
class TestProfileUserSupplierDetails(unittest.TestCase):
    """ProfileUserSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileUserSupplierDetails:
        """Test ProfileUserSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileUserSupplierDetails`
        """
        model = ProfileUserSupplierDetails()
        if include_optional:
            return ProfileUserSupplierDetails(
                first_name = 'Avid',
                last_name = 'Travelman',
    ...
    def testProfileUserSupplierDetails(self):
        """Test ProfileUserSupplierDetails"""
