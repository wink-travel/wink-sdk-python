...
class TestSalesChannelUpdateRequestSupplier(unittest.TestCase):
    """SalesChannelUpdateRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelUpdateRequestSupplier:
        """Test SalesChannelUpdateRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelUpdateRequestSupplier`
        """
        model = SalesChannelUpdateRequestSupplier()
        if include_optional:
            return SalesChannelUpdateRequestSupplier(
                enabled = True,
                blacklisted = True,
                percent_discount = 0.15,
                commission = 0.2,
                rate_modifier_identifiers = [
                    ''
                    ],
                rate_modifier_bundle_identifiers = [
                    ''
                    ]
            )
        else:
    ...
    def testSalesChannelUpdateRequestSupplier(self):
        """Test SalesChannelUpdateRequestSupplier"""
