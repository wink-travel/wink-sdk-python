...
class TestMinutesBeforeBookingStartDateRateQualifierSupplierDetails(unittest.TestCase):
    """MinutesBeforeBookingStartDateRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MinutesBeforeBookingStartDateRateQualifierSupplierDetails:
        """Test MinutesBeforeBookingStartDateRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MinutesBeforeBookingStartDateRateQualifierSupplierDetails`
        """
        model = MinutesBeforeBookingStartDateRateQualifierSupplierDetails()
        if include_optional:
            return MinutesBeforeBookingStartDateRateQualifierSupplierDetails(
                seconds = 0
            )
        else:
            return MinutesBeforeBookingStartDateRateQualifierSupplierDetails(
    ...
    def testMinutesBeforeBookingStartDateRateQualifierSupplierDetails(self):
        """Test MinutesBeforeBookingStartDateRateQualifierSupplierDetails"""
