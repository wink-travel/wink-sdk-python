...
class TestGeneralManagerSupplierDetails(unittest.TestCase):
    """GeneralManagerSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralManagerSupplierDetails:
        """Test GeneralManagerSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralManagerSupplierDetails`
        """
        model = GeneralManagerSupplierDetails()
        if include_optional:
            return GeneralManagerSupplierDetails(
                name = 'Jane Doe',
                image = cl-image-1,
                descriptions = [
    ...
    def testGeneralManagerSupplierDetails(self):
        """Test GeneralManagerSupplierDetails"""
