...
class TestRoomTypeLightweightSupplierDetails(unittest.TestCase):
    """RoomTypeLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomTypeLightweightSupplierDetails:
        """Test RoomTypeLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomTypeLightweightSupplierDetails`
        """
        model = RoomTypeLightweightSupplierDetails()
        if include_optional:
            return RoomTypeLightweightSupplierDetails(
                ...
                base_rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '0', ),
                min_rate = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '0', )
            )
        else:
    ...
    def testRoomTypeLightweightSupplierDetails(self):
        """Test RoomTypeLightweightSupplierDetails"""
