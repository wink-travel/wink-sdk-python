...
class TestTimezoneRateQualifierSupplierDetails(unittest.TestCase):
    """TimezoneRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimezoneRateQualifierSupplierDetails:
        """Test TimezoneRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimezoneRateQualifierSupplierDetails`
        """
        model = TimezoneRateQualifierSupplierDetails()
        if include_optional:
            return TimezoneRateQualifierSupplierDetails(
                timezone = ''
            )
        else:
            return TimezoneRateQualifierSupplierDetails(
    ...
    def testTimezoneRateQualifierSupplierDetails(self):
        """Test TimezoneRateQualifierSupplierDetails"""
