...
class TestArrivalDaysOfWeekRateQualifierSupplier(unittest.TestCase):
    """ArrivalDaysOfWeekRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrivalDaysOfWeekRateQualifierSupplier:
        """Test ArrivalDaysOfWeekRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrivalDaysOfWeekRateQualifierSupplier`
        """
        model = ArrivalDaysOfWeekRateQualifierSupplier()
        if include_optional:
            return ArrivalDaysOfWeekRateQualifierSupplier(
    ...
    def testArrivalDaysOfWeekRateQualifierSupplier(self):
        """Test ArrivalDaysOfWeekRateQualifierSupplier"""
