...
class TestCompanyDetailsBookingSalesMetricsAuthenticatedEntity(unittest.TestCase):
    """CompanyDetailsBookingSalesMetricsAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyDetailsBookingSalesMetricsAuthenticatedEntity:
        """Test CompanyDetailsBookingSalesMetricsAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyDetailsBookingSalesMetricsAuthenticatedEntity`
        """
        model = CompanyDetailsBookingSalesMetricsAuthenticatedEntity()
        if include_optional:
            return CompanyDetailsBookingSalesMetricsAuthenticatedEntity(
                affiliate_account = wink_sdk_extranet_distribution.models.browse_affiliate_account_authenticated_entity.BrowseAffiliateAccount_Authenticated_Entity(
                    identifier = '', 
                    city = wink_sdk_extranet_distribution.models.key_value_pair_authenticated_entity.KeyValuePair_Authenticated_Entity(
                        value = 'id-1', 
                        label = 'Readable text label', ), 
                    country = wink_sdk_extranet_distribution.models.key_value_pair_authenticated_entity.KeyValuePair_Authenticated_Entity(
                        value = 'id-1', 
                        label = 'Readable text label', ), 
                    continent = , 
                    name = '0', 
                    ...
                    travel_agent = null, 
                    owner_image_id = '', ),
                total = wink_sdk_extranet_distribution.models.grouped_booking_sales_metrics_authenticated_entity.GroupedBookingSalesMetrics_Authenticated_Entity(
                    type = 'BY_TOTAL', 
                    type_name = '', 
                    type_identifier = '', 
                    bookings = 56, 
                    ...
                    currency_code = '', ),
                by_property_list = [
                    wink_sdk_extranet_distribution.models.grouped_booking_sales_metrics_authenticated_entity.GroupedBookingSalesMetrics_Authenticated_Entity(
                        type = 'BY_TOTAL', 
                        type_name = '', 
                        type_identifier = '', 
                        bookings = 56, 
    ...
    def testCompanyDetailsBookingSalesMetricsAuthenticatedEntity(self):
        """Test CompanyDetailsBookingSalesMetricsAuthenticatedEntity"""
