...
class TestIPRangeRateQualifierSupplierDetails(unittest.TestCase):
    """IPRangeRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPRangeRateQualifierSupplierDetails:
        """Test IPRangeRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPRangeRateQualifierSupplierDetails`
        """
        model = IPRangeRateQualifierSupplierDetails()
        if include_optional:
            return IPRangeRateQualifierSupplierDetails(
                start_ip_range = '',
                end_ip_range = ''
            )
        else:
    ...
    def testIPRangeRateQualifierSupplierDetails(self):
        """Test IPRangeRateQualifierSupplierDetails"""
