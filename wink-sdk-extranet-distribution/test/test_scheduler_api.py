...
class TestSchedulerApi(unittest.TestCase):
    ...
    def test_create_schedule_item(self) -> None:
        """Test case for create_schedule_item
    ...
    def test_remove_schedule_item(self) -> None:
        """Test case for remove_schedule_item

        Delete Scheduler Item
        """
        pass

    def test_show_schedule_items(self) -> None:
        """Test case for show_schedule_items

        Show Scheduler Items
        """
        pass

    def test_update_schedule_item(self) -> None:
        """Test case for update_schedule_item
