...
class TestCommissionableEntrySupplierDetails(unittest.TestCase):
    """CommissionableEntrySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommissionableEntrySupplierDetails:
        """Test CommissionableEntrySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommissionableEntrySupplierDetails`
        """
        model = CommissionableEntrySupplierDetails()
        if include_optional:
            return CommissionableEntrySupplierDetails(
                name = '',
                identifier = '',
                type = 'GUEST_ROOM',
    ...
    def testCommissionableEntrySupplierDetails(self):
        """Test CommissionableEntrySupplierDetails"""
