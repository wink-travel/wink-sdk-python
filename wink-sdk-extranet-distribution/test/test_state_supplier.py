...
class TestStateSupplier(unittest.TestCase):
    """StateSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateSupplier:
        """Test StateSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateSupplier`
        """
        model = StateSupplier()
        if include_optional:
