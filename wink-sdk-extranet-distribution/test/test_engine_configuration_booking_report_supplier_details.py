...
class TestEngineConfigurationBookingReportSupplierDetails(unittest.TestCase):
    """EngineConfigurationBookingReportSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationBookingReportSupplierDetails:
        """Test EngineConfigurationBookingReportSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationBookingReportSupplierDetails`
        """
        model = EngineConfigurationBookingReportSupplierDetails()
        if include_optional:
            return EngineConfigurationBookingReportSupplierDetails(
                identifier = '',
                ...
                self_hosted = True,
                theme_colors = wink_sdk_extranet_distribution.models.engine_configuration_theme_supplier_details.EngineConfigurationTheme_SupplierDetails(
                    primary = '#dc3545', 
                    secondary = '#6c757d', 
                    success = '#28a745', 
                    danger = '#dc3545', 
    ...
    def testEngineConfigurationBookingReportSupplierDetails(self):
        """Test EngineConfigurationBookingReportSupplierDetails"""
