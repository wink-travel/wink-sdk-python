...
class TestRefundableRateQualifierSupplier(unittest.TestCase):
    """RefundableRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundableRateQualifierSupplier:
        """Test RefundableRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundableRateQualifierSupplier`
        """
        model = RefundableRateQualifierSupplier()
        if include_optional:
            return RefundableRateQualifierSupplier(
                refundable = True
            )
        else:
            return RefundableRateQualifierSupplier(
    ...
    def testRefundableRateQualifierSupplier(self):
        """Test RefundableRateQualifierSupplier"""
