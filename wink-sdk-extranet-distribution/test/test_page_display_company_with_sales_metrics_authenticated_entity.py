...
class TestPageDisplayCompanyWithSalesMetricsAuthenticatedEntity(unittest.TestCase):
    """PageDisplayCompanyWithSalesMetricsAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageDisplayCompanyWithSalesMetricsAuthenticatedEntity:
        """Test PageDisplayCompanyWithSalesMetricsAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageDisplayCompanyWithSalesMetricsAuthenticatedEntity`
        """
        model = PageDisplayCompanyWithSalesMetricsAuthenticatedEntity()
        if include_optional:
            return PageDisplayCompanyWithSalesMetricsAuthenticatedEntity(
                total_pages = 56,
                total_elements = 56,
                size = 56,
                content = [
                    wink_sdk_extranet_distribution.models.display_company_with_sales_metrics_authenticated_entity.DisplayCompanyWithSalesMetrics_Authenticated_Entity(
                        owner_identifier = '', 
                        type = 'TRIP_PAY', 
                        owner_name = '', 
                        url_name = '', 
                ...
                number = 56,
                sort = wink_sdk_extranet_distribution.models.sort_object_supplier.SortObject_Supplier(
                    empty = True, 
                    unsorted = True, 
                    sorted = True, ),
                first = True,
                ...
                pageable = wink_sdk_extranet_distribution.models.pageable_object_supplier.PageableObject_Supplier(
                    offset = 56, 
                    page_size = 56, 
                    sort = wink_sdk_extranet_distribution.models.sort_object_supplier.SortObject_Supplier(
                        empty = True, 
    ...
    def testPageDisplayCompanyWithSalesMetricsAuthenticatedEntity(self):
        """Test PageDisplayCompanyWithSalesMetricsAuthenticatedEntity"""
