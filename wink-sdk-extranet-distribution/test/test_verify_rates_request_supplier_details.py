...
class TestVerifyRatesRequestSupplierDetails(unittest.TestCase):
    """VerifyRatesRequestSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyRatesRequestSupplierDetails:
        """Test VerifyRatesRequestSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyRatesRequestSupplierDetails`
        """
        model = VerifyRatesRequestSupplierDetails()
        if include_optional:
            return VerifyRatesRequestSupplierDetails(
    ...
    def testVerifyRatesRequestSupplierDetails(self):
        """Test VerifyRatesRequestSupplierDetails"""
