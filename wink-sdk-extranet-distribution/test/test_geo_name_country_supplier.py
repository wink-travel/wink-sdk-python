...
class TestGeoNameCountrySupplier(unittest.TestCase):
    """GeoNameCountrySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameCountrySupplier:
        """Test GeoNameCountrySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameCountrySupplier`
        """
        model = GeoNameCountrySupplier()
        if include_optional:
            return GeoNameCountrySupplier(
                geo_name_id = '',
                continent_code = '',
                continent_name = '',
                country_iso_code = '',
    ...
    def testGeoNameCountrySupplier(self):
        """Test GeoNameCountrySupplier"""
