...
class TestAvailableDaysOfWeekRateQualifierSupplier(unittest.TestCase):
    """AvailableDaysOfWeekRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailableDaysOfWeekRateQualifierSupplier:
        """Test AvailableDaysOfWeekRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailableDaysOfWeekRateQualifierSupplier`
        """
        model = AvailableDaysOfWeekRateQualifierSupplier()
        if include_optional:
            return AvailableDaysOfWeekRateQualifierSupplier(
    ...
    def testAvailableDaysOfWeekRateQualifierSupplier(self):
        """Test AvailableDaysOfWeekRateQualifierSupplier"""
