...
class TestGeoIpLightweightSupplierDetails(unittest.TestCase):
    """GeoIpLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoIpLightweightSupplierDetails:
        """Test GeoIpLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoIpLightweightSupplierDetails`
        """
        model = GeoIpLightweightSupplierDetails()
        if include_optional:
            return GeoIpLightweightSupplierDetails(
                geo_name_id = '8798734',
                locale_code = 'en',
                continent_code = 'NA',
    ...
    def testGeoIpLightweightSupplierDetails(self):
        """Test GeoIpLightweightSupplierDetails"""
