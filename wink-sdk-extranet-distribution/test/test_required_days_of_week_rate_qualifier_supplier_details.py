...
class TestRequiredDaysOfWeekRateQualifierSupplierDetails(unittest.TestCase):
    """RequiredDaysOfWeekRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequiredDaysOfWeekRateQualifierSupplierDetails:
        """Test RequiredDaysOfWeekRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequiredDaysOfWeekRateQualifierSupplierDetails`
        """
        model = RequiredDaysOfWeekRateQualifierSupplierDetails()
        if include_optional:
            return RequiredDaysOfWeekRateQualifierSupplierDetails(
    ...
    def testRequiredDaysOfWeekRateQualifierSupplierDetails(self):
        """Test RequiredDaysOfWeekRateQualifierSupplierDetails"""
