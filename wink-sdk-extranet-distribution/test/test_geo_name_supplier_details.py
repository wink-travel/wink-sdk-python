...
class TestGeoNameSupplierDetails(unittest.TestCase):
    """GeoNameSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameSupplierDetails:
        """Test GeoNameSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameSupplierDetails`
        """
        model = GeoNameSupplierDetails()
        if include_optional:
            return GeoNameSupplierDetails(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
    ...
    def testGeoNameSupplierDetails(self):
        """Test GeoNameSupplierDetails"""
