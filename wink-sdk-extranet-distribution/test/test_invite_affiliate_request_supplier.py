...
class TestInviteAffiliateRequestSupplier(unittest.TestCase):
    """InviteAffiliateRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteAffiliateRequestSupplier:
        """Test InviteAffiliateRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteAffiliateRequestSupplier`
        """
        model = InviteAffiliateRequestSupplier()
        if include_optional:
            return InviteAffiliateRequestSupplier(
                hotel_email = '',
                affiliate_email = '',
                affiliate_name = ''
            )
    ...
    def testInviteAffiliateRequestSupplier(self):
        """Test InviteAffiliateRequestSupplier"""
