...
class TestRateSupplier(unittest.TestCase):
    """RateSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateSupplier:
        """Test RateSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateSupplier`
        """
        model = RateSupplier()
        if include_optional:
            return RateSupplier(
