...
class TestInventorySupplierDetails(unittest.TestCase):
    """InventorySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventorySupplierDetails:
        """Test InventorySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventorySupplierDetails`
        """
        model = InventorySupplierDetails()
        if include_optional:
    ...
    def testInventorySupplierDetails(self):
        """Test InventorySupplierDetails"""
