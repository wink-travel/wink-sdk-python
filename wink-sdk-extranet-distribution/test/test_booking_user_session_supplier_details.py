...
class TestBookingUserSessionSupplierDetails(unittest.TestCase):
    """BookingUserSessionSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserSessionSupplierDetails:
        """Test BookingUserSessionSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserSessionSupplierDetails`
        """
        model = BookingUserSessionSupplierDetails()
        if include_optional:
            return BookingUserSessionSupplierDetails(
                itinerary = wink_sdk_extranet_distribution.models.booking_itinerary_supplier_details.BookingItinerary_SupplierDetails(
                    start_date = 'Mon Jan 01 07:00:00 ICT 2024', 
                    end_date = 'Tue Jan 02 07:00:00 ICT 2024', 
                    nights = 56, 
                    items = [
                        wink_sdk_extranet_distribution.models.booking_itinerary_room_configuration_supplier_details.BookingItineraryRoomConfiguration_SupplierDetails(
                            adults = 2, 
                            children = [
                                wink_sdk_extranet_distribution.models.booking_itinerary_room_configuration_child_supplier_details.BookingItineraryRoomConfigurationChild_SupplierDetails(
                                    quantity = 56, 
                                    age = 56, )
                                ], )
                        ], 
    ...
    def testBookingUserSessionSupplierDetails(self):
        """Test BookingUserSessionSupplierDetails"""
