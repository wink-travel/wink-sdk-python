...
class TestPetInfoDtoSupplierDetails(unittest.TestCase):
    """PetInfoDtoSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoDtoSupplierDetails:
        """Test PetInfoDtoSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoDtoSupplierDetails`
        """
        model = PetInfoDtoSupplierDetails()
        if include_optional:
            return PetInfoDtoSupplierDetails(
                name = '',
                type = ''
            )
        else:
    ...
    def testPetInfoDtoSupplierDetails(self):
        """Test PetInfoDtoSupplierDetails"""
