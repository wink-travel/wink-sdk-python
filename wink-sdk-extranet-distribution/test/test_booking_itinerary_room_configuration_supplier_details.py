...
class TestBookingItineraryRoomConfigurationSupplierDetails(unittest.TestCase):
    """BookingItineraryRoomConfigurationSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingItineraryRoomConfigurationSupplierDetails:
        """Test BookingItineraryRoomConfigurationSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingItineraryRoomConfigurationSupplierDetails`
        """
        model = BookingItineraryRoomConfigurationSupplierDetails()
        if include_optional:
            return BookingItineraryRoomConfigurationSupplierDetails(
                adults = 2,
                children = [
    ...
    def testBookingItineraryRoomConfigurationSupplierDetails(self):
        """Test BookingItineraryRoomConfigurationSupplierDetails"""
