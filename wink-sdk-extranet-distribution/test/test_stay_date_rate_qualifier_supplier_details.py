...
class TestStayDateRateQualifierSupplierDetails(unittest.TestCase):
    """StayDateRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StayDateRateQualifierSupplierDetails:
        """Test StayDateRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StayDateRateQualifierSupplierDetails`
        """
        model = StayDateRateQualifierSupplierDetails()
        if include_optional:
            return StayDateRateQualifierSupplierDetails(
    ...
    def testStayDateRateQualifierSupplierDetails(self):
        """Test StayDateRateQualifierSupplierDetails"""
