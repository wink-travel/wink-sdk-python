...
class TestCreateScheduleItemRequestSupplier(unittest.TestCase):
    """CreateScheduleItemRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateScheduleItemRequestSupplier:
        """Test CreateScheduleItemRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateScheduleItemRequestSupplier`
        """
        model = CreateScheduleItemRequestSupplier()
        if include_optional:
            return CreateScheduleItemRequestSupplier(
    ...
    def testCreateScheduleItemRequestSupplier(self):
        """Test CreateScheduleItemRequestSupplier"""
