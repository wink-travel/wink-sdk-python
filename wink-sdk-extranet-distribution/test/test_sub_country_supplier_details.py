...
class TestSubCountrySupplierDetails(unittest.TestCase):
    """SubCountrySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountrySupplierDetails:
        """Test SubCountrySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountrySupplierDetails`
        """
        model = SubCountrySupplierDetails()
        if include_optional:
            return SubCountrySupplierDetails(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountrySupplierDetails(self):
        """Test SubCountrySupplierDetails"""
