...
class TestPageInventorySupplier(unittest.TestCase):
    """PageInventorySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageInventorySupplier:
        """Test PageInventorySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageInventorySupplier`
        """
        model = PageInventorySupplier()
        if include_optional:
            return PageInventorySupplier(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
                    wink_sdk_extranet_distribution.models.inventory_supplier.Inventory_Supplier(
                        identifier = '', 
    ...
    def testPageInventorySupplier(self):
        """Test PageInventorySupplier"""
