    ...
    def make_instance(self, include_optional) -> StateAuthenticatedEntity:
        ...
        if include_optional:
            return StateAuthenticatedEntity(
                ...
                take = 10,
                sort = [
                    wink_sdk_extranet_distribution.models.sort_descriptor_supplier.SortDescriptor_Supplier(
                        dir = 'asc', 
                        field = 'hotel.name', )
                    ],
                filter = wink_sdk_extranet_distribution.models.composite_filter_descriptor_supplier.CompositeFilterDescriptor_Supplier(
                    logic = 'and', 
                    filters = [
                        wink_sdk_extranet_distribution.models.filter_descriptor_supplier.FilterDescriptor_Supplier(
                            field = 'hotel.name', 
                            operator = 'startsWith', 
                            value = null, 
                            ignore_case = True, )
                ...
                group = [
                    wink_sdk_extranet_distribution.models.group_descriptor_supplier.GroupDescriptor_Supplier(
                        field = 'createdDate', 
                        dir = 'asc', 
                        aggregates = [
                            wink_sdk_extranet_distribution.models.aggregate_descriptor_supplier.AggregateDescriptor_Supplier(
