...
class TestDailyRateRateSupplierDetails(unittest.TestCase):
    """DailyRateRateSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DailyRateRateSupplierDetails:
        """Test DailyRateRateSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DailyRateRateSupplierDetails`
        """
        model = DailyRateRateSupplierDetails()
        if include_optional:
            return DailyRateRateSupplierDetails(
                ...
                extra_pax_rate_modifier = wink_sdk_extranet_distribution.models.variable_charge_supplier_details.VariableCharge_SupplierDetails(
                    ...
                    fixed_amount = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '', ), ),
                extra_child_rate_modifier = wink_sdk_extranet_distribution.models.variable_charge_supplier_details.VariableCharge_SupplierDetails(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
    ...
    def testDailyRateRateSupplierDetails(self):
        """Test DailyRateRateSupplierDetails"""
