...
class TestDepartureDaysOfWeekRateQualifierSupplierDetails(unittest.TestCase):
    """DepartureDaysOfWeekRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DepartureDaysOfWeekRateQualifierSupplierDetails:
        """Test DepartureDaysOfWeekRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DepartureDaysOfWeekRateQualifierSupplierDetails`
        """
        model = DepartureDaysOfWeekRateQualifierSupplierDetails()
        if include_optional:
            return DepartureDaysOfWeekRateQualifierSupplierDetails(
    ...
    def testDepartureDaysOfWeekRateQualifierSupplierDetails(self):
        """Test DepartureDaysOfWeekRateQualifierSupplierDetails"""
