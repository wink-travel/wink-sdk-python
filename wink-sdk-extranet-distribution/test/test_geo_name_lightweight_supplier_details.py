...
class TestGeoNameLightweightSupplierDetails(unittest.TestCase):
    """GeoNameLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameLightweightSupplierDetails:
        """Test GeoNameLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameLightweightSupplierDetails`
        """
        model = GeoNameLightweightSupplierDetails()
        if include_optional:
            return GeoNameLightweightSupplierDetails(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
    ...
    def testGeoNameLightweightSupplierDetails(self):
        """Test GeoNameLightweightSupplierDetails"""
