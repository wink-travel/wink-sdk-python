...
class TestSortObjectSupplier(unittest.TestCase):
    """SortObjectSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortObjectSupplier:
        """Test SortObjectSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortObjectSupplier`
        """
        model = SortObjectSupplier()
        if include_optional:
            return SortObjectSupplier(
                empty = True,
                sorted = True,
                unsorted = True
            )
    ...
    def testSortObjectSupplier(self):
        """Test SortObjectSupplier"""
