...
class TestAdvanceBookingRateQualifierSupplierDetails(unittest.TestCase):
    """AdvanceBookingRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvanceBookingRateQualifierSupplierDetails:
        """Test AdvanceBookingRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvanceBookingRateQualifierSupplierDetails`
        """
        model = AdvanceBookingRateQualifierSupplierDetails()
        if include_optional:
            return AdvanceBookingRateQualifierSupplierDetails(
    ...
    def testAdvanceBookingRateQualifierSupplierDetails(self):
        """Test AdvanceBookingRateQualifierSupplierDetails"""
