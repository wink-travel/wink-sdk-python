...
class TestUpsertSalesChannelRequestRequestSupplier(unittest.TestCase):
    """UpsertSalesChannelRequestRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSalesChannelRequestRequestSupplier:
        """Test UpsertSalesChannelRequestRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSalesChannelRequestRequestSupplier`
        """
        model = UpsertSalesChannelRequestRequestSupplier()
        if include_optional:
            return UpsertSalesChannelRequestRequestSupplier(
                request_type = 'DIRECT_CONNECTION',
                supplier_identifier = 'owner-1',
    ...
    def testUpsertSalesChannelRequestRequestSupplier(self):
        """Test UpsertSalesChannelRequestRequestSupplier"""
