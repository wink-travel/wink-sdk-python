...
class TestSalesChannelRelationshipRequestSupplier(unittest.TestCase):
    """SalesChannelRelationshipRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelRelationshipRequestSupplier:
        """Test SalesChannelRelationshipRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelRelationshipRequestSupplier`
        """
        model = SalesChannelRelationshipRequestSupplier()
        if include_optional:
            return SalesChannelRelationshipRequestSupplier(
                identifier = '',
                status = 'REQUESTING',
    ...
    def testSalesChannelRelationshipRequestSupplier(self):
        """Test SalesChannelRelationshipRequestSupplier"""
