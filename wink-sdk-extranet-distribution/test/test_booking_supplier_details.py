    ...
    def make_instance(self, include_optional) -> BookingSupplierDetails:
        ...
        if include_optional:
            return BookingSupplierDetails(
                ...
                group_identifier = '',
                identifier = '',
                engine_configuration = wink_sdk_extranet_distribution.models.engine_configuration_booking_report_supplier_details.EngineConfigurationBookingReport_SupplierDetails(
                    identifier = '', 
                ...
                user = wink_sdk_extranet_distribution.models.booking_user_supplier_details.BookingUser_SupplierDetails(
                    user_identifier = '', 
                    first_name = 'John', 
                    last_name = 'Smith', 
                ...
                user_session = wink_sdk_extranet_distribution.models.booking_user_session_supplier_details.BookingUserSession_SupplierDetails(
                ...
                server_url = '',
                contact_info = wink_sdk_extranet_distribution.models.contact_supplier_details.Contact_SupplierDetails(
                    first_name = 'John', 
                    last_name = 'Smith', 
                ...
                review = wink_sdk_extranet_distribution.models.review_supplier_details.Review_SupplierDetails(
                    identifier = '', 
                    booking_identifier = '', 
                    hotel_identifier = '', 
                ...
                hotel = wink_sdk_extranet_distribution.models.hotel_on_map_supplier_details.HotelOnMap_SupplierDetails(
                    ...
                    active = True, 
                    url_parameters = '', ),
                room_stay = wink_sdk_extranet_distribution.models.room_stay_supplier_details.RoomStay_SupplierDetails(
                    policy = wink_sdk_extranet_distribution.models.property_policy_supplier_details.PropertyPolicy_SupplierDetails(
                        children_allowed = True, 
                        children_minimum_age = 6, 
                        internet_availability = 'YES', 
                ...
                special_requests = '',
                comment = '',
                early_check_in_charge = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                late_check_out_charge = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                ...
                commission_list = [
                    wink_sdk_extranet_distribution.models.commissionable_entry_supplier_details.CommissionableEntry_SupplierDetails(
                        name = '', 
                        identifier = '', 
                        type = 'GUEST_ROOM', 
                ...
                ancillary_list = [
                    wink_sdk_extranet_distribution.models.booking_ancillary_supplier_details.BookingAncillary_SupplierDetails(
                        identifier = '', 
                        hotel_identifier = '', 
                        type_identifier = '', 
                ...
                booking_contract = wink_sdk_extranet_distribution.models.booking_contract_supplier_details.BookingContract_SupplierDetails(
                ...
                reporting_daily_rate_list = [
                    wink_sdk_extranet_distribution.models.reporting_daily_rate_supplier_details.ReportingDailyRate_SupplierDetails(
                        date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        base_amount = 1.337, 
                        gross_amount = 1.337, 
                        net_amount = 1.337, 
                ...
                reporting_ancillary_list = [
                    wink_sdk_extranet_distribution.models.reporting_ancillary_supplier_details.ReportingAncillary_SupplierDetails(
                        name = '', 
                        type = 'LODGING', 
                        gross_amount = 1.337, 
                        net_amount = 1.337, 
                ...
                reporting_extra_charge_list = [
                    wink_sdk_extranet_distribution.models.reporting_extra_charge_supplier_details.ReportingExtraCharge_SupplierDetails(
                        name = '', 
                        description = '', 
                        gross_amount = 1.337, 
                        net_amount = 1.337, 
