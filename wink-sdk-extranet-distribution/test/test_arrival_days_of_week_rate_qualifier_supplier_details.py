...
class TestArrivalDaysOfWeekRateQualifierSupplierDetails(unittest.TestCase):
    """ArrivalDaysOfWeekRateQualifierSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrivalDaysOfWeekRateQualifierSupplierDetails:
        """Test ArrivalDaysOfWeekRateQualifierSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrivalDaysOfWeekRateQualifierSupplierDetails`
        """
        model = ArrivalDaysOfWeekRateQualifierSupplierDetails()
        if include_optional:
            return ArrivalDaysOfWeekRateQualifierSupplierDetails(
    ...
    def testArrivalDaysOfWeekRateQualifierSupplierDetails(self):
        """Test ArrivalDaysOfWeekRateQualifierSupplierDetails"""
