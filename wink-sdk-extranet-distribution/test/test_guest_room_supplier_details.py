...
class TestGuestRoomSupplierDetails(unittest.TestCase):
    """GuestRoomSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomSupplierDetails:
        """Test GuestRoomSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomSupplierDetails`
        """
        model = GuestRoomSupplierDetails()
        if include_optional:
            return GuestRoomSupplierDetails(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testGuestRoomSupplierDetails(self):
        """Test GuestRoomSupplierDetails"""
