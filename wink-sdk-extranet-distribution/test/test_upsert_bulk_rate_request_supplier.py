...
class TestUpsertBulkRateRequestSupplier(unittest.TestCase):
    """UpsertBulkRateRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertBulkRateRequestSupplier:
        """Test UpsertBulkRateRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertBulkRateRequestSupplier`
        """
        model = UpsertBulkRateRequestSupplier()
        if include_optional:
            return UpsertBulkRateRequestSupplier(
                start_date = 'Mon Aug 24 07:00:00 ICT 2020',
                end_date = 'Wed Aug 26 07:00:00 ICT 2020',
    ...
    def testUpsertBulkRateRequestSupplier(self):
        """Test UpsertBulkRateRequestSupplier"""
