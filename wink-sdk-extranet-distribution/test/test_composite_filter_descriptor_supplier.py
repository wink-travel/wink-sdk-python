...
class TestCompositeFilterDescriptorSupplier(unittest.TestCase):
    """CompositeFilterDescriptorSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompositeFilterDescriptorSupplier:
        """Test CompositeFilterDescriptorSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompositeFilterDescriptorSupplier`
        """
        model = CompositeFilterDescriptorSupplier()
        if include_optional:
            return CompositeFilterDescriptorSupplier(
                logic = 'and',
                filters = [
    ...
    def testCompositeFilterDescriptorSupplier(self):
        """Test CompositeFilterDescriptorSupplier"""
