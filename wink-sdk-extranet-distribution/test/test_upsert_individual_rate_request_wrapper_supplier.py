...
class TestUpsertIndividualRateRequestWrapperSupplier(unittest.TestCase):
    """UpsertIndividualRateRequestWrapperSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertIndividualRateRequestWrapperSupplier:
        """Test UpsertIndividualRateRequestWrapperSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertIndividualRateRequestWrapperSupplier`
        """
        model = UpsertIndividualRateRequestWrapperSupplier()
        if include_optional:
            return UpsertIndividualRateRequestWrapperSupplier(
                key = wink_sdk_extranet_distribution.models.rate_key_supplier.RateKey_Supplier(
                    hotel_identifier = '', 
                    rate_plan_identifier = '', 
                    guest_room_identifier = '', 
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), ),
                value = wink_sdk_extranet_distribution.models.upsert_individual_rate_request_supplier.UpsertIndividualRateRequest_Supplier(
                    quantity = 56, 
                    delta_quantity = 56, 
                    master = True, 
    ...
    def testUpsertIndividualRateRequestWrapperSupplier(self):
        """Test UpsertIndividualRateRequestWrapperSupplier"""
