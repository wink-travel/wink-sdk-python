...
class TestSalesChannelRelationshipRequestsApi(unittest.TestCase):
    """SalesChannelRelationshipRequestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SalesChannelRelationshipRequestsApi()

    def tearDown(self) -> None:
        pass

    def test_create_sales_channel_request(self) -> None:
        """Test case for create_sales_channel_request

        Create Sales Channel Request
        """
        pass

    def test_remove_sales_channel_request(self) -> None:
        """Test case for remove_sales_channel_request

        Reject Sales Channel Request
        """
        pass

    def test_show_sales_channel_requests(self) -> None:
        """Test case for show_sales_channel_requests
