...
class TestGroupedBookingSalesMetricsSupplier(unittest.TestCase):
    """GroupedBookingSalesMetricsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupedBookingSalesMetricsSupplier:
        """Test GroupedBookingSalesMetricsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupedBookingSalesMetricsSupplier`
        """
        model = GroupedBookingSalesMetricsSupplier()
        if include_optional:
            return GroupedBookingSalesMetricsSupplier(
                type = 'BY_TOTAL',
                type_name = '',
                type_identifier = '',
                bookings = 56,
    ...
    def testGroupedBookingSalesMetricsSupplier(self):
        """Test GroupedBookingSalesMetricsSupplier"""
