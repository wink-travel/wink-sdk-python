...
class TestInviteAffiliateRequestAuthenticatedEntity(unittest.TestCase):
    """InviteAffiliateRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteAffiliateRequestAuthenticatedEntity:
        """Test InviteAffiliateRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteAffiliateRequestAuthenticatedEntity`
        """
        model = InviteAffiliateRequestAuthenticatedEntity()
        if include_optional:
            return InviteAffiliateRequestAuthenticatedEntity(
                hotel_email = '0',
                affiliate_email = '0',
                affiliate_name = '0'
            )
    ...
    def testInviteAffiliateRequestAuthenticatedEntity(self):
        """Test InviteAffiliateRequestAuthenticatedEntity"""
