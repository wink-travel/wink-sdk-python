...
class TestBlackoutDateSupplierDetails(unittest.TestCase):
    """BlackoutDateSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlackoutDateSupplierDetails:
        """Test BlackoutDateSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlackoutDateSupplierDetails`
        """
        model = BlackoutDateSupplierDetails()
        if include_optional:
            return BlackoutDateSupplierDetails(
    ...
    def testBlackoutDateSupplierDetails(self):
        """Test BlackoutDateSupplierDetails"""
