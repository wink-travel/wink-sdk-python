...
class TestSalesChannelCreateRequestSupplier(unittest.TestCase):
    """SalesChannelCreateRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelCreateRequestSupplier:
        """Test SalesChannelCreateRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelCreateRequestSupplier`
        """
        model = SalesChannelCreateRequestSupplier()
        if include_optional:
            return SalesChannelCreateRequestSupplier(
                owner_identifier = '',
                supplier_identifier = ''
            )
        else:
    ...
    def testSalesChannelCreateRequestSupplier(self):
        """Test SalesChannelCreateRequestSupplier"""
