...
class TestExtraChargeSupplierDetails(unittest.TestCase):
    """ExtraChargeSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargeSupplierDetails:
        """Test ExtraChargeSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargeSupplierDetails`
        """
        model = ExtraChargeSupplierDetails()
        if include_optional:
            return ExtraChargeSupplierDetails(
    ...
    def testExtraChargeSupplierDetails(self):
        """Test ExtraChargeSupplierDetails"""
