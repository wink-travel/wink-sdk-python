...
class TestAuthenticatedUserSupplierDetails(unittest.TestCase):
    """AuthenticatedUserSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticatedUserSupplierDetails:
        """Test AuthenticatedUserSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticatedUserSupplierDetails`
        """
        model = AuthenticatedUserSupplierDetails()
        if include_optional:
            return AuthenticatedUserSupplierDetails(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testAuthenticatedUserSupplierDetails(self):
        """Test AuthenticatedUserSupplierDetails"""
