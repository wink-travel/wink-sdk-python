...
class TestBeneficiaryChargeSupplierDetails(unittest.TestCase):
    """BeneficiaryChargeSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryChargeSupplierDetails:
        """Test BeneficiaryChargeSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryChargeSupplierDetails`
        """
        model = BeneficiaryChargeSupplierDetails()
        if include_optional:
            return BeneficiaryChargeSupplierDetails(
                type = 'PERCENTAGE',
                percent = 1.337
            )
        else:
    ...
    def testBeneficiaryChargeSupplierDetails(self):
        """Test BeneficiaryChargeSupplierDetails"""
