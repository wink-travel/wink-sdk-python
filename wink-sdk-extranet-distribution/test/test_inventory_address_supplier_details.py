...
class TestInventoryAddressSupplierDetails(unittest.TestCase):
    """InventoryAddressSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryAddressSupplierDetails:
        """Test InventoryAddressSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryAddressSupplierDetails`
        """
        model = InventoryAddressSupplierDetails()
        if include_optional:
            return InventoryAddressSupplierDetails(
                address1 = '234',
    ...
    def testInventoryAddressSupplierDetails(self):
        """Test InventoryAddressSupplierDetails"""
