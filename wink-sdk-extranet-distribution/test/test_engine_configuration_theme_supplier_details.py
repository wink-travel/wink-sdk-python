...
class TestEngineConfigurationThemeSupplierDetails(unittest.TestCase):
    """EngineConfigurationThemeSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeSupplierDetails:
        """Test EngineConfigurationThemeSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeSupplierDetails`
        """
        model = EngineConfigurationThemeSupplierDetails()
        if include_optional:
            return EngineConfigurationThemeSupplierDetails(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeSupplierDetails(self):
        """Test EngineConfigurationThemeSupplierDetails"""
