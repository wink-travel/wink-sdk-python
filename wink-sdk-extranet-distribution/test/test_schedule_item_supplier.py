...
class TestScheduleItemSupplier(unittest.TestCase):
    """ScheduleItemSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleItemSupplier:
        """Test ScheduleItemSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleItemSupplier`
        """
        model = ScheduleItemSupplier()
        if include_optional:
            return ScheduleItemSupplier(
                identifier = '',
    ...
    def testScheduleItemSupplier(self):
        """Test ScheduleItemSupplier"""
