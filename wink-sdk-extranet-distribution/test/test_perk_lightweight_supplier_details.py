...
class TestPerkLightweightSupplierDetails(unittest.TestCase):
    """PerkLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerkLightweightSupplierDetails:
        """Test PerkLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerkLightweightSupplierDetails`
        """
        model = PerkLightweightSupplierDetails()
        if include_optional:
            return PerkLightweightSupplierDetails(
                identifier = '',
                guaranteed = True,
                level = 56,
                descriptions = [
    ...
    def testPerkLightweightSupplierDetails(self):
        """Test PerkLightweightSupplierDetails"""
