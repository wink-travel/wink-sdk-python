...
class TestSalesChannelRelationshipRequestViewSupplier(unittest.TestCase):
    """SalesChannelRelationshipRequestViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelRelationshipRequestViewSupplier:
        """Test SalesChannelRelationshipRequestViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelRelationshipRequestViewSupplier`
        """
        model = SalesChannelRelationshipRequestViewSupplier()
        if include_optional:
            return SalesChannelRelationshipRequestViewSupplier(
                id = 'doc-1',
                created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                version = 12,
                user = wink_sdk_extranet_distribution.models.sales_channel_relationship_request_supplier.SalesChannelRelationshipRequest_Supplier(
                    identifier = '', 
                    status = 'REQUESTING', 
                ...
                request = wink_sdk_extranet_distribution.models.sales_channel_relationship_request_supplier.SalesChannelRelationshipRequest_Supplier(
                    identifier = '', 
                    status = 'REQUESTING', 
                    request_type = 'DIRECT_CONNECTION', 
                    supplier_identifier = '', 
    ...
    def testSalesChannelRelationshipRequestViewSupplier(self):
        """Test SalesChannelRelationshipRequestViewSupplier"""
