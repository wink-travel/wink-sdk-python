...
class TestBookingItineraryRoomConfigurationChildSupplierDetails(unittest.TestCase):
    """BookingItineraryRoomConfigurationChildSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingItineraryRoomConfigurationChildSupplierDetails:
        """Test BookingItineraryRoomConfigurationChildSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingItineraryRoomConfigurationChildSupplierDetails`
        """
        model = BookingItineraryRoomConfigurationChildSupplierDetails()
        if include_optional:
            return BookingItineraryRoomConfigurationChildSupplierDetails(
                quantity = 56,
                age = 56
            )
        else:
    ...
    def testBookingItineraryRoomConfigurationChildSupplierDetails(self):
        """Test BookingItineraryRoomConfigurationChildSupplierDetails"""
