...
class TestUpsertSalesChannelRelationshipRequestRequestSupplier(unittest.TestCase):
    """UpsertSalesChannelRelationshipRequestRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSalesChannelRelationshipRequestRequestSupplier:
        """Test UpsertSalesChannelRelationshipRequestRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSalesChannelRelationshipRequestRequestSupplier`
        """
        model = UpsertSalesChannelRelationshipRequestRequestSupplier()
        if include_optional:
            return UpsertSalesChannelRelationshipRequestRequestSupplier(
    ...
    def testUpsertSalesChannelRelationshipRequestRequestSupplier(self):
        """Test UpsertSalesChannelRelationshipRequestRequestSupplier"""
