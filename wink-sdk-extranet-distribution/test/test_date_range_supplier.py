...
class TestDateRangeSupplier(unittest.TestCase):
    """DateRangeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DateRangeSupplier:
        """Test DateRangeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DateRangeSupplier`
        """
        model = DateRangeSupplier()
        if include_optional:
            return DateRangeSupplier(
                start_date = 'Thu Dec 24 07:00:00 ICT 2020',
                end_date = 'Thu Dec 31 07:00:00 ICT 2020'
            )
        else:
            return DateRangeSupplier(
                start_date = 'Thu Dec 24 07:00:00 ICT 2020',
    ...
    def testDateRangeSupplier(self):
        """Test DateRangeSupplier"""
