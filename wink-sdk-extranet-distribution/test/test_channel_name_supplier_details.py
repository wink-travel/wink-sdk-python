...
class TestChannelNameSupplierDetails(unittest.TestCase):
    """ChannelNameSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelNameSupplierDetails:
        """Test ChannelNameSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelNameSupplierDetails`
        """
        model = ChannelNameSupplierDetails()
        if include_optional:
            return ChannelNameSupplierDetails(
                sub_type = 'DIRECT',
                owner_identifier = '',
                name = ''
            )
    ...
    def testChannelNameSupplierDetails(self):
        """Test ChannelNameSupplierDetails"""
