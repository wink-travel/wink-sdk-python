...
class TestGeoNameCountrySupplierDetails(unittest.TestCase):
    """GeoNameCountrySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameCountrySupplierDetails:
        """Test GeoNameCountrySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameCountrySupplierDetails`
        """
        model = GeoNameCountrySupplierDetails()
        if include_optional:
            return GeoNameCountrySupplierDetails(
                geo_name_id = '',
                continent_code = '',
                continent_name = '',
                country_iso_code = '',
    ...
    def testGeoNameCountrySupplierDetails(self):
        """Test GeoNameCountrySupplierDetails"""
