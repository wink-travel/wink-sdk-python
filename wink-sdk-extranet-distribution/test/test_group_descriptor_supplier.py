...
class TestGroupDescriptorSupplier(unittest.TestCase):
    """GroupDescriptorSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupDescriptorSupplier:
        """Test GroupDescriptorSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupDescriptorSupplier`
        """
        model = GroupDescriptorSupplier()
        if include_optional:
            return GroupDescriptorSupplier(
    ...
    def testGroupDescriptorSupplier(self):
        """Test GroupDescriptorSupplier"""
