...
class TestPageDisplayCompanyWithSalesMetricsSupplier(unittest.TestCase):
    """PageDisplayCompanyWithSalesMetricsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageDisplayCompanyWithSalesMetricsSupplier:
        """Test PageDisplayCompanyWithSalesMetricsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageDisplayCompanyWithSalesMetricsSupplier`
        """
        model = PageDisplayCompanyWithSalesMetricsSupplier()
        if include_optional:
            return PageDisplayCompanyWithSalesMetricsSupplier(
                ...
                size = 56,
                content = [
                    wink_sdk_extranet_distribution.models.display_company_with_sales_metrics_supplier.DisplayCompanyWithSalesMetrics_Supplier(
                        owner_identifier = '', 
                        type = 'DIRECT', 
                        owner_name = '', 
                        continent = '', 
    ...
    def testPageDisplayCompanyWithSalesMetricsSupplier(self):
        """Test PageDisplayCompanyWithSalesMetricsSupplier"""
