...
class TestBrowseAffiliateAccountAuthenticatedEntity(unittest.TestCase):
    """BrowseAffiliateAccountAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrowseAffiliateAccountAuthenticatedEntity:
        """Test BrowseAffiliateAccountAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrowseAffiliateAccountAuthenticatedEntity`
        """
        model = BrowseAffiliateAccountAuthenticatedEntity()
        if include_optional:
            return BrowseAffiliateAccountAuthenticatedEntity(
                identifier = '',
                ...
                country = wink_sdk_extranet_distribution.models.key_value_pair_authenticated_entity.KeyValuePair_Authenticated_Entity(
                    value = 'id-1', 
                    label = 'Readable text label', ),
                continent = wink_sdk_extranet_distribution.models.key_value_pair_authenticated_entity.KeyValuePair_Authenticated_Entity(
                    value = 'id-1', 
                    label = 'Readable text label', ),
                name = '0',
                owner_name = '0',
    ...
    def testBrowseAffiliateAccountAuthenticatedEntity(self):
        """Test BrowseAffiliateAccountAuthenticatedEntity"""
