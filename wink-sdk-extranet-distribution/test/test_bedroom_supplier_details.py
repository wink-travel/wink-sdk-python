...
class TestBedroomSupplierDetails(unittest.TestCase):
    """BedroomSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomSupplierDetails:
        """Test BedroomSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomSupplierDetails`
        """
        model = BedroomSupplierDetails()
        if include_optional:
            return BedroomSupplierDetails(
                type = 'MASTER',
                bed_list = [
    ...
    def testBedroomSupplierDetails(self):
        """Test BedroomSupplierDetails"""
