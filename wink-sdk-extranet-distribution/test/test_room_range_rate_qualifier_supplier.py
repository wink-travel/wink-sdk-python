...
class TestRoomRangeRateQualifierSupplier(unittest.TestCase):
    """RoomRangeRateQualifierSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomRangeRateQualifierSupplier:
        """Test RoomRangeRateQualifierSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomRangeRateQualifierSupplier`
        """
        model = RoomRangeRateQualifierSupplier()
        if include_optional:
            return RoomRangeRateQualifierSupplier(
                min_rooms = 1,
                max_rooms = 56
            )
        else:
    ...
    def testRoomRangeRateQualifierSupplier(self):
        """Test RoomRangeRateQualifierSupplier"""
