...
class TestBookingAncillarySupplierDetails(unittest.TestCase):
    """BookingAncillarySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingAncillarySupplierDetails:
        """Test BookingAncillarySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingAncillarySupplierDetails`
        """
        model = BookingAncillarySupplierDetails()
        if include_optional:
            return BookingAncillarySupplierDetails(
                identifier = '',
                hotel_identifier = '',
                type_identifier = '',
    ...
    def testBookingAncillarySupplierDetails(self):
        """Test BookingAncillarySupplierDetails"""
