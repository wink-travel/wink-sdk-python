...
class TestVariableChargeSupplierDetails(unittest.TestCase):
    """VariableChargeSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariableChargeSupplierDetails:
        """Test VariableChargeSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariableChargeSupplierDetails`
        """
        model = VariableChargeSupplierDetails()
        if include_optional:
            return VariableChargeSupplierDetails(
                type = 'FIXED',
                percent = 0.25,
    ...
    def testVariableChargeSupplierDetails(self):
        """Test VariableChargeSupplierDetails"""
