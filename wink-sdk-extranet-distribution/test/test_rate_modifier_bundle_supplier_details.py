...
class TestRateModifierBundleSupplierDetails(unittest.TestCase):
    """RateModifierBundleSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateModifierBundleSupplierDetails:
        """Test RateModifierBundleSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateModifierBundleSupplierDetails`
        """
        model = RateModifierBundleSupplierDetails()
        if include_optional:
            return RateModifierBundleSupplierDetails(
                identifier = '',
                hotel_identifier = '',
                ...
                modifier_override = wink_sdk_extranet_distribution.models.variable_charge_supplier_details.VariableCharge_SupplierDetails(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_distribution.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
    ...
    def testRateModifierBundleSupplierDetails(self):
        """Test RateModifierBundleSupplierDetails"""
