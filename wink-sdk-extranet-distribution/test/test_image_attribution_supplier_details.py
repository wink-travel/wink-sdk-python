...
class TestImageAttributionSupplierDetails(unittest.TestCase):
    """ImageAttributionSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageAttributionSupplierDetails:
        """Test ImageAttributionSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAttributionSupplierDetails`
        """
        model = ImageAttributionSupplierDetails()
        if include_optional:
            return ImageAttributionSupplierDetails(
    ...
    def testImageAttributionSupplierDetails(self):
        """Test ImageAttributionSupplierDetails"""
