...
class TestContactSupplierDetails(unittest.TestCase):
    """ContactSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactSupplierDetails:
        """Test ContactSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactSupplierDetails`
        """
        model = ContactSupplierDetails()
        if include_optional:
            return ContactSupplierDetails(
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testContactSupplierDetails(self):
        """Test ContactSupplierDetails"""
