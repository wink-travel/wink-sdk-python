...
class TestBookingTestNotificationSupplierDetails(unittest.TestCase):
    """BookingTestNotificationSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingTestNotificationSupplierDetails:
        """Test BookingTestNotificationSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingTestNotificationSupplierDetails`
        """
        model = BookingTestNotificationSupplierDetails()
        if include_optional:
            return BookingTestNotificationSupplierDetails(
    ...
    def testBookingTestNotificationSupplierDetails(self):
        """Test BookingTestNotificationSupplierDetails"""
