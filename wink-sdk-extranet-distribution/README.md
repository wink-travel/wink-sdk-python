...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.60#egg=wink_sdk_extranet_distribution&subdirectory=wink-sdk-extranet-distribution
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.60#egg=wink_sdk_extranet_distribution&subdirectory=wink_sdk_extranet_distribution`)
...
*AffiliateApi* | [**show_affiliate**](docs/AffiliateApi.md#show_affiliate) | **GET** /api/property/{propertyIdentifier}/sales/affiliate/{affiliateAccountIdentifier} | Show Affiliate
...
*SalesChannelRequestApi* | [**create_sales_channel_request**](docs/SalesChannelRequestApi.md#create_sales_channel_request) | **POST** /api/property/{propertyIdentifier}/sales-channel/request | Create Sales Channel Request
*SalesChannelRequestApi* | [**remove_sales_channel_request**](docs/SalesChannelRequestApi.md#remove_sales_channel_request) | **DELETE** /api/property/{propertyIdentifier}/sales-channel/request/{salesChannelRequestIdentifier} | Reject Sales Channel Request
*SalesChannelRequestApi* | [**show_sales_channel_requests**](docs/SalesChannelRequestApi.md#show_sales_channel_requests) | **GET** /api/property/{propertyIdentifier}/sales-channel/request/list | Show Sales Channel Requests
...
## Documentation For Models
 ...
 - [BrowseAffiliateAccountAuthenticatedEntity](docs/BrowseAffiliateAccountAuthenticatedEntity.md)
 - [CityRateQualifierSupplier](docs/CityRateQualifierSupplier.md)
 - [CompanyDetailsBookingSalesMetricsAuthenticatedEntity](docs/CompanyDetailsBookingSalesMetricsAuthenticatedEntity.md)
 ...
 - [DisplayCompanyWithSalesMetricsAuthenticatedEntity](docs/DisplayCompanyWithSalesMetricsAuthenticatedEntity.md)
 ...
 - [GroupedBookingSalesMetricsAuthenticatedEntity](docs/GroupedBookingSalesMetricsAuthenticatedEntity.md)
 ...
 - [InviteAffiliateRequestAuthenticatedEntity](docs/InviteAffiliateRequestAuthenticatedEntity.md)
 ...
 - [PageDisplayCompanyWithSalesMetricsAuthenticatedEntity](docs/PageDisplayCompanyWithSalesMetricsAuthenticatedEntity.md)
 - [PageInventorySupplier](docs/PageInventorySupplier.md)
 ...
 - [SalesChannelLightweightSupplier](docs/SalesChannelLightweightSupplier.md)
 - [SalesChannelRequestSupplier](docs/SalesChannelRequestSupplier.md)
 ...
 - [SpecialRateBundleLightweightSupplier](docs/SpecialRateBundleLightweightSupplier.md)
 ...
 - [UpsertSalesChannelRequestRequestSupplier](docs/UpsertSalesChannelRequestRequestSupplier.md)
