...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.55#egg=wink_sdk_extranet_distribution&subdirectory=wink-sdk-extranet-distribution
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.55#egg=wink_sdk_extranet_distribution&subdirectory=wink_sdk_extranet_distribution`)
