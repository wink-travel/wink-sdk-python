...
**engine_configuration** | [**EngineConfigurationBookingReportSupplierDetails**](EngineConfigurationBookingReportSupplierDetails.md) |  | 
**booking_code** | **str** | Unique user-friendly booking geoname. This code should be used when corresponding with travelers. | 
**user** | [**BookingUserSupplierDetails**](BookingUserSupplierDetails.md) |  | 
**user_session** | [**BookingUserSessionSupplierDetails**](BookingUserSessionSupplierDetails.md) |  | 
**server_url** | **str** | The URL the booking occurred | 
**contact_info** | [**ContactSupplierDetails**](ContactSupplierDetails.md) |  | 
...
**review** | [**ReviewSupplierDetails**](ReviewSupplierDetails.md) |  | [optional] 
...
**room_stay** | [**RoomStaySupplierDetails**](RoomStaySupplierDetails.md) |  | [optional] 
...
**booking_contract** | [**BookingContractSupplierDetails**](BookingContractSupplierDetails.md) |  | [optional] 
...
**reporting_daily_rate_list** | [**List[ReportingDailyRateSupplierDetails]**](ReportingDailyRateSupplierDetails.md) |  | [optional] 
**reporting_ancillary_list** | [**List[ReportingAncillarySupplierDetails]**](ReportingAncillarySupplierDetails.md) |  | [optional] 
**reporting_extra_charge_list** | [**List[ReportingExtraChargeSupplierDetails]**](ReportingExtraChargeSupplierDetails.md) |  | [optional] 
