...
**location** | [**GeoJsonPointSupplierDetails**](GeoJsonPointSupplierDetails.md) | Geo-location point where inventory takes place. Defaults to location of property. | 
...
**contact** | [**ContactSupplierDetails**](ContactSupplierDetails.md) | Associate a contact person for this inventory (if applicable). | 
