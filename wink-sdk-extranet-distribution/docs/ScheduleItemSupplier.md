...
**owner_identifier** | **UUID** | The unique identifier of the travel inventory you are creating a scheduled event for. | [optional] 
**booking_identifier** | **UUID** | Booking identifier this scheduled event was created as part of. | [optional] 
**booking_owner_identifier** | **UUID** | Which company owns this schedule. (Owner of the customization) | [optional] 
**hotel_identifier** | **UUID** | Hotel identifier that owns the travel inventory. | [optional] 
