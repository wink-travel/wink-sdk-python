...
**bedroom_configuration_list** | [**List[BedroomConfigurationSupplierDetails]**](BedroomConfigurationSupplierDetails.md) | A room type can have more than one bed configuration. | 
...
guest_room_lightweight_supplier_details_instance = GuestRoomLightweightSupplierDetails.from_json(json)
# print the JSON string representation of the object
print(GuestRoomLightweightSupplierDetails.to_json())

# convert the object into a dict
guest_room_lightweight_supplier_details_dict = guest_room_lightweight_supplier_details_instance.to_dict()
# create an instance of GuestRoomLightweightSupplierDetails from a dict
guest_room_lightweight_supplier_details_from_dict = GuestRoomLightweightSupplierDetails.from_dict(guest_room_lightweight_supplier_details_dict)
```
