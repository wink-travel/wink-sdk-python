...
**location** | [**GeoJsonPointSupplierDetails**](GeoJsonPointSupplierDetails.md) | Geo-location | [optional] 
**descriptions** | [**List[SimpleDescriptionSupplierDetails]**](SimpleDescriptionSupplierDetails.md) | Short and long welcome text | [optional] 
...
**reservations** | [**ContactSupplierDetails**](ContactSupplierDetails.md) | Contact details for reservations desk | [optional] 
**socials** | [**List[SocialSupplierDetails]**](SocialSupplierDetails.md) | Property&#39;s social network accounts | [optional] 
**images** | [**List[SimpleMultimediaSupplierDetails]**](SimpleMultimediaSupplierDetails.md) | Property images. | [optional] 
**videos** | [**List[SimpleMultimediaSupplierDetails]**](SimpleMultimediaSupplierDetails.md) | Property videos. | [optional] 
**policy** | [**PropertyPolicySupplierDetails**](PropertyPolicySupplierDetails.md) | Basic property policy record. | [optional] 
**third_party_reviews** | [**List[TravelInventoryRecognitionSupplierDetails]**](TravelInventoryRecognitionSupplierDetails.md) | Array of awards and third party reviews given to property by certified / non-certified providers. | [optional] 
...
**general_manager** | [**GeneralManagerSupplierDetails**](GeneralManagerSupplierDetails.md) |  | [optional] 
...
**address** | [**SimpleAddressSupplierDetails**](SimpleAddressSupplierDetails.md) | Property address. | [optional] 
...
json = "{}"
# create an instance of PropertyAggregateLightweightSupplierDetails from a JSON string
property_aggregate_lightweight_supplier_details_instance = PropertyAggregateLightweightSupplierDetails.from_json(json)
# print the JSON string representation of the object
print(PropertyAggregateLightweightSupplierDetails.to_json())

# convert the object into a dict
property_aggregate_lightweight_supplier_details_dict = property_aggregate_lightweight_supplier_details_instance.to_dict()
# create an instance of PropertyAggregateLightweightSupplierDetails from a dict
property_aggregate_lightweight_supplier_details_from_dict = PropertyAggregateLightweightSupplierDetails.from_dict(property_aggregate_lightweight_supplier_details_dict)
```
