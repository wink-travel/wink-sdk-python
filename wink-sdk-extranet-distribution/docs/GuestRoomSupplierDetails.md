...
guest_room_supplier_details_instance = GuestRoomSupplierDetails.from_json(json)
# print the JSON string representation of the object
print(GuestRoomSupplierDetails.to_json())

# convert the object into a dict
guest_room_supplier_details_dict = guest_room_supplier_details_instance.to_dict()
# create an instance of GuestRoomSupplierDetails from a dict
guest_room_supplier_details_from_dict = GuestRoomSupplierDetails.from_dict(guest_room_supplier_details_dict)
```
