...
**logos** | [**List[SimpleMultimediaSupplierDetails]**](SimpleMultimediaSupplierDetails.md) | Customize booking confirmation emails by adding a custom logo to your configuration. | [optional] 
...
**theme_colors** | [**CustomizationThemeColorsSupplierDetails**](CustomizationThemeColorsSupplierDetails.md) | Choose how you want our web components to look and more closely match with your own site style. | [optional] 
...
**room_configurations** | [**List[RoomConfigurationSupplierDetails]**](RoomConfigurationSupplierDetails.md) | Control how many adults / children will be staying and how many rooms. Defaults to: One room, two adults. | [optional] 
...
**city** | [**GeoNameLightweightSupplierDetails**](GeoNameLightweightSupplierDetails.md) |  | [optional] 
...
json = "{}"
# create an instance of CustomizationLightweightSupplierDetails from a JSON string
customization_lightweight_supplier_details_instance = CustomizationLightweightSupplierDetails.from_json(json)
# print the JSON string representation of the object
print(CustomizationLightweightSupplierDetails.to_json())

# convert the object into a dict
customization_lightweight_supplier_details_dict = customization_lightweight_supplier_details_instance.to_dict()
# create an instance of CustomizationLightweightSupplierDetails from a dict
customization_lightweight_supplier_details_from_dict = CustomizationLightweightSupplierDetails.from_dict(customization_lightweight_supplier_details_dict)
```
