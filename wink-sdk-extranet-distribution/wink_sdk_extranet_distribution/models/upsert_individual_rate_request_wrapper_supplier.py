...
class UpsertIndividualRateRequestWrapperSupplier(BaseModel):
    """
    UpsertIndividualRateRequestWrapperSupplier
    """ # noqa: E501
    key: RateKeySupplier
    value: UpsertIndividualRateRequestSupplier
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": RateKeySupplier.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "value": UpsertIndividualRateRequestSupplier.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
