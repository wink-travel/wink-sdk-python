...
class SpecialRateBundleLightweightSupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identifier", "hotelIdentifier", "name", "enabled", "items", "modifierOverride", "type", "pricingType", "isValid", "description", "hasPercentDiscountModifier", "hasFixedDiscountModifier"]
