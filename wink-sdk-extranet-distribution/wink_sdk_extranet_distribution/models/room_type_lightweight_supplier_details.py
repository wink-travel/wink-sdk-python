...
class RoomTypeLightweightSupplierDetails(BaseModel):
    """
    RoomTypeLightweightSupplierDetails
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Room type ID")
    ...
    lifestyle_type: Optional[StrictStr] = Field(default=None, description="Indicate the type of lifestyle this inventory should be associated with.", alias="lifestyleType")
    location: GeoJsonPointSupplierDetails = Field(description="Geo-location point where inventory takes place. Defaults to location of property.")
    descriptions: Annotated[List[SimpleDescriptionSupplierDetails], Field(min_length=1)]
    multimedias: Annotated[List[SimpleMultimediaSupplierDetails], Field(min_length=1)]
    contact: ContactSupplierDetails = Field(description="Associate a contact person for this inventory (if applicable).")
    address: AddressSupplierDetails = Field(description="Defaults to property address.")
    commissionable: StrictBool = Field(description="Indicate whether sales channels receive commission for selling this inventory.")
    ...
    sort: Optional[StrictInt] = Field(default=None, description="Use this property to sort an inventory in a list of activities.")
    ...
    bookable: StrictBool = Field(description="Indicates if this inventory can be added to a booking or if it is read-only marketing material only.")
    active: StrictBool = Field(description="Modify inventory availability with this flag.")
    ...
    socials: Optional[List[SocialSupplierDetails]] = None
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    recognition_list: Optional[List[TravelInventoryRecognitionSupplierDetails]] = Field(default=None, alias="recognitionList")
    transactional_inventory_list: Optional[List[TransactionalTravelInventorySupplierDetails]] = Field(default=None, alias="transactionalInventoryList")
    ...
    bedroom_configuration_list: Annotated[List[BedroomConfigurationSupplierDetails], Field(min_length=1)] = Field(alias="bedroomConfigurationList")
    ...
    base_rate: CustomMonetaryAmount = Field(description="Typical one night rate during regular remand period", alias="baseRate")
    min_rate: CustomMonetaryAmount = Field(description="Typical one night rate in a distressed period", alias="minRate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "descriptions": [SimpleDescriptionSupplierDetails.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None,
            "multimedias": [SimpleMultimediaSupplierDetails.from_dict(_item) for _item in obj["multimedias"]] if obj.get("multimedias") is not None else None,
            "contact": ContactSupplierDetails.from_dict(obj["contact"]) if obj.get("contact") is not None else None,
            ...
            "recognitionList": [TravelInventoryRecognitionSupplierDetails.from_dict(_item) for _item in obj["recognitionList"]] if obj.get("recognitionList") is not None else None,
            "transactionalInventoryList": [TransactionalTravelInventorySupplierDetails.from_dict(_item) for _item in obj["transactionalInventoryList"]] if obj.get("transactionalInventoryList") is not None else None,
            ...
            "bedroomConfigurationList": [BedroomConfigurationSupplierDetails.from_dict(_item) for _item in obj["bedroomConfigurationList"]] if obj.get("bedroomConfigurationList") is not None else None,
            "size": obj.get("size"),
