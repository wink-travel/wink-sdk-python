...
class DisplayCompanyWithSalesMetricsSupplier(BaseModel):
    """
    DisplayCompanyWithSalesMetricsSupplier
    """ # noqa: E501
    owner_identifier: Optional[StrictStr] = Field(default=None, description="The company ID.", alias="ownerIdentifier")
    type: Optional[StrictStr] = Field(default=None, description="The company type")
    owner_name: Optional[StrictStr] = Field(default=None, description="The company name", alias="ownerName")
    url_name: Optional[StrictStr] = Field(default=None, description="The company url slug", alias="urlName")
    continent: Optional[StrictStr] = Field(default=None, description="The company continent")
    country: Optional[StrictStr] = Field(default=None, description="The company country")
    country_geo_name_id: Optional[StrictStr] = Field(default=None, description="The company country geo name ID", alias="countryGeoNameId")
    city: Optional[StrictStr] = Field(default=None, description="The company city")
    city_geo_name_id: Optional[StrictStr] = Field(default=None, description="The company city geo name ID", alias="cityGeoNameId")
    owner_image_id: Optional[StrictStr] = Field(default=None, description="The company image ID", alias="ownerImageId")
    description: Optional[StrictStr] = None
    online_presence: Optional[List[OnlinePresenceSupplier]] = Field(default=None, alias="onlinePresence")
    annual_travel_spend_in_dollars: Optional[CustomMonetaryAmount] = Field(default=None, alias="annualTravelSpendInDollars")
    bookings: Optional[StrictInt] = None
    total_price_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPriceAmount")
    average_booking_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="averageBookingAmount")
    currency_code: Optional[StrictStr] = Field(default=None, alias="currencyCode")
    __properties: ClassVar[List[str]] = ["ownerIdentifier", "type", "ownerName", "urlName", "continent", "country", "countryGeoNameId", "city", "cityGeoNameId", "ownerImageId", "description", "onlinePresence", "annualTravelSpendInDollars", "bookings", "totalPriceAmount", "averageBookingAmount", "currencyCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ownerImageId": obj.get("ownerImageId"),
            "description": obj.get("description"),
            "onlinePresence": [OnlinePresenceSupplier.from_dict(_item) for _item in obj["onlinePresence"]] if obj.get("onlinePresence") is not None else None,
            ...
            "totalPriceAmount": obj.get("totalPriceAmount"),
            "averageBookingAmount": obj.get("averageBookingAmount"),
