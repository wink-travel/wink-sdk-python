...
class DisplayCompanyWithSalesMetricsSupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ownerIdentifier", "type", "ownerName", "continent", "country", "countryGeoNameId", "city", "cityGeoNameId", "ownerImageId", "description", "onlinePresence", "annualTravelSpendInDollars", "bookings", "totalPriceAmount", "averageBookingAmount", "currencyCode"]
