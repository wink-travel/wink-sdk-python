...
class DisplayCompanyWithSalesMetricsSupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ownerIdentifier", "type", "ownerName", "continent", "country", "countryGeoNameId", "city", "cityGeoNameId", "bookings", "totalPriceAmount", "averageBookingAmount", "currencyCode"]
