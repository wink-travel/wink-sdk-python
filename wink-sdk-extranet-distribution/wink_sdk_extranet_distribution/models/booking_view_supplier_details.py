...
class BookingViewSupplierDetails(BaseModel):
    """
    ...
    booking: BookingSupplierDetails
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "booking"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of booking
        if self.booking:
            _dict['booking'] = self.booking.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "booking": BookingSupplierDetails.from_dict(obj["booking"]) if obj.get("booking") is not None else None
        })
        return _obj
