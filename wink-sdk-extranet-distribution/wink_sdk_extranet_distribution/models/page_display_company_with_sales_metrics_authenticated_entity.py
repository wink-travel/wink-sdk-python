...
from wink_sdk_extranet_distribution.models.sort_object_supplier import SortObjectSupplier
from typing import Optional, Set
from typing_extensions import Self

class PageDisplayCompanyWithSalesMetricsAuthenticatedEntity(BaseModel):
    """
    ...
    content: Optional[List[DisplayCompanyWithSalesMetricsAuthenticatedEntity]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [DisplayCompanyWithSalesMetricsAuthenticatedEntity.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
