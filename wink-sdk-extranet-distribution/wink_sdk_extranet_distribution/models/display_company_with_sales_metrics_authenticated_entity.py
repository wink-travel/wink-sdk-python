...
class DisplayCompanyWithSalesMetricsAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ownerIdentifier", "type", "ownerName", "urlName", "continent", "country", "countryGeoNameId", "city", "cityGeoNameId", "ownerImageId", "description", "bookings", "totalPriceAmount", "averageBookingAmount", "currencyCode"]
