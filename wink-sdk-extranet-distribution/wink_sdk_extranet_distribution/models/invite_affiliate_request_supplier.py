...
class InviteAffiliateRequestSupplier(BaseModel):
    ...
    """ # noqa: E501
    hotel_email: StrictStr = Field(description="The email of the property", alias="hotelEmail")
    affiliate_email: StrictStr = Field(description="The email of the affiliate", alias="affiliateEmail")
    affiliate_name: StrictStr = Field(description="The name of the affiliate", alias="affiliateName")
