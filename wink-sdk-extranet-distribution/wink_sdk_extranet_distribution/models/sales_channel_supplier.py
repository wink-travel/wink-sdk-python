...
class SalesChannelSupplier(BaseModel):
    ...
    owner_identifier: UUID = Field(description="A specific identifier for the company / corporation / travel agency that is retrieving the rates", alias="ownerIdentifier")
