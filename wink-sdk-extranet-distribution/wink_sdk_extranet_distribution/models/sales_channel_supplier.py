...
class SalesChannelSupplier(BaseModel):
    """
    ...
    supplier_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Channel is owned by this supplier identifier.", alias="supplierIdentifier")
    ...
    owner_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="A specific identifier for the company / corporation / travel agency that is retrieving the rates", alias="ownerIdentifier")
    owner_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of the owner / affiliate. `Hotel booking customization` when it's the booking customization.", alias="ownerName")
    ...
    rate_modifiers: Optional[List[SpecialRateLightweightSupplier]] = Field(default=None, description="Promotions for this channel", alias="rateModifiers")
    rate_modifier_bundles: Optional[List[SpecialRateBundleLightweightSupplier]] = Field(default=None, description="Promotion bundles for this channel", alias="rateModifierBundles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateModifiers": [SpecialRateLightweightSupplier.from_dict(_item) for _item in obj["rateModifiers"]] if obj.get("rateModifiers") is not None else None,
            "rateModifierBundles": [SpecialRateBundleLightweightSupplier.from_dict(_item) for _item in obj["rateModifierBundles"]] if obj.get("rateModifierBundles") is not None else None,
