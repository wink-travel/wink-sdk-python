...
class SalesChannelSupplier(BaseModel):
    ...
    rate_modifiers: Optional[List[RateModifierSupplier]] = Field(default=None, description="Promotions for this channel", alias="rateModifiers")
    rate_modifier_bundles: Optional[List[RateModifierBundleSupplier]] = Field(default=None, description="Promotion bundles for this channel", alias="rateModifierBundles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateModifiers": [RateModifierSupplier.from_dict(_item) for _item in obj["rateModifiers"]] if obj.get("rateModifiers") is not None else None,
            "rateModifierBundles": [RateModifierBundleSupplier.from_dict(_item) for _item in obj["rateModifierBundles"]] if obj.get("rateModifierBundles") is not None else None
        })
        return _obj
