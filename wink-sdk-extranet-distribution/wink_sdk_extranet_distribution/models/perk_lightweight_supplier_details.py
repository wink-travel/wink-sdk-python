...
class PerkLightweightSupplierDetails(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescriptionSupplierDetails], Field(min_length=1)] = Field(description="Localized description for this perk")
