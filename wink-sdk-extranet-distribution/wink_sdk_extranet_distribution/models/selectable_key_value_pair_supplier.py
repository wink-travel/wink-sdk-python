...
class SelectableKeyValuePairSupplier(BaseModel):
    """
    ...
    selected: StrictBool = Field(description="Whether record is selected or not.")
    __properties: ClassVar[List[str]] = ["value", "label", "selected"]
