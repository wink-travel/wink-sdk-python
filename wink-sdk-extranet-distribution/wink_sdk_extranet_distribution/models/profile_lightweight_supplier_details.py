...
class ProfileLightweightSupplierDetails(BaseModel):
    """
    ...
    user: ProfileUserSupplierDetails = Field(description="User details")
    personal: PersonalSupplierDetails = Field(description="Detailed customer information for this profile")
    preferences: PreferencesSupplierDetails = Field(description="Customer preferences")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "share": obj.get("share"),
            "user": ProfileUserSupplierDetails.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "personal": PersonalSupplierDetails.from_dict(obj["personal"]) if obj.get("personal") is not None else None,
            "preferences": PreferencesSupplierDetails.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None
        })
        return _obj
