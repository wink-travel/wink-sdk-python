...
class CancellationPolicyExceptionSupplierDetails(BaseModel):
    """
    ...
    cancellation_policy: CancellationPolicyLightweightSupplierDetails = Field(description="Cancellation policy", alias="cancellationPolicy")
