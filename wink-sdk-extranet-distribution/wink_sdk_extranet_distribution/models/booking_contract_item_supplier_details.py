...
class BookingContractItemSupplierDetails(BaseModel):
    ...
    daily_rate_list: Optional[List[DailyRateSupplierDetails]] = Field(default=None, alias="dailyRateList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dailyRateList": [DailyRateSupplierDetails.from_dict(_item) for _item in obj["dailyRateList"]] if obj.get("dailyRateList") is not None else None,
