...
class InventorySupplier(BaseModel):
    ...
    address: InventoryAddressSupplier = Field(description="Defaults to property address.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": InventoryAddressSupplier.from_dict(obj["address"]) if obj.get("address") is not None else None,
