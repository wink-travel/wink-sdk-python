...
class MasterRateSupplierDetails(BaseModel):
    """
    A MasterRate pairs up a room type with a rate plan and some optional perks.
    """ # noqa: E501
    identifier: Optional[StrictStr] = Field(default=None, description="Unique record identifier")
    hotel_identifier: Optional[StrictStr] = Field(default=None, description="Hotel identifier.", alias="hotelIdentifier")
    name: Optional[StrictStr] = Field(default=None, description="Internal name of master rate. The name is generated by guest room and rate plan names respectively.")
    guest_room_identifier: StrictStr = Field(description="Guest room ID", alias="guestRoomIdentifier")
    rate_plan_identifier: StrictStr = Field(description="Rate plan ID", alias="ratePlanIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "hotelIdentifier", "name", "guestRoomIdentifier", "ratePlanIdentifier", "room", "ratePlan", "enabled", "perkTypes"]
