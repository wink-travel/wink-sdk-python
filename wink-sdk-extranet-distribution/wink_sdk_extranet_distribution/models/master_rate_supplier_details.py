...
class MasterRateSupplierDetails(BaseModel):
    ...
    room_type: RoomTypeLightweightSupplierDetails = Field(alias="roomType")
    rate_plan: RatePlanLightweightSupplierDetails = Field(alias="ratePlan")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "roomType": RoomTypeLightweightSupplierDetails.from_dict(obj["roomType"]) if obj.get("roomType") is not None else None,
            "ratePlan": RatePlanLightweightSupplierDetails.from_dict(obj["ratePlan"]) if obj.get("ratePlan") is not None else None,
