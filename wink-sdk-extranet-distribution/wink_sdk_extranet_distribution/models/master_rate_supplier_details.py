...
class MasterRateSupplierDetails(BaseModel):
    ...
    perks_value: Optional[StrictInt] = Field(default=None, alias="perksValue")
    __properties: ClassVar[List[str]] = ["identifier", "hotelIdentifier", "name", "guestRoomIdentifier", "ratePlanIdentifier", "room", "ratePlan", "enabled", "perkTypes", "perksValue"]
