...
class DisplayCompanySupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identifier", "owner", "city", "country", "continent", "name", "ownerName", "description", "url", "urls", "type", "enabled", "approved", "createdDate", "lastUpdate", "travelAgent"]
