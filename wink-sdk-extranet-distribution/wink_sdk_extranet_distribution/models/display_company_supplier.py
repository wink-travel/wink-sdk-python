...
class DisplayCompanySupplier(BaseModel):
    """
    DisplayCompanySupplier
    """ # noqa: E501
    identifier: StrictStr
    owner: KeyValuePairSupplier
    city: KeyValuePairSupplier
    country: KeyValuePairSupplier
    continent: KeyValuePairSupplier
    name: StrictStr
    owner_name: StrictStr = Field(alias="ownerName")
    url_name: StrictStr = Field(alias="urlName")
    ...
    travel_agent: TravelAgentSupplier = Field(alias="travelAgent")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "owner", "city", "country", "continent", "name", "ownerName", "urlName", "description", "type", "enabled", "approved", "createdDate", "lastUpdate", "travelAgent", "ownerImageId", "onlinePresence", "annualTravelSpendInDollars"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "city": KeyValuePairSupplier.from_dict(obj["city"]) if obj.get("city") is not None else None,
            "country": KeyValuePairSupplier.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "continent": KeyValuePairSupplier.from_dict(obj["continent"]) if obj.get("continent") is not None else None,
            "name": obj.get("name"),
