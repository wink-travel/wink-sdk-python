...
class BookingAncillarySupplierDetails(BaseModel):
    """
    ...
    type_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Travel inventory identifier", alias="typeIdentifier")
    transactional_travel_inventory_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Travel inventory identifier", alias="transactionalTravelInventoryIdentifier")
    ...
    price: LocalizedPriceSupplierDetails = Field(description="Pricing information for this ancillary.")
    ...
    contact: ContactSupplierDetails = Field(description="Travel blocking contact (if applicable)")
    address: SimpleAddressSupplierDetails = Field(description="Travel blocking address (if applicable)")
