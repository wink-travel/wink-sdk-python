...
class RequiredDaysOfWeekRateQualifierSupplierDetails(BaseModel):
    """
    RequiredDaysOfWeekRateQualifierSupplierDetails
    """ # noqa: E501
    days_of_week: DowPatternGroupSupplierDetails = Field(description="The days of the week the user has to stay on to get this rate", alias="daysOfWeek")
