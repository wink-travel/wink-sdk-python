...
class SalesChannelLightweightSupplierDetails(BaseModel):
    """
    SalesChannelLightweightSupplierDetails
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique record identifier of this segment / account")
    ...
    rate_modifiers: Optional[List[SpecialRateLightweightSupplierDetails]] = Field(default=None, description="Promotions for this channel", alias="rateModifiers")
    rate_modifier_bundles: Optional[List[SpecialRateBundleLightweightSupplierDetails]] = Field(default=None, description="Promotion bundles for this channel", alias="rateModifierBundles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateModifiers": [SpecialRateLightweightSupplierDetails.from_dict(_item) for _item in obj["rateModifiers"]] if obj.get("rateModifiers") is not None else None,
            "rateModifierBundles": [SpecialRateBundleLightweightSupplierDetails.from_dict(_item) for _item in obj["rateModifierBundles"]] if obj.get("rateModifierBundles") is not None else None,
