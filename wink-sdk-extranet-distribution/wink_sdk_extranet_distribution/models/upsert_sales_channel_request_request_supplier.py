...
class UpsertSalesChannelRequestRequestSupplier(BaseModel):
    """
    ...
    supplier_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Specific identifier for the company / corporation / travel agency that is retrieving the rates", alias="supplierIdentifier")
