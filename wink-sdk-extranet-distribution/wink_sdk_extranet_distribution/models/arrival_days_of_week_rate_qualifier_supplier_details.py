...
class ArrivalDaysOfWeekRateQualifierSupplierDetails(BaseModel):
    """
    ArrivalDaysOfWeekRateQualifierSupplierDetails
    """ # noqa: E501
    days_of_week: DowPatternGroupSupplierDetails = Field(description="The days of the week when this rate is available for guests to arrive on", alias="daysOfWeek")
