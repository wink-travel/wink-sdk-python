...
class RateKeySupplier(BaseModel):
    """
    ...
    guest_room_identifier: StrictStr = Field(alias="guestRoomIdentifier")
    var_date: date = Field(alias="date")
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "ratePlanIdentifier", "guestRoomIdentifier", "date"]
