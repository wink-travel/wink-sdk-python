...
class IPRangeRateQualifierSupplierDetails(BaseModel):
    ...
    """ # noqa: E501
    start_ip_range: StrictStr = Field(description="start of IP range", alias="startIPRange")
    end_ip_range: StrictStr = Field(description="end of IP range", alias="endIPRange")
