...
class InventoryUpdateRequestSupplier(BaseModel):
    """
    InventoryUpdateRequestSupplier
    """ # noqa: E501
    identifier: StrictStr = Field(description="Unique record identifier")
    enabled: StrictBool = Field(description="Flag the supplier can use to enable / disable this blocking")
    __properties: ClassVar[List[str]] = ["identifier", "enabled"]
