...
class BookingItinerarySupplierDetails(BaseModel):
    """
    BookingItinerary
    """ # noqa: E501
    ...
    items: Optional[List[BookingItineraryRoomConfigurationSupplierDetails]] = Field(default=None, description="Room configurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BookingItineraryRoomConfigurationSupplierDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "hours": obj.get("hours"),
