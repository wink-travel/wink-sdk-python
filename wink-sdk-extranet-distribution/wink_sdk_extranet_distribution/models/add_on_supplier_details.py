...
class AddOnSupplierDetails(BaseModel):
    """
    ...
    location: GeoJsonPointSupplierDetails
    descriptions: List[SimpleDescriptionSupplierDetails] = Field(description="Localized descriptions describing blocking.")
    multimedias: List[SimpleMultimediaSupplierDetails] = Field(description="List of images / videos of blocking.")
    contact: ContactSupplierDetails
    ...
    days_of_week: Optional[DowPatternGroupSupplierDetails] = Field(default=None, alias="daysOfWeek")
    ...
    rate_plan_identifier: Optional[StrictStr] = Field(default=None, description="Pass an optional rate plan identifier if you want to add more complex restrictions to this add-on. Example: You want the add-on to only be available when a specific room is available.", alias="ratePlanIdentifier")
    rate_plan: Optional[RatePlanSupplierDetails] = Field(default=None, alias="ratePlan")
    mandatory: StrictBool = Field(description="Make this add-on mandatory for all guests by enabling this flag.")
    __properties: ClassVar[List[str]] = ["identifier", "hotelIdentifier", "featuredInd", "lifestyleType", "location", "descriptions", "multimedias", "contact", "address", "commissionable", "name", "proximityCode", "sort", "minAgeAppropriateCode", "bookable", "active", "disabilityFeatures", "securityFeatures", "socials", "pricePoint", "recognitionList", "transactionalInventoryList", "applicableStart", "applicableEnd", "reservationRequiredInd", "opens", "closes", "daysOfWeek", "numberOfUnits", "ratePlanIdentifier", "ratePlan", "mandatory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratePlan": RatePlanSupplierDetails.from_dict(obj["ratePlan"]) if obj.get("ratePlan") is not None else None,
