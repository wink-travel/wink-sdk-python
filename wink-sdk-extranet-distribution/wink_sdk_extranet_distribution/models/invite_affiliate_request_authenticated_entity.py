...
class InviteAffiliateRequestAuthenticatedEntity(BaseModel):
    """
    InviteAffiliateRequestAuthenticatedEntity
    """ # noqa: E501
    hotel_email: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The email of the property", alias="hotelEmail")
    affiliate_email: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The email of the affiliate", alias="affiliateEmail")
    affiliate_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The name of the affiliate", alias="affiliateName")
    __properties: ClassVar[List[str]] = ["hotelEmail", "affiliateEmail", "affiliateName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hotelEmail": obj.get("hotelEmail"),
            "affiliateEmail": obj.get("affiliateEmail"),
