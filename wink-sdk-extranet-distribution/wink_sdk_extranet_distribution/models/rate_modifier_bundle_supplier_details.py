...
class RateModifierBundleSupplierDetails(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Internal name of promotion ancillary.")
    enabled: StrictBool = Field(description="Whether this promotion ancillary is enabled or not.")
    items: List[RateModifierSupplierDetails]
    modifier_override: Optional[VariableChargeSupplierDetails] = Field(default=None, alias="modifierOverride")
    ...
    description: Optional[List[LocalizedDescriptionSupplierDetails]] = None
    __properties: ClassVar[List[str]] = ["identifier", "hotelIdentifier", "name", "enabled", "items", "modifierOverride", "type", "pricingType", "hasFixedDiscountModifier", "hasPercentDiscountModifier", "isValid", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [RateModifierSupplierDetails.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "modifierOverride": VariableChargeSupplierDetails.from_dict(obj["modifierOverride"]) if obj.get("modifierOverride") is not None else None,
            "type": obj.get("type"),
            ...
            "description": [LocalizedDescriptionSupplierDetails.from_dict(_item) for _item in obj["description"]] if obj.get("description") is not None else None
        })
        return _obj
