...
class InventorySupplierDetails(BaseModel):
    """
    ...
    sales_channel: SalesChannelLightweightSupplierDetails = Field(description="Parent sales channel", alias="salesChannel")
    ...
    image: SimpleMultimediaSupplierDetails = Field(description="Main image of inventory")
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    location: GeoJsonPointSupplierDetails = Field(description="Location")
    address: InventoryAddressSupplierDetails = Field(description="Defaults to property address.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salesChannel": SalesChannelLightweightSupplierDetails.from_dict(obj["salesChannel"]) if obj.get("salesChannel") is not None else None,
            ...
            "image": SimpleMultimediaSupplierDetails.from_dict(obj["image"]) if obj.get("image") is not None else None,
            ...
            "address": InventoryAddressSupplierDetails.from_dict(obj["address"]) if obj.get("address") is not None else None,
