...
class InventorySupplierDetails(BaseModel):
    ...
    sales_channel: SalesChannelSupplierDetails = Field(alias="salesChannel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salesChannel": SalesChannelSupplierDetails.from_dict(obj["salesChannel"]) if obj.get("salesChannel") is not None else None,
