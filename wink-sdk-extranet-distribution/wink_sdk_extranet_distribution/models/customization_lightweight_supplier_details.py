...
class CustomizationLightweightSupplierDetails(BaseModel):
    """
    ...
    theme_colors: Optional[CustomizationThemeColorsSupplierDetails] = Field(default=None, description="Choose how you want our web components to look and more closely match with your own site style.", alias="themeColors")
    ...
    city: Optional[GeoNameLightweightSupplierDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "themeColors": CustomizationThemeColorsSupplierDetails.from_dict(obj["themeColors"]) if obj.get("themeColors") is not None else None,
            ...
            "city": GeoNameLightweightSupplierDetails.from_dict(obj["city"]) if obj.get("city") is not None else None,
