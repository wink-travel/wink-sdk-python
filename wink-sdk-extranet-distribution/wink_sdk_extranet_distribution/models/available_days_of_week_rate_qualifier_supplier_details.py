...
class AvailableDaysOfWeekRateQualifierSupplierDetails(BaseModel):
    """
    AvailableDaysOfWeekRateQualifierSupplierDetails
    """ # noqa: E501
    days_of_week: DowPatternGroupSupplierDetails = Field(description="The days of the week when this rate is available", alias="daysOfWeek")
