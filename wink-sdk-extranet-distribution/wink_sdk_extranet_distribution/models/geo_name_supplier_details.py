...
class GeoNameSupplierDetails(BaseModel):
    """
    ...
    country: Optional[CountrySupplierDetails] = None
    sub_country: Optional[SubCountrySupplierDetails] = Field(default=None, alias="subCountry")
    sub_sub_country: Optional[SubSubCountrySupplierDetails] = Field(default=None, alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountrySupplierDetails.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountrySupplierDetails.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountrySupplierDetails.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
