...
class TransactionalTravelInventorySupplierDetails(BaseModel):
    ...
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique transactional identifier")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Internal name of transactional blocking.")
    descriptions: Annotated[List[SimpleDescriptionSupplierDetails], Field(min_length=1, max_length=2147483647)]
    ...
    multimedias: Optional[List[SimpleMultimediaSupplierDetails]] = None
