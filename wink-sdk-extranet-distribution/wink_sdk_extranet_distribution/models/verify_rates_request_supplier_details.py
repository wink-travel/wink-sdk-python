...
class VerifyRatesRequestSupplierDetails(BaseModel):
    ...
    Rate request body
    """ # noqa: E501
    channel: ChannelNameSupplierDetails
    ...
    room_configurations: List[RoomConfigurationSupplierDetails] = Field(alias="roomConfigurations")
    currency: StrictStr = Field(description="Display currency")
    ...
    city: Optional[GeoIPSupplierDetails] = None
    country: Optional[GeoNameCountrySupplierDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "city": GeoIPSupplierDetails.from_dict(obj["city"]) if obj.get("city") is not None else None,
