...
class AddOnLocalizedInventorySupplierDetails(BaseModel):
    ...
    """ # noqa: E501
    add_on: AddOnSupplierDetails = Field(alias="addOn")
    price_list: Optional[List[LocalizedTransactionalTravelInventorySupplierDetails]] = Field(default=None, alias="priceList")
    channel_inventory_identifier: Optional[StrictStr] = Field(default=None, description="Channel blocking identifier referencing this record.", alias="channelInventoryIdentifier")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addOn": AddOnSupplierDetails.from_dict(obj["addOn"]) if obj.get("addOn") is not None else None,
