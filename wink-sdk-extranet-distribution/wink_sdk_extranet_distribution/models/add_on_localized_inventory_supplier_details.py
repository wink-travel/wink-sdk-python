...
class AddOnLocalizedInventorySupplierDetails(BaseModel):
    ...
    """ # noqa: E501
    add_on: AddOnLightweightSupplierDetails = Field(alias="addOn")
    price_list: Optional[List[LocalizedTransactionalTravelInventorySupplierDetails]] = Field(default=None, alias="priceList")
    channel_inventory_identifier: Optional[StrictStr] = Field(default=None, description="Channel inventory identifier referencing this record.", alias="channelInventoryIdentifier")
