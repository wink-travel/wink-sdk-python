...
class RoomConfigurationPriceSupplierDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adults", "children", "startDate", "endDate", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "price", "extraCharges", "configuration", "addOnOffers", "perkValue", "activeCancellationPolicy", "roomNights", "list", "channelInventoryIdentifier", "commissionable", "commission", "direct", "priceList", "available", "rateSource", "userSpecifiedCurrencyTotal", "sourceTotal", "internalTotal"]
