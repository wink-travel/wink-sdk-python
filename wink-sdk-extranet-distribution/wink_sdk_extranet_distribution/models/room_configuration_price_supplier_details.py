...
class RoomConfigurationPriceSupplierDetails(BaseModel):
    ...
    rate_plan: RoomConfigurationPriceRatePlanSupplierDetails = Field(alias="ratePlan")
    perk_types: Optional[List[PerkLightweightSupplierDetails]] = Field(default=None, alias="perkTypes")
    price: StayRateSupplierDetails
    extra_charges: Optional[ExtraChargesSupplierDetails] = Field(default=None, alias="extraCharges")
    configuration: RoomConfigurationSupplierDetails
    add_on_offers: Optional[List[AddOnLocalizedInventorySupplierDetails]] = Field(default=None, alias="addOnOffers")
    perk_value: Optional[StrictInt] = Field(default=None, description="The combined value of these perkTypes", alias="perkValue")
    active_cancellation_policy: CancellationPolicySupplierDetails = Field(alias="activeCancellationPolicy")
    ...
    price_list: Optional[List[LocalizedTransactionalTravelInventorySupplierDetails]] = Field(default=None, alias="priceList")
    ...
    __properties: ClassVar[List[str]] = ["adults", "children", "startDate", "endDate", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "price", "extraCharges", "configuration", "addOnOffers", "perkValue", "activeCancellationPolicy", "roomNights", "list", "channelInventoryIdentifier", "commissionable", "commission", "direct", "priceList", "available", "rateSource", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addOnOffers": [AddOnLocalizedInventorySupplierDetails.from_dict(_item) for _item in obj["addOnOffers"]] if obj.get("addOnOffers") is not None else None,
            "perkValue": obj.get("perkValue"),
            "activeCancellationPolicy": CancellationPolicySupplierDetails.from_dict(obj["activeCancellationPolicy"]) if obj.get("activeCancellationPolicy") is not None else None,
            ...
            "priceList": [LocalizedTransactionalTravelInventorySupplierDetails.from_dict(_item) for _item in obj["priceList"]] if obj.get("priceList") is not None else None,
