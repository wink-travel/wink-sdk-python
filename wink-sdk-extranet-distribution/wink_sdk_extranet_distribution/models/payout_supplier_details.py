...
class PayoutSupplierDetails(BaseModel):
    """
    ...
    ledger_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique system ID.", alias="ledgerIdentifier")
    beneficiary_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Beneficiary ID.", alias="beneficiaryIdentifier")
    ...
    fees: Optional[List[PayoutFeeSupplierDetails]] = Field(default=None, description="Fees incurred when making the withdrawal.")
    quote: Optional[QuoteLightweightSupplierDetails] = Field(default=None, description="FX quote for this transfer.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fees": [PayoutFeeSupplierDetails.from_dict(_item) for _item in obj["fees"]] if obj.get("fees") is not None else None,
            "quote": QuoteLightweightSupplierDetails.from_dict(obj["quote"]) if obj.get("quote") is not None else None,
