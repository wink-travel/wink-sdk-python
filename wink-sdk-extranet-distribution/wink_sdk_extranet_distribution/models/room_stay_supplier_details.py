...
class RoomStaySupplierDetails(BaseModel):
    ...
    """ # noqa: E501
    policy: PropertyPolicySupplierDetails
    room: GuestRoomLightweightSupplierDetails
    rooms: StrictInt = Field(description="Number of rooms. Always 1 since we switched to creating one booking per room.")
    bedroom_configuration: BedroomConfigurationSupplierDetails = Field(alias="bedroomConfiguration")
    ...
    extra_charges: ExtraChargesSupplierDetails = Field(alias="extraCharges")
