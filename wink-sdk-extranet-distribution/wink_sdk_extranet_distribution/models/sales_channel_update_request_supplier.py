...
class SalesChannelUpdateRequestSupplier(BaseModel):
    ...
    rate_modifier_identifiers: Optional[List[UUID]] = Field(default=None, alias="rateModifierIdentifiers")
    rate_modifier_bundle_identifiers: Optional[List[UUID]] = Field(default=None, alias="rateModifierBundleIdentifiers")
