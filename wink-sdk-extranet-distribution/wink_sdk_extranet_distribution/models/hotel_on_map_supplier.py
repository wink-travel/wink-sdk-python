...
class HotelOnMapSupplier(BaseModel):
    """
    ...
    location: Optional[GeoJsonPointSupplier] = None
    short_descriptions: Optional[List[LocalizedDescriptionSupplier]] = Field(default=None, description="A localized list of short property descriptions", alias="shortDescriptions")
    long_descriptions: Optional[List[LocalizedDescriptionSupplier]] = Field(default=None, description="A localized list of longer property descriptions", alias="longDescriptions")
    ...
    reservations: Optional[ContactSupplier] = None
    socials: Optional[List[SocialSupplier]] = Field(default=None, description="Property's social network accounts")
    images: Optional[List[SimpleMultimediaSupplier]] = Field(default=None, description="Property images.")
    videos: Optional[List[SimpleMultimediaSupplier]] = Field(default=None, description="Property videos.")
    policy: Optional[PropertyPolicySupplier] = None
    third_party_reviews: Optional[List[TravelInventoryRecognitionSupplier]] = Field(default=None, description="Array of awards and third party reviews given to property by certified / non-certified providers.", alias="thirdPartyReviews")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reservations": ContactSupplier.from_dict(obj["reservations"]) if obj.get("reservations") is not None else None,
            "socials": [SocialSupplier.from_dict(_item) for _item in obj["socials"]] if obj.get("socials") is not None else None,
            "images": [SimpleMultimediaSupplier.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
            "videos": [SimpleMultimediaSupplier.from_dict(_item) for _item in obj["videos"]] if obj.get("videos") is not None else None,
            "policy": PropertyPolicySupplier.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
            "thirdPartyReviews": [TravelInventoryRecognitionSupplier.from_dict(_item) for _item in obj["thirdPartyReviews"]] if obj.get("thirdPartyReviews") is not None else None,
