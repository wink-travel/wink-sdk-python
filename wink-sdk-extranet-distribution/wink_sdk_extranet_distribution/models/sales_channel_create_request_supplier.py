...
class SalesChannelCreateRequestSupplier(BaseModel):
    """
    SalesChannelCreateRequestSupplier
    """ # noqa: E501
    owner_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Owner identifier, in this context, is the unique company record identifier.", alias="ownerIdentifier")
    supplier_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supplier identifier is the entity that owns the ivnentory.", alias="supplierIdentifier")
    __properties: ClassVar[List[str]] = ["ownerIdentifier", "supplierIdentifier"]
