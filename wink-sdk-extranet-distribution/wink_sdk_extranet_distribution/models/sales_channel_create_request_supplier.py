...
class SalesChannelCreateRequestSupplier(BaseModel):
    ...
    """ # noqa: E501
    owner_identifier: UUID = Field(description="Owner identifier, in this context, is the unique company record identifier.", alias="ownerIdentifier")
    supplier_identifier: UUID = Field(description="Supplier identifier is the entity that owns the ivnentory.", alias="supplierIdentifier")
