...
class UpsertSalesChannelRelationshipRequestRequestSupplier(BaseModel):
    """
    ...
    supplier_identifier: StrictStr = Field(description="Specific identifier for the company / corporation / travel agency that is retrieving the rates", alias="supplierIdentifier")
