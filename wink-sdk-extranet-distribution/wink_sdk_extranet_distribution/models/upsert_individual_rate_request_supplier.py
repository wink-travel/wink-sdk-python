...
class UpsertIndividualRateRequestSupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["quantity", "deltaQuantity", "master", "closedOnArrival", "closedOnDeparture", "minLengthOfStay", "maxLengthOfStay", "rate", "currencyCode", "extraPaxRateModifier", "extraChildRateModifier", "singleOccupancyRateModifier"]
