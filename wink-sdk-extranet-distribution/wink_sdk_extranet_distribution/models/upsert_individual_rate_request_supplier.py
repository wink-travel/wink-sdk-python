...
class UpsertIndividualRateRequestSupplier(BaseModel):
    """
    ...
    closed_on_arrival: Optional[StrictBool] = Field(default=None, alias="closedOnArrival")
    closed_on_departure: Optional[StrictBool] = Field(default=None, alias="closedOnDeparture")
    ...
    __properties: ClassVar[List[str]] = ["quantity", "deltaQuantity", "master", "closedOnArrival", "closedOnDeparture", "minLengthOfStay", "maxLengthOfStay", "rate", "currencyCode", "extraPaxRateModifier", "extraChildRateModifier", "singleOccupancyRateModifier", "minOccupancy", "maxOccupancy"]
