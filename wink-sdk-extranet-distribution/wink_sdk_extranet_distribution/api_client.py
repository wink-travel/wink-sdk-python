...
from wink_sdk_extranet_distribution.configuration import Configuration
from wink_sdk_extranet_distribution.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_extranet_distribution.models
from wink_sdk_extranet_distribution import rest
from wink_sdk_extranet_distribution.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_extranet_distribution.models, klass)
