...
from wink_sdk_affiliate_sales_channel.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_affiliate_sales_channel.models
from wink_sdk_affiliate_sales_channel import rest
from wink_sdk_affiliate_sales_channel.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_affiliate_sales_channel.models, klass)
