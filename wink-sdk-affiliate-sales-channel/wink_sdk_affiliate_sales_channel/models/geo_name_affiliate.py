...
class GeoNameAffiliate(BaseModel):
    """
    ...
    country: Optional[CountryAffiliate] = None
    sub_country: Optional[SubCountryAffiliate] = Field(default=None, alias="subCountry")
    sub_sub_country: Optional[SubSubCountryAffiliate] = Field(default=None, alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountryAffiliate.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountryAffiliate.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountryAffiliate.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
