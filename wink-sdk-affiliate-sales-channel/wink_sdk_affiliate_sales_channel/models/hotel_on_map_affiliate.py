...
class HotelOnMapAffiliate(BaseModel):
    """
    Hotel aggregate data
    """ # noqa: E501
    ...
    location: Optional[GeoJsonPointAffiliate] = None
    short_descriptions: Optional[List[LocalizedDescriptionAffiliate]] = Field(default=None, description="A localized list of short property descriptions", alias="shortDescriptions")
    long_descriptions: Optional[List[LocalizedDescriptionAffiliate]] = Field(default=None, description="A localized list of longer property descriptions", alias="longDescriptions")
    ...
    reservations: Optional[ContactAffiliate] = None
    ...
    policy: Optional[PropertyPolicyAffiliate] = None
    ...
    address: Optional[AddressAffiliate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shortDescriptions": [LocalizedDescriptionAffiliate.from_dict(_item) for _item in obj["shortDescriptions"]] if obj.get("shortDescriptions") is not None else None,
            "longDescriptions": [LocalizedDescriptionAffiliate.from_dict(_item) for _item in obj["longDescriptions"]] if obj.get("longDescriptions") is not None else None,
