...
class PagePropertyAggregateLightweightAffiliate(BaseModel):
    """
    ...
    content: Optional[List[PropertyAggregateLightweightAffiliate]] = None
    number: Optional[StrictInt] = None
    pageable: Optional[PageableObjectAffiliate] = None
    number_of_elements: Optional[StrictInt] = Field(default=None, alias="numberOfElements")
    sort: Optional[SortObjectAffiliate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [PropertyAggregateLightweightAffiliate.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "number": obj.get("number"),
            "pageable": PageableObjectAffiliate.from_dict(obj["pageable"]) if obj.get("pageable") is not None else None,
            "numberOfElements": obj.get("numberOfElements"),
            "sort": SortObjectAffiliate.from_dict(obj["sort"]) if obj.get("sort") is not None else None,
            "first": obj.get("first"),
            "last": obj.get("last"),
            "empty": obj.get("empty")
        })
