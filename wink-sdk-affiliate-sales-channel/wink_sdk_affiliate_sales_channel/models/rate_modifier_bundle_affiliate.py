...
class RateModifierBundleAffiliate(BaseModel):
    """
    ...
    items: List[RateModifierAffiliate]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [RateModifierAffiliate.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
