...
class SpecialRateBundleLightweightAffiliate(BaseModel):
    """
    ...
    items: Annotated[List[SpecialRateLightweightAffiliate], Field(min_length=1)]
    modifier_override: Optional[Any] = Field(default=None, alias="modifierOverride")
    ...
    description: Optional[List[LocalizedDescriptionAffiliate]] = None
    __properties: ClassVar[List[str]] = ["identifier", "hotelIdentifier", "name", "enabled", "items", "modifierOverride", "type", "pricingType", "isValid", "hasFixedDiscountModifier", "hasPercentDiscountModifier", "description"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if modifier_override (nullable) is None
        # and model_fields_set contains the field
        if self.modifier_override is None and "modifier_override" in self.model_fields_set:
            _dict['modifierOverride'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [SpecialRateLightweightAffiliate.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "modifierOverride": obj.get("modifierOverride"),
            "type": obj.get("type"),
            ...
            "description": [LocalizedDescriptionAffiliate.from_dict(_item) for _item in obj["description"]] if obj.get("description") is not None else None
        })
        return _obj
