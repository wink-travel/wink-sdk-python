...
class SalesChannelRelationshipRequestView(BaseModel):
    """
    ...
    user: Optional[SalesChannelRelationshipRequest] = None
    request: Optional[SalesChannelRelationshipRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": SalesChannelRelationshipRequest.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "request": SalesChannelRelationshipRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
