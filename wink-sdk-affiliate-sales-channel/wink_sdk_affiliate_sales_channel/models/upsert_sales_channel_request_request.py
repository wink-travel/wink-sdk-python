...
class UpsertSalesChannelRequestRequest(BaseModel):
    """
    ...
    supplier_identifier: UUID = Field(description="Specific identifier for the company / corporation / travel agency that is retrieving the rates", alias="supplierIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["requestType", "supplierIdentifier", "introductoryMessage"]
