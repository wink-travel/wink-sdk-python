...
class SalesChannelRelationshipRequestViewAffiliate(BaseModel):
    """
    SalesChannelRelationshipRequestViewAffiliate
    """ # noqa: E501
    ...
    user: Optional[SalesChannelRelationshipRequestAffiliate] = None
    request: Optional[SalesChannelRelationshipRequestAffiliate] = None
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "user", "request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": SalesChannelRelationshipRequestAffiliate.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "request": SalesChannelRelationshipRequestAffiliate.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
