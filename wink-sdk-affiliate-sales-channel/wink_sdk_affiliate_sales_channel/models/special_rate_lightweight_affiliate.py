...
class SpecialRateLightweightAffiliate(BaseModel):
    """
    ...
    descriptions: Annotated[List[LocalizedDescriptionAffiliate], Field(min_length=1)] = Field(description="Localized descriptions describing promotion. At least one English entry is required.")
    ...
    room_range_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion by restricting to how many rooms the user wants.", alias="roomRangeRateQualifier")
    prepay_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to either prepaid / non-prepaid rates.", alias="prepayRateQualifier")
    refundable_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to either refundable / non-refundable rates.", alias="refundableRateQualifier")
    ...
    last_minute_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to users who want to book a room close to the date.", alias="lastMinuteRateQualifier")
    length_of_stay_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to users who want to stay a certain number of days.", alias="lengthOfStayRateQualifier")
    advance_booking_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to users who want to book in advance.", alias="advanceBookingRateQualifier")
    ...
    available_days_of_week_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to specific days of the week the promotion is available.", alias="availableDaysOfWeekRateQualifier")
    arrival_days_of_week_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to specific days of the week the guest is arriving.", alias="arrivalDaysOfWeekRateQualifier")
    departure_days_of_week_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to specific days of the week the guest is departing.", alias="departureDaysOfWeekRateQualifier")
    required_days_of_week_rate_qualifier: Optional[Any] = Field(default=None, description="Restrict promotion to specific days of the week the guest has to stay.", alias="requiredDaysOfWeekRateQualifier")
