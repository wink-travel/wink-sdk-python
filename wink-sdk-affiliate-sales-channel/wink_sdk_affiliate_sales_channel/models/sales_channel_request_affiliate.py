...
class SalesChannelRequestAffiliate(BaseModel):
    """
    ...
    supplier_identifier: UUID = Field(description="Request goes to this supplier identifier.", alias="supplierIdentifier")
    ...
    owner_identifier: UUID = Field(description="Specific identifier for the company / corporation / travel agency that is retrieving the rates", alias="ownerIdentifier")
