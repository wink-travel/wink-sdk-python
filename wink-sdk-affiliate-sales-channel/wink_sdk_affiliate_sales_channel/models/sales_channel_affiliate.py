...
class SalesChannelAffiliate(BaseModel):
    ...
    supplier_identifier: UUID = Field(description="Channel is owned by this supplier identifier.", alias="supplierIdentifier")
    supplier_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of property / supplier that owns this channel", alias="supplierName")
    supplier_available: StrictBool = Field(description="Flag when supplier not available. E.g. Hotel disables property", alias="supplierAvailable")
    sub_type: StrictStr = Field(description="What type of segment of channel is this.", alias="subType")
    owner_identifier: Optional[UUID] = Field(default=None, description="A specific identifier for the company / corporation / travel agency that is retrieving the rates", alias="ownerIdentifier")
    owner_name: Optional[StrictStr] = Field(default=None, description="Name of the owner / affiliate. `Hotel booking customization` when it's the booking customization.", alias="ownerName")
    enabled: Optional[StrictBool] = Field(default=True, description="Flag the supplier can use to enable / disable this channel")
    channel_disabled: Optional[StrictBool] = Field(default=None, description="System override by supplier to disable channel. E.g. Platform disables supplier.", alias="channelDisabled")
    ...
    rate_modifiers: Optional[List[SpecialRateLightweightAffiliate]] = Field(default=None, description="Promotions for this channel", alias="rateModifiers")
    rate_modifier_bundles: Optional[List[SpecialRateBundleLightweightAffiliate]] = Field(default=None, description="Promotion bundles for this channel", alias="rateModifierBundles")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "supplierIdentifier", "supplierName", "supplierAvailable", "subType", "ownerIdentifier", "ownerName", "enabled", "channelDisabled", "blacklisted", "percentDiscount", "commission", "rateModifiers", "rateModifierBundles", "selfAcquires"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateModifiers": [SpecialRateLightweightAffiliate.from_dict(_item) for _item in obj["rateModifiers"]] if obj.get("rateModifiers") is not None else None,
            "rateModifierBundles": [SpecialRateBundleLightweightAffiliate.from_dict(_item) for _item in obj["rateModifierBundles"]] if obj.get("rateModifierBundles") is not None else None,
