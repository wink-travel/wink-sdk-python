...
class SalesChannelRelationshipRequestAffiliate(BaseModel):
    """
    ...
    supplier_identifier: StrictStr = Field(description="Request goes to this supplier identifier.", alias="supplierIdentifier")
    supplier_name: StrictStr = Field(description="Request goes to this supplier name.", alias="supplierName")
    sub_type: StrictStr = Field(description="What type of segment of channel is this.", alias="subType")
    owner_identifier: StrictStr = Field(description="Specific identifier for the company / corporation / travel agency that is retrieving the rates", alias="ownerIdentifier")
    owner_name: StrictStr = Field(description="Name of the owner / affiliate.", alias="ownerName")
    introductory_message: StrictStr = Field(description="Owner / affiliate writes an intro to request a connection.", alias="introductoryMessage")
    __properties: ClassVar[List[str]] = ["identifier", "status", "requestType", "supplierIdentifier", "supplierName", "subType", "ownerIdentifier", "ownerName", "introductoryMessage"]
