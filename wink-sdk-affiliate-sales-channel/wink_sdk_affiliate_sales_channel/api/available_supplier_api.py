...
class AvailableSupplierApi:
    ...
    def browse_suppliers(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "PagePropertyAggregateLightweightAffiliate",
        }
    ...
    def browse_suppliers_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PagePropertyAggregateLightweightAffiliate]:
        """Supplier Search
    ...
    def _browse_suppliers_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/supplier/grid',
    ...
    def show_latest_supplier(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[PropertyAggregateLightweightAffiliate]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "BrowseSuppliers400Response",
            '200': "List[PropertyAggregateLightweightAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_latest_supplier_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PropertyAggregateLightweightAffiliate]]:
        """Recent Supplier List
    ...
    def _show_latest_supplier_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/supplier/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_supplier(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "BrowseSuppliers400Response",
            '200': "PropertyAggregateLightweightAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_supplier_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PropertyAggregateLightweightAffiliate]:
        """Show Supplier
    ...
    def _show_supplier_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/supplier/{supplierIdentifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _show_unique_city_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/supplier/city/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _show_unique_country_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/supplier/country/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
