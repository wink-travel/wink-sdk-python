...
class SalesChannelApi:
    ...
    def browse_sales_channels(
        ...
        _param = self._browse_sales_channels_serialize(
    ...
    @validate_call
    def browse_sales_channels_with_http_info(
        self,
        state_affiliate: StateAffiliate,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageSalesChannelAffiliate]:
        """Sales Channel Grid
    ...
    @validate_call
    def browse_sales_channels_without_preload_content(
        self,
        state_affiliate: StateAffiliate,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _browse_sales_channels_serialize(
        self,
        state_affiliate,
        wink_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/sales-channel/grid',
    ...
    def show_sales_channel(
        ...
        :param supplier_identifier: (required)
    ...
    def show_sales_channel_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SalesChannelAffiliate]:
        """Show Sales Channel
    ...
    def _show_sales_channel_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/sales-channel/supplier/{supplierIdentifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
