...
class SalesChannelApi:
    ...
    def browse_sales_channels(
        ...
        :param company_identifier: (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "PageSalesChannelViewAffiliate",
        }
    ...
    def browse_sales_channels_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageSalesChannelViewAffiliate]:
        """Sales Channel Search
    ...
    def _browse_sales_channels_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/affiliate/{companyIdentifier}/sales-channel/grid',
    ...
    def show_sales_channel_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SalesChannelViewAffiliate]:
        """Show Sales Channel
    ...
    def _show_sales_channel_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/affiliate/{companyIdentifier}/sales-channel/supplier/{supplierIdentifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
