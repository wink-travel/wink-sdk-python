...
property_policy_affiliate_instance = PropertyPolicyAffiliate.from_json(json)
# print the JSON string representation of the object
print(PropertyPolicyAffiliate.to_json())

# convert the object into a dict
property_policy_affiliate_dict = property_policy_affiliate_instance.to_dict()
# create an instance of PropertyPolicyAffiliate from a dict
property_policy_affiliate_from_dict = PropertyPolicyAffiliate.from_dict(property_policy_affiliate_dict)
```
