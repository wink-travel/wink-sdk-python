...
class TestCountryAffiliate(unittest.TestCase):
    """CountryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryAffiliate:
        """Test CountryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryAffiliate`
        """
        model = CountryAffiliate()
        if include_optional:
            return CountryAffiliate(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
