...
class TestSpecialRateBundleLightweightAffiliate(unittest.TestCase):
    """SpecialRateBundleLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialRateBundleLightweightAffiliate:
        """Test SpecialRateBundleLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialRateBundleLightweightAffiliate`
        """
        model = SpecialRateBundleLightweightAffiliate()
        if include_optional:
            return SpecialRateBundleLightweightAffiliate(
    ...
    def testSpecialRateBundleLightweightAffiliate(self):
        """Test SpecialRateBundleLightweightAffiliate"""
