...
class TestRateModifierAffiliate(unittest.TestCase):
    """RateModifierAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateModifierAffiliate:
        """Test RateModifierAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateModifierAffiliate`
        """
        model = RateModifierAffiliate()
        if include_optional:
            return RateModifierAffiliate(
                identifier = '',
                hotel_identifier = '',
                name = 'Early bird',
                type = 'DISCOUNT',
    ...
    def testRateModifierAffiliate(self):
        """Test RateModifierAffiliate"""
