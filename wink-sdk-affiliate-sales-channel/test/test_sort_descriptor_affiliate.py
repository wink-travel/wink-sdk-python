...
class TestSortDescriptorAffiliate(unittest.TestCase):
    """SortDescriptorAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortDescriptorAffiliate:
        """Test SortDescriptorAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortDescriptorAffiliate`
        """
        model = SortDescriptorAffiliate()
        if include_optional:
            return SortDescriptorAffiliate(
                dir = 'asc',
    ...
    def testSortDescriptorAffiliate(self):
        """Test SortDescriptorAffiliate"""
