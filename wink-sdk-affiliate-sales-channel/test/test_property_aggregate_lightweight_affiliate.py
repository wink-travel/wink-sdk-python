...
class TestPropertyAggregateLightweightAffiliate(unittest.TestCase):
    """PropertyAggregateLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateLightweightAffiliate:
        """Test PropertyAggregateLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateLightweightAffiliate`
        """
        model = PropertyAggregateLightweightAffiliate()
        if include_optional:
            return PropertyAggregateLightweightAffiliate(
    ...
    def testPropertyAggregateLightweightAffiliate(self):
        """Test PropertyAggregateLightweightAffiliate"""
