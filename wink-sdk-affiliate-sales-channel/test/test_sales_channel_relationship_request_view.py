...
class TestSalesChannelRelationshipRequestView(unittest.TestCase):
    """SalesChannelRelationshipRequestView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelRelationshipRequestView:
        """Test SalesChannelRelationshipRequestView
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelRelationshipRequestView`
        """
        model = SalesChannelRelationshipRequestView()
        if include_optional:
            return SalesChannelRelationshipRequestView(
                ...
                version = 12,
                user = wink_sdk_affiliate_sales_channel.models.sales_channel_relationship_request.SalesChannelRelationshipRequest(
                    identifier = '', 
                    status = 'REQUESTING', 
                ...
                request = wink_sdk_affiliate_sales_channel.models.sales_channel_relationship_request.SalesChannelRelationshipRequest(
                    identifier = '', 
                    status = 'REQUESTING', 
                    request_type = 'DIRECT_CONNECTION', 
                    supplier_identifier = '', 
    ...
    def testSalesChannelRelationshipRequestView(self):
        """Test SalesChannelRelationshipRequestView"""
