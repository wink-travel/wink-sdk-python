...
class TestPageHotelOnMapViewAffiliate(unittest.TestCase):
    """PageHotelOnMapViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageHotelOnMapViewAffiliate:
        """Test PageHotelOnMapViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageHotelOnMapViewAffiliate`
        """
        model = PageHotelOnMapViewAffiliate()
        if include_optional:
            return PageHotelOnMapViewAffiliate(
                ...
                size = 56,
                content = [
                    wink_sdk_affiliate_sales_channel.models.hotel_on_map_view_affiliate.HotelOnMapView_Affiliate(
                        id = 'doc-1', 
                        created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        version = 12, 
                        hotel = wink_sdk_affiliate_sales_channel.models.hotel_on_map_affiliate.HotelOnMap_Affiliate(
                            ...
                            number_of_rooms = 32, 
                            address = wink_sdk_affiliate_sales_channel.models.address_affiliate.Address_Affiliate(
                                address1 = '234 Near da beach', 
                                address2 = 'Pebble #5001', 
                                state = 'CA', 
                                postal_code = '90210', 
                                county = 'Alameda county', 
                                city = wink_sdk_affiliate_sales_channel.models.geo_name_affiliate.GeoName_Affiliate(
                                    geo_name_id = '5128581', 
                                    type = 'CITY', 
                                    name = 'New York City', 
                                    ...
                                    country = wink_sdk_affiliate_sales_channel.models.country_affiliate.Country_Affiliate(
                                        iso = 'US', 
                                        name = 'United States', 
                                        capital = 'Washington', 
                                        continent = 'NA', 
                                        ...
                                        geo_name_id = '6252001', ), 
                                    sub_country = wink_sdk_affiliate_sales_channel.models.sub_country_affiliate.SubCountry_Affiliate(
                                        name = 'New York', 
                                        ascii_name = 'New York', 
                                        geo_name_id = '5128638', ), 
                                    sub_sub_country = wink_sdk_affiliate_sales_channel.models.sub_sub_country_affiliate.SubSubCountry_Affiliate(
                                        name = '', 
                                        ascii_name = '', 
                                        geo_name_id = '', ), ), 
                                valid = True, 
    ...
    def testPageHotelOnMapViewAffiliate(self):
        """Test PageHotelOnMapViewAffiliate"""
