...
class TestAvailableSupplierApi(unittest.TestCase):
    """AvailableSupplierApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AvailableSupplierApi()

    def tearDown(self) -> None:
        pass

    def test_browse_suppliers(self) -> None:
        """Test case for browse_suppliers

        Supplier Search
        """
        pass

    def test_show_latest_supplier(self) -> None:
        """Test case for show_latest_supplier

        Recent Supplier List
        """
        pass

    def test_show_supplier(self) -> None:
        """Test case for show_supplier

        Show Supplier
        """
        pass

    def test_show_unique_city_list(self) -> None:
        """Test case for show_unique_city_list

        Cities by Supplier
        """
        pass

    def test_show_unique_country_list(self) -> None:
        """Test case for show_unique_country_list
