...
class TestSpecialRateLightweightAffiliate(unittest.TestCase):
    """SpecialRateLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialRateLightweightAffiliate:
        """Test SpecialRateLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialRateLightweightAffiliate`
        """
        model = SpecialRateLightweightAffiliate()
        if include_optional:
            return SpecialRateLightweightAffiliate(
    ...
    def testSpecialRateLightweightAffiliate(self):
        """Test SpecialRateLightweightAffiliate"""
