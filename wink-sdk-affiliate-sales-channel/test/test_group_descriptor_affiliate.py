...
class TestGroupDescriptorAffiliate(unittest.TestCase):
    """GroupDescriptorAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupDescriptorAffiliate:
        """Test GroupDescriptorAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupDescriptorAffiliate`
        """
        model = GroupDescriptorAffiliate()
        if include_optional:
            return GroupDescriptorAffiliate(
    ...
    def testGroupDescriptorAffiliate(self):
        """Test GroupDescriptorAffiliate"""
