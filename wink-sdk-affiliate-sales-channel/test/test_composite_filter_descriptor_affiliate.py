...
class TestCompositeFilterDescriptorAffiliate(unittest.TestCase):
    """CompositeFilterDescriptorAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompositeFilterDescriptorAffiliate:
        """Test CompositeFilterDescriptorAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompositeFilterDescriptorAffiliate`
        """
        model = CompositeFilterDescriptorAffiliate()
        if include_optional:
            return CompositeFilterDescriptorAffiliate(
                logic = 'and',
                filters = [
    ...
    def testCompositeFilterDescriptorAffiliate(self):
        """Test CompositeFilterDescriptorAffiliate"""
