...
class TestHotelOnMapViewAffiliate(unittest.TestCase):
    """HotelOnMapViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelOnMapViewAffiliate:
        """Test HotelOnMapViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelOnMapViewAffiliate`
        """
        model = HotelOnMapViewAffiliate()
        if include_optional:
    ...
    def testHotelOnMapViewAffiliate(self):
        """Test HotelOnMapViewAffiliate"""
