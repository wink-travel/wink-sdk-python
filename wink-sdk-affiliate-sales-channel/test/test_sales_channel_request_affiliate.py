...
class TestSalesChannelRequestAffiliate(unittest.TestCase):
    """SalesChannelRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelRequestAffiliate:
        """Test SalesChannelRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelRequestAffiliate`
        """
        model = SalesChannelRequestAffiliate()
        if include_optional:
            return SalesChannelRequestAffiliate(
                id = 'doc-1',
    ...
    def testSalesChannelRequestAffiliate(self):
        """Test SalesChannelRequestAffiliate"""
