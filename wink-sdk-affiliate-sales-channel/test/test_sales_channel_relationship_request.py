...
class TestSalesChannelRelationshipRequest(unittest.TestCase):
    """SalesChannelRelationshipRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelRelationshipRequest:
        """Test SalesChannelRelationshipRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelRelationshipRequest`
        """
        model = SalesChannelRelationshipRequest()
        if include_optional:
            return SalesChannelRelationshipRequest(
                identifier = '',
                status = 'REQUESTING',
    ...
    def testSalesChannelRelationshipRequest(self):
        """Test SalesChannelRelationshipRequest"""
