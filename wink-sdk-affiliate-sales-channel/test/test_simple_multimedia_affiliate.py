...
class TestSimpleMultimediaAffiliate(unittest.TestCase):
    """SimpleMultimediaAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimediaAffiliate:
        """Test SimpleMultimediaAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimediaAffiliate`
        """
        model = SimpleMultimediaAffiliate()
        if include_optional:
            return SimpleMultimediaAffiliate(
    ...
    def testSimpleMultimediaAffiliate(self):
        """Test SimpleMultimediaAffiliate"""
