...
class TestSalesChannelAffiliate(unittest.TestCase):
    """SalesChannelAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelAffiliate:
        """Test SalesChannelAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelAffiliate`
        """
        model = SalesChannelAffiliate()
        if include_optional:
            return SalesChannelAffiliate(
                identifier = '',
                supplier_identifier = '',
    ...
    def testSalesChannelAffiliate(self):
        """Test SalesChannelAffiliate"""
