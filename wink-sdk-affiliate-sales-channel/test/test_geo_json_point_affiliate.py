...
class TestGeoJsonPointAffiliate(unittest.TestCase):
    """GeoJsonPointAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonPointAffiliate:
        """Test GeoJsonPointAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonPointAffiliate`
        """
        model = GeoJsonPointAffiliate()
        if include_optional:
            return GeoJsonPointAffiliate(
                x = 1.337,
                y = 1.337,
                type = '',
                coordinates = [
    ...
    def testGeoJsonPointAffiliate(self):
        """Test GeoJsonPointAffiliate"""
