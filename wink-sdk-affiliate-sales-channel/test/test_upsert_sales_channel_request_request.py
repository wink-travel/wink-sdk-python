...
class TestUpsertSalesChannelRequestRequest(unittest.TestCase):
    """UpsertSalesChannelRequestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSalesChannelRequestRequest:
        """Test UpsertSalesChannelRequestRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSalesChannelRequestRequest`
        """
        model = UpsertSalesChannelRequestRequest()
        if include_optional:
            return UpsertSalesChannelRequestRequest(
    ...
    def testUpsertSalesChannelRequestRequest(self):
        """Test UpsertSalesChannelRequestRequest"""
