...
class TestPageSalesChannelAffiliate(unittest.TestCase):
    """PageSalesChannelAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageSalesChannelAffiliate:
        """Test PageSalesChannelAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageSalesChannelAffiliate`
        """
        model = PageSalesChannelAffiliate()
        if include_optional:
            return PageSalesChannelAffiliate(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
                    wink_sdk_affiliate_sales_channel.models.sales_channel_affiliate.SalesChannel_Affiliate(
                        id = 'doc-1', 
                        ...
                        commission = 0.2, 
                        rate_modifiers = [
                            wink_sdk_affiliate_sales_channel.models.special_rate_lightweight_affiliate.SpecialRateLightweight_Affiliate(
                        ...
                        rate_modifier_bundles = [
                            wink_sdk_affiliate_sales_channel.models.special_rate_bundle_lightweight_affiliate.SpecialRateBundleLightweight_Affiliate(
                                identifier = 'document-1', 
                                hotel_identifier = 'hotel-1', 
    ...
    def testPageSalesChannelAffiliate(self):
        """Test PageSalesChannelAffiliate"""
