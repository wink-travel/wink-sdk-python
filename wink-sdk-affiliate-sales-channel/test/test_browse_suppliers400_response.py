...
class TestBrowseSuppliers400Response(unittest.TestCase):
    """BrowseSuppliers400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrowseSuppliers400Response:
        """Test BrowseSuppliers400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrowseSuppliers400Response`
        """
        model = BrowseSuppliers400Response()
        if include_optional:
            return BrowseSuppliers400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testBrowseSuppliers400Response(self):
        """Test BrowseSuppliers400Response"""
