...
class TestUpsertSalesChannelRelationshipRequestRequest(unittest.TestCase):
    """UpsertSalesChannelRelationshipRequestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSalesChannelRelationshipRequestRequest:
        """Test UpsertSalesChannelRelationshipRequestRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSalesChannelRelationshipRequestRequest`
        """
        model = UpsertSalesChannelRelationshipRequestRequest()
        if include_optional:
            return UpsertSalesChannelRelationshipRequestRequest(
    ...
    def testUpsertSalesChannelRelationshipRequestRequest(self):
        """Test UpsertSalesChannelRelationshipRequestRequest"""
