...
class TestSalesChannelViewAffiliate(unittest.TestCase):
    """SalesChannelViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelViewAffiliate:
        """Test SalesChannelViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelViewAffiliate`
        """
        model = SalesChannelViewAffiliate()
        if include_optional:
            return SalesChannelViewAffiliate(
                id = 'doc-1',
    ...
    def testSalesChannelViewAffiliate(self):
        """Test SalesChannelViewAffiliate"""
