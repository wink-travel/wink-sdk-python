...
class TestRelationshipRequestApi(unittest.TestCase):
    """RelationshipRequestApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RelationshipRequestApi()

    def tearDown(self) -> None:
        pass

    def test_create_supplier_request(self) -> None:
        """Test case for create_supplier_request

        Create Supplier Request
        """
        pass

    def test_re_apply_supplier_request(self) -> None:
        """Test case for re_apply_supplier_request

        Re-apply Supplier Request
        """
        pass

    def test_remove_supplier_request(self) -> None:
        """Test case for remove_supplier_request

        Delete Relationship Request
        """
        pass

    def test_show_supplier_request(self) -> None:
        """Test case for show_supplier_request

        Show Supplier Request
        """
        pass

    def test_show_supplier_requests(self) -> None:
        """Test case for show_supplier_requests
