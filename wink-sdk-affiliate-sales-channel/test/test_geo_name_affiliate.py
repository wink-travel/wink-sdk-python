...
class TestGeoNameAffiliate(unittest.TestCase):
    """GeoNameAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameAffiliate:
        """Test GeoNameAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameAffiliate`
        """
        model = GeoNameAffiliate()
        if include_optional:
            return GeoNameAffiliate(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
