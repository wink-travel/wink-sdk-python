...
class TestPagePropertyAggregateLightweightAffiliate(unittest.TestCase):
    """PagePropertyAggregateLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagePropertyAggregateLightweightAffiliate:
        """Test PagePropertyAggregateLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagePropertyAggregateLightweightAffiliate`
        """
        model = PagePropertyAggregateLightweightAffiliate()
        if include_optional:
            return PagePropertyAggregateLightweightAffiliate(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
                    wink_sdk_affiliate_sales_channel.models.property_aggregate_lightweight_affiliate.PropertyAggregateLightweight_Affiliate(
                        ...
                        descriptions = [
                            wink_sdk_affiliate_sales_channel.models.simple_description_affiliate.SimpleDescription_Affiliate(
                        ...
                        total_reviews = 989, 
                        reservations = wink_sdk_affiliate_sales_channel.models.contact_affiliate.Contact_Affiliate(
                            first_name = 'John', 
                            last_name = 'Smith', 
                        ...
                        socials = [
                            wink_sdk_affiliate_sales_channel.models.social_affiliate.Social_Affiliate(
                                type = 'FACEBOOK', 
                                location = '', )
                            ], 
                        images = [
                            wink_sdk_affiliate_sales_channel.models.simple_multimedia_affiliate.SimpleMultimedia_Affiliate(
                                ...
                                attribution = [
                                    wink_sdk_affiliate_sales_channel.models.image_attribution_affiliate.ImageAttribution_Affiliate(
                        ...
                        policy = wink_sdk_affiliate_sales_channel.models.property_policy_affiliate.PropertyPolicy_Affiliate(
                            ...
                            pet_charge = wink_sdk_affiliate_sales_channel.models.custom_monetary_amount.CustomMonetaryAmount(
                                amount = 1.337, 
                                currency = '0', ), 
                            check_out_time = '10:00', 
                            check_in_time = '14:00', ), 
                        third_party_reviews = [
                            wink_sdk_affiliate_sales_channel.models.travel_inventory_recognition_affiliate.TravelInventoryRecognition_Affiliate(
                        ...
                        spas = 1, 
                        add_ons = 5, 
                        general_manager = wink_sdk_affiliate_sales_channel.models.general_manager_affiliate.GeneralManager_Affiliate(
                            name = 'Jane Doe', 
                            image = cl-image-1, ), 
                        ...
                        number_of_rooms = 32, 
                        address = wink_sdk_affiliate_sales_channel.models.simple_address_affiliate.SimpleAddress_Affiliate(
                            address1 = '234', 
                ...
                sort = wink_sdk_affiliate_sales_channel.models.sort_object_affiliate.SortObject_Affiliate(
                    empty = True, 
                    unsorted = True, 
                    sorted = True, ),
    ...
    def testPagePropertyAggregateLightweightAffiliate(self):
        """Test PagePropertyAggregateLightweightAffiliate"""
