...
class TestSalesChannelRelationshipRequestAffiliate(unittest.TestCase):
    """SalesChannelRelationshipRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelRelationshipRequestAffiliate:
        """Test SalesChannelRelationshipRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelRelationshipRequestAffiliate`
        """
        model = SalesChannelRelationshipRequestAffiliate()
        if include_optional:
            return SalesChannelRelationshipRequestAffiliate(
                identifier = '',
                status = 'REQUESTING',
    ...
    def testSalesChannelRelationshipRequestAffiliate(self):
        """Test SalesChannelRelationshipRequestAffiliate"""
