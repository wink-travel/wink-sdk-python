...
class TestPropertyPolicyAffiliate(unittest.TestCase):
    """PropertyPolicyAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyPolicyAffiliate:
        """Test PropertyPolicyAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyPolicyAffiliate`
        """
        model = PropertyPolicyAffiliate()
        if include_optional:
            return PropertyPolicyAffiliate(
    ...
    def testPropertyPolicyAffiliate(self):
        """Test PropertyPolicyAffiliate"""
