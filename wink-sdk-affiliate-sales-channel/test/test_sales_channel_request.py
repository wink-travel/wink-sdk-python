...
class TestSalesChannelRequest(unittest.TestCase):
    """SalesChannelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelRequest:
        """Test SalesChannelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelRequest`
        """
        model = SalesChannelRequest()
        if include_optional:
    ...
    def testSalesChannelRequest(self):
        """Test SalesChannelRequest"""
