...
class TestAggregateDescriptorAffiliate(unittest.TestCase):
    """AggregateDescriptorAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateDescriptorAffiliate:
        """Test AggregateDescriptorAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateDescriptorAffiliate`
        """
        model = AggregateDescriptorAffiliate()
        if include_optional:
            return AggregateDescriptorAffiliate(
    ...
    def testAggregateDescriptorAffiliate(self):
        """Test AggregateDescriptorAffiliate"""
