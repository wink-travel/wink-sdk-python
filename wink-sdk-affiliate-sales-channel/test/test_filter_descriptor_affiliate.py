...
class TestFilterDescriptorAffiliate(unittest.TestCase):
    """FilterDescriptorAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterDescriptorAffiliate:
        """Test FilterDescriptorAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterDescriptorAffiliate`
        """
        model = FilterDescriptorAffiliate()
        if include_optional:
            return FilterDescriptorAffiliate(
    ...
    def testFilterDescriptorAffiliate(self):
        """Test FilterDescriptorAffiliate"""
