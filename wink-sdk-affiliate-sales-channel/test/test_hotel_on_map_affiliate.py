...
class TestHotelOnMapAffiliate(unittest.TestCase):
    """HotelOnMapAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelOnMapAffiliate:
        """Test HotelOnMapAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelOnMapAffiliate`
        """
        model = HotelOnMapAffiliate()
        if include_optional:
            return HotelOnMapAffiliate(
    ...
    def testHotelOnMapAffiliate(self):
        """Test HotelOnMapAffiliate"""
