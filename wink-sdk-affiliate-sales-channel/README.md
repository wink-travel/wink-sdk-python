...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.48#egg=wink_sdk_affiliate_sales_channel&subdirectory=wink-sdk-affiliate-sales-channel
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.48#egg=wink_sdk_affiliate_sales_channel&subdirectory=wink_sdk_affiliate_sales_channel`)
