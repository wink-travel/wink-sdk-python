...
class TestAggregateDescriptorAgent(unittest.TestCase):
    """AggregateDescriptorAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateDescriptorAgent:
        """Test AggregateDescriptorAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateDescriptorAgent`
        """
        model = AggregateDescriptorAgent()
        if include_optional:
            return AggregateDescriptorAgent(
    ...
    def testAggregateDescriptorAgent(self):
        """Test AggregateDescriptorAgent"""
