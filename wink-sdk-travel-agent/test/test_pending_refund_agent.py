...
class TestPendingRefundAgent(unittest.TestCase):
    """PendingRefundAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingRefundAgent:
        """Test PendingRefundAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingRefundAgent`
        """
        model = PendingRefundAgent()
        if include_optional:
            return PendingRefundAgent(
    ...
    def testPendingRefundAgent(self):
        """Test PendingRefundAgent"""
