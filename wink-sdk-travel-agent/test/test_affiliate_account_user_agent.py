...
class TestAffiliateAccountUserAgent(unittest.TestCase):
    """AffiliateAccountUserAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AffiliateAccountUserAgent:
        """Test AffiliateAccountUserAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AffiliateAccountUserAgent`
        """
        model = AffiliateAccountUserAgent()
        if include_optional:
            return AffiliateAccountUserAgent(
    ...
    def testAffiliateAccountUserAgent(self):
        """Test AffiliateAccountUserAgent"""
