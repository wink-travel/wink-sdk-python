...
class TestCreateAgentBooking400Response(unittest.TestCase):
    """CreateAgentBooking400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAgentBooking400Response:
        """Test CreateAgentBooking400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAgentBooking400Response`
        """
        model = CreateAgentBooking400Response()
        if include_optional:
            return CreateAgentBooking400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testCreateAgentBooking400Response(self):
        """Test CreateAgentBooking400Response"""
