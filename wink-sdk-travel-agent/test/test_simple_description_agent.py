...
class TestSimpleDescriptionAgent(unittest.TestCase):
    """SimpleDescriptionAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDescriptionAgent:
        """Test SimpleDescriptionAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDescriptionAgent`
        """
        model = SimpleDescriptionAgent()
        if include_optional:
            return SimpleDescriptionAgent(
    ...
    def testSimpleDescriptionAgent(self):
        """Test SimpleDescriptionAgent"""
