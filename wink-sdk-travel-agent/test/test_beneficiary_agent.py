...
class TestBeneficiaryAgent(unittest.TestCase):
    """BeneficiaryAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryAgent:
        """Test BeneficiaryAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryAgent`
        """
        model = BeneficiaryAgent()
        if include_optional:
