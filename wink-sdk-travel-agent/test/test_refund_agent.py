...
class TestRefundAgent(unittest.TestCase):
    """RefundAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundAgent:
        """Test RefundAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundAgent`
        """
        model = RefundAgent()
        if include_optional:
            return RefundAgent(
