...
class TestEngineConfigurationThemeAgent(unittest.TestCase):
    """EngineConfigurationThemeAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeAgent:
        """Test EngineConfigurationThemeAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeAgent`
        """
        model = EngineConfigurationThemeAgent()
        if include_optional:
            return EngineConfigurationThemeAgent(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeAgent(self):
        """Test EngineConfigurationThemeAgent"""
