...
class TestBedroomConfigurationAgent(unittest.TestCase):
    """BedroomConfigurationAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomConfigurationAgent:
        """Test BedroomConfigurationAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomConfigurationAgent`
        """
        model = BedroomConfigurationAgent()
        if include_optional:
            return BedroomConfigurationAgent(
                identifier = '',
                name = '',
                bedroom_list = [
    ...
    def testBedroomConfigurationAgent(self):
        """Test BedroomConfigurationAgent"""
