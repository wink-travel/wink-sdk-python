...
class TestExtraChargeAgent(unittest.TestCase):
    """ExtraChargeAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargeAgent:
        """Test ExtraChargeAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargeAgent`
        """
        model = ExtraChargeAgent()
        if include_optional:
            return ExtraChargeAgent(
