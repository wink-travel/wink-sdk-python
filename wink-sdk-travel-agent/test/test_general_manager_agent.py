...
class TestGeneralManagerAgent(unittest.TestCase):
    """GeneralManagerAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralManagerAgent:
        """Test GeneralManagerAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralManagerAgent`
        """
        model = GeneralManagerAgent()
        if include_optional:
    ...
    def testGeneralManagerAgent(self):
        """Test GeneralManagerAgent"""
