...
class TestPerkLightweightAgent(unittest.TestCase):
    """PerkLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerkLightweightAgent:
        """Test PerkLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerkLightweightAgent`
        """
        model = PerkLightweightAgent()
        if include_optional:
            return PerkLightweightAgent(
                identifier = '',
                guaranteed = True,
                level = 56,
                descriptions = [
    ...
    def testPerkLightweightAgent(self):
        """Test PerkLightweightAgent"""
