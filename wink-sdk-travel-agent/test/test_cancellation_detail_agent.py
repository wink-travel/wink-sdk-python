...
class TestCancellationDetailAgent(unittest.TestCase):
    """CancellationDetailAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationDetailAgent:
        """Test CancellationDetailAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationDetailAgent`
        """
        model = CancellationDetailAgent()
        if include_optional:
            return CancellationDetailAgent(
    ...
    def testCancellationDetailAgent(self):
        """Test CancellationDetailAgent"""
