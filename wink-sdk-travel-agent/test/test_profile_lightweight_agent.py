...
class TestProfileLightweightAgent(unittest.TestCase):
    """ProfileLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileLightweightAgent:
        """Test ProfileLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileLightweightAgent`
        """
        model = ProfileLightweightAgent()
        if include_optional:
            return ProfileLightweightAgent(
    ...
    def testProfileLightweightAgent(self):
        """Test ProfileLightweightAgent"""
