...
class TestGroupDescriptorAgent(unittest.TestCase):
    """GroupDescriptorAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupDescriptorAgent:
        """Test GroupDescriptorAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupDescriptorAgent`
        """
        model = GroupDescriptorAgent()
        if include_optional:
            return GroupDescriptorAgent(
    ...
    def testGroupDescriptorAgent(self):
        """Test GroupDescriptorAgent"""
