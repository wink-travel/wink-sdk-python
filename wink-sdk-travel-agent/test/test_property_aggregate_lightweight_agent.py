...
class TestPropertyAggregateLightweightAgent(unittest.TestCase):
    """PropertyAggregateLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateLightweightAgent:
        """Test PropertyAggregateLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateLightweightAgent`
        """
        model = PropertyAggregateLightweightAgent()
        if include_optional:
            return PropertyAggregateLightweightAgent(
    ...
    def testPropertyAggregateLightweightAgent(self):
        """Test PropertyAggregateLightweightAgent"""
