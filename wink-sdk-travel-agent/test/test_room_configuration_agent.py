...
class TestRoomConfigurationAgent(unittest.TestCase):
    """RoomConfigurationAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationAgent:
        """Test RoomConfigurationAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationAgent`
        """
        model = RoomConfigurationAgent()
        if include_optional:
            return RoomConfigurationAgent(
                adults = 2,
                children = [
    ...
    def testRoomConfigurationAgent(self):
        """Test RoomConfigurationAgent"""
