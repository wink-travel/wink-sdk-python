...
class TestPreferencesAgent(unittest.TestCase):
    """PreferencesAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreferencesAgent:
        """Test PreferencesAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreferencesAgent`
        """
        model = PreferencesAgent()
        if include_optional:
