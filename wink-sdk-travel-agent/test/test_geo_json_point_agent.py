...
class TestGeoJsonPointAgent(unittest.TestCase):
    """GeoJsonPointAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonPointAgent:
        """Test GeoJsonPointAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonPointAgent`
        """
        model = GeoJsonPointAgent()
        if include_optional:
            return GeoJsonPointAgent(
                x = 1.337,
                y = 1.337,
                type = '',
                coordinates = [
    ...
    def testGeoJsonPointAgent(self):
        """Test GeoJsonPointAgent"""
