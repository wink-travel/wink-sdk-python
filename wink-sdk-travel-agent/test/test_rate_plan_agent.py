...
class TestRatePlanAgent(unittest.TestCase):
    """RatePlanAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanAgent:
        """Test RatePlanAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanAgent`
        """
        model = RatePlanAgent()
        if include_optional:
            return RatePlanAgent(
                identifier = '',
                hotel_identifier = '',
                name = 'BAR 1',
                prepaid = False,
                ...
                arrival_days_of_week = wink_sdk_travel_agent.models.dow_pattern_group_agent.DowPatternGroup_Agent(
                    ...
                    sun = True, 
                    disabled = True, ),
                departure_days_of_week = wink_sdk_travel_agent.models.dow_pattern_group_agent.DowPatternGroup_Agent(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                required_days_of_week = wink_sdk_travel_agent.models.dow_pattern_group_agent.DowPatternGroup_Agent(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
