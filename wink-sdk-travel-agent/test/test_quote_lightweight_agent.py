...
class TestQuoteLightweightAgent(unittest.TestCase):
    """QuoteLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLightweightAgent:
        """Test QuoteLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLightweightAgent`
        """
        model = QuoteLightweightAgent()
        if include_optional:
            return QuoteLightweightAgent(
                source = '0',
                target = '0',
                exchange_rate = 1.337,
                timestamp = 56
    ...
    def testQuoteLightweightAgent(self):
        """Test QuoteLightweightAgent"""
