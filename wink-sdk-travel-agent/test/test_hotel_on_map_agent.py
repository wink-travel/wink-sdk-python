...
class TestHotelOnMapAgent(unittest.TestCase):
    """HotelOnMapAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelOnMapAgent:
        """Test HotelOnMapAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelOnMapAgent`
        """
        model = HotelOnMapAgent()
        if include_optional:
            return HotelOnMapAgent(
                ...
                general_manager = wink_sdk_travel_agent.models.general_manager_agent.GeneralManager_Agent(
                    name = 'Jane Doe', 
                    image = wink_sdk_travel_agent.models.simple_multimedia_agent.SimpleMultimedia_Agent(
                        multimedia_identifier = '', 
                        identifier = 'cloudinary-image-1', 
                        type = 'IMAGE', 
                        source = 'CLOUDINARY', 
