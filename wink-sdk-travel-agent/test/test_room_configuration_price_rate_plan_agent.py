...
class TestRoomConfigurationPriceRatePlanAgent(unittest.TestCase):
    """RoomConfigurationPriceRatePlanAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceRatePlanAgent:
        """Test RoomConfigurationPriceRatePlanAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationPriceRatePlanAgent`
        """
        model = RoomConfigurationPriceRatePlanAgent()
        if include_optional:
            return RoomConfigurationPriceRatePlanAgent(
                identifier = '',
                name = 'BAR 1',
                breakfast = False,
                brunch = False,
    ...
    def testRoomConfigurationPriceRatePlanAgent(self):
        """Test RoomConfigurationPriceRatePlanAgent"""
