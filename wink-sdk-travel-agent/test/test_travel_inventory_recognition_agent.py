...
class TestTravelInventoryRecognitionAgent(unittest.TestCase):
    """TravelInventoryRecognitionAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelInventoryRecognitionAgent:
        """Test TravelInventoryRecognitionAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelInventoryRecognitionAgent`
        """
        model = TravelInventoryRecognitionAgent()
        if include_optional:
            return TravelInventoryRecognitionAgent(
                identifier = '',
                category = 'AWARD',
                type = 'PERCENT_RATING',
                provider = 'Michelin',
    ...
    def testTravelInventoryRecognitionAgent(self):
        """Test TravelInventoryRecognitionAgent"""
