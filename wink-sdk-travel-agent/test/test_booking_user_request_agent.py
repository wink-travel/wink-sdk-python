...
class TestBookingUserRequestAgent(unittest.TestCase):
    """BookingUserRequestAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserRequestAgent:
        """Test BookingUserRequestAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserRequestAgent`
        """
        model = BookingUserRequestAgent()
        if include_optional:
            return BookingUserRequestAgent(
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testBookingUserRequestAgent(self):
        """Test BookingUserRequestAgent"""
