...
class TestBookingAncillaryAgent(unittest.TestCase):
    """BookingAncillaryAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingAncillaryAgent:
        """Test BookingAncillaryAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingAncillaryAgent`
        """
        model = BookingAncillaryAgent()
        if include_optional:
            return BookingAncillaryAgent(
                identifier = '',
                hotel_identifier = '',
                type_identifier = '',
    ...
    def testBookingAncillaryAgent(self):
        """Test BookingAncillaryAgent"""
