...
class TestReviewAnswerAgent(unittest.TestCase):
    """ReviewAnswerAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewAnswerAgent:
        """Test ReviewAnswerAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAnswerAgent`
        """
        model = ReviewAnswerAgent()
        if include_optional:
            return ReviewAnswerAgent(
                question_identifier = '',
                category = 'COMFORT',
                sort = 56,
                value = 56
    ...
    def testReviewAnswerAgent(self):
        """Test ReviewAnswerAgent"""
