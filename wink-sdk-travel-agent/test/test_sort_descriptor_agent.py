...
class TestSortDescriptorAgent(unittest.TestCase):
    """SortDescriptorAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortDescriptorAgent:
        """Test SortDescriptorAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortDescriptorAgent`
        """
        model = SortDescriptorAgent()
        if include_optional:
            return SortDescriptorAgent(
                dir = 'asc',
    ...
    def testSortDescriptorAgent(self):
        """Test SortDescriptorAgent"""
