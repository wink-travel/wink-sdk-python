...
class TestCountryAgent(unittest.TestCase):
    """CountryAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryAgent:
        """Test CountryAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryAgent`
        """
        model = CountryAgent()
        if include_optional:
            return CountryAgent(
