...
class TestCustomizationThemeColorsAgent(unittest.TestCase):
    """CustomizationThemeColorsAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationThemeColorsAgent:
        """Test CustomizationThemeColorsAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationThemeColorsAgent`
        """
        model = CustomizationThemeColorsAgent()
        if include_optional:
            return CustomizationThemeColorsAgent(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testCustomizationThemeColorsAgent(self):
        """Test CustomizationThemeColorsAgent"""
