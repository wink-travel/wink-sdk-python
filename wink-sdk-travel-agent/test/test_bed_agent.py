...
class TestBedAgent(unittest.TestCase):
    """BedAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedAgent:
        """Test BedAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedAgent`
        """
        model = BedAgent()
        if include_optional:
            return BedAgent(
