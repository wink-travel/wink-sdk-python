...
class TestPageableObjectAgent(unittest.TestCase):
    """PageableObjectAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageableObjectAgent:
        """Test PageableObjectAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageableObjectAgent`
        """
        model = PageableObjectAgent()
        if include_optional:
            return PageableObjectAgent(
                offset = 56,
                sort = [
    ...
    def testPageableObjectAgent(self):
        """Test PageableObjectAgent"""
