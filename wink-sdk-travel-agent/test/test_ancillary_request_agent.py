...
class TestAncillaryRequestAgent(unittest.TestCase):
    """AncillaryRequestAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AncillaryRequestAgent:
        """Test AncillaryRequestAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AncillaryRequestAgent`
        """
        model = AncillaryRequestAgent()
        if include_optional:
            return AncillaryRequestAgent(
                type_identifier = '',
    ...
    def testAncillaryRequestAgent(self):
        """Test AncillaryRequestAgent"""
