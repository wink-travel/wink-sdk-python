...
class TestQuoteAgent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QuoteAgent:
        """Test QuoteAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteAgent`
        """
        model = QuoteAgent()
        if include_optional:
            return QuoteAgent(
