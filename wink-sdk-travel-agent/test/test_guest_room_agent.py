...
class TestGuestRoomAgent(unittest.TestCase):
    """GuestRoomAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomAgent:
        """Test GuestRoomAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomAgent`
        """
        model = GuestRoomAgent()
        if include_optional:
            return GuestRoomAgent(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
