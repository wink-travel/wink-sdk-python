...
class TestBookingViewAgent(unittest.TestCase):
    """BookingViewAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingViewAgent:
        """Test BookingViewAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingViewAgent`
        """
        model = BookingViewAgent()
        if include_optional:
