...
class TestCancellationPolicyLightweightAgent(unittest.TestCase):
    """CancellationPolicyLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyLightweightAgent:
        """Test CancellationPolicyLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyLightweightAgent`
        """
        model = CancellationPolicyLightweightAgent()
        if include_optional:
            return CancellationPolicyLightweightAgent(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyLightweightAgent(self):
        """Test CancellationPolicyLightweightAgent"""
