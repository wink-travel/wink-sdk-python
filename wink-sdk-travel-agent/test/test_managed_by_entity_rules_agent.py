...
class TestManagedByEntityRulesAgent(unittest.TestCase):
    """ManagedByEntityRulesAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedByEntityRulesAgent:
        """Test ManagedByEntityRulesAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedByEntityRulesAgent`
        """
        model = ManagedByEntityRulesAgent()
        if include_optional:
            return ManagedByEntityRulesAgent(
    ...
    def testManagedByEntityRulesAgent(self):
        """Test ManagedByEntityRulesAgent"""
