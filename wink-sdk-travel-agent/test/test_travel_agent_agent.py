...
class TestTravelAgentAgent(unittest.TestCase):
    """TravelAgentAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelAgentAgent:
        """Test TravelAgentAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelAgentAgent`
        """
        model = TravelAgentAgent()
        if include_optional:
            return TravelAgentAgent(
                self_acquires = True,
                self_disburses = True
            )
        else:
