...
class TestProfileAgent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProfileAgent:
        """Test ProfileAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileAgent`
        """
        model = ProfileAgent()
        if include_optional:
            return ProfileAgent(
