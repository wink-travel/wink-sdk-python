...
class TestLocalizedDescriptionAgent(unittest.TestCase):
    """LocalizedDescriptionAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedDescriptionAgent:
        """Test LocalizedDescriptionAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedDescriptionAgent`
        """
        model = LocalizedDescriptionAgent()
        if include_optional:
            return LocalizedDescriptionAgent(
    ...
    def testLocalizedDescriptionAgent(self):
        """Test LocalizedDescriptionAgent"""
