...
class TestPageBookingAgent(unittest.TestCase):
    """PageBookingAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageBookingAgent:
        """Test PageBookingAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageBookingAgent`
        """
        model = PageBookingAgent()
        if include_optional:
            return PageBookingAgent(
                ...
                size = 56,
                content = [
                    wink_sdk_travel_agent.models.booking_agent.Booking_Agent(
                        id = 'doc-1', 
                        ...
                        customization = wink_sdk_travel_agent.models.customization_lightweight_agent.CustomizationLightweight_Agent(
                            ...
                            self_hosted = True, 
                            theme_colors = wink_sdk_travel_agent.models.customization_theme_colors_agent.CustomizationThemeColors_Agent(
                                primary = '#dc3545', 
                                secondary = '#6c757d', 
                                success = '#28a745', 
                                danger = '#dc3545', 
                            ...
                            end_date = '2021-12-31', 
                            room_configurations = [
                                wink_sdk_travel_agent.models.room_configuration_agent.RoomConfiguration_Agent(
                                    adults = 2, 
                                    children = [
                                        wink_sdk_travel_agent.models.child_agent.Child_Agent(
                                            quantity = 1, 
                                            age = 0, )
                                        ], )
                                ], 
                            ...
                            city = wink_sdk_travel_agent.models.geo_name_lightweight_agent.GeoNameLightweight_Agent(
                                geo_name_id = '5128581', 
                                type = 'CITY', 
                                name = 'New York City', 
                                ...
                                country = wink_sdk_travel_agent.models.country_lightweight_agent.CountryLightweight_Agent(
                                    iso = 'US', 
                                    name = 'United States', 
                                    capital = 'Washington', 
                                    continent = 'NA', 
                                    ...
                                    geo_name_id = '6252001', ), 
                                sub_country = wink_sdk_travel_agent.models.sub_country_lightweight_agent.SubCountryLightweight_Agent(
                                    name = 'New York', 
                                    ascii_name = 'New York', 
                                    geo_name_id = '5128638', ), 
                                sub_sub_country = wink_sdk_travel_agent.models.sub_sub_country_lightweight_agent.SubSubCountryLightweight_Agent(
                                    name = '', 
                                    ascii_name = '', 
                                    geo_name_id = '', ), ), 
                        ...
                        user = wink_sdk_travel_agent.models.booking_user_agent.BookingUser_Agent(
                            user_identifier = '', 
                            first_name = 'John', 
                            last_name = 'Smith', 
                        ...
                        user_session = wink_sdk_travel_agent.models.booking_user_session_agent.BookingUserSession_Agent(
                            itinerary = wink_sdk_travel_agent.models.booking_itinerary_agent.BookingItinerary_Agent(
                                start_date = '2024-01-01', 
                                end_date = '2024-01-02', 
                                nights = 56, 
                                items = [
                                    wink_sdk_travel_agent.models.booking_itinerary_room_configuration_agent.BookingItineraryRoomConfiguration_Agent(
                                        adults = 2, )
                                    ], 
                                hours = 56, 
                                rooms = 56, 
                        ...
                        review = wink_sdk_travel_agent.models.review_lightweight_agent.ReviewLightweight_Agent(
                            identifier = 'review-1', 
                            ...
                            average_score = 8.7, 
                            answers = [
                                wink_sdk_travel_agent.models.review_answer_agent.ReviewAnswer_Agent(
                        ...
                        logo_identifier = '', 
                        hotel = wink_sdk_travel_agent.models.property_aggregate_lightweight_agent.PropertyAggregateLightweight_Agent(
                            hotel_identifier = 'hotel-1', 
                            ...
                            total_reviews = 989, 
                            reservations = wink_sdk_travel_agent.models.contact_agent.Contact_Agent(
                                first_name = 'John', 
                                last_name = 'Smith', 
                            ...
                            spas = 1, 
                            add_ons = 5, 
                            general_manager = wink_sdk_travel_agent.models.general_manager_agent.GeneralManager_Agent(
                                name = 'Jane Doe', 
                                image = cl-image-1, ), 
                            ...
                            active = True, 
                            url_parameters = '', ), 
                        room_stay = wink_sdk_travel_agent.models.room_stay_agent.RoomStay_Agent(
                            policy = wink_sdk_travel_agent.models.property_policy_agent.PropertyPolicy_Agent(
                                children_allowed = True, 
                                children_minimum_age = 6, 
                                internet_availability = 'YES', 
                                ...
                                check_out_time = '10:00', 
                                check_in_time = '14:00', ), 
                            room = wink_sdk_travel_agent.models.guest_room_lightweight_agent.GuestRoomLightweight_Agent(
                            ...
                            price = wink_sdk_travel_agent.models.stay_rate_agent.StayRate_Agent(
                                ...
                                available = True, 
                                source_to_user_currency_quote = wink_sdk_travel_agent.models.quote_lightweight_agent.QuoteLightweight_Agent(
                                    source = '0', 
                                    target = '0', 
                                    exchange_rate = 1.337, 
                                    timestamp = 56, ), 
                                source_to_internal_currency_quote = wink_sdk_travel_agent.models.quote_lightweight_agent.QuoteLightweight_Agent(
                                    source = '0', 
                                    target = '0', 
                                    exchange_rate = 1.337, 
                                    timestamp = 56, ), 
                            ...
                            rate_plan = wink_sdk_travel_agent.models.room_configuration_price_rate_plan_agent.RoomConfigurationPriceRatePlan_Agent(
                                identifier = '0', 
                                name = 'BAR 1', 
                                breakfast = False, 
                                brunch = False, 
                                ...
                                cancellation_policy = wink_sdk_travel_agent.models.cancellation_policy_lightweight_agent.CancellationPolicyLightweight_Agent(
                                    identifier = '', 
                                    hotel_identifier = '', 
                                    refundable = False, 
                        ...
                        commission_list = [
                            wink_sdk_travel_agent.models.commissionable_entry_agent.CommissionableEntry_Agent(
                                name = '0', 
                                identifier = '0', 
                                type = 'GUEST_ROOM', 
                        ...
                        ancillary_list = [
                            wink_sdk_travel_agent.models.booking_ancillary_agent.BookingAncillary_Agent(
                        ...
                        booking_contract = wink_sdk_travel_agent.models.booking_contract_agent.BookingContract_Agent(
                ...
                sort = wink_sdk_travel_agent.models.sort_object_agent.SortObject_Agent(
                    empty = True, 
                    sorted = True, 
                    unsorted = True, ),
                pageable = wink_sdk_travel_agent.models.pageable_object_agent.PageableObject_Agent(
                    offset = 56, 
                    unpaged = True, 
                    sort = wink_sdk_travel_agent.models.sort_object_agent.SortObject_Agent(
                        empty = True, 
