...
class TestBookingContractItemAgent(unittest.TestCase):
    """BookingContractItemAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractItemAgent:
        """Test BookingContractItemAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractItemAgent`
        """
        model = BookingContractItemAgent()
        if include_optional:
            return BookingContractItemAgent(
    ...
    def testBookingContractItemAgent(self):
        """Test BookingContractItemAgent"""
