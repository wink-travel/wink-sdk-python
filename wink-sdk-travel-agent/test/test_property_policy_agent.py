...
class TestPropertyPolicyAgent(unittest.TestCase):
    """PropertyPolicyAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyPolicyAgent:
        """Test PropertyPolicyAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyPolicyAgent`
        """
        model = PropertyPolicyAgent()
        if include_optional:
            return PropertyPolicyAgent(
    ...
    def testPropertyPolicyAgent(self):
        """Test PropertyPolicyAgent"""
