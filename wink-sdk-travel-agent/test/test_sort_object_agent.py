...
class TestSortObjectAgent(unittest.TestCase):
    """SortObjectAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortObjectAgent:
        """Test SortObjectAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortObjectAgent`
        """
        model = SortObjectAgent()
        if include_optional:
            return SortObjectAgent(
                empty = True,
                sorted = True,
                unsorted = True
            )
