...
class TestCancellationPolicyExceptionsAgent(unittest.TestCase):
    """CancellationPolicyExceptionsAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionsAgent:
        """Test CancellationPolicyExceptionsAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionsAgent`
        """
        model = CancellationPolicyExceptionsAgent()
        if include_optional:
            return CancellationPolicyExceptionsAgent(
                list = [
    ...
    def testCancellationPolicyExceptionsAgent(self):
        """Test CancellationPolicyExceptionsAgent"""
