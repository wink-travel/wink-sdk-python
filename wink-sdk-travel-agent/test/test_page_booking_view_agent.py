...
class TestPageBookingViewAgent(unittest.TestCase):
    """PageBookingViewAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageBookingViewAgent:
        """Test PageBookingViewAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageBookingViewAgent`
        """
        model = PageBookingViewAgent()
        if include_optional:
            return PageBookingViewAgent(
                ...
                size = 56,
                content = [
                    wink_sdk_travel_agent.models.booking_view_agent.BookingView_Agent(
                        id = 'doc-1', 
                        created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        version = 12, 
                        booking = wink_sdk_travel_agent.models.booking_agent.Booking_Agent(
                            creation = 'NORMAL', 
                            date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            group_identifier = '', 
                            identifier = '', 
                            engine_configuration = wink_sdk_travel_agent.models.engine_configuration_booking_report_agent.EngineConfigurationBookingReport_Agent(
                                identifier = '', 
                                ...
                                self_hosted = True, 
                                theme_colors = wink_sdk_travel_agent.models.engine_configuration_theme_agent.EngineConfigurationTheme_Agent(
                                    primary = '#dc3545', 
                                    secondary = '#6c757d', 
                                    success = '#28a745', 
                                    danger = '#dc3545', 
                            ...
                            server_url = '', 
                            contact_info = wink_sdk_travel_agent.models.contact_agent.Contact_Agent(
                                first_name = 'John', 
                                last_name = 'Smith', 
                            ...
                            review = wink_sdk_travel_agent.models.review_agent.Review_Agent(
                                identifier = '', 
                                booking_identifier = '', 
                                hotel_identifier = '', 
                            ...
                            logo_identifier = '', 
                            hotel = wink_sdk_travel_agent.models.hotel_on_map_agent.HotelOnMap_Agent(
                            ...
                            reporting_daily_rate_list = [
                                wink_sdk_travel_agent.models.reporting_daily_rate_agent.ReportingDailyRate_Agent(
                            ...
                            reporting_ancillary_list = [
                                wink_sdk_travel_agent.models.reporting_ancillary_agent.ReportingAncillary_Agent(
                                    name = '', 
                                    type = 'LODGING', 
                                    gross_amount = 1.337, 
                                    net_amount = 1.337, 
                            ...
                            reporting_extra_charge_list = [
                                wink_sdk_travel_agent.models.reporting_extra_charge_agent.ReportingExtraCharge_Agent(
                                    name = '', 
                                    description = '', 
                                    gross_amount = 1.337, 
                                    net_amount = 1.337, 
                ...
                number = 56,
                sort = [
                    wink_sdk_travel_agent.models.sort_object.SortObject(
                        direction = '', 
                        null_handling = '', 
                        ascending = True, 
                        property = '', 
    ...
    def testPageBookingViewAgent(self):
        """Test PageBookingViewAgent"""
