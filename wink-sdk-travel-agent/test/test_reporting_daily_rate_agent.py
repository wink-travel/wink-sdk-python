...
class TestReportingDailyRateAgent(unittest.TestCase):
    """ReportingDailyRateAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingDailyRateAgent:
        """Test ReportingDailyRateAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingDailyRateAgent`
        """
        model = ReportingDailyRateAgent()
        if include_optional:
            return ReportingDailyRateAgent(
    ...
    def testReportingDailyRateAgent(self):
        """Test ReportingDailyRateAgent"""
