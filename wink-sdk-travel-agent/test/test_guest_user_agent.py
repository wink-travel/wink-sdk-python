...
class TestGuestUserAgent(unittest.TestCase):
    """GuestUserAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestUserAgent:
        """Test GuestUserAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestUserAgent`
        """
        model = GuestUserAgent()
        if include_optional:
            return GuestUserAgent(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
