...
class TestBedroomAgent(unittest.TestCase):
    """BedroomAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomAgent:
        """Test BedroomAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomAgent`
        """
        model = BedroomAgent()
        if include_optional:
            return BedroomAgent(
