...
class TestSupplierContractItemPolicyAgent(unittest.TestCase):
    """SupplierContractItemPolicyAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierContractItemPolicyAgent:
        """Test SupplierContractItemPolicyAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierContractItemPolicyAgent`
        """
        model = SupplierContractItemPolicyAgent()
        if include_optional:
            return SupplierContractItemPolicyAgent(
                refundable = True,
    ...
    def testSupplierContractItemPolicyAgent(self):
        """Test SupplierContractItemPolicyAgent"""
