...
class TestBooleanResponseAgent(unittest.TestCase):
    """BooleanResponseAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BooleanResponseAgent:
        """Test BooleanResponseAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BooleanResponseAgent`
        """
        model = BooleanResponseAgent()
        if include_optional:
    ...
    def testBooleanResponseAgent(self):
        """Test BooleanResponseAgent"""
