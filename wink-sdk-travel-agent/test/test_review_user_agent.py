...
class TestReviewUserAgent(unittest.TestCase):
    """ReviewUserAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewUserAgent:
        """Test ReviewUserAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewUserAgent`
        """
        model = ReviewUserAgent()
        if include_optional:
            return ReviewUserAgent(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
