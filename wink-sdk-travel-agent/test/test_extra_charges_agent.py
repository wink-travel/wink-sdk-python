...
class TestExtraChargesAgent(unittest.TestCase):
    """ExtraChargesAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargesAgent:
        """Test ExtraChargesAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargesAgent`
        """
        model = ExtraChargesAgent()
        if include_optional:
            return ExtraChargesAgent(
                items = [
    ...
    def testExtraChargesAgent(self):
        """Test ExtraChargesAgent"""
