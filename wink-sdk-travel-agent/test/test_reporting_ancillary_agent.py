...
class TestReportingAncillaryAgent(unittest.TestCase):
    """ReportingAncillaryAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingAncillaryAgent:
        """Test ReportingAncillaryAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingAncillaryAgent`
        """
        model = ReportingAncillaryAgent()
        if include_optional:
            return ReportingAncillaryAgent(
                name = '',
                type = 'LODGING',
                gross_amount = 1.337,
                net_amount = 1.337,
    ...
    def testReportingAncillaryAgent(self):
        """Test ReportingAncillaryAgent"""
