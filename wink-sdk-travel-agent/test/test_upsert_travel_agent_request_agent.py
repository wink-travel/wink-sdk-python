...
class TestUpsertTravelAgentRequestAgent(unittest.TestCase):
    """UpsertTravelAgentRequestAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertTravelAgentRequestAgent:
        """Test UpsertTravelAgentRequestAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertTravelAgentRequestAgent`
        """
        model = UpsertTravelAgentRequestAgent()
        if include_optional:
            return UpsertTravelAgentRequestAgent(
                self_acquires = True,
                self_disburses = True
            )
        else:
    ...
    def testUpsertTravelAgentRequestAgent(self):
        """Test UpsertTravelAgentRequestAgent"""
