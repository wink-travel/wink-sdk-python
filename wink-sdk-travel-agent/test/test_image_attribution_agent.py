...
class TestImageAttributionAgent(unittest.TestCase):
    """ImageAttributionAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageAttributionAgent:
        """Test ImageAttributionAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAttributionAgent`
        """
        model = ImageAttributionAgent()
        if include_optional:
            return ImageAttributionAgent(
    ...
    def testImageAttributionAgent(self):
        """Test ImageAttributionAgent"""
