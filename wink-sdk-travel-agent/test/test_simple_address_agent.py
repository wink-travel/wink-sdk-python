...
class TestSimpleAddressAgent(unittest.TestCase):
    """SimpleAddressAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleAddressAgent:
        """Test SimpleAddressAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleAddressAgent`
        """
        model = SimpleAddressAgent()
        if include_optional:
            return SimpleAddressAgent(
    ...
    def testSimpleAddressAgent(self):
        """Test SimpleAddressAgent"""
