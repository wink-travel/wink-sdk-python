...
class TestSimpleMultimediaAgent(unittest.TestCase):
    """SimpleMultimediaAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleMultimediaAgent:
        """Test SimpleMultimediaAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleMultimediaAgent`
        """
        model = SimpleMultimediaAgent()
        if include_optional:
            return SimpleMultimediaAgent(
    ...
    def testSimpleMultimediaAgent(self):
        """Test SimpleMultimediaAgent"""
