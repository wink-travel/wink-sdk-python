...
class TestFeeAgent(unittest.TestCase):
    """FeeAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeeAgent:
        """Test FeeAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeeAgent`
        """
        model = FeeAgent()
        if include_optional:
            return FeeAgent(
