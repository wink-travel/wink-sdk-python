...
class TestChildAgent(unittest.TestCase):
    """ChildAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChildAgent:
        """Test ChildAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildAgent`
        """
        model = ChildAgent()
        if include_optional:
            return ChildAgent(
