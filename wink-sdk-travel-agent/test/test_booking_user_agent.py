...
class TestBookingUserAgent(unittest.TestCase):
    """BookingUserAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserAgent:
        """Test BookingUserAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserAgent`
        """
        model = BookingUserAgent()
        if include_optional:
            return BookingUserAgent(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
