...
class TestRatePlanLevelFeeAgent(unittest.TestCase):
    """RatePlanLevelFeeAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanLevelFeeAgent:
        """Test RatePlanLevelFeeAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanLevelFeeAgent`
        """
        model = RatePlanLevelFeeAgent()
        if include_optional:
            return RatePlanLevelFeeAgent(
                descriptions = [
    ...
    def testRatePlanLevelFeeAgent(self):
        """Test RatePlanLevelFeeAgent"""
