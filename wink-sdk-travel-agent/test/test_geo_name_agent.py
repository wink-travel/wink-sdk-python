...
class TestGeoNameAgent(unittest.TestCase):
    """GeoNameAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameAgent:
        """Test GeoNameAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameAgent`
        """
        model = GeoNameAgent()
        if include_optional:
            return GeoNameAgent(
