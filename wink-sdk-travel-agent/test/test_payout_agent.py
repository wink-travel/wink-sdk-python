...
class TestPayoutAgent(unittest.TestCase):
    """PayoutAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutAgent:
        """Test PayoutAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutAgent`
        """
        model = PayoutAgent()
        if include_optional:
            return PayoutAgent(
