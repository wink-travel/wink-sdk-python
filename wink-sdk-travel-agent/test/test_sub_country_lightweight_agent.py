...
class TestSubCountryLightweightAgent(unittest.TestCase):
    """SubCountryLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryLightweightAgent:
        """Test SubCountryLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryLightweightAgent`
        """
        model = SubCountryLightweightAgent()
        if include_optional:
            return SubCountryLightweightAgent(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountryLightweightAgent(self):
        """Test SubCountryLightweightAgent"""
