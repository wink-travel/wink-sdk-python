...
class TestCancellationPolicyAgent(unittest.TestCase):
    """CancellationPolicyAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyAgent:
        """Test CancellationPolicyAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyAgent`
        """
        model = CancellationPolicyAgent()
        if include_optional:
            return CancellationPolicyAgent(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyAgent(self):
        """Test CancellationPolicyAgent"""
