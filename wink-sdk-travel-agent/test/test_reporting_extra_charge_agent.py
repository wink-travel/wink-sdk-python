...
class TestReportingExtraChargeAgent(unittest.TestCase):
    """ReportingExtraChargeAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingExtraChargeAgent:
        """Test ReportingExtraChargeAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingExtraChargeAgent`
        """
        model = ReportingExtraChargeAgent()
        if include_optional:
            return ReportingExtraChargeAgent(
                name = '',
                description = '',
                gross_amount = 1.337,
                net_amount = 1.337,
    ...
    def testReportingExtraChargeAgent(self):
        """Test ReportingExtraChargeAgent"""
