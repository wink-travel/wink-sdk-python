...
class TestBookingAgent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BookingAgent:
        """Test BookingAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingAgent`
        """
        model = BookingAgent()
        if include_optional:
            return BookingAgent(
                ...
                special_requests = '',
                comment = '',
                early_check_in_charge = wink_sdk_travel_agent.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                late_check_out_charge = wink_sdk_travel_agent.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
