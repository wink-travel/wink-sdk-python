...
class TestSubCountryAgent(unittest.TestCase):
    """SubCountryAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryAgent:
        """Test SubCountryAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryAgent`
        """
        model = SubCountryAgent()
        if include_optional:
            return SubCountryAgent(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
