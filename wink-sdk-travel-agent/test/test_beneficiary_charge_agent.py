...
class TestBeneficiaryChargeAgent(unittest.TestCase):
    """BeneficiaryChargeAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryChargeAgent:
        """Test BeneficiaryChargeAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryChargeAgent`
        """
        model = BeneficiaryChargeAgent()
        if include_optional:
            return BeneficiaryChargeAgent(
                type = 'PERCENTAGE',
                percent = 1.337
            )
        else:
    ...
    def testBeneficiaryChargeAgent(self):
        """Test BeneficiaryChargeAgent"""
