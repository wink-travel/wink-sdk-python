...
class TestContactAgent(unittest.TestCase):
    """ContactAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactAgent:
        """Test ContactAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactAgent`
        """
        model = ContactAgent()
        if include_optional:
            return ContactAgent(
