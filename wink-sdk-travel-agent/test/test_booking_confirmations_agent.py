...
class TestBookingConfirmationsAgent(unittest.TestCase):
    """BookingConfirmationsAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingConfirmationsAgent:
        """Test BookingConfirmationsAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingConfirmationsAgent`
        """
        model = BookingConfirmationsAgent()
        if include_optional:
    ...
    def testBookingConfirmationsAgent(self):
        """Test BookingConfirmationsAgent"""
