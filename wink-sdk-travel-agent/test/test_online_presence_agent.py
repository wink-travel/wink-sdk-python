...
class TestOnlinePresenceAgent(unittest.TestCase):
    """OnlinePresenceAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnlinePresenceAgent:
        """Test OnlinePresenceAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnlinePresenceAgent`
        """
        model = OnlinePresenceAgent()
        if include_optional:
            return OnlinePresenceAgent(
                type = 'WINK',
                identifier = '',
                audiences = [
                    'EVERYONE'
    ...
    def testOnlinePresenceAgent(self):
        """Test OnlinePresenceAgent"""
