...
class TestFilterDescriptorAgent(unittest.TestCase):
    """FilterDescriptorAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterDescriptorAgent:
        """Test FilterDescriptorAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterDescriptorAgent`
        """
        model = FilterDescriptorAgent()
        if include_optional:
            return FilterDescriptorAgent(
    ...
    def testFilterDescriptorAgent(self):
        """Test FilterDescriptorAgent"""
