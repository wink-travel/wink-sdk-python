...
class TestCompanyViewAgent(unittest.TestCase):
    """CompanyViewAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyViewAgent:
        """Test CompanyViewAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyViewAgent`
        """
        model = CompanyViewAgent()
        if include_optional:
            return CompanyViewAgent(
                ...
                version = 12,
                company = wink_sdk_travel_agent.models.company_agent.Company_Agent(
                    identifier = '', 
                    user_identifier = '', 
                    owner = wink_sdk_travel_agent.models.company_user_agent.CompanyUser_Agent(
                    ...
                    managers = [
                        wink_sdk_travel_agent.models.company_user_agent.CompanyUser_Agent(
                            email = 'manager@me.com', 
                            status = '+12125551212', 
                            user_identifier = '', 
                            first_name = 'John', 
