...
class TestSocialAgent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SocialAgent:
        """Test SocialAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SocialAgent`
        """
        model = SocialAgent()
        if include_optional:
            return SocialAgent(
