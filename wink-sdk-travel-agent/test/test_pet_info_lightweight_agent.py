...
class TestPetInfoLightweightAgent(unittest.TestCase):
    """PetInfoLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoLightweightAgent:
        """Test PetInfoLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoLightweightAgent`
        """
        model = PetInfoLightweightAgent()
        if include_optional:
            return PetInfoLightweightAgent(
                name = '0',
                type = '0'
            )
        else:
    ...
    def testPetInfoLightweightAgent(self):
        """Test PetInfoLightweightAgent"""
