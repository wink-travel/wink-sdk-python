...
class TestCustomizationLightweightAgent(unittest.TestCase):
    """CustomizationLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationLightweightAgent:
        """Test CustomizationLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationLightweightAgent`
        """
        model = CustomizationLightweightAgent()
        if include_optional:
            return CustomizationLightweightAgent(
    ...
    def testCustomizationLightweightAgent(self):
        """Test CustomizationLightweightAgent"""
