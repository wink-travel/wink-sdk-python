...
class TestBookingContractPaymentDetailsAgent(unittest.TestCase):
    """BookingContractPaymentDetailsAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractPaymentDetailsAgent:
        """Test BookingContractPaymentDetailsAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractPaymentDetailsAgent`
        """
        model = BookingContractPaymentDetailsAgent()
        if include_optional:
            return BookingContractPaymentDetailsAgent(
    ...
    def testBookingContractPaymentDetailsAgent(self):
        """Test BookingContractPaymentDetailsAgent"""
