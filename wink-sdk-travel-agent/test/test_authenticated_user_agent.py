...
class TestAuthenticatedUserAgent(unittest.TestCase):
    """AuthenticatedUserAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticatedUserAgent:
        """Test AuthenticatedUserAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticatedUserAgent`
        """
        model = AuthenticatedUserAgent()
        if include_optional:
    ...
    def testAuthenticatedUserAgent(self):
        """Test AuthenticatedUserAgent"""
