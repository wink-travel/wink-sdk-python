...
class TestSimpleDateTimeItineraryAgent(unittest.TestCase):
    """SimpleDateTimeItineraryAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDateTimeItineraryAgent:
        """Test SimpleDateTimeItineraryAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDateTimeItineraryAgent`
        """
        model = SimpleDateTimeItineraryAgent()
        if include_optional:
            return SimpleDateTimeItineraryAgent(
    ...
    def testSimpleDateTimeItineraryAgent(self):
        """Test SimpleDateTimeItineraryAgent"""
