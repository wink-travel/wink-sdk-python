...
class TestPetInfoDtoAgent(unittest.TestCase):
    """PetInfoDtoAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoDtoAgent:
        """Test PetInfoDtoAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoDtoAgent`
        """
        model = PetInfoDtoAgent()
        if include_optional:
            return PetInfoDtoAgent(
                name = '',
                type = ''
            )
        else:
