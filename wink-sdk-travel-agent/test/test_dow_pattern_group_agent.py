...
class TestDowPatternGroupAgent(unittest.TestCase):
    """DowPatternGroupAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DowPatternGroupAgent:
        """Test DowPatternGroupAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DowPatternGroupAgent`
        """
        model = DowPatternGroupAgent()
        if include_optional:
            return DowPatternGroupAgent(
                mon = True,
                tue = True,
                wed = True,
                thu = True,
    ...
    def testDowPatternGroupAgent(self):
        """Test DowPatternGroupAgent"""
