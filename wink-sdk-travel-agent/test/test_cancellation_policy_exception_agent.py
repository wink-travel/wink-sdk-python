...
class TestCancellationPolicyExceptionAgent(unittest.TestCase):
    """CancellationPolicyExceptionAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionAgent:
        """Test CancellationPolicyExceptionAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionAgent`
        """
        model = CancellationPolicyExceptionAgent()
        if include_optional:
            return CancellationPolicyExceptionAgent(
    ...
    def testCancellationPolicyExceptionAgent(self):
        """Test CancellationPolicyExceptionAgent"""
