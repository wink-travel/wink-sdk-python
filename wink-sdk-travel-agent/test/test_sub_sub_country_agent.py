...
class TestSubSubCountryAgent(unittest.TestCase):
    """SubSubCountryAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryAgent:
        """Test SubSubCountryAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryAgent`
        """
        model = SubSubCountryAgent()
        if include_optional:
            return SubSubCountryAgent(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryAgent(self):
        """Test SubSubCountryAgent"""
