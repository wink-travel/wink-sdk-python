...
class TestCommissionableEntryAgent(unittest.TestCase):
    """CommissionableEntryAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommissionableEntryAgent:
        """Test CommissionableEntryAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommissionableEntryAgent`
        """
        model = CommissionableEntryAgent()
        if include_optional:
            return CommissionableEntryAgent(
                name = '',
                identifier = '',
                type = 'GUEST_ROOM',
    ...
    def testCommissionableEntryAgent(self):
        """Test CommissionableEntryAgent"""
