...
class TestProfileUserAgent(unittest.TestCase):
    """ProfileUserAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileUserAgent:
        """Test ProfileUserAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileUserAgent`
        """
        model = ProfileUserAgent()
        if include_optional:
