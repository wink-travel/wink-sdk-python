...
class TestCompanyAgent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CompanyAgent:
        """Test CompanyAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyAgent`
        """
        model = CompanyAgent()
        if include_optional:
            return CompanyAgent(
