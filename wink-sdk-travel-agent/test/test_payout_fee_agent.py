...
class TestPayoutFeeAgent(unittest.TestCase):
    """PayoutFeeAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutFeeAgent:
        """Test PayoutFeeAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutFeeAgent`
        """
        model = PayoutFeeAgent()
        if include_optional:
            return PayoutFeeAgent(
                identifier = '',
