...
class TestSubSubCountryLightweightAgent(unittest.TestCase):
    """SubSubCountryLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryLightweightAgent:
        """Test SubSubCountryLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryLightweightAgent`
        """
        model = SubSubCountryLightweightAgent()
        if include_optional:
            return SubSubCountryLightweightAgent(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryLightweightAgent(self):
        """Test SubSubCountryLightweightAgent"""
