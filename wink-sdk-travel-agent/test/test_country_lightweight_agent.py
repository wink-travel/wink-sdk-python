...
class TestCountryLightweightAgent(unittest.TestCase):
    """CountryLightweightAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryLightweightAgent:
        """Test CountryLightweightAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryLightweightAgent`
        """
        model = CountryLightweightAgent()
        if include_optional:
            return CountryLightweightAgent(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
    ...
    def testCountryLightweightAgent(self):
        """Test CountryLightweightAgent"""
