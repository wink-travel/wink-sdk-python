...
class TestLocalizedPriceAgent(unittest.TestCase):
    """LocalizedPriceAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedPriceAgent:
        """Test LocalizedPriceAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedPriceAgent`
        """
        model = LocalizedPriceAgent()
        if include_optional:
            return LocalizedPriceAgent(
    ...
    def testLocalizedPriceAgent(self):
        """Test LocalizedPriceAgent"""
