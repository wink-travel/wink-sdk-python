    ...
    def make_instance(self, include_optional) -> AffiliateAccountAgent:
        ...
        if include_optional:
            return AffiliateAccountAgent(
                ...
                owner = wink_sdk_travel_agent.models.affiliate_account_user_agent.AffiliateAccountUser_Agent(
                ...
                address = wink_sdk_travel_agent.models.address_agent.Address_Agent(
                    ...
                    full_address = '11', ),
                managers = [
                    wink_sdk_travel_agent.models.affiliate_account_user_agent.AffiliateAccountUser_Agent(
                        email = 'manager@me.com', 
                        status = '+12125551212', 
                        user_identifier = '', 
                        first_name = 'John', 
                ...
                logo = wink_sdk_travel_agent.models.simple_multimedia_agent.SimpleMultimedia_Agent(
                    ...
                    is_landscape = True, ),
                travel_agent = wink_sdk_travel_agent.models.travel_agent_agent.TravelAgent_Agent(
                    self_acquires = True, 
                    self_disburses = True, ),
                managed_by = wink_sdk_travel_agent.models.managed_by_entity_agent.ManagedByEntity_Agent(
                    identifier = 'agency-1', 
                    name = 'Agency X', 
                    commission_in_percent = 0.01, 
                    rules = wink_sdk_travel_agent.models.managed_by_entity_rules_agent.ManagedByEntityRules_Agent(
                ...
                annual_travel_spend_in_dollars = wink_sdk_travel_agent.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '0', ),
                plans = [
                    null
