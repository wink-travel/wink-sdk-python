...
class TestReviewAgent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReviewAgent:
        """Test ReviewAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAgent`
        """
        model = ReviewAgent()
        if include_optional:
            return ReviewAgent(
                ...
                booking_identifier = '',
                hotel_identifier = '',
                user = wink_sdk_travel_agent.models.review_user_agent.ReviewUser_Agent(
                    user_identifier = '', 
                    first_name = 'John', 
                    last_name = 'Smith', 
