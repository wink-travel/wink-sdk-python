...
class TestEngineConfigurationBookingReportAgent(unittest.TestCase):
    """EngineConfigurationBookingReportAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationBookingReportAgent:
        """Test EngineConfigurationBookingReportAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationBookingReportAgent`
        """
        model = EngineConfigurationBookingReportAgent()
        if include_optional:
            return EngineConfigurationBookingReportAgent(
                identifier = '',
    ...
    def testEngineConfigurationBookingReportAgent(self):
        """Test EngineConfigurationBookingReportAgent"""
