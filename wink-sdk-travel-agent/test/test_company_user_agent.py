...
class TestCompanyUserAgent(unittest.TestCase):
    """CompanyUserAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyUserAgent:
        """Test CompanyUserAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyUserAgent`
        """
        model = CompanyUserAgent()
        if include_optional:
            return CompanyUserAgent(
