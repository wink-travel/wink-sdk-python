...
class GroupedBookingSalesMetricsSupplierDetails(BaseModel):
    """
    GroupedBookingSalesMetricsSupplierDetails
    """ # noqa: E501
    type: Optional[StrictStr] = None
    type_name: Optional[StrictStr] = Field(default=None, alias="typeName")
    type_identifier: Optional[StrictStr] = Field(default=None, alias="typeIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["type", "typeName", "typeIdentifier", "bookings", "totalPriceAmount", "averageBookingAmount", "currencyCode"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['BY_TOTAL', 'BY_COUNTRY', 'BY_PROPERTY']):
            raise ValueError("must be one of enum values ('BY_TOTAL', 'BY_COUNTRY', 'BY_PROPERTY')")
        return value
