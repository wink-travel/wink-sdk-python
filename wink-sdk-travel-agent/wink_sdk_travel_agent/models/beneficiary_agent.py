...
class BeneficiaryAgent(BaseModel):
    """
    ...
    amount_due: Optional[BeneficiaryChargeAgent] = Field(default=None, description="The original slice requested", alias="amountDue")
    ...
    pending_refunds: Optional[List[PendingRefundAgent]] = Field(default=None, alias="pendingRefunds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "amountDue": BeneficiaryChargeAgent.from_dict(obj["amountDue"]) if obj.get("amountDue") is not None else None,
            ...
            "pendingRefunds": [PendingRefundAgent.from_dict(_item) for _item in obj["pendingRefunds"]] if obj.get("pendingRefunds") is not None else None,
