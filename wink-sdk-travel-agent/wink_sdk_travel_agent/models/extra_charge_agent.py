...
class ExtraChargeAgent(BaseModel):
    ...
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeAgent] = Field(default=None, alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceAgent] = Field(default=None, alias="unitPrice")
    price: Optional[LocalizedPriceAgent] = None
