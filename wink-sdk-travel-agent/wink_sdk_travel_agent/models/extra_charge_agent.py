...
class ExtraChargeAgent(BaseModel):
    """
    ExtraChargeAgent
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeAgent] = Field(default=None, description="What the guest is paying extra for", alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceAgent] = Field(default=None, description="The localized unit price of the extra charge", alias="unitPrice")
    price: Optional[LocalizedPriceAgent] = Field(default=None, description="The localized price of the extra charge")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ratePlanLevelFee": RatePlanLevelFeeAgent.from_dict(obj["ratePlanLevelFee"]) if obj.get("ratePlanLevelFee") is not None else None,
            "unitPrice": LocalizedPriceAgent.from_dict(obj["unitPrice"]) if obj.get("unitPrice") is not None else None,
