...
class RoomStayAgent(BaseModel):
    ...
    rate_plan: RatePlanAgent = Field(alias="ratePlan")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "room": GuestRoomAgent.from_dict(obj["room"]) if obj.get("room") is not None else None,
            ...
            "ratePlan": RatePlanAgent.from_dict(obj["ratePlan"]) if obj.get("ratePlan") is not None else None,
