...
class RoomStayAgent(BaseModel):
    ...
    """ # noqa: E501
    policy: PropertyPolicyAgent
    room: GuestRoomLightweightAgent
    rooms: StrictInt = Field(description="Number of rooms. Always 1 since we switched to creating one booking per room.")
    bedroom_configuration: BedroomConfigurationAgent = Field(alias="bedroomConfiguration")
    ...
    rate_plan: RoomConfigurationPriceRatePlanAgent = Field(alias="ratePlan")
    ...
    extra_charges: ExtraChargesAgent = Field(alias="extraCharges")
    active_cancellation_policy: CancellationPolicyAgent = Field(alias="activeCancellationPolicy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeCancellationPolicy": CancellationPolicyAgent.from_dict(obj["activeCancellationPolicy"]) if obj.get("activeCancellationPolicy") is not None else None,
