...
class GeneralManagerAgent(BaseModel):
    """
    General manager related data.
    """ # noqa: E501
    name: StrictStr = Field(description="Name of GM currently managing the property.")
    image: Optional[SimpleMultimediaAgent] = Field(default=None, description="Cloudinary image identifier of GM currently managing the property.")
    descriptions: Optional[List[LocalizedDescriptionAgent]] = Field(default=None, description="Localized welcome message from GM.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "image": SimpleMultimediaAgent.from_dict(obj["image"]) if obj.get("image") is not None else None,
