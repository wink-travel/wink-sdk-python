...
class GeoNameAgent(BaseModel):
    ...
    country: Optional[CountryAgent] = None
    sub_country: Optional[SubCountryAgent] = Field(default=None, alias="subCountry")
    sub_sub_country: Optional[SubSubCountryAgent] = Field(default=None, alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountryAgent.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountryAgent.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountryAgent.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
