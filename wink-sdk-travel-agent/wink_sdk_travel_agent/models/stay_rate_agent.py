...
class StayRateAgent(BaseModel):
    ...
    source_to_user_currency_quote: Optional[QuoteAgent] = Field(default=None, alias="sourceToUserCurrencyQuote")
    source_to_internal_currency_quote: Optional[QuoteAgent] = Field(default=None, alias="sourceToInternalCurrencyQuote")
