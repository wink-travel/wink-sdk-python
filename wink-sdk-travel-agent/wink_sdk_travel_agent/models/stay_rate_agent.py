...
class StayRateAgent(BaseModel):
    ...
    source_to_user_currency_quote: Optional[QuoteLightweightAgent] = Field(default=None, description="Hotel to user currency exchange rate.", alias="sourceToUserCurrencyQuote")
    source_to_internal_currency_quote: Optional[QuoteLightweightAgent] = Field(default=None, description="Hotel to wink currency exchange rate.", alias="sourceToInternalCurrencyQuote")
    offer_details: Optional[List[LocalizedDescriptionAgent]] = Field(default=None, description="Localized text of the discount", alias="offerDetails")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StayRateAgent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StayRateAgent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sourceToUserCurrencyQuote": QuoteLightweightAgent.from_dict(obj["sourceToUserCurrencyQuote"]) if obj.get("sourceToUserCurrencyQuote") is not None else None,
            "sourceToInternalCurrencyQuote": QuoteLightweightAgent.from_dict(obj["sourceToInternalCurrencyQuote"]) if obj.get("sourceToInternalCurrencyQuote") is not None else None,
            "offerDetails": [LocalizedDescriptionAgent.from_dict(_item) for _item in obj["offerDetails"]] if obj.get("offerDetails") is not None else None,
