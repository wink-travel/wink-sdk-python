...
class PageBookingAgent(BaseModel):
    """
    PageBookingAgent
    """ # noqa: E501
    ...
    content: Optional[List[BookingAgent]] = None
    number: Optional[StrictInt] = None
    pageable: Optional[PageableObjectAgent] = None
    sort: Optional[SortObjectAgent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [BookingAgent.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "number": obj.get("number"),
            "pageable": PageableObjectAgent.from_dict(obj["pageable"]) if obj.get("pageable") is not None else None,
            "sort": SortObjectAgent.from_dict(obj["sort"]) if obj.get("sort") is not None else None,
