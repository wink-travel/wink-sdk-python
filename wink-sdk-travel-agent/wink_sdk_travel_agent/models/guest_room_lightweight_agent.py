...
class GuestRoomLightweightAgent(BaseModel):
    ...
    descriptions: Annotated[List[SimpleDescriptionAgent], Field(min_length=1)] = Field(description="Localized descriptions describing inventory.")
    multimedias: Annotated[List[SimpleMultimediaAgent], Field(min_length=1)] = Field(description="List of images / videos of blocking.")
    ...
    bedroom_configuration_list: Annotated[List[BedroomConfigurationAgent], Field(min_length=1)] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
