...
class CreateAgentBookingRequestAgent(BaseModel):
    ...
    """ # noqa: E501
    rooms: List[AgentBookingRequestAgent] = Field(description="List of room configuration booking requests. Each entry is a separately booked room.")
    display_currency: StrictStr = Field(description="The desired currency", alias="displayCurrency")
    display_language: StrictStr = Field(description="The desired language", alias="displayLanguage")
