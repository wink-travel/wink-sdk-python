...
class BedroomConfigurationAgent(BaseModel):
    """
    ...
    bedroom_list: Annotated[List[BedroomAgent], Field(min_length=1)] = Field(description="A room type can have more than one bedroom configuration.", alias="bedroomList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "bedroomList": [BedroomAgent.from_dict(_item) for _item in obj["bedroomList"]] if obj.get("bedroomList") is not None else None
        })
        return _obj
