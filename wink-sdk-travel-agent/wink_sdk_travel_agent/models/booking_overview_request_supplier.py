...
class BookingOverviewRequestSupplier(BaseModel):
    """
    BookingOverviewRequestSupplier
    """ # noqa: E501
    type: StrictStr = Field(description="The type of time series that should be used")
    units: Optional[StrictInt] = Field(default=None, description="How many units of the timeseries type should be used")
    __properties: ClassVar[List[str]] = ["type", "units"]
