...
**user** | [**ReviewUserAgent**](ReviewUserAgent.md) |  | [optional] 
**review_date** | **datetime** | Date of review. | [optional] 
**average_score** | **float** | Total points divided by number of questions. | [optional] 
**answers** | [**List[ReviewAnswerAgent]**](ReviewAnswerAgent.md) | List of user review answers. | [optional] 
...
json = "{}"
# create an instance of ReviewAgent from a JSON string
review_agent_instance = ReviewAgent.from_json(json)
# print the JSON string representation of the object
print(ReviewAgent.to_json())

# convert the object into a dict
review_agent_dict = review_agent_instance.to_dict()
# create an instance of ReviewAgent from a dict
review_agent_from_dict = ReviewAgent.from_dict(review_agent_dict)
```
