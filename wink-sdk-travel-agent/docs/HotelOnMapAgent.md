...
**short_descriptions** | [**List[LocalizedDescriptionAgent]**](LocalizedDescriptionAgent.md) | A localized list of short property descriptions | [optional] 
**long_descriptions** | [**List[LocalizedDescriptionAgent]**](LocalizedDescriptionAgent.md) | A localized list of longer property descriptions | [optional] 
...
**reservations** | [**ContactAgent**](ContactAgent.md) |  | [optional] 
...
**policy** | [**PropertyPolicyAgent**](PropertyPolicyAgent.md) |  | [optional] 
...
**address** | [**AddressAgent**](AddressAgent.md) |  | [optional] 
...
hotel_on_map_agent_instance = HotelOnMapAgent.from_json(json)
# print the JSON string representation of the object
print(HotelOnMapAgent.to_json())

# convert the object into a dict
hotel_on_map_agent_dict = hotel_on_map_agent_instance.to_dict()
# create an instance of HotelOnMapAgent from a dict
hotel_on_map_agent_from_dict = HotelOnMapAgent.from_dict(hotel_on_map_agent_dict)
```
