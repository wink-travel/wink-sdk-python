...
guest_room_lightweight_agent_instance = GuestRoomLightweightAgent.from_json(json)
# print the JSON string representation of the object
print(GuestRoomLightweightAgent.to_json())

# convert the object into a dict
guest_room_lightweight_agent_dict = guest_room_lightweight_agent_instance.to_dict()
# create an instance of GuestRoomLightweightAgent from a dict
guest_room_lightweight_agent_from_dict = GuestRoomLightweightAgent.from_dict(guest_room_lightweight_agent_dict)
```
