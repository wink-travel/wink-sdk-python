...
**descriptions** | [**List[SimpleDescriptionAgent]**](SimpleDescriptionAgent.md) | Localized media captions to give user some context about where this media was taken. | [optional] 
...
**attribution** | [**List[MediaAuthorAttributionAgent]**](MediaAuthorAttributionAgent.md) | Whether image has attribution properties | [optional] 
...
simple_multimedia_agent_instance = SimpleMultimediaAgent.from_json(json)
# print the JSON string representation of the object
print(SimpleMultimediaAgent.to_json())

# convert the object into a dict
simple_multimedia_agent_dict = simple_multimedia_agent_instance.to_dict()
# create an instance of SimpleMultimediaAgent from a dict
simple_multimedia_agent_from_dict = SimpleMultimediaAgent.from_dict(simple_multimedia_agent_dict)
```
