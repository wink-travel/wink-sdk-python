...
wink_booking_contract_agent_instance = WinkBookingContractAgent.from_json(json)
# print the JSON string representation of the object
print(WinkBookingContractAgent.to_json())

# convert the object into a dict
wink_booking_contract_agent_dict = wink_booking_contract_agent_instance.to_dict()
# create an instance of WinkBookingContractAgent from a dict
wink_booking_contract_agent_from_dict = WinkBookingContractAgent.from_dict(wink_booking_contract_agent_dict)
```
