...
**theme_colors** | [**CustomizationThemeColorsAgent**](CustomizationThemeColorsAgent.md) | Choose how you want our web components to look and more closely match with your own site style. | [optional] 
...
**city** | [**GeoNameLightweightAgent**](GeoNameLightweightAgent.md) |  | [optional] 
...
customization_lightweight_agent_instance = CustomizationLightweightAgent.from_json(json)
# print the JSON string representation of the object
print(CustomizationLightweightAgent.to_json())

# convert the object into a dict
customization_lightweight_agent_dict = customization_lightweight_agent_instance.to_dict()
# create an instance of CustomizationLightweightAgent from a dict
customization_lightweight_agent_from_dict = CustomizationLightweightAgent.from_dict(customization_lightweight_agent_dict)
```
