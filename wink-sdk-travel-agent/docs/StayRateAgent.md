...
**source_to_user_currency_quote** | [**QuoteLightweightAgent**](QuoteLightweightAgent.md) | Hotel to user currency exchange rate. | [optional] 
**source_to_internal_currency_quote** | [**QuoteLightweightAgent**](QuoteLightweightAgent.md) | Hotel to wink currency exchange rate. | [optional] 
**offer_details** | [**List[LocalizedDescriptionAgent]**](LocalizedDescriptionAgent.md) | Localized text of the discount | [optional] 
...
stay_rate_agent_instance = StayRateAgent.from_json(json)
# print the JSON string representation of the object
print(StayRateAgent.to_json())

# convert the object into a dict
stay_rate_agent_dict = stay_rate_agent_instance.to_dict()
# create an instance of StayRateAgent from a dict
stay_rate_agent_from_dict = StayRateAgent.from_dict(stay_rate_agent_dict)
```
