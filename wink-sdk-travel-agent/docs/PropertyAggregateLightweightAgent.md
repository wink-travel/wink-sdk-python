...
**location** | [**GeoJsonPointAgent**](GeoJsonPointAgent.md) | Geo-location | [optional] 
**descriptions** | [**List[SimpleDescriptionAgent]**](SimpleDescriptionAgent.md) | Short and long welcome text | [optional] 
...
**reservations** | [**ContactAgent**](ContactAgent.md) | Contact details for reservations desk | [optional] 
**socials** | [**List[SocialAgent]**](SocialAgent.md) | Property&#39;s social network accounts | [optional] 
**images** | [**List[SimpleMultimediaAgent]**](SimpleMultimediaAgent.md) | Property images. | [optional] 
**videos** | [**List[SimpleMultimediaAgent]**](SimpleMultimediaAgent.md) | Property videos. | [optional] 
**policy** | [**PropertyPolicyAgent**](PropertyPolicyAgent.md) | Basic property policy record. | [optional] 
**third_party_reviews** | [**List[TravelInventoryRecognitionAgent]**](TravelInventoryRecognitionAgent.md) | Array of awards and third party reviews given to property by certified / non-certified providers. | [optional] 
...
**general_manager** | [**GeneralManagerAgent**](GeneralManagerAgent.md) |  | [optional] 
...
**address** | [**SimpleAddressAgent**](SimpleAddressAgent.md) | Property address. | [optional] 
...
property_aggregate_lightweight_agent_instance = PropertyAggregateLightweightAgent.from_json(json)
# print the JSON string representation of the object
print(PropertyAggregateLightweightAgent.to_json())

# convert the object into a dict
property_aggregate_lightweight_agent_dict = property_aggregate_lightweight_agent_instance.to_dict()
# create an instance of PropertyAggregateLightweightAgent from a dict
property_aggregate_lightweight_agent_from_dict = PropertyAggregateLightweightAgent.from_dict(property_aggregate_lightweight_agent_dict)
```
