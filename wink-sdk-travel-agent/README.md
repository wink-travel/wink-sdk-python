...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.60#egg=wink_sdk_travel_agent&subdirectory=wink-sdk-travel-agent
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.60#egg=wink_sdk_travel_agent&subdirectory=wink_sdk_travel_agent`)
...
## Documentation For Models
 ...
 - [PetInfoLightweightAgent](docs/PetInfoLightweightAgent.md)
