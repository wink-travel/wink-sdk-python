...
class RateProviderApi:
    ...
    def show_channel_managers(
    ...
    ) -> List[KeyValuePairAdministrator]:
        ...
        _param = self._show_channel_managers_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "List[KeyValuePairAdministrator]",
        }
    ...
    @validate_call
    def show_channel_managers_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[KeyValuePairAdministrator]]:
        """Show Channel Managers
    ...
    @validate_call
    def show_channel_managers_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_channel_managers_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reference-data/channel-manager/list',
