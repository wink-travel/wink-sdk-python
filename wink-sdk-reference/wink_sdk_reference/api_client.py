...
from wink_sdk_reference.configuration import Configuration
from wink_sdk_reference.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_reference.models
from wink_sdk_reference import rest
from wink_sdk_reference.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_reference.models, klass)
