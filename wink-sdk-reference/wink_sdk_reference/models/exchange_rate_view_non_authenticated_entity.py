...
class ExchangeRateViewNonAuthenticatedEntity(BaseModel):
    """
    ...
    quote: QuoteNonAuthenticatedEntity
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "quote"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quote": QuoteNonAuthenticatedEntity.from_dict(obj["quote"]) if obj.get("quote") is not None else None
        })
        return _obj
