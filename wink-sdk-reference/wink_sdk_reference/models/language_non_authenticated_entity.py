...
class LanguageNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["country", "displayCountry", "displayLanguage", "displayName", "displayScript", "displayVariant", "iso3Country", "iso3Language", "language", "script", "variant"]
