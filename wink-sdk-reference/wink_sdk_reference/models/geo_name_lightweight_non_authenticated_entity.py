...
class GeoNameLightweightNonAuthenticatedEntity(BaseModel):
    """
    ...
    location: Optional[GeoJsonPointNonAuthenticatedEntity] = Field(default=None, description="Coordinate points of the city")
    ...
    country: Optional[CountryLightweightNonAuthenticatedEntity] = Field(default=None, description="Country")
    sub_country: Optional[SubCountryLightweightNonAuthenticatedEntity] = Field(default=None, description="Country sub division", alias="subCountry")
    sub_sub_country: Optional[SubSubCountryLightweightNonAuthenticatedEntity] = Field(default=None, description="Country sub sub division", alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountryLightweightNonAuthenticatedEntity.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountryLightweightNonAuthenticatedEntity.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountryLightweightNonAuthenticatedEntity.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
