...
class TestQuoteNonAuthenticatedEntity(unittest.TestCase):
    """QuoteNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteNonAuthenticatedEntity:
        """Test QuoteNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteNonAuthenticatedEntity`
        """
        model = QuoteNonAuthenticatedEntity()
        if include_optional:
    ...
    def testQuoteNonAuthenticatedEntity(self):
        """Test QuoteNonAuthenticatedEntity"""
