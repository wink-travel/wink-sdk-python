...
class ExtraChargeSupplier(BaseModel):
    ...
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeSupplier] = Field(default=None, alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceSupplier] = Field(default=None, alias="unitPrice")
    price: Optional[LocalizedPriceSupplier] = None
