...
class PersonalSupplierDetails(BaseModel):
    """
    ...
    contact_person: Optional[List[ContactSupplierDetails]] = Field(default=None, alias="contactPerson")
    phys_chall_name: Optional[List[StrictStr]] = Field(default=None, alias="physChallName")
    pet_info: Optional[List[PetInfoLightweightSupplierDetails]] = Field(default=None, alias="petInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contactPerson": [ContactSupplierDetails.from_dict(_item) for _item in obj["contactPerson"]] if obj.get("contactPerson") is not None else None,
            "physChallName": obj.get("physChallName"),
            "petInfo": [PetInfoLightweightSupplierDetails.from_dict(_item) for _item in obj["petInfo"]] if obj.get("petInfo") is not None else None
        })
        return _obj
