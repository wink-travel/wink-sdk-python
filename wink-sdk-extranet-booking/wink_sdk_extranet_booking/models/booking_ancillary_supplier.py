...
class BookingAncillarySupplier(BaseModel):
    """
    ...
    price: LocalizedPriceSupplier = Field(description="Pricing information for this ancillary.")
    ...
    contact: ContactSupplier = Field(description="Travel blocking contact (if applicable)")
    address: SimpleAddressSupplier = Field(description="Travel blocking address (if applicable)")
