...
class ProfileLightweightSupplier(BaseModel):
    """
    ...
    user: ProfileUserSupplier = Field(description="User details")
    personal: PersonalSupplier = Field(description="Detailed customer information for this profile")
    preferences: PreferencesSupplier = Field(description="Customer preferences")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "share": obj.get("share"),
            "user": ProfileUserSupplier.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "personal": PersonalSupplier.from_dict(obj["personal"]) if obj.get("personal") is not None else None,
            "preferences": PreferencesSupplier.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None
        })
        return _obj
