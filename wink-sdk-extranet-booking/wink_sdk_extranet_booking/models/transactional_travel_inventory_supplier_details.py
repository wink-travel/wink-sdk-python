...
class TransactionalTravelInventorySupplierDetails(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescriptionSupplierDetails], Field(min_length=1, max_length=2147483647)] = Field(description="Localized descriptions describing inventory.")
    ...
    multimedias: Optional[List[SimpleMultimediaSupplierDetails]] = Field(default=None, description="List of images / videos of item.")
