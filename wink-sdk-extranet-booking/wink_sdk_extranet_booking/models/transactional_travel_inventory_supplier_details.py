...
class TransactionalTravelInventorySupplierDetails(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="Unique transactional identifier")
    name: StrictStr = Field(description="Internal name of transactional blocking.")
    descriptions: Annotated[List[SimpleDescriptionSupplierDetails], Field(min_length=1, max_length=2147483647)] = Field(description="Localized descriptions describing blocking.")
    pricing_type: StrictStr = Field(description="How this blocking item should be priced.", alias="pricingType")
    base_price: CustomMonetaryAmount = Field(alias="basePrice")
    discounted_price: CustomMonetaryAmount = Field(alias="discountedPrice")
