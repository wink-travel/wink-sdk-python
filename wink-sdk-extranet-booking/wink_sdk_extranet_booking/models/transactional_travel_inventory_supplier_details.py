...
class TransactionalTravelInventorySupplierDetails(BaseModel):
    ...
    min_pax: Optional[StrictInt] = Field(default=None, description="Whether there is a limit to minimum group size.", alias="minPax")
    max_pax: Optional[StrictInt] = Field(default=None, description="Whether there is a limit to maximum group size.", alias="maxPax")
