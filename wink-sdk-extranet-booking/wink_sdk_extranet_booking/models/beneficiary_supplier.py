...
class BeneficiarySupplier(BaseModel):
    """
    ...
    amount_due: Optional[BeneficiaryChargeSupplier] = Field(default=None, alias="amountDue")
    ...
    pending_refunds: Optional[List[PendingRefundSupplier]] = Field(default=None, alias="pendingRefunds")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "amountDue": BeneficiaryChargeSupplier.from_dict(obj["amountDue"]) if obj.get("amountDue") is not None else None,
            ...
            "pendingRefunds": [PendingRefundSupplier.from_dict(_item) for _item in obj["pendingRefunds"]] if obj.get("pendingRefunds") is not None else None,
