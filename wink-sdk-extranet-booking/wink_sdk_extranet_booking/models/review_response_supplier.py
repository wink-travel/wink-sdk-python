...
class ReviewResponseSupplier(BaseModel):
    """
    Property response to review.
    """ # noqa: E501
    response_from_hotel: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Texual response from hotel to user's review.", alias="responseFromHotel")
    approved_text: StrictBool = Field(description="Property approves the use of guest review text with property profile.", alias="approvedText")
    approved_image: StrictBool = Field(description="Property approves the use of guest generated image with property profile.", alias="approvedImage")
    __properties: ClassVar[List[str]] = ["responseFromHotel", "approvedText", "approvedImage"]
