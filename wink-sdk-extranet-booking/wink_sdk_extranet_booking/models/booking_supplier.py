...
class BookingSupplier(BaseModel):
    ...
    booking_contract: Optional[BookingContractSupplier] = Field(default=None, description="Booking contract created by TripPay", alias="bookingContract")
