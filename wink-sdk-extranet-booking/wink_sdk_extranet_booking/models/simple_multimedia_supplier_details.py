...
class SimpleMultimediaSupplierDetails(BaseModel):
    """
    Multimedia that contains less information than Multimedia object
    """ # noqa: E501
    multimedia_identifier: StrictStr = Field(description="Document identifier", alias="multimediaIdentifier")
    identifier: StrictStr = Field(description="Use this identifier to communicate with Cloudinary.")
    ...
    sort: Optional[StrictInt] = Field(default=999, description="Sort allows you to control how you want to sort this record in a list of media records.")
    angle: Optional[StrictStr] = Field(default=None, description="Media angle")
    width: StrictInt = Field(description="Media width in pixels.")
    height: StrictInt = Field(description="Media height in pixels.")
    ...
    descriptions: Optional[List[SimpleDescriptionSupplierDetails]] = Field(default=None, description="Localized media captions to give user some context about where this media was taken.")
    ...
    attribution: Optional[List[ImageAttributionSupplierDetails]] = Field(default=None, description="Whether image has attribution properties")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attribution": [ImageAttributionSupplierDetails.from_dict(_item) for _item in obj["attribution"]] if obj.get("attribution") is not None else None,
