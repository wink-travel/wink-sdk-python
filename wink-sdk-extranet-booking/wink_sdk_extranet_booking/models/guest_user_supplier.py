...
class GuestUserSupplier(BaseModel):
    """
    GuestUserSupplier
    """ # noqa: E501
    ...
    profile: Optional[ProfileLightweightSupplier] = Field(default=None, description="Optional profile record")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": ProfileLightweightSupplier.from_dict(obj["profile"]) if obj.get("profile") is not None else None,
