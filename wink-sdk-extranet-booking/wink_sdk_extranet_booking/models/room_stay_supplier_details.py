...
class RoomStaySupplierDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policy", "room", "rooms", "bedroomConfiguration", "adults", "children", "startDate", "endDate", "price", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "extraCharges", "activeCancellationPolicy", "roomNights", "rateSource", "guests", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "cancellableByHotel", "cancellableWithPotentialCharge", "cancellable"]
