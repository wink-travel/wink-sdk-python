...
class PropertyBookingRefundRequestSupplier(BaseModel):
    """
    PropertyBookingRefundRequestSupplier
    """ # noqa: E501
    type: StrictStr = Field(description="Type of reason")
    description: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Textual description of why the refund is being requested")
    refund: CustomMonetaryAmount = Field(description="Requested amount to refund")
    ...
    __properties: ClassVar[List[str]] = ["type", "description", "refund", "cancelOnRefund"]
