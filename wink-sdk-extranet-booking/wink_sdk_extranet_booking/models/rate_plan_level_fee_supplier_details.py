...
class RatePlanLevelFeeSupplierDetails(BaseModel):
    """
    RatePlanLevelFeeSupplierDetails
    """ # noqa: E501
    descriptions: Annotated[List[LocalizedDescriptionSupplierDetails], Field(min_length=1)] = Field(description="List of localized descriptions for this fee.")
