...
class WinkBookingContractSupplier(BaseModel):
    """
    ...
    user: AuthenticatedUserSupplier = Field(description="The authenticated user ID that made the request")
    ...
    display_price_quote: QuoteLightweightSupplier = Field(description="The quote used to create totalDisplayPrice.", alias="displayPriceQuote")
    supplier_price_quote: QuoteLightweightSupplier = Field(description="The quote used to create totalSupplierPrice.", alias="supplierPriceQuote")
    internal_price_quote: QuoteLightweightSupplier = Field(description="The quote used to create totalInternalPrice.", alias="internalPriceQuote")
    capture_price_quote: QuoteLightweightSupplier = Field(description="The quote used to create totalCapturePrice.", alias="capturePriceQuote")
    item_list: Annotated[List[BookingContractItemSupplier], Field(min_length=1, max_length=2147483647)] = Field(description="Holds one booking line item for a specific supplier.", alias="itemList")
    ...
    payment: BookingContractPaymentDetailsSupplier = Field(description="Payment details the merchant provided us at the time of payment.")
    ...
    refunds: Optional[List[RefundSupplier]] = Field(default=None, description="An optional list of refunds that occurred with this booking. If the refund amount(s) is the same as the total price, the booking also gets cancelled.")
    payouts: Optional[List[PayoutSupplier]] = Field(default=None, description="An optional list of refunds that occurred with this booking. If the refund amount(s) is the same as the total price, the booking also gets cancelled.")
    ...
    total_funds_grouped_by_beneficiary: Optional[List[BeneficiarySupplier]] = Field(default=None, description="Returns all the beneficiaries in this contract with their total amounts", alias="totalFundsGroupedByBeneficiary")
    ...
    lodging: Optional[BookingContractItemSupplier] = Field(default=None, description="Returns the lodging item only.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WinkBookingContractSupplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WinkBookingContractSupplier from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "user": AuthenticatedUserSupplier.from_dict(obj["user"]) if obj.get("user") is not None else None,
            ...
            "displayPriceQuote": QuoteLightweightSupplier.from_dict(obj["displayPriceQuote"]) if obj.get("displayPriceQuote") is not None else None,
            "supplierPriceQuote": QuoteLightweightSupplier.from_dict(obj["supplierPriceQuote"]) if obj.get("supplierPriceQuote") is not None else None,
            "internalPriceQuote": QuoteLightweightSupplier.from_dict(obj["internalPriceQuote"]) if obj.get("internalPriceQuote") is not None else None,
            "capturePriceQuote": QuoteLightweightSupplier.from_dict(obj["capturePriceQuote"]) if obj.get("capturePriceQuote") is not None else None,
            "itemList": [BookingContractItemSupplier.from_dict(_item) for _item in obj["itemList"]] if obj.get("itemList") is not None else None,
            ...
            "payment": BookingContractPaymentDetailsSupplier.from_dict(obj["payment"]) if obj.get("payment") is not None else None,
            ...
            "refunds": [RefundSupplier.from_dict(_item) for _item in obj["refunds"]] if obj.get("refunds") is not None else None,
            "payouts": [PayoutSupplier.from_dict(_item) for _item in obj["payouts"]] if obj.get("payouts") is not None else None,
            ...
            "totalFundsGroupedByBeneficiary": [BeneficiarySupplier.from_dict(_item) for _item in obj["totalFundsGroupedByBeneficiary"]] if obj.get("totalFundsGroupedByBeneficiary") is not None else None,
            "totalTokensEarned": obj.get("totalTokensEarned"),
            "lodging": BookingContractItemSupplier.from_dict(obj["lodging"]) if obj.get("lodging") is not None else None,
