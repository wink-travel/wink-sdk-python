...
class BookingContractSupplier(BaseModel):
    ...
    user: AuthenticatedUserSupplier
    ...
    display_price_quote: QuoteSupplier = Field(alias="displayPriceQuote")
    supplier_price_quote: QuoteSupplier = Field(alias="supplierPriceQuote")
    internal_price_quote: QuoteSupplier = Field(alias="internalPriceQuote")
    capture_price_quote: QuoteSupplier = Field(alias="capturePriceQuote")
    ...
    payment: BookingContractPaymentDetailsSupplier
    ...
    lodging: Optional[BookingContractItemSupplier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "displayPriceQuote": QuoteSupplier.from_dict(obj["displayPriceQuote"]) if obj.get("displayPriceQuote") is not None else None,
            "supplierPriceQuote": QuoteSupplier.from_dict(obj["supplierPriceQuote"]) if obj.get("supplierPriceQuote") is not None else None,
            "internalPriceQuote": QuoteSupplier.from_dict(obj["internalPriceQuote"]) if obj.get("internalPriceQuote") is not None else None,
            "capturePriceQuote": QuoteSupplier.from_dict(obj["capturePriceQuote"]) if obj.get("capturePriceQuote") is not None else None,
