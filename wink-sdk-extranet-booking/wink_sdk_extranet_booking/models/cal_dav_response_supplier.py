...
class CalDavResponseSupplier(BaseModel):
    """
    CalDavResponseSupplier
    """ # noqa: E501
    identifier: Optional[StrictStr] = None
    hotel_identifier: Optional[StrictStr] = Field(default=None, alias="hotelIdentifier")
    passkey: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["identifier", "hotelIdentifier", "passkey", "url"]
