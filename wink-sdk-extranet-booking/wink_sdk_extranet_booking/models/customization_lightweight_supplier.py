...
class CustomizationLightweightSupplier(BaseModel):
    """
    ...
    logos: Optional[List[SimpleMultimediaSupplier]] = Field(default=None, description="Customize booking confirmation emails by adding a custom logo to your configuration.")
    ...
    theme_colors: Optional[CustomizationThemeColorsSupplier] = Field(default=None, description="Choose how you want our web components to look and more closely match with your own site style.", alias="themeColors")
    ...
    room_configurations: Optional[List[RoomConfigurationSupplier]] = Field(default=None, description="Control how many adults / children will be staying and how many rooms. Defaults to: One room, two adults.", alias="roomConfigurations")
    ...
    city: Optional[GeoNameLightweightSupplier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "themeColors": CustomizationThemeColorsSupplier.from_dict(obj["themeColors"]) if obj.get("themeColors") is not None else None,
            ...
            "roomConfigurations": [RoomConfigurationSupplier.from_dict(_item) for _item in obj["roomConfigurations"]] if obj.get("roomConfigurations") is not None else None,
