...
class CategoryAxisNotesSupplier(BaseModel):
    """
    The configuration of the category axis notes.
    """ # noqa: E501
    data: Optional[List[Dict[str, Any]]] = None
    line: Optional[NoteLineSupplier] = None
    position: Optional[StrictStr] = None
    icon: Optional[CategoryAxisNotesIconSupplier] = None
    label: Optional[CategoryAxisNotesLabelSupplier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "line": NoteLineSupplier.from_dict(obj["line"]) if obj.get("line") is not None else None,
            "position": obj.get("position"),
            "icon": CategoryAxisNotesIconSupplier.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "label": CategoryAxisNotesLabelSupplier.from_dict(obj["label"]) if obj.get("label") is not None else None
        })
        return _obj
