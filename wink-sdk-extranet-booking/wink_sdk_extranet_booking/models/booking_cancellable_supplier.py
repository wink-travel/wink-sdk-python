...
class BookingCancellableSupplier(BaseModel):
    ...
    """ # noqa: E501
    hotel_identifier: UUID = Field(description="Owner identifier of booking.", alias="hotelIdentifier")
    booking_identifier: UUID = Field(description="Booking unique identifier.", alias="bookingIdentifier")
