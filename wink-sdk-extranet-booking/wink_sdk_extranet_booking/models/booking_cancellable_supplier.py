...
class BookingCancellableSupplier(BaseModel):
    """
    BookingCancellableSupplier
    """ # noqa: E501
    hotel_identifier: StrictStr = Field(description="Owner identifier of booking.", alias="hotelIdentifier")
    booking_identifier: StrictStr = Field(description="Booking unique identifier.", alias="bookingIdentifier")
    cancellable: StrictBool = Field(description="Whether booking can be cancelled or not.")
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "bookingIdentifier", "cancellable"]
