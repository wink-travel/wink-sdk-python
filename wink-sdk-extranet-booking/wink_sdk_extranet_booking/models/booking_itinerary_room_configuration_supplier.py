...
class BookingItineraryRoomConfigurationSupplier(BaseModel):
    """
    Room Configuration
    """ # noqa: E501
    adults: Optional[StrictInt] = Field(default=1, description="Number of adults")
    children: Optional[List[BookingItineraryRoomConfigurationChildSupplier]] = Field(default=None, description="Children configurations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [BookingItineraryRoomConfigurationChildSupplier.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
        return _obj
