...
class EngineConfigurationBookingReportSupplier(BaseModel):
    """
    ...
    theme_colors: Optional[EngineConfigurationThemeColorsSupplier] = Field(default=None, alias="themeColors")
    ...
    city: Optional[GeoNameSupplier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "themeColors": EngineConfigurationThemeColorsSupplier.from_dict(obj["themeColors"]) if obj.get("themeColors") is not None else None,
            ...
            "city": GeoNameSupplier.from_dict(obj["city"]) if obj.get("city") is not None else None,
