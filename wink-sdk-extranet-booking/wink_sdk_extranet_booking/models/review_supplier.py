...
class ReviewSupplier(BaseModel):
    ...
    user: Optional[ReviewUserSupplier] = Field(default=None, description="User details of creator of booking.")
    ...
    answers: Optional[List[ReviewAnswerSupplier]] = None
    ...
    likes: Optional[List[StrictStr]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReviewSupplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReviewSupplier from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "user": ReviewUserSupplier.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "reviewDate": obj.get("reviewDate"),
            "averageScore": obj.get("averageScore"),
            "answers": [ReviewAnswerSupplier.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None,
