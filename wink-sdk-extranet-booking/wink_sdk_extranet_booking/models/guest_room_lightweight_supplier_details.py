...
class GuestRoomLightweightSupplierDetails(BaseModel):
    """
    ...
    bedroom_configuration_list: Annotated[List[BedroomConfigurationSupplierDetails], Field(min_length=1)] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GuestRoomLightweightSupplierDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GuestRoomLightweightSupplierDetails from a dict"""
        if obj is None:
            return None
