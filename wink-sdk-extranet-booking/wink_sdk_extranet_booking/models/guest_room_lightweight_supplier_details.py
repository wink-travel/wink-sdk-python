...
class GuestRoomLightweightSupplierDetails(BaseModel):
    ...
    bedroom_configuration_list: List[BedroomConfigurationSupplierDetails] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
