...
class PayoutSupplier(BaseModel):
    """
    ...
    fees: Optional[List[PayoutFeeSupplier]] = Field(default=None, description="Fees incurred when making the withdrawal.")
    quote: Optional[QuoteLightweightSupplier] = Field(default=None, description="FX quote for this transfer.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fees": [PayoutFeeSupplier.from_dict(_item) for _item in obj["fees"]] if obj.get("fees") is not None else None,
            "quote": QuoteLightweightSupplier.from_dict(obj["quote"]) if obj.get("quote") is not None else None,
