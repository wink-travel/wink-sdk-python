...
class AddOnLocalizedInventorySupplierDetails(BaseModel):
    """
    AddOnLocalizedInventorySupplierDetails
    """ # noqa: E501
    add_on: AddOnLightweightSupplierDetails = Field(description="The original add-on record created by the property.", alias="addOn")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addOn": AddOnLightweightSupplierDetails.from_dict(obj["addOn"]) if obj.get("addOn") is not None else None,
