...
class DailyRateSupplierDetails(BaseModel):
    ...
    source_to_user_currency_quote: QuoteLightweightSupplierDetails = Field(alias="sourceToUserCurrencyQuote")
