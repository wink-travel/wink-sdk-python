...
class ChartValueAxisSupplier(BaseModel):
    """
    The configuration options of the value axis.
    """ # noqa: E501
    labels: Optional[ChartValueAxisLabelsSupplier] = None
    line: Optional[ChartValueAxisLineSupplier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labels": ChartValueAxisLabelsSupplier.from_dict(obj["labels"]) if obj.get("labels") is not None else None,
            "line": ChartValueAxisLineSupplier.from_dict(obj["line"]) if obj.get("line") is not None else None,
