...
class RoomStaySupplier(BaseModel):
    ...
    room: GuestRoomLightweightSupplier
    rooms: StrictInt = Field(description="Number of rooms. Always 1 since we switched to creating one booking per room.")
    bedroom_configuration: BedroomConfigurationSupplier = Field(alias="bedroomConfiguration")
    ...
    rate_plan: RoomConfigurationPriceRatePlanSupplier = Field(alias="ratePlan")
    ...
    extra_charges: ExtraChargesSupplier = Field(alias="extraCharges")
    active_cancellation_policy: CancellationPolicySupplier = Field(alias="activeCancellationPolicy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeCancellationPolicy": CancellationPolicySupplier.from_dict(obj["activeCancellationPolicy"]) if obj.get("activeCancellationPolicy") is not None else None,
