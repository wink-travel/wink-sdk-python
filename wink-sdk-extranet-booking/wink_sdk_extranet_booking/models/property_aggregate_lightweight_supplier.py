...
class PropertyAggregateLightweightSupplier(BaseModel):
    """
    ...
    location: Optional[GeoJsonPointSupplier] = Field(default=None, description="Geo-location")
    descriptions: Optional[List[SimpleDescriptionSupplier]] = Field(default=None, description="Short and long welcome text")
    ...
    reservations: Optional[ContactSupplier] = Field(default=None, description="Contact details for reservations desk")
    ...
    policy: Optional[PropertyPolicySupplier] = Field(default=None, description="Basic property policy record.")
    ...
    address: Optional[SimpleAddressSupplier] = Field(default=None, description="Property address.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PropertyAggregateLightweightSupplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PropertyAggregateLightweightSupplier from a dict"""
        if obj is None:
            return None
