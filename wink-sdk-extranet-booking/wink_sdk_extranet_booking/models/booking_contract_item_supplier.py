...
class BookingContractItemSupplier(BaseModel):
    """
    ...
    itinerary: SimpleDateTimeItinerarySupplier
    ...
    beneficiary_list: Annotated[List[BeneficiarySupplier], Field(min_length=1, max_length=2147483647)] = Field(alias="beneficiaryList")
    payable: StrictStr = Field(description="When to charge for this item.")
    policy: Optional[SupplierContractItemPolicySupplier] = None
    ...
    daily_rate_list: Optional[List[DailyRateSupplier]] = Field(default=None, alias="dailyRateList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BookingContractItemSupplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BookingContractItemSupplier from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "user": GuestUserSupplier.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "nameInEnglish": obj.get("nameInEnglish"),
            "descriptionInEnglish": obj.get("descriptionInEnglish"),
            "itinerary": SimpleDateTimeItinerarySupplier.from_dict(obj["itinerary"]) if obj.get("itinerary") is not None else None,
            "pricingType": obj.get("pricingType"),
            "type": obj.get("type"),
            "beneficiaryList": [BeneficiarySupplier.from_dict(_item) for _item in obj["beneficiaryList"]] if obj.get("beneficiaryList") is not None else None,
            "payable": obj.get("payable"),
            "policy": SupplierContractItemPolicySupplier.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
            "externalIdentifier": obj.get("externalIdentifier"),
            "tokensEarned": obj.get("tokensEarned"),
            "dailyRateList": [DailyRateSupplier.from_dict(_item) for _item in obj["dailyRateList"]] if obj.get("dailyRateList") is not None else None,
