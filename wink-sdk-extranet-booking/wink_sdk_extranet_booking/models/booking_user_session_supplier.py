...
class BookingUserSessionSupplier(BaseModel):
    """
    User session information containing itinerary and other user related data.
    """ # noqa: E501
    itinerary: BookingItinerarySupplier = Field(description="Dates and travel info.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "itinerary": BookingItinerarySupplier.from_dict(obj["itinerary"]) if obj.get("itinerary") is not None else None,
