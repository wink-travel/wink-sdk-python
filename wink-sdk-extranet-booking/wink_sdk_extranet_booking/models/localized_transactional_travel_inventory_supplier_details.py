...
class LocalizedTransactionalTravelInventorySupplierDetails(BaseModel):
    """
    ...
    price: LocalizedPriceSupplierDetails = Field(description="Localized price")
    ...
    offer_details: Optional[List[LocalizedDescriptionSupplierDetails]] = Field(default=None, description="Localized offer details if rate plan discount applies.", alias="offerDetails")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": LocalizedPriceSupplierDetails.from_dict(obj["price"]) if obj.get("price") is not None else None,
