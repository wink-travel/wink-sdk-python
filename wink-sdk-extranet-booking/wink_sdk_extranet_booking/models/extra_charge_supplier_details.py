...
class ExtraChargeSupplierDetails(BaseModel):
    ...
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeSupplierDetails] = Field(default=None, alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceSupplierDetails] = Field(default=None, alias="unitPrice")
    price: Optional[LocalizedPriceSupplierDetails] = None
