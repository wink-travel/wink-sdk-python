...
from wink_sdk_extranet_booking.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_extranet_booking.models
from wink_sdk_extranet_booking import rest
from wink_sdk_extranet_booking.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_extranet_booking.models, klass)
