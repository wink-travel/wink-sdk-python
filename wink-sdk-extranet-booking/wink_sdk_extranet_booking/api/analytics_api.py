...
class AnalyticsApi:
    ...
    @validate_call
    def show_property_booking_analytics(
        self,
        ...
        _param = self._show_property_booking_analytics_serialize(
    ...
    @validate_call
    def show_property_booking_analytics_with_http_info(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Show active booking count for hotel with this identifier")],
        booking_overview_request_supplier: Annotated[BookingOverviewRequestSupplier, Field(description="Overview request body")],
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_property_booking_analytics_without_preload_content(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Show active booking count for hotel with this identifier")],
        booking_overview_request_supplier: Annotated[BookingOverviewRequestSupplier, Field(description="Overview request body")],
        wink_version: Optional[StrictStr] = None,
    ...
    def _show_property_booking_analytics_serialize(
        self,
        property_identifier,
