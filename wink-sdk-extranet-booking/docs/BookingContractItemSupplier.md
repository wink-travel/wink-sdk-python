...
**user** | [**GuestUserSupplier**](GuestUserSupplier.md) |  | 
...
**itinerary** | [**SimpleDateTimeItinerarySupplier**](SimpleDateTimeItinerarySupplier.md) |  | 
**pricing_type** | **str** | How to calculate the total amount. | 
**type** | **str** | Type of item this is. | 
**beneficiary_list** | [**List[BeneficiarySupplier]**](BeneficiarySupplier.md) |  | 
**payable** | **str** | When to charge for this item. | 
**policy** | [**SupplierContractItemPolicySupplier**](SupplierContractItemPolicySupplier.md) |  | [optional] 
...
**daily_rate_list** | [**List[DailyRateSupplier]**](DailyRateSupplier.md) |  | [optional] 
...
booking_contract_item_supplier_instance = BookingContractItemSupplier.from_json(json)
# print the JSON string representation of the object
print(BookingContractItemSupplier.to_json())

# convert the object into a dict
booking_contract_item_supplier_dict = booking_contract_item_supplier_instance.to_dict()
# create an instance of BookingContractItemSupplier from a dict
booking_contract_item_supplier_from_dict = BookingContractItemSupplier.from_dict(booking_contract_item_supplier_dict)
```
