...
**logos** | [**List[SimpleMultimediaSupplier]**](SimpleMultimediaSupplier.md) | Customize booking confirmation emails by adding a custom logo to your configuration. | [optional] 
...
**theme_colors** | [**CustomizationThemeColorsSupplier**](CustomizationThemeColorsSupplier.md) | Choose how you want our web components to look and more closely match with your own site style. | [optional] 
...
**room_configurations** | [**List[RoomConfigurationSupplier]**](RoomConfigurationSupplier.md) | Control how many adults / children will be staying and how many rooms. Defaults to: One room, two adults. | [optional] 
...
**city** | [**GeoNameLightweightSupplier**](GeoNameLightweightSupplier.md) |  | [optional] 
...
json = "{}"
# create an instance of CustomizationLightweightSupplier from a JSON string
customization_lightweight_supplier_instance = CustomizationLightweightSupplier.from_json(json)
# print the JSON string representation of the object
print(CustomizationLightweightSupplier.to_json())

# convert the object into a dict
customization_lightweight_supplier_dict = customization_lightweight_supplier_instance.to_dict()
# create an instance of CustomizationLightweightSupplier from a dict
customization_lightweight_supplier_from_dict = CustomizationLightweightSupplier.from_dict(customization_lightweight_supplier_dict)
```
