...
guest_room_lightweight_supplier_instance = GuestRoomLightweightSupplier.from_json(json)
# print the JSON string representation of the object
print(GuestRoomLightweightSupplier.to_json())

# convert the object into a dict
guest_room_lightweight_supplier_dict = guest_room_lightweight_supplier_instance.to_dict()
# create an instance of GuestRoomLightweightSupplier from a dict
guest_room_lightweight_supplier_from_dict = GuestRoomLightweightSupplier.from_dict(guest_room_lightweight_supplier_dict)
```
