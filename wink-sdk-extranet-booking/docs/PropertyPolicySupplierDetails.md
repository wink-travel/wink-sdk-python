...
**internet_connection_type** | **str** | Indicates how guests can access the Internet on the property. | [optional] 
**internet_connection_location** | **str** | Indicates where internet is available in and around the property. | [optional] 
**parking_availability** | **str** | Indicates whether parking is available at the property. | 
**parking_access** | **str** | Indicates what type of parking is available at the property. | [optional] 
...
property_policy_supplier_details_instance = PropertyPolicySupplierDetails.from_json(json)
# print the JSON string representation of the object
print(PropertyPolicySupplierDetails.to_json())

# convert the object into a dict
property_policy_supplier_details_dict = property_policy_supplier_details_instance.to_dict()
# create an instance of PropertyPolicySupplierDetails from a dict
property_policy_supplier_details_from_dict = PropertyPolicySupplierDetails.from_dict(property_policy_supplier_details_dict)
```
