...
**user** | [**AuthenticatedUserSupplier**](AuthenticatedUserSupplier.md) | The authenticated user ID that made the request | 
...
**display_price_quote** | [**QuoteLightweightSupplier**](QuoteLightweightSupplier.md) | The quote used to create totalDisplayPrice. | 
**supplier_price_quote** | [**QuoteLightweightSupplier**](QuoteLightweightSupplier.md) | The quote used to create totalSupplierPrice. | 
**internal_price_quote** | [**QuoteLightweightSupplier**](QuoteLightweightSupplier.md) | The quote used to create totalInternalPrice. | 
**capture_price_quote** | [**QuoteLightweightSupplier**](QuoteLightweightSupplier.md) | The quote used to create totalCapturePrice. | 
**item_list** | [**List[BookingContractItemSupplier]**](BookingContractItemSupplier.md) | Holds one booking line item for a specific supplier. | 
...
**payment** | [**BookingContractPaymentDetailsSupplier**](BookingContractPaymentDetailsSupplier.md) | Payment details the merchant provided us at the time of payment. | 
...
**refunds** | [**List[RefundSupplier]**](RefundSupplier.md) | An optional list of refunds that occurred with this booking. If the refund amount(s) is the same as the total price, the booking also gets cancelled. | [optional] 
**payouts** | [**List[PayoutSupplier]**](PayoutSupplier.md) | An optional list of refunds that occurred with this booking. If the refund amount(s) is the same as the total price, the booking also gets cancelled. | [optional] 
...
wink_booking_contract_supplier_instance = WinkBookingContractSupplier.from_json(json)
# print the JSON string representation of the object
print(WinkBookingContractSupplier.to_json())

# convert the object into a dict
wink_booking_contract_supplier_dict = wink_booking_contract_supplier_instance.to_dict()
# create an instance of WinkBookingContractSupplier from a dict
wink_booking_contract_supplier_from_dict = WinkBookingContractSupplier.from_dict(wink_booking_contract_supplier_dict)
```
