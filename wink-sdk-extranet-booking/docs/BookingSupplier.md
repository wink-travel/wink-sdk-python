...
**group_identifier** | **UUID** | Unique record identifier for the collection of bookings that were made at the same time. | 
...
**booking_contract** | [**WinkBookingContractSupplierDetails**](WinkBookingContractSupplierDetails.md) | Booking contract created by TripPay | [optional] 
...
**metadata** | **Dict[str, object]** | Place to store related data | [optional] 
