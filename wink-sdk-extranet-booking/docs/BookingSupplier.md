...
**engine_configuration** | [**EngineConfigurationBookingReportSupplier**](EngineConfigurationBookingReportSupplier.md) |  | 
**booking_code** | **str** | Unique user-friendly booking geoname. This code should be used when corresponding with travelers. | 
**user** | [**BookingUserSupplier**](BookingUserSupplier.md) |  | 
**user_session** | [**BookingUserSessionSupplier**](BookingUserSessionSupplier.md) |  | 
**server_url** | **str** | The URL the booking occurred | 
**contact_info** | [**ContactSupplier**](ContactSupplier.md) |  | 
...
**review** | [**ReviewSupplier**](ReviewSupplier.md) |  | [optional] 
...
**room_stay** | [**RoomStaySupplier**](RoomStaySupplier.md) |  | [optional] 
...
**booking_contract** | [**BookingContractSupplier**](BookingContractSupplier.md) |  | [optional] 
...
**reporting_daily_rate_list** | [**List[ReportingDailyRateSupplier]**](ReportingDailyRateSupplier.md) |  | [optional] 
**reporting_ancillary_list** | [**List[ReportingAncillarySupplier]**](ReportingAncillarySupplier.md) |  | [optional] 
**reporting_extra_charge_list** | [**List[ReportingExtraChargeSupplier]**](ReportingExtraChargeSupplier.md) |  | [optional] 
