...
**user** | [**ReviewUserSupplier**](ReviewUserSupplier.md) | User details of creator of booking. | [optional] 
**review_date** | **datetime** | Date of review. | [optional] 
**average_score** | **float** | Total points divided by number of questions. | [optional] 
**answers** | [**List[ReviewAnswerSupplier]**](ReviewAnswerSupplier.md) |  | [optional] 
...
review_lightweight_supplier_instance = ReviewLightweightSupplier.from_json(json)
# print the JSON string representation of the object
print(ReviewLightweightSupplier.to_json())

# convert the object into a dict
review_lightweight_supplier_dict = review_lightweight_supplier_instance.to_dict()
# create an instance of ReviewLightweightSupplier from a dict
review_lightweight_supplier_from_dict = ReviewLightweightSupplier.from_dict(review_lightweight_supplier_dict)
```
