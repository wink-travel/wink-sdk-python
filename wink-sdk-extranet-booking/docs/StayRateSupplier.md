...
**source_to_user_currency_quote** | [**QuoteLightweightSupplier**](QuoteLightweightSupplier.md) | Hotel to user currency exchange rate. | [optional] 
**source_to_internal_currency_quote** | [**QuoteLightweightSupplier**](QuoteLightweightSupplier.md) | Hotel to wink currency exchange rate. | [optional] 
**offer_details** | [**List[LocalizedDescriptionSupplier]**](LocalizedDescriptionSupplier.md) |  | [optional] 
...
stay_rate_supplier_instance = StayRateSupplier.from_json(json)
# print the JSON string representation of the object
print(StayRateSupplier.to_json())

# convert the object into a dict
stay_rate_supplier_dict = stay_rate_supplier_instance.to_dict()
# create an instance of StayRateSupplier from a dict
stay_rate_supplier_from_dict = StayRateSupplier.from_dict(stay_rate_supplier_dict)
```
