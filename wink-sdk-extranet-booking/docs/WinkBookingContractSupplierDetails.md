...
**user** | [**AuthenticatedUserSupplierDetails**](AuthenticatedUserSupplierDetails.md) | The authenticated user ID that made the request | 
...
**internal_price_quote** | [**QuoteLightweightSupplierDetails**](QuoteLightweightSupplierDetails.md) | The quote used to create totalInternalPrice. | 
**capture_price_quote** | [**QuoteLightweightSupplierDetails**](QuoteLightweightSupplierDetails.md) | The quote used to create totalCapturePrice. | 
**item_list** | [**List[BookingContractItemSupplierDetails]**](BookingContractItemSupplierDetails.md) | Holds one booking line item for a specific supplier. | 
...
**payment** | [**BookingContractPaymentDetailsSupplierDetails**](BookingContractPaymentDetailsSupplierDetails.md) | Payment details the merchant provided us at the time of payment. | 
...
**refunds** | [**List[RefundSupplierDetails]**](RefundSupplierDetails.md) | An optional list of refunds that occurred with this booking. If the refund amount(s) is the same as the total price, the booking also gets cancelled. | [optional] 
**payouts** | [**List[PayoutSupplierDetails]**](PayoutSupplierDetails.md) | An optional list of refunds that occurred with this booking. If the refund amount(s) is the same as the total price, the booking also gets cancelled. | [optional] 
...
wink_booking_contract_supplier_details_instance = WinkBookingContractSupplierDetails.from_json(json)
# print the JSON string representation of the object
print(WinkBookingContractSupplierDetails.to_json())

# convert the object into a dict
wink_booking_contract_supplier_details_dict = wink_booking_contract_supplier_details_instance.to_dict()
# create an instance of WinkBookingContractSupplierDetails from a dict
wink_booking_contract_supplier_details_from_dict = WinkBookingContractSupplierDetails.from_dict(wink_booking_contract_supplier_details_dict)
```
