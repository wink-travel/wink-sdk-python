...
review_supplier_instance = ReviewSupplier.from_json(json)
# print the JSON string representation of the object
print(ReviewSupplier.to_json())

# convert the object into a dict
review_supplier_dict = review_supplier_instance.to_dict()
# create an instance of ReviewSupplier from a dict
review_supplier_from_dict = ReviewSupplier.from_dict(review_supplier_dict)
```
