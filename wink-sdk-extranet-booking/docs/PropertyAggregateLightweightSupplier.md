...
**location** | [**GeoJsonPointSupplier**](GeoJsonPointSupplier.md) | Geo-location | [optional] 
**descriptions** | [**List[SimpleDescriptionSupplier]**](SimpleDescriptionSupplier.md) | Short and long welcome text | [optional] 
...
**reservations** | [**ContactSupplier**](ContactSupplier.md) | Contact details for reservations desk | [optional] 
**socials** | [**List[SocialSupplier]**](SocialSupplier.md) | Property&#39;s social network accounts | [optional] 
**images** | [**List[SimpleMultimediaSupplier]**](SimpleMultimediaSupplier.md) | Property images. | [optional] 
**videos** | [**List[SimpleMultimediaSupplier]**](SimpleMultimediaSupplier.md) | Property videos. | [optional] 
**policy** | [**PropertyPolicySupplier**](PropertyPolicySupplier.md) | Basic property policy record. | [optional] 
**third_party_reviews** | [**List[TravelInventoryRecognitionSupplier]**](TravelInventoryRecognitionSupplier.md) | Array of awards and third party reviews given to property by certified / non-certified providers. | [optional] 
...
**address** | [**SimpleAddressSupplier**](SimpleAddressSupplier.md) | Property address. | [optional] 
...
property_aggregate_lightweight_supplier_instance = PropertyAggregateLightweightSupplier.from_json(json)
# print the JSON string representation of the object
print(PropertyAggregateLightweightSupplier.to_json())

# convert the object into a dict
property_aggregate_lightweight_supplier_dict = property_aggregate_lightweight_supplier_instance.to_dict()
# create an instance of PropertyAggregateLightweightSupplier from a dict
property_aggregate_lightweight_supplier_from_dict = PropertyAggregateLightweightSupplier.from_dict(property_aggregate_lightweight_supplier_dict)
```
