...
class TestBookingAncillarySupplier(unittest.TestCase):
    """BookingAncillarySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingAncillarySupplier:
        """Test BookingAncillarySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingAncillarySupplier`
        """
        model = BookingAncillarySupplier()
        if include_optional:
            return BookingAncillarySupplier(
                identifier = '',
                hotel_identifier = '',
                type_identifier = '',
    ...
    def testBookingAncillarySupplier(self):
        """Test BookingAncillarySupplier"""
