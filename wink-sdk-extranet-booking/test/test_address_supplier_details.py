...
class TestAddressSupplierDetails(unittest.TestCase):
    """AddressSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressSupplierDetails:
        """Test AddressSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressSupplierDetails`
        """
        model = AddressSupplierDetails()
        if include_optional:
            return AddressSupplierDetails(
    ...
    def testAddressSupplierDetails(self):
        """Test AddressSupplierDetails"""
