...
class TestPendingRefundSupplierDetails(unittest.TestCase):
    """PendingRefundSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingRefundSupplierDetails:
        """Test PendingRefundSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingRefundSupplierDetails`
        """
        model = PendingRefundSupplierDetails()
        if include_optional:
            return PendingRefundSupplierDetails(
    ...
    def testPendingRefundSupplierDetails(self):
        """Test PendingRefundSupplierDetails"""
