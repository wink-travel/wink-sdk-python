...
class TestPropertyAggregateLightweightSupplier(unittest.TestCase):
    """PropertyAggregateLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateLightweightSupplier:
        """Test PropertyAggregateLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateLightweightSupplier`
        """
        model = PropertyAggregateLightweightSupplier()
        if include_optional:
            return PropertyAggregateLightweightSupplier(
    ...
    def testPropertyAggregateLightweightSupplier(self):
        """Test PropertyAggregateLightweightSupplier"""
