...
class TestCategoryAxisNotesLabelSupplier(unittest.TestCase):
    """CategoryAxisNotesLabelSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryAxisNotesLabelSupplier:
        """Test CategoryAxisNotesLabelSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryAxisNotesLabelSupplier`
        """
        model = CategoryAxisNotesLabelSupplier()
        if include_optional:
            return CategoryAxisNotesLabelSupplier(
                background = '',
    ...
    def testCategoryAxisNotesLabelSupplier(self):
        """Test CategoryAxisNotesLabelSupplier"""
