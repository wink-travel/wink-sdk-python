...
class TestPageReviewViewSupplier(unittest.TestCase):
    """PageReviewViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageReviewViewSupplier:
        """Test PageReviewViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageReviewViewSupplier`
        """
        model = PageReviewViewSupplier()
        if include_optional:
            return PageReviewViewSupplier(
                ...
                size = 56,
                content = [
                    wink_sdk_extranet_booking.models.review_view_supplier.ReviewView_Supplier(
                        id = 'doc-1', 
                        ...
                        review = wink_sdk_extranet_booking.models.review_supplier.Review_Supplier(
                            ...
                            booking_identifier = '', 
                            hotel_identifier = '', 
                            user = wink_sdk_extranet_booking.models.review_user_supplier.ReviewUser_Supplier(
                                user_identifier = '', 
                                first_name = 'John', 
                                last_name = 'Smith', 
    ...
    def testPageReviewViewSupplier(self):
        """Test PageReviewViewSupplier"""
