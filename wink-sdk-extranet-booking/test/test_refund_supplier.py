...
class TestRefundSupplier(unittest.TestCase):
    """RefundSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundSupplier:
        """Test RefundSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundSupplier`
        """
        model = RefundSupplier()
        if include_optional:
            return RefundSupplier(
                identifier = 'refund-1',
