...
class TestChartTooltipSupplier(unittest.TestCase):
    """ChartTooltipSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartTooltipSupplier:
        """Test ChartTooltipSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartTooltipSupplier`
        """
        model = ChartTooltipSupplier()
        if include_optional:
            return ChartTooltipSupplier(
                visible = True,
                format = ''
            )
        else:
    ...
    def testChartTooltipSupplier(self):
        """Test ChartTooltipSupplier"""
