...
class TestBookingContractItemSupplier(unittest.TestCase):
    """BookingContractItemSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractItemSupplier:
        """Test BookingContractItemSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractItemSupplier`
        """
        model = BookingContractItemSupplier()
        if include_optional:
            return BookingContractItemSupplier(
    ...
    def testBookingContractItemSupplier(self):
        """Test BookingContractItemSupplier"""
