...
class TestBookingViewSupplierDetails(unittest.TestCase):
    """BookingViewSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingViewSupplierDetails:
        """Test BookingViewSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingViewSupplierDetails`
        """
        model = BookingViewSupplierDetails()
        if include_optional:
            return BookingViewSupplierDetails(
                ...
                version = 12,
                booking = wink_sdk_extranet_booking.models.booking_supplier_details.Booking_SupplierDetails(
                    creation = 'NORMAL', 
                    date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    group_identifier = '', 
                    identifier = '', 
                    engine_configuration = wink_sdk_extranet_booking.models.engine_configuration_booking_report_supplier_details.EngineConfigurationBookingReport_SupplierDetails(
                        identifier = '', 
                        ...
                        self_hosted = True, 
                        theme_colors = wink_sdk_extranet_booking.models.engine_configuration_theme_supplier_details.EngineConfigurationTheme_SupplierDetails(
                            primary = '#dc3545', 
                            secondary = '#6c757d', 
                            success = '#28a745', 
                            danger = '#dc3545', 
                        ...
                        room_configurations = [
                            wink_sdk_extranet_booking.models.room_configuration_supplier_details.RoomConfiguration_SupplierDetails(
                                adults = 2, 
                                children = [
                    ...
                    user = wink_sdk_extranet_booking.models.booking_user_supplier_details.BookingUser_SupplierDetails(
                        user_identifier = '', 
                        first_name = 'John', 
                        last_name = 'Smith', 
                    ...
                    user_session = wink_sdk_extranet_booking.models.booking_user_session_supplier_details.BookingUserSession_SupplierDetails(
                        itinerary = wink_sdk_extranet_booking.models.booking_itinerary_supplier_details.BookingItinerary_SupplierDetails(
                            start_date = 'Mon Jan 01 07:00:00 ICT 2024', 
                            end_date = 'Tue Jan 02 07:00:00 ICT 2024', 
                            nights = 56, 
                            items = [
                                wink_sdk_extranet_booking.models.booking_itinerary_room_configuration_supplier_details.BookingItineraryRoomConfiguration_SupplierDetails(
                                    adults = 2, )
                                ], 
                            hours = 56, 
                            rooms = 56, 
                    ...
                    server_url = '', 
                    contact_info = wink_sdk_extranet_booking.models.contact_supplier_details.Contact_SupplierDetails(
                        first_name = 'John', 
                        last_name = 'Smith', 
                    ...
                    review = wink_sdk_extranet_booking.models.review_supplier_details.Review_SupplierDetails(
                        identifier = '', 
                        booking_identifier = '', 
                        hotel_identifier = '', 
                        ...
                        average_score = 8.7, 
                        answers = [
                            wink_sdk_extranet_booking.models.review_answer_supplier_details.ReviewAnswer_SupplierDetails(
                                question_identifier = '', 
                                category = 'COMFORT', 
                                sort = 56, 
                                value = 56, )
                    ...
                    logo_identifier = '', 
                    hotel = wink_sdk_extranet_booking.models.hotel_on_map_supplier_details.HotelOnMap_SupplierDetails(
                        ...
                        active = True, 
                        url_parameters = '', ), 
                    room_stay = wink_sdk_extranet_booking.models.room_stay_supplier_details.RoomStay_SupplierDetails(
                        policy = wink_sdk_extranet_booking.models.property_policy_supplier_details.PropertyPolicy_SupplierDetails(
                            children_allowed = True, 
                            children_minimum_age = 6, 
                            internet_availability = 'YES', 
                    ...
                    commission_list = [
                        wink_sdk_extranet_booking.models.commissionable_entry_supplier_details.CommissionableEntry_SupplierDetails(
                            name = '', 
                            identifier = '', 
                            type = 'GUEST_ROOM', 
                    ...
                    ancillary_list = [
                        wink_sdk_extranet_booking.models.booking_ancillary_supplier_details.BookingAncillary_SupplierDetails(
                            identifier = '', 
                            hotel_identifier = '', 
                            type_identifier = '', 
                    ...
                    booking_contract = wink_sdk_extranet_booking.models.booking_contract_supplier_details.BookingContract_SupplierDetails(
                    ...
                    reporting_daily_rate_list = [
                        wink_sdk_extranet_booking.models.reporting_daily_rate_supplier_details.ReportingDailyRate_SupplierDetails(
                    ...
                    reporting_ancillary_list = [
                        wink_sdk_extranet_booking.models.reporting_ancillary_supplier_details.ReportingAncillary_SupplierDetails(
                            name = '', 
                            type = 'LODGING', 
                            gross_amount = 1.337, 
                            net_amount = 1.337, 
                    ...
                    reporting_extra_charge_list = [
                        wink_sdk_extranet_booking.models.reporting_extra_charge_supplier_details.ReportingExtraCharge_SupplierDetails(
                            name = '', 
                            description = '', 
                            gross_amount = 1.337, 
                            net_amount = 1.337, 
    ...
    def testBookingViewSupplierDetails(self):
        """Test BookingViewSupplierDetails"""
