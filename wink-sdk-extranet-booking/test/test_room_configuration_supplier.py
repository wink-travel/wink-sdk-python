...
class TestRoomConfigurationSupplier(unittest.TestCase):
    """RoomConfigurationSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationSupplier:
        """Test RoomConfigurationSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationSupplier`
        """
        model = RoomConfigurationSupplier()
        if include_optional:
            return RoomConfigurationSupplier(
                adults = 2,
                children = [
    ...
    def testRoomConfigurationSupplier(self):
        """Test RoomConfigurationSupplier"""
