...
class TestReportingExtraChargeSupplierDetails(unittest.TestCase):
    """ReportingExtraChargeSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingExtraChargeSupplierDetails:
        """Test ReportingExtraChargeSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingExtraChargeSupplierDetails`
        """
        model = ReportingExtraChargeSupplierDetails()
        if include_optional:
            return ReportingExtraChargeSupplierDetails(
                name = '',
                description = '',
                gross_amount = 1.337,
                net_amount = 1.337,
    ...
    def testReportingExtraChargeSupplierDetails(self):
        """Test ReportingExtraChargeSupplierDetails"""
