...
class TestAuthenticatedUserSupplier(unittest.TestCase):
    """AuthenticatedUserSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticatedUserSupplier:
        """Test AuthenticatedUserSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticatedUserSupplier`
        """
        model = AuthenticatedUserSupplier()
        if include_optional:
            return AuthenticatedUserSupplier(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testAuthenticatedUserSupplier(self):
        """Test AuthenticatedUserSupplier"""
