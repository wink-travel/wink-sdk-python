...
class TestSimpleDateTimeItinerarySupplierDetails(unittest.TestCase):
    """SimpleDateTimeItinerarySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDateTimeItinerarySupplierDetails:
        """Test SimpleDateTimeItinerarySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDateTimeItinerarySupplierDetails`
        """
        model = SimpleDateTimeItinerarySupplierDetails()
        if include_optional:
            return SimpleDateTimeItinerarySupplierDetails(
    ...
    def testSimpleDateTimeItinerarySupplierDetails(self):
        """Test SimpleDateTimeItinerarySupplierDetails"""
