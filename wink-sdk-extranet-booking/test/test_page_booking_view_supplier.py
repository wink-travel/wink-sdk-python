...
class TestPageBookingViewSupplier(unittest.TestCase):
    """PageBookingViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageBookingViewSupplier:
        """Test PageBookingViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageBookingViewSupplier`
        """
        model = PageBookingViewSupplier()
        if include_optional:
            return PageBookingViewSupplier(
                ...
                size = 56,
                content = [
                    wink_sdk_extranet_booking.models.booking_view_supplier.BookingView_Supplier(
                        id = 'doc-1', 
                        created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        version = 12, 
                        booking = wink_sdk_extranet_booking.models.booking_supplier.Booking_Supplier(
                            creation = 'NORMAL', 
                            date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            group_identifier = '', 
                            identifier = '', 
                            engine_configuration = wink_sdk_extranet_booking.models.engine_configuration_booking_report_supplier.EngineConfigurationBookingReport_Supplier(
                                identifier = '', 
                                ...
                                self_hosted = True, 
                                theme_colors = wink_sdk_extranet_booking.models.engine_configuration_theme_supplier.EngineConfigurationTheme_Supplier(
                                    primary = '#dc3545', 
                                    secondary = '#6c757d', 
                                    success = '#28a745', 
                                    danger = '#dc3545', 
                                ...
                                city = wink_sdk_extranet_booking.models.geo_name_supplier.GeoName_Supplier(
                                    geo_name_id = '5128581', 
                                    type = 'CITY', 
                                    name = 'New York City', 
                                    ...
                                    country = wink_sdk_extranet_booking.models.country_supplier.Country_Supplier(
                                        iso = 'US', 
                                        name = 'United States', 
                                        capital = 'Washington', 
                                        continent = 'NA', 
                                        ...
                                        geo_name_id = '6252001', ), 
                                    sub_country = wink_sdk_extranet_booking.models.sub_country_supplier.SubCountry_Supplier(
                                        name = 'New York', 
                                        ascii_name = 'New York', 
                                        geo_name_id = '5128638', ), 
                                    sub_sub_country = wink_sdk_extranet_booking.models.sub_sub_country_supplier.SubSubCountry_Supplier(
                                        name = '', 
                                        ascii_name = '', 
                                        geo_name_id = '', ), ), 
                            ...
                            server_url = '', 
                            contact_info = wink_sdk_extranet_booking.models.contact_supplier.Contact_Supplier(
                                first_name = 'John', 
                                last_name = 'Smith', 
                            ...
                            address = wink_sdk_extranet_booking.models.address_supplier.Address_Supplier(
                            ...
                            review = wink_sdk_extranet_booking.models.review_supplier.Review_Supplier(
                                identifier = '', 
                                booking_identifier = '', 
                                hotel_identifier = '', 
                            ...
                            logo_identifier = '', 
                            hotel = wink_sdk_extranet_booking.models.hotel_on_map_supplier.HotelOnMap_Supplier(
                            ...
                            room_stay = wink_sdk_extranet_booking.models.room_stay_supplier.RoomStay_Supplier(
                                policy = wink_sdk_extranet_booking.models.property_policy_supplier.PropertyPolicy_Supplier(
                                    ...
                                    check_out_time = '10:00', 
                                    check_in_time = '14:00', ), 
                                room = wink_sdk_extranet_booking.models.guest_room_supplier.GuestRoom_Supplier(
                                    identifier = '', 
                                    hotel_identifier = '', 
                                    featured_ind = False, 
                                    lifestyle_type = 'LIFESTYLE_HEALTH_FITNESS', 
                                ...
                                price = wink_sdk_extranet_booking.models.stay_rate_supplier.StayRate_Supplier(
                                    ...
                                    available = True, 
                                    source_to_user_currency_quote = wink_sdk_extranet_booking.models.quote_supplier.Quote_Supplier(
                                        source = '', 
                                        target = '', 
                                        exchange_rate = 1.337, 
                                        timestamp = 56, ), 
                                    source_to_internal_currency_quote = wink_sdk_extranet_booking.models.quote_supplier.Quote_Supplier(
                                        source = '', 
                                        target = '', 
                                        exchange_rate = 1.337, 
                                        timestamp = 56, ), 
                                ...
                                rate_plan = wink_sdk_extranet_booking.models.rate_plan_supplier.RatePlan_Supplier(
                                    identifier = '', 
                                    hotel_identifier = '', 
                                    name = 'BAR 1', 
                                    prepaid = False, 
                                    ...
                                    rate_plan_level_fees = [
                                        wink_sdk_extranet_booking.models.rate_plan_level_fee_supplier.RatePlanLevelFee_Supplier(
                                            descriptions = [
                                    ...
                                    available_days_of_week = wink_sdk_extranet_booking.models.dow_pattern_group_supplier.DowPatternGroup_Supplier(
                                        mon = True, 
                                        tue = True, 
                                        wed = True, 
                                        thu = True, 
                                        ...
                                        sun = True, 
                                        disabled = True, ), 
                                    arrival_days_of_week = wink_sdk_extranet_booking.models.dow_pattern_group_supplier.DowPatternGroup_Supplier(
                                        mon = True, 
                                        tue = True, 
                                        wed = True, 
                                        thu = True, 
                                    ...
                                    cancellation_policy = wink_sdk_extranet_booking.models.cancellation_policy_supplier.CancellationPolicy_Supplier(
                                        identifier = '', 
                                        hotel_identifier = '', 
                                        refundable = False, 
                            ...
                            reporting_daily_rate_list = [
                                wink_sdk_extranet_booking.models.reporting_daily_rate_supplier.ReportingDailyRate_Supplier(
                            ...
                            reporting_ancillary_list = [
                                wink_sdk_extranet_booking.models.reporting_ancillary_supplier.ReportingAncillary_Supplier(
                                    name = '', 
                                    type = 'LODGING', 
                                    gross_amount = 1.337, 
                                    net_amount = 1.337, 
                            ...
                            reporting_extra_charge_list = [
                                wink_sdk_extranet_booking.models.reporting_extra_charge_supplier.ReportingExtraCharge_Supplier(
                                    name = '', 
                                    description = '', 
                                    gross_amount = 1.337, 
                                    net_amount = 1.337, 
                ...
                number = 56,
                sort = [
                    wink_sdk_extranet_booking.models.sort_object.SortObject(
                        direction = '', 
                        null_handling = '', 
                        ascending = True, 
                        property = '', 
    ...
    def testPageBookingViewSupplier(self):
        """Test PageBookingViewSupplier"""
