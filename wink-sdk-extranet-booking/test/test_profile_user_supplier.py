...
class TestProfileUserSupplier(unittest.TestCase):
    """ProfileUserSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileUserSupplier:
        """Test ProfileUserSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileUserSupplier`
        """
        model = ProfileUserSupplier()
        if include_optional:
            return ProfileUserSupplier(
                first_name = 'Avid',
                last_name = 'Travelman',
    ...
    def testProfileUserSupplier(self):
        """Test ProfileUserSupplier"""
