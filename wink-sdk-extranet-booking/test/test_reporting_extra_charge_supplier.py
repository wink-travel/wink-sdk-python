...
class TestReportingExtraChargeSupplier(unittest.TestCase):
    """ReportingExtraChargeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingExtraChargeSupplier:
        """Test ReportingExtraChargeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingExtraChargeSupplier`
        """
        model = ReportingExtraChargeSupplier()
        if include_optional:
            return ReportingExtraChargeSupplier(
                name = '',
                description = '',
                gross_amount = 1.337,
                net_amount = 1.337,
    ...
    def testReportingExtraChargeSupplier(self):
        """Test ReportingExtraChargeSupplier"""
