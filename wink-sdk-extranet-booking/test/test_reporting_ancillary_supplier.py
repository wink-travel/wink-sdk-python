...
class TestReportingAncillarySupplier(unittest.TestCase):
    """ReportingAncillarySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingAncillarySupplier:
        """Test ReportingAncillarySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingAncillarySupplier`
        """
        model = ReportingAncillarySupplier()
        if include_optional:
            return ReportingAncillarySupplier(
                name = '',
                type = 'LODGING',
                gross_amount = 1.337,
                net_amount = 1.337,
    ...
    def testReportingAncillarySupplier(self):
        """Test ReportingAncillarySupplier"""
