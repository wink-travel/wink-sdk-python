...
class TestBedroomConfigurationSupplierDetails(unittest.TestCase):
    """BedroomConfigurationSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomConfigurationSupplierDetails:
        """Test BedroomConfigurationSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomConfigurationSupplierDetails`
        """
        model = BedroomConfigurationSupplierDetails()
        if include_optional:
            return BedroomConfigurationSupplierDetails(
                identifier = '',
                name = '',
                bedroom_list = [
    ...
    def testBedroomConfigurationSupplierDetails(self):
        """Test BedroomConfigurationSupplierDetails"""
