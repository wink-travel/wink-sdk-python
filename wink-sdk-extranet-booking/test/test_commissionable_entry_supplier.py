...
class TestCommissionableEntrySupplier(unittest.TestCase):
    """CommissionableEntrySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommissionableEntrySupplier:
        """Test CommissionableEntrySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommissionableEntrySupplier`
        """
        model = CommissionableEntrySupplier()
        if include_optional:
            return CommissionableEntrySupplier(
                name = '',
                identifier = '',
                type = 'GUEST_ROOM',
    ...
    def testCommissionableEntrySupplier(self):
        """Test CommissionableEntrySupplier"""
