...
class TestSupplierContractItemPolicySupplier(unittest.TestCase):
    """SupplierContractItemPolicySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierContractItemPolicySupplier:
        """Test SupplierContractItemPolicySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierContractItemPolicySupplier`
        """
        model = SupplierContractItemPolicySupplier()
        if include_optional:
            return SupplierContractItemPolicySupplier(
                refundable = True,
    ...
    def testSupplierContractItemPolicySupplier(self):
        """Test SupplierContractItemPolicySupplier"""
