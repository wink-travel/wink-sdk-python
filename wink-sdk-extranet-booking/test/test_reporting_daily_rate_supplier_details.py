...
class TestReportingDailyRateSupplierDetails(unittest.TestCase):
    """ReportingDailyRateSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingDailyRateSupplierDetails:
        """Test ReportingDailyRateSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingDailyRateSupplierDetails`
        """
        model = ReportingDailyRateSupplierDetails()
        if include_optional:
            return ReportingDailyRateSupplierDetails(
    ...
    def testReportingDailyRateSupplierDetails(self):
        """Test ReportingDailyRateSupplierDetails"""
