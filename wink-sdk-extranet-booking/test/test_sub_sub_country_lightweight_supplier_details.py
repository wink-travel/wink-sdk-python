...
class TestSubSubCountryLightweightSupplierDetails(unittest.TestCase):
    """SubSubCountryLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryLightweightSupplierDetails:
        """Test SubSubCountryLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryLightweightSupplierDetails`
        """
        model = SubSubCountryLightweightSupplierDetails()
        if include_optional:
            return SubSubCountryLightweightSupplierDetails(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryLightweightSupplierDetails(self):
        """Test SubSubCountryLightweightSupplierDetails"""
