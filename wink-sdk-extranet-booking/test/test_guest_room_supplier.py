    ...
    def make_instance(self, include_optional) -> GuestRoomSupplier:
        ...
        if include_optional:
            return GuestRoomSupplier(
                ...
                base_rate = wink_sdk_extranet_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', ),
                min_rate = wink_sdk_extranet_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', )
            )
        else:
