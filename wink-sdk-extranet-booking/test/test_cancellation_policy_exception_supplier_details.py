...
class TestCancellationPolicyExceptionSupplierDetails(unittest.TestCase):
    """CancellationPolicyExceptionSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionSupplierDetails:
        """Test CancellationPolicyExceptionSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionSupplierDetails`
        """
        model = CancellationPolicyExceptionSupplierDetails()
        if include_optional:
            return CancellationPolicyExceptionSupplierDetails(
    ...
    def testCancellationPolicyExceptionSupplierDetails(self):
        """Test CancellationPolicyExceptionSupplierDetails"""
