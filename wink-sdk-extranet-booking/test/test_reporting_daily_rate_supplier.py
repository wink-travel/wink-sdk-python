...
class TestReportingDailyRateSupplier(unittest.TestCase):
    """ReportingDailyRateSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingDailyRateSupplier:
        """Test ReportingDailyRateSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingDailyRateSupplier`
        """
        model = ReportingDailyRateSupplier()
        if include_optional:
            return ReportingDailyRateSupplier(
    ...
    def testReportingDailyRateSupplier(self):
        """Test ReportingDailyRateSupplier"""
