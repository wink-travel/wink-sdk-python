...
class TestBeneficiarySupplierDetails(unittest.TestCase):
    """BeneficiarySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiarySupplierDetails:
        """Test BeneficiarySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiarySupplierDetails`
        """
        model = BeneficiarySupplierDetails()
        if include_optional:
            return BeneficiarySupplierDetails(
    ...
    def testBeneficiarySupplierDetails(self):
        """Test BeneficiarySupplierDetails"""
