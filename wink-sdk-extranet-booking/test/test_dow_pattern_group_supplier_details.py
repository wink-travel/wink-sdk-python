...
class TestDowPatternGroupSupplierDetails(unittest.TestCase):
    """DowPatternGroupSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DowPatternGroupSupplierDetails:
        """Test DowPatternGroupSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DowPatternGroupSupplierDetails`
        """
        model = DowPatternGroupSupplierDetails()
        if include_optional:
            return DowPatternGroupSupplierDetails(
                mon = True,
                tue = True,
                wed = True,
                thu = True,
    ...
    def testDowPatternGroupSupplierDetails(self):
        """Test DowPatternGroupSupplierDetails"""
