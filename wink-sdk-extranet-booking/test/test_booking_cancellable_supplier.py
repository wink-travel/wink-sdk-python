...
class TestBookingCancellableSupplier(unittest.TestCase):
    """BookingCancellableSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingCancellableSupplier:
        """Test BookingCancellableSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingCancellableSupplier`
        """
        model = BookingCancellableSupplier()
        if include_optional:
    ...
    def testBookingCancellableSupplier(self):
        """Test BookingCancellableSupplier"""
