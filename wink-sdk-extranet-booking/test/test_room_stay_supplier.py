...
class TestRoomStaySupplier(unittest.TestCase):
    """RoomStaySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomStaySupplier:
        """Test RoomStaySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomStaySupplier`
        """
        model = RoomStaySupplier()
        if include_optional:
            return RoomStaySupplier(
                ...
                extra_charges = wink_sdk_extranet_booking.models.extra_charges_supplier.ExtraCharges_Supplier(
                    items = [
                        wink_sdk_extranet_booking.models.items.Items(
                            rate_plan_level_fee = wink_sdk_extranet_booking.models.rate_plan_level_fee_supplier.RatePlanLevelFee_Supplier(
                                descriptions = [
                                    wink_sdk_extranet_booking.models.localized_description_supplier.LocalizedDescription_Supplier(
                                        description = 'This is a longer description in the specified language.', 
                                        language = 'en', )
                                ...
                                fixed_amount = wink_sdk_extranet_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                                    ...
                                    currency = '', ), 
                                type = 'PER_DAY', ), 
                            unit_price = wink_sdk_extranet_booking.models.localized_price_supplier.LocalizedPrice_Supplier(
                                source_to_user_currency_quote = wink_sdk_extranet_booking.models.quote_supplier.Quote_Supplier(
                                    source = '', 
                                    target = '', 
                                    exchange_rate = 1.337, 
                    ...
                    source_total = , 
                    internal_total = , ),
                active_cancellation_policy = wink_sdk_extranet_booking.models.cancellation_policy_supplier.CancellationPolicy_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
                    refundable = False, 
                    advance_cancellation_free_of_charge = 'UNTIL_EIGHTEEN_HUNDRED_HOURS_ON_DAY_OF_ARRIVAL', 
