...
class TestPetInfoDtoSupplier(unittest.TestCase):
    """PetInfoDtoSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoDtoSupplier:
        """Test PetInfoDtoSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoDtoSupplier`
        """
        model = PetInfoDtoSupplier()
        if include_optional:
            return PetInfoDtoSupplier(
                name = '',
                type = ''
            )
        else:
    ...
    def testPetInfoDtoSupplier(self):
        """Test PetInfoDtoSupplier"""
