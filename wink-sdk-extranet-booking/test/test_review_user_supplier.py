...
class TestReviewUserSupplier(unittest.TestCase):
    """ReviewUserSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewUserSupplier:
        """Test ReviewUserSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewUserSupplier`
        """
        model = ReviewUserSupplier()
        if include_optional:
            return ReviewUserSupplier(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testReviewUserSupplier(self):
        """Test ReviewUserSupplier"""
