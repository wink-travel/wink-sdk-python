...
class TestExtraChargesSupplier(unittest.TestCase):
    """ExtraChargesSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargesSupplier:
        """Test ExtraChargesSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargesSupplier`
        """
        model = ExtraChargesSupplier()
        if include_optional:
            return ExtraChargesSupplier(
                items = [
    ...
    def testExtraChargesSupplier(self):
        """Test ExtraChargesSupplier"""
