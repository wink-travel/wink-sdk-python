...
class TestSimpleDescriptionSupplierDetails(unittest.TestCase):
    """SimpleDescriptionSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDescriptionSupplierDetails:
        """Test SimpleDescriptionSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDescriptionSupplierDetails`
        """
        model = SimpleDescriptionSupplierDetails()
        if include_optional:
            return SimpleDescriptionSupplierDetails(
    ...
    def testSimpleDescriptionSupplierDetails(self):
        """Test SimpleDescriptionSupplierDetails"""
