...
class TestBookingViewSupplier(unittest.TestCase):
    """BookingViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingViewSupplier:
        """Test BookingViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingViewSupplier`
        """
        model = BookingViewSupplier()
        if include_optional:
    ...
    def testBookingViewSupplier(self):
        """Test BookingViewSupplier"""
