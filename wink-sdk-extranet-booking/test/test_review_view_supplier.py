...
class TestReviewViewSupplier(unittest.TestCase):
    """ReviewViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewViewSupplier:
        """Test ReviewViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewViewSupplier`
        """
        model = ReviewViewSupplier()
        if include_optional:
    ...
    def testReviewViewSupplier(self):
        """Test ReviewViewSupplier"""
