...
class TestChildSupplier(unittest.TestCase):
    """ChildSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChildSupplier:
        """Test ChildSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildSupplier`
        """
        model = ChildSupplier()
        if include_optional:
