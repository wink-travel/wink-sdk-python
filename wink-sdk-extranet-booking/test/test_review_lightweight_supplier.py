...
class TestReviewLightweightSupplier(unittest.TestCase):
    """ReviewLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewLightweightSupplier:
        """Test ReviewLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewLightweightSupplier`
        """
        model = ReviewLightweightSupplier()
        if include_optional:
            return ReviewLightweightSupplier(
                identifier = 'review-1',
    ...
    def testReviewLightweightSupplier(self):
        """Test ReviewLightweightSupplier"""
