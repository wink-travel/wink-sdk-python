...
class TestRefundSupplierDetails(unittest.TestCase):
    """RefundSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefundSupplierDetails:
        """Test RefundSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundSupplierDetails`
        """
        model = RefundSupplierDetails()
        if include_optional:
            return RefundSupplierDetails(
                identifier = 'refund-1',
    ...
    def testRefundSupplierDetails(self):
        """Test RefundSupplierDetails"""
