...
class TestChildSupplierDetails(unittest.TestCase):
    """ChildSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChildSupplierDetails:
        """Test ChildSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildSupplierDetails`
        """
        model = ChildSupplierDetails()
        if include_optional:
            return ChildSupplierDetails(
                quantity = 1,
                age = 0
            )
        else:
    ...
    def testChildSupplierDetails(self):
        """Test ChildSupplierDetails"""
