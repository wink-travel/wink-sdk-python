...
class TestBookingContractItemSupplierDetails(unittest.TestCase):
    """BookingContractItemSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractItemSupplierDetails:
        """Test BookingContractItemSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractItemSupplierDetails`
        """
        model = BookingContractItemSupplierDetails()
        if include_optional:
            return BookingContractItemSupplierDetails(
    ...
    def testBookingContractItemSupplierDetails(self):
        """Test BookingContractItemSupplierDetails"""
