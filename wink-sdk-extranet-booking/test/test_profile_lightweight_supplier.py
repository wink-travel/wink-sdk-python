...
class TestProfileLightweightSupplier(unittest.TestCase):
    """ProfileLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileLightweightSupplier:
        """Test ProfileLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileLightweightSupplier`
        """
        model = ProfileLightweightSupplier()
        if include_optional:
            return ProfileLightweightSupplier(
    ...
    def testProfileLightweightSupplier(self):
        """Test ProfileLightweightSupplier"""
