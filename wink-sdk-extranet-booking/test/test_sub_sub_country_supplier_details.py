...
class TestSubSubCountrySupplierDetails(unittest.TestCase):
    """SubSubCountrySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountrySupplierDetails:
        """Test SubSubCountrySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountrySupplierDetails`
        """
        model = SubSubCountrySupplierDetails()
        if include_optional:
            return SubSubCountrySupplierDetails(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountrySupplierDetails(self):
        """Test SubSubCountrySupplierDetails"""
