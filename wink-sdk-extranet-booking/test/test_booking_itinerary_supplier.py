...
class TestBookingItinerarySupplier(unittest.TestCase):
    """BookingItinerarySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingItinerarySupplier:
        """Test BookingItinerarySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingItinerarySupplier`
        """
        model = BookingItinerarySupplier()
        if include_optional:
            return BookingItinerarySupplier(
    ...
    def testBookingItinerarySupplier(self):
        """Test BookingItinerarySupplier"""
