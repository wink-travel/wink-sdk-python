...
class TestCalendarSyncApi(unittest.TestCase):
    """CalendarSyncApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CalendarSyncApi()

    def tearDown(self) -> None:
        pass

    def test_caldav(self) -> None:
        """Test case for caldav

        CalDAV calendar
        """
        pass

    def test_generate_cal_dav_auth(self) -> None:
        """Test case for generate_cal_dav_auth

        Create CalDAV connection
        """
        pass

    def test_retrieve_cal_dav_auth(self) -> None:
        """Test case for retrieve_cal_dav_auth
