...
class TestSubCountryLightweightSupplierDetails(unittest.TestCase):
    """SubCountryLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryLightweightSupplierDetails:
        """Test SubCountryLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryLightweightSupplierDetails`
        """
        model = SubCountryLightweightSupplierDetails()
        if include_optional:
            return SubCountryLightweightSupplierDetails(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountryLightweightSupplierDetails(self):
        """Test SubCountryLightweightSupplierDetails"""
