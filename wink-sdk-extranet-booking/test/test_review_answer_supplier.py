...
class TestReviewAnswerSupplier(unittest.TestCase):
    """ReviewAnswerSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewAnswerSupplier:
        """Test ReviewAnswerSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAnswerSupplier`
        """
        model = ReviewAnswerSupplier()
        if include_optional:
            return ReviewAnswerSupplier(
                question_identifier = '',
                category = 'COMFORT',
                sort = 56,
                value = 56
    ...
    def testReviewAnswerSupplier(self):
        """Test ReviewAnswerSupplier"""
