...
class TestRatePlanLevelFeeSupplier(unittest.TestCase):
    """RatePlanLevelFeeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanLevelFeeSupplier:
        """Test RatePlanLevelFeeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanLevelFeeSupplier`
        """
        model = RatePlanLevelFeeSupplier()
        if include_optional:
            return RatePlanLevelFeeSupplier(
                descriptions = [
    ...
    def testRatePlanLevelFeeSupplier(self):
        """Test RatePlanLevelFeeSupplier"""
