...
class TestCancellationPolicySupplier(unittest.TestCase):
    """CancellationPolicySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicySupplier:
        """Test CancellationPolicySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicySupplier`
        """
        model = CancellationPolicySupplier()
        if include_optional:
            return CancellationPolicySupplier(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicySupplier(self):
        """Test CancellationPolicySupplier"""
