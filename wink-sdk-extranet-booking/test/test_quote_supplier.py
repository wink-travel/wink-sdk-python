...
class TestQuoteSupplier(unittest.TestCase):
    """QuoteSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteSupplier:
        """Test QuoteSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteSupplier`
        """
        model = QuoteSupplier()
        if include_optional:
