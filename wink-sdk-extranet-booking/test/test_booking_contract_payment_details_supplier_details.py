...
class TestBookingContractPaymentDetailsSupplierDetails(unittest.TestCase):
    """BookingContractPaymentDetailsSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractPaymentDetailsSupplierDetails:
        """Test BookingContractPaymentDetailsSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractPaymentDetailsSupplierDetails`
        """
        model = BookingContractPaymentDetailsSupplierDetails()
        if include_optional:
            return BookingContractPaymentDetailsSupplierDetails(
    ...
    def testBookingContractPaymentDetailsSupplierDetails(self):
        """Test BookingContractPaymentDetailsSupplierDetails"""
