...
class TestPersonalSupplierDetails(unittest.TestCase):
    """PersonalSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalSupplierDetails:
        """Test PersonalSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalSupplierDetails`
        """
        model = PersonalSupplierDetails()
        if include_optional:
            return PersonalSupplierDetails(
                gender = 'MALE',
    ...
    def testPersonalSupplierDetails(self):
        """Test PersonalSupplierDetails"""
