...
class TestShowReview400Response(unittest.TestCase):
    """ShowReview400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowReview400Response:
        """Test ShowReview400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowReview400Response`
        """
        model = ShowReview400Response()
        if include_optional:
            return ShowReview400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowReview400Response(self):
        """Test ShowReview400Response"""
