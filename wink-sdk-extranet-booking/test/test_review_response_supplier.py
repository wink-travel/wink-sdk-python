...
class TestReviewResponseSupplier(unittest.TestCase):
    """ReviewResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewResponseSupplier:
        """Test ReviewResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewResponseSupplier`
        """
        model = ReviewResponseSupplier()
        if include_optional:
            return ReviewResponseSupplier(
                response_from_hotel = 'Thank you for coming. Lovely to hear you enjoyed your stay.',
                approved_text = True,
                approved_image = True
            )
        else:
    ...
    def testReviewResponseSupplier(self):
        """Test ReviewResponseSupplier"""
