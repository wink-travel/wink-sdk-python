...
class TestBookingUserSupplier(unittest.TestCase):
    """BookingUserSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserSupplier:
        """Test BookingUserSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserSupplier`
        """
        model = BookingUserSupplier()
        if include_optional:
            return BookingUserSupplier(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testBookingUserSupplier(self):
        """Test BookingUserSupplier"""
