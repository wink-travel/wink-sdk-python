...
class TestPayoutSupplier(unittest.TestCase):
    """PayoutSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutSupplier:
        """Test PayoutSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutSupplier`
        """
        model = PayoutSupplier()
        if include_optional:
            return PayoutSupplier(
                vendor = 'STRIPE',
                vendor_identifier = '',
                vendor_name = '',
                vendor_token_key = '',
