...
class TestBeneficiaryChargeSupplier(unittest.TestCase):
    """BeneficiaryChargeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiaryChargeSupplier:
        """Test BeneficiaryChargeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiaryChargeSupplier`
        """
        model = BeneficiaryChargeSupplier()
        if include_optional:
            return BeneficiaryChargeSupplier(
                type = 'PERCENTAGE',
                percent = 1.337
            )
        else:
    ...
    def testBeneficiaryChargeSupplier(self):
        """Test BeneficiaryChargeSupplier"""
