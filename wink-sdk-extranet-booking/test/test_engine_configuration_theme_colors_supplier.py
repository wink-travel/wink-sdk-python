...
class TestEngineConfigurationThemeColorsSupplier(unittest.TestCase):
    """EngineConfigurationThemeColorsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeColorsSupplier:
        """Test EngineConfigurationThemeColorsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeColorsSupplier`
        """
        model = EngineConfigurationThemeColorsSupplier()
        if include_optional:
            return EngineConfigurationThemeColorsSupplier(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeColorsSupplier(self):
        """Test EngineConfigurationThemeColorsSupplier"""
