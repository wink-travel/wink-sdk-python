...
class TestStayRateSupplier(unittest.TestCase):
    """StayRateSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StayRateSupplier:
        """Test StayRateSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StayRateSupplier`
        """
        model = StayRateSupplier()
        if include_optional:
            return StayRateSupplier(
