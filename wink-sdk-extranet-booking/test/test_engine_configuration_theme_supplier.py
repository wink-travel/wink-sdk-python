...
class TestEngineConfigurationThemeSupplier(unittest.TestCase):
    """EngineConfigurationThemeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeSupplier:
        """Test EngineConfigurationThemeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeSupplier`
        """
        model = EngineConfigurationThemeSupplier()
        if include_optional:
            return EngineConfigurationThemeSupplier(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeSupplier(self):
        """Test EngineConfigurationThemeSupplier"""
