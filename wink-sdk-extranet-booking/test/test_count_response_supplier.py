...
class TestCountResponseSupplier(unittest.TestCase):
    """CountResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountResponseSupplier:
        """Test CountResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountResponseSupplier`
        """
        model = CountResponseSupplier()
        if include_optional:
    ...
    def testCountResponseSupplier(self):
        """Test CountResponseSupplier"""
