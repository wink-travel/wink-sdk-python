...
class TestPayoutSupplierDetails(unittest.TestCase):
    """PayoutSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutSupplierDetails:
        """Test PayoutSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutSupplierDetails`
        """
        model = PayoutSupplierDetails()
        if include_optional:
            return PayoutSupplierDetails(
                vendor = 'STRIPE',
                vendor_identifier = '',
                vendor_name = '',
                vendor_token_key = '',
    ...
    def testPayoutSupplierDetails(self):
        """Test PayoutSupplierDetails"""
