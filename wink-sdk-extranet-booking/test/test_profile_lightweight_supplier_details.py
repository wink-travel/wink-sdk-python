...
class TestProfileLightweightSupplierDetails(unittest.TestCase):
    """ProfileLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileLightweightSupplierDetails:
        """Test ProfileLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileLightweightSupplierDetails`
        """
        model = ProfileLightweightSupplierDetails()
        if include_optional:
            return ProfileLightweightSupplierDetails(
    ...
    def testProfileLightweightSupplierDetails(self):
        """Test ProfileLightweightSupplierDetails"""
