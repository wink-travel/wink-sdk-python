...
class TestBookingItineraryRoomConfigurationChildSupplier(unittest.TestCase):
    """BookingItineraryRoomConfigurationChildSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingItineraryRoomConfigurationChildSupplier:
        """Test BookingItineraryRoomConfigurationChildSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingItineraryRoomConfigurationChildSupplier`
        """
        model = BookingItineraryRoomConfigurationChildSupplier()
        if include_optional:
            return BookingItineraryRoomConfigurationChildSupplier(
                quantity = 56,
                age = 56
            )
        else:
    ...
    def testBookingItineraryRoomConfigurationChildSupplier(self):
        """Test BookingItineraryRoomConfigurationChildSupplier"""
