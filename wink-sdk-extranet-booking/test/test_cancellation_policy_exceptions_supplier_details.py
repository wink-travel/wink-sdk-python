...
class TestCancellationPolicyExceptionsSupplierDetails(unittest.TestCase):
    """CancellationPolicyExceptionsSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionsSupplierDetails:
        """Test CancellationPolicyExceptionsSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionsSupplierDetails`
        """
        model = CancellationPolicyExceptionsSupplierDetails()
        if include_optional:
            return CancellationPolicyExceptionsSupplierDetails(
                list = [
    ...
    def testCancellationPolicyExceptionsSupplierDetails(self):
        """Test CancellationPolicyExceptionsSupplierDetails"""
