...
class TestBookingContractPaymentDetailsSupplier(unittest.TestCase):
    """BookingContractPaymentDetailsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingContractPaymentDetailsSupplier:
        """Test BookingContractPaymentDetailsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingContractPaymentDetailsSupplier`
        """
        model = BookingContractPaymentDetailsSupplier()
        if include_optional:
            return BookingContractPaymentDetailsSupplier(
    ...
    def testBookingContractPaymentDetailsSupplier(self):
        """Test BookingContractPaymentDetailsSupplier"""
