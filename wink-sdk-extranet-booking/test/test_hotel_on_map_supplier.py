...
class TestHotelOnMapSupplier(unittest.TestCase):
    """HotelOnMapSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelOnMapSupplier:
        """Test HotelOnMapSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelOnMapSupplier`
        """
        model = HotelOnMapSupplier()
        if include_optional:
            return HotelOnMapSupplier(
                ...
                general_manager = wink_sdk_extranet_booking.models.general_manager_supplier.GeneralManager_Supplier(
                    name = 'Jane Doe', 
                    image = wink_sdk_extranet_booking.models.simple_multimedia_supplier.SimpleMultimedia_Supplier(
                        multimedia_identifier = '', 
                        identifier = 'cloudinary-image-1', 
                        type = 'IMAGE', 
                        source = 'CLOUDINARY', 
    ...
    def testHotelOnMapSupplier(self):
        """Test HotelOnMapSupplier"""
