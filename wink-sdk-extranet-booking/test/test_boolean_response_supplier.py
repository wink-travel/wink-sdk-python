...
class TestBooleanResponseSupplier(unittest.TestCase):
    """BooleanResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BooleanResponseSupplier:
        """Test BooleanResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BooleanResponseSupplier`
        """
        model = BooleanResponseSupplier()
        if include_optional:
    ...
    def testBooleanResponseSupplier(self):
        """Test BooleanResponseSupplier"""
