...
class TestAxisLineSupplier(unittest.TestCase):
    """AxisLineSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AxisLineSupplier:
        """Test AxisLineSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AxisLineSupplier`
        """
        model = AxisLineSupplier()
        if include_optional:
            return AxisLineSupplier(
                color = '',
                dash_type = 'dash',
                visible = True,
                width = 1.337
