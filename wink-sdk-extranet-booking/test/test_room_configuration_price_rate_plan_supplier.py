...
class TestRoomConfigurationPriceRatePlanSupplier(unittest.TestCase):
    """RoomConfigurationPriceRatePlanSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceRatePlanSupplier:
        """Test RoomConfigurationPriceRatePlanSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationPriceRatePlanSupplier`
        """
        model = RoomConfigurationPriceRatePlanSupplier()
        if include_optional:
            return RoomConfigurationPriceRatePlanSupplier(
                identifier = '',
                name = 'BAR 1',
                breakfast = False,
                brunch = False,
    ...
    def testRoomConfigurationPriceRatePlanSupplier(self):
        """Test RoomConfigurationPriceRatePlanSupplier"""
