...
class TestTravelInventoryRecognitionSupplierDetails(unittest.TestCase):
    """TravelInventoryRecognitionSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelInventoryRecognitionSupplierDetails:
        """Test TravelInventoryRecognitionSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelInventoryRecognitionSupplierDetails`
        """
        model = TravelInventoryRecognitionSupplierDetails()
        if include_optional:
            return TravelInventoryRecognitionSupplierDetails(
                identifier = '',
                category = 'AWARD',
                type = 'PERCENT_RATING',
                provider = 'Michelin',
    ...
    def testTravelInventoryRecognitionSupplierDetails(self):
        """Test TravelInventoryRecognitionSupplierDetails"""
