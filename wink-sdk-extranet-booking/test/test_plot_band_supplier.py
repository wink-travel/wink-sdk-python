...
class TestPlotBandSupplier(unittest.TestCase):
    """PlotBandSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlotBandSupplier:
        """Test PlotBandSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlotBandSupplier`
        """
        model = PlotBandSupplier()
        if include_optional:
            return PlotBandSupplier(
                color = '',
                var_from = '',
                opacity = 1.337,
                to = ''
