...
class TestFeeSupplierDetails(unittest.TestCase):
    """FeeSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeeSupplierDetails:
        """Test FeeSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeeSupplierDetails`
        """
        model = FeeSupplierDetails()
        if include_optional:
            return FeeSupplierDetails(
                identifier = 'ABC1234',
    ...
    def testFeeSupplierDetails(self):
        """Test FeeSupplierDetails"""
