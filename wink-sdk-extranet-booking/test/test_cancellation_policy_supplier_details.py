...
class TestCancellationPolicySupplierDetails(unittest.TestCase):
    """CancellationPolicySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicySupplierDetails:
        """Test CancellationPolicySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicySupplierDetails`
        """
        model = CancellationPolicySupplierDetails()
        if include_optional:
            return CancellationPolicySupplierDetails(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicySupplierDetails(self):
        """Test CancellationPolicySupplierDetails"""
