...
class TestReviewSupplier(unittest.TestCase):
    """ReviewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewSupplier:
        """Test ReviewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewSupplier`
        """
        model = ReviewSupplier()
        if include_optional:
