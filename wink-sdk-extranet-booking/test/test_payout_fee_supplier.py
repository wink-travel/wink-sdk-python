...
class TestPayoutFeeSupplier(unittest.TestCase):
    """PayoutFeeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutFeeSupplier:
        """Test PayoutFeeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutFeeSupplier`
        """
        model = PayoutFeeSupplier()
        if include_optional:
            return PayoutFeeSupplier(
                identifier = '',
    ...
    def testPayoutFeeSupplier(self):
        """Test PayoutFeeSupplier"""
