...
class TestBeneficiarySupplier(unittest.TestCase):
    """BeneficiarySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeneficiarySupplier:
        """Test BeneficiarySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeneficiarySupplier`
        """
        model = BeneficiarySupplier()
        if include_optional:
            return BeneficiarySupplier(
    ...
    def testBeneficiarySupplier(self):
        """Test BeneficiarySupplier"""
