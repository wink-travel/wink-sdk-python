...
class TestPreferencesSupplier(unittest.TestCase):
    """PreferencesSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreferencesSupplier:
        """Test PreferencesSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreferencesSupplier`
        """
        model = PreferencesSupplier()
        if include_optional:
            return PreferencesSupplier(
    ...
    def testPreferencesSupplier(self):
        """Test PreferencesSupplier"""
