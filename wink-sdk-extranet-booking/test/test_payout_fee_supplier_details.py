...
class TestPayoutFeeSupplierDetails(unittest.TestCase):
    """PayoutFeeSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutFeeSupplierDetails:
        """Test PayoutFeeSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutFeeSupplierDetails`
        """
        model = PayoutFeeSupplierDetails()
        if include_optional:
            return PayoutFeeSupplierDetails(
                identifier = '',
    ...
    def testPayoutFeeSupplierDetails(self):
        """Test PayoutFeeSupplierDetails"""
