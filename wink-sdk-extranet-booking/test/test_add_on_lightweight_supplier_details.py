...
class TestAddOnLightweightSupplierDetails(unittest.TestCase):
    """AddOnLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOnLightweightSupplierDetails:
        """Test AddOnLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOnLightweightSupplierDetails`
        """
        model = AddOnLightweightSupplierDetails()
        if include_optional:
            return AddOnLightweightSupplierDetails(
                identifier = 'document-1',
                hotel_identifier = 'hotel-1',
                featured_ind = False,
                lifestyle_type = 'LIFESTYLE_HEALTH_FITNESS',
                location = wink_sdk_extranet_booking.models.geo_json_point_supplier_details.GeoJsonPoint_SupplierDetails(
                    x = 1.337, 
                    y = 1.337, 
                    type = '', 
                    coordinates = [
                ...
                address = wink_sdk_extranet_booking.models.simple_address_supplier_details.SimpleAddress_SupplierDetails(
                    address1 = '234', 
                ...
                opens = '09:00',
                closes = '17:30',
                days_of_week = wink_sdk_extranet_booking.models.dow_pattern_group_supplier_details.DowPatternGroup_SupplierDetails(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
    ...
    def testAddOnLightweightSupplierDetails(self):
        """Test AddOnLightweightSupplierDetails"""
