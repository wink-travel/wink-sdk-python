...
class TestBookingUserSessionSupplier(unittest.TestCase):
    """BookingUserSessionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserSessionSupplier:
        """Test BookingUserSessionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserSessionSupplier`
        """
        model = BookingUserSessionSupplier()
        if include_optional:
            return BookingUserSessionSupplier(
    ...
    def testBookingUserSessionSupplier(self):
        """Test BookingUserSessionSupplier"""
