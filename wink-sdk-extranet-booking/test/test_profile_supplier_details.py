...
class TestProfileSupplierDetails(unittest.TestCase):
    """ProfileSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileSupplierDetails:
        """Test ProfileSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileSupplierDetails`
        """
        model = ProfileSupplierDetails()
        if include_optional:
            return ProfileSupplierDetails(
                profile_identifier = '',
                user_identifier = '',
                share = True,
    ...
    def testProfileSupplierDetails(self):
        """Test ProfileSupplierDetails"""
