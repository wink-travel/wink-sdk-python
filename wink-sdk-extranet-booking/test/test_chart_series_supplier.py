...
class TestChartSeriesSupplier(unittest.TestCase):
    """ChartSeriesSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartSeriesSupplier:
        """Test ChartSeriesSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartSeriesSupplier`
        """
        model = ChartSeriesSupplier()
        if include_optional:
            return ChartSeriesSupplier(
                name = '',
                data = [
                    1.337
                    ]
    ...
    def testChartSeriesSupplier(self):
        """Test ChartSeriesSupplier"""
