...
class TestQuoteLightweightSupplierDetails(unittest.TestCase):
    """QuoteLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLightweightSupplierDetails:
        """Test QuoteLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLightweightSupplierDetails`
        """
        model = QuoteLightweightSupplierDetails()
        if include_optional:
            return QuoteLightweightSupplierDetails(
                source = '0',
                target = '0',
                exchange_rate = 1.337,
                timestamp = 56
    ...
    def testQuoteLightweightSupplierDetails(self):
        """Test QuoteLightweightSupplierDetails"""
