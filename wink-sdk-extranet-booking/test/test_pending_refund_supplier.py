...
class TestPendingRefundSupplier(unittest.TestCase):
    """PendingRefundSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingRefundSupplier:
        """Test PendingRefundSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingRefundSupplier`
        """
        model = PendingRefundSupplier()
        if include_optional:
            return PendingRefundSupplier(
    ...
    def testPendingRefundSupplier(self):
        """Test PendingRefundSupplier"""
