...
class TestCustomizationThemeColorsSupplier(unittest.TestCase):
    """CustomizationThemeColorsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationThemeColorsSupplier:
        """Test CustomizationThemeColorsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationThemeColorsSupplier`
        """
        model = CustomizationThemeColorsSupplier()
        if include_optional:
            return CustomizationThemeColorsSupplier(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testCustomizationThemeColorsSupplier(self):
        """Test CustomizationThemeColorsSupplier"""
