...
class TestSocialSupplierDetails(unittest.TestCase):
    """SocialSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialSupplierDetails:
        """Test SocialSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SocialSupplierDetails`
        """
        model = SocialSupplierDetails()
        if include_optional:
            return SocialSupplierDetails(
                type = 'FACEBOOK',
                location = '',
                enabled = True
            )
    ...
    def testSocialSupplierDetails(self):
        """Test SocialSupplierDetails"""
