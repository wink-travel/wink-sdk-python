...
class TestGuestRoomLightweightSupplier(unittest.TestCase):
    """GuestRoomLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomLightweightSupplier:
        """Test GuestRoomLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomLightweightSupplier`
        """
        model = GuestRoomLightweightSupplier()
        if include_optional:
            return GuestRoomLightweightSupplier(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testGuestRoomLightweightSupplier(self):
        """Test GuestRoomLightweightSupplier"""
