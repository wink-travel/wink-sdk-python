...
class TestChartTitleSupplier(unittest.TestCase):
    """ChartTitleSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartTitleSupplier:
        """Test ChartTitleSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartTitleSupplier`
        """
        model = ChartTitleSupplier()
        if include_optional:
            return ChartTitleSupplier(
                text = ''
            )
        else:
            return ChartTitleSupplier(
    ...
    def testChartTitleSupplier(self):
        """Test ChartTitleSupplier"""
