...
class TestPetInfoLightweightSupplierDetails(unittest.TestCase):
    """PetInfoLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetInfoLightweightSupplierDetails:
        """Test PetInfoLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetInfoLightweightSupplierDetails`
        """
        model = PetInfoLightweightSupplierDetails()
        if include_optional:
            return PetInfoLightweightSupplierDetails(
                name = '0',
                type = '0'
            )
        else:
    ...
    def testPetInfoLightweightSupplierDetails(self):
        """Test PetInfoLightweightSupplierDetails"""
