...
class TestCancellationDetailSupplier(unittest.TestCase):
    """CancellationDetailSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationDetailSupplier:
        """Test CancellationDetailSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationDetailSupplier`
        """
        model = CancellationDetailSupplier()
        if include_optional:
            return CancellationDetailSupplier(
                cancellation_type = 'CC_INVALID',
    ...
    def testCancellationDetailSupplier(self):
        """Test CancellationDetailSupplier"""
