...
class TestCustomizationLightweightSupplier(unittest.TestCase):
    """CustomizationLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationLightweightSupplier:
        """Test CustomizationLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationLightweightSupplier`
        """
        model = CustomizationLightweightSupplier()
        if include_optional:
            return CustomizationLightweightSupplier(
    ...
    def testCustomizationLightweightSupplier(self):
        """Test CustomizationLightweightSupplier"""
