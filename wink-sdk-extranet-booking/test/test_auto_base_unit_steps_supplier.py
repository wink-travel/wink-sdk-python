...
class TestAutoBaseUnitStepsSupplier(unittest.TestCase):
    """AutoBaseUnitStepsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoBaseUnitStepsSupplier:
        """Test AutoBaseUnitStepsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoBaseUnitStepsSupplier`
        """
        model = AutoBaseUnitStepsSupplier()
        if include_optional:
            return AutoBaseUnitStepsSupplier(
                milliseconds = 1.337,
                seconds = 1.337,
                minutes = 1.337,
                hours = 1.337,
    ...
    def testAutoBaseUnitStepsSupplier(self):
        """Test AutoBaseUnitStepsSupplier"""
