...
class TestFeeSupplier(unittest.TestCase):
    """FeeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeeSupplier:
        """Test FeeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeeSupplier`
        """
        model = FeeSupplier()
        if include_optional:
            return FeeSupplier(
