...
class TestPageReviewSupplier(unittest.TestCase):
    """PageReviewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageReviewSupplier:
        """Test PageReviewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageReviewSupplier`
        """
        model = PageReviewSupplier()
        if include_optional:
            return PageReviewSupplier(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
                    wink_sdk_extranet_booking.models.review_supplier.Review_Supplier(
                        id = 'doc-1', 
    ...
    def testPageReviewSupplier(self):
        """Test PageReviewSupplier"""
