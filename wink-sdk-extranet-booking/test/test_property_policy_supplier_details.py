...
class TestPropertyPolicySupplierDetails(unittest.TestCase):
    """PropertyPolicySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyPolicySupplierDetails:
        """Test PropertyPolicySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyPolicySupplierDetails`
        """
        model = PropertyPolicySupplierDetails()
        if include_optional:
            return PropertyPolicySupplierDetails(
    ...
    def testPropertyPolicySupplierDetails(self):
        """Test PropertyPolicySupplierDetails"""
