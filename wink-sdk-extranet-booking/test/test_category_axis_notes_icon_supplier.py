...
class TestCategoryAxisNotesIconSupplier(unittest.TestCase):
    """CategoryAxisNotesIconSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryAxisNotesIconSupplier:
        """Test CategoryAxisNotesIconSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryAxisNotesIconSupplier`
        """
        model = CategoryAxisNotesIconSupplier()
        if include_optional:
            return CategoryAxisNotesIconSupplier(
                background = '',
    ...
    def testCategoryAxisNotesIconSupplier(self):
        """Test CategoryAxisNotesIconSupplier"""
