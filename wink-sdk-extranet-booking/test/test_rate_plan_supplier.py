        ...
        if include_optional:
            return RatePlanSupplier(
                ...
                arrival_days_of_week = wink_sdk_extranet_booking.models.dow_pattern_group_supplier.DowPatternGroup_Supplier(
                    ...
                    sun = True, 
                    disabled = True, ),
                departure_days_of_week = wink_sdk_extranet_booking.models.dow_pattern_group_supplier.DowPatternGroup_Supplier(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                required_days_of_week = wink_sdk_extranet_booking.models.dow_pattern_group_supplier.DowPatternGroup_Supplier(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                ...
                single_occupancy_rate_modifier = wink_sdk_extranet_booking.models.variable_charge_supplier.VariableCharge_Supplier(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '', ), ),
                extra_pax_rate_modifier = wink_sdk_extranet_booking.models.variable_charge_supplier.VariableCharge_Supplier(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '', ), ),
                extra_child_rate_modifier = wink_sdk_extranet_booking.models.variable_charge_supplier.VariableCharge_Supplier(
                    type = 'FIXED', 
                    percent = 0.25, 
                    fixed_amount = wink_sdk_extranet_booking.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
