...
class TestPersonalSupplier(unittest.TestCase):
    """PersonalSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalSupplier:
        """Test PersonalSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalSupplier`
        """
        model = PersonalSupplier()
        if include_optional:
            return PersonalSupplier(
                gender = 'MALE',
