...
class TestGuestUserSupplier(unittest.TestCase):
    """GuestUserSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestUserSupplier:
        """Test GuestUserSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestUserSupplier`
        """
        model = GuestUserSupplier()
        if include_optional:
            return GuestUserSupplier(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testGuestUserSupplier(self):
        """Test GuestUserSupplier"""
