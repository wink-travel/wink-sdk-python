...
class TestRatePlanLevelFeeSupplierDetails(unittest.TestCase):
    """RatePlanLevelFeeSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanLevelFeeSupplierDetails:
        """Test RatePlanLevelFeeSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanLevelFeeSupplierDetails`
        """
        model = RatePlanLevelFeeSupplierDetails()
        if include_optional:
            return RatePlanLevelFeeSupplierDetails(
                descriptions = [
    ...
    def testRatePlanLevelFeeSupplierDetails(self):
        """Test RatePlanLevelFeeSupplierDetails"""
