...
class TestQuoteLightweightSupplier(unittest.TestCase):
    """QuoteLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteLightweightSupplier:
        """Test QuoteLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteLightweightSupplier`
        """
        model = QuoteLightweightSupplier()
        if include_optional:
            return QuoteLightweightSupplier(
                source = '0',
                target = '0',
                exchange_rate = 1.337,
                timestamp = 56
    ...
    def testQuoteLightweightSupplier(self):
        """Test QuoteLightweightSupplier"""
