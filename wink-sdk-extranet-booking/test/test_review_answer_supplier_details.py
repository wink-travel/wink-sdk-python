...
class TestReviewAnswerSupplierDetails(unittest.TestCase):
    """ReviewAnswerSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewAnswerSupplierDetails:
        """Test ReviewAnswerSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAnswerSupplierDetails`
        """
        model = ReviewAnswerSupplierDetails()
        if include_optional:
            return ReviewAnswerSupplierDetails(
                question_identifier = '',
                category = 'COMFORT',
                sort = 56,
                value = 56
    ...
    def testReviewAnswerSupplierDetails(self):
        """Test ReviewAnswerSupplierDetails"""
