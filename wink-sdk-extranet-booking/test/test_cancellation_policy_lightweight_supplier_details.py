...
class TestCancellationPolicyLightweightSupplierDetails(unittest.TestCase):
    """CancellationPolicyLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyLightweightSupplierDetails:
        """Test CancellationPolicyLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyLightweightSupplierDetails`
        """
        model = CancellationPolicyLightweightSupplierDetails()
        if include_optional:
            return CancellationPolicyLightweightSupplierDetails(
                identifier = '',
                hotel_identifier = '',
                refundable = False,
    ...
    def testCancellationPolicyLightweightSupplierDetails(self):
        """Test CancellationPolicyLightweightSupplierDetails"""
