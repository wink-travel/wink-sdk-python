...
class TestPropertyAggregateLightweightSupplierDetails(unittest.TestCase):
    """PropertyAggregateLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateLightweightSupplierDetails:
        """Test PropertyAggregateLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateLightweightSupplierDetails`
        """
        model = PropertyAggregateLightweightSupplierDetails()
        if include_optional:
            return PropertyAggregateLightweightSupplierDetails(
    ...
    def testPropertyAggregateLightweightSupplierDetails(self):
        """Test PropertyAggregateLightweightSupplierDetails"""
