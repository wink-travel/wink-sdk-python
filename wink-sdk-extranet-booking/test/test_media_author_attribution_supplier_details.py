...
class TestMediaAuthorAttributionSupplierDetails(unittest.TestCase):
    """MediaAuthorAttributionSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaAuthorAttributionSupplierDetails:
        """Test MediaAuthorAttributionSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaAuthorAttributionSupplierDetails`
        """
        model = MediaAuthorAttributionSupplierDetails()
        if include_optional:
            return MediaAuthorAttributionSupplierDetails(
    ...
    def testMediaAuthorAttributionSupplierDetails(self):
        """Test MediaAuthorAttributionSupplierDetails"""
