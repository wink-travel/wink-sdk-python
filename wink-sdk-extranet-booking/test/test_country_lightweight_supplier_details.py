...
class TestCountryLightweightSupplierDetails(unittest.TestCase):
    """CountryLightweightSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryLightweightSupplierDetails:
        """Test CountryLightweightSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryLightweightSupplierDetails`
        """
        model = CountryLightweightSupplierDetails()
        if include_optional:
            return CountryLightweightSupplierDetails(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
    ...
    def testCountryLightweightSupplierDetails(self):
        """Test CountryLightweightSupplierDetails"""
