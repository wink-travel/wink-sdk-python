...
class TestExtraChargeSupplier(unittest.TestCase):
    """ExtraChargeSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargeSupplier:
        """Test ExtraChargeSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargeSupplier`
        """
        model = ExtraChargeSupplier()
        if include_optional:
            return ExtraChargeSupplier(
    ...
    def testExtraChargeSupplier(self):
        """Test ExtraChargeSupplier"""
