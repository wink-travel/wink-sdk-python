...
class TestCountrySupplierDetails(unittest.TestCase):
    """CountrySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountrySupplierDetails:
        """Test CountrySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountrySupplierDetails`
        """
        model = CountrySupplierDetails()
        if include_optional:
            return CountrySupplierDetails(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
    ...
    def testCountrySupplierDetails(self):
        """Test CountrySupplierDetails"""
