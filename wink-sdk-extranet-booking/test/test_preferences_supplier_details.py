...
class TestPreferencesSupplierDetails(unittest.TestCase):
    """PreferencesSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreferencesSupplierDetails:
        """Test PreferencesSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreferencesSupplierDetails`
        """
        model = PreferencesSupplierDetails()
        if include_optional:
            return PreferencesSupplierDetails(
    ...
    def testPreferencesSupplierDetails(self):
        """Test PreferencesSupplierDetails"""
