...
class TestReportingAncillarySupplierDetails(unittest.TestCase):
    """ReportingAncillarySupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportingAncillarySupplierDetails:
        """Test ReportingAncillarySupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportingAncillarySupplierDetails`
        """
        model = ReportingAncillarySupplierDetails()
        if include_optional:
            return ReportingAncillarySupplierDetails(
                name = '',
                type = 'LODGING',
                gross_amount = 1.337,
                net_amount = 1.337,
    ...
    def testReportingAncillarySupplierDetails(self):
        """Test ReportingAncillarySupplierDetails"""
