...
class TestBookingUserSupplierDetails(unittest.TestCase):
    """BookingUserSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingUserSupplierDetails:
        """Test BookingUserSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingUserSupplierDetails`
        """
        model = BookingUserSupplierDetails()
        if include_optional:
            return BookingUserSupplierDetails(
                user_identifier = '',
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testBookingUserSupplierDetails(self):
        """Test BookingUserSupplierDetails"""
