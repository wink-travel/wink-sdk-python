...
class TestLocalizedPriceSupplier(unittest.TestCase):
    """LocalizedPriceSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedPriceSupplier:
        """Test LocalizedPriceSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedPriceSupplier`
        """
        model = LocalizedPriceSupplier()
        if include_optional:
            return LocalizedPriceSupplier(
    ...
    def testLocalizedPriceSupplier(self):
        """Test LocalizedPriceSupplier"""
