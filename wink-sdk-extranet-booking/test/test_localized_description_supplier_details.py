...
class TestLocalizedDescriptionSupplierDetails(unittest.TestCase):
    """LocalizedDescriptionSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedDescriptionSupplierDetails:
        """Test LocalizedDescriptionSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedDescriptionSupplierDetails`
        """
        model = LocalizedDescriptionSupplierDetails()
        if include_optional:
            return LocalizedDescriptionSupplierDetails(
    ...
    def testLocalizedDescriptionSupplierDetails(self):
        """Test LocalizedDescriptionSupplierDetails"""
