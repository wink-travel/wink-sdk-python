...
class TestCalDavResponseSupplier(unittest.TestCase):
    """CalDavResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalDavResponseSupplier:
        """Test CalDavResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalDavResponseSupplier`
        """
        model = CalDavResponseSupplier()
        if include_optional:
    ...
    def testCalDavResponseSupplier(self):
        """Test CalDavResponseSupplier"""
