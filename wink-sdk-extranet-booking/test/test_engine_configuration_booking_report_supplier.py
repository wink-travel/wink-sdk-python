...
class TestEngineConfigurationBookingReportSupplier(unittest.TestCase):
    """EngineConfigurationBookingReportSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationBookingReportSupplier:
        """Test EngineConfigurationBookingReportSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationBookingReportSupplier`
        """
        model = EngineConfigurationBookingReportSupplier()
        if include_optional:
            return EngineConfigurationBookingReportSupplier(
                identifier = '',
    ...
    def testEngineConfigurationBookingReportSupplier(self):
        """Test EngineConfigurationBookingReportSupplier"""
