...
class TestQuoteSupplierDetails(unittest.TestCase):
    """QuoteSupplierDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteSupplierDetails:
        """Test QuoteSupplierDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteSupplierDetails`
        """
        model = QuoteSupplierDetails()
        if include_optional:
            return QuoteSupplierDetails(
                source = '',
                target = '',
                exchange_rate = 1.337,
                timestamp = 56
    ...
    def testQuoteSupplierDetails(self):
        """Test QuoteSupplierDetails"""
