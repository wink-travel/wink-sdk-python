...
class TestSimpleDateTimeItinerarySupplier(unittest.TestCase):
    """SimpleDateTimeItinerarySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDateTimeItinerarySupplier:
        """Test SimpleDateTimeItinerarySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDateTimeItinerarySupplier`
        """
        model = SimpleDateTimeItinerarySupplier()
        if include_optional:
            return SimpleDateTimeItinerarySupplier(
    ...
    def testSimpleDateTimeItinerarySupplier(self):
        """Test SimpleDateTimeItinerarySupplier"""
