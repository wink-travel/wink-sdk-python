...
from wink_sdk_extranet_experiences.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_extranet_experiences.models
from wink_sdk_extranet_experiences import rest
from wink_sdk_extranet_experiences.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_extranet_experiences.models, klass)
