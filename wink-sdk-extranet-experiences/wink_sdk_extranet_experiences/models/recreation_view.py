...
class RecreationView(BaseModel):
    """
    RecreationView
    """ # noqa: E501
    ...
    recreation: Optional[Recreation] = None
    featured_image_identifier: Optional[StrictStr] = Field(default=None, alias="featuredImageIdentifier")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "recreation", "featuredImageIdentifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recreation
        if self.recreation:
            _dict['recreation'] = self.recreation.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recreation": Recreation.from_dict(obj["recreation"]) if obj.get("recreation") is not None else None,
