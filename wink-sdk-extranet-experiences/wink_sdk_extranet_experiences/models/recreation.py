...
class Recreation(BaseModel):
    ...
    recreation_category_code: StrictStr = Field(description="Supported OTA specification `RST` code. See [OTA geoname data](#operation/showAvailableCodesForCategory)", alias="recreationCategoryCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Recreation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Recreation from a dict"""
        if obj is None:
            return None
