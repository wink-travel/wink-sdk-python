...
class TransactionalTravelInventorySupplier(BaseModel):
    ...
    descriptions: Annotated[List[SimpleDescriptionSupplier], Field(min_length=1, max_length=2147483647)] = Field(description="Localized descriptions describing blocking.")
