...
class AttractionView(BaseModel):
    """
    AttractionView
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "attraction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attraction": Attraction.from_dict(obj["attraction"]) if obj.get("attraction") is not None else None
        })
        return _obj
