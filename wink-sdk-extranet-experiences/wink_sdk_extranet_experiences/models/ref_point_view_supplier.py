...
class RefPointViewSupplier(BaseModel):
    """
    ...
    ref_point: Optional[RefPointSupplier] = Field(default=None, alias="refPoint")
    featured_image_identifier: Optional[StrictStr] = Field(default=None, alias="featuredImageIdentifier")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "refPoint", "featuredImageIdentifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ref_point
        if self.ref_point:
            _dict['refPoint'] = self.ref_point.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refPoint": RefPointSupplier.from_dict(obj["refPoint"]) if obj.get("refPoint") is not None else None,
            "featuredImageIdentifier": obj.get("featuredImageIdentifier")
        })
        return _obj
