...
class UpsertActivityRequest(BaseModel):
    ...
    amenities: Optional[List[StrictStr]] = Field(default=None, description="Supported OTA specification `REC` code. See [OTA geoname data](#operation/showAvailableCodesForCategory).")
