...
class UpsertPlaceRequestSupplier(BaseModel):
    """
    ...
    ref_point_category_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supported OTA specification `REF` code. See [OTA geoname data](#operation/showAvailableCodesForCategory).", alias="refPointCategoryCode")
    ...
    __properties: ClassVar[List[str]] = ["featuredInd", "lifestyleType", "location", "descriptions", "multimedias", "contact", "address", "commissionable", "name", "proximityCode", "sort", "minAgeAppropriateCode", "bookable", "active", "disabilityFeatures", "securityFeatures", "socials", "pricePoint", "recognitionList", "transactionInventoryList", "applicableStart", "applicableEnd", "reservationRequiredInd", "opens", "closes", "daysOfWeek", "refPointCategoryCode", "transactionalInventoryList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refPointCategoryCode": obj.get("refPointCategoryCode"),
