...
from wink_sdk_extranet_experiences.models.simple_address_supplier import SimpleAddressSupplier
...
class UpsertAttractionRequest(BaseModel):
    """
    ...
    attraction_category_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supported OTA specification `ACC` code. See [OTA geoname data](#operation/showAvailableCodesForCategory)", alias="attractionCategoryCode")
    ...
    __properties: ClassVar[List[str]] = ["featuredInd", "lifestyleType", "location", "descriptions", "multimedias", "contact", "address", "commissionable", "name", "proximityCode", "sort", "minAgeAppropriateCode", "bookable", "active", "disabilityFeatures", "securityFeatures", "socials", "pricePoint", "recognitionList", "transactionInventoryList", "applicableStart", "applicableEnd", "reservationRequiredInd", "opens", "closes", "daysOfWeek", "attractionCategoryCode", "courtesyPhone", "transactionalInventoryList"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpsertAttractionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpsertAttractionRequest from a dict"""
        if obj is None:
            return None
