...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.49#egg=wink_sdk_extranet_experiences&subdirectory=wink-sdk-extranet-experiences
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.49#egg=wink_sdk_extranet_experiences&subdirectory=wink_sdk_extranet_experiences`)
