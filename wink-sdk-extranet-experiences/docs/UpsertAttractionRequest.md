...
upsert_attraction_request_instance = UpsertAttractionRequest.from_json(json)
# print the JSON string representation of the object
print(UpsertAttractionRequest.to_json())

# convert the object into a dict
upsert_attraction_request_dict = upsert_attraction_request_instance.to_dict()
# create an instance of UpsertAttractionRequest from a dict
upsert_attraction_request_from_dict = UpsertAttractionRequest.from_dict(upsert_attraction_request_dict)
```
