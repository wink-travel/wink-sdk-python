...
recreation_instance = Recreation.from_json(json)
# print the JSON string representation of the object
print(Recreation.to_json())

# convert the object into a dict
recreation_dict = recreation_instance.to_dict()
# create an instance of Recreation from a dict
recreation_from_dict = Recreation.from_dict(recreation_dict)
```
