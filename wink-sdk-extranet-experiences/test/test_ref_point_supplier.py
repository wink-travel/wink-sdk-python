...
class TestRefPointSupplier(unittest.TestCase):
    """RefPointSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefPointSupplier:
        """Test RefPointSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefPointSupplier`
        """
        model = RefPointSupplier()
        if include_optional:
            return RefPointSupplier(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
