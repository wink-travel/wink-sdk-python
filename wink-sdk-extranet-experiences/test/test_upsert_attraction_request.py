...
class TestUpsertAttractionRequest(unittest.TestCase):
    """UpsertAttractionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertAttractionRequest:
        """Test UpsertAttractionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertAttractionRequest`
        """
        model = UpsertAttractionRequest()
        if include_optional:
            return UpsertAttractionRequest(
                featured_ind = False,
                ...
                address = wink_sdk_extranet_experiences.models.upsert_address_request.UpsertAddressRequest(
    ...
    def testUpsertAttractionRequest(self):
        """Test UpsertAttractionRequest"""
