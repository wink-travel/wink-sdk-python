...
class TestUpsertSimpleDescriptionSupplier(unittest.TestCase):
    """UpsertSimpleDescriptionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSimpleDescriptionSupplier:
        """Test UpsertSimpleDescriptionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSimpleDescriptionSupplier`
        """
        model = UpsertSimpleDescriptionSupplier()
        if include_optional:
            return UpsertSimpleDescriptionSupplier(
    ...
    def testUpsertSimpleDescriptionSupplier(self):
        """Test UpsertSimpleDescriptionSupplier"""
