...
class TestUpsertActivityRequest(unittest.TestCase):
    """UpsertActivityRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertActivityRequest:
        """Test UpsertActivityRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertActivityRequest`
        """
        model = UpsertActivityRequest()
        if include_optional:
    ...
    def testUpsertActivityRequest(self):
        """Test UpsertActivityRequest"""
