...
class TestPlaceSupplier(unittest.TestCase):
    """PlaceSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceSupplier:
        """Test PlaceSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceSupplier`
        """
        model = PlaceSupplier()
        if include_optional:
            return PlaceSupplier(
                id = 'doc-1',
                ...
                address = wink_sdk_extranet_experiences.models.address_supplier.Address_Supplier(
                    address1 = '234', 
                    address2 = 'Pebble #5001', 
                    state = 'CA', 
                    postal_code = '90210', 
                    county = 'Alameda county', 
                    city = wink_sdk_extranet_experiences.models.geo_name_lightweight_supplier.GeoNameLightweight_Supplier(
                        geo_name_id = '5128581', 
                        type = 'CITY', 
                        name = 'New York City', 
