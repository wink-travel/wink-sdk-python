...
class TestActivityApi(unittest.TestCase):
    ...
    def test_remove_activity(self) -> None:
        """Test case for remove_activity

        Delete Activity
        """
        pass

    def test_show_activities(self) -> None:
        """Test case for show_activities
    ...
    def test_show_activity(self) -> None:
        """Test case for show_activity

        Show Activity
        """
        pass

    def test_show_activity_pairs(self) -> None:
        """Test case for show_activity_pairs
    ...
    def test_upload_activity_media(self) -> None:
        """Test case for upload_activity_media
