...
class TestRefPointViewSupplier(unittest.TestCase):
    """RefPointViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefPointViewSupplier:
        """Test RefPointViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefPointViewSupplier`
        """
        model = RefPointViewSupplier()
        if include_optional:
            return RefPointViewSupplier(
                ...
                version = 12,
                ref_point = wink_sdk_extranet_experiences.models.ref_point_supplier.RefPoint_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
                    featured_ind = False, 
    ...
    def testRefPointViewSupplier(self):
        """Test RefPointViewSupplier"""
