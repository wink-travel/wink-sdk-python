...
class TestShowPlace400Response(unittest.TestCase):
    """ShowPlace400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowPlace400Response:
        """Test ShowPlace400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowPlace400Response`
        """
        model = ShowPlace400Response()
        if include_optional:
            return ShowPlace400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowPlace400Response(self):
        """Test ShowPlace400Response"""
