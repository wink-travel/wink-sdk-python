...
class TestRecreationView(unittest.TestCase):
    """RecreationView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecreationView:
        """Test RecreationView
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecreationView`
        """
        model = RecreationView()
        if include_optional:
            return RecreationView(
                ...
                version = 12,
                recreation = wink_sdk_extranet_experiences.models.recreation.Recreation(
                    identifier = '', 
                    hotel_identifier = '', 
                    featured_ind = False, 
                    ...
                    descriptions = [
                        wink_sdk_extranet_experiences.models.simple_description.SimpleDescription(
                            name = 'An example title', 
                            description = 'This is a longer description in the specified language.', 
                            language = 'en', )
                        ], 
                    multimedias = [
                        wink_sdk_extranet_experiences.models.simple_multimedia.SimpleMultimedia(
                            ...
                            lifestyle_type = 'LIFESTYLE_HEALTH_FITNESS', 
                            attribution = [
                                wink_sdk_extranet_experiences.models.image_attribution.ImageAttribution(
                                    url = 'https://maps.google.com/maps/contrib/111628493169070103594', 
                                    name = 'Samuel Adams', )
                                ], 
                            is_landscape = True, )
                        ], 
                    contact = wink_sdk_extranet_experiences.models.contact.Contact(
                        first_name = 'John', 
                        last_name = 'Smith', 
                    ...
                    address = wink_sdk_extranet_experiences.models.address.Address(
                        address1 = '234 Near da beach', 
                        address2 = 'Pebble #5001', 
                        state = 'CA', 
                        postal_code = '90210', 
                        county = 'Alameda county', 
                        city = wink_sdk_extranet_experiences.models.geo_name.GeoName(
                            geo_name_id = '5128581', 
                            type = 'CITY', 
                            name = 'New York City', 
                            ...
                            radius_in_meters = 56, 
                            country = wink_sdk_extranet_experiences.models.country.Country(
                                iso = 'US', 
                                iso3 = 'USA', 
                                iso_numeric = 840, 
                                fips = 'US', 
                            ...
                            sub_country = wink_sdk_extranet_experiences.models.sub_country.SubCountry(
                                code = 'US.NY', 
                                country_code = 'US', 
                                sub_country_code = 'NY', 
                                name = 'New York', 
                                ascii_name = 'New York', 
                                geo_name_id = '5128638', ), 
                            sub_sub_country = wink_sdk_extranet_experiences.models.sub_sub_country.SubSubCountry(
                                code = '', 
                                country_code = '', 
                                sub_country_code = '', 
                    ...
                    security_features = ["1"], 
                    socials = [
                        wink_sdk_extranet_experiences.models.social.Social(
                            type = 'FACEBOOK', 
                            enabled = True, )
                        ], 
                    price_point = 'THREE', 
                    recognition_list = [
                        wink_sdk_extranet_experiences.models.travel_inventory_recognition.TravelInventoryRecognition(
                            identifier = '', 
                            category = 'AWARD', 
                            type = 'PERCENT_RATING', 
                            provider = 'Michelin', 
                    ...
                    transactional_inventory_list = [
                        wink_sdk_extranet_experiences.models.transactional_travel_inventory.TransactionalTravelInventory(
                            identifier = '', 
                            name = '1 hour session', 
                            descriptions = [
                                wink_sdk_extranet_experiences.models.simple_description.SimpleDescription(
                    ...
                    opens = '09:00', 
                    closes = '17:30', 
                    days_of_week = wink_sdk_extranet_experiences.models.dow_pattern_group.DowPatternGroup(
                        mon = True, 
                        tue = True, 
                        wed = True, 
                        thu = True, 
