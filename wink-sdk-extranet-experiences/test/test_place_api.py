...
class TestPlaceApi(unittest.TestCase):
    ...
    def test_remove_place(self) -> None:
        """Test case for remove_place

        Delete Place
        """
        pass

    def test_show_place(self) -> None:
        """Test case for show_place

        Show Place
        """
        pass

    def test_show_place_pairs(self) -> None:
        """Test case for show_place_pairs

        Show Reference Pairs
        """
        pass

    def test_show_places(self) -> None:
        """Test case for show_places
    ...
    def test_upload_place_media(self) -> None:
        """Test case for upload_place_media
