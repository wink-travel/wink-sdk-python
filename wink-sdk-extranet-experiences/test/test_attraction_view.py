...
class TestAttractionView(unittest.TestCase):
    """AttractionView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttractionView:
        """Test AttractionView
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttractionView`
        """
        model = AttractionView()
        if include_optional:
            return AttractionView(
                ...
                version = 12,
                attraction = wink_sdk_extranet_experiences.models.attraction.Attraction(
                    identifier = '', 
                    hotel_identifier = '', 
                    featured_ind = False, 
