...
class TestAttractionApi(unittest.TestCase):
    """AttractionApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AttractionApi()

    def tearDown(self) -> None:
        pass

    def test_create_attraction(self) -> None:
        """Test case for create_attraction

        Create Attraction
        """
        pass

    def test_remove_attraction(self) -> None:
        """Test case for remove_attraction

        Delete attraction
        """
        pass

    def test_show_attraction(self) -> None:
        """Test case for show_attraction

        Show Attraction
        """
        pass

    def test_show_attraction_pairs(self) -> None:
        """Test case for show_attraction_pairs

        Show Attractions as Pairs
        """
        pass

    def test_show_attractions(self) -> None:
        """Test case for show_attractions

        Show Attractions
        """
        pass

    def test_update_attraction(self) -> None:
        """Test case for update_attraction

        Update Attraction
        """
        pass

    def test_upload_attraction_media(self) -> None:
        """Test case for upload_attraction_media
