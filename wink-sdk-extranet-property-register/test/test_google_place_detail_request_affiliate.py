...
class TestGooglePlaceDetailRequestAffiliate(unittest.TestCase):
    """GooglePlaceDetailRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePlaceDetailRequestAffiliate:
        """Test GooglePlaceDetailRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePlaceDetailRequestAffiliate`
        """
        model = GooglePlaceDetailRequestAffiliate()
        if include_optional:
            return GooglePlaceDetailRequestAffiliate(
                place_id = '0',
                name = '0',
                message_from_user = ''
            )
    ...
    def testGooglePlaceDetailRequestAffiliate(self):
        """Test GooglePlaceDetailRequestAffiliate"""
