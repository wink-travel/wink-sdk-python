...
class TestSupplierLeadSupplier(unittest.TestCase):
    """SupplierLeadSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierLeadSupplier:
        """Test SupplierLeadSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierLeadSupplier`
        """
        model = SupplierLeadSupplier()
        if include_optional:
            return SupplierLeadSupplier(
                id = 'doc-1',
                ...
                city_options = [
                    wink_sdk_extranet_property_register.models.geo_name_supplier.GeoName_Supplier(
                        geo_name_id = '5128581', 
                        type = 'CITY', 
                        name = 'New York City', 
                        url_name = 'new-york-city-united-states', 
    ...
    def testSupplierLeadSupplier(self):
        """Test SupplierLeadSupplier"""
