...
class TestTravelInventoryRecognitionSupplier(unittest.TestCase):
    """TravelInventoryRecognitionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelInventoryRecognitionSupplier:
        """Test TravelInventoryRecognitionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelInventoryRecognitionSupplier`
        """
        model = TravelInventoryRecognitionSupplier()
        if include_optional:
    ...
    def testTravelInventoryRecognitionSupplier(self):
        """Test TravelInventoryRecognitionSupplier"""
