...
class TestAggregateGreendexScoreByCategorySupplier(unittest.TestCase):
    """AggregateGreendexScoreByCategorySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateGreendexScoreByCategorySupplier:
        """Test AggregateGreendexScoreByCategorySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateGreendexScoreByCategorySupplier`
        """
        model = AggregateGreendexScoreByCategorySupplier()
        if include_optional:
            return AggregateGreendexScoreByCategorySupplier(
                category = 'GENERAL',
                high_score = 100,
                total_score = 50,
                aggregate_score = 0
    ...
    def testAggregateGreendexScoreByCategorySupplier(self):
        """Test AggregateGreendexScoreByCategorySupplier"""
