...
class TestPropertyPolicySupplier(unittest.TestCase):
    """PropertyPolicySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyPolicySupplier:
        """Test PropertyPolicySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyPolicySupplier`
        """
        model = PropertyPolicySupplier()
        if include_optional:
    ...
    def testPropertyPolicySupplier(self):
        """Test PropertyPolicySupplier"""
