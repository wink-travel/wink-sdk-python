...
class TestKeyValuePairSupplier(unittest.TestCase):
    """KeyValuePairSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyValuePairSupplier:
        """Test KeyValuePairSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyValuePairSupplier`
        """
        model = KeyValuePairSupplier()
        if include_optional:
            return KeyValuePairSupplier(
                value = 'id-1',
    ...
    def testKeyValuePairSupplier(self):
        """Test KeyValuePairSupplier"""
