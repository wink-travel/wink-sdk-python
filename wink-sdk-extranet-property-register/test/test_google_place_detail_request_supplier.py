...
class TestGooglePlaceDetailRequestSupplier(unittest.TestCase):
    """GooglePlaceDetailRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GooglePlaceDetailRequestSupplier:
        """Test GooglePlaceDetailRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GooglePlaceDetailRequestSupplier`
        """
        model = GooglePlaceDetailRequestSupplier()
        if include_optional:
            return GooglePlaceDetailRequestSupplier(
                place_id = 'place-1',
                name = 'Hotel X',
    ...
    def testGooglePlaceDetailRequestSupplier(self):
        """Test GooglePlaceDetailRequestSupplier"""
