        ...
        if include_optional:
            return PropertySupplier(
                ...
                reservations_contact = wink_sdk_extranet_property_register.models.contact_supplier.Contact_Supplier(
                    ...
                    full_name = 'John Smith', 
                    summary = 'John Smith (johnsmith@gmail.com / +12125551212)', ),
                revenue_contact = wink_sdk_extranet_property_register.models.contact_supplier.Contact_Supplier(
                    first_name = 'John', 
                    last_name = 'Smith', 
                    email = 'johnsmith@email.com', 
                    secondary_email = 'johnsmith2@email.com', 
                    ...
                    full_name = 'John Smith', 
                    summary = 'John Smith (johnsmith@gmail.com / +12125551212)', ),
                marketing_contact = wink_sdk_extranet_property_register.models.contact_supplier.Contact_Supplier(
                    first_name = 'John', 
                    last_name = 'Smith', 
                    email = 'johnsmith@email.com', 
                    secondary_email = 'johnsmith2@email.com', 
                ...
                logo = wink_sdk_extranet_property_register.models.simple_multimedia_supplier.SimpleMultimedia_Supplier(
                    multimedia_identifier = 'image-1', 
                    identifier = 'cloudinary-image-1', 
                    type = 'IMAGE', 
                    source = 'CLOUDINARY', 
                ...
                address = wink_sdk_extranet_property_register.models.address_supplier.Address_Supplier(
                    ...
                    city = wink_sdk_extranet_property_register.models.geo_name_lightweight_supplier.GeoNameLightweight_Supplier(
                        geo_name_id = '5128581', 
                        type = 'CITY', 
                        name = 'New York City', 
