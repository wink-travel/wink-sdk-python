...
class TestManageLeadsApi(unittest.TestCase):
    """ManageLeadsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ManageLeadsApi()
    ...
    def test_remove_lead(self) -> None:
        """Test case for remove_lead

        Delete Lead
        """
        pass

    def test_show_lead(self) -> None:
        """Test case for show_lead

        Show Lead
        """
        pass

    def test_show_lead_list(self) -> None:
        """Test case for show_lead_list
