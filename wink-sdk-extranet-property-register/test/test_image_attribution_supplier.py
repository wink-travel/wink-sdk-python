...
class TestImageAttributionSupplier(unittest.TestCase):
    """ImageAttributionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageAttributionSupplier:
        """Test ImageAttributionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAttributionSupplier`
        """
        model = ImageAttributionSupplier()
        if include_optional:
            return ImageAttributionSupplier(
    ...
    def testImageAttributionSupplier(self):
        """Test ImageAttributionSupplier"""
