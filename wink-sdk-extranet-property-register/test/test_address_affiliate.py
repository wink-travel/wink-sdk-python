...
class TestAddressAffiliate(unittest.TestCase):
    """AddressAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressAffiliate:
        """Test AddressAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressAffiliate`
        """
        model = AddressAffiliate()
        if include_optional:
            return AddressAffiliate(
                address1 = '234',
