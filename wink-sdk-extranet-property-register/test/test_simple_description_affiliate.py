...
class TestSimpleDescriptionAffiliate(unittest.TestCase):
    """SimpleDescriptionAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleDescriptionAffiliate:
        """Test SimpleDescriptionAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleDescriptionAffiliate`
        """
        model = SimpleDescriptionAffiliate()
        if include_optional:
            return SimpleDescriptionAffiliate(
    ...
    def testSimpleDescriptionAffiliate(self):
        """Test SimpleDescriptionAffiliate"""
