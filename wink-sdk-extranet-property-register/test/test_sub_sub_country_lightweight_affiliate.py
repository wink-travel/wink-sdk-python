...
class TestSubSubCountryLightweightAffiliate(unittest.TestCase):
    """SubSubCountryLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryLightweightAffiliate:
        """Test SubSubCountryLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryLightweightAffiliate`
        """
        model = SubSubCountryLightweightAffiliate()
        if include_optional:
            return SubSubCountryLightweightAffiliate(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryLightweightAffiliate(self):
        """Test SubSubCountryLightweightAffiliate"""
