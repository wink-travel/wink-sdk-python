...
class TestPropertyAggregateGreenIndexAnswersSupplier(unittest.TestCase):
    """PropertyAggregateGreenIndexAnswersSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateGreenIndexAnswersSupplier:
        """Test PropertyAggregateGreenIndexAnswersSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateGreenIndexAnswersSupplier`
        """
        model = PropertyAggregateGreenIndexAnswersSupplier()
        if include_optional:
            return PropertyAggregateGreenIndexAnswersSupplier(
                hotel_identifier = '',
                list = [
                    wink_sdk_extranet_property_register.models.property_aggregate_green_index_answer_supplier.PropertyAggregateGreenIndexAnswer_Supplier(
                        question_key = '', 
                        value = 56, )
                    ],
                high_score = 100,
                ...
                aggregate_score = 50,
                scores_by_category = [
                    wink_sdk_extranet_property_register.models.property_aggregate_green_index_score_by_category_supplier.PropertyAggregateGreenIndexScoreByCategory_Supplier(
                        category = 'GENERAL', 
                        high_score = 100, 
                        total_score = 50, 
                        aggregate_score = 50, )
    ...
    def testPropertyAggregateGreenIndexAnswersSupplier(self):
        """Test PropertyAggregateGreenIndexAnswersSupplier"""
