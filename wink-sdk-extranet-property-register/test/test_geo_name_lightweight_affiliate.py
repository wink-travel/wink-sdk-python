...
class TestGeoNameLightweightAffiliate(unittest.TestCase):
    """GeoNameLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameLightweightAffiliate:
        """Test GeoNameLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameLightweightAffiliate`
        """
        model = GeoNameLightweightAffiliate()
        if include_optional:
            return GeoNameLightweightAffiliate(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
    ...
    def testGeoNameLightweightAffiliate(self):
        """Test GeoNameLightweightAffiliate"""
