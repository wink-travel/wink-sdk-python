...
class TestSubSubCountryLightweightSupplier(unittest.TestCase):
    """SubSubCountryLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryLightweightSupplier:
        """Test SubSubCountryLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryLightweightSupplier`
        """
        model = SubSubCountryLightweightSupplier()
        if include_optional:
            return SubSubCountryLightweightSupplier(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryLightweightSupplier(self):
        """Test SubSubCountryLightweightSupplier"""
