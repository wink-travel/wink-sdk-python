...
class TestPropertyAggregateGreenIndexScoreByCategorySupplier(unittest.TestCase):
    """PropertyAggregateGreenIndexScoreByCategorySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateGreenIndexScoreByCategorySupplier:
        """Test PropertyAggregateGreenIndexScoreByCategorySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateGreenIndexScoreByCategorySupplier`
        """
        model = PropertyAggregateGreenIndexScoreByCategorySupplier()
        if include_optional:
            return PropertyAggregateGreenIndexScoreByCategorySupplier(
                category = 'GENERAL',
                high_score = 100,
                total_score = 50,
                aggregate_score = 50
    ...
    def testPropertyAggregateGreenIndexScoreByCategorySupplier(self):
        """Test PropertyAggregateGreenIndexScoreByCategorySupplier"""
