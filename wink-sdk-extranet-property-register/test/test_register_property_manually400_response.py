...
class TestRegisterPropertyManually400Response(unittest.TestCase):
    """RegisterPropertyManually400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterPropertyManually400Response:
        """Test RegisterPropertyManually400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterPropertyManually400Response`
        """
        model = RegisterPropertyManually400Response()
        if include_optional:
            return RegisterPropertyManually400Response(
                status = 56,
                error = '',
                message = '',
                timestamp = ''
    ...
    def testRegisterPropertyManually400Response(self):
        """Test RegisterPropertyManually400Response"""
