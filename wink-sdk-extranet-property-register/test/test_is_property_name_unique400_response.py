...
class TestIsPropertyNameUnique400Response(unittest.TestCase):
    """IsPropertyNameUnique400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IsPropertyNameUnique400Response:
        """Test IsPropertyNameUnique400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IsPropertyNameUnique400Response`
        """
        model = IsPropertyNameUnique400Response()
        if include_optional:
            return IsPropertyNameUnique400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testIsPropertyNameUnique400Response(self):
        """Test IsPropertyNameUnique400Response"""
