...
class TestCountryLightweightAffiliate(unittest.TestCase):
    """CountryLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryLightweightAffiliate:
        """Test CountryLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryLightweightAffiliate`
        """
        model = CountryLightweightAffiliate()
        if include_optional:
            return CountryLightweightAffiliate(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
    ...
    def testCountryLightweightAffiliate(self):
        """Test CountryLightweightAffiliate"""
