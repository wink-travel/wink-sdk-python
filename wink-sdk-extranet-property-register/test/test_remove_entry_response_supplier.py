...
from wink_sdk_extranet_property_register.models.remove_entry_response_supplier import RemoveEntryResponseSupplier

class TestRemoveEntryResponseSupplier(unittest.TestCase):
    """RemoveEntryResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveEntryResponseSupplier:
        """Test RemoveEntryResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveEntryResponseSupplier`
        """
        model = RemoveEntryResponseSupplier()
        if include_optional:
    ...
    def testRemoveEntryResponseSupplier(self):
        """Test RemoveEntryResponseSupplier"""
