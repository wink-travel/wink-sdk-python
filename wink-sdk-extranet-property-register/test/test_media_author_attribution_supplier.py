...
class TestMediaAuthorAttributionSupplier(unittest.TestCase):
    """MediaAuthorAttributionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaAuthorAttributionSupplier:
        """Test MediaAuthorAttributionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaAuthorAttributionSupplier`
        """
        model = MediaAuthorAttributionSupplier()
        if include_optional:
            return MediaAuthorAttributionSupplier(
    ...
    def testMediaAuthorAttributionSupplier(self):
        """Test MediaAuthorAttributionSupplier"""
