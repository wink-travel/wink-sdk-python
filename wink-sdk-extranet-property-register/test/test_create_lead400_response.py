...
class TestCreateLead400Response(unittest.TestCase):
    """CreateLead400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateLead400Response:
        """Test CreateLead400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateLead400Response`
        """
        model = CreateLead400Response()
        if include_optional:
            return CreateLead400Response(
                status = 56,
                error = '',
                message = '',
                timestamp = ''
    ...
    def testCreateLead400Response(self):
        """Test CreateLead400Response"""
