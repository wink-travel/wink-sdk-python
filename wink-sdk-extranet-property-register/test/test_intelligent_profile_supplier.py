...
class TestIntelligentProfileSupplier(unittest.TestCase):
    """IntelligentProfileSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntelligentProfileSupplier:
        """Test IntelligentProfileSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntelligentProfileSupplier`
        """
        model = IntelligentProfileSupplier()
        if include_optional:
            return IntelligentProfileSupplier(
    ...
    def testIntelligentProfileSupplier(self):
        """Test IntelligentProfileSupplier"""
