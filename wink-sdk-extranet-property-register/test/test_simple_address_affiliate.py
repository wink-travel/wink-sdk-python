...
class TestSimpleAddressAffiliate(unittest.TestCase):
    """SimpleAddressAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleAddressAffiliate:
        """Test SimpleAddressAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleAddressAffiliate`
        """
        model = SimpleAddressAffiliate()
        if include_optional:
            return SimpleAddressAffiliate(
                address1 = '234',
    ...
    def testSimpleAddressAffiliate(self):
        """Test SimpleAddressAffiliate"""
