...
class TestSubCountryLightweightAffiliate(unittest.TestCase):
    """SubCountryLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryLightweightAffiliate:
        """Test SubCountryLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryLightweightAffiliate`
        """
        model = SubCountryLightweightAffiliate()
        if include_optional:
            return SubCountryLightweightAffiliate(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountryLightweightAffiliate(self):
        """Test SubCountryLightweightAffiliate"""
