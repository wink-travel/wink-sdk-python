...
class TestManualPropertyRegistrationRequestSupplier(unittest.TestCase):
    """ManualPropertyRegistrationRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManualPropertyRegistrationRequestSupplier:
        """Test ManualPropertyRegistrationRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManualPropertyRegistrationRequestSupplier`
        """
        model = ManualPropertyRegistrationRequestSupplier()
        if include_optional:
            return ManualPropertyRegistrationRequestSupplier(
                name = 'The Getaway resort - Ubud',
                local_name = 'Getaway Resorts Limited',
    ...
    def testManualPropertyRegistrationRequestSupplier(self):
        """Test ManualPropertyRegistrationRequestSupplier"""
