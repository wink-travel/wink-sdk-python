...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.23#egg=wink_sdk_extranet_property_register&subdirectory=wink-sdk-extranet-property-register
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.23#egg=wink_sdk_extranet_property_register&subdirectory=wink_sdk_extranet_property_register`)
