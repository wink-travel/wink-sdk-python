...
class LeadsApi:
    ...
    def create_lead(
        self,
        google_place_detail_request_supplier: GooglePlaceDetailRequestSupplier,
        ...
        :param google_place_detail_request_supplier: (required)
        :type google_place_detail_request_supplier: GooglePlaceDetailRequestSupplier
        :param wink_version:
        ...
        _param = self._create_lead_serialize(
            google_place_detail_request_supplier=google_place_detail_request_supplier,
    ...
    def create_lead_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SupplierLeadSupplier]:
        """Create Lead
    ...
    def _create_lead_serialize(
        self,
        google_place_detail_request_supplier,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if google_place_detail_request_supplier is not None:
            _body_params = google_place_detail_request_supplier
    ...
    def create_lead1(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Create lead by this owner identifier.")],
        google_place_detail_request_affiliate: GooglePlaceDetailRequestAffiliate,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param company_identifier: Create lead by this owner identifier. (required)
        :type company_identifier: str
        :param google_place_detail_request_affiliate: (required)
        :type google_place_detail_request_affiliate: GooglePlaceDetailRequestAffiliate
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_lead1_serialize(
            company_identifier=company_identifier,
            google_place_detail_request_affiliate=google_place_detail_request_affiliate,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def create_lead1_with_http_info(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Create lead by this owner identifier.")],
        google_place_detail_request_affiliate: GooglePlaceDetailRequestAffiliate,
        wink_version: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SupplierLeadAffiliate]:
        """Create Lead Request
    ...
    @validate_call
    def create_lead1_without_preload_content(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Create lead by this owner identifier.")],
        google_place_detail_request_affiliate: GooglePlaceDetailRequestAffiliate,
        wink_version: Optional[StrictStr] = None,
    ...
    def _create_lead1_serialize(
        self,
        company_identifier,
        google_place_detail_request_affiliate,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if google_place_detail_request_affiliate is not None:
            _body_params = google_place_detail_request_affiliate
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/affiliate/{companyIdentifier}/lead',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
