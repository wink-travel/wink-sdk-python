...
from wink_sdk_extranet_property_register.models.geo_name_lightweight_supplier import GeoNameLightweightSupplier
...
from wink_sdk_extranet_property_register.models.simple_multimedia_supplier import SimpleMultimediaSupplier
from typing import Optional, Set
from typing_extensions import Self

class SupplierLeadSupplier(BaseModel):
    """
    ...
    user: KeyValuePairSupplier = Field(description="The user who initiated the creation of this object. Contains userId as value and username as label.")
    owner: Optional[KeyValuePairSupplier] = Field(default=None, description="Usually the company account ID that the lead occurred under. Contains company ID as value and company name as label.")
    ...
    address: Optional[SimpleAddressSupplier] = Field(default=None, description="Address in English")
    address_local: Optional[SimpleAddressSupplier] = Field(default=None, description="Address in local language if available", alias="addressLocal")
    ...
    location: GeoJsonPointSupplier = Field(description="Country")
    photos: Optional[List[SimpleMultimediaSupplier]] = Field(default=None, description="Photos for property")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.photos:
            ...
            _dict['photos'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in city_options (list)
        _items = []
        if self.city_options:
            for _item_city_options in self.city_options:
                if _item_city_options:
                    _items.append(_item_city_options.to_dict())
            _dict['cityOptions'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": KeyValuePairSupplier.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "owner": KeyValuePairSupplier.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            ...
            "photos": [SimpleMultimediaSupplier.from_dict(_item) for _item in obj["photos"]] if obj.get("photos") is not None else None,
            ...
            "cityOptions": [GeoNameLightweightSupplier.from_dict(_item) for _item in obj["cityOptions"]] if obj.get("cityOptions") is not None else None,
