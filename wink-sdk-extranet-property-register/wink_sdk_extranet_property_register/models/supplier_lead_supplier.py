...
from wink_sdk_extranet_property_register.models.address_supplier import AddressSupplier
...
class SupplierLeadSupplier(BaseModel):
    ...
    user: KeyValuePairSupplier
    owner: Optional[KeyValuePairSupplier] = None
    status: StrictStr = Field(description="Lead status")
    place_id: StrictStr = Field(description="Unique ID", alias="placeId")
    name_in_english: StrictStr = Field(description="Name of lead", alias="nameInEnglish")
    ...
    google_maps_url: StrictStr = Field(description="Google Maps URL of the place", alias="googleMapsUrl")
    ...
    city_options: Optional[List[GeoNameSupplier]] = Field(default=None, alias="cityOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cityOptions": [GeoNameSupplier.from_dict(_item) for _item in obj["cityOptions"]] if obj.get("cityOptions") is not None else None,
