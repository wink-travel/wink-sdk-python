...
from wink_sdk_extranet_property_register.models.sub_sub_country_lightweight_supplier import SubSubCountryLightweightSupplier
from typing import Optional, Set
from typing_extensions import Self

class GeoNameLightweightSupplier(BaseModel):
    """
    ...
    location: Optional[GeoJsonPointSupplier] = Field(default=None, description="Coordinate points of the city")
    ...
    country: Optional[CountryLightweightSupplier] = Field(default=None, description="Country")
    sub_country: Optional[SubCountryLightweightSupplier] = Field(default=None, description="Country sub division", alias="subCountry")
    sub_sub_country: Optional[SubSubCountryLightweightSupplier] = Field(default=None, description="Country sub sub division", alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountryLightweightSupplier.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountryLightweightSupplier.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountryLightweightSupplier.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
