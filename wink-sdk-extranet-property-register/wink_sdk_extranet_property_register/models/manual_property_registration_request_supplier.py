...
class ManualPropertyRegistrationRequestSupplier(BaseModel):
    """
    ...
    local_name: StrictStr = Field(description="Local name of the hotel as it is referred to in the local language.", alias="localName")
    ...
    __properties: ClassVar[List[str]] = ["name", "localName", "address", "reservation", "revenue", "marketing", "agreementAccepted"]
