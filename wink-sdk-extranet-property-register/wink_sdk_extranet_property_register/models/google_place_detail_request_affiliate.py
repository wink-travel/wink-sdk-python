...
class GooglePlaceDetailRequestAffiliate(BaseModel):
    """
    GooglePlaceDetailRequestAffiliate
    """ # noqa: E501
    place_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="placeId")
    name: Annotated[str, Field(min_length=1, strict=True)]
    message_from_user: Optional[StrictStr] = Field(default=None, alias="messageFromUser")
    __properties: ClassVar[List[str]] = ["placeId", "name", "messageFromUser"]
