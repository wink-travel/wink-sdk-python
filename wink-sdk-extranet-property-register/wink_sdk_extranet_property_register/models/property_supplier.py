...
class PropertySupplier(BaseModel):
    ...
    external_status: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Property goes active by changing externalStatus from 6 (Inactive) to 1 (Active) according to OTA property status.", alias="externalStatus")
