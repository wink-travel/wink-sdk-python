...
class GeneralManagerSupplier(BaseModel):
    """
    General manager related data.
    """ # noqa: E501
    name: StrictStr = Field(description="Name of GM currently managing the property.")
    image: Optional[SimpleMultimediaSupplier] = Field(default=None, description="Cloudinary image identifier of GM currently managing the property.")
    descriptions: Optional[List[LocalizedDescriptionSupplier]] = None
