...
class GeneralManagerSupplier(BaseModel):
    ...
    image: Optional[SimpleMultimediaSupplier] = None
    descriptions: Optional[List[LocalizedDescriptionSupplier]] = Field(default=None, description="Localized welcome message from GM.")
