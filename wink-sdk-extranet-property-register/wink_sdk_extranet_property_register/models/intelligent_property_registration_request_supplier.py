...
class IntelligentPropertyRegistrationRequestSupplier(BaseModel):
    ...
    """ # noqa: E501
    name_in_english: StrictStr = Field(description="Unique hotel trade name. The hotel name must be unique. If there are multiple hotels with the same name, we recommend appending destination to the name. [Verify uniqueness here](#operation/isHotelNameUnique).", alias="nameInEnglish")
    ...
    address_local: Optional[SimpleAddressSupplier] = Field(default=None, alias="addressLocal")
    location: GeoJsonPointSupplier
    multimedia_identifiers: Optional[List[StrictStr]] = Field(default=None, alias="multimediaIdentifiers")
    ...
    profile: IntelligentProfileSupplier
    hotel_amenity_codes: Optional[List[StrictStr]] = Field(default=None, alias="hotelAmenityCodes")
    property_accessibility_codes: Optional[List[StrictStr]] = Field(default=None, alias="propertyAccessibilityCodes")
    property_security_codes: Optional[List[StrictStr]] = Field(default=None, alias="propertySecurityCodes")
    __properties: ClassVar[List[str]] = ["nameInEnglish", "nameInLocalLanguage", "address", "addressLocal", "location", "multimediaIdentifiers", "approveRating", "website", "reservation", "agreementAccepted", "descriptions", "profile", "hotelAmenityCodes", "propertyAccessibilityCodes", "propertySecurityCodes"]
