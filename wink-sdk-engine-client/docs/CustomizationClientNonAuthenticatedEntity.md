...
**theme_colors** | [**CustomizationThemeColorsNonAuthenticatedEntity**](CustomizationThemeColorsNonAuthenticatedEntity.md) | Choose how you want our web components to look and more closely match with your own site style. | [optional] 
