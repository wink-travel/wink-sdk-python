...
from wink_sdk_engine_client.configuration import Configuration
from wink_sdk_engine_client.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_engine_client.models
from wink_sdk_engine_client import rest
from wink_sdk_engine_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_engine_client.models, klass)
