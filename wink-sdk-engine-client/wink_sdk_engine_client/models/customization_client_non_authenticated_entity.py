...
class CustomizationClientNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    identifier: Optional[StrictStr] = Field(default=None, description="Unique customization configuration identifier")
