...
class EngineClientNonAuthenticatedEntity(BaseModel):
    ...
    theme_colors: Optional[EngineConfigurationThemeNonAuthenticatedEntity] = Field(default=None, alias="themeColors")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "name", "appendToPageTitle", "ownerIdentifier", "ownerName", "subType", "primary", "googleAnalyticsMeasurementId", "googleMapsAPIKey", "defaultCurrency", "defaultLanguage", "logoImageIdentifier", "hostedBookingEngineUrl", "selfHosted", "themeColors", "numberOfAdvanceDays", "numberOfStayDays", "startDate", "endDate", "roomConfigurations", "useDays", "promotionalCodes", "wcBookClickAction", "showUnavailableCard", "showRankings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "themeColors": EngineConfigurationThemeNonAuthenticatedEntity.from_dict(obj["themeColors"]) if obj.get("themeColors") is not None else None,
