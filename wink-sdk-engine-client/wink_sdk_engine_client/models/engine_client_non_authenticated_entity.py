...
class EngineClientNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identifier", "name", "appendToPageTitle", "ownerIdentifier", "ownerName", "subType", "primary", "googleAnalyticsMeasurementId", "googleMapsAPIKey", "defaultCurrency", "defaultLanguage", "logoImageIdentifier", "hostedBookingEngineUrl", "selfHosted", "themeColors", "numberOfAdvanceDays", "numberOfStayDays", "startDate", "endDate", "roomConfigurations", "useDays", "promotionalCodes", "wcBookClickAction", "showUnavailableCard", "showRankings", "layout", "cardLayout"]
