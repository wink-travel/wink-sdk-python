...
from wink_sdk_engine_client.api_client import ApiClient, RequestSerialized
from wink_sdk_engine_client.api_response import ApiResponse
from wink_sdk_engine_client.rest import RESTResponseType
...
class ConfigurationApi:
    ...
    @validate_call
    def show_customization_by_client_id(
        self,
        client_id: Annotated[StrictStr, Field(description="The clientId")],
        ...
        :param client_id: The clientId (required)
        :type client_id: str
        :param wink_version:
        ...
        _param = self._show_customization_by_client_id_serialize(
            client_id=client_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '400': "ShowCustomizationById400Response",
            '200': "CustomizationClientNonAuthenticatedEntity",
        }
    ...
    @validate_call
    def show_customization_by_client_id_with_http_info(
        self,
        client_id: Annotated[StrictStr, Field(description="The clientId")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomizationClientNonAuthenticatedEntity]:
        """Load Configuration by Client ID
    ...
    @validate_call
    def show_customization_by_client_id_without_preload_content(
        self,
        client_id: Annotated[StrictStr, Field(description="The clientId")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_customization_by_client_id_serialize(
        self,
        client_id,
        wink_version,
        accept,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/public/configuration/client/{clientId}',
    ...
    @validate_call
    def show_customization_by_client_id_header(
        self,
        client_id: Annotated[StrictStr, Field(description="The clientId")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        ...
        _param = self._show_customization_by_client_id_header_serialize(
            client_id=client_id,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def show_customization_by_client_id_header_with_http_info(
        self,
        client_id: Annotated[StrictStr, Field(description="The clientId")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_customization_by_client_id_header_without_preload_content(
        self,
        client_id: Annotated[StrictStr, Field(description="The clientId")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_customization_by_client_id_header_serialize(
        self,
        client_id,
        wink_version,
        accept,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/public/configuration/client',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_customization_by_id(
        ...
        _param = self._show_customization_by_id_serialize(
    ...
    @validate_call
    def show_customization_by_id_with_http_info(
        self,
        identifier: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_customization_by_id_without_preload_content(
        self,
        identifier: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_customization_by_id_serialize(
        self,
        identifier,
        wink_version,
        accept,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/public/configuration/{identifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def show_customization_by_url_name(
        self,
        url_name: Annotated[StrictStr, Field(description="The urlName")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        :param url_name: The urlName (required)
        :type url_name: str
        :param wink_version:
        :type wink_version: str
        :param accept:
        ...
        _param = self._show_customization_by_url_name_serialize(
            url_name=url_name,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def show_customization_by_url_name_with_http_info(
        self,
        url_name: Annotated[StrictStr, Field(description="The urlName")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_customization_by_url_name_without_preload_content(
        self,
        url_name: Annotated[StrictStr, Field(description="The urlName")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_customization_by_url_name_serialize(
        self,
        url_name,
        wink_version,
        accept,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/public/configuration/url-name/{urlName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
