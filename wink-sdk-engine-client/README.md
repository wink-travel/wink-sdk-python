...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.33#egg=wink_sdk_engine_client&subdirectory=wink-sdk-engine-client
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.33#egg=wink_sdk_engine_client&subdirectory=wink_sdk_engine_client`)
