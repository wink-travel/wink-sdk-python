...
class GuestRoomApi:
    ...
    def _duplicate_guest_room_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if duplicate_guest_room_request_supplier is not None:
            _body_params = duplicate_guest_room_request_supplier
    ...
    @validate_call
    def show_guest_rooms(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Show list of room types owned by this property identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        :param property_identifier: Show list of room types owned by this property identifier (required)
        :type property_identifier: str
        :param wink_version:
        :type wink_version: str
        :param accept:
        ...
        _param = self._show_guest_rooms_serialize(
            property_identifier=property_identifier,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def show_guest_rooms_with_http_info(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Show list of room types owned by this property identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_guest_rooms_without_preload_content(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Show list of room types owned by this property identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_guest_rooms_serialize(
        self,
        property_identifier,
        wink_version,
        accept,
