...
class ImproveRoomTypeResponseSupplier(BaseModel):
    """
    ImproveRoomTypeResponseSupplier
    """ # noqa: E501
    title: StrictStr = Field(description="Indicates the category of the room. Typical values would be Moderate, Standard, or Deluxe. Supported OTA specification `SEG` code. See [OTA geoname data](#operation/showAvailableCodesForCategory)")
    description: Optional[StrictStr] = Field(default=None, description="Floor an which a room is located")
