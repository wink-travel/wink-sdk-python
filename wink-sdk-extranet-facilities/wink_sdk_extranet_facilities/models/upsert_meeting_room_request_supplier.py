...
class UpsertMeetingRoomRequestSupplier(BaseModel):
    """
    ...
    meeting_room_capacity: Annotated[int, Field(strict=True, ge=1)] = Field(description="The total number of people permitted in the meeting room.", alias="meetingRoomCapacity")
    access: Optional[StrictStr] = Field(default='MEETING_ROOM_ACCESS_PRIVATE', description="The type of access to the meeting space.")
    meeting_room_type_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supported OTA specification `MRF` code. See [OTA geoname data](#operation/showAvailableCodesForCategory).", alias="meetingRoomTypeCode")
    ...
    __properties: ClassVar[List[str]] = ["featuredInd", "lifestyleType", "location", "descriptions", "multimedias", "contact", "address", "commissionable", "name", "proximityCode", "sort", "minAgeAppropriateCode", "bookable", "active", "disabilityFeatures", "securityFeatures", "socials", "pricePoint", "recognitionList", "transactionInventoryList", "applicableStart", "applicableEnd", "reservationRequiredInd", "opens", "closes", "daysOfWeek", "irregular", "meetingRoomCapacity", "access", "meetingRoomTypeCode", "meetingRoomLevel", "dedicatedInd", "area", "height", "width", "length", "amenities", "transactionalInventoryList"]
