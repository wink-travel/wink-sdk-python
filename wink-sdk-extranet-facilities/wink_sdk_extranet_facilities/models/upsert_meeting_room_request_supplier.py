...
class UpsertMeetingRoomRequestSupplier(BaseModel):
    ...
    descriptions: Annotated[List[UpsertSimpleDescriptionSupplier], Field(min_length=1)]
    ...
    address: UpsertAddressRequestSupplier = Field(description="Defaults to property address.")
