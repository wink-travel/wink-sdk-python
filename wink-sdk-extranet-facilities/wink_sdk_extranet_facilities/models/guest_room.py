...
class GuestRoom(BaseModel):
    ...
    bedroom_configuration_list: List[BedroomConfiguration] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GuestRoom from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GuestRoom from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bedroomConfigurationList": [BedroomConfiguration.from_dict(_item) for _item in obj["bedroomConfigurationList"]] if obj.get("bedroomConfigurationList") is not None else None,
            "size": obj.get("size"),
