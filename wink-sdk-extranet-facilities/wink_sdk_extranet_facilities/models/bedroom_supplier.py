...
class BedroomSupplier(BaseModel):
    """
    BedroomSupplier
    """ # noqa: E501
    type: StrictStr = Field(description="Type of bedroom")
    bed_list: Annotated[List[BedSupplier], Field(min_length=1)] = Field(description="A bedroom can have more than one bed type.", alias="bedList")
    __properties: ClassVar[List[str]] = ["type", "bedList"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['MASTER', 'QUEEN', 'JUNIOR', 'DORMITORY', 'BEDROOM_1', 'BEDROOM_2', 'BEDROOM_3', 'BEDROOM_4', 'BEDROOM_5', 'BEDROOM_6', 'BEDROOM_7', 'BEDROOM_8', 'BEDROOM_9', 'BEDROOM_10']):
            raise ValueError("must be one of enum values ('MASTER', 'QUEEN', 'JUNIOR', 'DORMITORY', 'BEDROOM_1', 'BEDROOM_2', 'BEDROOM_3', 'BEDROOM_4', 'BEDROOM_5', 'BEDROOM_6', 'BEDROOM_7', 'BEDROOM_8', 'BEDROOM_9', 'BEDROOM_10')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in bed_list (list)
        _items = []
        if self.bed_list:
            for _item_bed_list in self.bed_list:
                if _item_bed_list:
                    _items.append(_item_bed_list.to_dict())
            _dict['bedList'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "bedList": [BedSupplier.from_dict(_item) for _item in obj["bedList"]] if obj.get("bedList") is not None else None
        })
        return _obj
