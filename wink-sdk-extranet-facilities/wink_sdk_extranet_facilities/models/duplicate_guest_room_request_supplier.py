...
class DuplicateGuestRoomRequestSupplier(BaseModel):
    """
    DuplicateGuestRoomRequestSupplier
    """ # noqa: E501
    hotel_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Which property to duplicate room type for", alias="hotelIdentifier")
    guest_room_identifier: StrictStr = Field(description="Which room type to duplicate", alias="guestRoomIdentifier")
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "guestRoomIdentifier"]
