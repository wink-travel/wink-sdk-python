...
class TransactionalTravelInventorySupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identifier", "name", "descriptions", "pricingType", "basePrice", "discountedPrice", "multimedias", "minPax", "maxPax", "percentPremium", "percentDiscount"]
