...
class TransactionalTravelInventorySupplier(BaseModel):
    """
    This is one bookable item that can stand alongside a restaurant / meeting room etc.
    """ # noqa: E501
    identifier: UUID = Field(description="Unique transactional identifier")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Internal name of transactional blocking.")
    descriptions: Annotated[List[SimpleDescriptionSupplier], Field(min_length=1, max_length=2147483647)] = Field(description="Localized descriptions describing inventory.")
    pricing_type: StrictStr = Field(description="How this blocking item should be priced.", alias="pricingType")
    base_price: CustomMonetaryAmount = Field(description="Base price of booking this blocking.", alias="basePrice")
    discounted_price: CustomMonetaryAmount = Field(description="If you are selling this blocking at a discount, indicate the discounted selling price. Leave empty if there is no discount.", alias="discountedPrice")
    multimedias: Optional[List[SimpleMultimediaSupplier]] = Field(default=None, description="List of images / videos of item.")
    min_pax: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Whether there is a limit to minimum group size.", alias="minPax")
    max_pax: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Whether there is a limit to maximum group size.", alias="maxPax")
    percent_discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Calculates the percent difference between basePrice and discountedPrice.", alias="percentDiscount")
    percent_premium: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Calculates the percent difference between basePrice and discountedPrice.", alias="percentPremium")
    __properties: ClassVar[List[str]] = ["identifier", "name", "descriptions", "pricingType", "basePrice", "discountedPrice", "multimedias", "minPax", "maxPax", "percentDiscount", "percentPremium"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "basePrice": CustomMonetaryAmount.from_dict(obj["basePrice"]) if obj.get("basePrice") is not None else None,
            "discountedPrice": CustomMonetaryAmount.from_dict(obj["discountedPrice"]) if obj.get("discountedPrice") is not None else None,
            ...
            "minPax": obj.get("minPax"),
            "maxPax": obj.get("maxPax"),
            "percentDiscount": obj.get("percentDiscount"),
            "percentPremium": obj.get("percentPremium")
        })
        return _obj
