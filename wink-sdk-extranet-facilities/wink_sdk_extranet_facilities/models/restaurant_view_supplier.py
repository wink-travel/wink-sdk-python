...
class RestaurantViewSupplier(BaseModel):
    """
    ...
    restaurant: Optional[RestaurantSupplier] = None
    featured_image_identifier: Optional[StrictStr] = Field(default=None, alias="featuredImageIdentifier")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "restaurant", "featuredImageIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "restaurant": RestaurantSupplier.from_dict(obj["restaurant"]) if obj.get("restaurant") is not None else None,
