...
class GuestRoomViewSupplier(BaseModel):
    """
    ...
    guest_room: GuestRoomSupplier = Field(alias="guestRoom")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "guestRoom"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of guest_room
        if self.guest_room:
            _dict['guestRoom'] = self.guest_room.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "guestRoom": GuestRoomSupplier.from_dict(obj["guestRoom"]) if obj.get("guestRoom") is not None else None
        })
        return _obj
