...
class RoomTypeSupplier(BaseModel):
    """
    RoomTypeSupplier
    """ # noqa: E501
    ...
    descriptions: Annotated[List[SimpleDescriptionSupplier], Field(min_length=1)] = Field(description="Localized descriptions describing inventory.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RoomTypeSupplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RoomTypeSupplier from a dict"""
        if obj is None:
            return None
