...
class SpaViewSupplier(BaseModel):
    """
    SpaViewSupplier
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "spa", "featuredImageIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spa": SpaSupplier.from_dict(obj["spa"]) if obj.get("spa") is not None else None,
