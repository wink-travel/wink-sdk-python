...
class GuestRoomView(BaseModel):
    ...
    guest_room: GuestRoom = Field(alias="guestRoom")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "guestRoom": GuestRoom.from_dict(obj["guestRoom"]) if obj.get("guestRoom") is not None else None
        })
        return _obj
