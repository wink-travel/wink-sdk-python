...
class MeetingRoomViewSupplier(BaseModel):
    """
    ...
    meeting_room: MeetingRoomSupplier = Field(alias="meetingRoom")
    featured_image_identifier: Optional[StrictStr] = Field(default=None, alias="featuredImageIdentifier")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "meetingRoom", "featuredImageIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meetingRoom": MeetingRoomSupplier.from_dict(obj["meetingRoom"]) if obj.get("meetingRoom") is not None else None,
