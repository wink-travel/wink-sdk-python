...
class BedSupplier(BaseModel):
    """
    BedSupplier
    """ # noqa: E501
    bed_type_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Indicates the type of bed(s) found in the room. Typical values would be Double, Twin, Queen, or King. Supported OTA specification `BED` code. See [OTA geoname data](#operation/showAvailableCodesForCategory).", alias="bedTypeCode")
    quantity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Number of beds for this bed type.")
    __properties: ClassVar[List[str]] = ["bedTypeCode", "quantity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bedTypeCode": obj.get("bedTypeCode"),
