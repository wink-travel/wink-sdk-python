...
class ImproveRoomTypeRequestSupplier(BaseModel):
    """
    ImproveRoomTypeRequestSupplier
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="Descriptive title")
    description: Optional[StrictStr] = Field(default=None, description="Descriptive text")
