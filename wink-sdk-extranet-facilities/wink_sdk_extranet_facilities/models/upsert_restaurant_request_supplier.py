...
class UpsertRestaurantRequestSupplier(BaseModel):
    """
    ...
    amenities: Optional[List[StrictStr]] = Field(default=None, description="Supported OTA specification `RSI` code. See [OTA geoname data](#operation/showAvailableCodesForCategory).")
    info_codes: Optional[List[StrictStr]] = Field(default=None, description="Supported OTA specification `RES` code. See [OTA geoname data](#operation/showAvailableCodesForCategory).", alias="infoCodes")
    cuisine_codes: Optional[List[StrictStr]] = Field(default=None, description="Supported OTA specification `CUI` code. See [OTA geoname data](#operation/showAvailableCodesForCategory).", alias="cuisineCodes")
