...
from wink_sdk_extranet_facilities.models.simple_address_supplier import SimpleAddressSupplier
...
class UpsertRoomTypeRequestSupplier(BaseModel):
    """
    ...
    descriptions: Annotated[List[UpsertSimpleDescriptionSupplier], Field(min_length=1)] = Field(description="Localized descriptions describing inventory.")
    multimedias: Annotated[List[SimpleMultimediaSupplier], Field(min_length=1)] = Field(description="List of images / videos of blocking.")
    ...
    contact: Optional[ContactSupplier] = Field(default=None, description="Associate a contact person for this blocking (if applicable).")
    ...
    transaction_inventory_list: Optional[List[TransactionalTravelInventorySupplier]] = Field(default=None, alias="transactionInventoryList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpsertRoomTypeRequestSupplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpsertRoomTypeRequestSupplier from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "descriptions": [UpsertSimpleDescriptionSupplier.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None,
            ...
            "transactionInventoryList": [TransactionalTravelInventorySupplier.from_dict(_item) for _item in obj["transactionInventoryList"]] if obj.get("transactionInventoryList") is not None else None,
