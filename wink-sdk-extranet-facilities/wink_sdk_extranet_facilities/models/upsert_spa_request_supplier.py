...
class UpsertSpaRequestSupplier(BaseModel):
    """
    ...
    amenities: Optional[List[StrictStr]] = Field(default=None, description="UnSupported OTA specification `SPA` code. See [OTA geoname data](#operation/showAvailableCodesForCategory).")
    ...
    __properties: ClassVar[List[str]] = ["featuredInd", "lifestyleType", "location", "descriptions", "multimedias", "contact", "address", "commissionable", "name", "proximityCode", "sort", "minAgeAppropriateCode", "bookable", "active", "disabilityFeatures", "securityFeatures", "socials", "pricePoint", "recognitionList", "transactionInventoryList", "applicableStart", "applicableEnd", "reservationRequiredInd", "opens", "closes", "daysOfWeek", "amenities", "transactionalInventoryList"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpsertSpaRequestSupplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpsertSpaRequestSupplier from a dict"""
        if obj is None:
            return None
