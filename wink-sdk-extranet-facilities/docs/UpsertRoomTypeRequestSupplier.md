...
upsert_room_type_request_supplier_instance = UpsertRoomTypeRequestSupplier.from_json(json)
# print the JSON string representation of the object
print(UpsertRoomTypeRequestSupplier.to_json())

# convert the object into a dict
upsert_room_type_request_supplier_dict = upsert_room_type_request_supplier_instance.to_dict()
# create an instance of UpsertRoomTypeRequestSupplier from a dict
upsert_room_type_request_supplier_from_dict = UpsertRoomTypeRequestSupplier.from_dict(upsert_room_type_request_supplier_dict)
```
