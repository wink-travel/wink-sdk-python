...
**bedroom_configuration_list** | [**List[BedroomConfiguration]**](BedroomConfiguration.md) | A room type can have more than one bed configuration. | 
...
guest_room_instance = GuestRoom.from_json(json)
# print the JSON string representation of the object
print(GuestRoom.to_json())

# convert the object into a dict
guest_room_dict = guest_room_instance.to_dict()
# create an instance of GuestRoom from a dict
guest_room_from_dict = GuestRoom.from_dict(guest_room_dict)
```
