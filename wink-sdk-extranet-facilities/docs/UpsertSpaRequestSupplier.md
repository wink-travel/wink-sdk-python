...
upsert_spa_request_supplier_instance = UpsertSpaRequestSupplier.from_json(json)
# print the JSON string representation of the object
print(UpsertSpaRequestSupplier.to_json())

# convert the object into a dict
upsert_spa_request_supplier_dict = upsert_spa_request_supplier_instance.to_dict()
# create an instance of UpsertSpaRequestSupplier from a dict
upsert_spa_request_supplier_from_dict = UpsertSpaRequestSupplier.from_dict(upsert_spa_request_supplier_dict)
```
