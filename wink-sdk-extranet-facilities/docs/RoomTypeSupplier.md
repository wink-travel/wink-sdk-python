...
room_type_supplier_instance = RoomTypeSupplier.from_json(json)
# print the JSON string representation of the object
print(RoomTypeSupplier.to_json())

# convert the object into a dict
room_type_supplier_dict = room_type_supplier_instance.to_dict()
# create an instance of RoomTypeSupplier from a dict
room_type_supplier_from_dict = RoomTypeSupplier.from_dict(room_type_supplier_dict)
```
