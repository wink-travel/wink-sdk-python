...
class TestGuestRoomViewSupplier(unittest.TestCase):
    """GuestRoomViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomViewSupplier:
        """Test GuestRoomViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomViewSupplier`
        """
        model = GuestRoomViewSupplier()
        if include_optional:
            return GuestRoomViewSupplier(
                ...
                version = 12,
                guest_room = wink_sdk_extranet_facilities.models.guest_room_supplier.GuestRoom_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
                    featured_ind = False, 
    ...
    def testGuestRoomViewSupplier(self):
        """Test GuestRoomViewSupplier"""
