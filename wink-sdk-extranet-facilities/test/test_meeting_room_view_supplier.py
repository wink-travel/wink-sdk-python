...
class TestMeetingRoomViewSupplier(unittest.TestCase):
    """MeetingRoomViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeetingRoomViewSupplier:
        """Test MeetingRoomViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeetingRoomViewSupplier`
        """
        model = MeetingRoomViewSupplier()
        if include_optional:
            return MeetingRoomViewSupplier(
                id = 'doc-1',
                created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                version = 12,
                meeting_room = wink_sdk_extranet_facilities.models.meeting_room_supplier.MeetingRoom_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
                    featured_ind = False, 
                    ...
                    address = wink_sdk_extranet_facilities.models.address_supplier.Address_Supplier(
                        ...
                        city = wink_sdk_extranet_facilities.models.geo_name_supplier.GeoName_Supplier(
                            geo_name_id = '5128581', 
                            type = 'CITY', 
                            name = 'New York City', 
                            ...
                            country = wink_sdk_extranet_facilities.models.country_supplier.Country_Supplier(
                                iso = 'US', 
                                name = 'United States', 
                                capital = 'Washington', 
                                continent = 'NA', 
                                ...
                                geo_name_id = '6252001', ), 
                            sub_country = wink_sdk_extranet_facilities.models.sub_country_supplier.SubCountry_Supplier(
                                name = 'New York', 
                                ascii_name = 'New York', 
                                geo_name_id = '5128638', ), 
                            sub_sub_country = wink_sdk_extranet_facilities.models.sub_sub_country_supplier.SubSubCountry_Supplier(
                                name = '', 
                                ascii_name = '', 
                                geo_name_id = '', ), ), 
                        valid = True, 
                    ...
                    opens = '09:00', 
                    closes = '17:30', 
                    days_of_week = wink_sdk_extranet_facilities.models.dow_pattern_group_supplier.DowPatternGroup_Supplier(
                        mon = True, 
                        tue = True, 
                        wed = True, 
                        thu = True, 
    ...
    def testMeetingRoomViewSupplier(self):
        """Test MeetingRoomViewSupplier"""
