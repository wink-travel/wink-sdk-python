...
class TestUpsertSpaRequestSupplier(unittest.TestCase):
    """UpsertSpaRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSpaRequestSupplier:
        """Test UpsertSpaRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSpaRequestSupplier`
        """
        model = UpsertSpaRequestSupplier()
        if include_optional:
            return UpsertSpaRequestSupplier(
                featured_ind = False,
    ...
    def testUpsertSpaRequestSupplier(self):
        """Test UpsertSpaRequestSupplier"""
