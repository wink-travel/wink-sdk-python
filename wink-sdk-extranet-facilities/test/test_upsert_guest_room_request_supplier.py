...
class TestUpsertGuestRoomRequestSupplier(unittest.TestCase):
    """UpsertGuestRoomRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertGuestRoomRequestSupplier:
        """Test UpsertGuestRoomRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertGuestRoomRequestSupplier`
        """
        model = UpsertGuestRoomRequestSupplier()
        if include_optional:
            return UpsertGuestRoomRequestSupplier(
                featured_ind = False,
    ...
    def testUpsertGuestRoomRequestSupplier(self):
        """Test UpsertGuestRoomRequestSupplier"""
