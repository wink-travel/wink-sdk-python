...
class TestBedroomConfiguration(unittest.TestCase):
    """BedroomConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomConfiguration:
        """Test BedroomConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomConfiguration`
        """
        model = BedroomConfiguration()
        if include_optional:
    ...
    def testBedroomConfiguration(self):
        """Test BedroomConfiguration"""
