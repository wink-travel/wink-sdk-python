...
class TestBedSupplier(unittest.TestCase):
    """BedSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedSupplier:
        """Test BedSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedSupplier`
        """
        model = BedSupplier()
        if include_optional:
            return BedSupplier(
