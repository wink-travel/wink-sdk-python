...
class TestImproveRoomTypeResponseSupplier(unittest.TestCase):
    """ImproveRoomTypeResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImproveRoomTypeResponseSupplier:
        """Test ImproveRoomTypeResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImproveRoomTypeResponseSupplier`
        """
        model = ImproveRoomTypeResponseSupplier()
        if include_optional:
            return ImproveRoomTypeResponseSupplier(
                title = '1',
                description = ''
            )
        else:
    ...
    def testImproveRoomTypeResponseSupplier(self):
        """Test ImproveRoomTypeResponseSupplier"""
