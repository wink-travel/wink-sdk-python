...
class TestTravelInventoryRecognition(unittest.TestCase):
    """TravelInventoryRecognition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelInventoryRecognition:
        """Test TravelInventoryRecognition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelInventoryRecognition`
        """
        model = TravelInventoryRecognition()
        if include_optional:
            return TravelInventoryRecognition(
                identifier = '',
                category = 'AWARD',
                type = 'PERCENT_RATING',
                provider = 'Michelin',
    ...
    def testTravelInventoryRecognition(self):
        """Test TravelInventoryRecognition"""
