...
class TestUpsertRoomTypeRequestSupplier(unittest.TestCase):
    """UpsertRoomTypeRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertRoomTypeRequestSupplier:
        """Test UpsertRoomTypeRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertRoomTypeRequestSupplier`
        """
        model = UpsertRoomTypeRequestSupplier()
        if include_optional:
            return UpsertRoomTypeRequestSupplier(
                featured_ind = False,
                lifestyle_type = 'LIFESTYLE_HEALTH_FITNESS',
                location = {type=POINT, coordinates=[100.5581533, 13.7370197]},
                descriptions = [
                    wink_sdk_extranet_facilities.models.upsert_simple_description_supplier.UpsertSimpleDescription_Supplier(
    ...
    def testUpsertRoomTypeRequestSupplier(self):
        """Test UpsertRoomTypeRequestSupplier"""
