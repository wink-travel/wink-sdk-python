...
class TestSimpleAddressSupplier(unittest.TestCase):
    """SimpleAddressSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleAddressSupplier:
        """Test SimpleAddressSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleAddressSupplier`
        """
        model = SimpleAddressSupplier()
        if include_optional:
            return SimpleAddressSupplier(
                address1 = '234',
    ...
    def testSimpleAddressSupplier(self):
        """Test SimpleAddressSupplier"""
