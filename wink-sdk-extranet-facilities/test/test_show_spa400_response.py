...
class TestShowSpa400Response(unittest.TestCase):
    """ShowSpa400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowSpa400Response:
        """Test ShowSpa400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowSpa400Response`
        """
        model = ShowSpa400Response()
        if include_optional:
            return ShowSpa400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowSpa400Response(self):
        """Test ShowSpa400Response"""
