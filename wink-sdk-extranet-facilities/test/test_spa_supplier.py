...
class TestSpaSupplier(unittest.TestCase):
    """SpaSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaSupplier:
        """Test SpaSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaSupplier`
        """
        model = SpaSupplier()
        if include_optional:
            return SpaSupplier(
