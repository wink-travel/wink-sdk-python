...
class TestRestaurantApi(unittest.TestCase):
    ...
    def test_remove_multimedia(self) -> None:
        """Test case for remove_multimedia

        Delete Multimedia
        """
        pass

    def test_remove_restaurant(self) -> None:
        """Test case for remove_restaurant

        Delete Restaurant
        """
        pass

    def test_show_restaurant(self) -> None:
        """Test case for show_restaurant

        Show Restaurant
        """
        pass

    def test_show_restaurant_pairs(self) -> None:
        """Test case for show_restaurant_pairs

        Show Reference Pairs
        """
        pass

    def test_show_restaurants(self) -> None:
        """Test case for show_restaurants
    ...
    def test_update_restaurant(self) -> None:
        """Test case for update_restaurant

        Update Restaurant
        """
        pass

    def test_upload_restaurant_media(self) -> None:
        """Test case for upload_restaurant_media
