        ...
        if include_optional:
            return RoomType(
                ...
                address = wink_sdk_extranet_facilities.models.address.Address(
                    ...
                    city = wink_sdk_extranet_facilities.models.geo_name_lightweight.GeoNameLightweight(
                        geo_name_id = '5128581', 
                        type = 'CITY', 
                        name = 'New York City', 
                        ...
                        radius_in_meters = 56, 
                        country = wink_sdk_extranet_facilities.models.country_lightweight.CountryLightweight(
                            iso = 'US', 
                            iso3 = 'USA', 
                            iso_numeric = 840, 
                            fips = 'US', 
                        ...
                        sub_country = wink_sdk_extranet_facilities.models.sub_country_lightweight.SubCountryLightweight(
                            code = 'US.NY', 
                            country_code = 'US', 
                            sub_country_code = 'NY', 
                            name = 'New York', 
                            ascii_name = 'New York', 
                            geo_name_id = '5128638', ), 
                        sub_sub_country = wink_sdk_extranet_facilities.models.sub_sub_country_lightweight.SubSubCountryLightweight(
                            code = '', 
                            country_code = '', 
                            sub_country_code = '', 
