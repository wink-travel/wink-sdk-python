...
class TestSubCountryLightweightSupplier(unittest.TestCase):
    """SubCountryLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryLightweightSupplier:
        """Test SubCountryLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryLightweightSupplier`
        """
        model = SubCountryLightweightSupplier()
        if include_optional:
            return SubCountryLightweightSupplier(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountryLightweightSupplier(self):
        """Test SubCountryLightweightSupplier"""
