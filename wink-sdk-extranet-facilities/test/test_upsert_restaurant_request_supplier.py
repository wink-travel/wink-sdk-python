...
class TestUpsertRestaurantRequestSupplier(unittest.TestCase):
    """UpsertRestaurantRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertRestaurantRequestSupplier:
        """Test UpsertRestaurantRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertRestaurantRequestSupplier`
        """
        model = UpsertRestaurantRequestSupplier()
        if include_optional:
            return UpsertRestaurantRequestSupplier(
                featured_ind = False,
    ...
    def testUpsertRestaurantRequestSupplier(self):
        """Test UpsertRestaurantRequestSupplier"""
