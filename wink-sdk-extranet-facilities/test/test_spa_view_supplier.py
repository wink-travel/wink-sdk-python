...
class TestSpaViewSupplier(unittest.TestCase):
    """SpaViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaViewSupplier:
        """Test SpaViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaViewSupplier`
        """
        model = SpaViewSupplier()
        if include_optional:
            return SpaViewSupplier(
                ...
                version = 12,
                spa = wink_sdk_extranet_facilities.models.spa_supplier.Spa_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
                    featured_ind = False, 
