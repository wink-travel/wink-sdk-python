...
class TestDuplicateGuestRoomRequestSupplier(unittest.TestCase):
    """DuplicateGuestRoomRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DuplicateGuestRoomRequestSupplier:
        """Test DuplicateGuestRoomRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DuplicateGuestRoomRequestSupplier`
        """
        model = DuplicateGuestRoomRequestSupplier()
        if include_optional:
            return DuplicateGuestRoomRequestSupplier(
    ...
    def testDuplicateGuestRoomRequestSupplier(self):
        """Test DuplicateGuestRoomRequestSupplier"""
