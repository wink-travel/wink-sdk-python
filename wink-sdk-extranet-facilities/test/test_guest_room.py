...
class TestGuestRoom(unittest.TestCase):
    """GuestRoom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoom:
        """Test GuestRoom
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoom`
        """
        model = GuestRoom()
        if include_optional:
            return GuestRoom(
