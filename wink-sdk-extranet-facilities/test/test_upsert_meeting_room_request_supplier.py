...
class TestUpsertMeetingRoomRequestSupplier(unittest.TestCase):
    """UpsertMeetingRoomRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertMeetingRoomRequestSupplier:
        """Test UpsertMeetingRoomRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertMeetingRoomRequestSupplier`
        """
        model = UpsertMeetingRoomRequestSupplier()
        if include_optional:
            return UpsertMeetingRoomRequestSupplier(
                featured_ind = False,
                ...
                address = wink_sdk_extranet_facilities.models.upsert_address_request_supplier.UpsertAddressRequest_Supplier(
    ...
    def testUpsertMeetingRoomRequestSupplier(self):
        """Test UpsertMeetingRoomRequestSupplier"""
