...
class TestGeoNameSupplier(unittest.TestCase):
    """GeoNameSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoNameSupplier:
        """Test GeoNameSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoNameSupplier`
        """
        model = GeoNameSupplier()
        if include_optional:
            return GeoNameSupplier(
                geo_name_id = '5128581',
                type = 'CITY',
                name = 'New York City',
