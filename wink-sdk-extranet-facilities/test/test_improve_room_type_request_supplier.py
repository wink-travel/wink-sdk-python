...
class TestImproveRoomTypeRequestSupplier(unittest.TestCase):
    """ImproveRoomTypeRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImproveRoomTypeRequestSupplier:
        """Test ImproveRoomTypeRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImproveRoomTypeRequestSupplier`
        """
        model = ImproveRoomTypeRequestSupplier()
        if include_optional:
            return ImproveRoomTypeRequestSupplier(
                title = '',
                description = ''
            )
        else:
    ...
    def testImproveRoomTypeRequestSupplier(self):
        """Test ImproveRoomTypeRequestSupplier"""
