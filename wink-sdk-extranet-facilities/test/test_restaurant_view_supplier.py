...
class TestRestaurantViewSupplier(unittest.TestCase):
    """RestaurantViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantViewSupplier:
        """Test RestaurantViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantViewSupplier`
        """
        model = RestaurantViewSupplier()
        if include_optional:
            return RestaurantViewSupplier(
                ...
                version = 12,
                restaurant = wink_sdk_extranet_facilities.models.restaurant_supplier.Restaurant_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
                    featured_ind = False, 
    ...
    def testRestaurantViewSupplier(self):
        """Test RestaurantViewSupplier"""
