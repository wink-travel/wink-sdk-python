...
class TestGuestRoomApi(unittest.TestCase):
    """GuestRoomApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GuestRoomApi()

    def tearDown(self) -> None:
        pass

    def test_create_guest_room(self) -> None:
        """Test case for create_guest_room

        Create Guest Room
        """
        pass

    def test_duplicate_guest_room(self) -> None:
        """Test case for duplicate_guest_room

        Duplicate Guest Room
        """
        pass

    def test_remove_guest_room(self) -> None:
        """Test case for remove_guest_room

        Delete Guest Room
        """
        pass

    def test_remove_multimedia2(self) -> None:
        """Test case for remove_multimedia2

        Delete Guest Room Multimedia
        """
        pass

    def test_show_guest_room(self) -> None:
        """Test case for show_guest_room

        Show Guest Room
        """
        pass

    def test_show_guest_rooms(self) -> None:
        """Test case for show_guest_rooms

        Show Guest Rooms
        """
        pass

    def test_update_guest_room(self) -> None:
        """Test case for update_guest_room

        Update Guest Room
        """
        pass

    def test_upload_guest_room_media(self) -> None:
        """Test case for upload_guest_room_media
