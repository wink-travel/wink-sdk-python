...
class TestMeetingRoomSupplier(unittest.TestCase):
    """MeetingRoomSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeetingRoomSupplier:
        """Test MeetingRoomSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeetingRoomSupplier`
        """
        model = MeetingRoomSupplier()
        if include_optional:
            return MeetingRoomSupplier(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testMeetingRoomSupplier(self):
        """Test MeetingRoomSupplier"""
