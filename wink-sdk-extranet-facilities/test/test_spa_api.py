...
class TestSpaApi(unittest.TestCase):
    """SpaApi unit test stubs"""
    ...
    def test_create_spa(self) -> None:
        """Test case for create_spa

        Create Spa
        """
        pass

    def test_delete_multimedia(self) -> None:
        """Test case for delete_multimedia

        Delete Multimedia
        """
        pass

    def test_remove_spa(self) -> None:
        """Test case for remove_spa

        Delete Spa
        """
        pass

    def test_show_spa(self) -> None:
        """Test case for show_spa

        Show Spa
        """
        pass

    def test_show_spa_pairs(self) -> None:
        """Test case for show_spa_pairs

        Show Reference Pairs
        """
        pass

    def test_show_spas(self) -> None:
        """Test case for show_spas

        Show Spas
        """
        pass

    def test_update_spa(self) -> None:
        """Test case for update_spa

        Update Spa
        """
        pass

    def test_upload_spa_media(self) -> None:
        """Test case for upload_spa_media
