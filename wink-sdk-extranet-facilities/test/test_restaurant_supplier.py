...
class TestRestaurantSupplier(unittest.TestCase):
    """RestaurantSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantSupplier:
        """Test RestaurantSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantSupplier`
        """
    ...
    def testRestaurantSupplier(self):
        """Test RestaurantSupplier"""
