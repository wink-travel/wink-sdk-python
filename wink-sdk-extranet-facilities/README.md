...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.48#egg=wink_sdk_extranet_facilities&subdirectory=wink-sdk-extranet-facilities
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.48#egg=wink_sdk_extranet_facilities&subdirectory=wink_sdk_extranet_facilities`)
