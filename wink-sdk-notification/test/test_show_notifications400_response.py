...
class TestShowNotifications400Response(unittest.TestCase):
    """ShowNotifications400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowNotifications400Response:
        """Test ShowNotifications400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowNotifications400Response`
        """
        model = ShowNotifications400Response()
        if include_optional:
            return ShowNotifications400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowNotifications400Response(self):
        """Test ShowNotifications400Response"""
