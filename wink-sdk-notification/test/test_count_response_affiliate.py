...
class TestCountResponseAffiliate(unittest.TestCase):
    """CountResponseAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountResponseAffiliate:
        """Test CountResponseAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountResponseAffiliate`
        """
        model = CountResponseAffiliate()
        if include_optional:
    ...
    def testCountResponseAffiliate(self):
        """Test CountResponseAffiliate"""
