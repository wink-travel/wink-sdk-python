...
class TestShowNotification400Response(unittest.TestCase):
    """ShowNotification400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowNotification400Response:
        """Test ShowNotification400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowNotification400Response`
        """
        model = ShowNotification400Response()
        if include_optional:
            return ShowNotification400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowNotification400Response(self):
        """Test ShowNotification400Response"""
