...
class TestNotificationAffiliate(unittest.TestCase):
    """NotificationAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationAffiliate:
        """Test NotificationAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationAffiliate`
        """
        model = NotificationAffiliate()
        if include_optional:
    ...
    def testNotificationAffiliate(self):
        """Test NotificationAffiliate"""
