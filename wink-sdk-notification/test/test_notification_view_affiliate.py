...
class TestNotificationViewAffiliate(unittest.TestCase):
    """NotificationViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationViewAffiliate:
        """Test NotificationViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationViewAffiliate`
        """
        model = NotificationViewAffiliate()
        if include_optional:
            return NotificationViewAffiliate(
                ...
                version = 12,
                notification = wink_sdk_notification.models.notification_affiliate.Notification_Affiliate(
                    identifier = '', 
                    owner_identifier = '', 
                    priority = 'HIGH', 
                    type = 'ALERT', 
    ...
    def testNotificationViewAffiliate(self):
        """Test NotificationViewAffiliate"""
