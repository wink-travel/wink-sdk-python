...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.24#egg=wink_sdk_notification&subdirectory=wink-sdk-notification
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.24#egg=wink_sdk_notification&subdirectory=wink_sdk_notification`)
