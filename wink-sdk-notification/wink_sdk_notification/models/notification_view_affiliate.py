...
class NotificationViewAffiliate(BaseModel):
    """
    ...
    notification: NotificationAffiliate
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notification": NotificationAffiliate.from_dict(obj["notification"]) if obj.get("notification") is not None else None
        })
        return _obj
