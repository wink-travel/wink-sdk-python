...
from wink_sdk_notification.configuration import Configuration
from wink_sdk_notification.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_notification.models
from wink_sdk_notification import rest
from wink_sdk_notification.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_notification.models, klass)
