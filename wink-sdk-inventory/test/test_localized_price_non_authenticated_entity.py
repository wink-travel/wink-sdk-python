...
class TestLocalizedPriceNonAuthenticatedEntity(unittest.TestCase):
    """LocalizedPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedPriceNonAuthenticatedEntity:
        """Test LocalizedPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedPriceNonAuthenticatedEntity`
        """
        model = LocalizedPriceNonAuthenticatedEntity()
        if include_optional:
            return LocalizedPriceNonAuthenticatedEntity(
    ...
    def testLocalizedPriceNonAuthenticatedEntity(self):
        """Test LocalizedPriceNonAuthenticatedEntity"""
