...
class TestAddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity:
        """Test AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity`
        """
        model = AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity()
        if include_optional:
            return AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(
    ...
    def testAddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(self):
        """Test AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity"""
