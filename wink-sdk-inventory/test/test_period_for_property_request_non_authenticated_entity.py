...
class TestPeriodForPropertyRequestNonAuthenticatedEntity(unittest.TestCase):
    """PeriodForPropertyRequestNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeriodForPropertyRequestNonAuthenticatedEntity:
        """Test PeriodForPropertyRequestNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeriodForPropertyRequestNonAuthenticatedEntity`
        """
        model = PeriodForPropertyRequestNonAuthenticatedEntity()
        if include_optional:
            return PeriodForPropertyRequestNonAuthenticatedEntity(
                hotel_identifier = '0',
    ...
    def testPeriodForPropertyRequestNonAuthenticatedEntity(self):
        """Test PeriodForPropertyRequestNonAuthenticatedEntity"""
