...
class TestSellableRankedListResponseNonAuthenticatedEntity(unittest.TestCase):
    """SellableRankedListResponseNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableRankedListResponseNonAuthenticatedEntity:
        """Test SellableRankedListResponseNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableRankedListResponseNonAuthenticatedEntity`
        """
        model = SellableRankedListResponseNonAuthenticatedEntity()
        if include_optional:
            return SellableRankedListResponseNonAuthenticatedEntity(
                page = wink_sdk_inventory.models.page_inventory_grid_item_non_authenticated_entity.PageInventoryGridItem_Non_Authenticated_Entity(
                    total_elements = 56, 
                    total_pages = 56, 
                    size = 56, 
                    content = [
                        wink_sdk_inventory.models.inventory_grid_item_non_authenticated_entity.InventoryGridItem_Non_Authenticated_Entity(
                            sort = 1, 
                            type = 'HOTEL', 
                            identifier = '', 
                            supplier_identifier = 'hotel-1', 
                            activity = wink_sdk_inventory.models.activity_localized_inventory_with_hotel_best_price_non_authenticated_entity.ActivityLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
                                inventory_with_price = wink_sdk_inventory.models.activity_localized_inventory_non_authenticated_entity.ActivityLocalizedInventory_Non_Authenticated_Entity(
                                    list = [
                                ...
                                hotel_with_best_price = wink_sdk_inventory.models.property_with_best_price_non_authenticated_entity.PropertyWithBestPrice_Non_Authenticated_Entity(
                                    ...
                                    available = True, ), 
                                sort = 1, ), 
                            attraction = wink_sdk_inventory.models.attraction_localized_inventory_with_hotel_best_price_non_authenticated_entity.AttractionLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
                                sort = 1, ), 
                            place = wink_sdk_inventory.models.place_localized_inventory_with_hotel_best_price_non_authenticated_entity.PlaceLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
                                sort = 1, ), 
                            room_type = wink_sdk_inventory.models.property_with_best_price_non_authenticated_entity.PropertyWithBestPrice_Non_Authenticated_Entity(
                                hotel = wink_sdk_inventory.models.property_aggregate_lightweight_non_authenticated_entity.PropertyAggregateLightweight_Non_Authenticated_Entity(
                                    hotel_identifier = 'hotel-1', 
                                    name = 'The Loveliest Hotel', 
                                    local_name = 'Det Beste Hotellet', 
                                ...
                                source_to_internal_currency_quote = , 
                                available = True, ), 
                            meeting_room = wink_sdk_inventory.models.meeting_room_localized_inventory_with_hotel_best_price_non_authenticated_entity.MeetingRoomLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
                                sort = 1, ), 
                            restaurant = wink_sdk_inventory.models.restaurant_localized_inventory_with_hotel_best_price_non_authenticated_entity.RestaurantLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
                                sort = 1, ), 
                            spa = wink_sdk_inventory.models.spa_localized_inventory_with_hotel_best_price_non_authenticated_entity.SpaLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
                                sort = 1, ), 
                            add_on = wink_sdk_inventory.models.add_on_localized_inventory_with_hotel_best_price_non_authenticated_entity.AddOnLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
                                sort = 1, ), 
                            available = True, )
                        ], 
                    number = 56, 
                    number_of_elements = 56, 
                    sort = wink_sdk_inventory.models.sort_object_non_authenticated_entity.SortObject_Non_Authenticated_Entity(
                        empty = True, 
                        sorted = True, 
                        unsorted = True, ), 
                    pageable = wink_sdk_inventory.models.pageable_object_non_authenticated_entity.PageableObject_Non_Authenticated_Entity(
                        offset = 56, 
                        unpaged = True, 
                        paged = True, 
                        page_number = 56, 
                    ...
                    last = True, 
                    empty = True, ),
                list = wink_sdk_inventory.models.sellable_ranked_list_lightweight_non_authenticated_entity.SellableRankedListLightweight_Non_Authenticated_Entity(
                    identifier = 'ranked-grid-1', 
                    owner_identifier = 'company-1', 
                    name = 'My ranked list', 
                    customization_identifier = 'customization-1', 
                    descriptions = [
                        wink_sdk_inventory.models.simple_description_non_authenticated_entity.SimpleDescription_Non_Authenticated_Entity(
                            name = 'An example title', 
                            description = 'This is a longer description in the specified language.', 
                    ...
                    status = 'ACTIVE', 
                    lookup = wink_sdk_inventory.models.lookup_lightweight_non_authenticated_entity.LookupLightweight_Non_Authenticated_Entity(
                        identifier = 'lookup-1', 
                        type = 'CITY', 
                        type_identifier = 'lookup-city-1', 
                        name = 'Archery on horseback', 
                        url_name = 'archery-on-horseback', 
                        owner_identifier = 'hotel-1', 
                        owner_name = 'My Chic Hotel', 
                        city_name = 'Los Angeles', 
                        country_name = 'United States', 
                        sub_country_name = 'California', 
                        sub_sub_country_name = 'Orange County', 
                        country_code = 'US', 
                        owner_type = 'HOTEL', 
                        language_code = 'en-US', 
                        sort = 2, 
                        origin = True, 
                        lowercase_name = 'archery on horseback', 
                        location = {type=POINT, coordinates=[100.5581533, 13.7370197]}, ), 
                    animate = False, 
                    animate_delay = 56, 
                    sort = 'MEMBER', 
    ...
    def testSellableRankedListResponseNonAuthenticatedEntity(self):
        """Test SellableRankedListResponseNonAuthenticatedEntity"""
