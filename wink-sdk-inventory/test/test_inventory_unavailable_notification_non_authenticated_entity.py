...
class TestInventoryUnavailableNotificationNonAuthenticatedEntity(unittest.TestCase):
    """InventoryUnavailableNotificationNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryUnavailableNotificationNonAuthenticatedEntity:
        """Test InventoryUnavailableNotificationNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryUnavailableNotificationNonAuthenticatedEntity`
        """
        model = InventoryUnavailableNotificationNonAuthenticatedEntity()
        if include_optional:
    ...
    def testInventoryUnavailableNotificationNonAuthenticatedEntity(self):
        """Test InventoryUnavailableNotificationNonAuthenticatedEntity"""
