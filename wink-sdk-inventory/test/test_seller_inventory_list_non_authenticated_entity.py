...
class TestSellerInventoryListNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryListNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryListNonAuthenticatedEntity:
        """Test SellerInventoryListNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryListNonAuthenticatedEntity`
        """
        model = SellerInventoryListNonAuthenticatedEntity()
        if include_optional:
            return SellerInventoryListNonAuthenticatedEntity(
                identifier = '',
                seller_identifier = '',
    ...
    def testSellerInventoryListNonAuthenticatedEntity(self):
        """Test SellerInventoryListNonAuthenticatedEntity"""
