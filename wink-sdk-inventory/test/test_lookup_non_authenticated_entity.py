...
class TestLookupNonAuthenticatedEntity(unittest.TestCase):
    """LookupNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LookupNonAuthenticatedEntity:
        """Test LookupNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LookupNonAuthenticatedEntity`
        """
        model = LookupNonAuthenticatedEntity()
        if include_optional:
    ...
    def testLookupNonAuthenticatedEntity(self):
        """Test LookupNonAuthenticatedEntity"""
