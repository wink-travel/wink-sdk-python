...
class TestItineraryNonAuthenticatedEntity(unittest.TestCase):
    """ItineraryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItineraryNonAuthenticatedEntity:
        """Test ItineraryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItineraryNonAuthenticatedEntity`
        """
        model = ItineraryNonAuthenticatedEntity()
        if include_optional:
            return ItineraryNonAuthenticatedEntity(
    ...
    def testItineraryNonAuthenticatedEntity(self):
        """Test ItineraryNonAuthenticatedEntity"""
