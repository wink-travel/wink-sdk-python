...
class TestLocalizedTransactionalTravelInventoryNonAuthenticatedEntity(unittest.TestCase):
    """LocalizedTransactionalTravelInventoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedTransactionalTravelInventoryNonAuthenticatedEntity:
        """Test LocalizedTransactionalTravelInventoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedTransactionalTravelInventoryNonAuthenticatedEntity`
        """
        model = LocalizedTransactionalTravelInventoryNonAuthenticatedEntity()
        if include_optional:
            return LocalizedTransactionalTravelInventoryNonAuthenticatedEntity(
                identifier = '',
                name = '1 hour session',
                descriptions = [
    ...
    def testLocalizedTransactionalTravelInventoryNonAuthenticatedEntity(self):
        """Test LocalizedTransactionalTravelInventoryNonAuthenticatedEntity"""
