...
class TestSellerInventoryGuestRoomNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryGuestRoomNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryGuestRoomNonAuthenticatedEntity:
        """Test SellerInventoryGuestRoomNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryGuestRoomNonAuthenticatedEntity`
        """
        model = SellerInventoryGuestRoomNonAuthenticatedEntity()
        if include_optional:
            return SellerInventoryGuestRoomNonAuthenticatedEntity(
                inventory = wink_sdk_inventory.models.hotel_with_best_price_non_authenticated_entity.HotelWithBestPrice_Non_Authenticated_Entity(
    ...
    def testSellerInventoryGuestRoomNonAuthenticatedEntity(self):
        """Test SellerInventoryGuestRoomNonAuthenticatedEntity"""
