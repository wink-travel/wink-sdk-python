...
class TestHotelInventoryResponseNonAuthenticatedEntity(unittest.TestCase):
    """HotelInventoryResponseNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelInventoryResponseNonAuthenticatedEntity:
        """Test HotelInventoryResponseNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelInventoryResponseNonAuthenticatedEntity`
        """
        model = HotelInventoryResponseNonAuthenticatedEntity()
        if include_optional:
    ...
    def testHotelInventoryResponseNonAuthenticatedEntity(self):
        """Test HotelInventoryResponseNonAuthenticatedEntity"""
