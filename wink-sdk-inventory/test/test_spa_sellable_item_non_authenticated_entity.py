...
class TestSpaSellableItemNonAuthenticatedEntity(unittest.TestCase):
    """SpaSellableItemNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaSellableItemNonAuthenticatedEntity:
        """Test SpaSellableItemNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaSellableItemNonAuthenticatedEntity`
        """
        model = SpaSellableItemNonAuthenticatedEntity()
        if include_optional:
            return SpaSellableItemNonAuthenticatedEntity(
                inventory = wink_sdk_inventory.models.spa_localized_inventory_with_hotel_best_price_non_authenticated_entity.SpaLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
    ...
    def testSpaSellableItemNonAuthenticatedEntity(self):
        """Test SpaSellableItemNonAuthenticatedEntity"""
