...
class TestSortObjectNonAuthenticatedEntity(unittest.TestCase):
    """SortObjectNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortObjectNonAuthenticatedEntity:
        """Test SortObjectNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortObjectNonAuthenticatedEntity`
        """
        model = SortObjectNonAuthenticatedEntity()
        if include_optional:
            return SortObjectNonAuthenticatedEntity(
                empty = True,
                sorted = True,
                unsorted = True
            )
    ...
    def testSortObjectNonAuthenticatedEntity(self):
        """Test SortObjectNonAuthenticatedEntity"""
