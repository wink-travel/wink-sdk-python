...
class TestSpaNonAuthenticatedEntity(unittest.TestCase):
    """SpaNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaNonAuthenticatedEntity:
        """Test SpaNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaNonAuthenticatedEntity`
        """
        model = SpaNonAuthenticatedEntity()
        if include_optional:
            return SpaNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testSpaNonAuthenticatedEntity(self):
        """Test SpaNonAuthenticatedEntity"""
