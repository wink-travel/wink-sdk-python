...
class TestMediaAuthorAttributionNonAuthenticatedEntity(unittest.TestCase):
    """MediaAuthorAttributionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MediaAuthorAttributionNonAuthenticatedEntity:
        """Test MediaAuthorAttributionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MediaAuthorAttributionNonAuthenticatedEntity`
        """
        model = MediaAuthorAttributionNonAuthenticatedEntity()
        if include_optional:
            return MediaAuthorAttributionNonAuthenticatedEntity(
    ...
    def testMediaAuthorAttributionNonAuthenticatedEntity(self):
        """Test MediaAuthorAttributionNonAuthenticatedEntity"""
