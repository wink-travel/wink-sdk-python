...
class TestBedroomConfigurationNonAuthenticatedEntity(unittest.TestCase):
    """BedroomConfigurationNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomConfigurationNonAuthenticatedEntity:
        """Test BedroomConfigurationNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomConfigurationNonAuthenticatedEntity`
        """
        model = BedroomConfigurationNonAuthenticatedEntity()
        if include_optional:
            return BedroomConfigurationNonAuthenticatedEntity(
                identifier = '',
                name = '',
                bedroom_list = [
    ...
    def testBedroomConfigurationNonAuthenticatedEntity(self):
        """Test BedroomConfigurationNonAuthenticatedEntity"""
