...
class TestPlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity:
        """Test PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity`
        """
        model = PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity()
        if include_optional:
            return PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(
    ...
    def testPlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(self):
        """Test PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity"""
