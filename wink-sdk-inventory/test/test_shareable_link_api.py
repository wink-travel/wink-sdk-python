...
class TestShareableLinkApi(unittest.TestCase):
    """ShareableLinkApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ShareableLinkApi()

    def tearDown(self) -> None:
        pass

    def test_oauth2_show_consumable_url(self) -> None:
        """Test case for oauth2_show_consumable_url

        Show Shareable Link (OAuth2)
        """
        pass

    def test_show_consumable_url(self) -> None:
        """Test case for show_consumable_url
