...
class TestPlaceLightweightNonAuthenticatedEntity(unittest.TestCase):
    """PlaceLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceLightweightNonAuthenticatedEntity:
        """Test PlaceLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceLightweightNonAuthenticatedEntity`
        """
        model = PlaceLightweightNonAuthenticatedEntity()
        if include_optional:
            return PlaceLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testPlaceLightweightNonAuthenticatedEntity(self):
        """Test PlaceLightweightNonAuthenticatedEntity"""
