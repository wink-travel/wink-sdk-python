...
class TestSellerInventoryListResponseNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryListResponseNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryListResponseNonAuthenticatedEntity:
        """Test SellerInventoryListResponseNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryListResponseNonAuthenticatedEntity`
        """
        model = SellerInventoryListResponseNonAuthenticatedEntity()
        if include_optional:
            return SellerInventoryListResponseNonAuthenticatedEntity(
                inventory_page = wink_sdk_inventory.models.page_inventory_grid_item_non_authenticated_entity.PageInventoryGridItem_Non_Authenticated_Entity(
                    ...
                    last = True, 
                    empty = True, ),
                configuration = wink_sdk_inventory.models.seller_inventory_list_non_authenticated_entity.SellerInventoryList_Non_Authenticated_Entity(
                    identifier = '', 
                    seller_identifier = '', 
                    seller_inventory_list_name = 'My list', 
    ...
    def testSellerInventoryListResponseNonAuthenticatedEntity(self):
        """Test SellerInventoryListResponseNonAuthenticatedEntity"""
