...
class TestAggregateGreendexScoreByCategoryNonAuthenticatedEntity(unittest.TestCase):
    """AggregateGreendexScoreByCategoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateGreendexScoreByCategoryNonAuthenticatedEntity:
        """Test AggregateGreendexScoreByCategoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateGreendexScoreByCategoryNonAuthenticatedEntity`
        """
        model = AggregateGreendexScoreByCategoryNonAuthenticatedEntity()
        if include_optional:
            return AggregateGreendexScoreByCategoryNonAuthenticatedEntity(
                category = 'GENERAL',
                high_score = 100,
                total_score = 50,
                aggregate_score = 0
    ...
    def testAggregateGreendexScoreByCategoryNonAuthenticatedEntity(self):
        """Test AggregateGreendexScoreByCategoryNonAuthenticatedEntity"""
