...
class TestRecreationNonAuthenticatedEntity(unittest.TestCase):
    """RecreationNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecreationNonAuthenticatedEntity:
        """Test RecreationNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecreationNonAuthenticatedEntity`
        """
        model = RecreationNonAuthenticatedEntity()
        if include_optional:
            return RecreationNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testRecreationNonAuthenticatedEntity(self):
        """Test RecreationNonAuthenticatedEntity"""
