...
class TestAttractionLightweightNonAuthenticatedEntity(unittest.TestCase):
    """AttractionLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttractionLightweightNonAuthenticatedEntity:
        """Test AttractionLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttractionLightweightNonAuthenticatedEntity`
        """
        model = AttractionLightweightNonAuthenticatedEntity()
        if include_optional:
            return AttractionLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testAttractionLightweightNonAuthenticatedEntity(self):
        """Test AttractionLightweightNonAuthenticatedEntity"""
