...
class TestMeetingRoomLightweightNonAuthenticatedEntity(unittest.TestCase):
    """MeetingRoomLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeetingRoomLightweightNonAuthenticatedEntity:
        """Test MeetingRoomLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeetingRoomLightweightNonAuthenticatedEntity`
        """
        model = MeetingRoomLightweightNonAuthenticatedEntity()
        if include_optional:
            return MeetingRoomLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testMeetingRoomLightweightNonAuthenticatedEntity(self):
        """Test MeetingRoomLightweightNonAuthenticatedEntity"""
