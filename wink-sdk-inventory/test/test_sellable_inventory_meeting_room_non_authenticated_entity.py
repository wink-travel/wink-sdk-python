...
class TestSellableInventoryMeetingRoomNonAuthenticatedEntity(unittest.TestCase):
    """SellableInventoryMeetingRoomNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableInventoryMeetingRoomNonAuthenticatedEntity:
        """Test SellableInventoryMeetingRoomNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableInventoryMeetingRoomNonAuthenticatedEntity`
        """
        model = SellableInventoryMeetingRoomNonAuthenticatedEntity()
        if include_optional:
            return SellableInventoryMeetingRoomNonAuthenticatedEntity(
                inventory = wink_sdk_inventory.models.meeting_room_localized_inventory_with_hotel_best_price_non_authenticated_entity.MeetingRoomLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
    ...
    def testSellableInventoryMeetingRoomNonAuthenticatedEntity(self):
        """Test SellableInventoryMeetingRoomNonAuthenticatedEntity"""
