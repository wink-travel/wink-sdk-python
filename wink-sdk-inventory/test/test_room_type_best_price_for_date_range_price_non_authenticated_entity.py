...
class TestRoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity(unittest.TestCase):
    """RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity:
        """Test RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity`
        """
        model = RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity()
        if include_optional:
            return RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity(
                user_specified_currency_total = wink_sdk_inventory.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '0', ),
                source_total = wink_sdk_inventory.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '0', )
            )
        else:
    ...
    def testRoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity(self):
        """Test RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity"""
