...
class TestRestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity:
        """Test RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity`
        """
        model = RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity()
        if include_optional:
            return RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(
    ...
    def testRestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(self):
        """Test RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity"""
