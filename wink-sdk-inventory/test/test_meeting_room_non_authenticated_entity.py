...
class TestMeetingRoomNonAuthenticatedEntity(unittest.TestCase):
    """MeetingRoomNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeetingRoomNonAuthenticatedEntity:
        """Test MeetingRoomNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeetingRoomNonAuthenticatedEntity`
        """
        model = MeetingRoomNonAuthenticatedEntity()
        if include_optional:
            return MeetingRoomNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testMeetingRoomNonAuthenticatedEntity(self):
        """Test MeetingRoomNonAuthenticatedEntity"""
