...
class TestAnnouncementLightweightNonAuthenticatedEntity(unittest.TestCase):
    """AnnouncementLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnnouncementLightweightNonAuthenticatedEntity:
        """Test AnnouncementLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnnouncementLightweightNonAuthenticatedEntity`
        """
        model = AnnouncementLightweightNonAuthenticatedEntity()
        if include_optional:
            return AnnouncementLightweightNonAuthenticatedEntity(
    ...
    def testAnnouncementLightweightNonAuthenticatedEntity(self):
        """Test AnnouncementLightweightNonAuthenticatedEntity"""
