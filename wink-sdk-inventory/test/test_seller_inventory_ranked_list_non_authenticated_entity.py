...
class TestSellerInventoryRankedListNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryRankedListNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryRankedListNonAuthenticatedEntity:
        """Test SellerInventoryRankedListNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryRankedListNonAuthenticatedEntity`
        """
        model = SellerInventoryRankedListNonAuthenticatedEntity()
        if include_optional:
            return SellerInventoryRankedListNonAuthenticatedEntity(
                identifier = '',
                seller_identifier = '',
    ...
    def testSellerInventoryRankedListNonAuthenticatedEntity(self):
        """Test SellerInventoryRankedListNonAuthenticatedEntity"""
