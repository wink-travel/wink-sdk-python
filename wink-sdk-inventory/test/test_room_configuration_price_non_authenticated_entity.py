    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceNonAuthenticatedEntity:
        ...
        if include_optional:
            return RoomConfigurationPriceNonAuthenticatedEntity(
                    ...
                    items = [
                        wink_sdk_inventory.models.items.Items(
                            rate_plan_level_fee = wink_sdk_inventory.models.rate_plan_level_fee_non_authenticated_entity.RatePlanLevelFee_Non_Authenticated_Entity(
                                ...
                                fixed_amount = wink_sdk_inventory.models.custom_monetary_amount.CustomMonetaryAmount(
                                    amount = 1.337, 
                                    currency = '', ), 
                                type = 'PER_DAY', ), 
                ...
                perk_value = 56,
                active_cancellation_policy = wink_sdk_inventory.models.cancellation_policy_non_authenticated_entity.CancellationPolicy_Non_Authenticated_Entity(
                    identifier = '', 
                    hotel_identifier = '', 
                    refundable = False, 
                    advance_cancellation_free_of_charge = 'UNTIL_EIGHTEEN_HUNDRED_HOURS_ON_DAY_OF_ARRIVAL', 
