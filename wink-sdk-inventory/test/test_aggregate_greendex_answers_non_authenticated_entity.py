...
class TestAggregateGreendexAnswersNonAuthenticatedEntity(unittest.TestCase):
    """AggregateGreendexAnswersNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateGreendexAnswersNonAuthenticatedEntity:
        """Test AggregateGreendexAnswersNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateGreendexAnswersNonAuthenticatedEntity`
        """
        model = AggregateGreendexAnswersNonAuthenticatedEntity()
        if include_optional:
            return AggregateGreendexAnswersNonAuthenticatedEntity(
                high_score = 100,
                total_score = 50,
                aggregate_score = 0,
                scores_by_category = [
    ...
    def testAggregateGreendexAnswersNonAuthenticatedEntity(self):
        """Test AggregateGreendexAnswersNonAuthenticatedEntity"""
