...
class TestPropertyAggregateGreenIndexAnswersNonAuthenticatedEntity(unittest.TestCase):
    """PropertyAggregateGreenIndexAnswersNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateGreenIndexAnswersNonAuthenticatedEntity:
        """Test PropertyAggregateGreenIndexAnswersNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateGreenIndexAnswersNonAuthenticatedEntity`
        """
        model = PropertyAggregateGreenIndexAnswersNonAuthenticatedEntity()
        if include_optional:
            return PropertyAggregateGreenIndexAnswersNonAuthenticatedEntity(
                hotel_identifier = '',
                list = [
    ...
    def testPropertyAggregateGreenIndexAnswersNonAuthenticatedEntity(self):
        """Test PropertyAggregateGreenIndexAnswersNonAuthenticatedEntity"""
