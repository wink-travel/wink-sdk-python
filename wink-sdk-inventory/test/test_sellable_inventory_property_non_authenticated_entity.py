...
class TestSellableInventoryPropertyNonAuthenticatedEntity(unittest.TestCase):
    """SellableInventoryPropertyNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableInventoryPropertyNonAuthenticatedEntity:
        """Test SellableInventoryPropertyNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableInventoryPropertyNonAuthenticatedEntity`
        """
        model = SellableInventoryPropertyNonAuthenticatedEntity()
        if include_optional:
            return SellableInventoryPropertyNonAuthenticatedEntity(
    ...
    def testSellableInventoryPropertyNonAuthenticatedEntity(self):
        """Test SellableInventoryPropertyNonAuthenticatedEntity"""
