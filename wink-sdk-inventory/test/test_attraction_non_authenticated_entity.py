...
class TestAttractionNonAuthenticatedEntity(unittest.TestCase):
    """AttractionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttractionNonAuthenticatedEntity:
        """Test AttractionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttractionNonAuthenticatedEntity`
        """
        model = AttractionNonAuthenticatedEntity()
        if include_optional:
            return AttractionNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testAttractionNonAuthenticatedEntity(self):
        """Test AttractionNonAuthenticatedEntity"""
