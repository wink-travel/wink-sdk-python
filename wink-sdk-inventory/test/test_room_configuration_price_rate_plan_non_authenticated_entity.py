...
class TestRoomConfigurationPriceRatePlanNonAuthenticatedEntity(unittest.TestCase):
    """RoomConfigurationPriceRatePlanNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationPriceRatePlanNonAuthenticatedEntity:
        """Test RoomConfigurationPriceRatePlanNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationPriceRatePlanNonAuthenticatedEntity`
        """
        model = RoomConfigurationPriceRatePlanNonAuthenticatedEntity()
        if include_optional:
            return RoomConfigurationPriceRatePlanNonAuthenticatedEntity(
                identifier = '',
                name = 'BAR 1',
                breakfast = False,
                brunch = False,
    ...
    def testRoomConfigurationPriceRatePlanNonAuthenticatedEntity(self):
        """Test RoomConfigurationPriceRatePlanNonAuthenticatedEntity"""
