...
class TestPageInventoryGridItemNonAuthenticatedEntity(unittest.TestCase):
    """PageInventoryGridItemNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageInventoryGridItemNonAuthenticatedEntity:
        """Test PageInventoryGridItemNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageInventoryGridItemNonAuthenticatedEntity`
        """
        model = PageInventoryGridItemNonAuthenticatedEntity()
        if include_optional:
            return PageInventoryGridItemNonAuthenticatedEntity(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
    ...
    def testPageInventoryGridItemNonAuthenticatedEntity(self):
        """Test PageInventoryGridItemNonAuthenticatedEntity"""
