...
class TestMetaDataNonAuthenticatedEntity(unittest.TestCase):
    """MetaDataNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetaDataNonAuthenticatedEntity:
        """Test MetaDataNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetaDataNonAuthenticatedEntity`
        """
        model = MetaDataNonAuthenticatedEntity()
        if include_optional:
            return MetaDataNonAuthenticatedEntity(
                type = 'PAGE_TITLE',
                key = '',
                value = ''
            )
    ...
    def testMetaDataNonAuthenticatedEntity(self):
        """Test MetaDataNonAuthenticatedEntity"""
