...
class TestSellerInventoryActivityNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryActivityNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryActivityNonAuthenticatedEntity:
        """Test SellerInventoryActivityNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryActivityNonAuthenticatedEntity`
        """
        model = SellerInventoryActivityNonAuthenticatedEntity()
        if include_optional:
    ...
    def testSellerInventoryActivityNonAuthenticatedEntity(self):
        """Test SellerInventoryActivityNonAuthenticatedEntity"""
