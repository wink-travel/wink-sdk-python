...
class TestSellerMediaNonAuthenticatedEntity(unittest.TestCase):
    """SellerMediaNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerMediaNonAuthenticatedEntity:
        """Test SellerMediaNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerMediaNonAuthenticatedEntity`
        """
        model = SellerMediaNonAuthenticatedEntity()
        if include_optional:
            return SellerMediaNonAuthenticatedEntity(
                channel = 'FACEBOOK',
                url = '',
                width = 56,
                height = 56,
    ...
    def testSellerMediaNonAuthenticatedEntity(self):
        """Test SellerMediaNonAuthenticatedEntity"""
