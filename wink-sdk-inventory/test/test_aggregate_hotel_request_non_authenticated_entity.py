...
class TestAggregateHotelRequestNonAuthenticatedEntity(unittest.TestCase):
    """AggregateHotelRequestNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateHotelRequestNonAuthenticatedEntity:
        """Test AggregateHotelRequestNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateHotelRequestNonAuthenticatedEntity`
        """
        model = AggregateHotelRequestNonAuthenticatedEntity()
        if include_optional:
            return AggregateHotelRequestNonAuthenticatedEntity(
                identifier = '',
    ...
    def testAggregateHotelRequestNonAuthenticatedEntity(self):
        """Test AggregateHotelRequestNonAuthenticatedEntity"""
