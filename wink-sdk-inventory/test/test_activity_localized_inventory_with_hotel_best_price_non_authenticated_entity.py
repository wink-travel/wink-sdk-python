...
class TestActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity:
        """Test ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity`
        """
        model = ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity()
        if include_optional:
            return ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(
    ...
    def testActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(self):
        """Test ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity"""
