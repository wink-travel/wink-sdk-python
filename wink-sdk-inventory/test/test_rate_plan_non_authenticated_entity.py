...
class TestRatePlanNonAuthenticatedEntity(unittest.TestCase):
    """RatePlanNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanNonAuthenticatedEntity:
        """Test RatePlanNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanNonAuthenticatedEntity`
        """
        model = RatePlanNonAuthenticatedEntity()
        if include_optional:
            return RatePlanNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                name = 'BAR 1',
                prepaid = False,
                ...
                arrival_days_of_week = wink_sdk_inventory.models.dow_pattern_group_non_authenticated_entity.DowPatternGroup_Non_Authenticated_Entity(
                    ...
                    sun = True, 
                    disabled = True, ),
                departure_days_of_week = wink_sdk_inventory.models.dow_pattern_group_non_authenticated_entity.DowPatternGroup_Non_Authenticated_Entity(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
                    ...
                    sun = True, 
                    disabled = True, ),
                required_days_of_week = wink_sdk_inventory.models.dow_pattern_group_non_authenticated_entity.DowPatternGroup_Non_Authenticated_Entity(
                    mon = True, 
                    tue = True, 
                    wed = True, 
                    thu = True, 
    ...
    def testRatePlanNonAuthenticatedEntity(self):
        """Test RatePlanNonAuthenticatedEntity"""
