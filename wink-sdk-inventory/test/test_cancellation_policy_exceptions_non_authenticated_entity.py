...
class TestCancellationPolicyExceptionsNonAuthenticatedEntity(unittest.TestCase):
    """CancellationPolicyExceptionsNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancellationPolicyExceptionsNonAuthenticatedEntity:
        """Test CancellationPolicyExceptionsNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancellationPolicyExceptionsNonAuthenticatedEntity`
        """
        model = CancellationPolicyExceptionsNonAuthenticatedEntity()
        if include_optional:
            return CancellationPolicyExceptionsNonAuthenticatedEntity(
                list = [
    ...
    def testCancellationPolicyExceptionsNonAuthenticatedEntity(self):
        """Test CancellationPolicyExceptionsNonAuthenticatedEntity"""
