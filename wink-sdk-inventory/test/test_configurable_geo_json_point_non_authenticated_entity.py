...
class TestConfigurableGeoJsonPointNonAuthenticatedEntity(unittest.TestCase):
    """ConfigurableGeoJsonPointNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurableGeoJsonPointNonAuthenticatedEntity:
        """Test ConfigurableGeoJsonPointNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurableGeoJsonPointNonAuthenticatedEntity`
        """
        model = ConfigurableGeoJsonPointNonAuthenticatedEntity()
        if include_optional:
            return ConfigurableGeoJsonPointNonAuthenticatedEntity(
    ...
    def testConfigurableGeoJsonPointNonAuthenticatedEntity(self):
        """Test ConfigurableGeoJsonPointNonAuthenticatedEntity"""
