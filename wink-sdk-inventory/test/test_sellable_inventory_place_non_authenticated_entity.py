...
class TestSellableInventoryPlaceNonAuthenticatedEntity(unittest.TestCase):
    """SellableInventoryPlaceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableInventoryPlaceNonAuthenticatedEntity:
        """Test SellableInventoryPlaceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableInventoryPlaceNonAuthenticatedEntity`
        """
        model = SellableInventoryPlaceNonAuthenticatedEntity()
        if include_optional:
            return SellableInventoryPlaceNonAuthenticatedEntity(
    ...
    def testSellableInventoryPlaceNonAuthenticatedEntity(self):
        """Test SellableInventoryPlaceNonAuthenticatedEntity"""
