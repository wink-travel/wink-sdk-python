...
class TestSellerInventoryHotelNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryHotelNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryHotelNonAuthenticatedEntity:
        """Test SellerInventoryHotelNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryHotelNonAuthenticatedEntity`
        """
        model = SellerInventoryHotelNonAuthenticatedEntity()
        if include_optional:
    ...
    def testSellerInventoryHotelNonAuthenticatedEntity(self):
        """Test SellerInventoryHotelNonAuthenticatedEntity"""
