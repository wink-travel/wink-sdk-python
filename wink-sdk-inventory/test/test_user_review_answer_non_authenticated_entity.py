...
class TestUserReviewAnswerNonAuthenticatedEntity(unittest.TestCase):
    """UserReviewAnswerNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserReviewAnswerNonAuthenticatedEntity:
        """Test UserReviewAnswerNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserReviewAnswerNonAuthenticatedEntity`
        """
        model = UserReviewAnswerNonAuthenticatedEntity()
        if include_optional:
            return UserReviewAnswerNonAuthenticatedEntity(
                category = 'COMFORT',
                sort = 56,
                value = 56
            )
    ...
    def testUserReviewAnswerNonAuthenticatedEntity(self):
        """Test UserReviewAnswerNonAuthenticatedEntity"""
