...
class TestRestaurantLocalizedInventoryNonAuthenticatedEntity(unittest.TestCase):
    """RestaurantLocalizedInventoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantLocalizedInventoryNonAuthenticatedEntity:
        """Test RestaurantLocalizedInventoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantLocalizedInventoryNonAuthenticatedEntity`
        """
        model = RestaurantLocalizedInventoryNonAuthenticatedEntity()
        if include_optional:
            return RestaurantLocalizedInventoryNonAuthenticatedEntity(
    ...
    def testRestaurantLocalizedInventoryNonAuthenticatedEntity(self):
        """Test RestaurantLocalizedInventoryNonAuthenticatedEntity"""
