...
class TestAggregateSpaRequestNonAuthenticatedEntity(unittest.TestCase):
    """AggregateSpaRequestNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateSpaRequestNonAuthenticatedEntity:
        """Test AggregateSpaRequestNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateSpaRequestNonAuthenticatedEntity`
        """
        model = AggregateSpaRequestNonAuthenticatedEntity()
        if include_optional:
            return AggregateSpaRequestNonAuthenticatedEntity(
                identifier = '',
    ...
    def testAggregateSpaRequestNonAuthenticatedEntity(self):
        """Test AggregateSpaRequestNonAuthenticatedEntity"""
