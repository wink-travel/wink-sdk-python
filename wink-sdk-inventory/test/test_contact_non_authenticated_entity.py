...
class TestContactNonAuthenticatedEntity(unittest.TestCase):
    """ContactNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactNonAuthenticatedEntity:
        """Test ContactNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactNonAuthenticatedEntity`
        """
        model = ContactNonAuthenticatedEntity()
        if include_optional:
            return ContactNonAuthenticatedEntity(
                first_name = 'John',
                last_name = 'Smith',
    ...
    def testContactNonAuthenticatedEntity(self):
        """Test ContactNonAuthenticatedEntity"""
