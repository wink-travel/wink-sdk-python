...
class TestGeneralManagerNonAuthenticatedEntity(unittest.TestCase):
    """GeneralManagerNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralManagerNonAuthenticatedEntity:
        """Test GeneralManagerNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralManagerNonAuthenticatedEntity`
        """
        model = GeneralManagerNonAuthenticatedEntity()
        if include_optional:
            return GeneralManagerNonAuthenticatedEntity(
                name = 'Jane Doe',
    ...
    def testGeneralManagerNonAuthenticatedEntity(self):
        """Test GeneralManagerNonAuthenticatedEntity"""
