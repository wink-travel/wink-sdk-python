...
class TestImageAttributionNonAuthenticatedEntity(unittest.TestCase):
    """ImageAttributionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageAttributionNonAuthenticatedEntity:
        """Test ImageAttributionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAttributionNonAuthenticatedEntity`
        """
        model = ImageAttributionNonAuthenticatedEntity()
        if include_optional:
            return ImageAttributionNonAuthenticatedEntity(
    ...
    def testImageAttributionNonAuthenticatedEntity(self):
        """Test ImageAttributionNonAuthenticatedEntity"""
