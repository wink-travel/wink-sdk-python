...
class TestSellableListLightweightNonAuthenticatedEntity(unittest.TestCase):
    """SellableListLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableListLightweightNonAuthenticatedEntity:
        """Test SellableListLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableListLightweightNonAuthenticatedEntity`
        """
        model = SellableListLightweightNonAuthenticatedEntity()
        if include_optional:
            return SellableListLightweightNonAuthenticatedEntity(
                identifier = 'grid-1',
    ...
    def testSellableListLightweightNonAuthenticatedEntity(self):
        """Test SellableListLightweightNonAuthenticatedEntity"""
