...
class TestGuestRoomNonAuthenticatedEntity(unittest.TestCase):
    """GuestRoomNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestRoomNonAuthenticatedEntity:
        """Test GuestRoomNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestRoomNonAuthenticatedEntity`
        """
        model = GuestRoomNonAuthenticatedEntity()
        if include_optional:
            return GuestRoomNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testGuestRoomNonAuthenticatedEntity(self):
        """Test GuestRoomNonAuthenticatedEntity"""
