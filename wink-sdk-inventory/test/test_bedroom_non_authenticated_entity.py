...
class TestBedroomNonAuthenticatedEntity(unittest.TestCase):
    """BedroomNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedroomNonAuthenticatedEntity:
        """Test BedroomNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedroomNonAuthenticatedEntity`
        """
        model = BedroomNonAuthenticatedEntity()
        if include_optional:
            return BedroomNonAuthenticatedEntity(
                type = 'MASTER',
                bed_list = [
    ...
    def testBedroomNonAuthenticatedEntity(self):
        """Test BedroomNonAuthenticatedEntity"""
