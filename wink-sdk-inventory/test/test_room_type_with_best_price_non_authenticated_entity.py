...
class TestRoomTypeWithBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """RoomTypeWithBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomTypeWithBestPriceNonAuthenticatedEntity:
        """Test RoomTypeWithBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomTypeWithBestPriceNonAuthenticatedEntity`
        """
        model = RoomTypeWithBestPriceNonAuthenticatedEntity()
        if include_optional:
            return RoomTypeWithBestPriceNonAuthenticatedEntity(
    ...
    def testRoomTypeWithBestPriceNonAuthenticatedEntity(self):
        """Test RoomTypeWithBestPriceNonAuthenticatedEntity"""
