...
class TestRoomTypeBestPriceForDateRangeNonAuthenticatedEntity(unittest.TestCase):
    """RoomTypeBestPriceForDateRangeNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomTypeBestPriceForDateRangeNonAuthenticatedEntity:
        """Test RoomTypeBestPriceForDateRangeNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomTypeBestPriceForDateRangeNonAuthenticatedEntity`
        """
        model = RoomTypeBestPriceForDateRangeNonAuthenticatedEntity()
        if include_optional:
            return RoomTypeBestPriceForDateRangeNonAuthenticatedEntity(
                room = wink_sdk_inventory.models.room_type_best_price_for_date_range_info_non_authenticated_entity.RoomTypeBestPriceForDateRangeInfo_Non_Authenticated_Entity(
                ...
                room_nights = 56,
                available = True,
                price = wink_sdk_inventory.models.room_type_best_price_for_date_range_price_non_authenticated_entity.RoomTypeBestPriceForDateRangePrice_Non_Authenticated_Entity(
                    user_specified_currency_total = null, 
                    source_total = null, )
            )
        else:
            return RoomTypeBestPriceForDateRangeNonAuthenticatedEntity(
    ...
    def testRoomTypeBestPriceForDateRangeNonAuthenticatedEntity(self):
        """Test RoomTypeBestPriceForDateRangeNonAuthenticatedEntity"""
