...
class TestBedNonAuthenticatedEntity(unittest.TestCase):
    """BedNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BedNonAuthenticatedEntity:
        """Test BedNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BedNonAuthenticatedEntity`
        """
        model = BedNonAuthenticatedEntity()
        if include_optional:
            return BedNonAuthenticatedEntity(
                bed_type_code = '1',
                quantity = 10
            )
        else:
    ...
    def testBedNonAuthenticatedEntity(self):
        """Test BedNonAuthenticatedEntity"""
