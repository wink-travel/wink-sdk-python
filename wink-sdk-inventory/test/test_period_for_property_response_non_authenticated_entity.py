...
class TestPeriodForPropertyResponseNonAuthenticatedEntity(unittest.TestCase):
    """PeriodForPropertyResponseNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeriodForPropertyResponseNonAuthenticatedEntity:
        """Test PeriodForPropertyResponseNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeriodForPropertyResponseNonAuthenticatedEntity`
        """
        model = PeriodForPropertyResponseNonAuthenticatedEntity()
        if include_optional:
            return PeriodForPropertyResponseNonAuthenticatedEntity(
                hotel_identifier = '0',
                name = '0',
                adults = 56,
                list = [
    ...
    def testPeriodForPropertyResponseNonAuthenticatedEntity(self):
        """Test PeriodForPropertyResponseNonAuthenticatedEntity"""
