...
class TestRoomTypeWithPriceConfigurationsNonAuthenticatedEntity(unittest.TestCase):
    """RoomTypeWithPriceConfigurationsNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomTypeWithPriceConfigurationsNonAuthenticatedEntity:
        """Test RoomTypeWithPriceConfigurationsNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomTypeWithPriceConfigurationsNonAuthenticatedEntity`
        """
        model = RoomTypeWithPriceConfigurationsNonAuthenticatedEntity()
        if include_optional:
            return RoomTypeWithPriceConfigurationsNonAuthenticatedEntity(
    ...
    def testRoomTypeWithPriceConfigurationsNonAuthenticatedEntity(self):
        """Test RoomTypeWithPriceConfigurationsNonAuthenticatedEntity"""
