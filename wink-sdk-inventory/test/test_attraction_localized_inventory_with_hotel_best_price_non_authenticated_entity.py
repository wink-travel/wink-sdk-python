...
class TestAttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity:
        """Test AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity`
        """
        model = AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity()
        if include_optional:
            return AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(
    ...
    def testAttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(self):
        """Test AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity"""
