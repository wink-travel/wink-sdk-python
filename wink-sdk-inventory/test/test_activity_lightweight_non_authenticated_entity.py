...
class TestActivityLightweightNonAuthenticatedEntity(unittest.TestCase):
    """ActivityLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityLightweightNonAuthenticatedEntity:
        """Test ActivityLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityLightweightNonAuthenticatedEntity`
        """
        model = ActivityLightweightNonAuthenticatedEntity()
        if include_optional:
            return ActivityLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testActivityLightweightNonAuthenticatedEntity(self):
        """Test ActivityLightweightNonAuthenticatedEntity"""
