...
class TestSellerInventoryAddOnNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryAddOnNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryAddOnNonAuthenticatedEntity:
        """Test SellerInventoryAddOnNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryAddOnNonAuthenticatedEntity`
        """
        model = SellerInventoryAddOnNonAuthenticatedEntity()
        if include_optional:
            return SellerInventoryAddOnNonAuthenticatedEntity(
                inventory = wink_sdk_inventory.models.add_on_localized_inventory_with_hotel_best_price_non_authenticated_entity.AddOnLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
    ...
    def testSellerInventoryAddOnNonAuthenticatedEntity(self):
        """Test SellerInventoryAddOnNonAuthenticatedEntity"""
