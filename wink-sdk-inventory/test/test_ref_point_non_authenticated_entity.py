...
class TestRefPointNonAuthenticatedEntity(unittest.TestCase):
    """RefPointNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefPointNonAuthenticatedEntity:
        """Test RefPointNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefPointNonAuthenticatedEntity`
        """
        model = RefPointNonAuthenticatedEntity()
        if include_optional:
            return RefPointNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testRefPointNonAuthenticatedEntity(self):
        """Test RefPointNonAuthenticatedEntity"""
