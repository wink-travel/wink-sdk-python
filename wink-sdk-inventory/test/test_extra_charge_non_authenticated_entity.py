...
class TestExtraChargeNonAuthenticatedEntity(unittest.TestCase):
    """ExtraChargeNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargeNonAuthenticatedEntity:
        """Test ExtraChargeNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargeNonAuthenticatedEntity`
        """
        model = ExtraChargeNonAuthenticatedEntity()
        if include_optional:
            return ExtraChargeNonAuthenticatedEntity(
    ...
    def testExtraChargeNonAuthenticatedEntity(self):
        """Test ExtraChargeNonAuthenticatedEntity"""
