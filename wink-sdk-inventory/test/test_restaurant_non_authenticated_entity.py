...
class TestRestaurantNonAuthenticatedEntity(unittest.TestCase):
    """RestaurantNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantNonAuthenticatedEntity:
        """Test RestaurantNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantNonAuthenticatedEntity`
        """
        model = RestaurantNonAuthenticatedEntity()
        if include_optional:
            return RestaurantNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testRestaurantNonAuthenticatedEntity(self):
        """Test RestaurantNonAuthenticatedEntity"""
