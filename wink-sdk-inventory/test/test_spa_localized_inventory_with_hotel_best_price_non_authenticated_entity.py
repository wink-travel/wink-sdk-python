...
class TestSpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(unittest.TestCase):
    """SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity:
        """Test SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity`
        """
        model = SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity()
        if include_optional:
            return SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(
    ...
    def testSpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(self):
        """Test SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity"""
