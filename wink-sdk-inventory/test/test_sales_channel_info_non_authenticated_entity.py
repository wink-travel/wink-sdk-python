...
class TestSalesChannelInfoNonAuthenticatedEntity(unittest.TestCase):
    """SalesChannelInfoNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelInfoNonAuthenticatedEntity:
        """Test SalesChannelInfoNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelInfoNonAuthenticatedEntity`
        """
        model = SalesChannelInfoNonAuthenticatedEntity()
        if include_optional:
            return SalesChannelInfoNonAuthenticatedEntity(
                name = 'Kim Kardashian',
    ...
    def testSalesChannelInfoNonAuthenticatedEntity(self):
        """Test SalesChannelInfoNonAuthenticatedEntity"""
