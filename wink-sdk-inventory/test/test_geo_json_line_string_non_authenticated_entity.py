...
class TestGeoJsonLineStringNonAuthenticatedEntity(unittest.TestCase):
    """GeoJsonLineStringNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonLineStringNonAuthenticatedEntity:
        """Test GeoJsonLineStringNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonLineStringNonAuthenticatedEntity`
        """
        model = GeoJsonLineStringNonAuthenticatedEntity()
        if include_optional:
            return GeoJsonLineStringNonAuthenticatedEntity(
                type = '',
                coordinates = [
    ...
    def testGeoJsonLineStringNonAuthenticatedEntity(self):
        """Test GeoJsonLineStringNonAuthenticatedEntity"""
