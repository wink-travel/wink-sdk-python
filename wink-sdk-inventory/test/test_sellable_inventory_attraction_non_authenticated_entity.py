...
class TestSellableInventoryAttractionNonAuthenticatedEntity(unittest.TestCase):
    """SellableInventoryAttractionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableInventoryAttractionNonAuthenticatedEntity:
        """Test SellableInventoryAttractionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableInventoryAttractionNonAuthenticatedEntity`
        """
        model = SellableInventoryAttractionNonAuthenticatedEntity()
        if include_optional:
            return SellableInventoryAttractionNonAuthenticatedEntity(
                inventory = wink_sdk_inventory.models.attraction_localized_inventory_with_hotel_best_price_non_authenticated_entity.AttractionLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
    ...
    def testSellableInventoryAttractionNonAuthenticatedEntity(self):
        """Test SellableInventoryAttractionNonAuthenticatedEntity"""
