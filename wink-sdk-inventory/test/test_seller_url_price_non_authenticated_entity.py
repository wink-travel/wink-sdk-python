...
class TestSellerUrlPriceNonAuthenticatedEntity(unittest.TestCase):
    """SellerUrlPriceNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerUrlPriceNonAuthenticatedEntity:
        """Test SellerUrlPriceNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerUrlPriceNonAuthenticatedEntity`
        """
        model = SellerUrlPriceNonAuthenticatedEntity()
        if include_optional:
            return SellerUrlPriceNonAuthenticatedEntity(
    ...
    def testSellerUrlPriceNonAuthenticatedEntity(self):
        """Test SellerUrlPriceNonAuthenticatedEntity"""
