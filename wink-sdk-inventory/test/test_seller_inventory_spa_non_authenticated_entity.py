...
class TestSellerInventorySpaNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventorySpaNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventorySpaNonAuthenticatedEntity:
        """Test SellerInventorySpaNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventorySpaNonAuthenticatedEntity`
        """
        model = SellerInventorySpaNonAuthenticatedEntity()
        if include_optional:
    ...
    def testSellerInventorySpaNonAuthenticatedEntity(self):
        """Test SellerInventorySpaNonAuthenticatedEntity"""
