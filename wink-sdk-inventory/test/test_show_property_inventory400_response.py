...
class TestShowPropertyInventory400Response(unittest.TestCase):
    """ShowPropertyInventory400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowPropertyInventory400Response:
        """Test ShowPropertyInventory400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowPropertyInventory400Response`
        """
        model = ShowPropertyInventory400Response()
        if include_optional:
            return ShowPropertyInventory400Response(
                status = 56,
                error = '',
                message = '',
                timestamp = ''
    ...
    def testShowPropertyInventory400Response(self):
        """Test ShowPropertyInventory400Response"""
