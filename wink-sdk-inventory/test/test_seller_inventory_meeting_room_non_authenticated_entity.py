...
class TestSellerInventoryMeetingRoomNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryMeetingRoomNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryMeetingRoomNonAuthenticatedEntity:
        """Test SellerInventoryMeetingRoomNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryMeetingRoomNonAuthenticatedEntity`
        """
        model = SellerInventoryMeetingRoomNonAuthenticatedEntity()
        if include_optional:
    ...
    def testSellerInventoryMeetingRoomNonAuthenticatedEntity(self):
        """Test SellerInventoryMeetingRoomNonAuthenticatedEntity"""
