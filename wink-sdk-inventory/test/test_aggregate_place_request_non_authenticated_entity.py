...
class TestAggregatePlaceRequestNonAuthenticatedEntity(unittest.TestCase):
    """AggregatePlaceRequestNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregatePlaceRequestNonAuthenticatedEntity:
        """Test AggregatePlaceRequestNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregatePlaceRequestNonAuthenticatedEntity`
        """
        model = AggregatePlaceRequestNonAuthenticatedEntity()
        if include_optional:
            return AggregatePlaceRequestNonAuthenticatedEntity(
                identifier = '',
    ...
    def testAggregatePlaceRequestNonAuthenticatedEntity(self):
        """Test AggregatePlaceRequestNonAuthenticatedEntity"""
