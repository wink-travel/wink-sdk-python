...
class TestRestaurantLightweightNonAuthenticatedEntity(unittest.TestCase):
    """RestaurantLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantLightweightNonAuthenticatedEntity:
        """Test RestaurantLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantLightweightNonAuthenticatedEntity`
        """
        model = RestaurantLightweightNonAuthenticatedEntity()
        if include_optional:
            return RestaurantLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testRestaurantLightweightNonAuthenticatedEntity(self):
        """Test RestaurantLightweightNonAuthenticatedEntity"""
