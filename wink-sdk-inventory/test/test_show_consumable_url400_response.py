...
class TestShowConsumableUrl400Response(unittest.TestCase):
    """ShowConsumableUrl400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowConsumableUrl400Response:
        """Test ShowConsumableUrl400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowConsumableUrl400Response`
        """
        model = ShowConsumableUrl400Response()
        if include_optional:
            return ShowConsumableUrl400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowConsumableUrl400Response(self):
        """Test ShowConsumableUrl400Response"""
