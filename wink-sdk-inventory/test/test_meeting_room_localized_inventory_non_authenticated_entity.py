...
class TestMeetingRoomLocalizedInventoryNonAuthenticatedEntity(unittest.TestCase):
    """MeetingRoomLocalizedInventoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeetingRoomLocalizedInventoryNonAuthenticatedEntity:
        """Test MeetingRoomLocalizedInventoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeetingRoomLocalizedInventoryNonAuthenticatedEntity`
        """
        model = MeetingRoomLocalizedInventoryNonAuthenticatedEntity()
        if include_optional:
            return MeetingRoomLocalizedInventoryNonAuthenticatedEntity(
    ...
    def testMeetingRoomLocalizedInventoryNonAuthenticatedEntity(self):
        """Test MeetingRoomLocalizedInventoryNonAuthenticatedEntity"""
