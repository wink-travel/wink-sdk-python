...
class TestUserReviewNonAuthenticatedEntity(unittest.TestCase):
    """UserReviewNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserReviewNonAuthenticatedEntity:
        """Test UserReviewNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserReviewNonAuthenticatedEntity`
        """
        model = UserReviewNonAuthenticatedEntity()
        if include_optional:
            return UserReviewNonAuthenticatedEntity(
                review_by = '',
    ...
    def testUserReviewNonAuthenticatedEntity(self):
        """Test UserReviewNonAuthenticatedEntity"""
