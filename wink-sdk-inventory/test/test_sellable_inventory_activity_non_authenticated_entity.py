...
class TestSellableInventoryActivityNonAuthenticatedEntity(unittest.TestCase):
    """SellableInventoryActivityNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableInventoryActivityNonAuthenticatedEntity:
        """Test SellableInventoryActivityNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableInventoryActivityNonAuthenticatedEntity`
        """
        model = SellableInventoryActivityNonAuthenticatedEntity()
        if include_optional:
            return SellableInventoryActivityNonAuthenticatedEntity(
                inventory = wink_sdk_inventory.models.activity_localized_inventory_with_hotel_best_price_non_authenticated_entity.ActivityLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
    ...
    def testSellableInventoryActivityNonAuthenticatedEntity(self):
        """Test SellableInventoryActivityNonAuthenticatedEntity"""
