...
class TestExtraChargesNonAuthenticatedEntity(unittest.TestCase):
    """ExtraChargesNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtraChargesNonAuthenticatedEntity:
        """Test ExtraChargesNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtraChargesNonAuthenticatedEntity`
        """
        model = ExtraChargesNonAuthenticatedEntity()
        if include_optional:
            return ExtraChargesNonAuthenticatedEntity(
                items = [
    ...
    def testExtraChargesNonAuthenticatedEntity(self):
        """Test ExtraChargesNonAuthenticatedEntity"""
