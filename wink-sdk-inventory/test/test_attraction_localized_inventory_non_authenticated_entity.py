...
class TestAttractionLocalizedInventoryNonAuthenticatedEntity(unittest.TestCase):
    """AttractionLocalizedInventoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttractionLocalizedInventoryNonAuthenticatedEntity:
        """Test AttractionLocalizedInventoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttractionLocalizedInventoryNonAuthenticatedEntity`
        """
        model = AttractionLocalizedInventoryNonAuthenticatedEntity()
        if include_optional:
            return AttractionLocalizedInventoryNonAuthenticatedEntity(
    ...
    def testAttractionLocalizedInventoryNonAuthenticatedEntity(self):
        """Test AttractionLocalizedInventoryNonAuthenticatedEntity"""
