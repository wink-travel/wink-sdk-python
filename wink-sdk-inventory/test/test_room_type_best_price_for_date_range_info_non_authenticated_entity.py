...
class TestRoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity(unittest.TestCase):
    """RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity:
        """Test RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity`
        """
        model = RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity()
        if include_optional:
            return RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity(
    ...
    def testRoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity(self):
        """Test RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity"""
