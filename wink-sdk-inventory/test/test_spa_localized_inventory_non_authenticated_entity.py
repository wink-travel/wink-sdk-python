...
class TestSpaLocalizedInventoryNonAuthenticatedEntity(unittest.TestCase):
    """SpaLocalizedInventoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaLocalizedInventoryNonAuthenticatedEntity:
        """Test SpaLocalizedInventoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaLocalizedInventoryNonAuthenticatedEntity`
        """
        model = SpaLocalizedInventoryNonAuthenticatedEntity()
        if include_optional:
            return SpaLocalizedInventoryNonAuthenticatedEntity(
    ...
    def testSpaLocalizedInventoryNonAuthenticatedEntity(self):
        """Test SpaLocalizedInventoryNonAuthenticatedEntity"""
