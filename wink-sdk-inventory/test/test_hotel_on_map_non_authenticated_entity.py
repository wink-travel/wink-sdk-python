...
class TestHotelOnMapNonAuthenticatedEntity(unittest.TestCase):
    """HotelOnMapNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelOnMapNonAuthenticatedEntity:
        """Test HotelOnMapNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelOnMapNonAuthenticatedEntity`
        """
        model = HotelOnMapNonAuthenticatedEntity()
        if include_optional:
            return HotelOnMapNonAuthenticatedEntity(
    ...
    def testHotelOnMapNonAuthenticatedEntity(self):
        """Test HotelOnMapNonAuthenticatedEntity"""
