...
class TestAggregateAddOnRequestNonAuthenticatedEntity(unittest.TestCase):
    """AggregateAddOnRequestNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateAddOnRequestNonAuthenticatedEntity:
        """Test AggregateAddOnRequestNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateAddOnRequestNonAuthenticatedEntity`
        """
        model = AggregateAddOnRequestNonAuthenticatedEntity()
        if include_optional:
            return AggregateAddOnRequestNonAuthenticatedEntity(
                identifier = '',
    ...
    def testAggregateAddOnRequestNonAuthenticatedEntity(self):
        """Test AggregateAddOnRequestNonAuthenticatedEntity"""
