...
class TestSpaLightweightNonAuthenticatedEntity(unittest.TestCase):
    """SpaLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaLightweightNonAuthenticatedEntity:
        """Test SpaLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaLightweightNonAuthenticatedEntity`
        """
        model = SpaLightweightNonAuthenticatedEntity()
        if include_optional:
            return SpaLightweightNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
                featured_ind = False,
    ...
    def testSpaLightweightNonAuthenticatedEntity(self):
        """Test SpaLightweightNonAuthenticatedEntity"""
