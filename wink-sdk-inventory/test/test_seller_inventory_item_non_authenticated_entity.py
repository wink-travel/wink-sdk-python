...
class TestSellerInventoryItemNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryItemNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryItemNonAuthenticatedEntity:
        """Test SellerInventoryItemNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryItemNonAuthenticatedEntity`
        """
        model = SellerInventoryItemNonAuthenticatedEntity()
        if include_optional:
            return SellerInventoryItemNonAuthenticatedEntity(
                identifier = '',
                seller_identifier = '',
    ...
    def testSellerInventoryItemNonAuthenticatedEntity(self):
        """Test SellerInventoryItemNonAuthenticatedEntity"""
