...
class TestSellableListResponseNonAuthenticatedEntity(unittest.TestCase):
    """SellableListResponseNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableListResponseNonAuthenticatedEntity:
        """Test SellableListResponseNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableListResponseNonAuthenticatedEntity`
        """
        model = SellableListResponseNonAuthenticatedEntity()
        if include_optional:
            return SellableListResponseNonAuthenticatedEntity(
                page = wink_sdk_inventory.models.page_inventory_grid_item_non_authenticated_entity.PageInventoryGridItem_Non_Authenticated_Entity(
                    ...
                    last = True, 
                    empty = True, ),
                list = wink_sdk_inventory.models.sellable_list_lightweight_non_authenticated_entity.SellableListLightweight_Non_Authenticated_Entity(
                    identifier = 'grid-1', 
                    seller_identifier = 'company-1', 
                    name = 'My list', 
    ...
    def testSellableListResponseNonAuthenticatedEntity(self):
        """Test SellableListResponseNonAuthenticatedEntity"""
