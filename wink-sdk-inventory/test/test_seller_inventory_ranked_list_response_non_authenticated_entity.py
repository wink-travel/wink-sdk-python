...
class TestSellerInventoryRankedListResponseNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryRankedListResponseNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryRankedListResponseNonAuthenticatedEntity:
        """Test SellerInventoryRankedListResponseNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryRankedListResponseNonAuthenticatedEntity`
        """
        model = SellerInventoryRankedListResponseNonAuthenticatedEntity()
        if include_optional:
            return SellerInventoryRankedListResponseNonAuthenticatedEntity(
                inventory_page = wink_sdk_inventory.models.page_inventory_grid_item_non_authenticated_entity.PageInventoryGridItem_Non_Authenticated_Entity(
                    total_elements = 56, 
                    total_pages = 56, 
                    size = 56, 
                    content = [
                        wink_sdk_inventory.models.inventory_grid_item_non_authenticated_entity.InventoryGridItem_Non_Authenticated_Entity(
                            ...
                            place = wink_sdk_inventory.models.place_localized_inventory_with_hotel_best_price_non_authenticated_entity.PlaceLocalizedInventoryWithHotelBestPrice_Non_Authenticated_Entity(
                                sort = 1, ), 
                            room_type = wink_sdk_inventory.models.hotel_with_best_price_non_authenticated_entity.HotelWithBestPrice_Non_Authenticated_Entity(
                                hotel = wink_sdk_inventory.models.hotel_on_map_non_authenticated_entity.HotelOnMap_Non_Authenticated_Entity(
                                    identifier = 'document-1', 
                                    hotel_identifier = '', 
                                    name = 'The Loveliest Hotel', 
                    ...
                    number = 56, 
                    sort = [
                        wink_sdk_inventory.models.sort_object.SortObject(
                            direction = '', 
                            null_handling = '', 
                            ascending = True, 
                            property = '', 
                    ...
                    last = True, 
                    empty = True, ),
                configuration = wink_sdk_inventory.models.seller_inventory_ranked_list_non_authenticated_entity.SellerInventoryRankedList_Non_Authenticated_Entity(
                    identifier = '', 
                    seller_identifier = '', 
                    seller_inventory_ranked_list_name = 'My ranked list', 
                    ...
                    status = 'ACTIVE', 
                    lookup = wink_sdk_inventory.models.lookup_non_authenticated_entity.Lookup_Non_Authenticated_Entity(
                        identifier = '', 
                        type = 'CITY', 
                        type_identifier = '', 
    ...
    def testSellerInventoryRankedListResponseNonAuthenticatedEntity(self):
        """Test SellerInventoryRankedListResponseNonAuthenticatedEntity"""
