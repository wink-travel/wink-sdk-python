...
class TestOauth2ShowConsumableUrl400Response(unittest.TestCase):
    """Oauth2ShowConsumableUrl400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Oauth2ShowConsumableUrl400Response:
        """Test Oauth2ShowConsumableUrl400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Oauth2ShowConsumableUrl400Response`
        """
        model = Oauth2ShowConsumableUrl400Response()
        if include_optional:
            return Oauth2ShowConsumableUrl400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testOauth2ShowConsumableUrl400Response(self):
        """Test Oauth2ShowConsumableUrl400Response"""
