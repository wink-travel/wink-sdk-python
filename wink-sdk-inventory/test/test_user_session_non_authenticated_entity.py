...
class TestUserSessionNonAuthenticatedEntity(unittest.TestCase):
    """UserSessionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserSessionNonAuthenticatedEntity:
        """Test UserSessionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSessionNonAuthenticatedEntity`
        """
        model = UserSessionNonAuthenticatedEntity()
        if include_optional:
            return UserSessionNonAuthenticatedEntity(
    ...
    def testUserSessionNonAuthenticatedEntity(self):
        """Test UserSessionNonAuthenticatedEntity"""
