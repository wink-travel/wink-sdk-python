...
class TestActivityLocalizedInventoryNonAuthenticatedEntity(unittest.TestCase):
    """ActivityLocalizedInventoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityLocalizedInventoryNonAuthenticatedEntity:
        """Test ActivityLocalizedInventoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityLocalizedInventoryNonAuthenticatedEntity`
        """
        model = ActivityLocalizedInventoryNonAuthenticatedEntity()
        if include_optional:
            return ActivityLocalizedInventoryNonAuthenticatedEntity(
    ...
    def testActivityLocalizedInventoryNonAuthenticatedEntity(self):
        """Test ActivityLocalizedInventoryNonAuthenticatedEntity"""
