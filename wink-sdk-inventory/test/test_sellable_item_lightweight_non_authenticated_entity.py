...
class TestSellableItemLightweightNonAuthenticatedEntity(unittest.TestCase):
    """SellableItemLightweightNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableItemLightweightNonAuthenticatedEntity:
        """Test SellableItemLightweightNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableItemLightweightNonAuthenticatedEntity`
        """
        model = SellableItemLightweightNonAuthenticatedEntity()
        if include_optional:
            return SellableItemLightweightNonAuthenticatedEntity(
                identifier = 'seller-blocking-1',
                owner_identifier = 'company-1',
                name = 'My fave travel blocking',
    ...
    def testSellableItemLightweightNonAuthenticatedEntity(self):
        """Test SellableItemLightweightNonAuthenticatedEntity"""
