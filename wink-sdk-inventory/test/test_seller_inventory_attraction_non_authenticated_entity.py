...
class TestSellerInventoryAttractionNonAuthenticatedEntity(unittest.TestCase):
    """SellerInventoryAttractionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryAttractionNonAuthenticatedEntity:
        """Test SellerInventoryAttractionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryAttractionNonAuthenticatedEntity`
        """
        model = SellerInventoryAttractionNonAuthenticatedEntity()
        if include_optional:
    ...
    def testSellerInventoryAttractionNonAuthenticatedEntity(self):
        """Test SellerInventoryAttractionNonAuthenticatedEntity"""
