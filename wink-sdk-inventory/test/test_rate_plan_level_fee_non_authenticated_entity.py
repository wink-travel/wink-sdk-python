...
class TestRatePlanLevelFeeNonAuthenticatedEntity(unittest.TestCase):
    """RatePlanLevelFeeNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatePlanLevelFeeNonAuthenticatedEntity:
        """Test RatePlanLevelFeeNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatePlanLevelFeeNonAuthenticatedEntity`
        """
        model = RatePlanLevelFeeNonAuthenticatedEntity()
        if include_optional:
            return RatePlanLevelFeeNonAuthenticatedEntity(
                descriptions = [
    ...
    def testRatePlanLevelFeeNonAuthenticatedEntity(self):
        """Test RatePlanLevelFeeNonAuthenticatedEntity"""
