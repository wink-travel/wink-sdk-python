...
class TestAnnouncementNonAuthenticatedEntity(unittest.TestCase):
    """AnnouncementNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnnouncementNonAuthenticatedEntity:
        """Test AnnouncementNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnnouncementNonAuthenticatedEntity`
        """
        model = AnnouncementNonAuthenticatedEntity()
        if include_optional:
            return AnnouncementNonAuthenticatedEntity(
                identifier = '',
                hotel_identifier = '',
    ...
    def testAnnouncementNonAuthenticatedEntity(self):
        """Test AnnouncementNonAuthenticatedEntity"""
