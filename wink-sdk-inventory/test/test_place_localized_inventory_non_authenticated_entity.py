...
class TestPlaceLocalizedInventoryNonAuthenticatedEntity(unittest.TestCase):
    """PlaceLocalizedInventoryNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaceLocalizedInventoryNonAuthenticatedEntity:
        """Test PlaceLocalizedInventoryNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceLocalizedInventoryNonAuthenticatedEntity`
        """
        model = PlaceLocalizedInventoryNonAuthenticatedEntity()
        if include_optional:
            return PlaceLocalizedInventoryNonAuthenticatedEntity(
    ...
    def testPlaceLocalizedInventoryNonAuthenticatedEntity(self):
        """Test PlaceLocalizedInventoryNonAuthenticatedEntity"""
