...
class TestSellableInventoryGuestRoomNonAuthenticatedEntity(unittest.TestCase):
    """SellableInventoryGuestRoomNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableInventoryGuestRoomNonAuthenticatedEntity:
        """Test SellableInventoryGuestRoomNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableInventoryGuestRoomNonAuthenticatedEntity`
        """
        model = SellableInventoryGuestRoomNonAuthenticatedEntity()
        if include_optional:
            return SellableInventoryGuestRoomNonAuthenticatedEntity(
                inventory = wink_sdk_inventory.models.property_with_best_price_non_authenticated_entity.PropertyWithBestPrice_Non_Authenticated_Entity(
    ...
    def testSellableInventoryGuestRoomNonAuthenticatedEntity(self):
        """Test SellableInventoryGuestRoomNonAuthenticatedEntity"""
