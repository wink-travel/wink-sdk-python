...
class TestConfigurableGeoJsonCircleNonAuthenticatedEntity(unittest.TestCase):
    """ConfigurableGeoJsonCircleNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurableGeoJsonCircleNonAuthenticatedEntity:
        """Test ConfigurableGeoJsonCircleNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurableGeoJsonCircleNonAuthenticatedEntity`
        """
        model = ConfigurableGeoJsonCircleNonAuthenticatedEntity()
        if include_optional:
            return ConfigurableGeoJsonCircleNonAuthenticatedEntity(
                radius = 2.5,
    ...
    def testConfigurableGeoJsonCircleNonAuthenticatedEntity(self):
        """Test ConfigurableGeoJsonCircleNonAuthenticatedEntity"""
