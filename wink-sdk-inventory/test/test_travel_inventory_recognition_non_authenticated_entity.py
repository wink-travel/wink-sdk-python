...
class TestTravelInventoryRecognitionNonAuthenticatedEntity(unittest.TestCase):
    """TravelInventoryRecognitionNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelInventoryRecognitionNonAuthenticatedEntity:
        """Test TravelInventoryRecognitionNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelInventoryRecognitionNonAuthenticatedEntity`
        """
        model = TravelInventoryRecognitionNonAuthenticatedEntity()
        if include_optional:
            return TravelInventoryRecognitionNonAuthenticatedEntity(
                identifier = '',
                category = 'AWARD',
                type = 'PERCENT_RATING',
                provider = 'Michelin',
                rating = 8.5,
                max_rating = 10,
                var_date = 'Sat Oct 24 07:00:00 ICT 2020',
    ...
    def testTravelInventoryRecognitionNonAuthenticatedEntity(self):
        """Test TravelInventoryRecognitionNonAuthenticatedEntity"""
