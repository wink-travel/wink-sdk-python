...
class ShareableLinkApi:
    ...
    @validate_call
    def oauth2_show_consumable_url(
        self,
        ...
        cid: Annotated[Optional[StrictStr], Field(description="Optional campaign id")] = None,
        gl: Annotated[Optional[StrictStr], Field(description="Optional GA4 cross-site link id")] = None,
        ...
        _param = self._oauth2_show_consumable_url_serialize(
            code=code,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "ConsumableSellerUrlNonAuthenticatedEntity",
        }
    ...
    @validate_call
    def oauth2_show_consumable_url_with_http_info(
        self,
        code: Annotated[StrictStr, Field(description="Unique link code")],
        user_session_non_authenticated_entity: UserSessionNonAuthenticatedEntity,
        cid: Annotated[Optional[StrictStr], Field(description="Optional campaign id")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConsumableSellerUrlNonAuthenticatedEntity]:
        """Show Shareable Link (OAuth2)
    ...
    @validate_call
    def oauth2_show_consumable_url_without_preload_content(
        self,
        code: Annotated[StrictStr, Field(description="Unique link code")],
        user_session_non_authenticated_entity: UserSessionNonAuthenticatedEntity,
        cid: Annotated[Optional[StrictStr], Field(description="Optional campaign id")] = None,
    ...
    def _oauth2_show_consumable_url_serialize(
        self,
        code,
    ...
    def _show_consumable_url_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/sell/{companyIdentifier}/shareable-link/{code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
