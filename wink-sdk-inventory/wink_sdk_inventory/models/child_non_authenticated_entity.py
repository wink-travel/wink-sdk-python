...
class ChildNonAuthenticatedEntity(BaseModel):
    """
    BookingItineraryRoomConfigurationChild configuration
    """ # noqa: E501
    quantity: Annotated[int, Field(strict=True, ge=1)] = Field(description="Number of children")
    age: Annotated[int, Field(strict=True, ge=0)] = Field(description="Age of children")
    __properties: ClassVar[List[str]] = ["quantity", "age"]
