...
class SellerInventoryMeetingRoomNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    inventory: Optional[MeetingRoomLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity] = None
    configuration: Optional[SellerInventoryItemNonAuthenticatedEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configuration": SellerInventoryItemNonAuthenticatedEntity.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
