...
class SellerInventoryAddOnNonAuthenticatedEntity(BaseModel):
    """
    SellerInventoryAddOnNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the priced add-on record.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
