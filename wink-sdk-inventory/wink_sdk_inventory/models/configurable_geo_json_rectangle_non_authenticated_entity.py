...
class ConfigurableGeoJsonRectangleNonAuthenticatedEntity(BaseModel):
    """
    A way to persist a GeoJSON rectangle
    """ # noqa: E501
    rectangle: GeoJsonRectangleNonAuthenticatedEntity
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rectangle": GeoJsonRectangleNonAuthenticatedEntity.from_dict(obj["rectangle"]) if obj.get("rectangle") is not None else None
        })
        return _obj
