...
class PropertyAggregateGreenIndexAnswerNonAuthenticatedEntity(BaseModel):
    """
    PropertyAggregateGreenIndexAnswerNonAuthenticatedEntity
    """ # noqa: E501
    question_key: Optional[StrictStr] = Field(default=None, alias="questionKey")
    value: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["questionKey", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "questionKey": obj.get("questionKey"),
            "value": obj.get("value")
        })
        return _obj
