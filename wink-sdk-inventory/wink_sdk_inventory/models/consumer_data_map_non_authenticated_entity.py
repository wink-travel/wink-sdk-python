...
class ConsumerDataMapNonAuthenticatedEntity(BaseModel):
    """
    ConsumerDataMapNonAuthenticatedEntity
    """ # noqa: E501
    configuration: Optional[AdvancedMapConfigurationNonAuthenticatedEntity] = None
    markers: Optional[List[InventoryMapMarkerNonAuthenticatedEntity]] = None
    __properties: ClassVar[List[str]] = ["configuration", "markers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": AdvancedMapConfigurationNonAuthenticatedEntity.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
            "markers": [InventoryMapMarkerNonAuthenticatedEntity.from_dict(_item) for _item in obj["markers"]] if obj.get("markers") is not None else None
        })
        return _obj
