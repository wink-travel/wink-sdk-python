...
class ConsumerDataMapNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    map: InventoryMapLightweightNonAuthenticatedEntity
    markers: List[InventoryMapMarkerNonAuthenticatedEntity]
    __properties: ClassVar[List[str]] = ["map", "markers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "map": InventoryMapLightweightNonAuthenticatedEntity.from_dict(obj["map"]) if obj.get("map") is not None else None,
