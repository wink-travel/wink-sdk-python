...
class ActivityLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    """
    ActivityLocalizedInventoryNonAuthenticatedEntity
    """ # noqa: E501
    activity: Optional[ActivityLightweightNonAuthenticatedEntity] = Field(default=None, description="Inventory data object")
    ...
    __properties: ClassVar[List[str]] = ["activity", "list", "channelInventoryIdentifier", "commissionable", "commission", "direct", "priceList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": ActivityLightweightNonAuthenticatedEntity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
