...
class ActivityLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    activity: Optional[RecreationNonAuthenticatedEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": RecreationNonAuthenticatedEntity.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
