...
class PropertyAggregateLightweightNonAuthenticatedEntity(BaseModel):
    """
    ...
    location: Optional[GeoJsonPointNonAuthenticatedEntity] = Field(default=None, description="Geo-location")
    descriptions: Optional[List[SimpleDescriptionNonAuthenticatedEntity]] = Field(default=None, description="Short and long welcome text")
    ...
    reservations: Optional[ContactNonAuthenticatedEntity] = Field(default=None, description="Contact details for reservations desk")
    ...
    policy: Optional[PropertyPolicyNonAuthenticatedEntity] = Field(default=None, description="Basic property policy record.")
    ...
    address: Optional[SimpleAddressNonAuthenticatedEntity] = Field(default=None, description="Property address.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reservations": ContactNonAuthenticatedEntity.from_dict(obj["reservations"]) if obj.get("reservations") is not None else None,
