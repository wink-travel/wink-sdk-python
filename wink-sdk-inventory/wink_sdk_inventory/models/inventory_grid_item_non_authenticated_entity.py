...
class InventoryGridItemNonAuthenticatedEntity(BaseModel):
    ...
    identifier: StrictStr = Field(description="Unique inventory identifier")
    supplier_identifier: StrictStr = Field(description="Supplier identifier referencing inventory owner", alias="supplierIdentifier")
