...
class RoomConfigurationPriceRatePlanNonAuthenticatedEntity(BaseModel):
    """
    ...
    cancellation_policy: Optional[CancellationPolicyLightweightNonAuthenticatedEntity] = Field(default=None, description="The cancellation policy for this rate plan.", alias="cancellationPolicy")
    cancellation_policy_exceptions: Optional[CancellationPolicyExceptionsNonAuthenticatedEntity] = Field(default=None, description="Allows a property to dynamically use another cancellation policy for a specific date range", alias="cancellationPolicyExceptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cancellationPolicy": CancellationPolicyLightweightNonAuthenticatedEntity.from_dict(obj["cancellationPolicy"]) if obj.get("cancellationPolicy") is not None else None,
