...
class SimpleAddressNonAuthenticatedEntity(BaseModel):
    ...
    country_code: StrictStr = Field(description="Country", alias="countryCode")
    ...
    __properties: ClassVar[List[str]] = ["address1", "address2", "state", "postalCode", "county", "city", "countryCode", "fullAddress"]
