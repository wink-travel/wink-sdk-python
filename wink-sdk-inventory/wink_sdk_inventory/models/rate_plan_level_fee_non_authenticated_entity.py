...
class RatePlanLevelFeeNonAuthenticatedEntity(BaseModel):
    """
    RatePlanLevelFeeNonAuthenticatedEntity
    """ # noqa: E501
    descriptions: Annotated[List[LocalizedDescriptionNonAuthenticatedEntity], Field(min_length=1)] = Field(description="List of localized descriptions for this fee.")
    fixed_amount: CustomMonetaryAmount = Field(description="Rate plan level fixed fee amount in property currency", alias="fixedAmount")
