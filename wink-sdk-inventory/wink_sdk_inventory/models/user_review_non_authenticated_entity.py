...
class UserReviewNonAuthenticatedEntity(BaseModel):
    """
    UserReviewNonAuthenticatedEntity
    """ # noqa: E501
    review_by: Optional[StrictStr] = Field(default=None, description="User details of creator of booking.", alias="reviewBy")
    reviewed_on: Optional[datetime] = Field(default=None, description="Date of review.", alias="reviewedOn")
    ...
    answers: Optional[List[UserReviewAnswerNonAuthenticatedEntity]] = Field(default=None, description="List of reviewBy review answers.")
    ...
    review: Optional[StrictStr] = Field(default=None, description="Free text record created by traveler")
    likes: Optional[StrictInt] = Field(default=None, description="List of member identifiers who liked the reviewual review")
    __properties: ClassVar[List[str]] = ["reviewBy", "reviewedOn", "averageScore", "answers", "responseFromHotel", "imageIdentifier", "review", "likes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reviewBy": obj.get("reviewBy"),
            "reviewedOn": obj.get("reviewedOn"),
            "averageScore": obj.get("averageScore"),
            "answers": [UserReviewAnswerNonAuthenticatedEntity.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None,
