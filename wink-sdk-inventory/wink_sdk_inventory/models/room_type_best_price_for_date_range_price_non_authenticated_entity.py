...
class RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity(BaseModel):
    """
    RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity
    """ # noqa: E501
    user_specified_currency_total: Optional[CustomMonetaryAmount] = Field(default=None, description="Total amount with any extra charges included", alias="userSpecifiedCurrencyTotal")
    source_total: Optional[CustomMonetaryAmount] = Field(default=None, description="Source total amount with any extra charges included", alias="sourceTotal")
    __properties: ClassVar[List[str]] = ["userSpecifiedCurrencyTotal", "sourceTotal"]
