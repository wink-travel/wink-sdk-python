...
class RoomConfigurationPriceNonAuthenticatedEntity(BaseModel):
    ...
    rate_plan: RoomConfigurationPriceRatePlanNonAuthenticatedEntity = Field(description="Specified rate plan", alias="ratePlan")
    perk_types: Optional[List[PerkLightweightNonAuthenticatedEntity]] = Field(default=None, alias="perkTypes")
    price: StayRateNonAuthenticatedEntity = Field(description="Calculated price")
    extra_charges: Optional[ExtraChargesNonAuthenticatedEntity] = Field(default=None, description="Per rate plan level extra charges with localized prices", alias="extraCharges")
    configuration: RoomConfigurationNonAuthenticatedEntity = Field(description="The selected room configuration that created this record")
    ...
    active_cancellation_policy: CancellationPolicyLightweightNonAuthenticatedEntity = Field(description="The active / selected cancellation policy for this room configuration", alias="activeCancellationPolicy")
    ...
    __properties: ClassVar[List[str]] = ["channelInventoryIdentifier", "list", "commissionable", "commission", "direct", "adults", "children", "startDate", "endDate", "roomRateIdentifier", "roomRateInternalName", "ratePlan", "perkTypes", "price", "extraCharges", "configuration", "addOnOffers", "perkValue", "activeCancellationPolicy", "roomNights", "priceList", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "rateSource", "available"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ratePlan": RoomConfigurationPriceRatePlanNonAuthenticatedEntity.from_dict(obj["ratePlan"]) if obj.get("ratePlan") is not None else None,
            "perkTypes": [PerkLightweightNonAuthenticatedEntity.from_dict(_item) for _item in obj["perkTypes"]] if obj.get("perkTypes") is not None else None,
            ...
            "activeCancellationPolicy": CancellationPolicyLightweightNonAuthenticatedEntity.from_dict(obj["activeCancellationPolicy"]) if obj.get("activeCancellationPolicy") is not None else None,
