...
class RoomTypeBestPriceNonAuthenticatedEntity(BaseModel):
    """
    RoomTypeBestPriceNonAuthenticatedEntity
    """ # noqa: E501
    room_type_identifier: UUID = Field(description="Room type identifier.", alias="roomTypeIdentifier")
    price: RoomConfigurationPriceNonAuthenticatedEntity = Field(description="Price details for this room type configuration.")
    perk_value: StrictInt = Field(description="The sum of all perks the master rate had made available.", alias="perkValue")
    available: StrictBool = Field(description="Whether this room type is available with this configuration")
    sort: StrictInt = Field(description="When this room type is displayed in conjunction with many others, this sort property will often times be populated to indicate how the room types should be sorted and displayed.")
    __properties: ClassVar[List[str]] = ["roomTypeIdentifier", "price", "perkValue", "available", "sort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": RoomConfigurationPriceNonAuthenticatedEntity.from_dict(obj["price"]) if obj.get("price") is not None else None,
