...
class PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(BaseModel):
    """
    PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
    """ # noqa: E501
    inventory_with_price: Optional[PlaceLocalizedInventoryNonAuthenticatedEntity] = Field(default=None, description="Place details", alias="inventoryWithPrice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventoryWithPrice": PlaceLocalizedInventoryNonAuthenticatedEntity.from_dict(obj["inventoryWithPrice"]) if obj.get("inventoryWithPrice") is not None else None,
