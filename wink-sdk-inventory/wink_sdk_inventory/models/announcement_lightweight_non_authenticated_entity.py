...
class AnnouncementLightweightNonAuthenticatedEntity(BaseModel):
    """
    AnnouncementLightweightNonAuthenticatedEntity
    """ # noqa: E501
    start_date: Optional[date] = Field(default=None, description="Start date for when announcement is valid", alias="startDate")
    end_date: Optional[date] = Field(default=None, description="End date for when announcement is no longer valid", alias="endDate")
    descriptions: Annotated[List[SimpleDescriptionNonAuthenticatedEntity], Field(min_length=1, max_length=2147483647)] = Field(description="List of all localized announcements.")
    show_title: Optional[StrictBool] = Field(default=False, description="When enabled, the property does not want the title to be displayed", alias="showTitle")
    show_always: Optional[StrictBool] = Field(default=False, description="When enabled, the property wants this announcement always to be displayed", alias="showAlways")
    __properties: ClassVar[List[str]] = ["startDate", "endDate", "descriptions", "showTitle", "showAlways"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "showTitle": obj.get("showTitle") if obj.get("showTitle") is not None else False,
            "showAlways": obj.get("showAlways") if obj.get("showAlways") is not None else False
        })
        return _obj
