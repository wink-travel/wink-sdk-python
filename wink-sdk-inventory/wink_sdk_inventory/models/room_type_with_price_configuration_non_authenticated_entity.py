...
class RoomTypeWithPriceConfigurationNonAuthenticatedEntity(BaseModel):
    """
    ...
    price: Optional[RoomConfigurationPriceNonAuthenticatedEntity] = Field(default=None, description="Price if available")
    available: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["room", "price", "available"]
