...
class RatePlanNonAuthenticatedEntity(BaseModel):
    """
    ...
    available_days_of_week: Optional[DowPatternGroupNonAuthenticatedEntity] = Field(default=None, alias="availableDaysOfWeek")
    arrival_days_of_week: Optional[DowPatternGroupNonAuthenticatedEntity] = Field(default=None, alias="arrivalDaysOfWeek")
    departure_days_of_week: Optional[DowPatternGroupNonAuthenticatedEntity] = Field(default=None, alias="departureDaysOfWeek")
    required_days_of_week: Optional[DowPatternGroupNonAuthenticatedEntity] = Field(default=None, alias="requiredDaysOfWeek")
    ...
    cancellation_policy: Optional[CancellationPolicyNonAuthenticatedEntity] = Field(default=None, alias="cancellationPolicy")
    cancellation_policy_exceptions: Optional[CancellationPolicyExceptionsNonAuthenticatedEntity] = Field(default=None, alias="cancellationPolicyExceptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "availableDaysOfWeek": DowPatternGroupNonAuthenticatedEntity.from_dict(obj["availableDaysOfWeek"]) if obj.get("availableDaysOfWeek") is not None else None,
            "arrivalDaysOfWeek": DowPatternGroupNonAuthenticatedEntity.from_dict(obj["arrivalDaysOfWeek"]) if obj.get("arrivalDaysOfWeek") is not None else None,
            "departureDaysOfWeek": DowPatternGroupNonAuthenticatedEntity.from_dict(obj["departureDaysOfWeek"]) if obj.get("departureDaysOfWeek") is not None else None,
            "requiredDaysOfWeek": DowPatternGroupNonAuthenticatedEntity.from_dict(obj["requiredDaysOfWeek"]) if obj.get("requiredDaysOfWeek") is not None else None,
            ...
            "cancellationPolicy": CancellationPolicyNonAuthenticatedEntity.from_dict(obj["cancellationPolicy"]) if obj.get("cancellationPolicy") is not None else None,
            "cancellationPolicyExceptions": CancellationPolicyExceptionsNonAuthenticatedEntity.from_dict(obj["cancellationPolicyExceptions"]) if obj.get("cancellationPolicyExceptions") is not None else None
        })
        return _obj
