...
class SellableRankedListResponseNonAuthenticatedEntity(BaseModel):
    """
    SellableRankedListResponseNonAuthenticatedEntity
    """ # noqa: E501
    page: Optional[PageInventoryGridItemNonAuthenticatedEntity] = Field(default=None, description="Property details along with the grid record.")
    list: Optional[SellableRankedListLightweightNonAuthenticatedEntity] = Field(default=None, description="Identifier inventory record")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "page": PageInventoryGridItemNonAuthenticatedEntity.from_dict(obj["page"]) if obj.get("page") is not None else None,
            "list": SellableRankedListLightweightNonAuthenticatedEntity.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
