...
class InventoryMapLightweightNonAuthenticatedEntity(BaseModel):
    """
    InventoryMapLightweightNonAuthenticatedEntity
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Map identifier")
    owner_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Map owner identifier", alias="ownerIdentifier")
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of map")
    type_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Inventory type identifier. Either a single channel inventory identifier, a list identifier or a dynamic search identifier.", alias="typeIdentifier")
    type: StrictStr = Field(description="Type of blocking")
    center: GeoJsonPointNonAuthenticatedEntity = Field(description="Map center point")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "ownerIdentifier", "customizationIdentifier", "name", "typeIdentifier", "type", "center", "draggable", "zoomable", "initialZoomLevel", "mapStyle", "mapMarkerColor", "mapHeight", "displayType", "circles", "rectangles", "markers", "polygons"]
