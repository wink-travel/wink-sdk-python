...
class InventoryMapMarkerNonAuthenticatedEntity(BaseModel):
    ...
    point: GeoJsonPointNonAuthenticatedEntity
    ...
    supplier_url_name: StrictStr = Field(description="Hotel url name", alias="supplierUrlName")
    inventory_identifier: StrictStr = Field(description="Actual blocking identifier", alias="inventoryIdentifier")
    inventory_type: StrictStr = Field(description="Type of blocking", alias="inventoryType")
    inventory_name: StrictStr = Field(description="Name of blocking", alias="inventoryName")
    lowest_display_price: CustomMonetaryAmount = Field(alias="lowestDisplayPrice")
    __properties: ClassVar[List[str]] = ["channelInventoryIdentifier", "point", "supplierIdentifier", "supplierName", "supplierUrlName", "inventoryIdentifier", "inventoryType", "inventoryName", "lowestDisplayPrice"]
