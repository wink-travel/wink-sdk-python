...
class AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(BaseModel):
    """
    AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
    """ # noqa: E501
    inventory_with_price: Optional[AttractionLocalizedInventoryNonAuthenticatedEntity] = Field(default=None, description="Attraction details", alias="inventoryWithPrice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventoryWithPrice": AttractionLocalizedInventoryNonAuthenticatedEntity.from_dict(obj["inventoryWithPrice"]) if obj.get("inventoryWithPrice") is not None else None,
