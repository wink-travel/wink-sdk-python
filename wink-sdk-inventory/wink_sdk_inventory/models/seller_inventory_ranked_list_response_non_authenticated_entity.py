...
class SellerInventoryRankedListResponseNonAuthenticatedEntity(BaseModel):
    """
    SellerInventoryRankedListResponseNonAuthenticatedEntity
    """ # noqa: E501
    inventory_page: Optional[PageInventoryGridItemNonAuthenticatedEntity] = Field(default=None, alias="inventoryPage")
    configuration: Optional[SellerInventoryRankedListNonAuthenticatedEntity] = None
    __properties: ClassVar[List[str]] = ["inventoryPage", "configuration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of inventory_page
        if self.inventory_page:
            _dict['inventoryPage'] = self.inventory_page.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventoryPage": PageInventoryGridItemNonAuthenticatedEntity.from_dict(obj["inventoryPage"]) if obj.get("inventoryPage") is not None else None,
            "configuration": SellerInventoryRankedListNonAuthenticatedEntity.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
