...
class SellerInventoryListResponseNonAuthenticatedEntity(BaseModel):
    """
    ...
    configuration: Optional[SellerInventoryListNonAuthenticatedEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configuration": SellerInventoryListNonAuthenticatedEntity.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
