...
class PlaceLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    """
    PlaceLocalizedInventoryNonAuthenticatedEntity
    """ # noqa: E501
    place: Optional[PlaceLightweightNonAuthenticatedEntity] = Field(default=None, description="Inventory data object")
    ...
    __properties: ClassVar[List[str]] = ["place", "list", "channelInventoryIdentifier", "commissionable", "commission", "direct", "priceList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "place": PlaceLightweightNonAuthenticatedEntity.from_dict(obj["place"]) if obj.get("place") is not None else None,
