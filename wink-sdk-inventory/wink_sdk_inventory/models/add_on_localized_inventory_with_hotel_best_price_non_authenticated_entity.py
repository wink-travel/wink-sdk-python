...
class AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(BaseModel):
    """
    AddOnLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
    """ # noqa: E501
    inventory_with_price: Optional[AddOnLocalizedInventoryNonAuthenticatedEntity] = Field(default=None, description="Add-on details", alias="inventoryWithPrice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventoryWithPrice": AddOnLocalizedInventoryNonAuthenticatedEntity.from_dict(obj["inventoryWithPrice"]) if obj.get("inventoryWithPrice") is not None else None,
