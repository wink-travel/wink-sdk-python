...
class HotelInventoryListRequestNonAuthenticatedEntity(BaseModel):
    """
    Wrapper to query for multiple property inventories
    """ # noqa: E501
    list: Annotated[List[HotelInventoryRequestNonAuthenticatedEntity], Field(min_length=1, max_length=20)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [HotelInventoryRequestNonAuthenticatedEntity.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
