...
class AddOnLightweightNonAuthenticatedEntity(BaseModel):
    ...
    multimedias: Annotated[List[SimpleMultimediaNonAuthenticatedEntity], Field(min_length=1)]
    ...
    socials: Optional[List[SocialNonAuthenticatedEntity]] = None
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    recognition_list: Optional[List[TravelInventoryRecognitionNonAuthenticatedEntity]] = Field(default=None, alias="recognitionList")
