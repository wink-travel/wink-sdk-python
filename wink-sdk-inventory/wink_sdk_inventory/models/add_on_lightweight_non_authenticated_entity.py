...
class AddOnLightweightNonAuthenticatedEntity(BaseModel):
    """
    ...
    location: GeoJsonPointNonAuthenticatedEntity = Field(description="Geo-location point where blocking takes place. Defaults to location of property.")
    descriptions: Annotated[List[SimpleDescriptionNonAuthenticatedEntity], Field(min_length=1)] = Field(description="Localized descriptions describing inventory.")
    multimedias: Annotated[List[SimpleMultimediaNonAuthenticatedEntity], Field(min_length=1)] = Field(description="List of images / videos of blocking.")
    contact: ContactNonAuthenticatedEntity = Field(description="Associate a contact person for this blocking (if applicable).")
    address: SimpleAddressNonAuthenticatedEntity = Field(description="Defaults to property address.")
    ...
    days_of_week: Optional[DowPatternGroupNonAuthenticatedEntity] = Field(default=None, description="Indicate which days this blocking is open.", alias="daysOfWeek")
