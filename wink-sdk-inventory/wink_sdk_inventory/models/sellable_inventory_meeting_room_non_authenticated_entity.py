...
class SellableInventoryMeetingRoomNonAuthenticatedEntity(BaseModel):
    """
    SellableInventoryMeetingRoomNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[MeetingRoomLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the priced meeting room record.")
    configuration: Optional[SellableItemLightweightNonAuthenticatedEntity] = Field(default=None, description="Identifier inventory record")
    __properties: ClassVar[List[str]] = ["inventory", "configuration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": MeetingRoomLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
            "configuration": SellableItemLightweightNonAuthenticatedEntity.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
