...
class SpaSellableItemNonAuthenticatedEntity(BaseModel):
    """
    SpaSellableItemNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the priced spa record.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
