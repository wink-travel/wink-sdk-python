...
class RoomTypeBestPriceForDateRangeNonAuthenticatedEntity(BaseModel):
    """
    RoomTypeBestPriceForDateRangeNonAuthenticatedEntity
    """ # noqa: E501
    room: RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity = Field(description="The room type.")
    ...
    available: StrictBool = Field(description="Utilify flag to verify whether this rate is available or not")
    price: Optional[RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity] = None
    __properties: ClassVar[List[str]] = ["room", "startDate", "endDate", "roomNights", "available", "price"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "room": RoomTypeBestPriceForDateRangeInfoNonAuthenticatedEntity.from_dict(obj["room"]) if obj.get("room") is not None else None,
            "startDate": obj.get("startDate"),
            "endDate": obj.get("endDate"),
            "roomNights": obj.get("roomNights"),
            "available": obj.get("available"),
            "price": RoomTypeBestPriceForDateRangePriceNonAuthenticatedEntity.from_dict(obj["price"]) if obj.get("price") is not None else None
        })
        return _obj
