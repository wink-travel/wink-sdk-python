...
class LocalizedTransactionalTravelInventoryNonAuthenticatedEntity(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescriptionNonAuthenticatedEntity], Field(min_length=1, max_length=2147483647)] = Field(description="Localized descriptions describing inventory.")
    pricing_type: StrictStr = Field(description="How this blocking item should be priced.", alias="pricingType")
    price: LocalizedPriceNonAuthenticatedEntity = Field(description="Localized price")
    multimedias: Optional[List[SimpleMultimediaNonAuthenticatedEntity]] = Field(default=None, description="List of images / videos of item.")
    ...
    offer_details: Optional[List[LocalizedDescriptionNonAuthenticatedEntity]] = Field(default=None, description="Localized offer details if rate plan discount applies.", alias="offerDetails")
    promotion: Optional[StrictStr] = Field(default=None, description="If a package is linked to a rate plan the user could be entitled to a promotional discount if she enters a code. When this field is populated, it means the discount was applied to the package.")
    __properties: ClassVar[List[str]] = ["identifier", "name", "descriptions", "pricingType", "price", "multimedias", "minPax", "maxPax", "offerDetails", "promotion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": LocalizedPriceNonAuthenticatedEntity.from_dict(obj["price"]) if obj.get("price") is not None else None,
            ...
            "offerDetails": [LocalizedDescriptionNonAuthenticatedEntity.from_dict(_item) for _item in obj["offerDetails"]] if obj.get("offerDetails") is not None else None,
