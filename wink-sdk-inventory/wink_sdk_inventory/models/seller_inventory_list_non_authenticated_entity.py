...
class SellerInventoryListNonAuthenticatedEntity(BaseModel):
    """
    ...
    seller_inventory_list_name: StrictStr = Field(description="Descriptive name of this list for seller use only", alias="sellerInventoryListName")
    ...
    list_identifier: StrictStr = Field(description="Depending on the `listType`, this is either the list / search / channel inventory identifier.", alias="listIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "sellerIdentifier", "sellerInventoryListName", "engineConfigurationIdentifier", "descriptions", "keywords", "status", "listType", "listIdentifier", "animate", "animateDelay", "sort", "displayType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sellerInventoryListName": obj.get("sellerInventoryListName"),
