...
class MeetingRoomLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    """
    MeetingRoomLocalizedInventoryNonAuthenticatedEntity
    """ # noqa: E501
    meeting_room: Optional[MeetingRoomLightweightNonAuthenticatedEntity] = Field(default=None, description="Inventory data object", alias="meetingRoom")
    list: Optional[List[LocalizedTransactionalTravelInventoryNonAuthenticatedEntity]] = None
    channel_inventory_identifier: Optional[UUID] = Field(default=None, description="Channel inventory identifier referencing this record.", alias="channelInventoryIdentifier")
    commissionable: Optional[StrictBool] = Field(default=None, description="Whether this package is commissionable based on the incoming sales channel.")
    commission: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The commission percentage.")
    ...
    __properties: ClassVar[List[str]] = ["meetingRoom", "list", "channelInventoryIdentifier", "commissionable", "commission", "direct", "priceList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meetingRoom": MeetingRoomLightweightNonAuthenticatedEntity.from_dict(obj["meetingRoom"]) if obj.get("meetingRoom") is not None else None,
