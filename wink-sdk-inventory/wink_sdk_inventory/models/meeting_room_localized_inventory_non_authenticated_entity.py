...
class MeetingRoomLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    meeting_room: Optional[MeetingRoomNonAuthenticatedEntity] = Field(default=None, alias="meetingRoom")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meetingRoom": MeetingRoomNonAuthenticatedEntity.from_dict(obj["meetingRoom"]) if obj.get("meetingRoom") is not None else None,
