...
class SellerInventoryGuestRoomNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    inventory: Optional[HotelWithBestPriceNonAuthenticatedEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": HotelWithBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
