...
class SellableRankedListLightweightNonAuthenticatedEntity(BaseModel):
    """
    ...
    lookup: LookupLightweightNonAuthenticatedEntity = Field(description="The destination to display ranked inventory from.")
    ...
    display_type: Optional[StrictStr] = Field(default='NATIVE', description="Indicate which initial values to display first on the front-facing card", alias="displayType")
    __properties: ClassVar[List[str]] = ["identifier", "ownerIdentifier", "name", "customizationIdentifier", "descriptions", "keywords", "status", "lookup", "animate", "animateDelay", "sort", "displayType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lookup": LookupLightweightNonAuthenticatedEntity.from_dict(obj["lookup"]) if obj.get("lookup") is not None else None,
