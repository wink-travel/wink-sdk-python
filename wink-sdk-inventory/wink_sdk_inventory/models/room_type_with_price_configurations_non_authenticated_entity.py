...
class RoomTypeWithPriceConfigurationsNonAuthenticatedEntity(BaseModel):
    ...
    best_price: Optional[RoomConfigurationPriceNonAuthenticatedEntity] = Field(default=None, alias="bestPrice")
    __properties: ClassVar[List[str]] = ["room", "priceConfigurations", "available", "bestPrice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "room": GuestRoomNonAuthenticatedEntity.from_dict(obj["room"]) if obj.get("room") is not None else None,
            ...
            "bestPrice": RoomConfigurationPriceNonAuthenticatedEntity.from_dict(obj["bestPrice"]) if obj.get("bestPrice") is not None else None
        })
        return _obj
