...
class RoomTypeWithPriceConfigurationsNonAuthenticatedEntity(BaseModel):
    """
    RoomTypeWithPriceConfigurationsNonAuthenticatedEntity
    """ # noqa: E501
    room: GuestRoomLightweightNonAuthenticatedEntity = Field(description="The room type.")
    price_configurations: List[RoomConfigurationPriceNonAuthenticatedEntity] = Field(alias="priceConfigurations")
    lowest_price: Optional[RoomConfigurationPriceNonAuthenticatedEntity] = Field(default=None, alias="lowestPrice")
    available: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["room", "priceConfigurations", "lowestPrice", "available"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "room": GuestRoomLightweightNonAuthenticatedEntity.from_dict(obj["room"]) if obj.get("room") is not None else None,
            "priceConfigurations": [RoomConfigurationPriceNonAuthenticatedEntity.from_dict(_item) for _item in obj["priceConfigurations"]] if obj.get("priceConfigurations") is not None else None,
            "lowestPrice": RoomConfigurationPriceNonAuthenticatedEntity.from_dict(obj["lowestPrice"]) if obj.get("lowestPrice") is not None else None,
