...
class SellableListLightweightNonAuthenticatedEntity(BaseModel):
    """
    SellableListLightweightNonAuthenticatedEntity
    """ # noqa: E501
    identifier: UUID = Field(description="Unique identifier")
    seller_identifier: UUID = Field(description="AffiliateAccount identifier", alias="sellerIdentifier")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Descriptive name of this list for seller use only")
    customization_identifier: UUID = Field(description="Customization identifier", alias="customizationIdentifier")
    descriptions: Annotated[List[SimpleDescriptionNonAuthenticatedEntity], Field(min_length=1, max_length=2147483647)] = Field(description="Contains custom title and description of grid")
    keywords: Annotated[List[StrictStr], Field(min_length=1, max_length=2147483647)] = Field(description="Keywords is meta data for the grid you created that can be used for SEO purposes.")
    status: StrictStr = Field(description="Status")
    list_type: StrictStr = Field(description="List type", alias="listType")
    list_identifier: UUID = Field(description="Depending on the `listType`, this is either the list / search / channel inventory identifier.", alias="listIdentifier")
    animate: Optional[StrictBool] = Field(default=False, description="Create an animated gif instead of a list of images")
    animate_delay: Optional[StrictInt] = Field(default=-1, description="Controls animation delay in milliseconds. -1 is disabled", alias="animateDelay")
    sort: Optional[StrictStr] = Field(default=None, description="Determines which badge to show on the Web Component. Is also used to sort properties for search grids.")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "sellerIdentifier", "name", "customizationIdentifier", "descriptions", "keywords", "status", "listType", "listIdentifier", "animate", "animateDelay", "sort", "displayType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "listIdentifier": obj.get("listIdentifier"),
