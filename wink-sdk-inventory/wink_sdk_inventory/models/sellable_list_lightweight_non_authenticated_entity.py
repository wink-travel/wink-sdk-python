...
class SellableListLightweightNonAuthenticatedEntity(BaseModel):
    ...
    seller_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="AffiliateAccountLightweight identifier", alias="sellerIdentifier")
    ...
    list_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Depending on the `listType`, this is either the list / search / channel inventory identifier.", alias="listIdentifier")
