...
class ExtraChargesNonAuthenticatedEntity(BaseModel):
    """
    ExtraChargesNonAuthenticatedEntity
    """ # noqa: E501
    items: Optional[List[ExtraChargeNonAuthenticatedEntity]] = Field(default=None, description="List of extra charges that applies to the rate plan.")
    ...
    __properties: ClassVar[List[str]] = ["items", "userSpecifiedCurrencyTotal", "sourceTotal", "internalTotal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ExtraChargeNonAuthenticatedEntity.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
