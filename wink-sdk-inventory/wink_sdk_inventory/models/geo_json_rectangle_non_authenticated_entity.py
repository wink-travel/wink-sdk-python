...
class GeoJsonRectangleNonAuthenticatedEntity(BaseModel):
    """
    A GeoJSON rectangle
    """ # noqa: E501
    south_west: GeoJsonPointNonAuthenticatedEntity = Field(alias="southWest")
    north_east: GeoJsonPointNonAuthenticatedEntity = Field(alias="northEast")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "southWest": GeoJsonPointNonAuthenticatedEntity.from_dict(obj["southWest"]) if obj.get("southWest") is not None else None,
            "northEast": GeoJsonPointNonAuthenticatedEntity.from_dict(obj["northEast"]) if obj.get("northEast") is not None else None
        })
        return _obj
