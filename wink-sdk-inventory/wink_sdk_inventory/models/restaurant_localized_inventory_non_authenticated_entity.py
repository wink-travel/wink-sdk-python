...
class RestaurantLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    restaurant: Optional[RestaurantNonAuthenticatedEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "restaurant": RestaurantNonAuthenticatedEntity.from_dict(obj["restaurant"]) if obj.get("restaurant") is not None else None,
