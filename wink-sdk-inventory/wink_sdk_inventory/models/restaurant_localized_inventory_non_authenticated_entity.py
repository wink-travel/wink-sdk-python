...
class RestaurantLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    """
    RestaurantLocalizedInventoryNonAuthenticatedEntity
    """ # noqa: E501
    restaurant: Optional[RestaurantLightweightNonAuthenticatedEntity] = Field(default=None, description="Inventory data object")
    ...
    __properties: ClassVar[List[str]] = ["restaurant", "list", "channelInventoryIdentifier", "commissionable", "commission", "direct", "priceList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "restaurant": RestaurantLightweightNonAuthenticatedEntity.from_dict(obj["restaurant"]) if obj.get("restaurant") is not None else None,
