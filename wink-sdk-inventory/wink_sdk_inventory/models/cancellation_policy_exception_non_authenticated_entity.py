...
class CancellationPolicyExceptionNonAuthenticatedEntity(BaseModel):
    """
    CancellationPolicyExceptionNonAuthenticatedEntity
    """ # noqa: E501
    cancellation_policy_identifier: UUID = Field(description="Cancellation policy", alias="cancellationPolicyIdentifier")
    cancellation_policy: CancellationPolicyLightweightNonAuthenticatedEntity = Field(description="Cancellation policy", alias="cancellationPolicy")
