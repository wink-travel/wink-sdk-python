...
class PageInventoryGridItemNonAuthenticatedEntity(BaseModel):
    """
    ...
    content: Optional[List[InventoryGridItemNonAuthenticatedEntity]] = None
    number: Optional[StrictInt] = None
    pageable: Optional[PageableObjectNonAuthenticatedEntity] = None
    number_of_elements: Optional[StrictInt] = Field(default=None, alias="numberOfElements")
    sort: Optional[SortObjectNonAuthenticatedEntity] = None
    first: Optional[StrictBool] = None
    last: Optional[StrictBool] = None
    empty: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["totalPages", "totalElements", "size", "content", "number", "pageable", "numberOfElements", "sort", "first", "last", "empty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [InventoryGridItemNonAuthenticatedEntity.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "number": obj.get("number"),
            "pageable": PageableObjectNonAuthenticatedEntity.from_dict(obj["pageable"]) if obj.get("pageable") is not None else None,
            "numberOfElements": obj.get("numberOfElements"),
            "sort": SortObjectNonAuthenticatedEntity.from_dict(obj["sort"]) if obj.get("sort") is not None else None,
            "first": obj.get("first"),
            "last": obj.get("last"),
            "empty": obj.get("empty")
        })
