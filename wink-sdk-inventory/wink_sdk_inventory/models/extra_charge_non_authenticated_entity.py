...
class ExtraChargeNonAuthenticatedEntity(BaseModel):
    """
    ExtraChargeNonAuthenticatedEntity
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeNonAuthenticatedEntity] = Field(default=None, description="What the guest is paying extra for", alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceNonAuthenticatedEntity] = Field(default=None, description="The localized unit price of the extra charge", alias="unitPrice")
    price: Optional[LocalizedPriceNonAuthenticatedEntity] = Field(default=None, description="The localized price of the extra charge")
    __properties: ClassVar[List[str]] = ["ratePlanLevelFee", "unitPrice", "price"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rate_plan_level_fee
        if self.rate_plan_level_fee:
            _dict['ratePlanLevelFee'] = self.rate_plan_level_fee.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ratePlanLevelFee": RatePlanLevelFeeNonAuthenticatedEntity.from_dict(obj["ratePlanLevelFee"]) if obj.get("ratePlanLevelFee") is not None else None,
            "unitPrice": LocalizedPriceNonAuthenticatedEntity.from_dict(obj["unitPrice"]) if obj.get("unitPrice") is not None else None,
