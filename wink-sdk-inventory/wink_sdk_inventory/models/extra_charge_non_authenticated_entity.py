...
class ExtraChargeNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    rate_plan_level_fee: Optional[RatePlanLevelFeeNonAuthenticatedEntity] = Field(default=None, alias="ratePlanLevelFee")
    unit_price: Optional[LocalizedPriceNonAuthenticatedEntity] = Field(default=None, alias="unitPrice")
    price: Optional[LocalizedPriceNonAuthenticatedEntity] = None
