...
class SellableInventoryAttractionNonAuthenticatedEntity(BaseModel):
    """
    SellableInventoryAttractionNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the priced attraction record.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": AttractionLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
