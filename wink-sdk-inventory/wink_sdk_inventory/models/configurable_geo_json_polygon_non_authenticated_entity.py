...
class ConfigurableGeoJsonPolygonNonAuthenticatedEntity(BaseModel):
    """
    A way to persist a GeoJSON polygon
    """ # noqa: E501
    polygon: GeoJsonPolygonNonAuthenticatedEntity
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "polygon": GeoJsonPolygonNonAuthenticatedEntity.from_dict(obj["polygon"]) if obj.get("polygon") is not None else None
        })
        return _obj
