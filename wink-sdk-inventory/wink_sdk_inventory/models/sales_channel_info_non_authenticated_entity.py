...
class SalesChannelInfoNonAuthenticatedEntity(BaseModel):
    """
    SalesChannelInfoNonAuthenticatedEntity
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of sales channel")
    channel_discount_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, description="A percent discount the property gave the sales channel. Value between 0.0 - 1.0.", alias="channelDiscountPercent")
    commission_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, description="A percent commission the property gave the sales channel. Value between 0.0 - 1.0.", alias="commissionPercent")
    __properties: ClassVar[List[str]] = ["name", "channelDiscountPercent", "commissionPercent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "channelDiscountPercent": obj.get("channelDiscountPercent") if obj.get("channelDiscountPercent") is not None else 0,
            "commissionPercent": obj.get("commissionPercent") if obj.get("commissionPercent") is not None else 0
        })
        return _obj
