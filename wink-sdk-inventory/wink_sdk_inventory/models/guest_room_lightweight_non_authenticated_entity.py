...
class GuestRoomLightweightNonAuthenticatedEntity(BaseModel):
    ...
    bedroom_configuration_list: List[BedroomConfigurationNonAuthenticatedEntity] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
