...
class GuestRoomLightweightNonAuthenticatedEntity(BaseModel):
    """
    ...
    bedroom_configuration_list: Annotated[List[BedroomConfigurationNonAuthenticatedEntity], Field(min_length=1)] = Field(description="A room type can have more than one bed configuration.", alias="bedroomConfigurationList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GuestRoomLightweightNonAuthenticatedEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GuestRoomLightweightNonAuthenticatedEntity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bedroomConfigurationList": [BedroomConfigurationNonAuthenticatedEntity.from_dict(_item) for _item in obj["bedroomConfigurationList"]] if obj.get("bedroomConfigurationList") is not None else None,
            "size": obj.get("size"),
