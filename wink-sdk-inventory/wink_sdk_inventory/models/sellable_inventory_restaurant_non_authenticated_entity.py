...
class SellableInventoryRestaurantNonAuthenticatedEntity(BaseModel):
    """
    SellableInventoryRestaurantNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the priced restaurant record.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
