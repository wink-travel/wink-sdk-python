...
class PropertyInventoryResponseNonAuthenticatedEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "urlName", "hotel", "greenIndexScores", "roomTypes", "meetingRooms", "restaurants", "spas", "activities", "attractions", "places", "metadata", "images", "videos", "recognitions", "announcements", "reviews", "salesChannel", "available", "cheapestRoomTypes", "lowestPrice"]
