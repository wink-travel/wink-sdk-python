...
class ItineraryNonAuthenticatedEntity(BaseModel):
    """
    BookingItinerary
    """ # noqa: E501
    ...
    items: Annotated[List[RoomConfigurationNonAuthenticatedEntity], Field(min_length=1, max_length=2147483647)] = Field(description="Room configurations")
    ...
    __properties: ClassVar[List[str]] = ["startDate", "endDate", "nights", "items", "hours", "children", "guests", "rooms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [RoomConfigurationNonAuthenticatedEntity.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "hours": obj.get("hours"),
