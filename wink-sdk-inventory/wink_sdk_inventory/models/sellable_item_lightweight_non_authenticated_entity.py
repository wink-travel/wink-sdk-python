...
class SellableItemLightweightNonAuthenticatedEntity(BaseModel):
    ...
    owner_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="AffiliateAccountLightweight / Owner identifier", alias="ownerIdentifier")
    ...
    descriptions: Annotated[List[SimpleDescriptionNonAuthenticatedEntity], Field(min_length=1, max_length=2147483647)] = Field(description="Title and description of blocking.")
    ...
    supplier_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supplier / Hotel identifier that owns this blocking.", alias="supplierIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "ownerIdentifier", "name", "customizationIdentifier", "descriptions", "keywords", "status", "inventoryStatus", "inventoryType", "channelInventoryType", "supplierIdentifier", "channelInventoryIdentifier", "multimediaIdentifiers", "animate", "animateDelay", "sort", "displayType"]
