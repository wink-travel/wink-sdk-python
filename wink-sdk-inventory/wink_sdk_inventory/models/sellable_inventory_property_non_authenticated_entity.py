...
class SellableInventoryPropertyNonAuthenticatedEntity(BaseModel):
    """
    SellableInventoryPropertyNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[PropertyWithBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the best price this property has to offer.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": PropertyWithBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
