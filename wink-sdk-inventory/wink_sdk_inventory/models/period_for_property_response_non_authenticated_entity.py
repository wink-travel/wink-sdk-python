...
class PeriodForPropertyResponseNonAuthenticatedEntity(BaseModel):
    """
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The property name.")
    adults: StrictInt = Field(description="The actual amount of adults as determined by the hotel's policy")
    list: List[RoomTypeBestPriceForDateRangeNonAuthenticatedEntity]
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "name", "adults", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [RoomTypeBestPriceForDateRangeNonAuthenticatedEntity.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
