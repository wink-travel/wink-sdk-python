...
class SellerMediaNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["channel", "url", "width", "height", "type", "mimeType", "altText"]
    ...
    def channel_validate_enum(cls, value):
        ...
        if value not in set(['FACEBOOK', 'INSTAGRAM', 'LINKED_IN', 'TWITTER', 'REDDIT']):
            raise ValueError("must be one of enum values ('FACEBOOK', 'INSTAGRAM', 'LINKED_IN', 'TWITTER', 'REDDIT')")
        return value
