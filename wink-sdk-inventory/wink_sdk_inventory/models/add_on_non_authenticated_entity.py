...
class AddOnNonAuthenticatedEntity(BaseModel):
    """
    ...
    rate_plan: Optional[RatePlanNonAuthenticatedEntity] = Field(default=None, alias="ratePlan")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddOnNonAuthenticatedEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddOnNonAuthenticatedEntity from a dict"""
        if obj is None:
            return None
