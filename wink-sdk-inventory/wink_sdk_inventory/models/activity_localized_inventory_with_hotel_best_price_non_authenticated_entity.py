...
class ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(BaseModel):
    """
    ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
    """ # noqa: E501
    inventory_with_price: Optional[ActivityLocalizedInventoryNonAuthenticatedEntity] = Field(default=None, description="Activity details", alias="inventoryWithPrice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventoryWithPrice": ActivityLocalizedInventoryNonAuthenticatedEntity.from_dict(obj["inventoryWithPrice"]) if obj.get("inventoryWithPrice") is not None else None,
