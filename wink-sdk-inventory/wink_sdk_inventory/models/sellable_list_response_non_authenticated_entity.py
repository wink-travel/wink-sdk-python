...
class SellableListResponseNonAuthenticatedEntity(BaseModel):
    """
    ...
    list: Optional[SellableListLightweightNonAuthenticatedEntity] = Field(default=None, description="Identifier inventory record")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": SellableListLightweightNonAuthenticatedEntity.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
