...
class GeneralManagerNonAuthenticatedEntity(BaseModel):
    """
    General manager related data.
    """ # noqa: E501
    name: StrictStr = Field(description="Name of GM currently managing the property.")
    image: Optional[SimpleMultimediaNonAuthenticatedEntity] = Field(default=None, description="Cloudinary image identifier of GM currently managing the property.")
    descriptions: Optional[List[LocalizedDescriptionNonAuthenticatedEntity]] = Field(default=None, description="Localized welcome message from GM.")
    __properties: ClassVar[List[str]] = ["name", "image", "descriptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "image": SimpleMultimediaNonAuthenticatedEntity.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "descriptions": [LocalizedDescriptionNonAuthenticatedEntity.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None
        })
        return _obj
