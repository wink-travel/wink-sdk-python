...
class RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(BaseModel):
    """
    RestaurantLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
    """ # noqa: E501
    inventory_with_price: Optional[RestaurantLocalizedInventoryNonAuthenticatedEntity] = Field(default=None, description="Restaurant details", alias="inventoryWithPrice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventoryWithPrice": RestaurantLocalizedInventoryNonAuthenticatedEntity.from_dict(obj["inventoryWithPrice"]) if obj.get("inventoryWithPrice") is not None else None,
