...
class SellableInventoryGuestRoomNonAuthenticatedEntity(BaseModel):
    """
    SellableInventoryGuestRoomNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[PropertyWithBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the best room type price.")
