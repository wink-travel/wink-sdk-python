...
class SellableInventoryActivityNonAuthenticatedEntity(BaseModel):
    """
    SellableInventoryActivityNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the priced activity record.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": ActivityLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
