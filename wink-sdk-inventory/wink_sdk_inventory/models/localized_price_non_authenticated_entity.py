...
class LocalizedPriceNonAuthenticatedEntity(BaseModel):
    """
    LocalizedPriceNonAuthenticatedEntity
    """ # noqa: E501
    source_to_user_currency_quote: QuoteLightweightNonAuthenticatedEntity = Field(description="Hotel to user currency exchange rate.", alias="sourceToUserCurrencyQuote")
    source_to_internal_currency_quote: QuoteLightweightNonAuthenticatedEntity = Field(description="Hotel to wink currency exchange rate.", alias="sourceToInternalCurrencyQuote")
    user_specified_currency_base_total: CustomMonetaryAmount = Field(description="Base total in user specified currency.", alias="userSpecifiedCurrencyBaseTotal")
    source_base_total: CustomMonetaryAmount = Field(description="Base total in hotel currency.", alias="sourceBaseTotal")
    internal_base_total: CustomMonetaryAmount = Field(description="Base total in wink currency.", alias="internalBaseTotal")
    ...
    __properties: ClassVar[List[str]] = ["sourceToUserCurrencyQuote", "sourceToInternalCurrencyQuote", "userSpecifiedCurrencyBaseTotal", "sourceBaseTotal", "internalBaseTotal", "userSpecifiedCurrencyPromotionalModifier", "sourcePromotionalModifier", "internalPromotionalModifier", "userSpecifiedCurrencyPremiumModifier", "sourcePremiumModifier", "internalPremiumModifier", "userSpecifiedCurrencyChannelModifier", "sourceChannelModifier", "internalChannelModifier", "quantity", "promotionalDiscountPercent", "channelDiscountPercent", "premiumPercent", "totalDiscountPercent", "sourceTotal", "userSpecifiedCurrencyTotal", "internalTotal", "hasChannelDiscount", "hasPromotion", "hasPremium"]
