...
class SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity(BaseModel):
    """
    SpaLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity
    """ # noqa: E501
    inventory_with_price: Optional[SpaLocalizedInventoryNonAuthenticatedEntity] = Field(default=None, description="Spa details", alias="inventoryWithPrice")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventoryWithPrice": SpaLocalizedInventoryNonAuthenticatedEntity.from_dict(obj["inventoryWithPrice"]) if obj.get("inventoryWithPrice") is not None else None,
