...
class BedroomNonAuthenticatedEntity(BaseModel):
    """
    BedroomNonAuthenticatedEntity
    """ # noqa: E501
    type: StrictStr = Field(description="Type of bedroom")
    bed_list: Annotated[List[BedNonAuthenticatedEntity], Field(min_length=1)] = Field(description="A bedroom can have more than one bed type.", alias="bedList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "bedList": [BedNonAuthenticatedEntity.from_dict(_item) for _item in obj["bedList"]] if obj.get("bedList") is not None else None
        })
        return _obj
