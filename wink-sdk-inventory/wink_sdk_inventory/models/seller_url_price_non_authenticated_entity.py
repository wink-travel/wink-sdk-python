...
class SellerUrlPriceNonAuthenticatedEntity(BaseModel):
    """
    The price of the link being exposed
    """ # noqa: E501
    base_price: Optional[CustomMonetaryAmount] = Field(default=None, description="Original price", alias="basePrice")
    price: Optional[CustomMonetaryAmount] = Field(default=None, description="Discounted price")
    percent_discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Price discount in percent", alias="percentDiscount")
    __properties: ClassVar[List[str]] = ["basePrice", "price", "percentDiscount"]
