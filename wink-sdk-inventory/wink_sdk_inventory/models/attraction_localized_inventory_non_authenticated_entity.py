...
class AttractionLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    attraction: Optional[AttractionNonAuthenticatedEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attraction": AttractionNonAuthenticatedEntity.from_dict(obj["attraction"]) if obj.get("attraction") is not None else None,
