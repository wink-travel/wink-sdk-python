...
class AttractionLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    """
    AttractionLocalizedInventoryNonAuthenticatedEntity
    """ # noqa: E501
    attraction: Optional[AttractionLightweightNonAuthenticatedEntity] = Field(default=None, description="Inventory data object")
    ...
    __properties: ClassVar[List[str]] = ["attraction", "list", "channelInventoryIdentifier", "commissionable", "commission", "direct", "priceList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attraction": AttractionLightweightNonAuthenticatedEntity.from_dict(obj["attraction"]) if obj.get("attraction") is not None else None,
