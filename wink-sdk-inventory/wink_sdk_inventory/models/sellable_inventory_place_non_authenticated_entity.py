...
class SellableInventoryPlaceNonAuthenticatedEntity(BaseModel):
    """
    SellableInventoryPlaceNonAuthenticatedEntity
    """ # noqa: E501
    inventory: Optional[PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity] = Field(default=None, description="Property details along with the priced place record.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": PlaceLocalizedInventoryWithHotelBestPriceNonAuthenticatedEntity.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
