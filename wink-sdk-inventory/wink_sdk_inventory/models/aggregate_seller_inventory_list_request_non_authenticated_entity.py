...
class AggregateSellerInventoryListRequestNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="Record identifier")
    engine_configuration_identifier: Optional[StrictStr] = Field(default=None, description="The configuration identifier that was used during this call.", alias="engineConfigurationIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "engineConfigurationIdentifier", "userSession", "page", "size"]
