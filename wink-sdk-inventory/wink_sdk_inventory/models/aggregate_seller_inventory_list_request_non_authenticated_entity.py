...
class AggregateSellerInventoryListRequestNonAuthenticatedEntity(BaseModel):
    """
    AggregateSellerInventoryListRequestNonAuthenticatedEntity
    """ # noqa: E501
    identifier: UUID = Field(description="Record identifier")
    user_session: UserSessionNonAuthenticatedEntity = Field(description="User session containing itinerary and other data by the user", alias="userSession")
    customization_identifier: Optional[UUID] = Field(default=None, description="The configuration identifier that was used during this call.", alias="customizationIdentifier")
    locale: Optional[StrictStr] = None
    page: Annotated[int, Field(strict=True, ge=0)] = Field(description="Which to page to paginate to")
    size: Annotated[int, Field(le=12, strict=True, ge=0)] = Field(description="How many results to return per page")
    __properties: ClassVar[List[str]] = ["identifier", "userSession", "customizationIdentifier", "locale", "page", "size"]
