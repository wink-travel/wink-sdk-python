...
class AggregateSellerInventoryListRequestNonAuthenticatedEntity(BaseModel):
    ...
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Record identifier")
    ...
    customization_identifier: Optional[StrictStr] = Field(default=None, description="The configuration identifier that was used during this call.", alias="customizationIdentifier")
