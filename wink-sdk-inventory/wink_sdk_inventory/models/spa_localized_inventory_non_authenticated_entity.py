...
class SpaLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    """
    SpaLocalizedInventoryNonAuthenticatedEntity
    """ # noqa: E501
    spa: Optional[SpaLightweightNonAuthenticatedEntity] = Field(default=None, description="Inventory data object")
    ...
    __properties: ClassVar[List[str]] = ["spa", "list", "channelInventoryIdentifier", "commissionable", "commission", "direct", "priceList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spa": SpaLightweightNonAuthenticatedEntity.from_dict(obj["spa"]) if obj.get("spa") is not None else None,
