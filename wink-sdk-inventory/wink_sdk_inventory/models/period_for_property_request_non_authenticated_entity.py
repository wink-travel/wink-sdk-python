...
class PeriodForPropertyRequestNonAuthenticatedEntity(BaseModel):
    """
    PeriodForPropertyRequestNonAuthenticatedEntity
    """ # noqa: E501
    hotel_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The property to query for.", alias="hotelIdentifier")
    start_date: date = Field(description="Start of period.", alias="startDate")
    period_in_days: Optional[Annotated[int, Field(le=30, strict=True, ge=2)]] = Field(default=5, description="The period to query within.", alias="periodInDays")
    adults: Optional[Annotated[int, Field(le=10, strict=True, ge=1)]] = Field(default=2, description="The period to query within.")
    language: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The language to display room type name.")
    currency: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=3)]] = Field(default='USD', description="The currency to display prices in.")
    rate_plan_name_matches_reg_ex: Optional[StrictStr] = Field(default=None, description="A regular expression to apply to the rate plan name", alias="ratePlanNameMatchesRegEx")
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "startDate", "periodInDays", "adults", "language", "currency", "ratePlanNameMatchesRegEx"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "periodInDays": obj.get("periodInDays") if obj.get("periodInDays") is not None else 5,
            ...
            "ratePlanNameMatchesRegEx": obj.get("ratePlanNameMatchesRegEx")
        })
        return _obj
