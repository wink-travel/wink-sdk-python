...
class PeriodForPropertyRequestNonAuthenticatedEntity(BaseModel):
    ...
    currency: Annotated[str, Field(min_length=3, strict=True, max_length=3)] = Field(description="The currency to display prices in.")
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "startDate", "periodInDays", "adults", "language", "currency"]
