...
class InventoryUnavailableNotificationNonAuthenticatedEntity(BaseModel):
    """
    ...
    inventory_name: StrictStr = Field(alias="inventoryName")
    inventory_type: StrictStr = Field(alias="inventoryType")
    inventory_identifier: StrictStr = Field(alias="inventoryIdentifier")
    user_session: UserSessionNonAuthenticatedEntity = Field(alias="userSession")
    __properties: ClassVar[List[str]] = ["propertyIdentifier", "propertyName", "inventoryName", "inventoryType", "inventoryIdentifier", "userSession"]
