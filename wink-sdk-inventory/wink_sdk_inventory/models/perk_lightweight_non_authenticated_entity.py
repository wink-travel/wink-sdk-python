...
class PerkLightweightNonAuthenticatedEntity(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescriptionNonAuthenticatedEntity], Field(min_length=1)] = Field(description="Localized description for this perk")
