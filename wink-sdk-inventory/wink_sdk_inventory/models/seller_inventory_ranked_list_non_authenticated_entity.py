...
class SellerInventoryRankedListNonAuthenticatedEntity(BaseModel):
    """
    ...
    seller_inventory_ranked_list_name: StrictStr = Field(description="Descriptive name of this list for seller use only", alias="sellerInventoryRankedListName")
    ...
    lookup: LookupNonAuthenticatedEntity
    ...
    __properties: ClassVar[List[str]] = ["identifier", "sellerIdentifier", "sellerInventoryRankedListName", "engineConfigurationIdentifier", "descriptions", "keywords", "status", "lookup", "animate", "animateDelay", "sort", "displayType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lookup": LookupNonAuthenticatedEntity.from_dict(obj["lookup"]) if obj.get("lookup") is not None else None,
