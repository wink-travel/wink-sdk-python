...
class AggregateInventoryGridItemRequestNonAuthenticatedEntity(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["identifier", "userSession", "customizationIdentifier", "locale", "type"]
