...
class GeoNameNonAuthenticatedEntity(BaseModel):
    """
    ...
    country: Optional[CountryNonAuthenticatedEntity] = None
    sub_country: Optional[SubCountryNonAuthenticatedEntity] = Field(default=None, alias="subCountry")
    sub_sub_country: Optional[SubSubCountryNonAuthenticatedEntity] = Field(default=None, alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountryNonAuthenticatedEntity.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountryNonAuthenticatedEntity.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountryNonAuthenticatedEntity.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
