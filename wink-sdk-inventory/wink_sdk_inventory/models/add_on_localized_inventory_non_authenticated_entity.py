...
class AddOnLocalizedInventoryNonAuthenticatedEntity(BaseModel):
    """
    AddOnLocalizedInventoryNonAuthenticatedEntity
    """ # noqa: E501
    add_on: AddOnLightweightNonAuthenticatedEntity = Field(description="The original add-on record created by the property.", alias="addOn")
    ...
    __properties: ClassVar[List[str]] = ["addOn", "priceList", "channelInventoryIdentifier", "commissionable", "commission", "direct"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addOn": AddOnLightweightNonAuthenticatedEntity.from_dict(obj["addOn"]) if obj.get("addOn") is not None else None,
