...
class ConsumableSellerUrlNonAuthenticatedEntity(BaseModel):
    ...
    twitter_account: Optional[StrictStr] = Field(default=None, alias="twitterAccount")
    facebook_app_id: Optional[StrictStr] = Field(default=None, alias="facebookAppId")
    image: Optional[SellerMediaNonAuthenticatedEntity] = None
    video: Optional[SellerMediaNonAuthenticatedEntity] = None
    transact_url: Optional[StrictStr] = Field(default=None, alias="transactUrl")
    supplier_identifier: Optional[StrictStr] = Field(default=None, alias="supplierIdentifier")
    supplier_name: Optional[StrictStr] = Field(default=None, alias="supplierName")
    supplier_url_name: Optional[StrictStr] = Field(default=None, alias="supplierUrlName")
    supplier_brand: Optional[StrictStr] = Field(default=None, alias="supplierBrand")
    ...
    inventory_type: Optional[StrictStr] = Field(default=None, alias="inventoryType")
    __properties: ClassVar[List[str]] = ["language", "currency", "title", "description", "keywords", "uniqueId", "twitterAccount", "facebookAppId", "image", "video", "transactUrl", "supplierIdentifier", "supplierName", "supplierUrlName", "supplierBrand", "available", "price", "cityName", "countryName", "inventoryType"]
