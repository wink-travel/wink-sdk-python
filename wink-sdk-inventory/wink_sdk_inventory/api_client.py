...
from wink_sdk_inventory.configuration import Configuration
from wink_sdk_inventory.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_inventory.models
from wink_sdk_inventory import rest
from wink_sdk_inventory.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_inventory.models, klass)
