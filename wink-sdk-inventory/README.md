...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.47#egg=wink_sdk_inventory&subdirectory=wink-sdk-inventory
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.47#egg=wink_sdk_inventory&subdirectory=wink_sdk_inventory`)
...
*InventoryApi* | [**show_consumable_url**](docs/InventoryApi.md#show_consumable_url) | **POST** /api/shareable-link/{code} | Show Shareable Link
