...
json = "{}"
# create an instance of GuestRoomNonAuthenticatedEntity from a JSON string
guest_room_non_authenticated_entity_instance = GuestRoomNonAuthenticatedEntity.from_json(json)
# print the JSON string representation of the object
print(GuestRoomNonAuthenticatedEntity.to_json())

# convert the object into a dict
guest_room_non_authenticated_entity_dict = guest_room_non_authenticated_entity_instance.to_dict()
# create an instance of GuestRoomNonAuthenticatedEntity from a dict
guest_room_non_authenticated_entity_from_dict = GuestRoomNonAuthenticatedEntity.from_dict(guest_room_non_authenticated_entity_dict)
```
