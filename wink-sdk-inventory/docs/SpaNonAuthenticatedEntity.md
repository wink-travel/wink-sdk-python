...
json = "{}"
# create an instance of SpaNonAuthenticatedEntity from a JSON string
spa_non_authenticated_entity_instance = SpaNonAuthenticatedEntity.from_json(json)
# print the JSON string representation of the object
print(SpaNonAuthenticatedEntity.to_json())

# convert the object into a dict
spa_non_authenticated_entity_dict = spa_non_authenticated_entity_instance.to_dict()
# create an instance of SpaNonAuthenticatedEntity from a dict
spa_non_authenticated_entity_from_dict = SpaNonAuthenticatedEntity.from_dict(spa_non_authenticated_entity_dict)
```
