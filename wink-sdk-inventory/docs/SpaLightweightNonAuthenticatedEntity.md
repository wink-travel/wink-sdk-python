...
**amenities** | **List[str]** | UnSupported OTA specification &#x60;SPA&#x60; code. See [OTA geoname data](#operation/showAvailableCodesForCategory). | [optional] 
...
spa_lightweight_non_authenticated_entity_instance = SpaLightweightNonAuthenticatedEntity.from_json(json)
# print the JSON string representation of the object
print(SpaLightweightNonAuthenticatedEntity.to_json())

# convert the object into a dict
spa_lightweight_non_authenticated_entity_dict = spa_lightweight_non_authenticated_entity_instance.to_dict()
# create an instance of SpaLightweightNonAuthenticatedEntity from a dict
spa_lightweight_non_authenticated_entity_from_dict = SpaLightweightNonAuthenticatedEntity.from_dict(spa_lightweight_non_authenticated_entity_dict)
```
