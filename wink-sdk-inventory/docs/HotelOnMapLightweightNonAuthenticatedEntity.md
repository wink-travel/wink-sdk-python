...
**address** | [**SimpleAddressNonAuthenticatedEntity**](SimpleAddressNonAuthenticatedEntity.md) |  | [optional] 
...
hotel_on_map_lightweight_non_authenticated_entity_instance = HotelOnMapLightweightNonAuthenticatedEntity.from_json(json)
# print the JSON string representation of the object
print(HotelOnMapLightweightNonAuthenticatedEntity.to_json())

# convert the object into a dict
hotel_on_map_lightweight_non_authenticated_entity_dict = hotel_on_map_lightweight_non_authenticated_entity_instance.to_dict()
# create an instance of HotelOnMapLightweightNonAuthenticatedEntity from a dict
hotel_on_map_lightweight_non_authenticated_entity_from_dict = HotelOnMapLightweightNonAuthenticatedEntity.from_dict(hotel_on_map_lightweight_non_authenticated_entity_dict)
```
