# AttractionNonAuthenticatedEntity
...
attraction_non_authenticated_entity_instance = AttractionNonAuthenticatedEntity.from_json(json)
# print the JSON string representation of the object
print(AttractionNonAuthenticatedEntity.to_json())

# convert the object into a dict
attraction_non_authenticated_entity_dict = attraction_non_authenticated_entity_instance.to_dict()
# create an instance of AttractionNonAuthenticatedEntity from a dict
attraction_non_authenticated_entity_from_dict = AttractionNonAuthenticatedEntity.from_dict(attraction_non_authenticated_entity_dict)
```
