...
class TestUpsertCompanyRequestAffiliate(unittest.TestCase):
    """UpsertCompanyRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertCompanyRequestAffiliate:
        """Test UpsertCompanyRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertCompanyRequestAffiliate`
        """
        model = UpsertCompanyRequestAffiliate()
        if include_optional:
            return UpsertCompanyRequestAffiliate(
                name = 'Company 1',
    ...
    def testUpsertCompanyRequestAffiliate(self):
        """Test UpsertCompanyRequestAffiliate"""
