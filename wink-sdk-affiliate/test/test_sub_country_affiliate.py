...
class TestSubCountryAffiliate(unittest.TestCase):
    """SubCountryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubCountryAffiliate:
        """Test SubCountryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubCountryAffiliate`
        """
        model = SubCountryAffiliate()
        if include_optional:
            return SubCountryAffiliate(
                name = 'New York',
                ascii_name = 'New York',
                geo_name_id = '5128638'
            )
    ...
    def testSubCountryAffiliate(self):
        """Test SubCountryAffiliate"""
