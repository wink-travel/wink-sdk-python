...
class TestPaddingSupplier(unittest.TestCase):
    """PaddingSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaddingSupplier:
        """Test PaddingSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaddingSupplier`
        """
        model = PaddingSupplier()
        if include_optional:
            return PaddingSupplier(
                top = 1.337,
                right = 1.337,
                bottom = 1.337,
                left = 1.337
