...
class TestUniqueResultAffiliate(unittest.TestCase):
    """UniqueResultAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueResultAffiliate:
        """Test UniqueResultAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueResultAffiliate`
        """
        model = UniqueResultAffiliate()
        if include_optional:
    ...
    def testUniqueResultAffiliate(self):
        """Test UniqueResultAffiliate"""
