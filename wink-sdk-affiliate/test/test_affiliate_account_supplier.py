...
class TestAffiliateAccountSupplier(unittest.TestCase):
    """AffiliateAccountSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AffiliateAccountSupplier:
        """Test AffiliateAccountSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AffiliateAccountSupplier`
        """
        model = AffiliateAccountSupplier()
        if include_optional:
    ...
    def testAffiliateAccountSupplier(self):
        """Test AffiliateAccountSupplier"""
