...
class TestCompanyAffiliate(unittest.TestCase):
    """CompanyAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyAffiliate:
        """Test CompanyAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyAffiliate`
        """
        model = CompanyAffiliate()
        if include_optional:
