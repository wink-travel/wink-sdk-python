...
class TestAffiliateAccountUserAffiliate(unittest.TestCase):
    """AffiliateAccountUserAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AffiliateAccountUserAffiliate:
        """Test AffiliateAccountUserAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AffiliateAccountUserAffiliate`
        """
        model = AffiliateAccountUserAffiliate()
        if include_optional:
            return AffiliateAccountUserAffiliate(
    ...
    def testAffiliateAccountUserAffiliate(self):
        """Test AffiliateAccountUserAffiliate"""
