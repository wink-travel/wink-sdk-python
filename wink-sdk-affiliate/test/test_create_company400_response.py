...
class TestCreateCompany400Response(unittest.TestCase):
    """CreateCompany400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCompany400Response:
        """Test CreateCompany400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCompany400Response`
        """
        model = CreateCompany400Response()
        if include_optional:
            return CreateCompany400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testCreateCompany400Response(self):
        """Test CreateCompany400Response"""
