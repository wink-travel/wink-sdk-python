...
class TestCompanyViewAffiliate(unittest.TestCase):
    """CompanyViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyViewAffiliate:
        """Test CompanyViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyViewAffiliate`
        """
        model = CompanyViewAffiliate()
        if include_optional:
            return CompanyViewAffiliate(
                ...
                version = 12,
                company = wink_sdk_affiliate.models.company_affiliate.Company_Affiliate(
                    identifier = '', 
                    user_identifier = '', 
                    owner = wink_sdk_affiliate.models.company_user_affiliate.CompanyUser_Affiliate(
                    ...
                    address = wink_sdk_affiliate.models.address_affiliate.Address_Affiliate(
                        ...
                        city = wink_sdk_affiliate.models.geo_name_affiliate.GeoName_Affiliate(
                            geo_name_id = '5128581', 
                            type = 'CITY', 
                            name = 'New York City', 
                            ...
                            country = wink_sdk_affiliate.models.country_affiliate.Country_Affiliate(
                                iso = 'US', 
                                name = 'United States', 
                                capital = 'Washington', 
                                continent = 'NA', 
                                ...
                                geo_name_id = '6252001', ), 
                            sub_country = wink_sdk_affiliate.models.sub_country_affiliate.SubCountry_Affiliate(
                                name = 'New York', 
                                ascii_name = 'New York', 
                                geo_name_id = '5128638', ), 
                            sub_sub_country = wink_sdk_affiliate.models.sub_sub_country_affiliate.SubSubCountry_Affiliate(
                                name = '', 
                                ascii_name = '', 
                                geo_name_id = '', ), ), 
                        valid = True, 
                    ...
                    managers = [
                        wink_sdk_affiliate.models.company_user_affiliate.CompanyUser_Affiliate(
                            email = 'manager@me.com', 
                            status = '+12125551212', 
                            user_identifier = '', 
                            first_name = 'John', 
    ...
    def testCompanyViewAffiliate(self):
        """Test CompanyViewAffiliate"""
