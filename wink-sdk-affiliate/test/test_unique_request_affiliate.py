...
class TestUniqueRequestAffiliate(unittest.TestCase):
    """UniqueRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueRequestAffiliate:
        """Test UniqueRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueRequestAffiliate`
        """
        model = UniqueRequestAffiliate()
        if include_optional:
            return UniqueRequestAffiliate(
                name = 'My unique name',
                identifier = ''
            )
        else:
    ...
    def testUniqueRequestAffiliate(self):
        """Test UniqueRequestAffiliate"""
