...
class TestCompanyUserAffiliate(unittest.TestCase):
    """CompanyUserAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyUserAffiliate:
        """Test CompanyUserAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyUserAffiliate`
        """
        model = CompanyUserAffiliate()
        if include_optional:
            return CompanyUserAffiliate(
    ...
    def testCompanyUserAffiliate(self):
        """Test CompanyUserAffiliate"""
