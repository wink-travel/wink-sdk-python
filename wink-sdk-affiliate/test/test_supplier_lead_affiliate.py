    ...
    def make_instance(self, include_optional) -> SupplierLeadAffiliate:
        ...
        if include_optional:
            return SupplierLeadAffiliate(
                ...
                version = 12,
                user = wink_sdk_affiliate.models.key_value_pair_affiliate.KeyValuePair_Affiliate(
                    value = 'id-1', 
                    label = 'Readable text label', ),
                owner = wink_sdk_affiliate.models.key_value_pair_affiliate.KeyValuePair_Affiliate(
                    value = 'id-1', 
                    label = 'Readable text label', ),
                status = 'CREATED',
                place_id = 'place-1',
                ...
                address = wink_sdk_affiliate.models.address_affiliate.Address_Affiliate(
                    ...
                    valid = True, 
                    full_address = '11', ),
                address_local = wink_sdk_affiliate.models.simple_address_affiliate.SimpleAddress_Affiliate(
                    address1 = '234', 
                    address2 = 'Pebble #5001', 
                    state = 'CA', 
                    postal_code = '90210', 
                ...
                location = {type=POINT, coordinates=[100.5581533, 13.7370197]},
                photos = [
                    wink_sdk_affiliate.models.simple_multimedia_affiliate.SimpleMultimedia_Affiliate(
