...
class TestOnlinePresenceAffiliate(unittest.TestCase):
    """OnlinePresenceAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnlinePresenceAffiliate:
        """Test OnlinePresenceAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnlinePresenceAffiliate`
        """
        model = OnlinePresenceAffiliate()
        if include_optional:
            return OnlinePresenceAffiliate(
                type = 'WINK',
                identifier = '',
                audiences = [
                    'EVERYONE'
    ...
    def testOnlinePresenceAffiliate(self):
        """Test OnlinePresenceAffiliate"""
