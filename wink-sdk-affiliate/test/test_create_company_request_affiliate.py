...
class TestCreateCompanyRequestAffiliate(unittest.TestCase):
    """CreateCompanyRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCompanyRequestAffiliate:
        """Test CreateCompanyRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCompanyRequestAffiliate`
        """
        model = CreateCompanyRequestAffiliate()
        if include_optional:
            return CreateCompanyRequestAffiliate(
                name = 'Company 1',
    ...
    def testCreateCompanyRequestAffiliate(self):
        """Test CreateCompanyRequestAffiliate"""
