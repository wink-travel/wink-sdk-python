...
class TestAggregateDescriptorSupplier(unittest.TestCase):
    """AggregateDescriptorSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateDescriptorSupplier:
        """Test AggregateDescriptorSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateDescriptorSupplier`
        """
        model = AggregateDescriptorSupplier()
        if include_optional:
            return AggregateDescriptorSupplier(
    ...
    def testAggregateDescriptorSupplier(self):
        """Test AggregateDescriptorSupplier"""
