...
class TestNoteLineSupplier(unittest.TestCase):
    """NoteLineSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteLineSupplier:
        """Test NoteLineSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteLineSupplier`
        """
        model = NoteLineSupplier()
        if include_optional:
            return NoteLineSupplier(
                color = '',
                dash_type = 'dash',
                length = 1.337,
                width = 1.337
