...
class TestAffiliateAccountAgent(unittest.TestCase):
    """AffiliateAccountAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AffiliateAccountAgent:
        """Test AffiliateAccountAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AffiliateAccountAgent`
        """
        model = AffiliateAccountAgent()
        if include_optional:
            return AffiliateAccountAgent(
                ...
                type = 'APPLICATION',
                description = '',
                address = wink_sdk_affiliate.models.address_agent.Address_Agent(
                    address1 = '234', 
                    address2 = 'Pebble #5001', 
                    state = 'CA', 
                    postal_code = '90210', 
                    county = 'Alameda county', 
                    city = wink_sdk_affiliate.models.geo_name_lightweight_agent.GeoNameLightweight_Agent(
                        geo_name_id = '5128581', 
                        type = 'CITY', 
                        name = 'New York City', 
                ...
                logo = wink_sdk_affiliate.models.simple_multimedia_agent.SimpleMultimedia_Agent(
                ...
                travel_agent = wink_sdk_affiliate.models.travel_agent_supplier.TravelAgent_Supplier(
                    self_acquires = True, 
                    self_disburses = True, ),
                managed_by = wink_sdk_affiliate.models.managed_by_entity_agent.ManagedByEntity_Agent(
                    identifier = 'agency-1', 
                    name = 'Agency X', 
    ...
    def testAffiliateAccountAgent(self):
        """Test AffiliateAccountAgent"""
