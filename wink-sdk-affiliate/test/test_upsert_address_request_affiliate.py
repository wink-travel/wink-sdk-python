...
class TestUpsertAddressRequestAffiliate(unittest.TestCase):
    """UpsertAddressRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertAddressRequestAffiliate:
        """Test UpsertAddressRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertAddressRequestAffiliate`
        """
        model = UpsertAddressRequestAffiliate()
        if include_optional:
            return UpsertAddressRequestAffiliate(
    ...
    def testUpsertAddressRequestAffiliate(self):
        """Test UpsertAddressRequestAffiliate"""
