...
class TestChartLegendSupplier(unittest.TestCase):
    """ChartLegendSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartLegendSupplier:
        """Test ChartLegendSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartLegendSupplier`
        """
        model = ChartLegendSupplier()
        if include_optional:
            return ChartLegendSupplier(
                position = ''
            )
        else:
            return ChartLegendSupplier(
    ...
    def testChartLegendSupplier(self):
        """Test ChartLegendSupplier"""
