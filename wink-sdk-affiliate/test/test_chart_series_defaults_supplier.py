...
class TestChartSeriesDefaultsSupplier(unittest.TestCase):
    """ChartSeriesDefaultsSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartSeriesDefaultsSupplier:
        """Test ChartSeriesDefaultsSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartSeriesDefaultsSupplier`
        """
        model = ChartSeriesDefaultsSupplier()
        if include_optional:
            return ChartSeriesDefaultsSupplier(
                type = ''
            )
        else:
            return ChartSeriesDefaultsSupplier(
    ...
    def testChartSeriesDefaultsSupplier(self):
        """Test ChartSeriesDefaultsSupplier"""
