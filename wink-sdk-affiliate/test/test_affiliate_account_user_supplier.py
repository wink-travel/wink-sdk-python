...
class TestAffiliateAccountUserSupplier(unittest.TestCase):
    """AffiliateAccountUserSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AffiliateAccountUserSupplier:
        """Test AffiliateAccountUserSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AffiliateAccountUserSupplier`
        """
        model = AffiliateAccountUserSupplier()
        if include_optional:
            return AffiliateAccountUserSupplier(
    ...
    def testAffiliateAccountUserSupplier(self):
        """Test AffiliateAccountUserSupplier"""
