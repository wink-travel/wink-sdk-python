...
class TestCompanyViewSupplier(unittest.TestCase):
    """CompanyViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyViewSupplier:
        """Test CompanyViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyViewSupplier`
        """
        model = CompanyViewSupplier()
        if include_optional:
    ...
    def testCompanyViewSupplier(self):
        """Test CompanyViewSupplier"""
