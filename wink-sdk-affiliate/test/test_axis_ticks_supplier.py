...
class TestAxisTicksSupplier(unittest.TestCase):
    """AxisTicksSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AxisTicksSupplier:
        """Test AxisTicksSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AxisTicksSupplier`
        """
        model = AxisTicksSupplier()
        if include_optional:
            return AxisTicksSupplier(
                color = '',
                size = 1.337,
                step = 1.337,
                skip = 1.337,
    ...
    def testAxisTicksSupplier(self):
        """Test AxisTicksSupplier"""
