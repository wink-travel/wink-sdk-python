...
class TestUpsertCompanyLogoRequestAffiliate(unittest.TestCase):
    """UpsertCompanyLogoRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertCompanyLogoRequestAffiliate:
        """Test UpsertCompanyLogoRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertCompanyLogoRequestAffiliate`
        """
        model = UpsertCompanyLogoRequestAffiliate()
        if include_optional:
            return UpsertCompanyLogoRequestAffiliate(
    ...
    def testUpsertCompanyLogoRequestAffiliate(self):
        """Test UpsertCompanyLogoRequestAffiliate"""
