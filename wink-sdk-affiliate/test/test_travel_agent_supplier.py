...
class TestTravelAgentSupplier(unittest.TestCase):
    """TravelAgentSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelAgentSupplier:
        """Test TravelAgentSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelAgentSupplier`
        """
        model = TravelAgentSupplier()
        if include_optional:
            return TravelAgentSupplier(
                self_acquires = True,
                self_disburses = True
            )
        else:
    ...
    def testTravelAgentSupplier(self):
        """Test TravelAgentSupplier"""
