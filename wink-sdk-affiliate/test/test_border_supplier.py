...
class TestBorderSupplier(unittest.TestCase):
    """BorderSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BorderSupplier:
        """Test BorderSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BorderSupplier`
        """
        model = BorderSupplier()
        if include_optional:
            return BorderSupplier(
                color = '',
                dash_type = 'dash',
                width = 1.337
            )
