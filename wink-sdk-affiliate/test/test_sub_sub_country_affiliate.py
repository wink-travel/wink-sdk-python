...
class TestSubSubCountryAffiliate(unittest.TestCase):
    """SubSubCountryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubSubCountryAffiliate:
        """Test SubSubCountryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubSubCountryAffiliate`
        """
        model = SubSubCountryAffiliate()
        if include_optional:
            return SubSubCountryAffiliate(
                name = '',
                ascii_name = '',
                geo_name_id = ''
            )
    ...
    def testSubSubCountryAffiliate(self):
        """Test SubSubCountryAffiliate"""
