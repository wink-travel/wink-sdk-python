...
class TestManagedByEntityAffiliate(unittest.TestCase):
    """ManagedByEntityAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedByEntityAffiliate:
        """Test ManagedByEntityAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedByEntityAffiliate`
        """
        model = ManagedByEntityAffiliate()
        if include_optional:
            return ManagedByEntityAffiliate(
                identifier = 'agency-1',
                name = 'Agency X',
    ...
    def testManagedByEntityAffiliate(self):
        """Test ManagedByEntityAffiliate"""
