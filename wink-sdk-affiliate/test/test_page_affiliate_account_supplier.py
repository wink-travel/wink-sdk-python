...
class TestPageAffiliateAccountSupplier(unittest.TestCase):
    """PageAffiliateAccountSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageAffiliateAccountSupplier:
        """Test PageAffiliateAccountSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageAffiliateAccountSupplier`
        """
        model = PageAffiliateAccountSupplier()
        if include_optional:
            return PageAffiliateAccountSupplier(
                ...
                size = 56,
                content = [
                    wink_sdk_affiliate.models.affiliate_account_supplier.AffiliateAccount_Supplier(
                        id = 'doc-1', 
                        created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        version = 12, 
                        user_identifier = 'user-1', 
                        owner = wink_sdk_affiliate.models.affiliate_account_user_affiliate.AffiliateAccountUser_Affiliate(
                        ...
                        address = wink_sdk_affiliate.models.address_supplier.Address_Supplier(
                            ...
                            city = wink_sdk_affiliate.models.geo_name_lightweight_supplier.GeoNameLightweight_Supplier(
                                geo_name_id = '5128581', 
                                type = 'CITY', 
                                name = 'New York City', 
                                ...
                                country = wink_sdk_affiliate.models.country_lightweight_affiliate.CountryLightweight_Affiliate(
                                    iso = 'US', 
                                    name = 'United States', 
                                    capital = 'Washington', 
                                    continent = 'NA', 
                                    ...
                                    geo_name_id = '6252001', ), 
                                sub_country = wink_sdk_affiliate.models.sub_country_lightweight_affiliate.SubCountryLightweight_Affiliate(
                                    name = 'New York', 
                                    ascii_name = 'New York', 
                                    geo_name_id = '5128638', ), 
                                sub_sub_country = wink_sdk_affiliate.models.sub_sub_country_lightweight_affiliate.SubSubCountryLightweight_Affiliate(
                                    name = '', 
                                    ascii_name = '', 
                                    geo_name_id = '', ), ), 
                            valid = True, 
                            full_address = '11', ), 
                        managers = [
                            wink_sdk_affiliate.models.affiliate_account_user_affiliate.AffiliateAccountUser_Affiliate(
                                email = 'manager@me.com', 
                                status = '+12125551212', 
                                user_identifier = '', 
                                first_name = 'John', 
                        ...
                        logo = wink_sdk_affiliate.models.simple_multimedia_supplier.SimpleMultimedia_Supplier(
                            ...
                            attribution = [
                                wink_sdk_affiliate.models.image_attribution_affiliate.ImageAttribution_Affiliate(
                        ...
                        travel_agent = wink_sdk_affiliate.models.travel_agent_supplier.TravelAgent_Supplier(
                            self_acquires = True, 
                            self_disburses = True, ), 
                        managed_by = wink_sdk_affiliate.models.managed_by_entity_supplier.ManagedByEntity_Supplier(
                            identifier = 'agency-1', 
                            name = 'Agency X', 
                            commission_in_percent = 0.01, 
                            rules = wink_sdk_affiliate.models.managed_by_entity_rules_affiliate.ManagedByEntityRules_Affiliate(
                        ...
                        annual_travel_spend_in_dollars = wink_sdk_affiliate.models.custom_monetary_amount.CustomMonetaryAmount(
                            amount = 1.337, 
                            currency = '0', ), 
                        plans = [
                            null
                ...
                sort = wink_sdk_affiliate.models.sort_object_supplier.SortObject_Supplier(
                    empty = True, 
                    unsorted = True, 
                    sorted = True, ),
    ...
    def testPageAffiliateAccountSupplier(self):
        """Test PageAffiliateAccountSupplier"""
