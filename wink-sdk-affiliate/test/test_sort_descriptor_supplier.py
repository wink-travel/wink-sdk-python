...
class TestSortDescriptorSupplier(unittest.TestCase):
    """SortDescriptorSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortDescriptorSupplier:
        """Test SortDescriptorSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortDescriptorSupplier`
        """
        model = SortDescriptorSupplier()
        if include_optional:
            return SortDescriptorSupplier(
                dir = 'asc',
    ...
    def testSortDescriptorSupplier(self):
        """Test SortDescriptorSupplier"""
