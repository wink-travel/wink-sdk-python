...
class TestManagingEntityProvisionAffiliate(unittest.TestCase):
    """ManagingEntityProvisionAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityProvisionAffiliate:
        """Test ManagingEntityProvisionAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityProvisionAffiliate`
        """
        model = ManagingEntityProvisionAffiliate()
        if include_optional:
            return ManagingEntityProvisionAffiliate(
    ...
    def testManagingEntityProvisionAffiliate(self):
        """Test ManagingEntityProvisionAffiliate"""
