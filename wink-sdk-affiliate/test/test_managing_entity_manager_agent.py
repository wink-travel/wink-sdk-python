...
class TestManagingEntityManagerAgent(unittest.TestCase):
    """ManagingEntityManagerAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityManagerAgent:
        """Test ManagingEntityManagerAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityManagerAgent`
        """
        model = ManagingEntityManagerAgent()
        if include_optional:
            return ManagingEntityManagerAgent(
    ...
    def testManagingEntityManagerAgent(self):
        """Test ManagingEntityManagerAgent"""
