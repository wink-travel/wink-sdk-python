...
class TestGridLinesSupplier(unittest.TestCase):
    """GridLinesSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GridLinesSupplier:
        """Test GridLinesSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GridLinesSupplier`
        """
        model = GridLinesSupplier()
        if include_optional:
            return GridLinesSupplier(
                color = '',
                dash_type = 'dash',
                skip = 1.337,
                step = 1.337,
    ...
    def testGridLinesSupplier(self):
        """Test GridLinesSupplier"""
