...
class TestManagedByEntityAgent(unittest.TestCase):
    """ManagedByEntityAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedByEntityAgent:
        """Test ManagedByEntityAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedByEntityAgent`
        """
        model = ManagedByEntityAgent()
        if include_optional:
            return ManagedByEntityAgent(
                identifier = 'agency-1',
                name = 'Agency X',
    ...
    def testManagedByEntityAgent(self):
        """Test ManagedByEntityAgent"""
