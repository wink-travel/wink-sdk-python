...
class TestCompanyUserSupplier(unittest.TestCase):
    """CompanyUserSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyUserSupplier:
        """Test CompanyUserSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyUserSupplier`
        """
        model = CompanyUserSupplier()
        if include_optional:
    ...
    def testCompanyUserSupplier(self):
        """Test CompanyUserSupplier"""
