...
class TestUpdateTravelAgentRequestAgent(unittest.TestCase):
    """UpdateTravelAgentRequestAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTravelAgentRequestAgent:
        """Test UpdateTravelAgentRequestAgent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTravelAgentRequestAgent`
        """
        model = UpdateTravelAgentRequestAgent()
        if include_optional:
            return UpdateTravelAgentRequestAgent(
                self_acquires = True,
                self_disburses = True
            )
        else:
    ...
    def testUpdateTravelAgentRequestAgent(self):
        """Test UpdateTravelAgentRequestAgent"""
