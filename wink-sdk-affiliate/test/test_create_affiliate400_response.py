...
class TestCreateAffiliate400Response(unittest.TestCase):
    """CreateAffiliate400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAffiliate400Response:
        """Test CreateAffiliate400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAffiliate400Response`
        """
        model = CreateAffiliate400Response()
        if include_optional:
            return CreateAffiliate400Response(
                status = 56,
                error = '',
                message = '',
                timestamp = ''
    ...
    def testCreateAffiliate400Response(self):
        """Test CreateAffiliate400Response"""
