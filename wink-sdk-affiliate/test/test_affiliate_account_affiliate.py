...
class TestAffiliateAccountAffiliate(unittest.TestCase):
    """AffiliateAccountAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AffiliateAccountAffiliate:
        """Test AffiliateAccountAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AffiliateAccountAffiliate`
        """
        model = AffiliateAccountAffiliate()
        if include_optional:
            return AffiliateAccountAffiliate(
                ...
                type = 'APPLICATION',
                description = '',
                address = wink_sdk_affiliate.models.address_affiliate.Address_Affiliate(
                    address1 = '234', 
    ...
    def testAffiliateAccountAffiliate(self):
        """Test AffiliateAccountAffiliate"""
