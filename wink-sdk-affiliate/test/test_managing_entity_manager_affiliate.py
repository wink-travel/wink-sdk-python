...
class TestManagingEntityManagerAffiliate(unittest.TestCase):
    """ManagingEntityManagerAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityManagerAffiliate:
        """Test ManagingEntityManagerAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityManagerAffiliate`
        """
        model = ManagingEntityManagerAffiliate()
        if include_optional:
            return ManagingEntityManagerAffiliate(
    ...
    def testManagingEntityManagerAffiliate(self):
        """Test ManagingEntityManagerAffiliate"""
