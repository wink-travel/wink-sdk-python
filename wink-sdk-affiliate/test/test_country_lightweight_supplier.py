...
class TestCountryLightweightSupplier(unittest.TestCase):
    """CountryLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryLightweightSupplier:
        """Test CountryLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryLightweightSupplier`
        """
        model = CountryLightweightSupplier()
        if include_optional:
            return CountryLightweightSupplier(
                iso = 'US',
                name = 'United States',
                capital = 'Washington',
                continent = 'NA',
    ...
    def testCountryLightweightSupplier(self):
        """Test CountryLightweightSupplier"""
