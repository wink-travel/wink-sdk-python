...
class TestManagerInviteAcceptedSupplier(unittest.TestCase):
    """ManagerInviteAcceptedSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagerInviteAcceptedSupplier:
        """Test ManagerInviteAcceptedSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagerInviteAcceptedSupplier`
        """
        model = ManagerInviteAcceptedSupplier()
        if include_optional:
    ...
    def testManagerInviteAcceptedSupplier(self):
        """Test ManagerInviteAcceptedSupplier"""
