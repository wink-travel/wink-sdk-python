...
class AccountManagerApi:
    ...
    def accept_manager_invite(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Company identifier for which to accept invite to")],
        ...
        :param company_identifier: Company identifier for which to accept invite to (required)
    ...
    def invite_manager(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Invite user to manage company with given identifier")],
        ...
        :param company_identifier: Invite user to manage company with given identifier (required)
        :type company_identifier: str
    ...
    def _invite_manager_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/affiliate/{companyIdentifier}/manager/invite',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def reject_invite_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CompanyViewSupplier]:
        """Reject Invite
    ...
    def remove_company_user(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Remove manager from company with given identifier")],
        email: StrictStr,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        :param company_identifier: Remove manager from company with given identifier (required)
        :type company_identifier: str
    ...
    def _remove_company_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/affiliate/{companyIdentifier}/manager/{email}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
