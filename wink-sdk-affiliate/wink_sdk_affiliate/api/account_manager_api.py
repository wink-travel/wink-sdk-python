...
class AccountManagerApi:
    ...
    def accept_manager_invite(
        self,
        company_identifier: Annotated[StrictStr, Field(description="AffiliateAccountLightweight identifier for which to accept invite to")],
        ...
        :param company_identifier: AffiliateAccountLightweight identifier for which to accept invite to (required)
