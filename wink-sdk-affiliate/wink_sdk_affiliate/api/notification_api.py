...
class NotificationApi:
    ...
    def remove_notification_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NotificationAffiliate]:
        """Delete Notification
    ...
    def show_notifications(
        ...
        app: Annotated[Optional[StrictStr], Field(description="Show all messages for this application")] = None,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '400': "CreateAffiliate400Response",
            '500': "object",
            '200': "List[NotificationAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_notifications_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[NotificationAffiliate]]:
        """Show Notifications
