...
class TravelAgentApi:
    ...
    def update_agent(
        ...
        update_travel_agent_request_agent: UpdateTravelAgentRequestAgent,
        ...
        :param update_travel_agent_request_agent: (required)
        :type update_travel_agent_request_agent: UpdateTravelAgentRequestAgent
        :param wink_version:
        ...
        _param = self._update_agent_serialize(
            ...
            update_travel_agent_request_agent=update_travel_agent_request_agent,
    ...
    def _update_agent_serialize(
        self,
        company_identifier,
        update_travel_agent_request_agent,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if update_travel_agent_request_agent is not None:
            _body_params = update_travel_agent_request_agent
