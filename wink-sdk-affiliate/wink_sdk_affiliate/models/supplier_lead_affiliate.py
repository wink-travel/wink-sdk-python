...
class SupplierLeadAffiliate(BaseModel):
    ...
    address: Optional[SimpleAddressAffiliate] = Field(default=None, description="Address in English")
    ...
    city_options: Optional[List[GeoNameLightweightAffiliate]] = Field(default=None, alias="cityOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cityOptions": [GeoNameLightweightAffiliate.from_dict(_item) for _item in obj["cityOptions"]] if obj.get("cityOptions") is not None else None
        })
        return _obj
