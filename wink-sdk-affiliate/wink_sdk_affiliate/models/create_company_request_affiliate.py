...
class CreateCompanyRequestAffiliate(BaseModel):
    """
    ...
    vat_id: StrictStr = Field(description="A VAT id if required", alias="vatID")
    ...
    travel_agent: Optional[Dict[str, Any]] = Field(default=None, description="If the company type is travel agent, this object will be filled out too.", alias="travelAgent")
    __properties: ClassVar[List[str]] = ["name", "legalName", "companyType", "type", "vatID", "description", "url", "cityGeoNameId", "urls", "travelAgent"]
