...
class AffiliateAccountSupplier(BaseModel):
    """
    ...
    user_identifier: UUID = Field(description="User or Registered client owner identifier that created this record", alias="userIdentifier")
    owner: AffiliateAccountUserSupplier = Field(description="Owner")
    ...
    enabled: StrictBool = Field(description="Whether this company is enabled by platform.")
    ...
    managers: Optional[Annotated[List[AffiliateAccountUserSupplier], Field(min_length=0, max_length=30)]] = None
    logo: Optional[SimpleMultimediaSupplier] = Field(default=None, description="Customize account with a custom logo / profile picture.")
    travel_agent: Optional[TravelAgentSupplier] = Field(default=None, description="Customize account with a custom logo / profile picture.", alias="travelAgent")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "owner", "name", "urlName", "uniqueId", "legalName", "enabled", "approved", "companyType", "type", "description", "address", "managers", "logo", "travelAgent", "managedBy", "onlinePresence", "annualTravelSpendInDollars", "plans", "previousUrlNameList", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner": AffiliateAccountUserSupplier.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "name": obj.get("name"),
            ...
            "managers": [AffiliateAccountUserSupplier.from_dict(_item) for _item in obj["managers"]] if obj.get("managers") is not None else None,
            "logo": SimpleMultimediaSupplier.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
            "travelAgent": TravelAgentSupplier.from_dict(obj["travelAgent"]) if obj.get("travelAgent") is not None else None,
