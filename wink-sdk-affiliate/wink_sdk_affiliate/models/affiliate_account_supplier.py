...
class AffiliateAccountSupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "owner", "name", "urlName", "uniqueId", "legalName", "enabled", "approved", "companyType", "type", "description", "address", "managers", "logo", "travelAgent", "managedBy", "onlinePresence", "annualTravelSpendInDollars", "plans", "previousUrlNameList"]
