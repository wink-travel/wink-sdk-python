...
class CreateAffiliateAccountRequestAffiliate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "legalName", "urlName", "companyType", "type", "description", "cityGeoNameId", "travelAgent", "onlinePresence", "annualTravelSpendInDollars"]
