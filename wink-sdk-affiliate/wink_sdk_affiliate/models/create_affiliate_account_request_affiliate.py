...
class CreateAffiliateAccountRequestAffiliate(BaseModel):
    """
    ...
    url_name: Optional[StrictStr] = Field(default=None, description="Url slug of entity", alias="urlName")
    unique_id: Optional[StrictStr] = Field(default=None, description="Unique short ID of entity", alias="uniqueId")
    company_type: StrictStr = Field(description="Type of company", alias="companyType")
    type: StrictStr = Field(description="Type of company")
    ...
    travel_agent: Optional[Any] = Field(default=None, alias="travelAgent")
    online_presence: Optional[List[Any]] = Field(default=None, alias="onlinePresence")
    annual_travel_spend_in_dollars: Optional[StrictInt] = Field(default=None, description="How much user or company spends on travel per year.", alias="annualTravelSpendInDollars")
    __properties: ClassVar[List[str]] = ["name", "legalName", "urlName", "uniqueId", "companyType", "type", "description", "cityGeoNameId", "travelAgent", "onlinePresence", "annualTravelSpendInDollars"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "annualTravelSpendInDollars": obj.get("annualTravelSpendInDollars")
        })
        return _obj
