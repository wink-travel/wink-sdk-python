...
class ManagedByEntitySupplier(BaseModel):
    ...
    """ # noqa: E501
    identifier: StrictStr = Field(description="Entity identifier")
    name: StrictStr = Field(description="Name of entity")
    commission_in_percent: Union[StrictFloat, StrictInt] = Field(description="Agency commission", alias="commissionInPercent")
    rules: Optional[ManagedByEntityRulesSupplier] = None
