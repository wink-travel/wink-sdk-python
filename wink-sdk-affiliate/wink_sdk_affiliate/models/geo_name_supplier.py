...
class GeoNameSupplier(BaseModel):
    """
    ...
    country: Optional[CountrySupplier] = None
    sub_country: Optional[SubCountrySupplier] = Field(default=None, alias="subCountry")
    sub_sub_country: Optional[SubSubCountrySupplier] = Field(default=None, alias="subSubCountry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "country": CountrySupplier.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "subCountry": SubCountrySupplier.from_dict(obj["subCountry"]) if obj.get("subCountry") is not None else None,
            "subSubCountry": SubSubCountrySupplier.from_dict(obj["subSubCountry"]) if obj.get("subSubCountry") is not None else None
        })
        return _obj
