...
class UpsertManagedByAgencyRequestAffiliate(BaseModel):
    """
    UpsertManagedByAgencyRequestAffiliate
    """ # noqa: E501
    managing_entity_identifier: StrictStr = Field(description="Existing user account managingEntityIdentifier to make manager", alias="managingEntityIdentifier")
    commission_in_percent: Union[StrictFloat, StrictInt] = Field(description="Agency commission", alias="commissionInPercent")
    rules: Optional[ManagedByEntityRulesAffiliate] = None
