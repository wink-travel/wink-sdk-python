...
class AffiliateAccountAffiliate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "managingEntityIdentifier", "ownerIdentifier", "managers", "managedBy", "ownerType", "type", "name", "urlName", "uniqueId", "description", "currencyCode", "city", "placeId", "profilePicture", "status", "logo", "onlinePresence", "annualTravelSpendInDollars"]
