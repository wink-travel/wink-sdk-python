...
class CompanyAffiliate(BaseModel):
    """
    ...
    managers: Optional[Annotated[List[CompanyUserAffiliate], Field(min_length=0, max_length=30)]] = None
    logo: Optional[SimpleMultimediaAffiliate] = None
    managed_by: Optional[ManagedByEntityAffiliate] = Field(default=None, alias="managedBy")
    online_presence: Optional[List[OnlinePresenceAffiliate]] = Field(default=None, alias="onlinePresence")
    annual_travel_spend_in_dollars: Optional[CustomMonetaryAmount] = Field(default=None, alias="annualTravelSpendInDollars")
    __properties: ClassVar[List[str]] = ["identifier", "userIdentifier", "owner", "name", "urlName", "legalName", "enabled", "approved", "companyType", "type", "description", "address", "managers", "logo", "managedBy", "onlinePresence", "annualTravelSpendInDollars"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner": CompanyUserAffiliate.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "name": obj.get("name"),
            ...
            "managers": [CompanyUserAffiliate.from_dict(_item) for _item in obj["managers"]] if obj.get("managers") is not None else None,
            ...
            "onlinePresence": [OnlinePresenceAffiliate.from_dict(_item) for _item in obj["onlinePresence"]] if obj.get("onlinePresence") is not None else None,
