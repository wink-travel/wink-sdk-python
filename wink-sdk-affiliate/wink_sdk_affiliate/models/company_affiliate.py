...
class CompanyAffiliate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identifier", "userIdentifier", "owner", "name", "urlName", "legalName", "enabled", "approved", "companyType", "type", "vatID", "description", "url", "address", "managers", "urls", "logo"]
