...
class ManagingEntitySupplier(BaseModel):
    ...
    managers: Annotated[List[ManagingEntityManagerAffiliate], Field(min_length=0, max_length=30)]
    ...
    city: GeoNameLightweightAffiliate = Field(description="City location")
    address: Optional[SimpleAddressAffiliate] = Field(default=None, description="Account address. Usually the business address")
    plan: Optional[ManagingEntityProvisionAffiliate] = Field(default=None, description="Optional subscription for this entity.")
    profile_picture: Optional[SimpleMultimediaAffiliate] = Field(default=None, description="Customize account with a custom profile picture.", alias="profilePicture")
    logo: Optional[SimpleMultimediaAffiliate] = Field(default=None, description="Entity logo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "managers": [ManagingEntityManagerAffiliate.from_dict(_item) for _item in obj["managers"]] if obj.get("managers") is not None else None,
            ...
            "plan": ManagingEntityProvisionAffiliate.from_dict(obj["plan"]) if obj.get("plan") is not None else None,
            "profilePicture": SimpleMultimediaAffiliate.from_dict(obj["profilePicture"]) if obj.get("profilePicture") is not None else None,
