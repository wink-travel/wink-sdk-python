...
class CompanySupplier(BaseModel):
    ...
    vat_id: StrictStr = Field(description="An optional VAT ID", alias="vatID")
    description: Optional[StrictStr] = Field(default=None, description="A personal message from the company.")
    url: StrictStr = Field(description="Company's main website")
    address: AddressSupplier
    managers: Optional[Annotated[List[CompanyUserSupplier], Field(min_length=0, max_length=30)]] = None
    urls: Optional[List[StrictStr]] = Field(default=None, description="List of all active accounts that could be used for selling or seeing a company's reach.")
    logo: Optional[SimpleMultimediaSupplier] = None
    travel_agent: Optional[TravelAgentSupplier] = Field(default=None, alias="travelAgent")
    __properties: ClassVar[List[str]] = ["identifier", "userIdentifier", "owner", "name", "urlName", "legalName", "enabled", "approved", "companyType", "type", "vatID", "description", "url", "address", "managers", "urls", "logo", "travelAgent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner": CompanyUserSupplier.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "name": obj.get("name"),
            ...
            "managers": [CompanyUserSupplier.from_dict(_item) for _item in obj["managers"]] if obj.get("managers") is not None else None,
            "urls": obj.get("urls"),
