...
class CategoryAxisCrosshairSupplier(BaseModel):
    """
    ...
    tooltip: Optional[CategoryAxisCrosshairTooltipSupplier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "width": obj.get("width"),
            "tooltip": CategoryAxisCrosshairTooltipSupplier.from_dict(obj["tooltip"]) if obj.get("tooltip") is not None else None
        })
        return _obj
