...
class CategoryAxisTitleSupplier(BaseModel):
    """
    Title of axis
    """ # noqa: E501
    background: Optional[StrictStr] = None
    border: Optional[BorderSupplier] = None
    color: Optional[StrictStr] = None
    font: Optional[StrictStr] = None
    margin: Optional[MarginSupplier] = None
    padding: Optional[PaddingSupplier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "border": BorderSupplier.from_dict(obj["border"]) if obj.get("border") is not None else None,
            "color": obj.get("color"),
            "font": obj.get("font"),
            "margin": MarginSupplier.from_dict(obj["margin"]) if obj.get("margin") is not None else None,
            "padding": PaddingSupplier.from_dict(obj["padding"]) if obj.get("padding") is not None else None,
