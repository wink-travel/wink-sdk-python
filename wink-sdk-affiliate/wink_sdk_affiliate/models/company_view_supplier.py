...
class CompanyViewSupplier(BaseModel):
    """
    CompanyViewSupplier
    """ # noqa: E501
    ...
    company: CompanySupplier
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "company"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "company": CompanySupplier.from_dict(obj["company"]) if obj.get("company") is not None else None
        })
        return _obj
