...
class ManagingEntityManagerAffiliate(BaseModel):
    """
    ...
    profile_picture: Optional[SimpleMultimediaAffiliate] = Field(default=None, description="Profile picture is available", alias="profilePicture")
