...
class OnlinePresenceAgent(BaseModel):
    """
    OnlinePresenceAgent
    """ # noqa: E501
    type: StrictStr = Field(description="List of all active accounts that could be used for selling or seeing a company's reach.")
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The url, account name or phone number that identifies this user with the specified network.")
    audiences: Optional[List[StrictStr]] = Field(default=None, description="The type of audience you have on this network.")
    audience_size: Optional[StrictInt] = Field(default=None, description="The size of your audience.", alias="audienceSize")
    sort: Optional[StrictInt] = Field(default=None, description="How you would like to order your accounts.")
    disabled: StrictBool = Field(description="The url, account name or phone number that identifies this user with the specified network.")
    __properties: ClassVar[List[str]] = ["type", "identifier", "audiences", "audienceSize", "sort", "disabled"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['WINK', 'WEB_SITE', 'PERSONAL_WEB_SITE', 'CORPORATE_WEB_SITE', 'FACEBOOK', 'INSTAGRAM', 'TWITTER_X', 'LINKEDIN', 'TIKTOK', 'SNAPCHAT', 'MASTODON', 'THREADS', 'HIVE_SOCIAL', 'MEWE', 'ELLO', 'WHATSAPP', 'TELEGRAM', 'SIGNAL', 'WECHAT', 'LINE', 'KAKAOTALK', 'VIBER', 'DISCORD', 'SKYPE', 'FACEBOOK_MESSENGER', 'YOUTUBE', 'TWITCH', 'BILIBILI', 'VIMEO', 'DAILYMOTION', 'KICK', 'UPLIVE', 'PINTEREST', 'BEREAL', 'VSCO', 'IMGUR', 'FLICKR', 'FIVE_HUNDRED_PX', 'REDDIT', 'QUORA', 'TUMBLR', 'PLURK', 'MEDIUM', 'BLUESKY', 'MINDS', 'STEEMIT', 'DIASPORA', 'WHISPER', 'YIK_YAK', 'TELLONYM', 'GOOGLE', 'GITHUB', 'SPOTIFY', 'UPWORK', 'SHOPIFY', 'AMAZON', 'PERSONAL_EMAIL', 'WORK_EMAIL', 'ONLY_FANS', 'FANSLY']):
            raise ValueError("must be one of enum values ('WINK', 'WEB_SITE', 'PERSONAL_WEB_SITE', 'CORPORATE_WEB_SITE', 'FACEBOOK', 'INSTAGRAM', 'TWITTER_X', 'LINKEDIN', 'TIKTOK', 'SNAPCHAT', 'MASTODON', 'THREADS', 'HIVE_SOCIAL', 'MEWE', 'ELLO', 'WHATSAPP', 'TELEGRAM', 'SIGNAL', 'WECHAT', 'LINE', 'KAKAOTALK', 'VIBER', 'DISCORD', 'SKYPE', 'FACEBOOK_MESSENGER', 'YOUTUBE', 'TWITCH', 'BILIBILI', 'VIMEO', 'DAILYMOTION', 'KICK', 'UPLIVE', 'PINTEREST', 'BEREAL', 'VSCO', 'IMGUR', 'FLICKR', 'FIVE_HUNDRED_PX', 'REDDIT', 'QUORA', 'TUMBLR', 'PLURK', 'MEDIUM', 'BLUESKY', 'MINDS', 'STEEMIT', 'DIASPORA', 'WHISPER', 'YIK_YAK', 'TELLONYM', 'GOOGLE', 'GITHUB', 'SPOTIFY', 'UPWORK', 'SHOPIFY', 'AMAZON', 'PERSONAL_EMAIL', 'WORK_EMAIL', 'ONLY_FANS', 'FANSLY')")
        return value

    @field_validator('audiences')
    def audiences_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        for i in value:
            if i not in set(['EVERYONE', 'ADVENTURE', 'BEACH', 'BUSINESS', 'CULTURAL_EXPERIENCE', 'EDUCATION', 'FAMILY', 'FOOD_AND_CULINARY', 'HIKING', 'HISTORICAL_SITES', 'HONEYMOON', 'LUXURY', 'MEDICAL_TOURISM', 'MUSIC_AND_FESTIVALS', 'NATURE_AND_WILDLIFE', 'PHOTOGRAPHY', 'PILGRIMAGE', 'RELAXATION', 'ROAD_TRIP', 'ROMANCE', 'SHOPPING', 'SKIING', 'SOLO_TRAVEL', 'SPORTS_EVENTS', 'VOLUNTEERING', 'WELLNESS_AND_SPA', 'CITY', 'WILDLIFE']):
                raise ValueError("each list item must be one of ('EVERYONE', 'ADVENTURE', 'BEACH', 'BUSINESS', 'CULTURAL_EXPERIENCE', 'EDUCATION', 'FAMILY', 'FOOD_AND_CULINARY', 'HIKING', 'HISTORICAL_SITES', 'HONEYMOON', 'LUXURY', 'MEDICAL_TOURISM', 'MUSIC_AND_FESTIVALS', 'NATURE_AND_WILDLIFE', 'PHOTOGRAPHY', 'PILGRIMAGE', 'RELAXATION', 'ROAD_TRIP', 'ROMANCE', 'SHOPPING', 'SKIING', 'SOLO_TRAVEL', 'SPORTS_EVENTS', 'VOLUNTEERING', 'WELLNESS_AND_SPA', 'CITY', 'WILDLIFE')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "audienceSize": obj.get("audienceSize"),
            "sort": obj.get("sort"),
