...
class LineChartSupplier(BaseModel):
    ...
    title: Optional[ChartTitleSupplier] = None
    legend: Optional[ChartLegendSupplier] = None
    ...
    x_axis: Optional[ChartCategoryAxisSupplier] = Field(default=None, alias="xAxis")
