...
class UniqueRequestAffiliate(BaseModel):
    """
    UniqueRequestAffiliate
    """ # noqa: E501
    name: StrictStr = Field(description="The name we want to check uniqueness for")
    identifier: Optional[StrictStr] = Field(default=None, description="An optional accompanying identifier so it doesn't check itself on an update")
