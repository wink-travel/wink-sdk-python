...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.34#egg=wink_sdk_affiliate&subdirectory=wink-sdk-affiliate
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.34#egg=wink_sdk_affiliate&subdirectory=wink_sdk_affiliate`)
