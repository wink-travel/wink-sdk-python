...
class ItemsApi:
    ...
    def create_supplier_seller_inventory_item(
        self,
        upsert_supplier_sellable_item_request_affiliate: UpsertSupplierSellableItemRequestAffiliate,
        ...
        :param upsert_supplier_sellable_item_request_affiliate: (required)
        :type upsert_supplier_sellable_item_request_affiliate: UpsertSupplierSellableItemRequestAffiliate
        :param wink_version:
        ...
        _param = self._create_supplier_seller_inventory_item_serialize(
            upsert_supplier_sellable_item_request_affiliate=upsert_supplier_sellable_item_request_affiliate,
    ...
    def create_supplier_seller_inventory_item_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SellableItemAffiliate]:
        """Create Supplier Item
    ...
    def _create_supplier_seller_inventory_item_serialize(
        self,
        upsert_supplier_sellable_item_request_affiliate,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if upsert_supplier_sellable_item_request_affiliate is not None:
            _body_params = upsert_supplier_sellable_item_request_affiliate
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/item/supplier',
    ...
    def _remove_seller_inventory_item_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/item/{inventoryIdentifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_inventory_media1(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSupplierUrl400Response",
            '200': "List[SimpleMultimediaAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _show_inventory_media1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/item/inventory/{channelInventoryIdentifier}/media/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_seller_inventory_items_for_company(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSupplierUrl400Response",
            '200': "List[SellableItemAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_seller_inventory_items_for_company_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SellableItemAffiliate]]:
        """Show Items
    ...
    def update_seller_inventory_item(
        ...
        upsert_sellable_item_request_affiliate: UpsertSellableItemRequestAffiliate,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type inventory_identifier: str
        :param upsert_sellable_item_request_affiliate: (required)
        :type upsert_sellable_item_request_affiliate: UpsertSellableItemRequestAffiliate
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._update_seller_inventory_item_serialize(
            inventory_identifier=inventory_identifier,
            upsert_sellable_item_request_affiliate=upsert_sellable_item_request_affiliate,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _update_seller_inventory_item_serialize(
        self,
        inventory_identifier,
        upsert_sellable_item_request_affiliate,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if upsert_sellable_item_request_affiliate is not None:
            _body_params = upsert_sellable_item_request_affiliate
