...
class ItemsApi:
    ...
    def create_seller_inventory_item(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '201': "SellerInventoryItemViewAffiliate",
        }
    ...
    def _create_seller_inventory_item_serialize(
        ...
        if upsert_seller_inventory_item_request_affiliate is not None:
            _body_params = upsert_seller_inventory_item_request_affiliate
    ...
    def _create_seller_inventory_item_syndication_entry_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_seller_inventory_item_syndication_entry_request_affiliate is not None:
            _body_params = create_seller_inventory_item_syndication_entry_request_affiliate
    ...
    def _create_supplier_seller_inventory_item_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if upsert_supplier_seller_inventory_item_request_affiliate is not None:
            _body_params = upsert_supplier_seller_inventory_item_request_affiliate
    ...
    def remove_seller_inventory_item(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSupplierUrl400Response",
            '200': "SellerInventoryItemViewAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_seller_inventory_items_for_company(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSupplierUrl400Response",
            '200': "List[SellerInventoryItemViewAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_seller_inventory_items_for_company_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SellerInventoryItemViewAffiliate]]:
        """Show Items
