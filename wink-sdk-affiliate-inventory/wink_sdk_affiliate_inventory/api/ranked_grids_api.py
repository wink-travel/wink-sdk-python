...
class RankedGridsApi:
    ...
    def create_seller_inventory_ranked_list(
        ...
        upsert_seller_inventory_ranked_list_request_affiliate: UpsertSellerInventoryRankedListRequestAffiliate,
        ...
        :param upsert_seller_inventory_ranked_list_request_affiliate: (required)
        :type upsert_seller_inventory_ranked_list_request_affiliate: UpsertSellerInventoryRankedListRequestAffiliate
        :param wink_version:
        ...
        _param = self._create_seller_inventory_ranked_list_serialize(
            ...
            upsert_seller_inventory_ranked_list_request_affiliate=upsert_seller_inventory_ranked_list_request_affiliate,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '201': "SellerInventoryRankedListViewAffiliate",
        }
    ...
    def create_seller_inventory_ranked_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SellerInventoryRankedListViewAffiliate]:
        """Create Ranked Grid
    ...
    def _create_seller_inventory_ranked_list_serialize(
        self,
        company_identifier,
        upsert_seller_inventory_ranked_list_request_affiliate,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if upsert_seller_inventory_ranked_list_request_affiliate is not None:
            _body_params = upsert_seller_inventory_ranked_list_request_affiliate
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/affiliate/{companyIdentifier}/ranked-grids',
    ...
    def create_seller_inventory_ranked_list_syndication_entry(
        ...
        create_seller_inventory_ranked_list_syndication_entry_request_affiliate: CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type company_identifier: str
        :param create_seller_inventory_ranked_list_syndication_entry_request_affiliate: (required)
        :type create_seller_inventory_ranked_list_syndication_entry_request_affiliate: CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_seller_inventory_ranked_list_syndication_entry_serialize(
            company_identifier=company_identifier,
            create_seller_inventory_ranked_list_syndication_entry_request_affiliate=create_seller_inventory_ranked_list_syndication_entry_request_affiliate,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _create_seller_inventory_ranked_list_syndication_entry_serialize(
        self,
        company_identifier,
        create_seller_inventory_ranked_list_syndication_entry_request_affiliate,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if create_seller_inventory_ranked_list_syndication_entry_request_affiliate is not None:
            _body_params = create_seller_inventory_ranked_list_syndication_entry_request_affiliate
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/affiliate/{companyIdentifier}/ranked-grids/syndication/entry',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_seller_inventory_ranked_list(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Remove grid owned by this owner identifier.")],
        ...
        :param company_identifier: Remove grid owned by this owner identifier. (required)
        :type company_identifier: str
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSupplierUrl400Response",
            '200': "SellerInventoryRankedListViewAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _remove_seller_inventory_ranked_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/affiliate/{companyIdentifier}/ranked-grids/{listIdentifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_seller_inventory_ranked_list(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Retrieve grid for owner identifier.")],
        ...
        :param company_identifier: Retrieve grid for owner identifier. (required)
        :type company_identifier: str
    ...
    def show_seller_inventory_ranked_lists(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Retrieve list for owner identifier.")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        :param company_identifier: Retrieve list for owner identifier. (required)
        :type company_identifier: str
        :param wink_version:
        :type wink_version: str
        :param accept:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSupplierUrl400Response",
            '200': "List[SellerInventoryRankedListViewAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_seller_inventory_ranked_lists_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SellerInventoryRankedListViewAffiliate]]:
        """Show Ranked Grids
    ...
    def _show_seller_inventory_ranked_lists_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/affiliate/{companyIdentifier}/ranked-grids/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
