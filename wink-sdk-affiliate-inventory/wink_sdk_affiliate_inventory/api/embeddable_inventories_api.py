...
class EmbeddableInventoriesApi:
    ...
    def show_embeddable_inventory(
        ...
        _param = self._show_embeddable_inventory_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "List[CampaignInventoryAffiliate]",
        }
    ...
    @validate_call
    def show_embeddable_inventory_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CampaignInventoryAffiliate]]:
        """Show Embeddable Inventories
    ...
    @validate_call
    def show_embeddable_inventory_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_embeddable_inventory_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/embeddable-inventory/list',
