...
class EmbeddableInventoriesApi:
    ...
    def show_embeddable_inventory(
        self,
        company_identifier: Annotated[StrictStr, Field(description="Show campaigns for this company")],
        ...
        :param company_identifier: Show campaigns for this company (required)
    ...
    def _show_embeddable_inventory_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/affiliate/{companyIdentifier}/embeddable-inventory/list',
