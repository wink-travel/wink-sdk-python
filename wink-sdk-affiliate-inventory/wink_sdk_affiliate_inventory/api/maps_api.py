...
class MapsApi:
    ...
    def create_advanced_map_configuration(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '201': "AdvancedMapConfigurationViewAffiliate",
        }
    ...
    def create_advanced_map_configuration_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AdvancedMapConfigurationViewAffiliate]:
        """Create Inventory Map
    ...
    def _create_advanced_map_configuration_serialize(
        ...
        if upsert_advanced_map_configuration_request_affiliate is not None:
            _body_params = upsert_advanced_map_configuration_request_affiliate
    ...
    def _create_advanced_map_configuration_for_supplier_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if upsert_supplier_advanced_map_configuration_request_affiliate is not None:
            _body_params = upsert_supplier_advanced_map_configuration_request_affiliate
    ...
    def _create_advanced_map_syndication_entry_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_advanced_map_configuration_syndication_entry_request_affiliate is not None:
            _body_params = create_advanced_map_configuration_syndication_entry_request_affiliate
    ...
    def remove_advanced_map_configuration(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSupplierUrl400Response",
            '200': "AdvancedMapConfigurationViewAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_advanced_map_configurations(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowSupplierUrl400Response",
            '200': "List[AdvancedMapConfigurationViewAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_advanced_map_configurations_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[AdvancedMapConfigurationViewAffiliate]]:
        """Show Maps
