...
class ConfigurableGeoJsonPolygonAffiliate(BaseModel):
    """
    A way to persist a GeoJSON polygon
    """ # noqa: E501
    polygon: GeoJsonPolygonAffiliate = Field(description="A GeoJSON polygon")
    __properties: ClassVar[List[str]] = ["polygon"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "polygon": GeoJsonPolygonAffiliate.from_dict(obj["polygon"]) if obj.get("polygon") is not None else None
        })
        return _obj
