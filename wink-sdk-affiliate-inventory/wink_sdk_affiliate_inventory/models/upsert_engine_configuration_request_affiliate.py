...
class UpsertEngineConfigurationRequestAffiliate(BaseModel):
    """
    ...
    theme_colors: Optional[EngineConfigurationThemeColorsAffiliate] = Field(default=None, alias="themeColors")
    ...
    __properties: ClassVar[List[str]] = ["name", "appendToPageTitle", "googleAnalyticsMeasurementId", "googleMapsAPIKey", "defaultCurrency", "defaultLanguage", "defaultLifestyle", "logos", "hostedBookingEngineUrl", "selfHosted", "themeColors", "cardLayout", "layout", "cardDesign", "numberOfAdvanceDays", "numberOfStayDays", "startDate", "endDate", "roomConfigurations", "useDays", "promotionalCodes", "sendBookingNotificationEmailsToProperty", "sendBookingNotificationEmailsToBooker", "sendBookingNotificationEmailsToChannelManager", "wcBookClickAction", "showUnavailableCard", "showRankings", "showSearch"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpsertEngineConfigurationRequestAffiliate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpsertEngineConfigurationRequestAffiliate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "themeColors": EngineConfigurationThemeColorsAffiliate.from_dict(obj["themeColors"]) if obj.get("themeColors") is not None else None,
