...
class SellableListAffiliate(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescriptionAffiliate], Field(min_length=1, max_length=2147483647)] = Field(description="Contains custom title and description of grid")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "ownerIdentifier", "name", "customizationIdentifier", "descriptions", "keywords", "status", "listType", "listIdentifier", "animate", "animateDelay", "sort", "displayType"]
