...
class GeoJsonRectangleAffiliate(BaseModel):
    """
    GeoJsonRectangleAffiliate
    """ # noqa: E501
    south_west: GeoJsonPointAffiliate = Field(alias="southWest")
    north_east: GeoJsonPointAffiliate = Field(alias="northEast")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "southWest": GeoJsonPointAffiliate.from_dict(obj["southWest"]) if obj.get("southWest") is not None else None,
            "northEast": GeoJsonPointAffiliate.from_dict(obj["northEast"]) if obj.get("northEast") is not None else None
        })
        return _obj
