...
class SellerInventoryListViewAffiliate(BaseModel):
    """
    ...
    seller_inventory_list: SellerInventoryListAffiliate = Field(alias="sellerInventoryList")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "sellerInventoryList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of seller_inventory_list
        if self.seller_inventory_list:
            _dict['sellerInventoryList'] = self.seller_inventory_list.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sellerInventoryList": SellerInventoryListAffiliate.from_dict(obj["sellerInventoryList"]) if obj.get("sellerInventoryList") is not None else None
        })
        return _obj
