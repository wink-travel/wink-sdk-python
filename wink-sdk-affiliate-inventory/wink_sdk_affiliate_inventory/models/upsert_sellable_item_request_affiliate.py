...
class UpsertSellableItemRequestAffiliate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "keywords", "inventoryType", "channelInventoryType", "supplierIdentifier", "channelInventoryIdentifier", "multimediaIdentifiers", "animate", "animateDelay", "sort", "displayType"]
