...
class SellerInventoryRankedListViewAffiliate(BaseModel):
    """
    ...
    seller_inventory_ranked_list: SellerInventoryRankedListAffiliate = Field(alias="sellerInventoryRankedList")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "sellerInventoryRankedList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of seller_inventory_ranked_list
        if self.seller_inventory_ranked_list:
            _dict['sellerInventoryRankedList'] = self.seller_inventory_ranked_list.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sellerInventoryRankedList": SellerInventoryRankedListAffiliate.from_dict(obj["sellerInventoryRankedList"]) if obj.get("sellerInventoryRankedList") is not None else None
        })
        return _obj
