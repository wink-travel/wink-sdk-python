...
class UpsertSellableInventoryUrlRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "keywords", "twitterAccount", "facebookAppId", "theme", "inventoryType", "supplierIdentifier", "channelInventoryIdentifier", "transactionalItemIdentifier", "multimediaIdentifiers", "animate", "animateDelay"]
