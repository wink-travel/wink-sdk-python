...
class UpsertSellableInventoryUrlRequestAffiliate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "multimedias", "keywords", "twitterAccount", "facebookAppId", "theme", "inventoryType", "supplierIdentifier", "channelInventoryIdentifier", "transactionalItemIdentifier", "animate", "animateDelay"]
