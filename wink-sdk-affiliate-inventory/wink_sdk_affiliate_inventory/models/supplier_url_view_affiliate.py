...
class SupplierUrlViewAffiliate(BaseModel):
    """
    ...
    supplier_url: SupplierUrlAffiliate = Field(alias="supplierUrl")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "supplierUrl"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of supplier_url
        if self.supplier_url:
            _dict['supplierUrl'] = self.supplier_url.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supplierUrl": SupplierUrlAffiliate.from_dict(obj["supplierUrl"]) if obj.get("supplierUrl") is not None else None
        })
        return _obj
