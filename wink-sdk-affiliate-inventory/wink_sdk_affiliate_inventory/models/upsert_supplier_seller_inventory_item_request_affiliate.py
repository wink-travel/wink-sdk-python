...
class UpsertSupplierSellerInventoryItemRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sellerInventoryItemName", "engineConfigurationIdentifier", "descriptions", "keywords", "inventoryType", "channelInventoryType", "supplierIdentifier", "multimediaIdentifiers", "animate", "animateDelay", "sort", "displayType"]
