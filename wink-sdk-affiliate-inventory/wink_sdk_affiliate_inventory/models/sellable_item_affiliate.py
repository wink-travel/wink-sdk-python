...
class SellableItemAffiliate(BaseModel):
    ...
    owner_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="AffiliateAccount / Owner identifier", alias="ownerIdentifier")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Descriptive name of this item for seller use")
    customization_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Which configuration to use with this item", alias="customizationIdentifier")
    ...
    supplier_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supplier / Hotel identifier that owns this inventory.", alias="supplierIdentifier")
    channel_inventory_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The channel inventory record identifier describing the relationship between supplier and seller.", alias="channelInventoryIdentifier")
