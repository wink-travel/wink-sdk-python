...
class SellableItemAffiliate(BaseModel):
    """
    ...
    descriptions: Annotated[List[SimpleDescriptionAffiliate], Field(min_length=1, max_length=2147483647)] = Field(description="Title and description of inventory.")
    ...
    multimedias: Annotated[List[SimpleMultimediaAffiliate], Field(min_length=1, max_length=2147483647)]
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "ownerIdentifier", "name", "customizationIdentifier", "descriptions", "keywords", "status", "inventoryStatus", "inventoryType", "channelInventoryType", "supplierIdentifier", "channelInventoryIdentifier", "multimedias", "animate", "animateDelay", "sort", "displayType"]
