...
class ConfigurableGeoJsonRectangleAffiliate(BaseModel):
    """
    A way to persist a GeoJSON rectangle
    """ # noqa: E501
    rectangle: GeoJsonRectangleAffiliate = Field(description="A GeoJSON rectangle")
    __properties: ClassVar[List[str]] = ["rectangle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rectangle": GeoJsonRectangleAffiliate.from_dict(obj["rectangle"]) if obj.get("rectangle") is not None else None
        })
        return _obj
