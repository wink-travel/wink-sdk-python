...
class CampaignInventoryAffiliate(BaseModel):
    """
    ...
    placeholder_image_url: Optional[StrictStr] = Field(default=None, alias="placeholderImageUrl")
    __properties: ClassVar[List[str]] = ["name", "layout", "id", "placeholderImageUrl"]
    ...
    def layout_validate_enum(cls, value):
        ...
        if value not in set(['AD_BANNER', 'MAP', 'HOTEL', 'GUEST_ROOM', 'MEETING_ROOM', 'SPA', 'RESTAURANT', 'ACTIVITY', 'ATTRACTION', 'PLACE', 'ADD_ON', 'LIST', 'SEARCH', 'RANKED']):
            raise ValueError("must be one of enum values ('AD_BANNER', 'MAP', 'HOTEL', 'GUEST_ROOM', 'MEETING_ROOM', 'SPA', 'RESTAURANT', 'ACTIVITY', 'ATTRACTION', 'PLACE', 'ADD_ON', 'LIST', 'SEARCH', 'RANKED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "placeholderImageUrl": obj.get("placeholderImageUrl")
        })
        return _obj
