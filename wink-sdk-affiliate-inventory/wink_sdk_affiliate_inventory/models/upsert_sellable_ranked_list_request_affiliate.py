...
class UpsertSellableRankedListRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "keywords", "lookup", "animate", "animateDelay", "sort", "displayType"]
