...
class UpsertSellableRankedListRequestAffiliate(BaseModel):
    ...
    """ # noqa: E501
    seller_inventory_ranked_list_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Descriptive name of this list for seller use only", alias="sellerInventoryRankedListName")
    ...
    __properties: ClassVar[List[str]] = ["sellerInventoryRankedListName", "engineConfigurationIdentifier", "descriptions", "keywords", "lookup", "animate", "animateDelay", "sort", "displayType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sellerInventoryRankedListName": obj.get("sellerInventoryRankedListName"),
