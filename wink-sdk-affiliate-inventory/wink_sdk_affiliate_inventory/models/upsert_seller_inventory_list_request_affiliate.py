...
class UpsertSellerInventoryListRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sellerInventoryListName", "engineConfigurationIdentifier", "descriptions", "keywords", "listType", "listIdentifier", "animate", "animateDelay", "sort", "displayType"]
