...
class UpsertSellerInventoryItemRequestAffiliate(BaseModel):
    """
    ...
    channel_inventory_identifier: StrictStr = Field(description="The channel blocking record identifier describing the relationship between supplier and seller.", alias="channelInventoryIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["sellerInventoryItemName", "engineConfigurationIdentifier", "descriptions", "keywords", "inventoryType", "channelInventoryType", "supplierIdentifier", "channelInventoryIdentifier", "multimediaIdentifiers", "animate", "animateDelay", "sort", "displayType"]
