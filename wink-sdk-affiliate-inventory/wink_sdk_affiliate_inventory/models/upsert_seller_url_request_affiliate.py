...
class UpsertSellerUrlRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sellerUrlName", "engineConfigurationIdentifier", "descriptions", "keywords", "twitterAccount", "facebookAppId", "theme", "inventoryType", "supplierIdentifier", "channelInventoryIdentifier", "transactionalItemIdentifier", "multimediaIdentifiers", "animate", "animateDelay"]
