...
class GeoJsonPolygonAffiliate(BaseModel):
    """
    GeoJsonPolygonAffiliate
    """ # noqa: E501
    points: Optional[List[PointAffiliate]] = None
    coordinates: Optional[List[GeoJsonLineStringAffiliate]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "points": [PointAffiliate.from_dict(_item) for _item in obj["points"]] if obj.get("points") is not None else None,
            "coordinates": [GeoJsonLineStringAffiliate.from_dict(_item) for _item in obj["coordinates"]] if obj.get("coordinates") is not None else None,
            "type": obj.get("type")
        })
        return _obj
