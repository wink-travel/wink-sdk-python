...
class InventoryMapAffiliate(BaseModel):
    """
    ...
    owner_identifier: UUID = Field(description="Map owner identifier", alias="ownerIdentifier")
    ...
    type_identifier: UUID = Field(description="Inventory type identifier. Either a single channel inventory identifier, a list identifier or a dynamic search identifier.", alias="typeIdentifier")
    type: StrictStr = Field(description="Type of inventory")
    center: GeoJsonPointAffiliate = Field(description="Map center point")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "ownerIdentifier", "customizationIdentifier", "name", "typeIdentifier", "type", "center", "draggable", "zoomable", "initialZoomLevel", "mapStyle", "mapMarkerColor", "mapHeight", "displayType", "circles", "rectangles", "markers", "polygons"]
