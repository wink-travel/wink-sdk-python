...
class CreateStaticSellerListSyndicationEntryRequestAffiliate(BaseModel):
    """
    CreateStaticSellerListSyndicationEntryRequestAffiliate
    """ # noqa: E501
    identifier: StrictStr = Field(description="ID of seller blocking item to create a syndication entry from")
