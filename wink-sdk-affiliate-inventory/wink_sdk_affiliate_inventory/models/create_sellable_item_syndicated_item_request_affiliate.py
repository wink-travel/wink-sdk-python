...
class CreateSellableItemSyndicatedItemRequestAffiliate(BaseModel):
    """
    CreateSellableItemSyndicatedItemRequestAffiliate
    """ # noqa: E501
    identifier: UUID = Field(description="ID of seller inventory item to create a syndication entry from")
