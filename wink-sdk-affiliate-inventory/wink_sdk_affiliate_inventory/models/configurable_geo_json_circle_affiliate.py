...
class ConfigurableGeoJsonCircleAffiliate(BaseModel):
    """
    A way to persist a GeoJSON circle
    """ # noqa: E501
    radius: Union[StrictFloat, StrictInt] = Field(description="Circle radius from center")
    point: GeoJsonPointAffiliate = Field(description="Circle center point")
    __properties: ClassVar[List[str]] = ["radius", "point"]
