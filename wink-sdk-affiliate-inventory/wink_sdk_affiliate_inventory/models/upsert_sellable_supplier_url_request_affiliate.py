...
class UpsertSellableSupplierUrlRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "multimedias", "keywords", "twitterAccount", "facebookAppId", "theme", "supplierIdentifier", "animate", "animateDelay"]
