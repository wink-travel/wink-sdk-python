...
class UpsertSellableSupplierUrlRequestAffiliate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "keywords", "twitterAccount", "facebookAppId", "theme", "supplierIdentifier", "multimediaIdentifiers", "animate", "animateDelay"]
