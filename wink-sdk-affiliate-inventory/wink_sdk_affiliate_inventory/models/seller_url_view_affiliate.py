...
class SellerUrlViewAffiliate(BaseModel):
    """
    ...
    seller_url: SellerUrlAffiliate = Field(alias="sellerUrl")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "sellerUrl"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of seller_url
        if self.seller_url:
            _dict['sellerUrl'] = self.seller_url.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sellerUrl": SellerUrlAffiliate.from_dict(obj["sellerUrl"]) if obj.get("sellerUrl") is not None else None
        })
        return _obj
