...
class InventoryMapMarkerAffiliate(BaseModel):
    """
    Inventory map marker
    """ # noqa: E501
    channel_inventory_identifier: StrictStr = Field(description="Identifier of the list, channel inventory or search", alias="channelInventoryIdentifier")
    point: GeoJsonPointAffiliate = Field(description="Location of inventory")
    supplier_identifier: UUID = Field(description="Hotel identifier", alias="supplierIdentifier")
    supplier_name: StrictStr = Field(description="Hotel name", alias="supplierName")
    inventory_identifier: UUID = Field(description="Actual inventory identifier", alias="inventoryIdentifier")
    inventory_type: StrictStr = Field(description="Type of inventory", alias="inventoryType")
    inventory_name: StrictStr = Field(description="Name of inventory", alias="inventoryName")
    lowest_display_price: CustomMonetaryAmount = Field(description="Lowest price of inventory in desired currency", alias="lowestDisplayPrice")
    __properties: ClassVar[List[str]] = ["channelInventoryIdentifier", "point", "supplierIdentifier", "supplierName", "inventoryIdentifier", "inventoryType", "inventoryName", "lowestDisplayPrice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "point": GeoJsonPointAffiliate.from_dict(obj["point"]) if obj.get("point") is not None else None,
