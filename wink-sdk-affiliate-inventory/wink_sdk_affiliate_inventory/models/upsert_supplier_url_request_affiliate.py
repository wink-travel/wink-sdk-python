...
class UpsertSupplierUrlRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["supplierUrlName", "engineConfigurationIdentifier", "descriptions", "keywords", "twitterAccount", "facebookAppId", "theme", "supplierIdentifier", "multimediaIdentifiers", "animate", "animateDelay"]
