...
class CreateSellerUrlSyndicationEntryRequestAffiliate(BaseModel):
    """
    CreateSellerUrlSyndicationEntryRequestAffiliate
    """ # noqa: E501
    identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="ID of seller url to create a syndication entry from")
