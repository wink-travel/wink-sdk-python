...
class SimpleMultimediaAffiliate(BaseModel):
    """
    ...
    descriptions: Optional[List[SimpleDescriptionAffiliate]] = Field(default=None, description="Localized media captions to give user some context about where this media was taken.")
    ...
    attribution: Optional[List[MediaAuthorAttributionAffiliate]] = Field(default=None, description="Whether image has attribution properties")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attribution": [MediaAuthorAttributionAffiliate.from_dict(_item) for _item in obj["attribution"]] if obj.get("attribution") is not None else None,
