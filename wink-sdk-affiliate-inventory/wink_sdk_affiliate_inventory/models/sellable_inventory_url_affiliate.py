...
class SellableInventoryUrlAffiliate(BaseModel):
    ...
    descriptions: Annotated[List[SimpleDescriptionAffiliate], Field(min_length=1, max_length=2147483647)] = Field(description="Localized link descriptions")
    keywords: Annotated[List[StrictStr], Field(min_length=1, max_length=2147483647)] = Field(description="Keywords")
    ...
    supplier_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The entity supplying the blocking. Usually a hotel.", alias="supplierIdentifier")
    channel_inventory_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Selected blocking record", alias="channelInventoryIdentifier")
    transactional_item_identifier: StrictStr = Field(description="The transactional item to retrieve pricing for. If left empty, will find the cheapest priced item.", alias="transactionalItemIdentifier")
    multimedia_identifiers: Annotated[List[StrictStr], Field(min_length=1, max_length=2147483647)] = Field(description="Cloudinary identifiers", alias="multimediaIdentifiers")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "ownerIdentifier", "name", "customizationIdentifier", "descriptions", "keywords", "uniqueId", "twitterAccount", "facebookAppId", "theme", "status", "inventoryStatus", "inventoryType", "channelInventoryType", "supplierIdentifier", "channelInventoryIdentifier", "transactionalItemIdentifier", "multimediaIdentifiers", "animate", "animateDelay"]
