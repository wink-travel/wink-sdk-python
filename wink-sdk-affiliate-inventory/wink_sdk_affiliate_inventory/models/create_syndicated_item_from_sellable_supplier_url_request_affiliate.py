...
class CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate(BaseModel):
    """
    CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate
    """ # noqa: E501
    identifier: UUID = Field(description="ID of supplier url to create a syndication entry from")
