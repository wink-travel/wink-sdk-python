...
class SellerInventoryItemViewAffiliate(BaseModel):
    """
    ...
    seller_inventory_item: SellerInventoryItemAffiliate = Field(alias="sellerInventoryItem")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "sellerInventoryItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of seller_inventory_item
        if self.seller_inventory_item:
            _dict['sellerInventoryItem'] = self.seller_inventory_item.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sellerInventoryItem": SellerInventoryItemAffiliate.from_dict(obj["sellerInventoryItem"]) if obj.get("sellerInventoryItem") is not None else None
        })
        return _obj
