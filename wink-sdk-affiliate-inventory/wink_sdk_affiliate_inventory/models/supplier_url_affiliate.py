...
class SupplierUrlAffiliate(BaseModel):
    """
    Supplier URL
    """ # noqa: E501
    ...
    supplier_url_name: StrictStr = Field(description="Descriptive supplierUrlName of this url for seller use only", alias="supplierUrlName")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "sellerIdentifier", "supplierUrlName", "engineConfigurationIdentifier", "descriptions", "keywords", "uniqueId", "twitterAccount", "facebookAppId", "theme", "status", "supplierIdentifier", "multimediaIdentifiers", "animate", "animateDelay"]
