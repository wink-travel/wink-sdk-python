...
class EngineConfigurationViewAffiliate(BaseModel):
    """
    ...
    engine_configuration: EngineConfigurationAffiliate = Field(alias="engineConfiguration")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "engineConfiguration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "engineConfiguration": EngineConfigurationAffiliate.from_dict(obj["engineConfiguration"]) if obj.get("engineConfiguration") is not None else None
        })
        return _obj
