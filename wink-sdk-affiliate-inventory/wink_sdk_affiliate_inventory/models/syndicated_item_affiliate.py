...
class SyndicatedItemAffiliate(BaseModel):
    ...
    status: StrictStr = Field(description="This can change if it's linked to travel inventory that is no longer available.")
    ...
    descriptions: Annotated[List[SimpleDescriptionAffiliate], Field(min_length=1)] = Field(description="Localized descriptions describing inventory.")
    ...
    user_tags: Optional[List[StrictStr]] = Field(default=None, alias="userTags")
    hash_tags: Optional[List[StrictStr]] = Field(default=None, alias="hashTags")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "ownerIdentifier", "title", "contentUrl", "sort", "status", "type", "metadata", "descriptions", "tags", "multimedias", "display", "disabled", "publishDate", "publishStatus", "lockCode", "uniqueId", "userTags", "hashTags"]
