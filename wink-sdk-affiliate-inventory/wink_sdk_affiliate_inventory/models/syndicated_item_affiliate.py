...
class SyndicatedItemAffiliate(BaseModel):
    ...
    multimedias: Optional[List[SimpleMultimediaAffiliate]] = Field(default=None, description="The main multimedias for this entry.")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "ownerIdentifier", "contentUrl", "sort", "status", "type", "imageList", "videoList", "audioList", "metadata", "descriptions", "tags", "multimedias", "intelligent"]
