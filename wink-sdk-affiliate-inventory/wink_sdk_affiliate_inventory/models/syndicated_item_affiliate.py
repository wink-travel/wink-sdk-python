...
class SyndicatedItemAffiliate(BaseModel):
    """
    ...
    media: Optional[SimpleMultimediaAffiliate] = Field(default=None, description="The main media for this entry.")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "ownerIdentifier", "contentUrl", "sort", "status", "type", "imageList", "videoList", "audioList", "metadata", "descriptions", "ogType", "tags", "media", "intelligent"]
