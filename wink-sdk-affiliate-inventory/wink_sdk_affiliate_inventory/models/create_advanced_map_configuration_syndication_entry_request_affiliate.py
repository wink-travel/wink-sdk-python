...
class CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate(BaseModel):
    """
    CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate
    """ # noqa: E501
    identifier: StrictStr = Field(description="ID of map to create a syndication entry from")
