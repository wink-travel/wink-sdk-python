...
class UpsertSupplierInventoryMapRequestAffiliate(BaseModel):
    ...
    supplier_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Inventory type identifier. Either a single channel inventory identifier, a list identifier or a dynamic search identifier.", alias="supplierIdentifier")
