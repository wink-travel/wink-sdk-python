...
class UpsertSupplierInventoryMapRequestAffiliate(BaseModel):
    """
    ...
    supplier_identifier: UUID = Field(description="Inventory type identifier. Either a single channel inventory identifier, a list identifier or a dynamic search identifier.", alias="supplierIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["customizationIdentifier", "name", "supplierIdentifier", "type", "draggable", "zoomable", "initialZoomLevel", "mapStyle", "mapMarkerColor", "mapHeight", "displayType", "circles", "rectangles", "markers", "polygons"]
