...
class AdvancedMapConfigurationViewAffiliate(BaseModel):
    """
    ...
    advanced_map_configuration: AdvancedMapConfigurationAffiliate = Field(alias="advancedMapConfiguration")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "advancedMapConfiguration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of advanced_map_configuration
        if self.advanced_map_configuration:
            _dict['advancedMapConfiguration'] = self.advanced_map_configuration.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "advancedMapConfiguration": AdvancedMapConfigurationAffiliate.from_dict(obj["advancedMapConfiguration"]) if obj.get("advancedMapConfiguration") is not None else None
        })
        return _obj
