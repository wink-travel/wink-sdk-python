...
class CreateSellableRankedListSyndicatedItemRequestAffiliate(BaseModel):
    """
    CreateSellableRankedListSyndicatedItemRequestAffiliate
    """ # noqa: E501
    identifier: UUID = Field(description="ID of seller inventory ranked list to create a syndication entry from")
