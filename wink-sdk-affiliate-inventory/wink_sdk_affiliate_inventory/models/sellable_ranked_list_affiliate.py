...
class SellableRankedListAffiliate(BaseModel):
    """
    ...
    lookup: LookupLightweightAffiliate = Field(description="The destination to display ranked inventory from.")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "ownerIdentifier", "name", "customizationIdentifier", "descriptions", "keywords", "status", "lookup", "animate", "animateDelay", "sort", "displayType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lookup": LookupLightweightAffiliate.from_dict(obj["lookup"]) if obj.get("lookup") is not None else None,
