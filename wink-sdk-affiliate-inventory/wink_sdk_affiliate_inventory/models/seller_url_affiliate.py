...
class SellerUrlAffiliate(BaseModel):
    """
    Seller URL
    """ # noqa: E501
    identifier: StrictStr = Field(description="Unique identifier")
    seller_identifier: StrictStr = Field(description="Company identifier", alias="sellerIdentifier")
    seller_url_name: StrictStr = Field(description="Descriptive name of this url for seller use only", alias="sellerUrlName")
    ...
    unique_id: StrictStr = Field(description="Unique link id", alias="uniqueId")
    ...
    channel_inventory_type: StrictStr = Field(description="Channel blocking type is a subset of blocking type in that it does not include the `HOTEL` type. THe way it works is, as a seller you might want to sell a guest room but instead of showing the price of that guest room, you would like to display the best room type price for the property.", alias="channelInventoryType")
    supplier_identifier: StrictStr = Field(description="The entity supplying the blocking. Usually a hotel.", alias="supplierIdentifier")
    channel_inventory_identifier: StrictStr = Field(description="Selected blocking record", alias="channelInventoryIdentifier")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sellerUrlName": obj.get("sellerUrlName"),
