...
class UpsertSellableListRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "keywords", "listType", "listIdentifier", "animate", "animateDelay", "sort", "displayType"]
