...
class EngineConfigurationAffiliate(BaseModel):
    """
    ...
    city: Optional[GeoNameAffiliate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "city": GeoNameAffiliate.from_dict(obj["city"]) if obj.get("city") is not None else None,
