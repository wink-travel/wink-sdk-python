...
class EngineConfigurationAffiliate(BaseModel):
    ...
    theme_colors: Optional[EngineConfigurationThemeAffiliate] = Field(default=None, alias="themeColors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "themeColors": EngineConfigurationThemeAffiliate.from_dict(obj["themeColors"]) if obj.get("themeColors") is not None else None,
