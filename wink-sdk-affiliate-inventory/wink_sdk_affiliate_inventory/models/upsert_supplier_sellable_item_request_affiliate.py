...
class UpsertSupplierSellableItemRequestAffiliate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "keywords", "inventoryType", "channelInventoryType", "supplierIdentifier", "multimediaIdentifiers", "animate", "animateDelay", "sort", "displayType"]
