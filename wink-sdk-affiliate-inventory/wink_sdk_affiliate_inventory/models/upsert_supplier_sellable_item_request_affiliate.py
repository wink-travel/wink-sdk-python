...
class UpsertSupplierSellableItemRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "customizationIdentifier", "descriptions", "keywords", "inventoryType", "channelInventoryType", "supplierIdentifier", "multimedias", "animate", "animateDelay", "sort", "displayType"]
