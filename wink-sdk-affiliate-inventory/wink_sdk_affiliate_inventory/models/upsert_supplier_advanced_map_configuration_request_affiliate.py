...
class UpsertSupplierAdvancedMapConfigurationRequestAffiliate(BaseModel):
    ...
    supplier_identifier: StrictStr = Field(description="Inventory type identifier. Either a single channel blocking identifier, a list identifier or a dynamic search identifier.", alias="supplierIdentifier")
