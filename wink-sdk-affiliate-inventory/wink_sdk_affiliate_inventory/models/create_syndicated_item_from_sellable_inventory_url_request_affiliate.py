...
class CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate(BaseModel):
    """
    CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate
    """ # noqa: E501
    identifier: UUID = Field(description="ID of seller url to create a syndication entry from")
