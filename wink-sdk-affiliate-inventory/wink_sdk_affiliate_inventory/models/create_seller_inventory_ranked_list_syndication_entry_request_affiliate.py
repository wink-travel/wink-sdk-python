...
class CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate(BaseModel):
    """
    CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate
    """ # noqa: E501
    identifier: StrictStr = Field(description="ID of seller blocking ranked list to create a syndication entry from")
