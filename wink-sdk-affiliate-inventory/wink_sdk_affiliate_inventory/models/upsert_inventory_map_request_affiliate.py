...
class UpsertInventoryMapRequestAffiliate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["customizationIdentifier", "name", "typeIdentifier", "type", "center", "draggable", "zoomable", "initialZoomLevel", "mapStyle", "mapMarkerColor", "mapHeight", "displayType", "circles", "rectangles", "markers", "polygons"]
