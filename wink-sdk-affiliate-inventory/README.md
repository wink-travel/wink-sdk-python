...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.27#egg=wink_sdk_affiliate_inventory&subdirectory=wink-sdk-affiliate-inventory
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.27#egg=wink_sdk_affiliate_inventory&subdirectory=wink_sdk_affiliate_inventory`)
