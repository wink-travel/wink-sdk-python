...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.28#egg=wink_sdk_affiliate_inventory&subdirectory=wink-sdk-affiliate-inventory
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.28#egg=wink_sdk_affiliate_inventory&subdirectory=wink_sdk_affiliate_inventory`)
...
*SellableItemsApi* | [**create_seller_inventory_item**](docs/SellableItemsApi.md#create_seller_inventory_item) | **POST** /api/items | Create Item
*SellableItemsApi* | [**create_seller_inventory_item_syndication_entry**](docs/SellableItemsApi.md#create_seller_inventory_item_syndication_entry) | **POST** /api/items/syndication/entry | Add to WinkLinks
*SellableItemsApi* | [**create_supplier_seller_inventory_item**](docs/SellableItemsApi.md#create_supplier_seller_inventory_item) | **POST** /api/items/supplier | Create Supplier Item
*SellableItemsApi* | [**remove_seller_inventory_item**](docs/SellableItemsApi.md#remove_seller_inventory_item) | **DELETE** /api/items/{inventoryIdentifier} | Delete Item
*SellableItemsApi* | [**show_inventory_media1**](docs/SellableItemsApi.md#show_inventory_media1) | **GET** /api/items/inventory/{channelInventoryIdentifier}/media/list | Show Item Media
*SellableItemsApi* | [**show_seller_inventory_item**](docs/SellableItemsApi.md#show_seller_inventory_item) | **GET** /api/items/{inventoryIdentifier} | Show Item
*SellableItemsApi* | [**show_seller_inventory_items_for_company**](docs/SellableItemsApi.md#show_seller_inventory_items_for_company) | **GET** /api/items/list | Show Items
*SellableItemsApi* | [**update_seller_inventory_item**](docs/SellableItemsApi.md#update_seller_inventory_item) | **PUT** /api/items/{inventoryIdentifier} | Update Item
