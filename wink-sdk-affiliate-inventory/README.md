...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.60#egg=wink_sdk_affiliate_inventory&subdirectory=wink-sdk-affiliate-inventory
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.60#egg=wink_sdk_affiliate_inventory&subdirectory=wink_sdk_affiliate_inventory`)
...
*SyndicatedItemApi* | [**create_inventory_url_syndication_entry**](docs/SyndicatedItemApi.md#create_inventory_url_syndication_entry) | **POST** /api/shareable-link/inventory/syndication/entry | Add to WinkLinks
