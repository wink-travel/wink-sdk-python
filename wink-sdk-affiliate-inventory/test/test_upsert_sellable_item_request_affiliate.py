...
class TestUpsertSellableItemRequestAffiliate(unittest.TestCase):
    """UpsertSellableItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSellableItemRequestAffiliate:
        """Test UpsertSellableItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSellableItemRequestAffiliate`
        """
        model = UpsertSellableItemRequestAffiliate()
        if include_optional:
            return UpsertSellableItemRequestAffiliate(
    ...
    def testUpsertSellableItemRequestAffiliate(self):
        """Test UpsertSellableItemRequestAffiliate"""
