...
class TestEngineConfigurationViewAffiliate(unittest.TestCase):
    """EngineConfigurationViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationViewAffiliate:
        """Test EngineConfigurationViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationViewAffiliate`
        """
        model = EngineConfigurationViewAffiliate()
        if include_optional:
            return EngineConfigurationViewAffiliate(
                ...
                version = 12,
                engine_configuration = wink_sdk_affiliate_inventory.models.engine_configuration_affiliate.EngineConfiguration_Affiliate(
                    identifier = '', 
                    name = 'Engine Configuration 1', 
                    append_to_page_title = '', 
                    user_identifier = '', 
                    owner_identifier = '', 
                    ...
                    google_maps_api_key = 'google-maps-api-123', 
                    default_currency = 'USD', 
                    default_language = 'en', 
                    default_lifestyle = 'LIFESTYLE_HEALTH_FITNESS', 
                    logos = [
                        wink_sdk_affiliate_inventory.models.simple_multimedia_affiliate.SimpleMultimedia_Affiliate(
                            ...
                            category = '1', 
                            descriptions = [
                                wink_sdk_affiliate_inventory.models.simple_description_affiliate.SimpleDescription_Affiliate(
                            ...
                            attribution = [
                                wink_sdk_affiliate_inventory.models.image_attribution_affiliate.ImageAttribution_Affiliate(
                    ...
                    self_hosted = True, 
                    theme_colors = wink_sdk_affiliate_inventory.models.engine_configuration_theme_affiliate.EngineConfigurationTheme_Affiliate(
                        primary = '#dc3545', 
                        secondary = '#6c757d', 
                        success = '#28a745', 
                        danger = '#dc3545', 
                    ...
                    room_configurations = [
                        wink_sdk_affiliate_inventory.models.room_configuration_affiliate.RoomConfiguration_Affiliate(
                            adults = 2, 
                            children = [
                                wink_sdk_affiliate_inventory.models.child_affiliate.Child_Affiliate(
                                    quantity = 1, 
                                    age = 0, )
                                ], )
                        ], 
                    ...
                    city = wink_sdk_affiliate_inventory.models.geo_name_affiliate.GeoName_Affiliate(
                        geo_name_id = '5128581', 
                        type = 'CITY', 
                        name = 'New York City', 
                        ...
                        country = wink_sdk_affiliate_inventory.models.country_affiliate.Country_Affiliate(
                            iso = 'US', 
                            name = 'United States', 
                            capital = 'Washington', 
                            continent = 'NA', 
                            ...
                            geo_name_id = '6252001', ), 
                        sub_country = wink_sdk_affiliate_inventory.models.sub_country_affiliate.SubCountry_Affiliate(
                            name = 'New York', 
                            ascii_name = 'New York', 
                            geo_name_id = '5128638', ), 
                        sub_sub_country = wink_sdk_affiliate_inventory.models.sub_sub_country_affiliate.SubSubCountry_Affiliate(
                            name = '', 
                            ascii_name = '', 
                            geo_name_id = '', ), ), 
    ...
    def testEngineConfigurationViewAffiliate(self):
        """Test EngineConfigurationViewAffiliate"""
