...
class TestSellableItemAffiliate(unittest.TestCase):
    """SellableItemAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableItemAffiliate:
        """Test SellableItemAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableItemAffiliate`
        """
        model = SellableItemAffiliate()
        if include_optional:
            return SellableItemAffiliate(
                id = 'doc-1',
    ...
    def testSellableItemAffiliate(self):
        """Test SellableItemAffiliate"""
