...
class TestShowSupplierUrl400Response(unittest.TestCase):
    """ShowSupplierUrl400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowSupplierUrl400Response:
        """Test ShowSupplierUrl400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowSupplierUrl400Response`
        """
        model = ShowSupplierUrl400Response()
        if include_optional:
            return ShowSupplierUrl400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowSupplierUrl400Response(self):
        """Test ShowSupplierUrl400Response"""
