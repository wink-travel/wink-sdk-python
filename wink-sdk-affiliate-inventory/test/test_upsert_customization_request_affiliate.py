...
class TestUpsertCustomizationRequestAffiliate(unittest.TestCase):
    """UpsertCustomizationRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertCustomizationRequestAffiliate:
        """Test UpsertCustomizationRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertCustomizationRequestAffiliate`
        """
        model = UpsertCustomizationRequestAffiliate()
        if include_optional:
            return UpsertCustomizationRequestAffiliate(
    ...
    def testUpsertCustomizationRequestAffiliate(self):
        """Test UpsertCustomizationRequestAffiliate"""
