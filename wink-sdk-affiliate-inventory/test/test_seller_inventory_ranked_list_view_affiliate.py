...
class TestSellerInventoryRankedListViewAffiliate(unittest.TestCase):
    """SellerInventoryRankedListViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryRankedListViewAffiliate:
        """Test SellerInventoryRankedListViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryRankedListViewAffiliate`
        """
        model = SellerInventoryRankedListViewAffiliate()
        if include_optional:
            return SellerInventoryRankedListViewAffiliate(
                ...
                version = 12,
                seller_inventory_ranked_list = wink_sdk_affiliate_inventory.models.seller_inventory_ranked_list_affiliate.SellerInventoryRankedList_Affiliate(
                    identifier = '', 
                    seller_identifier = '', 
                    ...
                    status = 'ACTIVE', 
                    lookup = wink_sdk_affiliate_inventory.models.lookup_affiliate.Lookup_Affiliate(
                        identifier = '', 
                        type = 'CITY', 
                        type_identifier = '', 
    ...
    def testSellerInventoryRankedListViewAffiliate(self):
        """Test SellerInventoryRankedListViewAffiliate"""
