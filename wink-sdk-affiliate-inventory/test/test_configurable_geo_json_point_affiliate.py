...
class TestConfigurableGeoJsonPointAffiliate(unittest.TestCase):
    """ConfigurableGeoJsonPointAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurableGeoJsonPointAffiliate:
        """Test ConfigurableGeoJsonPointAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurableGeoJsonPointAffiliate`
        """
        model = ConfigurableGeoJsonPointAffiliate()
        if include_optional:
            return ConfigurableGeoJsonPointAffiliate(
    ...
    def testConfigurableGeoJsonPointAffiliate(self):
        """Test ConfigurableGeoJsonPointAffiliate"""
