...
class TestGeoJsonPolygonAffiliate(unittest.TestCase):
    """GeoJsonPolygonAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonPolygonAffiliate:
        """Test GeoJsonPolygonAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonPolygonAffiliate`
        """
        model = GeoJsonPolygonAffiliate()
        if include_optional:
            return GeoJsonPolygonAffiliate(
                points = [
    ...
    def testGeoJsonPolygonAffiliate(self):
        """Test GeoJsonPolygonAffiliate"""
