...
class TestUpsertEngineConfigurationRequestAffiliate(unittest.TestCase):
    """UpsertEngineConfigurationRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertEngineConfigurationRequestAffiliate:
        """Test UpsertEngineConfigurationRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertEngineConfigurationRequestAffiliate`
        """
        model = UpsertEngineConfigurationRequestAffiliate()
        if include_optional:
            return UpsertEngineConfigurationRequestAffiliate(
    ...
    def testUpsertEngineConfigurationRequestAffiliate(self):
        """Test UpsertEngineConfigurationRequestAffiliate"""
