...
class TestSellerInventoryListAffiliate(unittest.TestCase):
    """SellerInventoryListAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryListAffiliate:
        """Test SellerInventoryListAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryListAffiliate`
        """
        model = SellerInventoryListAffiliate()
        if include_optional:
            return SellerInventoryListAffiliate(
                identifier = '',
                seller_identifier = '',
    ...
    def testSellerInventoryListAffiliate(self):
        """Test SellerInventoryListAffiliate"""
