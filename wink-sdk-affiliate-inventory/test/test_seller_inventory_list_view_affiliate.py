...
class TestSellerInventoryListViewAffiliate(unittest.TestCase):
    """SellerInventoryListViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryListViewAffiliate:
        """Test SellerInventoryListViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryListViewAffiliate`
        """
        model = SellerInventoryListViewAffiliate()
        if include_optional:
            return SellerInventoryListViewAffiliate(
                ...
                version = 12,
                seller_inventory_list = wink_sdk_affiliate_inventory.models.seller_inventory_list_affiliate.SellerInventoryList_Affiliate(
                    identifier = '', 
                    seller_identifier = '', 
    ...
    def testSellerInventoryListViewAffiliate(self):
        """Test SellerInventoryListViewAffiliate"""
