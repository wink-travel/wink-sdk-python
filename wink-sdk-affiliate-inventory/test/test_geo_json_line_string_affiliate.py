...
class TestGeoJsonLineStringAffiliate(unittest.TestCase):
    """GeoJsonLineStringAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonLineStringAffiliate:
        """Test GeoJsonLineStringAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonLineStringAffiliate`
        """
        model = GeoJsonLineStringAffiliate()
        if include_optional:
            return GeoJsonLineStringAffiliate(
                type = '',
                coordinates = [
    ...
    def testGeoJsonLineStringAffiliate(self):
        """Test GeoJsonLineStringAffiliate"""
