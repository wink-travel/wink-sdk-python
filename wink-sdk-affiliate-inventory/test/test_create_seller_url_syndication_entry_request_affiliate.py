...
class TestCreateSellerUrlSyndicationEntryRequestAffiliate(unittest.TestCase):
    """CreateSellerUrlSyndicationEntryRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSellerUrlSyndicationEntryRequestAffiliate:
        """Test CreateSellerUrlSyndicationEntryRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSellerUrlSyndicationEntryRequestAffiliate`
        """
        model = CreateSellerUrlSyndicationEntryRequestAffiliate()
        if include_optional:
            return CreateSellerUrlSyndicationEntryRequestAffiliate(
                identifier = ''
            )
        else:
            return CreateSellerUrlSyndicationEntryRequestAffiliate(
    ...
    def testCreateSellerUrlSyndicationEntryRequestAffiliate(self):
        """Test CreateSellerUrlSyndicationEntryRequestAffiliate"""
