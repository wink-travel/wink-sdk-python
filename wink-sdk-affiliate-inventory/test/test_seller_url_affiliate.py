...
class TestSellerUrlAffiliate(unittest.TestCase):
    """SellerUrlAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerUrlAffiliate:
        """Test SellerUrlAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerUrlAffiliate`
        """
        model = SellerUrlAffiliate()
        if include_optional:
            return SellerUrlAffiliate(
                identifier = '',
                seller_identifier = '',
    ...
    def testSellerUrlAffiliate(self):
        """Test SellerUrlAffiliate"""
