...
class TestUpsertSupplierInventoryMapRequestAffiliate(unittest.TestCase):
    """UpsertSupplierInventoryMapRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSupplierInventoryMapRequestAffiliate:
        """Test UpsertSupplierInventoryMapRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSupplierInventoryMapRequestAffiliate`
        """
        model = UpsertSupplierInventoryMapRequestAffiliate()
        if include_optional:
            return UpsertSupplierInventoryMapRequestAffiliate(
                customization_identifier = 'customization-1',
                name = 'My lovely map',
                supplier_identifier = 'list-1',
                type = 'LIST',
                draggable = True,
                zoomable = True,
                ...
                circles = [
                    wink_sdk_affiliate_inventory.models.configurable_geo_json_circle_affiliate.ConfigurableGeoJsonCircle_Affiliate(
                        radius = 2.5, 
                        point = wink_sdk_affiliate_inventory.models.geo_json_point_affiliate.GeoJsonPoint_Affiliate(
                            x = 1.337, 
                            y = 1.337, 
                            type = '', 
                            coordinates = [
    ...
    def testUpsertSupplierInventoryMapRequestAffiliate(self):
        """Test UpsertSupplierInventoryMapRequestAffiliate"""
