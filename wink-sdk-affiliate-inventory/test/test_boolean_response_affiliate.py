...
class TestBooleanResponseAffiliate(unittest.TestCase):
    """BooleanResponseAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BooleanResponseAffiliate:
        """Test BooleanResponseAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BooleanResponseAffiliate`
        """
        model = BooleanResponseAffiliate()
        if include_optional:
    ...
    def testBooleanResponseAffiliate(self):
        """Test BooleanResponseAffiliate"""
