...
class TestSellableSupplierUrlAffiliate(unittest.TestCase):
    """SellableSupplierUrlAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableSupplierUrlAffiliate:
        """Test SellableSupplierUrlAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableSupplierUrlAffiliate`
        """
        model = SellableSupplierUrlAffiliate()
        if include_optional:
            return SellableSupplierUrlAffiliate(
                id = 'doc-1',
    ...
    def testSellableSupplierUrlAffiliate(self):
        """Test SellableSupplierUrlAffiliate"""
