...
class TestUpsertSupplierSellableItemRequestAffiliate(unittest.TestCase):
    """UpsertSupplierSellableItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSupplierSellableItemRequestAffiliate:
        """Test UpsertSupplierSellableItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSupplierSellableItemRequestAffiliate`
        """
        model = UpsertSupplierSellableItemRequestAffiliate()
        if include_optional:
            return UpsertSupplierSellableItemRequestAffiliate(
    ...
    def testUpsertSupplierSellableItemRequestAffiliate(self):
        """Test UpsertSupplierSellableItemRequestAffiliate"""
