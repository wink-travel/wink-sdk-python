...
class TestCreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate(unittest.TestCase):
    """CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate:
        """Test CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate`
        """
        model = CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate()
        if include_optional:
            return CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate(
                identifier = '0'
            )
        else:
            return CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate(
    ...
    def testCreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate(self):
        """Test CreateSyndicatedItemFromSellableInventoryUrlRequestAffiliate"""
