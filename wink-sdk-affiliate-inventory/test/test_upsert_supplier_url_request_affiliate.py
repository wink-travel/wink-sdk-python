...
class TestUpsertSupplierUrlRequestAffiliate(unittest.TestCase):
    """UpsertSupplierUrlRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSupplierUrlRequestAffiliate:
        """Test UpsertSupplierUrlRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSupplierUrlRequestAffiliate`
        """
        model = UpsertSupplierUrlRequestAffiliate()
        if include_optional:
            return UpsertSupplierUrlRequestAffiliate(
                supplier_url_name = 'My Bali Villa',
    ...
    def testUpsertSupplierUrlRequestAffiliate(self):
        """Test UpsertSupplierUrlRequestAffiliate"""
