...
class TestSellerInventoryRankedListAffiliate(unittest.TestCase):
    """SellerInventoryRankedListAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryRankedListAffiliate:
        """Test SellerInventoryRankedListAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryRankedListAffiliate`
        """
        model = SellerInventoryRankedListAffiliate()
        if include_optional:
            return SellerInventoryRankedListAffiliate(
                identifier = '',
                seller_identifier = '',
    ...
    def testSellerInventoryRankedListAffiliate(self):
        """Test SellerInventoryRankedListAffiliate"""
