...
class TestEngineConfigurationAffiliate(unittest.TestCase):
    """EngineConfigurationAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationAffiliate:
        """Test EngineConfigurationAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationAffiliate`
        """
        model = EngineConfigurationAffiliate()
        if include_optional:
            return EngineConfigurationAffiliate(
                identifier = '',
    ...
    def testEngineConfigurationAffiliate(self):
        """Test EngineConfigurationAffiliate"""
