...
class TestInventoryMapAffiliate(unittest.TestCase):
    """InventoryMapAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryMapAffiliate:
        """Test InventoryMapAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryMapAffiliate`
        """
        model = InventoryMapAffiliate()
        if include_optional:
            return InventoryMapAffiliate(
                id = 'doc-1',
    ...
    def testInventoryMapAffiliate(self):
        """Test InventoryMapAffiliate"""
