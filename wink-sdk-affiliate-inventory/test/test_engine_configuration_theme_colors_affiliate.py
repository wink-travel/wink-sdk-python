...
class TestEngineConfigurationThemeColorsAffiliate(unittest.TestCase):
    """EngineConfigurationThemeColorsAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeColorsAffiliate:
        """Test EngineConfigurationThemeColorsAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeColorsAffiliate`
        """
        model = EngineConfigurationThemeColorsAffiliate()
        if include_optional:
            return EngineConfigurationThemeColorsAffiliate(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeColorsAffiliate(self):
        """Test EngineConfigurationThemeColorsAffiliate"""
