...
class TestUpsertSellableRankedListRequestAffiliate(unittest.TestCase):
    """UpsertSellableRankedListRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSellableRankedListRequestAffiliate:
        """Test UpsertSellableRankedListRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSellableRankedListRequestAffiliate`
        """
        model = UpsertSellableRankedListRequestAffiliate()
        if include_optional:
            return UpsertSellableRankedListRequestAffiliate(
                seller_inventory_ranked_list_name = 'My ranked list',
                engine_configuration_identifier = 'customization-1',
                descriptions = [
                ...
                lookup = wink_sdk_affiliate_inventory.models.lookup_lightweight_affiliate.LookupLightweight_Affiliate(
                    identifier = 'lookup-1', 
                    type = 'CITY', 
    ...
    def testUpsertSellableRankedListRequestAffiliate(self):
        """Test UpsertSellableRankedListRequestAffiliate"""
