...
class TestChildAffiliate(unittest.TestCase):
    """ChildAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChildAffiliate:
        """Test ChildAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildAffiliate`
        """
        model = ChildAffiliate()
        if include_optional:
