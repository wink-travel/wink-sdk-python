...
class TestSellableListAffiliate(unittest.TestCase):
    """SellableListAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableListAffiliate:
        """Test SellableListAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableListAffiliate`
        """
        model = SellableListAffiliate()
        if include_optional:
            return SellableListAffiliate(
                id = 'doc-1',
    ...
    def testSellableListAffiliate(self):
        """Test SellableListAffiliate"""
