...
class TestEmbeddableInventoriesApi(unittest.TestCase):
    """EmbeddableInventoriesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EmbeddableInventoriesApi()

    def tearDown(self) -> None:
        pass

    def test_oauth2_show_embeddable_inventory(self) -> None:
        """Test case for oauth2_show_embeddable_inventory

        Show Embeddable Inventories (OAuth2)
        """
        pass

    def test_show_embeddable_inventory(self) -> None:
        """Test case for show_embeddable_inventory
