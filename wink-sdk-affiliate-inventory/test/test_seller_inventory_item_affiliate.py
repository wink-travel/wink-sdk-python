...
class TestSellerInventoryItemAffiliate(unittest.TestCase):
    """SellerInventoryItemAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryItemAffiliate:
        """Test SellerInventoryItemAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryItemAffiliate`
        """
        model = SellerInventoryItemAffiliate()
        if include_optional:
            return SellerInventoryItemAffiliate(
                identifier = '',
                seller_identifier = '',
    ...
    def testSellerInventoryItemAffiliate(self):
        """Test SellerInventoryItemAffiliate"""
