...
class TestPointAffiliate(unittest.TestCase):
    """PointAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PointAffiliate:
        """Test PointAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PointAffiliate`
        """
        model = PointAffiliate()
        if include_optional:
            return PointAffiliate(
                x = 1.337,
                y = 1.337
            )
        else:
