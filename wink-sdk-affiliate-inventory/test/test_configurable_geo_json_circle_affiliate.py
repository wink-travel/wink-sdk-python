...
class TestConfigurableGeoJsonCircleAffiliate(unittest.TestCase):
    """ConfigurableGeoJsonCircleAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigurableGeoJsonCircleAffiliate:
        """Test ConfigurableGeoJsonCircleAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurableGeoJsonCircleAffiliate`
        """
        model = ConfigurableGeoJsonCircleAffiliate()
        if include_optional:
            return ConfigurableGeoJsonCircleAffiliate(
                radius = 2.5,
    ...
    def testConfigurableGeoJsonCircleAffiliate(self):
        """Test ConfigurableGeoJsonCircleAffiliate"""
