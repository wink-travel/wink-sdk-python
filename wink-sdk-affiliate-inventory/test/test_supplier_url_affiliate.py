...
class TestSupplierUrlAffiliate(unittest.TestCase):
    """SupplierUrlAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierUrlAffiliate:
        """Test SupplierUrlAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierUrlAffiliate`
        """
        model = SupplierUrlAffiliate()
        if include_optional:
            return SupplierUrlAffiliate(
                identifier = '',
                seller_identifier = '',
    ...
    def testSupplierUrlAffiliate(self):
        """Test SupplierUrlAffiliate"""
