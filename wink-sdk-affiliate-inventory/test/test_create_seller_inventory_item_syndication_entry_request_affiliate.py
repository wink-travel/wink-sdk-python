...
class TestCreateSellerInventoryItemSyndicationEntryRequestAffiliate(unittest.TestCase):
    """CreateSellerInventoryItemSyndicationEntryRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSellerInventoryItemSyndicationEntryRequestAffiliate:
        """Test CreateSellerInventoryItemSyndicationEntryRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSellerInventoryItemSyndicationEntryRequestAffiliate`
        """
        model = CreateSellerInventoryItemSyndicationEntryRequestAffiliate()
        if include_optional:
            return CreateSellerInventoryItemSyndicationEntryRequestAffiliate(
                identifier = ''
            )
        else:
            return CreateSellerInventoryItemSyndicationEntryRequestAffiliate(
    ...
    def testCreateSellerInventoryItemSyndicationEntryRequestAffiliate(self):
        """Test CreateSellerInventoryItemSyndicationEntryRequestAffiliate"""
