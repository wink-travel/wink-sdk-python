...
class TestSellableRankedListAffiliate(unittest.TestCase):
    """SellableRankedListAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableRankedListAffiliate:
        """Test SellableRankedListAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableRankedListAffiliate`
        """
        model = SellableRankedListAffiliate()
        if include_optional:
            return SellableRankedListAffiliate(
                id = 'doc-1',
    ...
    def testSellableRankedListAffiliate(self):
        """Test SellableRankedListAffiliate"""
