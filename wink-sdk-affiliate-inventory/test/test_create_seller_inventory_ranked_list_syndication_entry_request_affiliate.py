...
class TestCreateSellerInventoryRankedListSyndicationEntryRequestAffiliate(unittest.TestCase):
    """CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate:
        """Test CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate`
        """
        model = CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate()
        if include_optional:
            return CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate(
                identifier = ''
            )
        else:
            return CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate(
    ...
    def testCreateSellerInventoryRankedListSyndicationEntryRequestAffiliate(self):
        """Test CreateSellerInventoryRankedListSyndicationEntryRequestAffiliate"""
