...
class TestUpsertSellerInventoryListRequestAffiliate(unittest.TestCase):
    """UpsertSellerInventoryListRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSellerInventoryListRequestAffiliate:
        """Test UpsertSellerInventoryListRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSellerInventoryListRequestAffiliate`
        """
        model = UpsertSellerInventoryListRequestAffiliate()
        if include_optional:
            return UpsertSellerInventoryListRequestAffiliate(
    ...
    def testUpsertSellerInventoryListRequestAffiliate(self):
        """Test UpsertSellerInventoryListRequestAffiliate"""
