...
class TestSellerInventoryItemViewAffiliate(unittest.TestCase):
    """SellerInventoryItemViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerInventoryItemViewAffiliate:
        """Test SellerInventoryItemViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerInventoryItemViewAffiliate`
        """
        model = SellerInventoryItemViewAffiliate()
        if include_optional:
            return SellerInventoryItemViewAffiliate(
                ...
                version = 12,
                seller_inventory_item = wink_sdk_affiliate_inventory.models.seller_inventory_item_affiliate.SellerInventoryItem_Affiliate(
                    identifier = '', 
                    seller_identifier = '', 
    ...
    def testSellerInventoryItemViewAffiliate(self):
        """Test SellerInventoryItemViewAffiliate"""
