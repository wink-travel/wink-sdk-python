...
class TestCreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate(unittest.TestCase):
    """CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate:
        """Test CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate`
        """
        model = CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate()
        if include_optional:
            return CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate(
                identifier = ''
            )
        else:
            return CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate(
    ...
    def testCreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate(self):
        """Test CreateAdvancedMapConfigurationSyndicationEntryRequestAffiliate"""
