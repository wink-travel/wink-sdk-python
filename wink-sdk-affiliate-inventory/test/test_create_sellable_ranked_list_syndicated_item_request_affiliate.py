...
class TestCreateSellableRankedListSyndicatedItemRequestAffiliate(unittest.TestCase):
    """CreateSellableRankedListSyndicatedItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSellableRankedListSyndicatedItemRequestAffiliate:
        """Test CreateSellableRankedListSyndicatedItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSellableRankedListSyndicatedItemRequestAffiliate`
        """
        model = CreateSellableRankedListSyndicatedItemRequestAffiliate()
        if include_optional:
            return CreateSellableRankedListSyndicatedItemRequestAffiliate(
                identifier = '0'
            )
        else:
            return CreateSellableRankedListSyndicatedItemRequestAffiliate(
    ...
    def testCreateSellableRankedListSyndicatedItemRequestAffiliate(self):
        """Test CreateSellableRankedListSyndicatedItemRequestAffiliate"""
