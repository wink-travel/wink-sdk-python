...
class TestUpsertSupplierSellerInventoryItemRequestAffiliate(unittest.TestCase):
    """UpsertSupplierSellerInventoryItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSupplierSellerInventoryItemRequestAffiliate:
        """Test UpsertSupplierSellerInventoryItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSupplierSellerInventoryItemRequestAffiliate`
        """
        model = UpsertSupplierSellerInventoryItemRequestAffiliate()
        if include_optional:
            return UpsertSupplierSellerInventoryItemRequestAffiliate(
    ...
    def testUpsertSupplierSellerInventoryItemRequestAffiliate(self):
        """Test UpsertSupplierSellerInventoryItemRequestAffiliate"""
