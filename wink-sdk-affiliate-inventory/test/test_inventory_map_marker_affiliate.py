...
class TestInventoryMapMarkerAffiliate(unittest.TestCase):
    """InventoryMapMarkerAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryMapMarkerAffiliate:
        """Test InventoryMapMarkerAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryMapMarkerAffiliate`
        """
        model = InventoryMapMarkerAffiliate()
        if include_optional:
            return InventoryMapMarkerAffiliate(
                ...
                lowest_display_price = wink_sdk_affiliate_inventory.models.custom_monetary_amount.CustomMonetaryAmount(
                    amount = 1.337, 
                    currency = '', )
            )
        else:
    ...
    def testInventoryMapMarkerAffiliate(self):
        """Test InventoryMapMarkerAffiliate"""
