...
class TestCreateSupplierUrlSyndicationEntryRequestAffiliate(unittest.TestCase):
    """CreateSupplierUrlSyndicationEntryRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSupplierUrlSyndicationEntryRequestAffiliate:
        """Test CreateSupplierUrlSyndicationEntryRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSupplierUrlSyndicationEntryRequestAffiliate`
        """
        model = CreateSupplierUrlSyndicationEntryRequestAffiliate()
        if include_optional:
            return CreateSupplierUrlSyndicationEntryRequestAffiliate(
                identifier = ''
            )
        else:
            return CreateSupplierUrlSyndicationEntryRequestAffiliate(
    ...
    def testCreateSupplierUrlSyndicationEntryRequestAffiliate(self):
        """Test CreateSupplierUrlSyndicationEntryRequestAffiliate"""
