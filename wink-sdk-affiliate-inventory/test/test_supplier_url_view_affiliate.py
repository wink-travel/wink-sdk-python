...
class TestSupplierUrlViewAffiliate(unittest.TestCase):
    """SupplierUrlViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplierUrlViewAffiliate:
        """Test SupplierUrlViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplierUrlViewAffiliate`
        """
        model = SupplierUrlViewAffiliate()
        if include_optional:
            return SupplierUrlViewAffiliate(
                ...
                version = 12,
                supplier_url = wink_sdk_affiliate_inventory.models.supplier_url_affiliate.SupplierUrl_Affiliate(
                    identifier = '', 
                    seller_identifier = '', 
    ...
    def testSupplierUrlViewAffiliate(self):
        """Test SupplierUrlViewAffiliate"""
