...
class TestCustomizationAffiliate(unittest.TestCase):
    """CustomizationAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomizationAffiliate:
        """Test CustomizationAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomizationAffiliate`
        """
        model = CustomizationAffiliate()
        if include_optional:
            return CustomizationAffiliate(
                id = 'doc-1',
                ...
                self_hosted = True,
                theme_colors = wink_sdk_affiliate_inventory.models.customization_theme_colors_affiliate.CustomizationThemeColors_Affiliate(
                    primary = '#dc3545', 
                    secondary = '#6c757d', 
                    success = '#28a745', 
                    danger = '#dc3545', 
                ...
                city = wink_sdk_affiliate_inventory.models.geo_name_lightweight_affiliate.GeoNameLightweight_Affiliate(
                    geo_name_id = '5128581', 
                    type = 'CITY', 
                    name = 'New York City', 
                    ...
                    country = wink_sdk_affiliate_inventory.models.country_lightweight_affiliate.CountryLightweight_Affiliate(
                        iso = 'US', 
                        name = 'United States', 
                        capital = 'Washington', 
                        continent = 'NA', 
                        ...
                        geo_name_id = '6252001', ), 
                    sub_country = wink_sdk_affiliate_inventory.models.sub_country_lightweight_affiliate.SubCountryLightweight_Affiliate(
                        name = 'New York', 
                        ascii_name = 'New York', 
                        geo_name_id = '5128638', ), 
                    sub_sub_country = wink_sdk_affiliate_inventory.models.sub_sub_country_lightweight_affiliate.SubSubCountryLightweight_Affiliate(
                        name = '', 
                        ascii_name = '', 
                        geo_name_id = '', ), ),
    ...
    def testCustomizationAffiliate(self):
        """Test CustomizationAffiliate"""
