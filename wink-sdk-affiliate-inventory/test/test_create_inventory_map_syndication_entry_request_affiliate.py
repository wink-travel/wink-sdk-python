...
class TestCreateInventoryMapSyndicationEntryRequestAffiliate(unittest.TestCase):
    """CreateInventoryMapSyndicationEntryRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateInventoryMapSyndicationEntryRequestAffiliate:
        """Test CreateInventoryMapSyndicationEntryRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateInventoryMapSyndicationEntryRequestAffiliate`
        """
        model = CreateInventoryMapSyndicationEntryRequestAffiliate()
        if include_optional:
            return CreateInventoryMapSyndicationEntryRequestAffiliate(
                identifier = '0'
            )
        else:
            return CreateInventoryMapSyndicationEntryRequestAffiliate(
    ...
    def testCreateInventoryMapSyndicationEntryRequestAffiliate(self):
        """Test CreateInventoryMapSyndicationEntryRequestAffiliate"""
