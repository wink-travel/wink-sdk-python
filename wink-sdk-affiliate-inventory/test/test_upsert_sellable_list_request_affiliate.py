...
class TestUpsertSellableListRequestAffiliate(unittest.TestCase):
    """UpsertSellableListRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSellableListRequestAffiliate:
        """Test UpsertSellableListRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSellableListRequestAffiliate`
        """
        model = UpsertSellableListRequestAffiliate()
        if include_optional:
            return UpsertSellableListRequestAffiliate(
                name = 'My list',
    ...
    def testUpsertSellableListRequestAffiliate(self):
        """Test UpsertSellableListRequestAffiliate"""
