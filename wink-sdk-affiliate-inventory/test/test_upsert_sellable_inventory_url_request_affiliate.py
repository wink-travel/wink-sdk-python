...
class TestUpsertSellableInventoryUrlRequestAffiliate(unittest.TestCase):
    """UpsertSellableInventoryUrlRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSellableInventoryUrlRequestAffiliate:
        """Test UpsertSellableInventoryUrlRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSellableInventoryUrlRequestAffiliate`
        """
        model = UpsertSellableInventoryUrlRequestAffiliate()
        if include_optional:
            return UpsertSellableInventoryUrlRequestAffiliate(
                name = 'My Bali Villa',
                ...
                keywords = [bali],
                twitter_account = '@travelikoworld',
                facebook_app_id = '19827398721938798237',
                theme = 'THEME_1',
                inventory_type = 'GUEST_ROOM',
                supplier_identifier = 'hotel-1',
                channel_inventory_identifier = 'channel-blocking-1',
                transactional_item_identifier = 'transactional-item-1',
                multimedia_identifiers = [cloudinary-image-1],
                animate = True,
                animate_delay = 1000
            )
        else:
    ...
    def testUpsertSellableInventoryUrlRequestAffiliate(self):
        """Test UpsertSellableInventoryUrlRequestAffiliate"""
