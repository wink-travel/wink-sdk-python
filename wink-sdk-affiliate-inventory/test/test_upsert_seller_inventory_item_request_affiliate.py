...
class TestUpsertSellerInventoryItemRequestAffiliate(unittest.TestCase):
    """UpsertSellerInventoryItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSellerInventoryItemRequestAffiliate:
        """Test UpsertSellerInventoryItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSellerInventoryItemRequestAffiliate`
        """
        model = UpsertSellerInventoryItemRequestAffiliate()
        if include_optional:
            return UpsertSellerInventoryItemRequestAffiliate(
    ...
    def testUpsertSellerInventoryItemRequestAffiliate(self):
        """Test UpsertSellerInventoryItemRequestAffiliate"""
