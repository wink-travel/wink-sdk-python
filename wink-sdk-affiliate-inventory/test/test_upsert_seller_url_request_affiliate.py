...
class TestUpsertSellerUrlRequestAffiliate(unittest.TestCase):
    """UpsertSellerUrlRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSellerUrlRequestAffiliate:
        """Test UpsertSellerUrlRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSellerUrlRequestAffiliate`
        """
        model = UpsertSellerUrlRequestAffiliate()
        if include_optional:
            return UpsertSellerUrlRequestAffiliate(
                seller_url_name = 'My Bali Villa',
    ...
    def testUpsertSellerUrlRequestAffiliate(self):
        """Test UpsertSellerUrlRequestAffiliate"""
