...
class TestSupplierLinksApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = SupplierLinksApi()

    def tearDown(self) -> None:
        pass

    def test_create_supplier_url(self) -> None:
        """Test case for create_supplier_url
    ...
    def test_remove_supplier_url(self) -> None:
        """Test case for remove_supplier_url

        Delete Link
        """
        pass

    def test_show_supplier_url(self) -> None:
        """Test case for show_supplier_url

        Show Link
        """
        pass

    def test_show_supplier_urls(self) -> None:
        """Test case for show_supplier_urls

        Show Links
        """
        pass

    def test_update_supplier_url(self) -> None:
        """Test case for update_supplier_url
