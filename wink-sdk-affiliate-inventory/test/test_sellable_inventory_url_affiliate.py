...
class TestSellableInventoryUrlAffiliate(unittest.TestCase):
    """SellableInventoryUrlAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellableInventoryUrlAffiliate:
        """Test SellableInventoryUrlAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellableInventoryUrlAffiliate`
        """
        model = SellableInventoryUrlAffiliate()
        if include_optional:
            return SellableInventoryUrlAffiliate(
                id = 'doc-1',
    ...
    def testSellableInventoryUrlAffiliate(self):
        """Test SellableInventoryUrlAffiliate"""
