...
class TestLookupLightweightAffiliate(unittest.TestCase):
    """LookupLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LookupLightweightAffiliate:
        """Test LookupLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LookupLightweightAffiliate`
        """
        model = LookupLightweightAffiliate()
        if include_optional:
            return LookupLightweightAffiliate(
                identifier = 'lookup-1',
                type = 'CITY',
    ...
    def testLookupLightweightAffiliate(self):
        """Test LookupLightweightAffiliate"""
