...
class TestRoomConfigurationAffiliate(unittest.TestCase):
    """RoomConfigurationAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoomConfigurationAffiliate:
        """Test RoomConfigurationAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoomConfigurationAffiliate`
        """
        model = RoomConfigurationAffiliate()
        if include_optional:
            return RoomConfigurationAffiliate(
                adults = 2,
                children = [
    ...
    def testRoomConfigurationAffiliate(self):
        """Test RoomConfigurationAffiliate"""
