...
class TestCreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate(unittest.TestCase):
    """CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate:
        """Test CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate`
        """
        model = CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate()
        if include_optional:
            return CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate(
                identifier = '0'
            )
        else:
            return CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate(
    ...
    def testCreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate(self):
        """Test CreateSyndicatedItemFromSellableSupplierUrlRequestAffiliate"""
