...
class TestCreateStaticListSyndicationEntryRequestAffiliate(unittest.TestCase):
    """CreateStaticListSyndicationEntryRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStaticListSyndicationEntryRequestAffiliate:
        """Test CreateStaticListSyndicationEntryRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStaticListSyndicationEntryRequestAffiliate`
        """
        model = CreateStaticListSyndicationEntryRequestAffiliate()
        if include_optional:
            return CreateStaticListSyndicationEntryRequestAffiliate(
                identifier = '0'
            )
        else:
            return CreateStaticListSyndicationEntryRequestAffiliate(
    ...
    def testCreateStaticListSyndicationEntryRequestAffiliate(self):
        """Test CreateStaticListSyndicationEntryRequestAffiliate"""
