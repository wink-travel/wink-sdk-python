...
class TestCampaignInventoryAffiliate(unittest.TestCase):
    """CampaignInventoryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignInventoryAffiliate:
        """Test CampaignInventoryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignInventoryAffiliate`
        """
        model = CampaignInventoryAffiliate()
        if include_optional:
            return CampaignInventoryAffiliate(
                name = '',
                layout = 'AD_BANNER',
                id = '',
    ...
    def testCampaignInventoryAffiliate(self):
        """Test CampaignInventoryAffiliate"""
