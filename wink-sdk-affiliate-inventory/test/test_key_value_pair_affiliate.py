...
class TestKeyValuePairAffiliate(unittest.TestCase):
    """KeyValuePairAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyValuePairAffiliate:
        """Test KeyValuePairAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyValuePairAffiliate`
        """
        model = KeyValuePairAffiliate()
        if include_optional:
            return KeyValuePairAffiliate(
                value = 'id-1',
    ...
    def testKeyValuePairAffiliate(self):
        """Test KeyValuePairAffiliate"""
