...
class TestGeoJsonRectangleAffiliate(unittest.TestCase):
    """GeoJsonRectangleAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoJsonRectangleAffiliate:
        """Test GeoJsonRectangleAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoJsonRectangleAffiliate`
        """
        model = GeoJsonRectangleAffiliate()
        if include_optional:
            return GeoJsonRectangleAffiliate(
    ...
    def testGeoJsonRectangleAffiliate(self):
        """Test GeoJsonRectangleAffiliate"""
