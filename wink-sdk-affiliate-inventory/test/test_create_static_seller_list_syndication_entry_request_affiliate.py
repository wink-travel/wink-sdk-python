...
class TestCreateStaticSellerListSyndicationEntryRequestAffiliate(unittest.TestCase):
    """CreateStaticSellerListSyndicationEntryRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStaticSellerListSyndicationEntryRequestAffiliate:
        """Test CreateStaticSellerListSyndicationEntryRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStaticSellerListSyndicationEntryRequestAffiliate`
        """
        model = CreateStaticSellerListSyndicationEntryRequestAffiliate()
        if include_optional:
            return CreateStaticSellerListSyndicationEntryRequestAffiliate(
                identifier = ''
            )
        else:
            return CreateStaticSellerListSyndicationEntryRequestAffiliate(
    ...
    def testCreateStaticSellerListSyndicationEntryRequestAffiliate(self):
        """Test CreateStaticSellerListSyndicationEntryRequestAffiliate"""
