...
class TestLookupAffiliate(unittest.TestCase):
    """LookupAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LookupAffiliate:
        """Test LookupAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LookupAffiliate`
        """
        model = LookupAffiliate()
        if include_optional:
            return LookupAffiliate(
                identifier = '',
                type = 'CITY',
                type_identifier = '',
