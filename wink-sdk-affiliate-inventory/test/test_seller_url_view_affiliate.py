...
class TestSellerUrlViewAffiliate(unittest.TestCase):
    """SellerUrlViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellerUrlViewAffiliate:
        """Test SellerUrlViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellerUrlViewAffiliate`
        """
        model = SellerUrlViewAffiliate()
        if include_optional:
            return SellerUrlViewAffiliate(
                ...
                version = 12,
                seller_url = wink_sdk_affiliate_inventory.models.seller_url_affiliate.SellerUrl_Affiliate(
                    identifier = '', 
                    seller_identifier = '', 
    ...
    def testSellerUrlViewAffiliate(self):
        """Test SellerUrlViewAffiliate"""
