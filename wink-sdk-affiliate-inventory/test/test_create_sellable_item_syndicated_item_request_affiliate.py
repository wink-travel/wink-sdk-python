...
class TestCreateSellableItemSyndicatedItemRequestAffiliate(unittest.TestCase):
    """CreateSellableItemSyndicatedItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSellableItemSyndicatedItemRequestAffiliate:
        """Test CreateSellableItemSyndicatedItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSellableItemSyndicatedItemRequestAffiliate`
        """
        model = CreateSellableItemSyndicatedItemRequestAffiliate()
        if include_optional:
            return CreateSellableItemSyndicatedItemRequestAffiliate(
                identifier = '0'
            )
        else:
            return CreateSellableItemSyndicatedItemRequestAffiliate(
    ...
    def testCreateSellableItemSyndicatedItemRequestAffiliate(self):
        """Test CreateSellableItemSyndicatedItemRequestAffiliate"""
