...
class TestEngineConfigurationThemeAffiliate(unittest.TestCase):
    """EngineConfigurationThemeAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineConfigurationThemeAffiliate:
        """Test EngineConfigurationThemeAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineConfigurationThemeAffiliate`
        """
        model = EngineConfigurationThemeAffiliate()
        if include_optional:
            return EngineConfigurationThemeAffiliate(
                primary = '#dc3545',
                secondary = '#6c757d',
                success = '#28a745',
                danger = '#dc3545',
    ...
    def testEngineConfigurationThemeAffiliate(self):
        """Test EngineConfigurationThemeAffiliate"""
