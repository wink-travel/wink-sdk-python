...
class TestUpsertInventoryMapRequestAffiliate(unittest.TestCase):
    """UpsertInventoryMapRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertInventoryMapRequestAffiliate:
        """Test UpsertInventoryMapRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertInventoryMapRequestAffiliate`
        """
        model = UpsertInventoryMapRequestAffiliate()
        if include_optional:
            return UpsertInventoryMapRequestAffiliate(
    ...
    def testUpsertInventoryMapRequestAffiliate(self):
        """Test UpsertInventoryMapRequestAffiliate"""
