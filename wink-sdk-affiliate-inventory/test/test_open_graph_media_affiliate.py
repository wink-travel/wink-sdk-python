...
class TestOpenGraphMediaAffiliate(unittest.TestCase):
    """OpenGraphMediaAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenGraphMediaAffiliate:
        """Test OpenGraphMediaAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenGraphMediaAffiliate`
        """
        model = OpenGraphMediaAffiliate()
        if include_optional:
            return OpenGraphMediaAffiliate(
    ...
    def testOpenGraphMediaAffiliate(self):
        """Test OpenGraphMediaAffiliate"""
