...
class TestUpsertSellableSupplierUrlRequestAffiliate(unittest.TestCase):
    """UpsertSellableSupplierUrlRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSellableSupplierUrlRequestAffiliate:
        """Test UpsertSellableSupplierUrlRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSellableSupplierUrlRequestAffiliate`
        """
        model = UpsertSellableSupplierUrlRequestAffiliate()
        if include_optional:
            return UpsertSellableSupplierUrlRequestAffiliate(
                name = 'My Bali Villa',
    ...
    def testUpsertSellableSupplierUrlRequestAffiliate(self):
        """Test UpsertSellableSupplierUrlRequestAffiliate"""
