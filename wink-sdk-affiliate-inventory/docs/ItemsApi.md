...
------------- | ------------- | -------------
[**create_supplier_seller_inventory_item**](ItemsApi.md#create_supplier_seller_inventory_item) | **POST** /api/item/supplier | Create Supplier Item
[**remove_seller_inventory_item**](ItemsApi.md#remove_seller_inventory_item) | **DELETE** /api/item/{inventoryIdentifier} | Delete Item
[**show_inventory_media1**](ItemsApi.md#show_inventory_media1) | **GET** /api/item/inventory/{channelInventoryIdentifier}/media/list | Show Item Media
[**show_seller_inventory_item**](ItemsApi.md#show_seller_inventory_item) | **GET** /api/item/{inventoryIdentifier} | Show Item
[**show_seller_inventory_items_for_company**](ItemsApi.md#show_seller_inventory_items_for_company) | **GET** /api/item/list | Show Items
[**update_seller_inventory_item**](ItemsApi.md#update_seller_inventory_item) | **PUT** /api/item/{inventoryIdentifier} | Update Item
