...
[**create_inventory_url_syndication_entry**](SyndicatedItemApi.md#create_inventory_url_syndication_entry) | **POST** /api/shareable-link/inventory/syndication/entry | Add to WinkLinks
...
# **create_inventory_url_syndication_entry**
> SyndicatedItemAffiliate create_inventory_url_syndication_entry(create_syndicated_item_from_sellable_inventory_url_request_affiliate, wink_version=wink_version)
...
with wink_sdk_affiliate_inventory.ApiClient(configuration) as api_client:
    ...
    try:
        # Add to WinkLinks
        api_response = api_instance.create_inventory_url_syndication_entry(create_syndicated_item_from_sellable_inventory_url_request_affiliate, wink_version=wink_version)
        print("The response of SyndicatedItemApi->create_inventory_url_syndication_entry:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SyndicatedItemApi->create_inventory_url_syndication_entry: %s\n" % e)
```
