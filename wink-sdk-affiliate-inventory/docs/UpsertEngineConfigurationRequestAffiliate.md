...
**theme_colors** | [**EngineConfigurationThemeAffiliate**](EngineConfigurationThemeAffiliate.md) |  | [optional] 
...
upsert_engine_configuration_request_affiliate_instance = UpsertEngineConfigurationRequestAffiliate.from_json(json)
# print the JSON string representation of the object
print(UpsertEngineConfigurationRequestAffiliate.to_json())

# convert the object into a dict
upsert_engine_configuration_request_affiliate_dict = upsert_engine_configuration_request_affiliate_instance.to_dict()
# create an instance of UpsertEngineConfigurationRequestAffiliate from a dict
upsert_engine_configuration_request_affiliate_from_dict = UpsertEngineConfigurationRequestAffiliate.from_dict(upsert_engine_configuration_request_affiliate_dict)
```
