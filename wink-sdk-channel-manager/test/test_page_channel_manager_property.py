...
class TestPageChannelManagerProperty(unittest.TestCase):
    """PageChannelManagerProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageChannelManagerProperty:
        """Test PageChannelManagerProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageChannelManagerProperty`
        """
        model = PageChannelManagerProperty()
        if include_optional:
            return PageChannelManagerProperty(
                total_elements = 56,
                total_pages = 56,
                size = 56,
                content = [
                    wink_sdk_channel_manager.models.channel_manager_property.ChannelManagerProperty(
                        identifier = '0', 
                        name = '0', 
                        city = '0', 
                        country_code = '0', 
                ...
                sort = wink_sdk_channel_manager.models.sort_object.SortObject(
                    empty = True, 
                    sorted = True, 
                    unsorted = True, ),
                pageable = wink_sdk_channel_manager.models.pageable_object.PageableObject(
                    offset = 56, 
                    sort = wink_sdk_channel_manager.models.sort_object.SortObject(
                        empty = True, 
                        sorted = True, 
    ...
    def testPageChannelManagerProperty(self):
        """Test PageChannelManagerProperty"""
