...
class TestChannelManagerApi(unittest.TestCase):
    ...
    def test_show_properties(self) -> None:
        """Test case for show_properties

        Show Properties
        """
        pass

    def test_show_property(self) -> None:
    ...
    def test_show_property_booking(self) -> None:
        """Test case for show_property_booking

        Show Booking
        """
        pass

    def test_show_property_bookings(self) -> None:
        """Test case for show_property_bookings

        Show Bookings
        """
        pass

    def test_show_property_room_rates(self) -> None:
        """Test case for show_property_room_rates
