...
class TestPropertyWithRoomRateList(unittest.TestCase):
    """PropertyWithRoomRateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyWithRoomRateList:
        """Test PropertyWithRoomRateList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyWithRoomRateList`
        """
        model = PropertyWithRoomRateList()
        if include_optional:
            return PropertyWithRoomRateList(
                var_property = wink_sdk_channel_manager.models.property.Property(
                    identifier = '', 
                    name = '', 
                    city = '', 
                    country_code = '', 
                    ...
                    time_zone = '', ),
                list = [
                    wink_sdk_channel_manager.models.property_room_rate.PropertyRoomRate(
                        identifier = '', 
                        property_identifier = '', 
                        name = '', 
    ...
    def testPropertyWithRoomRateList(self):
        """Test PropertyWithRoomRateList"""
