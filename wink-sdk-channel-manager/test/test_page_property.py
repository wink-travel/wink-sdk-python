...
class TestPageProperty(unittest.TestCase):
    """PageProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageProperty:
        """Test PageProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageProperty`
        """
        model = PageProperty()
        if include_optional:
            return PageProperty(
                ...
                size = 56,
                content = [
                    wink_sdk_channel_manager.models.property.Property(
                        identifier = '', 
                        name = '', 
                        city = '', 
                        country_code = '', 
                ...
                number = 56,
                sort = [
                    wink_sdk_channel_manager.models.sort_object.SortObject(
                        direction = '', 
                        null_handling = '', 
                        ascending = True, 
                        property = '', 
