...
class TestChannelManagerProperty(unittest.TestCase):
    """ChannelManagerProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelManagerProperty:
        """Test ChannelManagerProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelManagerProperty`
        """
        model = ChannelManagerProperty()
        if include_optional:
            return ChannelManagerProperty(
                identifier = '0',
                name = '0',
                city = '0',
                country_code = '0',
    ...
    def testChannelManagerProperty(self):
        """Test ChannelManagerProperty"""
