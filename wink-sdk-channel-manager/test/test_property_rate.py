...
class TestPropertyRate(unittest.TestCase):
    """PropertyRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyRate:
        """Test PropertyRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyRate`
        """
        model = PropertyRate()
        if include_optional:
            return PropertyRate(
