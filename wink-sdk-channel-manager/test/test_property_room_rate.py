...
class TestPropertyRoomRate(unittest.TestCase):
    """PropertyRoomRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyRoomRate:
        """Test PropertyRoomRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyRoomRate`
        """
        model = PropertyRoomRate()
        if include_optional:
            return PropertyRoomRate(
                identifier = '',
                property_identifier = '',
                name = '',
