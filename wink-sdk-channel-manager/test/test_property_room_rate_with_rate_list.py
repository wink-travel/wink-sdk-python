...
class TestPropertyRoomRateWithRateList(unittest.TestCase):
    """PropertyRoomRateWithRateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyRoomRateWithRateList:
        """Test PropertyRoomRateWithRateList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyRoomRateWithRateList`
        """
        model = PropertyRoomRateWithRateList()
        if include_optional:
            return PropertyRoomRateWithRateList(
                room = wink_sdk_channel_manager.models.property_room_rate.PropertyRoomRate(
                    identifier = '', 
                    property_identifier = '', 
                    name = '', 
                    ...
                    min_occupancy = 56, 
                    max_occupancy = 56, 
                    max_adult_occupancy = 56, 
                    max_child_occupancy = 56, 
                    included_adult_occupancy = 56, 
                    included_child_occupancy = 56, 
                    base_rate = wink_sdk_channel_manager.models.custom_monetary_amount.CustomMonetaryAmount(
                        amount = 1.337, 
                        currency = '', ), 
                ...
                rates = [
                    wink_sdk_channel_manager.models.property_rate.PropertyRate(
                        identifier = '', 
                        property_identifier = '', 
    ...
    def testPropertyRoomRateWithRateList(self):
        """Test PropertyRoomRateWithRateList"""
