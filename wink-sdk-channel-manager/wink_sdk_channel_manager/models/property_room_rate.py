...
class PropertyRoomRate(BaseModel):
    ...
    room_type_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="roomTypeIdentifier")
    rate_plan_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="ratePlanIdentifier")
    guest_room_name: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="guestRoomName")
    rate_plan_name: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="ratePlanName")
