...
class PropertyWithRoomRateList(BaseModel):
    """
    PropertyWithRoomRateList
    """ # noqa: E501
    var_property: ChannelManagerProperty = Field(alias="property")
    list: Optional[List[PropertyRoomRate]] = None
    __properties: ClassVar[List[str]] = ["property", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property": ChannelManagerProperty.from_dict(obj["property"]) if obj.get("property") is not None else None,
            "list": [PropertyRoomRate.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
