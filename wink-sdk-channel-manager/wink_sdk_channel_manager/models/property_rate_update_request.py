...
class PropertyRateUpdateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["startDate", "endDate", "amount", "currencyCode", "master", "closedOnArrival", "closedOnDeparture", "quantity", "minLengthOfStay", "maxLengthOfStay", "minOccupancy", "maxOccupancy", "singleOccupancyRateModifier", "extraPaxRateModifier", "extraChildRateModifier"]
