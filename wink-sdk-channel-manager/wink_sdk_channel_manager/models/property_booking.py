...
class PropertyBooking(BaseModel):
    ...
    PropertyBooking
    """ # noqa: E501
    booking_identifier: StrictStr = Field(description="Booking ID", alias="bookingIdentifier")
    property_identifier: StrictStr = Field(description="Property ID", alias="propertyIdentifier")
    room_rate_identifier: StrictStr = Field(description="Master Rate ID", alias="roomRateIdentifier")
    name: StrictStr = Field(description="Master Rate name")
    guest_room_name: StrictStr = Field(description="Guest room name", alias="guestRoomName")
    rate_plan_name: StrictStr = Field(description="Rate plan name", alias="ratePlanName")
    ...
    first_name: StrictStr = Field(description="First name of traveler", alias="firstName")
    last_name: StrictStr = Field(description="Last name of traveler", alias="lastName")
    email: StrictStr = Field(description="E-mail of traveler")
    amount: Union[StrictFloat, StrictInt] = Field(description="Total booking amount")
    currency_code: StrictStr = Field(description="Supplier currency", alias="currencyCode")
    booking_code: StrictStr = Field(description="Ref. code for traveler", alias="bookingCode")
    ...
    payment_method_type: StrictStr = Field(description="Payment method", alias="paymentMethodType")
    ...
    sales_channel_name: StrictStr = Field(description="Sales channel name", alias="salesChannelName")
    sales_channel_identifier: StrictStr = Field(description="Sales channel ID", alias="salesChannelIdentifier")
