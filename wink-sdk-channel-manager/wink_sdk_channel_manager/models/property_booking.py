...
class PropertyBooking(BaseModel):
    ...
    PropertyBooking
    """ # noqa: E501
    booking_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Booking ID", alias="bookingIdentifier")
    property_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="ChannelManagerProperty ID", alias="propertyIdentifier")
    room_rate_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Master Rate ID", alias="roomRateIdentifier")
    ...
    sales_channel_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Sales channel ID", alias="salesChannelIdentifier")
