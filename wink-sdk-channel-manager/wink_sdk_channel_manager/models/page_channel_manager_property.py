...
from wink_sdk_channel_manager.models.sort_object import SortObject
from typing import Optional, Set
from typing_extensions import Self

class PageChannelManagerProperty(BaseModel):
    """
    ...
    content: Optional[List[ChannelManagerProperty]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [ChannelManagerProperty.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
