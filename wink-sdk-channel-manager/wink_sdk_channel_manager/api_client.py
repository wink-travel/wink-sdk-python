...
from wink_sdk_channel_manager.configuration import Configuration
from wink_sdk_channel_manager.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_channel_manager.models
from wink_sdk_channel_manager import rest
from wink_sdk_channel_manager.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_channel_manager.models, klass)
