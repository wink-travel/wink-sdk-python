...
class TestChartRequestAuthenticatedEntity(unittest.TestCase):
    """ChartRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartRequestAuthenticatedEntity:
        """Test ChartRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartRequestAuthenticatedEntity`
        """
        model = ChartRequestAuthenticatedEntity()
        if include_optional:
            return ChartRequestAuthenticatedEntity(
                series = 'HOUR',
    ...
    def testChartRequestAuthenticatedEntity(self):
        """Test ChartRequestAuthenticatedEntity"""
