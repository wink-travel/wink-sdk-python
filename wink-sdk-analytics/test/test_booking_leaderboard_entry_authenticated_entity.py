...
class TestBookingLeaderboardEntryAuthenticatedEntity(unittest.TestCase):
    """BookingLeaderboardEntryAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookingLeaderboardEntryAuthenticatedEntity:
        """Test BookingLeaderboardEntryAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookingLeaderboardEntryAuthenticatedEntity`
        """
        model = BookingLeaderboardEntryAuthenticatedEntity()
        if include_optional:
            return BookingLeaderboardEntryAuthenticatedEntity(
                owner_identifier = '',
                owner_name = '',
                continent = '',
                country = '',
    ...
    def testBookingLeaderboardEntryAuthenticatedEntity(self):
        """Test BookingLeaderboardEntryAuthenticatedEntity"""
