...
class TestChartRequestViewAuthenticatedEntity(unittest.TestCase):
    """ChartRequestViewAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartRequestViewAuthenticatedEntity:
        """Test ChartRequestViewAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartRequestViewAuthenticatedEntity`
        """
        model = ChartRequestViewAuthenticatedEntity()
        if include_optional:
            return ChartRequestViewAuthenticatedEntity(
                ...
                version = 12,
                data = wink_sdk_analytics.models.chart_request_wrapper_authenticated_entity.ChartRequestWrapper_Authenticated_Entity(
                    identifier = '', 
                    owner_identifier = '', 
                    name = 'My First Chart', 
                    sort = 1, 
    ...
    def testChartRequestViewAuthenticatedEntity(self):
        """Test ChartRequestViewAuthenticatedEntity"""
