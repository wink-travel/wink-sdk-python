...
class TestPageBookingLeaderboardEntryAuthenticatedEntity(unittest.TestCase):
    """PageBookingLeaderboardEntryAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageBookingLeaderboardEntryAuthenticatedEntity:
        """Test PageBookingLeaderboardEntryAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageBookingLeaderboardEntryAuthenticatedEntity`
        """
        model = PageBookingLeaderboardEntryAuthenticatedEntity()
        if include_optional:
            return PageBookingLeaderboardEntryAuthenticatedEntity(
                total_pages = 56,
                total_elements = 56,
                size = 56,
                content = [
                    wink_sdk_analytics.models.booking_leaderboard_entry_authenticated_entity.BookingLeaderboardEntry_Authenticated_Entity(
                        owner_identifier = '', 
                        owner_name = '', 
                        continent = '', 
                        country = '', 
                        ...
                        city_geo_name_id = '', 
                        bookings = 56, 
                        total_price_amount = 1.337, 
                        average_booking_amount = 1.337, 
                        currency_code = '', )
                    ],
                number = 56,
                sort = wink_sdk_analytics.models.sort_object_authenticated_entity.SortObject_Authenticated_Entity(
                    empty = True, 
                    unsorted = True, 
                    sorted = True, ),
                first = True,
                ...
                pageable = wink_sdk_analytics.models.pageable_object_authenticated_entity.PageableObject_Authenticated_Entity(
                    offset = 56, 
                    page_size = 56, 
                    sort = wink_sdk_analytics.models.sort_object_authenticated_entity.SortObject_Authenticated_Entity(
                        empty = True, 
    ...
    def testPageBookingLeaderboardEntryAuthenticatedEntity(self):
        """Test PageBookingLeaderboardEntryAuthenticatedEntity"""
