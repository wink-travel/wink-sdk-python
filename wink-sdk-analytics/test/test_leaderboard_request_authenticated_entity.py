...
class TestLeaderboardRequestAuthenticatedEntity(unittest.TestCase):
    """LeaderboardRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeaderboardRequestAuthenticatedEntity:
        """Test LeaderboardRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeaderboardRequestAuthenticatedEntity`
        """
        model = LeaderboardRequestAuthenticatedEntity()
        if include_optional:
            return LeaderboardRequestAuthenticatedEntity(
                page = 0,
                size = 20,
                currency_code = 'USD',
                type = 'GLOBAL',
                grouping_identifier = '654321'
            )
        else:
            return LeaderboardRequestAuthenticatedEntity(
                page = 0,
    ...
    def testLeaderboardRequestAuthenticatedEntity(self):
        """Test LeaderboardRequestAuthenticatedEntity"""
