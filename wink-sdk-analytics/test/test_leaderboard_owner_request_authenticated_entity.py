...
class TestLeaderboardOwnerRequestAuthenticatedEntity(unittest.TestCase):
    """LeaderboardOwnerRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeaderboardOwnerRequestAuthenticatedEntity:
        """Test LeaderboardOwnerRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeaderboardOwnerRequestAuthenticatedEntity`
        """
        model = LeaderboardOwnerRequestAuthenticatedEntity()
        if include_optional:
            return LeaderboardOwnerRequestAuthenticatedEntity(
                currency_code = 'USD',
    ...
    def testLeaderboardOwnerRequestAuthenticatedEntity(self):
        """Test LeaderboardOwnerRequestAuthenticatedEntity"""
