...
class TestCategoryAxisNotesNonAuthenticatedEntity(unittest.TestCase):
    """CategoryAxisNotesNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryAxisNotesNonAuthenticatedEntity:
        """Test CategoryAxisNotesNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryAxisNotesNonAuthenticatedEntity`
        """
        model = CategoryAxisNotesNonAuthenticatedEntity()
        if include_optional:
            return CategoryAxisNotesNonAuthenticatedEntity(
                data = [
                    None
                    ],
    ...
    def testCategoryAxisNotesNonAuthenticatedEntity(self):
        """Test CategoryAxisNotesNonAuthenticatedEntity"""
