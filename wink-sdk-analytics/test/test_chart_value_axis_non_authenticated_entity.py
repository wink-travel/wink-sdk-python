...
class TestChartValueAxisNonAuthenticatedEntity(unittest.TestCase):
    """ChartValueAxisNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartValueAxisNonAuthenticatedEntity:
        """Test ChartValueAxisNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartValueAxisNonAuthenticatedEntity`
        """
        model = ChartValueAxisNonAuthenticatedEntity()
        if include_optional:
            return ChartValueAxisNonAuthenticatedEntity(
    ...
    def testChartValueAxisNonAuthenticatedEntity(self):
        """Test ChartValueAxisNonAuthenticatedEntity"""
