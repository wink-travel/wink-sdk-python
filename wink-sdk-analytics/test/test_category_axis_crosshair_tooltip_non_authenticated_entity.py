...
class TestCategoryAxisCrosshairTooltipNonAuthenticatedEntity(unittest.TestCase):
    """CategoryAxisCrosshairTooltipNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryAxisCrosshairTooltipNonAuthenticatedEntity:
        """Test CategoryAxisCrosshairTooltipNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryAxisCrosshairTooltipNonAuthenticatedEntity`
        """
        model = CategoryAxisCrosshairTooltipNonAuthenticatedEntity()
        if include_optional:
            return CategoryAxisCrosshairTooltipNonAuthenticatedEntity(
                background = '',
    ...
    def testCategoryAxisCrosshairTooltipNonAuthenticatedEntity(self):
        """Test CategoryAxisCrosshairTooltipNonAuthenticatedEntity"""
