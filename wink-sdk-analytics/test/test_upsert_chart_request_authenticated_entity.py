...
class TestUpsertChartRequestAuthenticatedEntity(unittest.TestCase):
    """UpsertChartRequestAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertChartRequestAuthenticatedEntity:
        """Test UpsertChartRequestAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertChartRequestAuthenticatedEntity`
        """
        model = UpsertChartRequestAuthenticatedEntity()
        if include_optional:
            return UpsertChartRequestAuthenticatedEntity(
                name = 'My First Chart',
                sort = 1,
                request = wink_sdk_analytics.models.chart_details_authenticated_entity.ChartDetails_Authenticated_Entity(
                    series = 'HOUR', 
    ...
    def testUpsertChartRequestAuthenticatedEntity(self):
        """Test UpsertChartRequestAuthenticatedEntity"""
