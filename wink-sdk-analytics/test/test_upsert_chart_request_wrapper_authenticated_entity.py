...
class TestUpsertChartRequestWrapperAuthenticatedEntity(unittest.TestCase):
    """UpsertChartRequestWrapperAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertChartRequestWrapperAuthenticatedEntity:
        """Test UpsertChartRequestWrapperAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertChartRequestWrapperAuthenticatedEntity`
        """
        model = UpsertChartRequestWrapperAuthenticatedEntity()
        if include_optional:
            return UpsertChartRequestWrapperAuthenticatedEntity(
                name = 'My First Chart',
                sort = 1,
    ...
    def testUpsertChartRequestWrapperAuthenticatedEntity(self):
        """Test UpsertChartRequestWrapperAuthenticatedEntity"""
