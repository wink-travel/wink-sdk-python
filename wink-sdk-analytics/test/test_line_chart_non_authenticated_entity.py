...
class TestLineChartNonAuthenticatedEntity(unittest.TestCase):
    """LineChartNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineChartNonAuthenticatedEntity:
        """Test LineChartNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineChartNonAuthenticatedEntity`
        """
        model = LineChartNonAuthenticatedEntity()
        if include_optional:
            return LineChartNonAuthenticatedEntity(
                identifier = '',
    ...
    def testLineChartNonAuthenticatedEntity(self):
        """Test LineChartNonAuthenticatedEntity"""
