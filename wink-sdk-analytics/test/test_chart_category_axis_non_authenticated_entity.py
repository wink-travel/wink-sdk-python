...
class TestChartCategoryAxisNonAuthenticatedEntity(unittest.TestCase):
    """ChartCategoryAxisNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartCategoryAxisNonAuthenticatedEntity:
        """Test ChartCategoryAxisNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartCategoryAxisNonAuthenticatedEntity`
        """
        model = ChartCategoryAxisNonAuthenticatedEntity()
        if include_optional:
            return ChartCategoryAxisNonAuthenticatedEntity(
                ...
                color = '',
                justified = True,
                line = wink_sdk_analytics.models.axis_line_non_authenticated_entity.AxisLine_Non_Authenticated_Entity(
                    color = '', 
                    dash_type = 'dash', 
                    visible = True, 
                    width = 1.337, ),
                ...
                crosshair = wink_sdk_analytics.models.crosshair.Crosshair(
                    ...
                    tooltip = wink_sdk_analytics.models.category_axis_crosshair_tooltip_non_authenticated_entity.CategoryAxisCrosshairTooltip_Non_Authenticated_Entity(
                        ...
                        padding = wink_sdk_analytics.models.padding_non_authenticated_entity.Padding_Non_Authenticated_Entity(
                            ...
                            left = 1.337, ), 
                        visible = True, ), ),
                labels = wink_sdk_analytics.models.labels.Labels(
                    rotation = '', ),
                notes = wink_sdk_analytics.models.notes.Notes(
                    data = [
                        None
                        ], 
                    line = wink_sdk_analytics.models.note_line_non_authenticated_entity.NoteLine_Non_Authenticated_Entity(
                        color = '', 
                        dash_type = 'dash', 
                        length = 1.337, 
                        width = 1.337, ), 
                ...
                title = wink_sdk_analytics.models.title.Title(
                    background = '', 
                    border = wink_sdk_analytics.models.border_non_authenticated_entity.Border_Non_Authenticated_Entity(
                        color = '', 
                        dash_type = 'dash', 
                    ...
                    color = '', 
                    font = '', 
                    margin = wink_sdk_analytics.models.margin_non_authenticated_entity.Margin_Non_Authenticated_Entity(
                        top = 1.337, 
                        right = 1.337, 
                        bottom = 1.337, 
                        left = 1.337, ), 
    ...
    def testChartCategoryAxisNonAuthenticatedEntity(self):
        """Test ChartCategoryAxisNonAuthenticatedEntity"""
