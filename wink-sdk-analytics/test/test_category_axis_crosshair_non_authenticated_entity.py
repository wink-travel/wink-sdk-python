...
class TestCategoryAxisCrosshairNonAuthenticatedEntity(unittest.TestCase):
    """CategoryAxisCrosshairNonAuthenticatedEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryAxisCrosshairNonAuthenticatedEntity:
        """Test CategoryAxisCrosshairNonAuthenticatedEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryAxisCrosshairNonAuthenticatedEntity`
        """
        model = CategoryAxisCrosshairNonAuthenticatedEntity()
        if include_optional:
            return CategoryAxisCrosshairNonAuthenticatedEntity(
                color = '',
                dash_type = 'dash',
                opacity = 1.337,
                visible = True,
    ...
    def testCategoryAxisCrosshairNonAuthenticatedEntity(self):
        """Test CategoryAxisCrosshairNonAuthenticatedEntity"""
