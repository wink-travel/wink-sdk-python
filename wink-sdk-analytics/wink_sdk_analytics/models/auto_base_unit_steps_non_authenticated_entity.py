...
class AutoBaseUnitStepsNonAuthenticatedEntity(BaseModel):
    """
    ...
    """ # noqa: E501
    milliseconds: Optional[Union[StrictFloat, StrictInt]] = None
    seconds: Optional[Union[StrictFloat, StrictInt]] = None
    minutes: Optional[Union[StrictFloat, StrictInt]] = None
    hours: Optional[Union[StrictFloat, StrictInt]] = None
    days: Optional[Union[StrictFloat, StrictInt]] = None
    weeks: Optional[Union[StrictFloat, StrictInt]] = None
    months: Optional[Union[StrictFloat, StrictInt]] = None
    years: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["milliseconds", "seconds", "minutes", "hours", "days", "weeks", "months", "years"]
