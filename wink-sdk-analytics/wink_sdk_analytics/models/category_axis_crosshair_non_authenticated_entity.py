...
class CategoryAxisCrosshairNonAuthenticatedEntity(BaseModel):
    """
    ...
    dash_type: Optional[StrictStr] = Field(default=None, alias="dashType")
    ...
    tooltip: Optional[CategoryAxisCrosshairTooltipNonAuthenticatedEntity] = None
    __properties: ClassVar[List[str]] = ["color", "dashType", "opacity", "visible", "width", "tooltip"]

    @field_validator('dash_type')
    def dash_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['dash', 'dashDot', 'dot', 'longDash', 'longDashDot', 'longDashDotDot', 'solid']):
            raise ValueError("must be one of enum values ('dash', 'dashDot', 'dot', 'longDash', 'longDashDot', 'longDashDotDot', 'solid')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tooltip
        if self.tooltip:
            _dict['tooltip'] = self.tooltip.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "color": obj.get("color"),
            "dashType": obj.get("dashType"),
            "opacity": obj.get("opacity"),
            "visible": obj.get("visible"),
            "width": obj.get("width"),
            "tooltip": CategoryAxisCrosshairTooltipNonAuthenticatedEntity.from_dict(obj["tooltip"]) if obj.get("tooltip") is not None else None
        })
        return _obj
