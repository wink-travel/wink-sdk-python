...
class LeaderboardOwnerRequestAuthenticatedEntity(BaseModel):
    """
    ...
    owner_identifier: UUID = Field(description="The company you wish to track on a leaderboard", alias="ownerIdentifier")
    __properties: ClassVar[List[str]] = ["currencyCode", "ownerIdentifier"]
