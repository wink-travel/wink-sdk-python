...
class ChartValueAxisNonAuthenticatedEntity(BaseModel):
    """
    The configuration options of the value axis.
    """ # noqa: E501
    labels: Optional[ChartValueAxisLabelsNonAuthenticatedEntity] = None
    line: Optional[ChartValueAxisLineNonAuthenticatedEntity] = None
    axis_crossing_value: Optional[StrictInt] = Field(default=None, description="- (Only for objects) The value at which the category axis crosses this axis. - (Only for arrays) The value indices at which the category axes cross the value axis. - (Only for dates) The date at which the category axis crosses this axis.", alias="axisCrossingValue")
    major_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The interval between major divisions. If `valueAxis.type` is set to `log`, the majorUnit value is used for the base of the logarithm.", alias="majorUnit")
    __properties: ClassVar[List[str]] = ["labels", "line", "axisCrossingValue", "majorUnit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labels": ChartValueAxisLabelsNonAuthenticatedEntity.from_dict(obj["labels"]) if obj.get("labels") is not None else None,
            "line": ChartValueAxisLineNonAuthenticatedEntity.from_dict(obj["line"]) if obj.get("line") is not None else None,
            "axisCrossingValue": obj.get("axisCrossingValue"),
            "majorUnit": obj.get("majorUnit")
        })
        return _obj
