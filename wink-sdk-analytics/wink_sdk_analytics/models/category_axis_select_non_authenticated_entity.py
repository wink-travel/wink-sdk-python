...
class CategoryAxisSelectNonAuthenticatedEntity(BaseModel):
    """
    ...
    mousewheel: Optional[Dict[str, Any]] = None
    to: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["from", "max", "min", "mousewheel", "to"]
