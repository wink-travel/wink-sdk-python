...
class UpsertChartRequestAuthenticatedEntity(BaseModel):
    """
    ...
    request: ChartDetailsAuthenticatedEntity = Field(description="Chart settings")
    __properties: ClassVar[List[str]] = ["name", "sort", "request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": ChartDetailsAuthenticatedEntity.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
