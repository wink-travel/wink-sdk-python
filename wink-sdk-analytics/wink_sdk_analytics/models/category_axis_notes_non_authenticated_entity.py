...
class CategoryAxisNotesNonAuthenticatedEntity(BaseModel):
    """
    The configuration of the category axis notes.
    """ # noqa: E501
    data: Optional[List[Dict[str, Any]]] = None
    line: Optional[NoteLineNonAuthenticatedEntity] = None
    position: Optional[StrictStr] = None
    icon: Optional[CategoryAxisNotesIconNonAuthenticatedEntity] = None
    label: Optional[CategoryAxisNotesLabelNonAuthenticatedEntity] = None
    __properties: ClassVar[List[str]] = ["data", "line", "position", "icon", "label"]
    ...
    def position_validate_enum(cls, value):
        ...
        if value not in set(['top', 'bottom', 'left', 'right']):
            raise ValueError("must be one of enum values ('top', 'bottom', 'left', 'right')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "line": NoteLineNonAuthenticatedEntity.from_dict(obj["line"]) if obj.get("line") is not None else None,
            "position": obj.get("position"),
            "icon": CategoryAxisNotesIconNonAuthenticatedEntity.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "label": CategoryAxisNotesLabelNonAuthenticatedEntity.from_dict(obj["label"]) if obj.get("label") is not None else None
        })
        return _obj
