...
class StateAuthenticatedEntity(BaseModel):
    """
    ...
    sort: Optional[List[SortDescriptorAuthenticatedEntity]] = Field(default=None, description="Descriptors used for sorting result set.")
    filter: Optional[CompositeFilterDescriptorAuthenticatedEntity] = Field(default=None, description="Descriptors used for filtering result set")
    group: Optional[List[GroupDescriptorAuthenticatedEntity]] = Field(default=None, description="Descriptors to group result sets by.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [SortDescriptorAuthenticatedEntity.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
            "filter": CompositeFilterDescriptorAuthenticatedEntity.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "group": [GroupDescriptorAuthenticatedEntity.from_dict(_item) for _item in obj["group"]] if obj.get("group") is not None else None
        })
        return _obj
