...
class AggregateSharesProjectionAuthenticatedEntity(BaseModel):
    """
    AggregateSharesProjectionAuthenticatedEntity
    """ # noqa: E501
    owner_identifier: Optional[StrictStr] = Field(default=None, description="Affiliate ID.", alias="ownerIdentifier")
    views: Optional[StrictInt] = None
    clicks: Optional[StrictInt] = None
    shares: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["ownerIdentifier", "views", "clicks", "shares"]
