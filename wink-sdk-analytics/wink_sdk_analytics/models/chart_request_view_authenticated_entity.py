...
class ChartRequestViewAuthenticatedEntity(BaseModel):
    """
    ...
    data: ChartRequestWrapperAuthenticatedEntity
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ChartRequestWrapperAuthenticatedEntity.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
