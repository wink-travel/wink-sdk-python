...
class PageBookingLeaderboardEntryAuthenticatedEntity(BaseModel):
    """
    ...
    content: Optional[List[BookingLeaderboardEntryAuthenticatedEntity]] = None
    number: Optional[StrictInt] = None
    pageable: Optional[PageableObjectAuthenticatedEntity] = None
    sort: Optional[SortObjectAuthenticatedEntity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [BookingLeaderboardEntryAuthenticatedEntity.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "number": obj.get("number"),
            "pageable": PageableObjectAuthenticatedEntity.from_dict(obj["pageable"]) if obj.get("pageable") is not None else None,
            "sort": SortObjectAuthenticatedEntity.from_dict(obj["sort"]) if obj.get("sort") is not None else None,
