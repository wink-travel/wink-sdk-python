...
class CategoryAxisTitleNonAuthenticatedEntity(BaseModel):
    """
    Title of axis
    """ # noqa: E501
    background: Optional[StrictStr] = None
    border: Optional[BorderNonAuthenticatedEntity] = None
    color: Optional[StrictStr] = None
    font: Optional[StrictStr] = None
    margin: Optional[MarginNonAuthenticatedEntity] = None
    padding: Optional[PaddingNonAuthenticatedEntity] = None
    position: Optional[StrictStr] = None
    rotation: Optional[Union[StrictFloat, StrictInt]] = None
    text: Optional[StrictStr] = None
    visible: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["background", "border", "color", "font", "margin", "padding", "position", "rotation", "text", "visible"]
    ...
    def position_validate_enum(cls, value):
        ...
        if value not in set(['top', 'bottom', 'left', 'right', 'center']):
            raise ValueError("must be one of enum values ('top', 'bottom', 'left', 'right', 'center')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "border": BorderNonAuthenticatedEntity.from_dict(obj["border"]) if obj.get("border") is not None else None,
            "color": obj.get("color"),
            "font": obj.get("font"),
            "margin": MarginNonAuthenticatedEntity.from_dict(obj["margin"]) if obj.get("margin") is not None else None,
            "padding": PaddingNonAuthenticatedEntity.from_dict(obj["padding"]) if obj.get("padding") is not None else None,
