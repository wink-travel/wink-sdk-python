...
class CategoryAxisNotesIconNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["background", "border", "size", "type", "visible"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['square', 'circle', 'triangle', 'cross']):
            raise ValueError("must be one of enum values ('square', 'circle', 'triangle', 'cross')")
        return value
