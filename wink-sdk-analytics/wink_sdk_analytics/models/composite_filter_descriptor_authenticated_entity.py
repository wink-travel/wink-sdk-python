...
class CompositeFilterDescriptorAuthenticatedEntity(BaseModel):
    """
    ...
    filters: Optional[List[FilterDescriptorAuthenticatedEntity]] = Field(default=None, description="Descriptors used for filtering the result set")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logic": obj.get("logic"),
            "filters": [FilterDescriptorAuthenticatedEntity.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
