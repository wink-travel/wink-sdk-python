...
class ChartRequestWrapperAuthenticatedEntity(BaseModel):
    """
    ChartRequestWrapperAuthenticatedEntity
    """ # noqa: E501
    identifier: StrictStr = Field(description="Unique record identifier")
    owner_identifier: StrictStr = Field(description="Owner of this chart", alias="ownerIdentifier")
    name: StrictStr = Field(description="Chart name as named by creator")
    sort: Optional[StrictInt] = Field(default=-1, description="Sort a list of charts by this sort value.")
    request: ChartRequestAuthenticatedEntity
    __properties: ClassVar[List[str]] = ["identifier", "ownerIdentifier", "name", "sort", "request"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": ChartRequestAuthenticatedEntity.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
