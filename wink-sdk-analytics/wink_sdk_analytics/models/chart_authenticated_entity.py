...
class ChartAuthenticatedEntity(BaseModel):
    """
    ...
    owner_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Owner of this chart", alias="ownerIdentifier")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Chart name as named by creator")
    sort: Optional[StrictInt] = Field(default=-1, description="Sort a list of charts by this sort value.")
    details: ChartDetailsAuthenticatedEntity = Field(description="Chart settings")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "ownerIdentifier", "name", "sort", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "sort": obj.get("sort") if obj.get("sort") is not None else -1,
            "details": ChartDetailsAuthenticatedEntity.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
