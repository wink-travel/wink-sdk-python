...
class BookingLeaderboardEntryAuthenticatedEntity(BaseModel):
    """
    BookingLeaderboardEntryAuthenticatedEntity
    """ # noqa: E501
    owner_identifier: Optional[StrictStr] = Field(default=None, alias="ownerIdentifier")
    owner_name: Optional[StrictStr] = Field(default=None, alias="ownerName")
    continent: Optional[StrictStr] = None
    country: Optional[StrictStr] = None
    country_geo_name_id: Optional[StrictStr] = Field(default=None, alias="countryGeoNameId")
    city: Optional[StrictStr] = None
    city_geo_name_id: Optional[StrictStr] = Field(default=None, alias="cityGeoNameId")
    ...
    __properties: ClassVar[List[str]] = ["ownerIdentifier", "ownerName", "continent", "country", "countryGeoNameId", "city", "cityGeoNameId", "bookings", "totalPriceAmount", "averageBookingAmount", "currencyCode"]
