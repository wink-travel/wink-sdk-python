...
class ChartValueAxisLabelsNonAuthenticatedEntity(BaseModel):
    """
    The axis labels configuration.
    """ # noqa: E501
    format: Optional[StrictStr] = Field(default=None, description="The format for displaying the labels. Uses the format method of IntlService. Contains one placeholder (`{0}`) which represents the category value.")
