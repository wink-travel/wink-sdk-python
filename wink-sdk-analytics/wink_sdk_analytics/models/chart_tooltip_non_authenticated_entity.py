...
class ChartTooltipNonAuthenticatedEntity(BaseModel):
    """
    ...
    """ # noqa: E501
    visible: Optional[StrictBool] = Field(default=None, description="If set to `true`, the Chart displays the series tooltip. By default, the series tooltip is not displayed.")
    ...
    __properties: ClassVar[List[str]] = ["visible", "format"]
