...
class ChartSeriesAuthenticatedEntity(BaseModel):
    """
    ChartSeriesAuthenticatedEntity
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the Chart series which is visible in the legend.")
    data: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="The array of data items which represent the series data.  You can set it to:  - Array of numbers. Supported when the series.type option is set to `area`, `bar`, `column`, `donut`, `pie`, `line`, or `waterfall`. The Bubble series need arrays of three values—X value, Y value, and Size value—for example, [1, 1, 10]. The Scatter and ScatterLine series need arrays of two values—X value and Y value. The OHLC and Candlestick series need arrays of four values—open, high, low, and close. The RangeBar and RangeArea series need arrays of two values—the from and to value.")
