...
class ChartCategoryAxisAuthenticatedEntity(BaseModel):
    """
    ChartCategoryAxisAuthenticatedEntity
    """ # noqa: E501
    data: Optional[List[StrictStr]] = Field(default=None, description="The category names. The Chart creates a category for every item of the array.")
