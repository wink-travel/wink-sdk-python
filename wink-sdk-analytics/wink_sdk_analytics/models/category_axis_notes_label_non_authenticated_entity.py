...
class CategoryAxisNotesLabelNonAuthenticatedEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["background", "border", "color", "font", "format", "position", "rotation", "visible"]
    ...
    def position_validate_enum(cls, value):
        ...
        if value not in set(['inside', 'outside']):
            raise ValueError("must be one of enum values ('inside', 'outside')")
        return value
