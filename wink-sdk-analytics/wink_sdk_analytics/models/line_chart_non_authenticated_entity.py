...
class LineChartNonAuthenticatedEntity(BaseModel):
    ...
    title: Optional[ChartTitleNonAuthenticatedEntity] = None
    legend: Optional[ChartLegendNonAuthenticatedEntity] = None
    ...
    x_axis: Optional[ChartCategoryAxisNonAuthenticatedEntity] = Field(default=None, alias="xAxis")
