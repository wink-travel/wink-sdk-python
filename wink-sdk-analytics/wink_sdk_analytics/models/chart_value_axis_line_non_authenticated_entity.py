...
class ChartValueAxisLineNonAuthenticatedEntity(BaseModel):
    """
    The configuration of the axis lines. Also affects the major and minor ticks, but not the grid lines.
    """ # noqa: E501
    visible: Optional[StrictBool] = Field(default=None, description="If set to true, the Chart displays the axis lines. By default, the axis lines are visible.")
    __properties: ClassVar[List[str]] = ["visible"]
