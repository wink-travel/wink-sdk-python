...
class AnalyticsApi:
    ...
    def _create_chart_request_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/analytics/chart',
    ...
    def remove_chart_request(
        ...
        _param = self._remove_chart_request_serialize(
    ...
    @validate_call
    def remove_chart_request_with_http_info(
        self,
        chart_identifier: Annotated[StrictStr, Field(description="Chart identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def remove_chart_request_without_preload_content(
        self,
        chart_identifier: Annotated[StrictStr, Field(description="Chart identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _remove_chart_request_serialize(
        self,
        chart_identifier,
        wink_version,
        accept,
        ...
        # process the path parameters
        if chart_identifier is not None:
            _path_params['chartIdentifier'] = chart_identifier
        # process the query parameters
        # process the header parameters
        if wink_version is not None:
            _header_params['Wink-Version'] = wink_version
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/analytics/chart/{chartIdentifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def show_analytics_grid(
        self,
        state_non_authenticated_entity: StateNonAuthenticatedEntity,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param state_non_authenticated_entity: (required)
        ...
        _param = self._show_analytics_grid_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowChartRequest400Response",
            '200': "PageLineChartNonAuthenticatedEntity",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def show_analytics_grid_with_http_info(
        self,
        state_non_authenticated_entity: StateNonAuthenticatedEntity,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageLineChartNonAuthenticatedEntity]:
        """Show Analytics Grid
    ...
    @validate_call
    def show_analytics_grid_without_preload_content(
        self,
        state_non_authenticated_entity: StateNonAuthenticatedEntity,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_analytics_grid_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/analytics/grid',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_analytics_list(
        ...
        _param = self._show_analytics_list_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowChartRequest400Response",
            '200': "List[LineChartNonAuthenticatedEntity]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def show_analytics_list_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[LineChartNonAuthenticatedEntity]]:
        """Show Analytics
    ...
    @validate_call
    def show_analytics_list_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_analytics_list_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/analytics/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_chart_request(
        ...
        _param = self._show_chart_request_serialize(
            chart_identifier=chart_identifier,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def show_chart_request_with_http_info(
        self,
        chart_identifier: Annotated[StrictStr, Field(description="Chart identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    @validate_call
    def show_chart_request_without_preload_content(
        self,
        chart_identifier: Annotated[StrictStr, Field(description="Chart identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_chart_request_serialize(
        self,
        chart_identifier,
        wink_version,
        accept,
    ...
    def show_chart_requests(
        ...
        _param = self._show_chart_requests_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_chart_requests_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def show_chart_requests_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_chart_requests_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/analytics/chart/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
