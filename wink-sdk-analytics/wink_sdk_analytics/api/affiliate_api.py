...
class AffiliateApi:
    ...
    def show_leaderboard(
        self,
        leaderboard_request_authenticated_entity: LeaderboardRequestAuthenticatedEntity,
        ...
        :param leaderboard_request_authenticated_entity: (required)
        :type leaderboard_request_authenticated_entity: LeaderboardRequestAuthenticatedEntity
        :param wink_version:
        ...
        _param = self._show_leaderboard_serialize(
            leaderboard_request_authenticated_entity=leaderboard_request_authenticated_entity,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '400': "ShowShareAnalytics400Response",
            '200': "PageBookingLeaderboardEntryAuthenticatedEntity",
        }
    ...
    def show_leaderboard_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageBookingLeaderboardEntryAuthenticatedEntity]:
        """Show Leaderboard by Region
    ...
    def _show_leaderboard_serialize(
        self,
        leaderboard_request_authenticated_entity,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if leaderboard_request_authenticated_entity is not None:
            _body_params = leaderboard_request_authenticated_entity
    ...
    def show_leaderboard_by_owner(
        self,
        leaderboard_owner_request_authenticated_entity: LeaderboardOwnerRequestAuthenticatedEntity,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param leaderboard_owner_request_authenticated_entity: (required)
        :type leaderboard_owner_request_authenticated_entity: LeaderboardOwnerRequestAuthenticatedEntity
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._show_leaderboard_by_owner_serialize(
            leaderboard_owner_request_authenticated_entity=leaderboard_owner_request_authenticated_entity,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "ShowShareAnalytics400Response",
            '200': "BookingLeaderboardEntryAuthenticatedEntity",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_leaderboard_by_owner_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BookingLeaderboardEntryAuthenticatedEntity]:
        """Show Leaderboard by Affiliate 
    ...
    def _show_leaderboard_by_owner_serialize(
        self,
        leaderboard_owner_request_authenticated_entity,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if leaderboard_owner_request_authenticated_entity is not None:
            _body_params = leaderboard_owner_request_authenticated_entity
