...
from wink_sdk_analytics.configuration import Configuration
from wink_sdk_analytics.api_response import ApiResponse, T as ApiResponseT
import wink_sdk_analytics.models
from wink_sdk_analytics import rest
from wink_sdk_analytics.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wink_sdk_analytics.models, klass)
