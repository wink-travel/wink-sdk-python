...
**sort** | [**List[SortDescriptorAuthenticatedEntity]**](SortDescriptorAuthenticatedEntity.md) | Descriptors used for sorting result set. | [optional] 
**filter** | [**CompositeFilterDescriptorAuthenticatedEntity**](CompositeFilterDescriptorAuthenticatedEntity.md) | Descriptors used for filtering result set | [optional] 
**group** | [**List[GroupDescriptorAuthenticatedEntity]**](GroupDescriptorAuthenticatedEntity.md) | Descriptors to group result sets by. | [optional] 
