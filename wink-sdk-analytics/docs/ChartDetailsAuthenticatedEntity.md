# ChartDetailsAuthenticatedEntity
...
**filter_on_hotel_identifier** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on hotel identifier | [optional] 
**filter_on_channel_sub_type** | **str** | Filter on channel sub type. What channel sub-type helped make the booking. | [optional] 
**filter_on_owner_identifier** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on seller identifier. What affiliate helped make this booking. | [optional] 
**filter_on_engine_country_geo_name_id** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on customization country geoNameId. Which country is this application from. | [optional] 
**filter_on_engine_city_geo_name_id** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on city geoNameId. Which city is this application from. | [optional] 
**filter_on_engine_continent_code** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on continent. Which city is this application from. | [optional] 
**filter_on_engine_configuration_identifier** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on customization. Which customization made this booking. | [optional] 
**filter_on_country_geo_name_id** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on country geoNameId. Which country is the traveler from. | [optional] 
**filter_on_city_geo_name_id** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on city geoNameId. Which city is the traveler from. | [optional] 
**filter_on_continent_code** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on continent. Which continent is the traveler from. | [optional] 
**filter_on_user_identifier** | [**KeyValuePairAuthenticatedEntity**](KeyValuePairAuthenticatedEntity.md) | Filter on user identifier. Which authenticated user made the booking. | [optional] 
