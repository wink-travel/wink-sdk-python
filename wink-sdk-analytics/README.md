...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.41#egg=wink_sdk_analytics&subdirectory=wink-sdk-analytics
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.41#egg=wink_sdk_analytics&subdirectory=wink_sdk_analytics`)
...
*AnalyticsApi* | [**show_booking_analytics_grid**](docs/AnalyticsApi.md#show_booking_analytics_grid) | **POST** /api/analytics/booking/grid | Show Booking Analytic Grid
*AnalyticsApi* | [**show_booking_analytics_list**](docs/AnalyticsApi.md#show_booking_analytics_list) | **GET** /api/analytics/booking/list | Show Booking Analytic List
*AnalyticsApi* | [**show_leaderboard**](docs/AnalyticsApi.md#show_leaderboard) | **POST** /api/analytics/leaderboard/list | Show Leaderboard by Region
*AnalyticsApi* | [**show_leaderboard_by_owner**](docs/AnalyticsApi.md#show_leaderboard_by_owner) | **POST** /api/analytics/leaderboard | Show Leaderboard by Affiliate 
...
## Documentation For Models
 ...
 - [ShowLeaderboardByOwner400Response](docs/ShowLeaderboardByOwner400Response.md)
