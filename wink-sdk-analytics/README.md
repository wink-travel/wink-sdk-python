...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.32#egg=wink_sdk_analytics&subdirectory=wink-sdk-analytics
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.32#egg=wink_sdk_analytics&subdirectory=wink_sdk_analytics`)
