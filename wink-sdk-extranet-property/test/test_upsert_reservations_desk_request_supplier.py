...
class TestUpsertReservationsDeskRequestSupplier(unittest.TestCase):
    """UpsertReservationsDeskRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertReservationsDeskRequestSupplier:
        """Test UpsertReservationsDeskRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertReservationsDeskRequestSupplier`
        """
        model = UpsertReservationsDeskRequestSupplier()
        if include_optional:
            return UpsertReservationsDeskRequestSupplier(
    ...
    def testUpsertReservationsDeskRequestSupplier(self):
        """Test UpsertReservationsDeskRequestSupplier"""
