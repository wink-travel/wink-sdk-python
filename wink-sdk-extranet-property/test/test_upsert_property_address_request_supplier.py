...
class TestUpsertPropertyAddressRequestSupplier(unittest.TestCase):
    """UpsertPropertyAddressRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertPropertyAddressRequestSupplier:
        """Test UpsertPropertyAddressRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertPropertyAddressRequestSupplier`
        """
        model = UpsertPropertyAddressRequestSupplier()
        if include_optional:
            return UpsertPropertyAddressRequestSupplier(
                address = wink_sdk_extranet_property.models.upsert_address_request_supplier.UpsertAddressRequest_Supplier(
    ...
    def testUpsertPropertyAddressRequestSupplier(self):
        """Test UpsertPropertyAddressRequestSupplier"""
