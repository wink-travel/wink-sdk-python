...
class TestSuggestProfileResponseSupplier(unittest.TestCase):
    """SuggestProfileResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestProfileResponseSupplier:
        """Test SuggestProfileResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestProfileResponseSupplier`
        """
        model = SuggestProfileResponseSupplier()
        if include_optional:
    ...
    def testSuggestProfileResponseSupplier(self):
        """Test SuggestProfileResponseSupplier"""
