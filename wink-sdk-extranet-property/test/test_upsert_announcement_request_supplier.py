...
class TestUpsertAnnouncementRequestSupplier(unittest.TestCase):
    """UpsertAnnouncementRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertAnnouncementRequestSupplier:
        """Test UpsertAnnouncementRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertAnnouncementRequestSupplier`
        """
        model = UpsertAnnouncementRequestSupplier()
        if include_optional:
            return UpsertAnnouncementRequestSupplier(
    ...
    def testUpsertAnnouncementRequestSupplier(self):
        """Test UpsertAnnouncementRequestSupplier"""
