...
class TestUpdateLifestylesRequestSupplier(unittest.TestCase):
    """UpdateLifestylesRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLifestylesRequestSupplier:
        """Test UpdateLifestylesRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLifestylesRequestSupplier`
        """
        model = UpdateLifestylesRequestSupplier()
        if include_optional:
            return UpdateLifestylesRequestSupplier(
                hotel_identifier = '',
                list = [
    ...
    def testUpdateLifestylesRequestSupplier(self):
        """Test UpdateLifestylesRequestSupplier"""
