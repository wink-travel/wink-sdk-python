...
class TestUpsertPropertyProfileRequestSupplier(unittest.TestCase):
    """UpsertPropertyProfileRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertPropertyProfileRequestSupplier:
        """Test UpsertPropertyProfileRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertPropertyProfileRequestSupplier`
        """
        model = UpsertPropertyProfileRequestSupplier()
        if include_optional:
            return UpsertPropertyProfileRequestSupplier(
                stars = 4,
    ...
    def testUpsertPropertyProfileRequestSupplier(self):
        """Test UpsertPropertyProfileRequestSupplier"""
