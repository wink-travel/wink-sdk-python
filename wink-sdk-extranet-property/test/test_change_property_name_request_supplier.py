...
class TestChangePropertyNameRequestSupplier(unittest.TestCase):
    """ChangePropertyNameRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangePropertyNameRequestSupplier:
        """Test ChangePropertyNameRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangePropertyNameRequestSupplier`
        """
        model = ChangePropertyNameRequestSupplier()
        if include_optional:
            return ChangePropertyNameRequestSupplier(
                trade_name = 'Happy Resorts',
                legal_name = 'Getaway Resorts',
                local_name = 'Frohe Resort'
            )
        else:
            return ChangePropertyNameRequestSupplier(
                trade_name = 'Happy Resorts',
    ...
    def testChangePropertyNameRequestSupplier(self):
        """Test ChangePropertyNameRequestSupplier"""
