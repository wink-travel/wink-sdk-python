...
class TestAnnouncementViewSupplier(unittest.TestCase):
    """AnnouncementViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnnouncementViewSupplier:
        """Test AnnouncementViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnnouncementViewSupplier`
        """
        model = AnnouncementViewSupplier()
        if include_optional:
            return AnnouncementViewSupplier(
                ...
                version = 12,
                announcement = wink_sdk_extranet_property.models.announcement_supplier.Announcement_Supplier(
                    identifier = '', 
                    hotel_identifier = '', 
    ...
    def testAnnouncementViewSupplier(self):
        """Test AnnouncementViewSupplier"""
