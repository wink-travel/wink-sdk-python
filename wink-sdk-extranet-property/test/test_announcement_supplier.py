...
class TestAnnouncementSupplier(unittest.TestCase):
    """AnnouncementSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnnouncementSupplier:
        """Test AnnouncementSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnnouncementSupplier`
        """
        model = AnnouncementSupplier()
        if include_optional:
            return AnnouncementSupplier(
                identifier = '',
                hotel_identifier = '',
    ...
    def testAnnouncementSupplier(self):
        """Test AnnouncementSupplier"""
