...
class TestManagingEntityManagerSupplier(unittest.TestCase):
    """ManagingEntityManagerSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagingEntityManagerSupplier:
        """Test ManagingEntityManagerSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagingEntityManagerSupplier`
        """
        model = ManagingEntityManagerSupplier()
        if include_optional:
            return ManagingEntityManagerSupplier(
                ...
                profile_picture = wink_sdk_extranet_property.models.simple_multimedia_supplier.SimpleMultimedia_Supplier(
                    ...
                    attribution = [
                        wink_sdk_extranet_property.models.media_author_attribution_supplier.MediaAuthorAttribution_Supplier(
    ...
    def testManagingEntityManagerSupplier(self):
        """Test ManagingEntityManagerSupplier"""
