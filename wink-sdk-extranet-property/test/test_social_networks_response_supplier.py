...
class TestSocialNetworksResponseSupplier(unittest.TestCase):
    """SocialNetworksResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialNetworksResponseSupplier:
        """Test SocialNetworksResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SocialNetworksResponseSupplier`
        """
        model = SocialNetworksResponseSupplier()
        if include_optional:
    ...
    def testSocialNetworksResponseSupplier(self):
        """Test SocialNetworksResponseSupplier"""
