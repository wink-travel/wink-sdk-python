...
class TestUniqueResultSupplier(unittest.TestCase):
    """UniqueResultSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniqueResultSupplier:
        """Test UniqueResultSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniqueResultSupplier`
        """
        model = UniqueResultSupplier()
        if include_optional:
    ...
    def testUniqueResultSupplier(self):
        """Test UniqueResultSupplier"""
