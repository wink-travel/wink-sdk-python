...
from wink_sdk_extranet_property.models.managed_by_entity_rules_supplier import ManagedByEntityRulesSupplier

class TestManagedByEntityRulesSupplier(unittest.TestCase):
    """ManagedByEntityRulesSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedByEntityRulesSupplier:
        """Test ManagedByEntityRulesSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedByEntityRulesSupplier`
        """
        model = ManagedByEntityRulesSupplier()
        if include_optional:
            return ManagedByEntityRulesSupplier(
    ...
    def testManagedByEntityRulesSupplier(self):
        """Test ManagedByEntityRulesSupplier"""
