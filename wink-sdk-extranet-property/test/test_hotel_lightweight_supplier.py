...
class TestHotelLightweightSupplier(unittest.TestCase):
    """HotelLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelLightweightSupplier:
        """Test HotelLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelLightweightSupplier`
        """
        model = HotelLightweightSupplier()
        if include_optional:
            return HotelLightweightSupplier(
                hotel_identifier = '',
    ...
    def testHotelLightweightSupplier(self):
        """Test HotelLightweightSupplier"""
