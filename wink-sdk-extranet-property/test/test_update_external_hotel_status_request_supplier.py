...
class TestUpdateExternalHotelStatusRequestSupplier(unittest.TestCase):
    """UpdateExternalHotelStatusRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateExternalHotelStatusRequestSupplier:
        """Test UpdateExternalHotelStatusRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateExternalHotelStatusRequestSupplier`
        """
        model = UpdateExternalHotelStatusRequestSupplier()
        if include_optional:
    ...
    def testUpdateExternalHotelStatusRequestSupplier(self):
        """Test UpdateExternalHotelStatusRequestSupplier"""
