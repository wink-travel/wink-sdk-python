...
class TestUpdateLocationRequestSupplier(unittest.TestCase):
    """UpdateLocationRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLocationRequestSupplier:
        """Test UpdateLocationRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLocationRequestSupplier`
        """
        model = UpdateLocationRequestSupplier()
        if include_optional:
            return UpdateLocationRequestSupplier(
    ...
    def testUpdateLocationRequestSupplier(self):
        """Test UpdateLocationRequestSupplier"""
