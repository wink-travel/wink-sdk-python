...
class TestRecognitionApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = RecognitionApi()

    def tearDown(self) -> None:
        pass

    def test_create_recognition(self) -> None:
        """Test case for create_recognition

        Create Recognition
        """
        pass

    def test_remove_recognition(self) -> None:
        """Test case for remove_recognition

        Delete Recognition
        """
        pass

    def test_show_recognition(self) -> None:
        """Test case for show_recognition

        Show Recognition
        """
        pass

    def test_show_recognitions(self) -> None:
        """Test case for show_recognitions

        Show Recognitions
        """
        pass

    def test_show_recognitions_by_category(self) -> None:
        """Test case for show_recognitions_by_category

        Show Recognition by Category
        """
        pass

    def test_update_recognition(self) -> None:
        """Test case for update_recognition
