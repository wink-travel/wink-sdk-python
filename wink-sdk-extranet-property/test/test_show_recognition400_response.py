...
class TestShowRecognition400Response(unittest.TestCase):
    """ShowRecognition400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowRecognition400Response:
        """Test ShowRecognition400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShowRecognition400Response`
        """
        model = ShowRecognition400Response()
        if include_optional:
            return ShowRecognition400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testShowRecognition400Response(self):
        """Test ShowRecognition400Response"""
