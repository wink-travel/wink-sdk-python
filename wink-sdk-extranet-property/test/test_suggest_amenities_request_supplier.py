...
class TestSuggestAmenitiesRequestSupplier(unittest.TestCase):
    """SuggestAmenitiesRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestAmenitiesRequestSupplier:
        """Test SuggestAmenitiesRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestAmenitiesRequestSupplier`
        """
        model = SuggestAmenitiesRequestSupplier()
        if include_optional:
            return SuggestAmenitiesRequestSupplier(
                language = 'en'
            )
        else:
            return SuggestAmenitiesRequestSupplier(
    ...
    def testSuggestAmenitiesRequestSupplier(self):
        """Test SuggestAmenitiesRequestSupplier"""
