    ...
    def make_instance(self, include_optional) -> PropertyAggregateGreenIndexAnswersSupplier:
        ...
        if include_optional:
            return PropertyAggregateGreenIndexAnswersSupplier(
                hotel_identifier = '',
                list = [
                    wink_sdk_extranet_property.models.property_aggregate_green_index_answer_supplier.PropertyAggregateGreenIndexAnswer_Supplier(
                        question_key = '', 
                        value = 56, )
                    ],
                high_score = 100,
                ...
                aggregate_score = 50,
                scores_by_category = [
                    wink_sdk_extranet_property.models.property_aggregate_green_index_score_by_category_supplier.PropertyAggregateGreenIndexScoreByCategory_Supplier(
                        category = 'GENERAL', 
                        high_score = 100, 
                        total_score = 50, 
                        aggregate_score = 50, )
