...
class TestMediaApi(unittest.TestCase):
    ...
    def test_create_multimedia(self) -> None:
        """Test case for create_multimedia

        Create Multimedia
        """
        pass

    def test_remove_media_list(self) -> None:
        """Test case for remove_media_list
    ...
    def test_show_media_list(self) -> None:
        """Test case for show_media_list

        Show Multimedia
        """
        pass

    def test_update_media_list(self) -> None:
    ...
    def test_update_multimedia(self) -> None:
        """Test case for update_multimedia

        Update Multimedia
        """
        pass

    def test_upload_multipart_files(self) -> None:
        """Test case for upload_multipart_files
