...
class TestAnnouncementApi(unittest.TestCase):
    ...
    def test_create_announcement(self) -> None:
        """Test case for create_announcement

        Create Announcement
        """
        pass

    def test_remove_announcement(self) -> None:
        """Test case for remove_announcement

        Delete Announcement
        """
        pass

    def test_show_announcement(self) -> None:
        """Test case for show_announcement

        Show Announcement
        """
        pass

    def test_show_announcements(self) -> None:
        """Test case for show_announcements
    ...
    def test_update_announcement(self) -> None:
        """Test case for update_announcement
