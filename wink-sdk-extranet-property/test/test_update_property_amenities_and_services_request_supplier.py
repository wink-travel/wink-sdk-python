...
class TestUpdatePropertyAmenitiesAndServicesRequestSupplier(unittest.TestCase):
    """UpdatePropertyAmenitiesAndServicesRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePropertyAmenitiesAndServicesRequestSupplier:
        """Test UpdatePropertyAmenitiesAndServicesRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyAmenitiesAndServicesRequestSupplier`
        """
        model = UpdatePropertyAmenitiesAndServicesRequestSupplier()
        if include_optional:
            return UpdatePropertyAmenitiesAndServicesRequestSupplier(
    ...
    def testUpdatePropertyAmenitiesAndServicesRequestSupplier(self):
        """Test UpdatePropertyAmenitiesAndServicesRequestSupplier"""
