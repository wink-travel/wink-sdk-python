...
class TestLifestylesResponseSupplier(unittest.TestCase):
    """LifestylesResponseSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LifestylesResponseSupplier:
        """Test LifestylesResponseSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LifestylesResponseSupplier`
        """
        model = LifestylesResponseSupplier()
        if include_optional:
    ...
    def testLifestylesResponseSupplier(self):
        """Test LifestylesResponseSupplier"""
