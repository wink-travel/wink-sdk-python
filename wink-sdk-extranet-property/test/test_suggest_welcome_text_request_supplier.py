...
class TestSuggestWelcomeTextRequestSupplier(unittest.TestCase):
    """SuggestWelcomeTextRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestWelcomeTextRequestSupplier:
        """Test SuggestWelcomeTextRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestWelcomeTextRequestSupplier`
        """
        model = SuggestWelcomeTextRequestSupplier()
        if include_optional:
            return SuggestWelcomeTextRequestSupplier(
                language = 'en'
            )
        else:
            return SuggestWelcomeTextRequestSupplier(
    ...
    def testSuggestWelcomeTextRequestSupplier(self):
        """Test SuggestWelcomeTextRequestSupplier"""
