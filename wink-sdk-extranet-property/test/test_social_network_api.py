...
class TestSocialNetworkApi(unittest.TestCase):
    """SocialNetworkApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SocialNetworkApi()
    ...
    def test_update_socials(self) -> None:
        """Test case for update_socials
