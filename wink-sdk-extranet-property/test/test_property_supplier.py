...
class TestPropertySupplier(unittest.TestCase):
    """PropertySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertySupplier:
        """Test PropertySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertySupplier`
        """
        ...
        if include_optional:
            return PropertySupplier(
                ...
                reservations_contact = wink_sdk_extranet_property.models.contact_supplier.Contact_Supplier(
                    ...
                    full_name = 'John Smith', 
                    summary = 'John Smith (johnsmith@gmail.com / +12125551212)', ),
                revenue_contact = wink_sdk_extranet_property.models.contact_supplier.Contact_Supplier(
                    first_name = 'John', 
                    last_name = 'Smith', 
                    email = 'johnsmith@email.com', 
                    secondary_email = 'johnsmith2@email.com', 
                    ...
                    full_name = 'John Smith', 
                    summary = 'John Smith (johnsmith@gmail.com / +12125551212)', ),
                marketing_contact = wink_sdk_extranet_property.models.contact_supplier.Contact_Supplier(
                    first_name = 'John', 
                    last_name = 'Smith', 
                    email = 'johnsmith@email.com', 
                    secondary_email = 'johnsmith2@email.com', 
                ...
                logo = wink_sdk_extranet_property.models.simple_multimedia_supplier.SimpleMultimedia_Supplier(
                    multimedia_identifier = 'image-1', 
                    identifier = 'cloudinary-image-1', 
                    type = 'IMAGE', 
                    source = 'CLOUDINARY', 
                ...
                address = wink_sdk_extranet_property.models.address_supplier.Address_Supplier(
                    ...
                    city = wink_sdk_extranet_property.models.geo_name_lightweight_supplier.GeoNameLightweight_Supplier(
                        geo_name_id = '5128581', 
                        type = 'CITY', 
                        name = 'New York City', 
                        ...
                        country = wink_sdk_extranet_property.models.country_lightweight_supplier.CountryLightweight_Supplier(
                            iso = 'US', 
                            name = 'United States', 
                            capital = 'Washington', 
                            continent = 'NA', 
                            ...
                            geo_name_id = '6252001', ), 
                        sub_country = wink_sdk_extranet_property.models.sub_country_lightweight_supplier.SubCountryLightweight_Supplier(
                            name = 'New York', 
                            ascii_name = 'New York', 
                            geo_name_id = '5128638', ), 
                        sub_sub_country = wink_sdk_extranet_property.models.sub_sub_country_lightweight_supplier.SubSubCountryLightweight_Supplier(
                            name = '', 
                            ascii_name = '', 
                            geo_name_id = '', ), ), 
                    valid = True, 
