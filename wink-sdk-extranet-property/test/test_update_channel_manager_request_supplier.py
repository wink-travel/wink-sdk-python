...
class TestUpdateChannelManagerRequestSupplier(unittest.TestCase):
    """UpdateChannelManagerRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateChannelManagerRequestSupplier:
        """Test UpdateChannelManagerRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateChannelManagerRequestSupplier`
        """
        model = UpdateChannelManagerRequestSupplier()
        if include_optional:
            return UpdateChannelManagerRequestSupplier(
    ...
    def testUpdateChannelManagerRequestSupplier(self):
        """Test UpdateChannelManagerRequestSupplier"""
