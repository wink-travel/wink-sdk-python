...
class TestPropertyAggregateGreenIndexAnswerSupplier(unittest.TestCase):
    """PropertyAggregateGreenIndexAnswerSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyAggregateGreenIndexAnswerSupplier:
        """Test PropertyAggregateGreenIndexAnswerSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyAggregateGreenIndexAnswerSupplier`
        """
        model = PropertyAggregateGreenIndexAnswerSupplier()
        if include_optional:
            return PropertyAggregateGreenIndexAnswerSupplier(
                question_key = '',
                value = 56
            )
        else:
    ...
    def testPropertyAggregateGreenIndexAnswerSupplier(self):
        """Test PropertyAggregateGreenIndexAnswerSupplier"""
