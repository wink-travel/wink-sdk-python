...
class TestUpsertRecognitionSupplier(unittest.TestCase):
    """UpsertRecognitionSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertRecognitionSupplier:
        """Test UpsertRecognitionSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertRecognitionSupplier`
        """
        model = UpsertRecognitionSupplier()
        if include_optional:
            return UpsertRecognitionSupplier(
                type = 'PERCENT_RATING',
                category = 'AWARD',
                provider = 'Michelin',
                rating = 8.5,
    ...
    def testUpsertRecognitionSupplier(self):
        """Test UpsertRecognitionSupplier"""
