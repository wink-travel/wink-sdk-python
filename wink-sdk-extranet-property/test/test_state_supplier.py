    ...
    def make_instance(self, include_optional) -> StateSupplier:
        ...
        if include_optional:
            return StateSupplier(
                ...
                take = 10,
                sort = [
                    wink_sdk_extranet_property.models.sort_descriptor_supplier.SortDescriptor_Supplier(
                        dir = 'asc', 
                        field = 'hotel.name', )
                    ],
                filter = wink_sdk_extranet_property.models.composite_filter_descriptor_supplier.CompositeFilterDescriptor_Supplier(
                    logic = 'and', 
                    filters = [
                        wink_sdk_extranet_property.models.filter_descriptor_supplier.FilterDescriptor_Supplier(
                            field = 'hotel.name', 
                            operator = 'startsWith', 
                            value = Happy Res, 
                            ignore_case = True, )
                ...
                group = [
                    wink_sdk_extranet_property.models.group_descriptor_supplier.GroupDescriptor_Supplier(
                        field = 'createdDate', 
                        dir = 'asc', 
                        aggregates = [
                            wink_sdk_extranet_property.models.aggregate_descriptor_supplier.AggregateDescriptor_Supplier(
