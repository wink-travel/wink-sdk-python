...
class TestPolicyApi(unittest.TestCase):
    ...
    def test_show_property_policy(self) -> None:
        """Test case for show_property_policy

        Show property policy
        """
        pass

    def test_update_property_policy(self) -> None:
        """Test case for update_property_policy
