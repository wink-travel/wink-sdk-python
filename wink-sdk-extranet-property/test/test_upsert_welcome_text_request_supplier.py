...
class TestUpsertWelcomeTextRequestSupplier(unittest.TestCase):
    """UpsertWelcomeTextRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertWelcomeTextRequestSupplier:
        """Test UpsertWelcomeTextRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertWelcomeTextRequestSupplier`
        """
        model = UpsertWelcomeTextRequestSupplier()
        if include_optional:
            return UpsertWelcomeTextRequestSupplier(
                list = [
    ...
    def testUpsertWelcomeTextRequestSupplier(self):
        """Test UpsertWelcomeTextRequestSupplier"""
