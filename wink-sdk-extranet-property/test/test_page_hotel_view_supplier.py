...
class TestPageHotelViewSupplier(unittest.TestCase):
    """PageHotelViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageHotelViewSupplier:
        """Test PageHotelViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageHotelViewSupplier`
        """
        model = PageHotelViewSupplier()
        if include_optional:
            return PageHotelViewSupplier(
                ...
                size = 56,
                content = [
                    wink_sdk_extranet_property.models.hotel_view_supplier.HotelView_Supplier(
                        id = 'doc-1', 
                        created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        version = 12, 
                        hotel = wink_sdk_extranet_property.models.hotel_supplier.Hotel_Supplier(
                            hotel_identifier = '', 
                            ...
                            external_status = '6', 
                            multimedias = [
                                wink_sdk_extranet_property.models.simple_multimedia_supplier.SimpleMultimedia_Supplier(
                                    ...
                                    category = '1', 
                                    descriptions = [
                                        wink_sdk_extranet_property.models.simple_description_supplier.SimpleDescription_Supplier(
                                    ...
                                    attribution = [
                                        wink_sdk_extranet_property.models.image_attribution_supplier.ImageAttribution_Supplier(
                            ...
                            recognition_list = [
                                wink_sdk_extranet_property.models.travel_inventory_recognition_supplier.TravelInventoryRecognition_Supplier(
                                    identifier = '', 
                                    category = 'AWARD', 
                                    type = 'PERCENT_RATING', 
                                    provider = 'Michelin', 
                            ...
                            stars = 0, 
                            general_manager = wink_sdk_extranet_property.models.general_manager_supplier.GeneralManager_Supplier(
                                name = 'Jane Doe', 
                                image = wink_sdk_extranet_property.models.simple_multimedia_supplier.SimpleMultimedia_Supplier(
                                    multimedia_identifier = '', 
                                    identifier = 'cloudinary-image-1', 
                                    type = 'IMAGE', 
                                    source = 'CLOUDINARY', 
                                    ...
                                    is_landscape = True, ), ), 
                            short_descriptions = [
                                wink_sdk_extranet_property.models.localized_description_supplier.LocalizedDescription_Supplier(
                                    description = 'This is a longer description in the specified language.', 
                                    language = 'en', )
                                ], 
                            long_descriptions = [
                            ...
                            policy = wink_sdk_extranet_property.models.property_policy_supplier.PropertyPolicy_Supplier(
                                ...
                                pet_charge = wink_sdk_extranet_property.models.custom_monetary_amount.CustomMonetaryAmount(
                                    amount = 1.337, 
                                    currency = '', ), 
                                check_out_time = '10:00', 
                                check_in_time = '14:00', ), 
                            socials = [
                                wink_sdk_extranet_property.models.social_supplier.Social_Supplier(
                                    type = 'FACEBOOK', 
                                    location = '', 
                                    enabled = True, )
                                ], 
                            owner_contact = wink_sdk_extranet_property.models.contact_supplier.Contact_Supplier(
                                first_name = 'John', 
                                last_name = 'Smith', 
                            ...
                            reservations_contact = wink_sdk_extranet_property.models.contact_supplier.Contact_Supplier(
                                first_name = 'John', 
                                last_name = 'Smith', 
                                email = 'johnsmith@email.com', 
                                secondary_email = 'johnsmith2@email.com', 
                                ...
                                summary = 'John Smith (johnsmith@gmail.com / +12125551212)', ), 
                            accounting_contact = , 
                            accounting_address = wink_sdk_extranet_property.models.address_supplier.Address_Supplier(
                                address1 = '234 Near da beach', 
                                address2 = 'Pebble #5001', 
                                state = 'CA', 
                                postal_code = '90210', 
                                county = 'Alameda county', 
                                city = wink_sdk_extranet_property.models.geo_name_supplier.GeoName_Supplier(
                                    geo_name_id = '5128581', 
                                    type = 'CITY', 
                                    name = 'New York City', 
                                    ...
                                    country = wink_sdk_extranet_property.models.country_supplier.Country_Supplier(
                                        iso = 'US', 
                                        name = 'United States', 
                                        capital = 'Washington', 
                                        continent = 'NA', 
                                        ...
                                        geo_name_id = '6252001', ), 
                                    sub_country = wink_sdk_extranet_property.models.sub_country_supplier.SubCountry_Supplier(
                                        name = 'New York', 
                                        ascii_name = 'New York', 
                                        geo_name_id = '5128638', ), 
                                    sub_sub_country = wink_sdk_extranet_property.models.sub_sub_country_supplier.SubSubCountry_Supplier(
                                        name = '', 
                                        ascii_name = '', 
                                        geo_name_id = '', ), ), 
                                valid = True, 
                            ...
                            green_index_scores = wink_sdk_extranet_property.models.aggregate_greendex_answers_supplier.AggregateGreendexAnswers_Supplier(
                                high_score = 100, 
                                total_score = 50, 
                                aggregate_score = 0, 
                                scores_by_category = [
                                    wink_sdk_extranet_property.models.aggregate_greendex_score_by_category_supplier.AggregateGreendexScoreByCategory_Supplier(
                                        category = 'GENERAL', 
                                        high_score = 100, 
                                        total_score = 50, 
                                        aggregate_score = 0, )
                            ...
                            number_of_rooms = 40, 
                            address = wink_sdk_extranet_property.models.address_supplier.Address_Supplier(
                                address1 = '234 Near da beach', 
                                address2 = 'Pebble #5001', 
                                state = 'CA', 
                                postal_code = '90210', 
                            ...
                            rate_provider = wink_sdk_extranet_property.models.key_value_pair_supplier.KeyValuePair_Supplier(
                                value = 'id-1', 
                ...
                number = 56,
                sort = [
                    wink_sdk_extranet_property.models.sort_object.SortObject(
                        direction = '', 
                        null_handling = '', 
                        ascending = True, 
                        property = '', 
                ...
                pageable = wink_sdk_extranet_property.models.pageable_object_supplier.PageableObject_Supplier(
                    offset = 56, 
                    sort = [
                        wink_sdk_extranet_property.models.sort_object.SortObject(
                            direction = '', 
    ...
    def testPageHotelViewSupplier(self):
        """Test PageHotelViewSupplier"""
