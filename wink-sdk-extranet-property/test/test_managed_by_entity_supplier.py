...
class TestManagedByEntitySupplier(unittest.TestCase):
    """ManagedByEntitySupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedByEntitySupplier:
        """Test ManagedByEntitySupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedByEntitySupplier`
        """
        model = ManagedByEntitySupplier()
        if include_optional:
            return ManagedByEntitySupplier(
                identifier = 'agency-1',
                name = 'Agency X',
                commission_in_percent = 0.01,
                rules = wink_sdk_extranet_property.models.managed_by_entity_rules_supplier.ManagedByEntityRules_Supplier(
    ...
    def testManagedByEntitySupplier(self):
        """Test ManagedByEntitySupplier"""
