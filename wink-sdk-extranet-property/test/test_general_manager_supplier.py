...
class TestGeneralManagerSupplier(unittest.TestCase):
    """GeneralManagerSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralManagerSupplier:
        """Test GeneralManagerSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralManagerSupplier`
        """
        model = GeneralManagerSupplier()
        if include_optional:
            return GeneralManagerSupplier(
                name = 'Jane Doe',
    ...
    def testGeneralManagerSupplier(self):
        """Test GeneralManagerSupplier"""
