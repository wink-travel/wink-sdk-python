...
class TestUpsertAddressRequestSupplier(unittest.TestCase):
    """UpsertAddressRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertAddressRequestSupplier:
        """Test UpsertAddressRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertAddressRequestSupplier`
        """
        model = UpsertAddressRequestSupplier()
        if include_optional:
            return UpsertAddressRequestSupplier(
    ...
    def testUpsertAddressRequestSupplier(self):
        """Test UpsertAddressRequestSupplier"""
