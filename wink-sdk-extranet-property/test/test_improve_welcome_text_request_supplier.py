...
class TestImproveWelcomeTextRequestSupplier(unittest.TestCase):
    """ImproveWelcomeTextRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImproveWelcomeTextRequestSupplier:
        """Test ImproveWelcomeTextRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImproveWelcomeTextRequestSupplier`
        """
        model = ImproveWelcomeTextRequestSupplier()
        if include_optional:
            return ImproveWelcomeTextRequestSupplier(
    ...
    def testImproveWelcomeTextRequestSupplier(self):
        """Test ImproveWelcomeTextRequestSupplier"""
