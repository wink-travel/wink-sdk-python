...
class TestSuggestProfileRequestSupplier(unittest.TestCase):
    """SuggestProfileRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuggestProfileRequestSupplier:
        """Test SuggestProfileRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuggestProfileRequestSupplier`
        """
        model = SuggestProfileRequestSupplier()
        if include_optional:
            return SuggestProfileRequestSupplier(
                language = 'en'
            )
        else:
            return SuggestProfileRequestSupplier(
    ...
    def testSuggestProfileRequestSupplier(self):
        """Test SuggestProfileRequestSupplier"""
