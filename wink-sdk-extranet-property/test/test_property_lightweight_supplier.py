...
class TestPropertyLightweightSupplier(unittest.TestCase):
    """PropertyLightweightSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyLightweightSupplier:
        """Test PropertyLightweightSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyLightweightSupplier`
        """
        model = PropertyLightweightSupplier()
        if include_optional:
            return PropertyLightweightSupplier(
    ...
    def testPropertyLightweightSupplier(self):
        """Test PropertyLightweightSupplier"""
