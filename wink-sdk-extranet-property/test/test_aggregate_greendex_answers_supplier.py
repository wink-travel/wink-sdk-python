...
class TestAggregateGreendexAnswersSupplier(unittest.TestCase):
    """AggregateGreendexAnswersSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregateGreendexAnswersSupplier:
        """Test AggregateGreendexAnswersSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateGreendexAnswersSupplier`
        """
        model = AggregateGreendexAnswersSupplier()
        if include_optional:
            return AggregateGreendexAnswersSupplier(
                high_score = 100,
                total_score = 50,
                aggregate_score = 0,
                scores_by_category = [
    ...
    def testAggregateGreendexAnswersSupplier(self):
        """Test AggregateGreendexAnswersSupplier"""
