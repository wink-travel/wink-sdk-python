...
class TestPropertyApi(unittest.TestCase):
    ...
    def test_change_property_name(self) -> None:
        """Test case for change_property_name

        Change Property Name
        """
        pass

    def test_improve_welcome_text(self) -> None:
        """Test case for improve_welcome_text

        Improve Welcome Text
        """
        pass

    def test_is_hotel_name_unique(self) -> None:
        """Test case for is_hotel_name_unique
    ...
    def test_property_search(self) -> None:
        """Test case for property_search

        Property Search
        """
        pass

    def test_show_hotel_by_manager(self) -> None:
        """Test case for show_hotel_by_manager

        Show Property
        """
        pass

    def test_show_hotel_status(self) -> None:
        """Test case for show_hotel_status

        Show Property Status
        """
        pass

    def test_show_hotels_by_manager(self) -> None:
        """Test case for show_hotels_by_manager

        Property List
        """
        pass

    def test_suggest_property_profile(self) -> None:
        """Test case for suggest_property_profile

        Suggest property profile
        """
        pass

    def test_suggest_property_welcome_text(self) -> None:
        """Test case for suggest_property_welcome_text

        Suggest Property Welcome Text
        """
        pass

    def test_suggest_property_welcome_text1(self) -> None:
        """Test case for suggest_property_welcome_text1
    ...
    def test_update_general_manager(self) -> None:
        """Test case for update_general_manager

        Update General Manager
        """
        pass

    def test_update_hotel_status(self) -> None:
        """Test case for update_hotel_status

        Update Property Status
        """
        pass

    def test_update_property_profile(self) -> None:
        """Test case for update_property_profile

        Update property profile
        """
        pass

    def test_update_reservations_desk(self) -> None:
        """Test case for update_reservations_desk
    ...
    def test_update_services(self) -> None:
        """Test case for update_services

        Update property services
        """
        pass

    def test_update_welcome_text(self) -> None:
        """Test case for update_welcome_text

        Update Property Text
        """
        pass

    def test_upload_general_manager_profile_picture(self) -> None:
        """Test case for upload_general_manager_profile_picture
