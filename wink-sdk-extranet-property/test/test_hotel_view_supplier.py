...
class TestHotelViewSupplier(unittest.TestCase):
    """HotelViewSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotelViewSupplier:
        """Test HotelViewSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotelViewSupplier`
        """
        model = HotelViewSupplier()
        if include_optional:
    ...
    def testHotelViewSupplier(self):
        """Test HotelViewSupplier"""
