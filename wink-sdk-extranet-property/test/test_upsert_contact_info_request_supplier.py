...
class TestUpsertContactInfoRequestSupplier(unittest.TestCase):
    """UpsertContactInfoRequestSupplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertContactInfoRequestSupplier:
        """Test UpsertContactInfoRequestSupplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertContactInfoRequestSupplier`
        """
        model = UpsertContactInfoRequestSupplier()
        if include_optional:
            return UpsertContactInfoRequestSupplier(
    ...
    def testUpsertContactInfoRequestSupplier(self):
        """Test UpsertContactInfoRequestSupplier"""
