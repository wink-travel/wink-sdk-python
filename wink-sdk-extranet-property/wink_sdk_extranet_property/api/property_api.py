...
class PropertyApi:
    ...
    @validate_call
    def is_hotel_url_name_unique(
        self,
        url_name: Annotated[StrictStr, Field(description="Search for uniqueness for this hotel url name.")],
        hotel_identifier: Annotated[Optional[StrictStr], Field(description="Optional, existing hotel identifier")] = None,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        :param url_name: Search for uniqueness for this hotel url name. (required)
        :type url_name: str
        :param hotel_identifier: Optional, existing hotel identifier
        :type hotel_identifier: str
        :param wink_version:
        ...
        _param = self._is_hotel_url_name_unique_serialize(
            url_name=url_name,
            hotel_identifier=hotel_identifier,
            wink_version=wink_version,
            accept=accept,
    ...
    @validate_call
    def is_hotel_url_name_unique_with_http_info(
        self,
        url_name: Annotated[StrictStr, Field(description="Search for uniqueness for this hotel url name.")],
        hotel_identifier: Annotated[Optional[StrictStr], Field(description="Optional, existing hotel identifier")] = None,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def is_hotel_url_name_unique_without_preload_content(
        self,
        url_name: Annotated[StrictStr, Field(description="Search for uniqueness for this hotel url name.")],
        hotel_identifier: Annotated[Optional[StrictStr], Field(description="Optional, existing hotel identifier")] = None,
        wink_version: Optional[StrictStr] = None,
    ...
    def _is_hotel_url_name_unique_serialize(
        self,
        url_name,
        hotel_identifier,
        wink_version,
        ...
        if url_name is not None:
            ...
            _query_params.append(('urlName', url_name))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/property/unique/url-name',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def upload_hotel_logos(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Property identifier")],
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Multipart file array")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param property_identifier: Property identifier (required)
        :type property_identifier: str
        :param file: Multipart file array (required)
        :type file: bytearray
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._upload_hotel_logos_serialize(
            property_identifier=property_identifier,
            file=file,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def upload_hotel_logos_with_http_info(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Property identifier")],
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Multipart file array")],
        _request_timeout: Union[
    ...
    @validate_call
    def upload_hotel_logos_without_preload_content(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Property identifier")],
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Multipart file array")],
        _request_timeout: Union[
    ...
    def _upload_hotel_logos_serialize(
        self,
        property_identifier,
        file,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/property/{propertyIdentifier}/logo',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
