...
class ChannelManagerApi:
    ...
    @validate_call
    def update_channel_manager(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Set channel manager for this property identifier")],
        update_channel_manager_request_supplier: UpdateChannelManagerRequestSupplier,
        ...
        :param property_identifier: Set channel manager for this property identifier (required)
        :type property_identifier: str
        :param update_channel_manager_request_supplier: (required)
        :type update_channel_manager_request_supplier: UpdateChannelManagerRequestSupplier
        :param wink_version:
        ...
        _param = self._update_channel_manager_serialize(
            property_identifier=property_identifier,
            update_channel_manager_request_supplier=update_channel_manager_request_supplier,
    ...
    @validate_call
    def update_channel_manager_with_http_info(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Set channel manager for this property identifier")],
        update_channel_manager_request_supplier: UpdateChannelManagerRequestSupplier,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def update_channel_manager_without_preload_content(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Set channel manager for this property identifier")],
        update_channel_manager_request_supplier: UpdateChannelManagerRequestSupplier,
        wink_version: Optional[StrictStr] = None,
    ...
    def _update_channel_manager_serialize(
        self,
        property_identifier,
        update_channel_manager_request_supplier,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if update_channel_manager_request_supplier is not None:
            _body_params = update_channel_manager_request_supplier
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/property/{propertyIdentifier}/channel-manager',
