...
class PolicyApi:
    ...
    def create_policy(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Create property policy for this property identifier")],
        property_policy_supplier: PropertyPolicySupplier,
        ...
        :param property_identifier: Create property policy for this property identifier (required)
        :type property_identifier: str
        :param property_policy_supplier: (required)
        :type property_policy_supplier: PropertyPolicySupplier
        :param wink_version:
        ...
        _param = self._create_policy_serialize(
            ...
            property_policy_supplier=property_policy_supplier,
    ...
    def _create_policy_serialize(
        ...
        if property_policy_supplier is not None:
            _body_params = property_policy_supplier
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/property/{propertyIdentifier}/policy/property',
    ...
    @validate_call
    def show_property_policy(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Retrieve property policy for this property identifier")],
        wink_version: Optional[StrictStr] = None,
        ...
        :param property_identifier: Retrieve property policy for this property identifier (required)
        :type property_identifier: str
        :param wink_version:
        :type wink_version: str
        :param accept:
        ...
        _param = self._show_property_policy_serialize(
            property_identifier=property_identifier,
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
    ...
    @validate_call
    def show_property_policy_with_http_info(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Retrieve property policy for this property identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PropertyPolicySupplier]:
        """Show property policy
    ...
    @validate_call
    def show_property_policy_without_preload_content(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Retrieve property policy for this property identifier")],
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
    ...
    def _show_property_policy_serialize(
        self,
        property_identifier,
        wink_version,
        accept,
    ...
    @validate_call
    def update_property_policy(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Update property policy record for this property identifier")],
        property_policy_supplier: PropertyPolicySupplier,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        :param property_identifier: Update property policy record for this property identifier (required)
        :type property_identifier: str
        :param property_policy_supplier: (required)
        :type property_policy_supplier: PropertyPolicySupplier
        :param wink_version:
        ...
        _param = self._update_property_policy_serialize(
            property_identifier=property_identifier,
            property_policy_supplier=property_policy_supplier,
            wink_version=wink_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_property_policy_with_http_info(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Update property policy record for this property identifier")],
        property_policy_supplier: PropertyPolicySupplier,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def update_property_policy_without_preload_content(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Update property policy record for this property identifier")],
        property_policy_supplier: PropertyPolicySupplier,
        wink_version: Optional[StrictStr] = None,
    ...
    def _update_property_policy_serialize(
        self,
        property_identifier,
        property_policy_supplier,
        wink_version,
