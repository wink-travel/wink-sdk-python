...
class LifestyleApi:
    ...
    def show_lifestyles(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Show Lifestyles for this property identifier")],
        ...
        :param property_identifier: Show Lifestyles for this property identifier (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "LifestylesResponseSupplier",
        }
    ...
    def show_lifestyles_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LifestylesResponseSupplier]:
        """Show Lifestyles
    ...
    def _show_lifestyles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/property/{propertyIdentifier}/lifestyles',
    ...
    def update_lifestyles(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Update lifestyles for this property identifier")],
        update_lifestyles_request_supplier: UpdateLifestylesRequestSupplier,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param property_identifier: Update lifestyles for this property identifier (required)
        :type property_identifier: str
        :param update_lifestyles_request_supplier: (required)
        :type update_lifestyles_request_supplier: UpdateLifestylesRequestSupplier
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._update_lifestyles_serialize(
            property_identifier=property_identifier,
            update_lifestyles_request_supplier=update_lifestyles_request_supplier,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def update_lifestyles_with_http_info(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Update lifestyles for this property identifier")],
        update_lifestyles_request_supplier: UpdateLifestylesRequestSupplier,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def update_lifestyles_without_preload_content(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Update lifestyles for this property identifier")],
        update_lifestyles_request_supplier: UpdateLifestylesRequestSupplier,
        wink_version: Optional[StrictStr] = None,
    ...
    def _update_lifestyles_serialize(
        self,
        property_identifier,
        update_lifestyles_request_supplier,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if update_lifestyles_request_supplier is not None:
            _body_params = update_lifestyles_request_supplier
