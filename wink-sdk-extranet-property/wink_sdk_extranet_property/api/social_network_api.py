...
class SocialNetworkApi:
    ...
    def show_social_networks(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Show Social Networks associated with this property identifier")],
        ...
        :param property_identifier: Show Social Networks associated with this property identifier (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "SocialNetworksResponseSupplier",
        }
    ...
    def show_social_networks_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SocialNetworksResponseSupplier]:
        """Show Social Networks
    ...
    def _show_social_networks_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/property/{propertyIdentifier}/social-networks',
    ...
    def update_socials(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Set social networks this property identifier")],
        social_networks_request_supplier: SocialNetworksRequestSupplier,
        wink_version: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param property_identifier: Set social networks this property identifier (required)
        :type property_identifier: str
        :param social_networks_request_supplier: (required)
        :type social_networks_request_supplier: SocialNetworksRequestSupplier
        :param wink_version:
        :type wink_version: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._update_socials_serialize(
            property_identifier=property_identifier,
            social_networks_request_supplier=social_networks_request_supplier,
            wink_version=wink_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def update_socials_with_http_info(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Set social networks this property identifier")],
        social_networks_request_supplier: SocialNetworksRequestSupplier,
        wink_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def update_socials_without_preload_content(
        self,
        property_identifier: Annotated[StrictStr, Field(description="Set social networks this property identifier")],
        social_networks_request_supplier: SocialNetworksRequestSupplier,
        wink_version: Optional[StrictStr] = None,
    ...
    def _update_socials_serialize(
        self,
        property_identifier,
        social_networks_request_supplier,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if social_networks_request_supplier is not None:
            _body_params = social_networks_request_supplier
