...
class ChangePropertyNameRequestSupplier(BaseModel):
    ...
    local_name: StrictStr = Field(description="Name of the hotel in its local language.", alias="localName")
    __properties: ClassVar[List[str]] = ["tradeName", "legalName", "localName"]
