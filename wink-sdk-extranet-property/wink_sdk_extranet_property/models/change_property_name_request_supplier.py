...
class ChangePropertyNameRequestSupplier(BaseModel):
    """
    ChangePropertyNameRequestSupplier
    """ # noqa: E501
    trade_name: StrictStr = Field(description="Doing business as name.", alias="tradeName")
    legal_name: StrictStr = Field(description="Hotel chain name if property is part of that chain.", alias="legalName")
    local_name: Optional[StrictStr] = Field(default=None, description="Name of the hotel in its local language.", alias="localName")
    url_name: Optional[StrictStr] = Field(default=None, description="Url slug that uniquely identifies the property.", alias="urlName")
    __properties: ClassVar[List[str]] = ["tradeName", "legalName", "localName", "urlName"]
