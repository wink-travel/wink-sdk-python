...
class ManagedByEntitySupplier(BaseModel):
    """
    ...
    rules: Optional[ManagedByEntityRulesSupplier] = Field(default=None, description="Optional rules for expiration date etc when agency is no longer managing this entity.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": ManagedByEntityRulesSupplier.from_dict(obj["rules"]) if obj.get("rules") is not None else None,
            "valid": obj.get("valid")
        })
        return _obj
