...
class AnnouncementViewSupplier(BaseModel):
    """
    ...
    announcement: AnnouncementSupplier
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "announcement"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "announcement": AnnouncementSupplier.from_dict(obj["announcement"]) if obj.get("announcement") is not None else None
        })
        return _obj
