...
class UpdatePropertyAmenitiesAndServicesRequestSupplier(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["hotelAmenityCodes", "propertyAccessibilityCodes", "propertySecurityCodes"]
