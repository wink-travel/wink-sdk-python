...
class UpsertWelcomeTextRequestSupplier(BaseModel):
    """
    UpsertWelcomeTextRequestSupplier
    """ # noqa: E501
    list: Annotated[List[UpsertSimpleDescriptionSupplier], Field(min_length=1, max_length=2147483647)] = Field(description="Long and short property descriptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [UpsertSimpleDescriptionSupplier.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
