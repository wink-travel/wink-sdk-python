...
class AggregateGreendexAnswersSupplier(BaseModel):
    """
    ...
    scores_by_category: Optional[List[AggregateGreendexScoreByCategorySupplier]] = Field(default=None, description="Aggregate scores by Green Index category", alias="scoresByCategory")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scoresByCategory": [AggregateGreendexScoreByCategorySupplier.from_dict(_item) for _item in obj["scoresByCategory"]] if obj.get("scoresByCategory") is not None else None
        })
        return _obj
