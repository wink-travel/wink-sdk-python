...
class ImproveWelcomeTextRequestSupplier(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Short description")
    description: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Long description")
