...
class ImproveWelcomeTextRequestSupplier(BaseModel):
    """
    ImproveWelcomeTextRequestSupplier
    """ # noqa: E501
    short_description: StrictStr = Field(description="Short description", alias="shortDescription")
    long_description: StrictStr = Field(description="Long description", alias="longDescription")
    language: StrictStr
    __properties: ClassVar[List[str]] = ["shortDescription", "longDescription", "language"]
