...
class SocialNetworksResponseSupplier(BaseModel):
    """
    SocialNetworksResponseSupplier
    """ # noqa: E501
    hotel_identifier: StrictStr = Field(description="Property identifier associated with social networks", alias="hotelIdentifier")
    list: Optional[List[SocialSupplier]] = Field(default=None, description="List of social networks.")
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [SocialSupplier.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
