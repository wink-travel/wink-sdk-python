...
class SocialNetworksResponseSupplier(BaseModel):
    ...
    """ # noqa: E501
    hotel_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Property identifier associated with social networks", alias="hotelIdentifier")
    list: Optional[List[SocialSupplier]] = None
