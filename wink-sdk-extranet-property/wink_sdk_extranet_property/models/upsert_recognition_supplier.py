...
class UpsertRecognitionSupplier(BaseModel):
    """
    ...
    max_rating: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Use this to let hotels indicate what the total score for this award is.", alias="maxRating")
    ...
    __properties: ClassVar[List[str]] = ["type", "category", "provider", "rating", "maxRating", "date", "officialAppointmentInd", "ratingSymbol"]
