...
class AnnouncementSupplier(BaseModel):
    ...
    hotel_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Hotel identifier manager has access to.", alias="hotelIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "hotelIdentifier", "startDate", "endDate", "descriptions", "showTitle", "showAlways"]
