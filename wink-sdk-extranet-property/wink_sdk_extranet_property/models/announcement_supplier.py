...
class AnnouncementSupplier(BaseModel):
    """
    Announcement
    """ # noqa: E501
    ...
    descriptions: Annotated[List[SimpleDescriptionSupplier], Field(min_length=1, max_length=2147483647)] = Field(description="List of all localized announcements.")
