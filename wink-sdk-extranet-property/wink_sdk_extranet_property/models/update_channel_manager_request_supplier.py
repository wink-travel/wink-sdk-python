...
class UpdateChannelManagerRequestSupplier(BaseModel):
    """
    UpdateChannelManagerRequestSupplier
    """ # noqa: E501
    rate_provider: KeyValuePairSupplier = Field(description="Property's channel manager. Rate ownership is decided based on the channel manager selected. This can be both an enum and an identifier.", alias="rateProvider")
    __properties: ClassVar[List[str]] = ["rateProvider"]
