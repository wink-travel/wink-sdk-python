...
class ManagingEntityManagerSupplier(BaseModel):
    """
    ...
    profile_picture: Optional[SimpleMultimediaSupplier] = Field(default=None, description="Profile picture is available", alias="profilePicture")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profilePicture": SimpleMultimediaSupplier.from_dict(obj["profilePicture"]) if obj.get("profilePicture") is not None else None,
            "owner": obj.get("owner"),
            "roles": obj.get("roles"),
            "name": obj.get("name")
        })
