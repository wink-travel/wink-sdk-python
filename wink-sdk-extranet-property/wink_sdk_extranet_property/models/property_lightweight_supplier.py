...
class PropertyLightweightSupplier(BaseModel):
    """
    PropertyLightweightSupplier
    """ # noqa: E501
    hotel_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique hotel identifier", alias="hotelIdentifier")
    ...
    external_status: StrictStr = Field(description="Property goes active by changing externalStatus.", alias="externalStatus")
    ...
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "name", "urlName", "currencyCode", "status", "externalStatus", "stars", "numberOfRooms", "active", "propertyActive", "platformActive"]
