...
class PropertyLightweightSupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hotelIdentifier", "name", "urlName", "currencyCode", "status", "externalStatus", "stars", "numberOfRooms", "active", "platformActive", "propertyActive"]
