...
class LifestylesResponseSupplier(BaseModel):
    ...
    """ # noqa: E501
    hotel_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Lifestyles belong to this property identifier ", alias="hotelIdentifier")
    list: Optional[Annotated[List[StrictStr], Field(min_length=0, max_length=4)]] = None
