...
class LifestylesResponseSupplier(BaseModel):
    """
    LifestylesResponseSupplier
    """ # noqa: E501
    hotel_identifier: StrictStr = Field(description="Lifestyles belong to this property identifier ", alias="hotelIdentifier")
    list: Optional[Annotated[List[StrictStr], Field(min_length=0, max_length=4)]] = Field(default=None, description="List of new lifestyles to set on property.")
