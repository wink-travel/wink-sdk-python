...
class PropertyAggregateGreenIndexAnswersSupplier(BaseModel):
    """
    PropertyAggregateGreenIndexAnswersSupplier
    """ # noqa: E501
    hotel_identifier: StrictStr = Field(alias="hotelIdentifier")
    list: List[PropertyAggregateGreenIndexAnswerSupplier]
    ...
    scores_by_category: List[PropertyAggregateGreenIndexScoreByCategorySupplier] = Field(description="Aggregate scores by Green Index category", alias="scoresByCategory")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [PropertyAggregateGreenIndexAnswerSupplier.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
            "highScore": obj.get("highScore"),
            "totalScore": obj.get("totalScore"),
            "aggregateScore": obj.get("aggregateScore"),
            "scoresByCategory": [PropertyAggregateGreenIndexScoreByCategorySupplier.from_dict(_item) for _item in obj["scoresByCategory"]] if obj.get("scoresByCategory") is not None else None
        })
        return _obj
