...
class UpdateExternalHotelStatusRequestSupplier(BaseModel):
    """
    UpdateExternalHotelStatusRequestSupplier
    """ # noqa: E501
    hotel_status_code: Optional[StrictStr] = Field(default=None, description="Via OTA spec: 1 = Active, 6 = Inactive. This status can be changed by the hotel.", alias="hotelStatusCode")
    __properties: ClassVar[List[str]] = ["hotelStatusCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hotelStatusCode": obj.get("hotelStatusCode")
        })
        return _obj
