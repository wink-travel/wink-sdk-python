...
class UpsertReservationsDeskRequestSupplier(BaseModel):
    """
    UpsertReservationsDeskRequestSupplier
    """ # noqa: E501
    reservations_contact: ContactSupplier = Field(alias="reservationsContact")
    reservation_desk_start_time: StrictStr = Field(description="If the reservation desk does not operate 24 hours, enter a start time.", alias="reservationDeskStartTime")
    reservation_desk_end_time: StrictStr = Field(description="If the reservation desk does not operate 24 hours, enter an end time.", alias="reservationDeskEndTime")
    __properties: ClassVar[List[str]] = ["reservationsContact", "reservationDeskStartTime", "reservationDeskEndTime"]
