...
class SuggestProfileResponseSupplier(BaseModel):
    """
    SuggestProfileResponseSupplier
    """ # noqa: E501
    website: StrictStr = Field(description="Website")
    ambiance: StrictStr = Field(description="Property ambiance")
    ...
    design_elements: Optional[StrictStr] = Field(default=None, alias="designElements")
    historic: Optional[StrictStr] = None
    number_of_rooms: Optional[StrictStr] = Field(default=None, alias="numberOfRooms")
    hotel_stars: Optional[StrictStr] = Field(default=None, alias="hotelStars")
    location_category: Optional[StrictStr] = Field(default=None, alias="locationCategory")
    segment: Optional[StrictStr] = None
    property_class: Optional[StrictStr] = Field(default=None, alias="propertyClass")
    style: Optional[StrictStr] = None
    chain: Optional[StrictStr] = None
    brand: Optional[StrictStr] = None
    year_built: Optional[StrictStr] = Field(default=None, alias="yearBuilt")
    __properties: ClassVar[List[str]] = ["website", "ambiance", "address1", "address2", "address3", "city", "province", "postalCode", "country", "phoneNumber", "emailAddress", "architecture", "designElements", "historic", "numberOfRooms", "hotelStars", "locationCategory", "segment", "propertyClass", "style", "chain", "brand", "yearBuilt"]
