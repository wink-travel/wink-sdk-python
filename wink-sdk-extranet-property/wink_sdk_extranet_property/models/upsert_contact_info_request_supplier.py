...
class UpsertContactInfoRequestSupplier(BaseModel):
    """
    UpsertContactInfoRequestSupplier
    """ # noqa: E501
    reservations_contact: ContactSupplier = Field(description="[Online] reservationsContact desk assistant at property that can be contacted by travelers and agents.", alias="reservationsContact")
    revenue_contact: ContactSupplier = Field(description="Digital revenueContact mgmt team at property that can be contacted by Wink.", alias="revenueContact")
    marketing_contact: ContactSupplier = Field(description="Marketing team at property that can be contacted by Wink.", alias="marketingContact")
    reservation_desk_start_time: Annotated[str, Field(min_length=1, strict=True)] = Field(description="If the reservationsContact desk does not operate 24 hours, enter a start time.", alias="reservationDeskStartTime")
    reservation_desk_end_time: Annotated[str, Field(min_length=1, strict=True)] = Field(description="If the reservationsContact desk does not operate 24 hours, enter an end time.", alias="reservationDeskEndTime")
    __properties: ClassVar[List[str]] = ["reservationsContact", "revenueContact", "marketingContact", "reservationDeskStartTime", "reservationDeskEndTime"]
