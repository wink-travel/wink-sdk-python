...
class UpsertPropertyProfileRequestSupplier(BaseModel):
    """
    UpsertPropertyProfileRequestSupplier
    """ # noqa: E501
    stars: Annotated[int, Field(le=6, strict=True, ge=0)] = Field(description="Hotel star rating.")
    ...
    website: Optional[StrictStr] = Field(default=None, description="Property's brand.com website.")
    ...
    location_category: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supported OTA specification `LOC` code. See [OTA geoname data](#operation/showAvailableCodesForCategory)", alias="locationCategory")
    segment_category: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supported OTA specification `SEG` code. See [OTA geoname data](#operation/showAvailableCodesForCategory)", alias="segmentCategory")
    hotel_category: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supported OTA specification `PCT` code. See [OTA geoname data](#operation/showAvailableCodesForCategory)", alias="hotelCategory")
    architectural_style: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Supported OTA specification `ARC` code. See [OTA geoname data](#operation/showAvailableCodesForCategory)", alias="architecturalStyle")
    __properties: ClassVar[List[str]] = ["stars", "hotelChain", "hotelBrand", "whenBuilt", "website", "licenseNumber", "numberOfRooms", "locationCategory", "segmentCategory", "hotelCategory", "architecturalStyle"]
