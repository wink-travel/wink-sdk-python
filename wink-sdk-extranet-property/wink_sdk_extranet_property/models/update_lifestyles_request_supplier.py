...
class UpdateLifestylesRequestSupplier(BaseModel):
    """
    UpdateLifestylesRequestSupplier
    """ # noqa: E501
    list: Optional[Annotated[List[StrictStr], Field(min_length=0, max_length=6)]] = Field(default=None, description="List of new lifestyles to set on property.")
