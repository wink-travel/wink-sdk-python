...
class PropertySupplier(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "userIdentifier", "managingEntityIdentifier", "ownerIdentifier", "managers", "managedBy", "ownerType", "type", "name", "legalName", "urlName", "uniqueId", "currencyCode", "status", "city", "address", "placeId", "hotelCode", "localName", "externalStatus", "multimedias", "recognitionList", "locationCategory", "segmentCategory", "hotelCategory", "architecturalStyle", "whenBuilt", "hotelChain", "hotelBrand", "otherChannelManager", "licenseNumber", "stars", "generalManager", "descriptions", "hotelAmenityCodes", "propertyAccessibilityCodes", "propertySecurityCodes", "locationPoint", "policy", "socials", "reservationsContact", "revenueContact", "marketingContact", "lifestyleTypes", "greenIndexScores", "numberOfRooms", "reservationDeskStartTime", "reservationDeskEndTime", "website", "googleMapsUrl", "rateProvider", "metadata", "active", "socialNetworks", "lifestyles", "propertyActive", "platformActive"]
