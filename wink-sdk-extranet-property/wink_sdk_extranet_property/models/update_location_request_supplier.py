...
class UpdateLocationRequestSupplier(BaseModel):
    """
    UpdateLocationRequestSupplier
    """ # noqa: E501
    point: GeoJsonPointSupplier = Field(description="New location for property.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "point": GeoJsonPointSupplier.from_dict(obj["point"]) if obj.get("point") is not None else None
        })
        return _obj
