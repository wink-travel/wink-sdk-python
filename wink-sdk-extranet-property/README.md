...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.64#egg=wink_sdk_extranet_property&subdirectory=wink-sdk-extranet-property
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.64#egg=wink_sdk_extranet_property&subdirectory=wink_sdk_extranet_property`)
