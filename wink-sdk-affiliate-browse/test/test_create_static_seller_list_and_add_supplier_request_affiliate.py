...
class TestCreateStaticSellerListAndAddSupplierRequestAffiliate(unittest.TestCase):
    """CreateStaticSellerListAndAddSupplierRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStaticSellerListAndAddSupplierRequestAffiliate:
        """Test CreateStaticSellerListAndAddSupplierRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStaticSellerListAndAddSupplierRequestAffiliate`
        """
        model = CreateStaticSellerListAndAddSupplierRequestAffiliate()
        if include_optional:
            return CreateStaticSellerListAndAddSupplierRequestAffiliate(
    ...
    def testCreateStaticSellerListAndAddSupplierRequestAffiliate(self):
        """Test CreateStaticSellerListAndAddSupplierRequestAffiliate"""
