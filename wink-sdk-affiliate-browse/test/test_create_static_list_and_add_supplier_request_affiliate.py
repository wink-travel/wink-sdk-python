...
class TestCreateStaticListAndAddSupplierRequestAffiliate(unittest.TestCase):
    """CreateStaticListAndAddSupplierRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStaticListAndAddSupplierRequestAffiliate:
        """Test CreateStaticListAndAddSupplierRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStaticListAndAddSupplierRequestAffiliate`
        """
        model = CreateStaticListAndAddSupplierRequestAffiliate()
        if include_optional:
            return CreateStaticListAndAddSupplierRequestAffiliate(
    ...
    def testCreateStaticListAndAddSupplierRequestAffiliate(self):
        """Test CreateStaticListAndAddSupplierRequestAffiliate"""
