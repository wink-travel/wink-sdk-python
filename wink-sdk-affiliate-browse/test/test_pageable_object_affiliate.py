...
class TestPageableObjectAffiliate(unittest.TestCase):
    """PageableObjectAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageableObjectAffiliate:
        """Test PageableObjectAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageableObjectAffiliate`
        """
        model = PageableObjectAffiliate()
        if include_optional:
            return PageableObjectAffiliate(
                offset = 56,
                sort = [
    ...
    def testPageableObjectAffiliate(self):
        """Test PageableObjectAffiliate"""
