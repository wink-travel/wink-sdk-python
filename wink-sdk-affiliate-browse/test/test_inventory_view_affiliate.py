...
class TestInventoryViewAffiliate(unittest.TestCase):
    """InventoryViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryViewAffiliate:
        """Test InventoryViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryViewAffiliate`
        """
        model = InventoryViewAffiliate()
        if include_optional:
            return InventoryViewAffiliate(
                id = 'doc-1',
    ...
    def testInventoryViewAffiliate(self):
        """Test InventoryViewAffiliate"""
