...
class TestInventoryAggregateLightweightAffiliate(unittest.TestCase):
    """InventoryAggregateLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryAggregateLightweightAffiliate:
        """Test InventoryAggregateLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryAggregateLightweightAffiliate`
        """
        model = InventoryAggregateLightweightAffiliate()
        if include_optional:
            return InventoryAggregateLightweightAffiliate(
                id = 'doc-1',
                ...
                hotel = wink_sdk_affiliate_browse.models.property_aggregate_lightweight_affiliate.PropertyAggregateLightweight_Affiliate(
                    ...
                    location = {type=POINT, coordinates=[100.5581533, 13.7370197]}, 
                    descriptions = [
                        wink_sdk_affiliate_browse.models.simple_description_affiliate.SimpleDescription_Affiliate(
                    ...
                    policy = wink_sdk_affiliate_browse.models.property_policy_affiliate.PropertyPolicy_Affiliate(
                        ...
                        pet_charge = wink_sdk_affiliate_browse.models.custom_monetary_amount.CustomMonetaryAmount(
                            amount = 1.337, 
                            currency = '0', ), 
                    ...
                    number_of_rooms = 32, 
                    address = wink_sdk_affiliate_browse.models.simple_address_affiliate.SimpleAddress_Affiliate(
                        address1 = '234', 
                        address2 = 'Pebble #5001', 
                        state = 'CA', 
                        postal_code = '90210', 
    ...
    def testInventoryAggregateLightweightAffiliate(self):
        """Test InventoryAggregateLightweightAffiliate"""
