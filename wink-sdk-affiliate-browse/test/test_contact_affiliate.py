...
class TestContactAffiliate(unittest.TestCase):
    """ContactAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactAffiliate:
        """Test ContactAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactAffiliate`
        """
        model = ContactAffiliate()
        if include_optional:
            return ContactAffiliate(
                first_name = 'John',
                last_name = 'Smith',
