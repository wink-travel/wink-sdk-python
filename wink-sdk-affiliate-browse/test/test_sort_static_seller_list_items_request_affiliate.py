...
class TestSortStaticSellerListItemsRequestAffiliate(unittest.TestCase):
    """SortStaticSellerListItemsRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortStaticSellerListItemsRequestAffiliate:
        """Test SortStaticSellerListItemsRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortStaticSellerListItemsRequestAffiliate`
        """
        model = SortStaticSellerListItemsRequestAffiliate()
        if include_optional:
            return SortStaticSellerListItemsRequestAffiliate(
                items = {
                    'key' : 56
                    }
            )
    ...
    def testSortStaticSellerListItemsRequestAffiliate(self):
        """Test SortStaticSellerListItemsRequestAffiliate"""
