...
class TestStaticListAffiliate(unittest.TestCase):
    """StaticListAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticListAffiliate:
        """Test StaticListAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticListAffiliate`
        """
        model = StaticListAffiliate()
        if include_optional:
    ...
    def testStaticListAffiliate(self):
        """Test StaticListAffiliate"""
