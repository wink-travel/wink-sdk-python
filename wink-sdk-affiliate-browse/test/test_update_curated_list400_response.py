...
class TestUpdateCuratedList400Response(unittest.TestCase):
    """UpdateCuratedList400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCuratedList400Response:
        """Test UpdateCuratedList400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCuratedList400Response`
        """
        model = UpdateCuratedList400Response()
        if include_optional:
            return UpdateCuratedList400Response(
                timestamp = '',
                status = 56,
                error = '',
                message = '',
    ...
    def testUpdateCuratedList400Response(self):
        """Test UpdateCuratedList400Response"""
