...
class TestPageInventorySupplierAffiliate(unittest.TestCase):
    """PageInventorySupplierAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageInventorySupplierAffiliate:
        """Test PageInventorySupplierAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageInventorySupplierAffiliate`
        """
        model = PageInventorySupplierAffiliate()
        if include_optional:
            return PageInventorySupplierAffiliate(
                ...
                size = 56,
                content = [
                    wink_sdk_affiliate_browse.models.inventory_supplier_affiliate.InventorySupplier_Affiliate(
                ...
                number = 56,
                sort = [
                    wink_sdk_affiliate_browse.models.sort_object.SortObject(
                        direction = '', 
                        null_handling = '', 
                        ascending = True, 
                        property = '', 
    ...
    def testPageInventorySupplierAffiliate(self):
        """Test PageInventorySupplierAffiliate"""
