...
class TestAddStaticListItemRequestAffiliate(unittest.TestCase):
    """AddStaticListItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddStaticListItemRequestAffiliate:
        """Test AddStaticListItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddStaticListItemRequestAffiliate`
        """
        model = AddStaticListItemRequestAffiliate()
        if include_optional:
            return AddStaticListItemRequestAffiliate(
                channel_inventory_identifier = '0'
            )
        else:
            return AddStaticListItemRequestAffiliate(
                channel_inventory_identifier = '0',
    ...
    def testAddStaticListItemRequestAffiliate(self):
        """Test AddStaticListItemRequestAffiliate"""
