...
class TestInventoryAddressAffiliate(unittest.TestCase):
    """InventoryAddressAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryAddressAffiliate:
        """Test InventoryAddressAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryAddressAffiliate`
        """
        model = InventoryAddressAffiliate()
        if include_optional:
            return InventoryAddressAffiliate(
                address1 = '234',
    ...
    def testInventoryAddressAffiliate(self):
        """Test InventoryAddressAffiliate"""
