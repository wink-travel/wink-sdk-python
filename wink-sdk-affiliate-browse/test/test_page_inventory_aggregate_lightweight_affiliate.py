...
class TestPageInventoryAggregateLightweightAffiliate(unittest.TestCase):
    """PageInventoryAggregateLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageInventoryAggregateLightweightAffiliate:
        """Test PageInventoryAggregateLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageInventoryAggregateLightweightAffiliate`
        """
        model = PageInventoryAggregateLightweightAffiliate()
        if include_optional:
            return PageInventoryAggregateLightweightAffiliate(
                ...
                size = 56,
                content = [
                    wink_sdk_affiliate_browse.models.inventory_aggregate_lightweight_affiliate.InventoryAggregateLightweight_Affiliate(
                        id = 'doc-1', 
                        created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        version = 12, 
                        sales_channel = wink_sdk_affiliate_browse.models.sales_channel_lightweight_affiliate.SalesChannelLightweight_Affiliate(
                            ...
                            commission = 0.2, 
                            rate_modifiers = [
                                wink_sdk_affiliate_browse.models.special_rate_lightweight_affiliate.SpecialRateLightweight_Affiliate(
                            ...
                            rate_modifier_bundles = [
                                wink_sdk_affiliate_browse.models.special_rate_bundle_lightweight_affiliate.SpecialRateBundleLightweight_Affiliate(
                                    identifier = 'document-1', 
                                    hotel_identifier = 'hotel-1', 
                        ...
                        inventory_identifier = '0', 
                        inventory_name = '0', 
                        inventory_name_in_english = '0', 
                        enabled = True, 
                        image_identifier = '0', 
                        price_point = 'THREE', 
                        location = {type=POINT, coordinates=[100.5581533, 13.7370197]}, 
                        address = wink_sdk_affiliate_browse.models.inventory_address_affiliate.InventoryAddress_Affiliate(
                            address1 = '234', 
                            address2 = 'Pebble #5001', 
                            state = 'CA', 
                            postal_code = '90210', 
                            county = 'Alameda county', 
                            city_geo_name_id = '1234567', 
                            city_url_name = 'new-york-city-united-states', 
                            city = 'New York City', 
                            country = 'United States', 
                            country_code = 'US', 
                            country_geo_name_id = '7654321', 
                            continent = 'SEA', ), 
                        quantity = 100, 
                        commissionable = True, 
                        bookable = True, 
                        ...
                        lowest_display_price = wink_sdk_affiliate_browse.models.custom_monetary_amount.CustomMonetaryAmount(
                            amount = 1.337, 
                            currency = '0', ), 
                        hotel = wink_sdk_affiliate_browse.models.property_aggregate_lightweight_affiliate.PropertyAggregateLightweight_Affiliate(
                            hotel_identifier = 'hotel-1', 
                            ...
                            images = [
                                wink_sdk_affiliate_browse.models.simple_multimedia_affiliate.SimpleMultimedia_Affiliate(
                                    ...
                                    attribution = [
                                        wink_sdk_affiliate_browse.models.image_attribution_affiliate.ImageAttribution_Affiliate(
                ...
                sort = wink_sdk_affiliate_browse.models.sort_object_affiliate.SortObject_Affiliate(
                    empty = True, 
                    unsorted = True, 
                    sorted = True, ),
                pageable = wink_sdk_affiliate_browse.models.pageable_object_affiliate.PageableObject_Affiliate(
                    offset = 56, 
                    sort = wink_sdk_affiliate_browse.models.sort_object_affiliate.SortObject_Affiliate(
                        empty = True, 
                        unsorted = True, 
    ...
    def testPageInventoryAggregateLightweightAffiliate(self):
        """Test PageInventoryAggregateLightweightAffiliate"""
