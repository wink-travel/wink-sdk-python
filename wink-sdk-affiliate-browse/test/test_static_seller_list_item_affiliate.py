...
class TestStaticSellerListItemAffiliate(unittest.TestCase):
    """StaticSellerListItemAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticSellerListItemAffiliate:
        """Test StaticSellerListItemAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticSellerListItemAffiliate`
        """
        model = StaticSellerListItemAffiliate()
        if include_optional:
            return StaticSellerListItemAffiliate(
                identifier = '',
    ...
    def testStaticSellerListItemAffiliate(self):
        """Test StaticSellerListItemAffiliate"""
