...
class TestStaticSellerListAffiliate(unittest.TestCase):
    """StaticSellerListAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticSellerListAffiliate:
        """Test StaticSellerListAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticSellerListAffiliate`
        """
        model = StaticSellerListAffiliate()
        if include_optional:
            return StaticSellerListAffiliate(
                identifier = '',
                owner_identifier = '',
    ...
    def testStaticSellerListAffiliate(self):
        """Test StaticSellerListAffiliate"""
