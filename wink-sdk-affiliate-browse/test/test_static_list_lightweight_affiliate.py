...
class TestStaticListLightweightAffiliate(unittest.TestCase):
    """StaticListLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticListLightweightAffiliate:
        """Test StaticListLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticListLightweightAffiliate`
        """
        model = StaticListLightweightAffiliate()
        if include_optional:
            return StaticListLightweightAffiliate(
                identifier = 'list-1',
    ...
    def testStaticListLightweightAffiliate(self):
        """Test StaticListLightweightAffiliate"""
