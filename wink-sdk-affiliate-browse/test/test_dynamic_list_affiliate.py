...
class TestDynamicListAffiliate(unittest.TestCase):
    """DynamicListAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicListAffiliate:
        """Test DynamicListAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicListAffiliate`
        """
        model = DynamicListAffiliate()
        if include_optional:
    ...
    def testDynamicListAffiliate(self):
        """Test DynamicListAffiliate"""
