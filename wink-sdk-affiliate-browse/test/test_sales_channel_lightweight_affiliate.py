...
class TestSalesChannelLightweightAffiliate(unittest.TestCase):
    """SalesChannelLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesChannelLightweightAffiliate:
        """Test SalesChannelLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesChannelLightweightAffiliate`
        """
        model = SalesChannelLightweightAffiliate()
        if include_optional:
            return SalesChannelLightweightAffiliate(
    ...
    def testSalesChannelLightweightAffiliate(self):
        """Test SalesChannelLightweightAffiliate"""
