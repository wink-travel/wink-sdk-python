...
class TestInventorySupplierAggregateLightweightAffiliate(unittest.TestCase):
    """InventorySupplierAggregateLightweightAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventorySupplierAggregateLightweightAffiliate:
        """Test InventorySupplierAggregateLightweightAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventorySupplierAggregateLightweightAffiliate`
        """
        model = InventorySupplierAggregateLightweightAffiliate()
        if include_optional:
    ...
    def testInventorySupplierAggregateLightweightAffiliate(self):
        """Test InventorySupplierAggregateLightweightAffiliate"""
