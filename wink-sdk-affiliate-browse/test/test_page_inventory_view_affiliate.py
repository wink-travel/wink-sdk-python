...
class TestPageInventoryViewAffiliate(unittest.TestCase):
    """PageInventoryViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageInventoryViewAffiliate:
        """Test PageInventoryViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageInventoryViewAffiliate`
        """
        model = PageInventoryViewAffiliate()
        if include_optional:
            return PageInventoryViewAffiliate(
                ...
                size = 56,
                content = [
                    wink_sdk_affiliate_browse.models.inventory_view_affiliate.InventoryView_Affiliate(
                        id = 'doc-1', 
    ...
    def testPageInventoryViewAffiliate(self):
        """Test PageInventoryViewAffiliate"""
