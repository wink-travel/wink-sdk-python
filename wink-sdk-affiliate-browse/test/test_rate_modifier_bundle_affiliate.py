...
class TestRateModifierBundleAffiliate(unittest.TestCase):
    """RateModifierBundleAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateModifierBundleAffiliate:
        """Test RateModifierBundleAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateModifierBundleAffiliate`
        """
        model = RateModifierBundleAffiliate()
        if include_optional:
            return RateModifierBundleAffiliate(
                identifier = '',
                hotel_identifier = '',
    ...
    def testRateModifierBundleAffiliate(self):
        """Test RateModifierBundleAffiliate"""
