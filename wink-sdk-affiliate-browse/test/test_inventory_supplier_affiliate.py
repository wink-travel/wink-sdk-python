...
class TestInventorySupplierAffiliate(unittest.TestCase):
    """InventorySupplierAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventorySupplierAffiliate:
        """Test InventorySupplierAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventorySupplierAffiliate`
        """
        model = InventorySupplierAffiliate()
        if include_optional:
    ...
    def testInventorySupplierAffiliate(self):
        """Test InventorySupplierAffiliate"""
