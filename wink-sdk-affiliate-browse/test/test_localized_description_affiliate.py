...
class TestLocalizedDescriptionAffiliate(unittest.TestCase):
    """LocalizedDescriptionAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalizedDescriptionAffiliate:
        """Test LocalizedDescriptionAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalizedDescriptionAffiliate`
        """
        model = LocalizedDescriptionAffiliate()
        if include_optional:
            return LocalizedDescriptionAffiliate(
    ...
    def testLocalizedDescriptionAffiliate(self):
        """Test LocalizedDescriptionAffiliate"""
