...
class TestSocialAffiliate(unittest.TestCase):
    """SocialAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialAffiliate:
        """Test SocialAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SocialAffiliate`
        """
        model = SocialAffiliate()
        if include_optional:
            return SocialAffiliate(
                type = 'FACEBOOK',
                location = '',
                enabled = True
            )
