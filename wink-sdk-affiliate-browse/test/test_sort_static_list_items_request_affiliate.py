...
class TestSortStaticListItemsRequestAffiliate(unittest.TestCase):
    """SortStaticListItemsRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortStaticListItemsRequestAffiliate:
        """Test SortStaticListItemsRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortStaticListItemsRequestAffiliate`
        """
        model = SortStaticListItemsRequestAffiliate()
        if include_optional:
            return SortStaticListItemsRequestAffiliate(
                items = {
                    'key' : 56
                    }
            )
    ...
    def testSortStaticListItemsRequestAffiliate(self):
        """Test SortStaticListItemsRequestAffiliate"""
