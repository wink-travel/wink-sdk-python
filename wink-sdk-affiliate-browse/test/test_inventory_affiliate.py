...
class TestInventoryAffiliate(unittest.TestCase):
    """InventoryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryAffiliate:
        """Test InventoryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryAffiliate`
        """
        model = InventoryAffiliate()
        if include_optional:
            return InventoryAffiliate(
                identifier = '',
    ...
    def testInventoryAffiliate(self):
        """Test InventoryAffiliate"""
