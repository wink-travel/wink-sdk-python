...
class TestSearchCategoryAffiliate(unittest.TestCase):
    """SearchCategoryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchCategoryAffiliate:
        """Test SearchCategoryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchCategoryAffiliate`
        """
        model = SearchCategoryAffiliate()
        if include_optional:
            return SearchCategoryAffiliate(
                type = 'HOTEL',
                key = 'GRE',
                value = 'GRE',
                count = 15
    ...
    def testSearchCategoryAffiliate(self):
        """Test SearchCategoryAffiliate"""
