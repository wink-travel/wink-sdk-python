...
class TestStaticListItemInventoryAffiliate(unittest.TestCase):
    """StaticListItemInventoryAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticListItemInventoryAffiliate:
        """Test StaticListItemInventoryAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticListItemInventoryAffiliate`
        """
        model = StaticListItemInventoryAffiliate()
        if include_optional:
            return StaticListItemInventoryAffiliate(
                identifier = '',
    ...
    def testStaticListItemInventoryAffiliate(self):
        """Test StaticListItemInventoryAffiliate"""
