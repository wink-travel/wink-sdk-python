...
class TestSortObjectAffiliate(unittest.TestCase):
    """SortObjectAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SortObjectAffiliate:
        """Test SortObjectAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortObjectAffiliate`
        """
        model = SortObjectAffiliate()
        if include_optional:
            return SortObjectAffiliate(
                empty = True,
                sorted = True,
                unsorted = True
            )
    ...
    def testSortObjectAffiliate(self):
        """Test SortObjectAffiliate"""
