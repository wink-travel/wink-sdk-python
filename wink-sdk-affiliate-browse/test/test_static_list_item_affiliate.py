...
class TestStaticListItemAffiliate(unittest.TestCase):
    """StaticListItemAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticListItemAffiliate:
        """Test StaticListItemAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticListItemAffiliate`
        """
        model = StaticListItemAffiliate()
        if include_optional:
    ...
    def testStaticListItemAffiliate(self):
        """Test StaticListItemAffiliate"""
