...
class TestAddStaticSellerListSupplierRequestAffiliate(unittest.TestCase):
    """AddStaticSellerListSupplierRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddStaticSellerListSupplierRequestAffiliate:
        """Test AddStaticSellerListSupplierRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddStaticSellerListSupplierRequestAffiliate`
        """
        model = AddStaticSellerListSupplierRequestAffiliate()
        if include_optional:
            return AddStaticSellerListSupplierRequestAffiliate(
    ...
    def testAddStaticSellerListSupplierRequestAffiliate(self):
        """Test AddStaticSellerListSupplierRequestAffiliate"""
