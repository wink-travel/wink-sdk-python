...
class TestAddStaticSellerListItemRequestAffiliate(unittest.TestCase):
    """AddStaticSellerListItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddStaticSellerListItemRequestAffiliate:
        """Test AddStaticSellerListItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddStaticSellerListItemRequestAffiliate`
        """
        model = AddStaticSellerListItemRequestAffiliate()
        if include_optional:
            return AddStaticSellerListItemRequestAffiliate(
    ...
    def testAddStaticSellerListItemRequestAffiliate(self):
        """Test AddStaticSellerListItemRequestAffiliate"""
