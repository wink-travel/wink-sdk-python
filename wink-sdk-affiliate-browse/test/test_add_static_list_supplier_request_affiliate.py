...
class TestAddStaticListSupplierRequestAffiliate(unittest.TestCase):
    """AddStaticListSupplierRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddStaticListSupplierRequestAffiliate:
        """Test AddStaticListSupplierRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddStaticListSupplierRequestAffiliate`
        """
        model = AddStaticListSupplierRequestAffiliate()
        if include_optional:
            return AddStaticListSupplierRequestAffiliate(
    ...
    def testAddStaticListSupplierRequestAffiliate(self):
        """Test AddStaticListSupplierRequestAffiliate"""
