...
class TestTravelInventoryRecognitionAffiliate(unittest.TestCase):
    """TravelInventoryRecognitionAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelInventoryRecognitionAffiliate:
        """Test TravelInventoryRecognitionAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelInventoryRecognitionAffiliate`
        """
        model = TravelInventoryRecognitionAffiliate()
        if include_optional:
            return TravelInventoryRecognitionAffiliate(
                identifier = '',
                category = 'AWARD',
                type = 'PERCENT_RATING',
                provider = 'Michelin',
    ...
    def testTravelInventoryRecognitionAffiliate(self):
        """Test TravelInventoryRecognitionAffiliate"""
