...
class TestStaticSellerListViewAffiliate(unittest.TestCase):
    """StaticSellerListViewAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticSellerListViewAffiliate:
        """Test StaticSellerListViewAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticSellerListViewAffiliate`
        """
        model = StaticSellerListViewAffiliate()
        if include_optional:
            return StaticSellerListViewAffiliate(
                id = 'doc-1',
    ...
    def testStaticSellerListViewAffiliate(self):
        """Test StaticSellerListViewAffiliate"""
