...
class TestStaticSellerListWrapperAffiliate(unittest.TestCase):
    """StaticSellerListWrapperAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticSellerListWrapperAffiliate:
        """Test StaticSellerListWrapperAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticSellerListWrapperAffiliate`
        """
        model = StaticSellerListWrapperAffiliate()
        if include_optional:
            return StaticSellerListWrapperAffiliate(
                list = wink_sdk_affiliate_browse.models.static_seller_list_view_affiliate.StaticSellerListView_Affiliate(
                    id = 'doc-1', 
                    created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    version = 12, 
                    static_seller_list = wink_sdk_affiliate_browse.models.static_seller_list_affiliate.StaticSellerList_Affiliate(
                        identifier = '', 
                        owner_identifier = '', 
                        name = 'Top 3 hotels in Chiang Mai', 
                        type = 'NORMAL', ), ),
                items = [
                    wink_sdk_affiliate_browse.models.static_seller_list_item_view_affiliate.StaticSellerListItemView_Affiliate(
                        id = 'doc-1', 
                        created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        last_update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        version = 12, 
    ...
    def testStaticSellerListWrapperAffiliate(self):
        """Test StaticSellerListWrapperAffiliate"""
