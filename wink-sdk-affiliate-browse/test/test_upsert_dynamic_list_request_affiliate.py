...
class TestUpsertDynamicListRequestAffiliate(unittest.TestCase):
    """UpsertDynamicListRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertDynamicListRequestAffiliate:
        """Test UpsertDynamicListRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertDynamicListRequestAffiliate`
        """
        model = UpsertDynamicListRequestAffiliate()
        if include_optional:
            return UpsertDynamicListRequestAffiliate(
                name = '0',
                property_name = 'Shera',
                ...
                near_point = wink_sdk_affiliate_browse.models.geo_json_point_affiliate.GeoJsonPoint_Affiliate(
                    x = 1.337, 
                    y = 1.337, 
                    type = '', 
                    coordinates = [
    ...
    def testUpsertDynamicListRequestAffiliate(self):
        """Test UpsertDynamicListRequestAffiliate"""
