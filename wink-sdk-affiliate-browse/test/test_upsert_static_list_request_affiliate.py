...
class TestUpsertStaticListRequestAffiliate(unittest.TestCase):
    """UpsertStaticListRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertStaticListRequestAffiliate:
        """Test UpsertStaticListRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertStaticListRequestAffiliate`
        """
        model = UpsertStaticListRequestAffiliate()
        if include_optional:
            return UpsertStaticListRequestAffiliate(
    ...
    def testUpsertStaticListRequestAffiliate(self):
        """Test UpsertStaticListRequestAffiliate"""
