...
class TestCreateStaticListAndAddItemRequestAffiliate(unittest.TestCase):
    """CreateStaticListAndAddItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStaticListAndAddItemRequestAffiliate:
        """Test CreateStaticListAndAddItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateStaticListAndAddItemRequestAffiliate`
        """
        model = CreateStaticListAndAddItemRequestAffiliate()
        if include_optional:
            return CreateStaticListAndAddItemRequestAffiliate(
    ...
    def testCreateStaticListAndAddItemRequestAffiliate(self):
        """Test CreateStaticListAndAddItemRequestAffiliate"""
