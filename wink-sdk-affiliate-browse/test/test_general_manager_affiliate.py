...
class TestGeneralManagerAffiliate(unittest.TestCase):
    """GeneralManagerAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralManagerAffiliate:
        """Test GeneralManagerAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralManagerAffiliate`
        """
        model = GeneralManagerAffiliate()
        if include_optional:
            return GeneralManagerAffiliate(
                name = 'Jane Doe',
                image = cl-image-1,
                descriptions = [
    ...
    def testGeneralManagerAffiliate(self):
        """Test GeneralManagerAffiliate"""
