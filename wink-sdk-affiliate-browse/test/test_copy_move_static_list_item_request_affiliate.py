...
class TestCopyMoveStaticListItemRequestAffiliate(unittest.TestCase):
    """CopyMoveStaticListItemRequestAffiliate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CopyMoveStaticListItemRequestAffiliate:
        """Test CopyMoveStaticListItemRequestAffiliate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CopyMoveStaticListItemRequestAffiliate`
        """
        model = CopyMoveStaticListItemRequestAffiliate()
        if include_optional:
            return CopyMoveStaticListItemRequestAffiliate(
    ...
    def testCopyMoveStaticListItemRequestAffiliate(self):
        """Test CopyMoveStaticListItemRequestAffiliate"""
