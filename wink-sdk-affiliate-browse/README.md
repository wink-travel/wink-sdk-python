...
```sh
pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.5#egg=wink_sdk_affiliate_browse&subdirectory=wink-sdk-affiliate-browse
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/wink-travel/wink-sdk-python.git@v0.0.5#egg=wink_sdk_affiliate_browse&subdirectory=wink_sdk_affiliate_browse`)
