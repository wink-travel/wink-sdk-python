...
class CreateStaticListAndAddItemRequestAffiliate(BaseModel):
    """
    ...
    channel_inventory_identifiers: Optional[List[UUID]] = Field(default=None, alias="channelInventoryIdentifiers")
    __properties: ClassVar[List[str]] = ["name", "channelInventoryIdentifiers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "channelInventoryIdentifiers": obj.get("channelInventoryIdentifiers")
        })
        return _obj
