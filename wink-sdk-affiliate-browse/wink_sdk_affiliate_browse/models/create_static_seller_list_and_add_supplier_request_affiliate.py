...
class CreateStaticSellerListAndAddSupplierRequestAffiliate(BaseModel):
    """
    CreateStaticSellerListAndAddSupplierRequestAffiliate
    """ # noqa: E501
    name: StrictStr = Field(description="Name of curated list")
    supplier_identifier: StrictStr = Field(description="Supplier this list should add.", alias="supplierIdentifier")
