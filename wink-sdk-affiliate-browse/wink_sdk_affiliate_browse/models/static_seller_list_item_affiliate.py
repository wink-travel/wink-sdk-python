...
class StaticSellerListItemAffiliate(BaseModel):
    """
    StaticSellerListItemAffiliate
    """ # noqa: E501
    identifier: StrictStr = Field(description="Identifier")
    parent: StaticSellerListAffiliate
    inventory: InventoryAffiliate
    sort: Optional[StrictInt] = Field(default=None, description="Sort key")
    status: Optional[StrictStr] = Field(default=None, description="Status")
    __properties: ClassVar[List[str]] = ["identifier", "parent", "inventory", "sort", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": StaticSellerListAffiliate.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "inventory": InventoryAffiliate.from_dict(obj["inventory"]) if obj.get("inventory") is not None else None,
            "sort": obj.get("sort"),
