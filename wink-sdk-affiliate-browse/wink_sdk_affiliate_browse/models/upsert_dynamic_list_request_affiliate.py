...
class UpsertDynamicListRequestAffiliate(BaseModel):
    """
    UpsertDynamicListRequestAffiliate
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of dynamic list for when user want to persist it")
    ...
    inventory_name: Optional[StrictStr] = Field(default=None, description="Regex expression filter matching on inventory name", alias="inventoryName")
    ...
    show_direct_only: Optional[StrictBool] = Field(default=False, description="Filter on direct inventory", alias="showDirectOnly")
    ...
    near_point: Optional[GeoJsonPointAffiliate] = Field(default=None, description="Find hotels close to certain location", alias="nearPoint")
    radius_in_meters: Optional[StrictInt] = Field(default=None, description="Use this in conjunction with `nearPoint`. Control the distance from point we are searching for.", alias="radiusInMeters")
    inventory_types: Optional[List[StrictStr]] = Field(default=None, description="Filter on inventory types", alias="inventoryTypes")
    ...
    __properties: ClassVar[List[str]] = ["name", "propertyName", "locationCategories", "segmentCategories", "hotelCategories", "architecturalStyles", "inventoryName", "continents", "countries", "cities", "showEcoFriendly", "showPetFriendly", "showChildFriendly", "showPopular", "showDirectOnly", "lifestyles", "hotelStars", "aggregateReviewRating", "nearPoint", "radiusInMeters", "inventoryTypes", "primaryOrderBy"]
