...
class InventoryAffiliate(BaseModel):
    """
    Channel blocking
    """ # noqa: E501
    identifier: StrictStr = Field(description="Inventory identifier")
    sales_channel: SalesChannelAffiliate = Field(alias="salesChannel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salesChannel": SalesChannelAffiliate.from_dict(obj["salesChannel"]) if obj.get("salesChannel") is not None else None,
            ...
            "hotel": HotelOnMapAffiliate.from_dict(obj["hotel"]) if obj.get("hotel") is not None else None
        })
        return _obj
