...
class CopyMoveStaticListItemRequestAffiliate(BaseModel):
    """
    CopyMoveStaticListItemRequestAffiliate
    """ # noqa: E501
    target_list_identifier: StrictStr = Field(alias="targetListIdentifier")
    __properties: ClassVar[List[str]] = ["targetListIdentifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "targetListIdentifier": obj.get("targetListIdentifier")
        })
        return _obj
