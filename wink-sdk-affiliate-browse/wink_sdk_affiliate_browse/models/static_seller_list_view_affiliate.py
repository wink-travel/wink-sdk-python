...
class StaticSellerListViewAffiliate(BaseModel):
    """
    Curated list object
    """ # noqa: E501
    ...
    static_seller_list: StaticSellerListAffiliate = Field(alias="staticSellerList")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "staticSellerList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of static_seller_list
        if self.static_seller_list:
            _dict['staticSellerList'] = self.static_seller_list.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "staticSellerList": StaticSellerListAffiliate.from_dict(obj["staticSellerList"]) if obj.get("staticSellerList") is not None else None
        })
        return _obj
