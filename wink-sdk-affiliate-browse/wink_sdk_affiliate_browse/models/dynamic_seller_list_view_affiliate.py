...
class DynamicSellerListViewAffiliate(BaseModel):
    """
    ...
    dynamic_seller_list: DynamicSellerListAffiliate = Field(alias="dynamicSellerList")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "dynamicSellerList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dynamic_seller_list
        if self.dynamic_seller_list:
            _dict['dynamicSellerList'] = self.dynamic_seller_list.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dynamicSellerList": DynamicSellerListAffiliate.from_dict(obj["dynamicSellerList"]) if obj.get("dynamicSellerList") is not None else None
        })
        return _obj
