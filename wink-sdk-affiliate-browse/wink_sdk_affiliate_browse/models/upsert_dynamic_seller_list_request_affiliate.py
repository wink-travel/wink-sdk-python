...
class UpsertDynamicSellerListRequestAffiliate(BaseModel):
    """
    UpsertDynamicSellerListRequestAffiliate
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of dynamic list for when user want to persist it")
