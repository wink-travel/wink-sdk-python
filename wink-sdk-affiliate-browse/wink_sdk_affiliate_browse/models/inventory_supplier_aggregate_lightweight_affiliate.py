...
class InventorySupplierAggregateLightweightAffiliate(BaseModel):
    """
    ...
    hotel: PropertyAggregateLightweightAffiliate = Field(description="Combined property data.")
    ...
    __properties: ClassVar[List[str]] = ["salesChannel", "hotel", "lowestPrice", "lowestDisplayPrice"]
