...
class AddStaticSellerListItemRequestAffiliate(BaseModel):
    """
    AddStaticSellerListItemRequestAffiliate
    """ # noqa: E501
    channel_inventory_identifier: StrictStr = Field(description="The blocking ID", alias="channelInventoryIdentifier")
