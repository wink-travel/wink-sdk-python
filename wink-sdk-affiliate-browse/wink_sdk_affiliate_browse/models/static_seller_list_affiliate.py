...
class StaticSellerListAffiliate(BaseModel):
    """
    ...
    owner_identifier: StrictStr = Field(description="List creator", alias="ownerIdentifier")
    name: StrictStr = Field(description="Name of curated list")
    type: StrictStr = Field(description="Static seller list type")
