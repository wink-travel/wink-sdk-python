...
class StaticSellerListWrapperAffiliate(BaseModel):
    """
    Contains both the curated list and all its items.
    """ # noqa: E501
    list: StaticSellerListViewAffiliate
    items: Optional[List[StaticSellerListItemViewAffiliate]] = Field(default=None, description="Travel blocking items contained in list")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": StaticSellerListViewAffiliate.from_dict(obj["list"]) if obj.get("list") is not None else None,
            "items": [StaticSellerListItemViewAffiliate.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
