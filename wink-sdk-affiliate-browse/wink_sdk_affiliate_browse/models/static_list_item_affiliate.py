...
class StaticListItemAffiliate(BaseModel):
    """
    ...
    parent: StaticListLightweightAffiliate = Field(description="Parent list")
    item: StaticListItemInventoryAffiliate = Field(description="Channel inventory")
    sort: Optional[StrictInt] = Field(default=None, description="Sort key")
    status: Optional[StrictStr] = Field(default=None, description="Status")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "parent", "item", "sort", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": StaticListLightweightAffiliate.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "item": StaticListItemInventoryAffiliate.from_dict(obj["item"]) if obj.get("item") is not None else None,
            "sort": obj.get("sort"),
