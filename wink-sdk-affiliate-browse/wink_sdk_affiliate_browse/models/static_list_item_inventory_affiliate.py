...
class StaticListItemInventoryAffiliate(BaseModel):
    """
    StaticListItemInventoryAffiliate
    """ # noqa: E501
    identifier: UUID = Field(description="Channel Inventory identifier")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "salesChannel", "inventoryType", "inventoryIdentifier", "inventoryNameInEnglish", "enabled", "image", "location", "commissionable", "lowestPrice", "lowestDisplayPrice", "pricePoint"]
