...
class AddStaticListItemRequestAffiliate(BaseModel):
    """
    AddStaticListItemRequestAffiliate
    """ # noqa: E501
    channel_inventory_identifier: UUID = Field(description="The inventory ID", alias="channelInventoryIdentifier")
    __properties: ClassVar[List[str]] = ["channelInventoryIdentifier"]
