...
class InventoryAggregateLightweightAffiliate(BaseModel):
    ...
    inventory_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of blocking as hotel is seeing it", alias="inventoryName")
    inventory_name_in_english: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of blocking as traveler is seeing it", alias="inventoryNameInEnglish")
    enabled: StrictBool = Field(description="Whether this blocking is enabled or not")
    image_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Main image of blocking", alias="imageIdentifier")
    ...
    bookable: StrictBool = Field(description="Whether blocking can be booked")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "salesChannel", "inventoryType", "inventoryIdentifier", "inventoryName", "inventoryNameInEnglish", "enabled", "imageIdentifier", "pricePoint", "location", "address", "quantity", "commissionable", "bookable", "lowestPrice", "lowestDisplayPrice", "hotel"]
