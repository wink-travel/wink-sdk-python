...
class InventoryAggregateLightweightAffiliate(BaseModel):
    """
    ...
    sales_channel: SalesChannelLightweightAffiliate = Field(description="Parent sales channel", alias="salesChannel")
    ...
    image: SimpleMultimediaAffiliate = Field(description="Main image of inventory")
    price_point: StrictStr = Field(description="Level of expensiveness.", alias="pricePoint")
    location: GeoJsonPointAffiliate = Field(description="Location")
    address: SimpleAddressAffiliate = Field(description="Defaults to property address.")
    ...
    hotel: Optional[PropertyAggregateLightweightAffiliate] = Field(default=None, description="Linked hotel")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "salesChannel", "inventoryType", "inventoryIdentifier", "inventoryName", "inventoryNameInEnglish", "enabled", "image", "pricePoint", "location", "address", "quantity", "commissionable", "bookable", "lowestPrice", "lowestDisplayPrice", "hotel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salesChannel": SalesChannelLightweightAffiliate.from_dict(obj["salesChannel"]) if obj.get("salesChannel") is not None else None,
            ...
            "image": SimpleMultimediaAffiliate.from_dict(obj["image"]) if obj.get("image") is not None else None,
            ...
            "address": SimpleAddressAffiliate.from_dict(obj["address"]) if obj.get("address") is not None else None,
            ...
            "hotel": PropertyAggregateLightweightAffiliate.from_dict(obj["hotel"]) if obj.get("hotel") is not None else None
        })
        return _obj
