...
class InventoryAggregateLightweightAffiliate(BaseModel):
    ...
    inventory_identifier: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Inventory type identifier", alias="inventoryIdentifier")
    ...
    address: InventoryAddressAffiliate = Field(description="Defaults to property address.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": InventoryAddressAffiliate.from_dict(obj["address"]) if obj.get("address") is not None else None,
