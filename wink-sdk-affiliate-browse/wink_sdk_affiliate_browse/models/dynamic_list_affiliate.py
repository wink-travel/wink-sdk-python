...
class DynamicListAffiliate(BaseModel):
    """
    ...
    owner_identifier: UUID = Field(description="Entity identifier of record creator", alias="ownerIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "ownerIdentifier", "name", "propertyName", "locationCategories", "segmentCategories", "hotelCategories", "architecturalStyles", "inventoryName", "continents", "countries", "cities", "showEcoFriendly", "showPetFriendly", "showChildFriendly", "showPopular", "showDirectOnly", "lifestyles", "hotelStars", "aggregateReviewRating", "nearPoint", "radiusInMeters", "inventoryTypes", "primaryOrderBy"]
