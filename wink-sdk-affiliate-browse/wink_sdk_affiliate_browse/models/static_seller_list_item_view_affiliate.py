...
class StaticSellerListItemViewAffiliate(BaseModel):
    """
    ...
    static_seller_list_item: StaticSellerListItemAffiliate = Field(alias="staticSellerListItem")
    __properties: ClassVar[List[str]] = ["id", "createdDate", "lastUpdate", "version", "staticSellerListItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of static_seller_list_item
        if self.static_seller_list_item:
            _dict['staticSellerListItem'] = self.static_seller_list_item.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "staticSellerListItem": StaticSellerListItemAffiliate.from_dict(obj["staticSellerListItem"]) if obj.get("staticSellerListItem") is not None else None
        })
        return _obj
