...
class CreateStaticListAndAddSupplierRequestAffiliate(BaseModel):
    """
    ...
    supplier_identifier: UUID = Field(description="Supplier this list should add.", alias="supplierIdentifier")
    channel_inventory_type: StrictStr = Field(description="Supplier this list should add.", alias="channelInventoryType")
    __properties: ClassVar[List[str]] = ["name", "supplierIdentifier", "channelInventoryType"]
