...
class SearchCategoryAffiliate(BaseModel):
    ...
    key: StrictStr = Field(description="Usually the OTA reactive code.")
    value: StrictStr = Field(description="Usually the OTA reactive code value.")
    count: Optional[StrictInt] = Field(default=None, description="Quantity of items in this category.")
    __properties: ClassVar[List[str]] = ["type", "key", "value", "count"]
