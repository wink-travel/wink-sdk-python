...
class CreateStaticSellerListAndAddItemRequestAffiliate(BaseModel):
    """
    CreateStaticSellerListAndAddItemRequestAffiliate
    """ # noqa: E501
    name: StrictStr = Field(description="Name of curated list")
    channel_inventory_identifiers: Optional[List[StrictStr]] = Field(default=None, alias="channelInventoryIdentifiers")
