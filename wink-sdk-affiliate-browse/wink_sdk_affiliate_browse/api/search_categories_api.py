...
class SearchCategoriesApi:
    ...
    def show_search_category_list(
        self,
        company_identifier: Annotated[StrictStr, Field(description="List search categories on behalf of this owner identifier.")],
        ...
        :param company_identifier: List search categories on behalf of this owner identifier. (required)
    ...
    def _show_search_category_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/affiliate/{companyIdentifier}/browse/category/list',
