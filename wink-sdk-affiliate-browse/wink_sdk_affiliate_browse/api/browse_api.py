...
from wink_sdk_affiliate_browse.rest import RESTResponseType
...
class BrowseApi:
    ...
    @validate_call
    def show_continents_for_inventory(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _param = self._show_continents_for_inventory_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_continents_for_inventory_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def show_continents_for_inventory_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_continents_for_inventory_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/browse/inventory/continent/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def show_continents_for_inventory_supplier(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _param = self._show_continents_for_inventory_supplier_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def show_continents_for_inventory_supplier_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def show_continents_for_inventory_supplier_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_continents_for_inventory_supplier_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/browse/supplier/continent/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_dynamic_seller_inventory(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "UpdateCuratedList400Response",
            '200': "PageInventoryAggregateLightweightAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_dynamic_seller_inventory_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageInventoryAggregateLightweightAffiliate]:
        """Inventory Search
    ...
    def _show_dynamic_seller_inventory_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if dynamic_seller_list_request_affiliate is not None:
            _body_params = dynamic_seller_list_request_affiliate
    ...
    def show_dynamic_seller_inventory_by_id(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "UpdateCuratedList400Response",
            '200': "PageInventorySupplierAggregateLightweightAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_dynamic_seller_inventory_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageInventorySupplierAggregateLightweightAffiliate]:
        """Supplier Search by Saved Search
    ...
    def show_inventory_supplier(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "UpdateCuratedList400Response",
            '200': "InventorySupplierAggregateLightweightAffiliate",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_inventory_supplier_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InventorySupplierAggregateLightweightAffiliate]:
        """Show Supplier
    ...
    def show_latest_inventory(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "UpdateCuratedList400Response",
            '200': "List[InventoryAggregateLightweightAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_latest_inventory_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[InventoryAggregateLightweightAffiliate]]:
        """Latest Inventory
    ...
    def show_latest_inventory_supplier_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "UpdateCuratedList400Response",
            '200': "List[InventorySupplierAggregateLightweightAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def show_latest_inventory_supplier_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[InventorySupplierAggregateLightweightAffiliate]]:
        """Latest Suppliers
    ...
    def show_search_category_list(
        ...
        _param = self._show_search_category_list_serialize(
            wink_version=wink_version,
            accept=accept,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GenericErrorMessage",
            '400': "UpdateCuratedList400Response",
            '200': "List[SearchCategoryAffiliate]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def show_search_category_list_with_http_info(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SearchCategoryAffiliate]]:
        """Show Categories
    ...
    @validate_call
    def show_search_category_list_without_preload_content(
        self,
        wink_version: Optional[StrictStr] = None,
        accept: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _show_search_category_list_serialize(
        self,
        wink_version,
        accept,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/browse/category/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
