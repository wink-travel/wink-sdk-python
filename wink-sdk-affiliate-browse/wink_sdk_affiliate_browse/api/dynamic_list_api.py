...
class DynamicListApi:
    ...
    def create_saved_search(
        self,
        upsert_dynamic_list_request_affiliate: UpsertDynamicListRequestAffiliate,
        ...
        :param upsert_dynamic_list_request_affiliate: (required)
        :type upsert_dynamic_list_request_affiliate: UpsertDynamicListRequestAffiliate
        :param wink_version:
        ...
        _param = self._create_saved_search_serialize(
            upsert_dynamic_list_request_affiliate=upsert_dynamic_list_request_affiliate,
    ...
    def create_saved_search_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DynamicListAffiliate]:
        """Create Dynamic List
    ...
    def _create_saved_search_serialize(
        self,
        upsert_dynamic_list_request_affiliate,
        wink_version,
        _request_auth,
        _content_type,
        _headers,
        ...
        if upsert_dynamic_list_request_affiliate is not None:
            _body_params = upsert_dynamic_list_request_affiliate
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/dynamic-list',
    ...
    def _remove_saved_search_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/dynamic-list/{listIdentifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_saved_searches_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DynamicListAffiliate]]:
        """Show Dynamic Lists
